...
public struct MessageWithI32: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// A singular field.
  public var singular: Swift.Int32 = Swift.Int32()

  /// An optional field.
  public var option: Swift.Int32? = nil
  ...
  ///
  /// ```
  /// let value = MessageWithI32().with { $0.singular = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.Int32.self, forKey: .singular) {
      self.singular = value
    }
    self.option = try container.decodeIfPresent(Swift.Int32.self, forKey: .option)
    if let value = try container.decodeIfPresent([Swift.Int32].self, forKey: .repeated) {
      self.repeated = value
    }
    if let value = try container.decodeIfPresent(
      [Swift.String: Swift.Int32].self, forKey: .mapValue)
    {
      self.mapValue = value
    }
    ...
    if let stringKeyed = try container.decodeIfPresent(
      [Swift.String: Swift.Int32].self, forKey: .mapKeyValue)
    {
      let tuples = try stringKeyed.lazy.map { (key, value) throws -> (Swift.Int32, Swift.Int32) in
        guard let newKey = Swift.Int32(key) else {
          throw DecodingError.typeMismatch(
            Swift.Int32.self,
            DecodingError.Context(
