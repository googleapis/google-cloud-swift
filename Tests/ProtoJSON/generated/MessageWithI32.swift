  ...
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.singular = try container.decode(Swift.Int32.self, forKey: .singular)
    self.option = try container.decodeIfPresent(Swift.Int32.self, forKey: .option)
    self.repeated = try container.decode([Swift.Int32].self, forKey: .repeated)
    self.mapValue = try container.decode([Swift.String: Swift.Int32].self, forKey: .mapValue)
    ...
    self.mapKeyValue = try { () throws in
      let stringKeyed = try container.decode([Swift.String: Swift.Int32].self, forKey: .mapKeyValue)
