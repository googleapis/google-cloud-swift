...
{
  /// A singular field.
  public var singular: GoogleWKT.WKTListValue? = nil

  /// An optional field.
  public var `optional`: GoogleWKT.WKTListValue? = nil

  /// A repeated field.
  public var repeated: [GoogleWKT.WKTListValue] = []

  /// A map field, messages cannot be keys.
  public var map: [Swift.String: GoogleWKT.WKTListValue] = [:]
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.singular = try container.decodeIfPresent(GoogleWKT.WKTListValue.self, forKey: .singular)
    self.`optional` = try container.decodeIfPresent(
      GoogleWKT.WKTListValue.self, forKey: .`optional`)
    if let value = try container.decodeIfPresent([GoogleWKT.WKTListValue].self, forKey: .repeated) {
      self.repeated = value
    }
    if let value = try container.decodeIfPresent(
      [Swift.String: GoogleWKT.WKTListValue].self, forKey: .map)
    {
      self.map = value
    }
