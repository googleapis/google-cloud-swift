  ...
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.singular = try container.decodeIfPresent(GoogleCloudWKT.Int64Value.self, forKey: .singular)
    if let value = try container.decodeIfPresent(
      [GoogleCloudWKT.Int64Value].self, forKey: .repeated)
    {
      self.repeated = value
    }
    if let value = try container.decodeIfPresent(
      [Swift.String: GoogleCloudWKT.Int64Value].self, forKey: .map)
    {
      self.map = value
    }
