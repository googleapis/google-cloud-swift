...
{
  /// A singular field.
  public var singular: GoogleWKT.Struct? = nil

  /// An optional field.
  public var `optional`: GoogleWKT.Struct? = nil

  /// A repeated field.
  public var repeated: [GoogleWKT.Struct] = []

  /// A map field, messages cannot be keys.
  public var map: [Swift.String: GoogleWKT.Struct] = [:]
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.singular = try container.decodeIfPresent(GoogleWKT.Struct.self, forKey: .singular)
    self.`optional` = try container.decodeIfPresent(GoogleWKT.Struct.self, forKey: .`optional`)
    if let value = try container.decodeIfPresent([GoogleWKT.Struct].self, forKey: .repeated) {
      self.repeated = value
    }
    if let value = try container.decodeIfPresent(
      [Swift.String: GoogleWKT.Struct].self, forKey: .map)
    {
      self.map = value
    }
