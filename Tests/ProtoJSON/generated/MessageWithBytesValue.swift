...
{
  /// A singular field.
  public var singular: GoogleWKT.WKTBytesValue? = nil

  /// A repeated field.
  public var repeated: [GoogleWKT.WKTBytesValue] = []

  /// A map field, google.protobuf.BytesValue cannot be keys, so we only need to
  /// test them as values.
  public var map: [Swift.String: GoogleWKT.WKTBytesValue] = [:]
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [Swift.String: GoogleWKT.WKTBytesValue].self, forKey: .map)
    {
      self.map = value
    }
