  ...
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.singular = try container.decode(Swift.UInt32.self, forKey: .singular)
    self.option = try container.decodeIfPresent(Swift.UInt32.self, forKey: .option)
    self.repeated = try container.decode([Swift.UInt32].self, forKey: .repeated)
    self.mapValue = try container.decode([Swift.String: Swift.UInt32].self, forKey: .mapValue)
