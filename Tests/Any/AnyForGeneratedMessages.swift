...
// Verify `Any` can be used with a struct defined outside the `GoogleWKT`  package.
//
// We use an integration test to avoid a cyclic dependency between the `GoogleWKT` package and the generated library.
