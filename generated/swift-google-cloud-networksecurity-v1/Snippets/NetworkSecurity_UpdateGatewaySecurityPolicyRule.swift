...
func sample(
  ...
  let poller = try await client.updateGatewaySecurityPolicyRule(
    withPolling: UpdateGatewaySecurityPolicyRuleRequest()
      .with {
  ...
  static func main() async throws {
    do {
      ...
      try await sample(
        ...
        gatewaySecurityPolicyId: "[placeholder]", ruleId: "[placeholder]")
    } catch {
      print("Error: \(error)")
    }
  }
