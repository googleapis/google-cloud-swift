...
public struct ListUrlListsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// List of UrlList resources.
  public var urlLists: [UrlList] = []
  ...
  /// Initialize a new instance of `ListUrlListsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListUrlListsResponse().with { $0.urlLists = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let urlLists = CodingKeys(stringValue: "urlLists")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([UrlList].self, forKey: .urlLists) {
      self.urlLists = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.urlLists, forKey: .urlLists)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListUrlListsResponse"
  }
...
extension ListUrlListsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [UrlList] {
