  ...
  Sendable
{
  ...
  public var clientTlsPolicies: [ClientTlsPolicy] = []
  ...
  /// Initialize a new instance of `ListClientTlsPoliciesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListClientTlsPoliciesResponse().with { $0.clientTlsPolicies = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let clientTlsPolicies = CodingKeys(stringValue: "clientTlsPolicies")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListClientTlsPoliciesResponse"
  }
