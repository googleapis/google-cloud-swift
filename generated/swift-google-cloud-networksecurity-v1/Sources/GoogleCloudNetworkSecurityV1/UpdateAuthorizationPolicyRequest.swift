...
public struct UpdateAuthorizationPolicyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateAuthorizationPolicyRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateAuthorizationPolicyRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.UpdateAuthorizationPolicyRequest"
  }
