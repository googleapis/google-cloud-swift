...
public struct ListAuthzPoliciesResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The list of `AuthzPolicy` resources.
  public var authzPolicies: [AuthzPolicy] = []
  ...
  /// Initialize a new instance of `ListAuthzPoliciesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAuthzPoliciesResponse().with { $0.authzPolicies = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let authzPolicies = CodingKeys(stringValue: "authzPolicies")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListAuthzPoliciesResponse"
  }
...
extension ListAuthzPoliciesResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [AuthzPolicy] {
    return self.authzPolicies
  }
