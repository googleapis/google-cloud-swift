...
public struct DeleteTlsInspectionPolicyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteTlsInspectionPolicyRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteTlsInspectionPolicyRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.DeleteTlsInspectionPolicyRequest"
  }
