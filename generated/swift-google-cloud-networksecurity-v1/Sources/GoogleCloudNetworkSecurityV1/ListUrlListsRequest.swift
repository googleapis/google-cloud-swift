...
public struct ListUrlListsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListUrlListsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListUrlListsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListUrlListsRequest"
  }
