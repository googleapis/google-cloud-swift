...
public struct DeleteGatewaySecurityPolicyRuleRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteGatewaySecurityPolicyRuleRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteGatewaySecurityPolicyRuleRequest().with { $0.name = ... }
  /// ```
