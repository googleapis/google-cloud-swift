...
public struct UpdateMirroringDeploymentRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var mirroringDeployment: MirroringDeployment? = nil
  ...
  /// Initialize a new instance of `UpdateMirroringDeploymentRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateMirroringDeploymentRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.UpdateMirroringDeploymentRequest"
  }
