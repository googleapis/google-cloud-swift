...
public struct ListSACRealmsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListSACRealmsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListSACRealmsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListSACRealmsRequest"
  }
