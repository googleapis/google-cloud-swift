...
public struct GetGatewaySecurityPolicyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetGatewaySecurityPolicyRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetGatewaySecurityPolicyRequest().with { $0.name = ... }
  /// ```
