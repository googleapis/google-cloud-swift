...
public struct GrpcEndpoint: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GrpcEndpoint`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GrpcEndpoint().with { $0.targetUri = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.GrpcEndpoint"
  }
