...
public struct UpdateInterceptEndpointGroupAssociationRequest: Codable, Equatable, GoogleWKT
    ._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateInterceptEndpointGroupAssociationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateInterceptEndpointGroupAssociationRequest().with { $0.updateMask = ... }
  /// ```
