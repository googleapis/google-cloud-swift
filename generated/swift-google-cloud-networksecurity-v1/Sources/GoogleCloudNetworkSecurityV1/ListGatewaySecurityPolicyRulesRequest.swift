...
public struct ListGatewaySecurityPolicyRulesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListGatewaySecurityPolicyRulesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListGatewaySecurityPolicyRulesRequest().with { $0.parent = ... }
  /// ```
