...
public struct UpdateTlsInspectionPolicyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateTlsInspectionPolicyRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateTlsInspectionPolicyRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.UpdateTlsInspectionPolicyRequest"
  }
