...
public struct ListSACAttachmentsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The list of SACAttachments.
  public var sacAttachments: [SACAttachment] = []
  ...
  /// Initialize a new instance of `ListSACAttachmentsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListSACAttachmentsResponse().with { $0.sacAttachments = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let sacAttachments = CodingKeys(stringValue: "sacAttachments")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([SACAttachment].self, forKey: .sacAttachments) {
      self.sacAttachments = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.sacAttachments, forKey: .sacAttachments)
...
extension ListSACAttachmentsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [SACAttachment] {
    return self.sacAttachments
  }
