...
public struct UpdateDnsThreatDetectorRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateDnsThreatDetectorRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateDnsThreatDetectorRequest().with { $0.updateMask = ... }
  /// ```
