...
public struct ListGatewaySecurityPoliciesResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// List of GatewaySecurityPolicies resources.
  public var gatewaySecurityPolicies: [GatewaySecurityPolicy] = []
  ...
  /// Initialize a new instance of `ListGatewaySecurityPoliciesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListGatewaySecurityPoliciesResponse().with { $0.gatewaySecurityPolicies = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let gatewaySecurityPolicies = CodingKeys(stringValue: "gatewaySecurityPolicies")
  ...
  public init(from decoder: Decoder) throws {
    ...
    {
      self.gatewaySecurityPolicies = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListGatewaySecurityPoliciesResponse"
  }
...
extension ListGatewaySecurityPoliciesResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [GatewaySecurityPolicy] {
    return self.gatewaySecurityPolicies
  }
