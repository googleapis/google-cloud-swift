...
public struct ListSACAttachmentsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListSACAttachmentsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListSACAttachmentsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListSACAttachmentsRequest"
  }
