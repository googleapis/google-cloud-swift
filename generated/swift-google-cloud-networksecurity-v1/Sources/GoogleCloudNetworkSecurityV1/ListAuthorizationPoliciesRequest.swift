...
public struct ListAuthorizationPoliciesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListAuthorizationPoliciesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAuthorizationPoliciesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListAuthorizationPoliciesRequest"
  }
