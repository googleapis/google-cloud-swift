...
public struct DeleteMirroringEndpointGroupAssociationRequest: Codable, Equatable, GoogleWKT
    ._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteMirroringEndpointGroupAssociationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteMirroringEndpointGroupAssociationRequest().with { $0.name = ... }
  /// ```
