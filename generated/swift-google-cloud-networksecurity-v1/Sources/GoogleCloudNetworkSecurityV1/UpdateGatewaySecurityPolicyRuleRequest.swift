...
public struct UpdateGatewaySecurityPolicyRuleRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateGatewaySecurityPolicyRuleRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateGatewaySecurityPolicyRuleRequest().with { $0.updateMask = ... }
  /// ```
