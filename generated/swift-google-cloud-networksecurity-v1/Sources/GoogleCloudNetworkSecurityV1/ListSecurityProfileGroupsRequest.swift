...
public struct ListSecurityProfileGroupsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListSecurityProfileGroupsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListSecurityProfileGroupsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListSecurityProfileGroupsRequest"
  }
