...
public struct UrlFilter: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Required. The action taken when this filter is applied.
  public var filteringAction: UrlFilter.UrlFilteringAction = UrlFilter.UrlFilteringAction()
  ...
  ///
  /// ```
  /// let value = UrlFilter().with { $0.filteringAction = ... }
  /// ```
  ...
  ///   them to named cases.
  public enum UrlFilteringAction: Codable, Equatable, Hashable, Sendable {
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "URL_FILTERING_ACTION_UNSPECIFIED"
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:UrlFilteringAction/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "URL_FILTERING_ACTION_UNSPECIFIED": self = .unspecified
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:UrlFilteringAction/unknownIntValue(_:)).
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("URL_FILTERING_ACTION_UNSPECIFIED")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.UrlFilter"
  }
