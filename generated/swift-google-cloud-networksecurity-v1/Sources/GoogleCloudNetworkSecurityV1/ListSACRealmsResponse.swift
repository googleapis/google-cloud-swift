  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListSACRealmsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListSACRealmsResponse().with { $0.sacRealms = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let sacRealms = CodingKeys(stringValue: "sacRealms")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([SACRealm].self, forKey: .sacRealms) {
      self.sacRealms = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.sacRealms, forKey: .sacRealms)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListSACRealmsResponse"
  }
