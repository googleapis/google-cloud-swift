...
public struct ListFirewallEndpointsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListFirewallEndpointsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListFirewallEndpointsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListFirewallEndpointsRequest"
  }
