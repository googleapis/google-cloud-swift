...
public struct ListInterceptDeploymentsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListInterceptDeploymentsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListInterceptDeploymentsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListInterceptDeploymentsRequest"
  }
