...
public struct UpdateServerTlsPolicyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateServerTlsPolicyRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateServerTlsPolicyRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.UpdateServerTlsPolicyRequest"
  }
