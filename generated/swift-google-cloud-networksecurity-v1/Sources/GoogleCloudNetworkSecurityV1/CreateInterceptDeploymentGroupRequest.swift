...
public struct CreateInterceptDeploymentGroupRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var interceptDeploymentGroupId: Swift.String = Swift.String()
  ...
  ///
  /// ```
  /// let value = CreateInterceptDeploymentGroupRequest().with { $0.parent = ... }
  /// ```
