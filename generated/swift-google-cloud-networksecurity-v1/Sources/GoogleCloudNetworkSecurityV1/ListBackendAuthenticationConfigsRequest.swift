...
public struct ListBackendAuthenticationConfigsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListBackendAuthenticationConfigsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListBackendAuthenticationConfigsRequest().with { $0.parent = ... }
  /// ```
