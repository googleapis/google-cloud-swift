  ...
  Sendable
{
  ...
  public var securityProfiles: [SecurityProfile] = []
  ...
  /// Initialize a new instance of `ListSecurityProfilesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListSecurityProfilesResponse().with { $0.securityProfiles = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let securityProfiles = CodingKeys(stringValue: "securityProfiles")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([SecurityProfile].self, forKey: .securityProfiles)
    {
      self.securityProfiles = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListSecurityProfilesResponse"
  }
