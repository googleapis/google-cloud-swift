...
public struct CertificateProviderInstance: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CertificateProviderInstance`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CertificateProviderInstance().with { $0.pluginInstance = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.CertificateProviderInstance"
  }
