...
public struct DeleteInterceptDeploymentGroupRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteInterceptDeploymentGroupRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteInterceptDeploymentGroupRequest().with { $0.name = ... }
  /// ```
