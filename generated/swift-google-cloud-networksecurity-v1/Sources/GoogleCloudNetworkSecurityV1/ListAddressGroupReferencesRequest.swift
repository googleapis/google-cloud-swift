...
public struct ListAddressGroupReferencesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// [google.cloud.networksecurity.v1.ListAddressGroupReferencesResponse.next_page_token]: <doc:ListAddressGroupReferencesResponse/nextPageToken>
  ...
  /// Initialize a new instance of `ListAddressGroupReferencesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAddressGroupReferencesRequest().with { $0.addressGroup = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListAddressGroupReferencesRequest"
  }
