...
public struct UpdateSecurityProfileGroupRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateSecurityProfileGroupRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateSecurityProfileGroupRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.UpdateSecurityProfileGroupRequest"
  }
