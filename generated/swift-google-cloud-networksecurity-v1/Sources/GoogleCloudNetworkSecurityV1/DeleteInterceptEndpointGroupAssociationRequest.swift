...
public struct DeleteInterceptEndpointGroupAssociationRequest: Codable, Equatable, GoogleWKT
    ._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteInterceptEndpointGroupAssociationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteInterceptEndpointGroupAssociationRequest().with { $0.name = ... }
  /// ```
