...
public struct ListClientTlsPoliciesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListClientTlsPoliciesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListClientTlsPoliciesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListClientTlsPoliciesRequest"
  }
