  ...
  Sendable
{
  ...
  public var mirroringEndpointGroups: [MirroringEndpointGroup] = []
  ...
  /// Initialize a new instance of `ListMirroringEndpointGroupsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMirroringEndpointGroupsResponse().with { $0.mirroringEndpointGroups = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let mirroringEndpointGroups = CodingKeys(stringValue: "mirroringEndpointGroups")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [MirroringEndpointGroup].self, forKey: .mirroringEndpointGroups)
    {
      self.mirroringEndpointGroups = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.mirroringEndpointGroups, forKey: .mirroringEndpointGroups)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListMirroringEndpointGroupsResponse"
  }
