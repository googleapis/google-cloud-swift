...
public struct GetInterceptEndpointGroupAssociationRequest: Codable, Equatable, GoogleWKT
    ._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetInterceptEndpointGroupAssociationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetInterceptEndpointGroupAssociationRequest().with { $0.name = ... }
  /// ```
