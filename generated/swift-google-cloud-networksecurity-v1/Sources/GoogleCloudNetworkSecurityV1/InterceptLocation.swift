...
public struct InterceptLocation: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var state: InterceptLocation.State = InterceptLocation.State()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `InterceptLocation`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = InterceptLocation().with { $0.location = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(InterceptLocation.State.self, forKey: .state) {
      self.state = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.InterceptLocation"
  }
