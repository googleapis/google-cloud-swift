...
public struct ListFirewallEndpointAssociationsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListFirewallEndpointAssociationsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListFirewallEndpointAssociationsRequest().with { $0.parent = ... }
  /// ```
