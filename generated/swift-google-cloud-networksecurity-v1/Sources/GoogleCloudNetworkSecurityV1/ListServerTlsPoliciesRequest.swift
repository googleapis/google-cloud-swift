...
public struct ListServerTlsPoliciesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListServerTlsPoliciesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListServerTlsPoliciesRequest().with { $0.parent = ... }
  /// ```
