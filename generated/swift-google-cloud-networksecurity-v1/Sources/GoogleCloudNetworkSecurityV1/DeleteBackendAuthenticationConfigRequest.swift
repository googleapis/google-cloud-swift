...
public struct DeleteBackendAuthenticationConfigRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteBackendAuthenticationConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteBackendAuthenticationConfigRequest().with { $0.name = ... }
  /// ```
