...
public struct GetBackendAuthenticationConfigRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetBackendAuthenticationConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetBackendAuthenticationConfigRequest().with { $0.name = ... }
  /// ```
