...
public struct ListMirroringDeploymentGroupsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListMirroringDeploymentGroupsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMirroringDeploymentGroupsRequest().with { $0.parent = ... }
  /// ```
