...
public struct ListMirroringDeploymentsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListMirroringDeploymentsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMirroringDeploymentsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListMirroringDeploymentsRequest"
  }
