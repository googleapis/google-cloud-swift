...
public struct ListAuthzPoliciesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListAuthzPoliciesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAuthzPoliciesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListAuthzPoliciesRequest"
  }
