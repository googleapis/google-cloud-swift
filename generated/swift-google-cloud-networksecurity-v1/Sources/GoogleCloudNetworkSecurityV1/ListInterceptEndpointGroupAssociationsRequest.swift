...
public struct ListInterceptEndpointGroupAssociationsRequest: Codable, Equatable, GoogleWKT
    ._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListInterceptEndpointGroupAssociationsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListInterceptEndpointGroupAssociationsRequest().with { $0.parent = ... }
  /// ```
