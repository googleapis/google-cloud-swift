...
public struct ListGatewaySecurityPolicyRulesResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// List of GatewaySecurityPolicyRule resources.
  public var gatewaySecurityPolicyRules: [GatewaySecurityPolicyRule] = []
  ...
  /// Initialize a new instance of `ListGatewaySecurityPolicyRulesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListGatewaySecurityPolicyRulesResponse().with { $0.gatewaySecurityPolicyRules = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let gatewaySecurityPolicyRules = CodingKeys(stringValue: "gatewaySecurityPolicyRules")
  ...
  public init(from decoder: Decoder) throws {
    ...
    {
      self.gatewaySecurityPolicyRules = value
    }
...
extension ListGatewaySecurityPolicyRulesResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [GatewaySecurityPolicyRule] {
    return self.gatewaySecurityPolicyRules
  }
