  ...
  Sendable
{
  ...
  public var dnsThreatDetectors: [DnsThreatDetector] = []
  ...
  /// Initialize a new instance of `ListDnsThreatDetectorsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDnsThreatDetectorsResponse().with { $0.dnsThreatDetectors = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let dnsThreatDetectors = CodingKeys(stringValue: "dnsThreatDetectors")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [DnsThreatDetector].self, forKey: .dnsThreatDetectors)
    {
      self.dnsThreatDetectors = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.dnsThreatDetectors, forKey: .dnsThreatDetectors)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListDnsThreatDetectorsResponse"
  }
