  ...
  Sendable
{
  ...
  public var interceptEndpointGroupAssociations: [InterceptEndpointGroupAssociation] = []
  ...
  /// Initialize a new instance of `ListInterceptEndpointGroupAssociationsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListInterceptEndpointGroupAssociationsResponse().with { $0.interceptEndpointGroupAssociations = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let interceptEndpointGroupAssociations = CodingKeys(
      stringValue: "interceptEndpointGroupAssociations")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [InterceptEndpointGroupAssociation].self, forKey: .interceptEndpointGroupAssociations)
    {
      self.interceptEndpointGroupAssociations = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(
      self.interceptEndpointGroupAssociations, forKey: .interceptEndpointGroupAssociations)
