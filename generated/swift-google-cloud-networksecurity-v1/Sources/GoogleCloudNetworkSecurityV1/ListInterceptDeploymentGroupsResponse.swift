  ...
  Sendable
{
  ...
  public var interceptDeploymentGroups: [InterceptDeploymentGroup] = []
  ...
  /// Initialize a new instance of `ListInterceptDeploymentGroupsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListInterceptDeploymentGroupsResponse().with { $0.interceptDeploymentGroups = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let interceptDeploymentGroups = CodingKeys(stringValue: "interceptDeploymentGroups")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [InterceptDeploymentGroup].self, forKey: .interceptDeploymentGroups)
    {
      self.interceptDeploymentGroups = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.interceptDeploymentGroups, forKey: .interceptDeploymentGroups)
