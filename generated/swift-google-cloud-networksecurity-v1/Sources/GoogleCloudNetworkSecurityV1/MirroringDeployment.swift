...
public struct MirroringDeployment: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `MirroringDeployment`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = MirroringDeployment().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.MirroringDeployment"
  }
