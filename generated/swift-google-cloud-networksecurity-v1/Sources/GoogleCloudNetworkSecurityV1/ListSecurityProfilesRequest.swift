...
public struct ListSecurityProfilesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListSecurityProfilesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListSecurityProfilesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListSecurityProfilesRequest"
  }
