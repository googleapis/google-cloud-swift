  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let connectedDeploymentGroup = CodingKeys(stringValue: "connectedDeploymentGroup")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      Swift.String.self, forKey: .interceptDeploymentGroup)
    {
      self.interceptDeploymentGroup = value
    }
    self.connectedDeploymentGroup = try container.decodeIfPresent(
      InterceptEndpointGroup.ConnectedDeploymentGroup.self, forKey: .connectedDeploymentGroup)
    if let value = try container.decodeIfPresent(InterceptEndpointGroup.State.self, forKey: .state)
    {
      self.state = value
    }
    ...
    if let value = try container.decodeIfPresent(
      [InterceptEndpointGroup.AssociationDetails].self, forKey: .associations)
    {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.interceptDeploymentGroup, forKey: .interceptDeploymentGroup)
    try container.encodeIfPresent(self.connectedDeploymentGroup, forKey: .connectedDeploymentGroup)
