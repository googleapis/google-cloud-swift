  ...
  Sendable
{
  ...
  public var firewallEndpointAssociations: [FirewallEndpointAssociation] = []
  ...
  /// Initialize a new instance of `ListFirewallEndpointAssociationsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListFirewallEndpointAssociationsResponse().with { $0.firewallEndpointAssociations = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let firewallEndpointAssociations = CodingKeys(
      stringValue: "firewallEndpointAssociations")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [FirewallEndpointAssociation].self, forKey: .firewallEndpointAssociations)
    {
      self.firewallEndpointAssociations = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.firewallEndpointAssociations, forKey: .firewallEndpointAssociations)
