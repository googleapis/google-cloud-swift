...
public struct UpdateClientTlsPolicyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateClientTlsPolicyRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateClientTlsPolicyRequest().with { $0.updateMask = ... }
  /// ```
