  ...
  Sendable
{
  ...
  public var backendAuthenticationConfigs: [BackendAuthenticationConfig] = []
  ...
  /// Initialize a new instance of `ListBackendAuthenticationConfigsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListBackendAuthenticationConfigsResponse().with { $0.backendAuthenticationConfigs = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let backendAuthenticationConfigs = CodingKeys(
      stringValue: "backendAuthenticationConfigs")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [BackendAuthenticationConfig].self, forKey: .backendAuthenticationConfigs)
    {
      self.backendAuthenticationConfigs = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.backendAuthenticationConfigs, forKey: .backendAuthenticationConfigs)
