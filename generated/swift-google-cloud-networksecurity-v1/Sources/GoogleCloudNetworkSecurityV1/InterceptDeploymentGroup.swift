...
public struct InterceptDeploymentGroup: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// resource.
  public var connectedEndpointGroups: [InterceptDeploymentGroup.ConnectedEndpointGroup] = []

  /// Output only. The list of Intercept Deployments that belong to this group.
  @available(*, deprecated)
  public var nestedDeployments: [InterceptDeploymentGroup.Deployment] = []

  /// Output only. The current state of the deployment group.
  /// See https://google.aip.dev/216.
  public var state: InterceptDeploymentGroup.State = InterceptDeploymentGroup.State()
  ...
  /// Initialize a new instance of `InterceptDeploymentGroup`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = InterceptDeploymentGroup().with { $0.name = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [InterceptDeploymentGroup.ConnectedEndpointGroup].self, forKey: .connectedEndpointGroups)
    {
      self.connectedEndpointGroups = value
    }
    if let value = try container.decodeIfPresent(
      [InterceptDeploymentGroup.Deployment].self, forKey: .nestedDeployments)
    {
      self.nestedDeployments = value
    }
    if let value = try container.decodeIfPresent(
      InterceptDeploymentGroup.State.self, forKey: .state)
    {
      self.state = value
    }
    ...
    Sendable
  {
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(InterceptDeployment.State.self, forKey: .state) {
        self.state = value
      }
      for key in container.allKeys where !CodingKeys._knownKeys.contains(key.stringValue) {
        self._unknownFields.json[key.stringValue] = try container.decode(
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.InterceptDeploymentGroup"
  }
  public init(fromAny any: GoogleWKT.WKTAny) throws {
    self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
  }
