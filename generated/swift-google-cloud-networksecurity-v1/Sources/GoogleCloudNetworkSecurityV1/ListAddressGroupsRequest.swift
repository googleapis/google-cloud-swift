...
public struct ListAddressGroupsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListAddressGroupsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAddressGroupsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListAddressGroupsRequest"
  }
