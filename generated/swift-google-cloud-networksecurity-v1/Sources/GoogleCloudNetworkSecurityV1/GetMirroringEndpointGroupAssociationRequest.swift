...
public struct GetMirroringEndpointGroupAssociationRequest: Codable, Equatable, GoogleWKT
    ._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetMirroringEndpointGroupAssociationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetMirroringEndpointGroupAssociationRequest().with { $0.name = ... }
  /// ```
