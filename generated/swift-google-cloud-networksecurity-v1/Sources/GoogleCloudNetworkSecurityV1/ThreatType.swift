...
public enum ThreatType: Codable, Equatable, Hashable, Sendable {
  ...
  public var intValue: Int? {
    ...
    case .antivirus: return 3
    case .spyware: return 4
    case .dns: return 5
  ...
  public init(stringValue: Swift.String) {
    ...
    case "ANTIVIRUS": self = .antivirus
    case "SPYWARE": self = .spyware
    case "DNS": self = .dns
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    case .antivirus: return try container.encode("ANTIVIRUS")
    case .spyware: return try container.encode("SPYWARE")
