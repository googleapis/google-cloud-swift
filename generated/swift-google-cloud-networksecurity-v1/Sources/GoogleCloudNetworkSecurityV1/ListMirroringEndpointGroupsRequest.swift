...
public struct ListMirroringEndpointGroupsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListMirroringEndpointGroupsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMirroringEndpointGroupsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListMirroringEndpointGroupsRequest"
  }
