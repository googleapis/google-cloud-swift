...
public struct DeleteMirroringDeploymentGroupRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteMirroringDeploymentGroupRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteMirroringDeploymentGroupRequest().with { $0.name = ... }
  /// ```
