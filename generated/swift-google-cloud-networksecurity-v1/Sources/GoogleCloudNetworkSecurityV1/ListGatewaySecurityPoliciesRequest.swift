...
public struct ListGatewaySecurityPoliciesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListGatewaySecurityPoliciesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListGatewaySecurityPoliciesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListGatewaySecurityPoliciesRequest"
  }
