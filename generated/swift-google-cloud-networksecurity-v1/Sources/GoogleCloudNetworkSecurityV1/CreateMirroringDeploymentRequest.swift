...
public struct CreateMirroringDeploymentRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var mirroringDeploymentId: Swift.String = Swift.String()
  ...
  ///
  /// ```
  /// let value = CreateMirroringDeploymentRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.CreateMirroringDeploymentRequest"
  }
