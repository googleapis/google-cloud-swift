...
public struct ListDnsThreatDetectorsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDnsThreatDetectorsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDnsThreatDetectorsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListDnsThreatDetectorsRequest"
  }
