...
public struct ListTlsInspectionPoliciesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListTlsInspectionPoliciesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListTlsInspectionPoliciesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networksecurity.v1.ListTlsInspectionPoliciesRequest"
  }
