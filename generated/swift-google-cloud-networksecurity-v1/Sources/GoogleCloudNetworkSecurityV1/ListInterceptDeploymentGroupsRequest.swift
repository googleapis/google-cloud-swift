...
public struct ListInterceptDeploymentGroupsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListInterceptDeploymentGroupsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListInterceptDeploymentGroupsRequest().with { $0.parent = ... }
  /// ```
