...
public enum HttpAuthorizationHeader: Codable, Equatable, Hashable, Sendable {
  ...
  public var intValue: Int? {
    ...
    case .systemIdToken: return 1
    case .userIdToken: return 2
    case .`none`: return 3
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "HTTP_AUTHORIZATION_HEADER_UNSPECIFIED"
    case .systemIdToken: return "SYSTEM_ID_TOKEN"
    case .userIdToken: return "USER_ID_TOKEN"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:HttpAuthorizationHeader/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "HTTP_AUTHORIZATION_HEADER_UNSPECIFIED": self = .unspecified
    case "SYSTEM_ID_TOKEN": self = .systemIdToken
    case "USER_ID_TOKEN": self = .userIdToken
    case "NONE": self = .`none`
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:HttpAuthorizationHeader/unknownIntValue(_:)).
  public init(intValue: Int) {
    switch intValue {
    case 0: self = .unspecified
    case 1: self = .systemIdToken
    case 2: self = .userIdToken
    case 3: self = .`none`
