...
/// host app.
public struct MenuItemExtensionPoint: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = MenuItemExtensionPoint().with { $0.runFunction = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.apps.script.type.MenuItemExtensionPoint"
  }
