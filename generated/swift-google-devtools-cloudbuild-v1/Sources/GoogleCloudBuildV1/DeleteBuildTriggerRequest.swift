...
public struct DeleteBuildTriggerRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteBuildTriggerRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteBuildTriggerRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.devtools.cloudbuild.v1.DeleteBuildTriggerRequest"
  }
