...
public struct StorageSource: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public enum SourceFetcher: Codable, Equatable, Sendable {
    ...
    public var intValue: Int? {
      ...
      case .gsutil: return 1
      case .gcsFetcher: return 2
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "SOURCE_FETCHER_UNSPECIFIED"
      case .gsutil: return "GSUTIL"
      case .gcsFetcher: return "GCS_FETCHER"
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:SourceFetcher/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "SOURCE_FETCHER_UNSPECIFIED": self = .unspecified
      case "GSUTIL": self = .gsutil
      case "GCS_FETCHER": self = .gcsFetcher
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:SourceFetcher/unknownIntValue(_:)).
    public init(intValue: Int) {
      switch intValue {
      case 0: self = .unspecified
      case 1: self = .gsutil
      case 2: self = .gcsFetcher
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.devtools.cloudbuild.v1.StorageSource"
  }
