...
public struct GetBuildTriggerRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetBuildTriggerRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetBuildTriggerRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.devtools.cloudbuild.v1.GetBuildTriggerRequest"
  }
