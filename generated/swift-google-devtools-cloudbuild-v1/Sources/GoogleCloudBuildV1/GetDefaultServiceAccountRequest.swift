  ...
  Sendable
{
  ...
  /// Initialize a new instance of `GetDefaultServiceAccountRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetDefaultServiceAccountRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.devtools.cloudbuild.v1.GetDefaultServiceAccountRequest"
  }
