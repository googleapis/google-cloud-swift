...
public struct TimeSpan: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Start of time span.
  ...
  /// Initialize a new instance of `TimeSpan`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = TimeSpan().with { $0.startTime = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.devtools.cloudbuild.v1.TimeSpan"
  }
