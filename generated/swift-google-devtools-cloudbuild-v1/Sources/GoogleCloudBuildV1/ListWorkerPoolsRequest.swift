...
public struct ListWorkerPoolsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListWorkerPoolsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListWorkerPoolsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.devtools.cloudbuild.v1.ListWorkerPoolsRequest"
  }
