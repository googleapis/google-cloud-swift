  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ConnectedRepository`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ConnectedRepository().with { $0.repository = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.devtools.cloudbuild.v1.ConnectedRepository"
  }
