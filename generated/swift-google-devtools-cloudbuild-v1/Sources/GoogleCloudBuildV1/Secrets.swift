...
public struct Secrets: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Secrets in Secret Manager and associated secret environment variable.
  public var secretManager: [SecretManagerSecret] = []
  ...
  ///
  /// ```
  /// let value = Secrets().with { $0.secretManager = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.devtools.cloudbuild.v1.Secrets"
  }
