...
/// directive.
public struct UploadedNpmPackage: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UploadedNpmPackage`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UploadedNpmPackage().with { $0.uri = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.devtools.cloudbuild.v1.UploadedNpmPackage"
  }
