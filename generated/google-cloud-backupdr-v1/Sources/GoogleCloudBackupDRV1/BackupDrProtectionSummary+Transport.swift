...
extension Clients {
  class BackupDrProtectionSummaryTransport: BackupDrProtectionSummaryStub {
    ...
    public func listResourceBackupConfigs(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/resourceBackupConfigs"
      }()
      var query = [
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudBackupDRV1.ListResourceBackupConfigsResponse.self, from: data)
    }
