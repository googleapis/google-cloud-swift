...
public struct ListDiscoveredServicesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDiscoveredServicesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDiscoveredServicesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apphub.v1.ListDiscoveredServicesRequest"
  }
