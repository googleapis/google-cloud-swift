...
{
  /// Required. Scope Type.
  public var type: Scope.Type_ = Scope.Type_()
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Scope.Type_.self, forKey: .type) {
      self.type = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apphub.v1.Scope"
  }
