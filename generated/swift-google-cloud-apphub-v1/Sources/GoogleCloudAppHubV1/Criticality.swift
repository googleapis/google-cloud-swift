...
public struct Criticality: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Required. Criticality Type.
  public var type: Criticality.Type_ = Criticality.Type_()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `Criticality`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = Criticality().with { $0.type = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Criticality.Type_.self, forKey: .type) {
      self.type = value
    }
  ...
  public enum Type_: Codable, Equatable, Sendable {
    ...
    public init(stringValue: Swift.String) {
      ...
      case "MISSION_CRITICAL": self = .missionCritical
      case "HIGH": self = .high
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apphub.v1.Criticality"
  }
