...
public struct ListServiceProjectAttachmentsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListServiceProjectAttachmentsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListServiceProjectAttachmentsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apphub.v1.ListServiceProjectAttachmentsRequest"
  }
