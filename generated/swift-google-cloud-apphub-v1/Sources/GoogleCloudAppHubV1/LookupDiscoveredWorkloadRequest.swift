  ...
  Sendable
{
  ...
  /// Initialize a new instance of `LookupDiscoveredWorkloadRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = LookupDiscoveredWorkloadRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apphub.v1.LookupDiscoveredWorkloadRequest"
  }
