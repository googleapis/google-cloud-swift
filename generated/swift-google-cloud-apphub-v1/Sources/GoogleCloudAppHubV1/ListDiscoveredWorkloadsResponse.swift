  ...
  Sendable
{
  ...
  public var discoveredWorkloads: [DiscoveredWorkload] = []
  ...
  /// Initialize a new instance of `ListDiscoveredWorkloadsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDiscoveredWorkloadsResponse().with { $0.discoveredWorkloads = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let discoveredWorkloads = CodingKeys(stringValue: "discoveredWorkloads")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [DiscoveredWorkload].self, forKey: .discoveredWorkloads)
    {
      self.discoveredWorkloads = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.discoveredWorkloads, forKey: .discoveredWorkloads)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apphub.v1.ListDiscoveredWorkloadsResponse"
  }
