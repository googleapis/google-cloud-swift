...
public struct ListDiscoveredWorkloadsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDiscoveredWorkloadsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDiscoveredWorkloadsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apphub.v1.ListDiscoveredWorkloadsRequest"
  }
