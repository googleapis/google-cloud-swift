  ...
  Sendable
{
  ...
  public var discoveredWorkload: Swift.String = Swift.String()
  ...
  public var state: Workload.State = Workload.State()
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .discoveredWorkload) {
      self.discoveredWorkload = value
    }
    ...
    if let value = try container.decodeIfPresent(Workload.State.self, forKey: .state) {
      self.state = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.discoveredWorkload, forKey: .discoveredWorkload)
