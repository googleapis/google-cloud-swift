...
public struct LookupDiscoveredServiceRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `LookupDiscoveredServiceRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = LookupDiscoveredServiceRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apphub.v1.LookupDiscoveredServiceRequest"
  }
