...
extension Clients {
  final class ParallelstoreRetry: ParallelstoreStub {
    let inner: any ParallelstoreStub
    let options: GoogleCloudGax.ClientOptions

    public init(_ inner: any ParallelstoreStub, options: GoogleCloudGax.ClientOptions) {
      self.inner = inner
