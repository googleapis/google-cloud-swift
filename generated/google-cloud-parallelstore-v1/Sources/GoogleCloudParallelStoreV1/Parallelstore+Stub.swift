...
extension Clients {
  ...
  class ParallelstoreTransport: ParallelstoreStub {
    let inner: GoogleCloudGax.HTTPClient

    public init(_ options: GoogleCloudGax.ClientOptions = .init()) throws {
      self.inner = try GoogleCloudGax.HTTPClient(
        from: options, withDefaultEndpoint: "https://parallelstore.googleapis.com")
    }
    ...
    public func listInstances(
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudParallelStoreV1.ListInstancesResponse.self, from: data)
    }
    ...
    public func getInstance(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudParallelStoreV1.Instance.self, from: data)
    }
    ...
    public func importData(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0):importData"
      }()
      let query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
    ...
    public func exportData(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0):exportData"
      }()
      let query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
