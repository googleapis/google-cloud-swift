...
public enum FileStripeLevel: Codable, Equatable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "FILE_STRIPE_LEVEL_UNSPECIFIED"
    case .min: return "FILE_STRIPE_LEVEL_MIN"
    case .balanced: return "FILE_STRIPE_LEVEL_BALANCED"
    case .max: return "FILE_STRIPE_LEVEL_MAX"
  ...
  public init(stringValue: Swift.String) {
    ...
    case "FILE_STRIPE_LEVEL_MIN": self = .min
    case "FILE_STRIPE_LEVEL_BALANCED": self = .balanced
    case "FILE_STRIPE_LEVEL_MAX": self = .max
