...
///
/// @Snippet(path: "ParallelstoreQuickstart")
public class ParallelstoreClient: Clients.ParallelstoreProtocol {
  let inner: any Clients.ParallelstoreStub
  let pollingErrorPolicy: GoogleCloudGax.PollingErrorPolicy
  let pollingBackoffPolicy: GoogleCloudGax.BackoffPolicy

  /// Creates a new `ParallelstoreClient` instance.
  public init(_ options: GoogleCloudGax.ClientOptions = .init()) throws {
    var inner: any Clients.ParallelstoreStub = try Clients.ParallelstoreTransport(options)
    inner = Clients.ParallelstoreRetry(inner, options: options)
    if let logger = options.logger {
      inner = Clients.ParallelstoreLogging(inner, logger: logger)
    }
    self.inner = inner
  ...
  ///
  /// @Snippet(path: "Parallelstore_ListInstances")
  public func listInstances(
    request: ListInstancesRequest, options: GoogleCloudGax.RequestOptions
  ) async throws -> GoogleCloudParallelStoreV1.ListInstancesResponse {
  ...
  public func listInstances(
    ...
    let listRpc = {
      (token: Swift.String) async throws -> GoogleCloudParallelStoreV1.ListInstancesResponse in
      var request = byItem
  ...
  ///
  /// @Snippet(path: "Parallelstore_GetInstance")
  ...
  ///
  /// @Snippet(path: "Parallelstore_ListLocations")
  ...
  ///
  /// @Snippet(path: "Parallelstore_GetLocation")
...
extension Clients {
  /// A Swift protocol to mock `ParallelstoreClient`.
  ///
  /// To mock `ParallelstoreClient` change your functions to receive
  /// `some ParallelstoreProtocol` or `any ParallelstoreProtocol`
  /// and pass a mock implementation in your tests.
  public protocol ParallelstoreProtocol {
    /// See `ParallelstoreClient.listInstances`.
    func listInstances(request: ListInstancesRequest) async throws
      -> GoogleCloudParallelStoreV1.ListInstancesResponse
    ...
    /// See `ParallelstoreClient.getInstance`.
    func getInstance(request: GetInstanceRequest) async throws
      -> GoogleCloudParallelStoreV1.Instance
    ...
    /// See `ParallelstoreClient.listLocations`.
    ...
    /// See `ParallelstoreClient.getLocation`.
...
extension Clients.ParallelstoreProtocol {
