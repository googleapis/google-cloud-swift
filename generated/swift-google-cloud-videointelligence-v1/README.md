# Google Cloud Client Libraries for Swift - Cloud Video Intelligence API
...
Add `swift-google-cloud-videointelligence-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-videointelligence-v1.git --from 0.3.0
```

Then add `GoogleCloudVideoIntelligenceV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudVideoIntelligenceV1 <target-name> --package swift-google-cloud-videointelligence-v1
```
