...
public struct AnnotateVideoProgress: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = AnnotateVideoProgress().with { $0.annotationProgress = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.videointelligence.v1.AnnotateVideoProgress"
  }
