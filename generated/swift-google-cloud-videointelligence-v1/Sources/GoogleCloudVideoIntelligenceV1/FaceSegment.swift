...
public struct FaceSegment: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `FaceSegment`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FaceSegment().with { $0.segment = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.videointelligence.v1.FaceSegment"
  }
