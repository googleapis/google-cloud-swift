...
public struct DetectedAttribute: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DetectedAttribute`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DetectedAttribute().with { $0.name = ... }
  /// ```
