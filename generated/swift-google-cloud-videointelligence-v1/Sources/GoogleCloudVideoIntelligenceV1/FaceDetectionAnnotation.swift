...
public struct FaceDetectionAnnotation: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var thumbnail: Foundation.Data = Foundation.Data()
  ...
  /// Initialize a new instance of `FaceDetectionAnnotation`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FaceDetectionAnnotation().with { $0.tracks = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.videointelligence.v1.FaceDetectionAnnotation"
  }
