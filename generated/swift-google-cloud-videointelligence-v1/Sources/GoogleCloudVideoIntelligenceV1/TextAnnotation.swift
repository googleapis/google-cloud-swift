  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = TextAnnotation().with { $0.text = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([TextSegment].self, forKey: .segments) {
      self.segments = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.videointelligence.v1.TextAnnotation"
  }
