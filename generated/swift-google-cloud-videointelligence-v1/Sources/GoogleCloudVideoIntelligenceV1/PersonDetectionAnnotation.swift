...
public struct PersonDetectionAnnotation: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `PersonDetectionAnnotation`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = PersonDetectionAnnotation().with { $0.tracks = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.videointelligence.v1.PersonDetectionAnnotation"
  }
