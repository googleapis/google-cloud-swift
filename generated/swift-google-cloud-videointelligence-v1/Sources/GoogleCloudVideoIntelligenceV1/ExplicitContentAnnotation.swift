  ...
  Sendable
{
  ...
  public var frames: [ExplicitContentFrame] = []
  ...
  ///
  /// ```
  /// let value = ExplicitContentAnnotation().with { $0.frames = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([ExplicitContentFrame].self, forKey: .frames) {
      self.frames = value
    }
