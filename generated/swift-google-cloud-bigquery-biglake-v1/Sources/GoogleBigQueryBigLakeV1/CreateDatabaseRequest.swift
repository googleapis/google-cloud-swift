...
public struct CreateDatabaseRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CreateDatabaseRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateDatabaseRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.biglake.v1.CreateDatabaseRequest"
  }
