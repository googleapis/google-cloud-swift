...
public struct ListTablesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var view: TableView = TableView()
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(TableView.self, forKey: .view) {
      self.view = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.biglake.v1.ListTablesRequest"
  }
