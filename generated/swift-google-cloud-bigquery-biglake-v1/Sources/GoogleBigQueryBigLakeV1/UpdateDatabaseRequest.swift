...
public struct UpdateDatabaseRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateDatabaseRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateDatabaseRequest().with { $0.database = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.biglake.v1.UpdateDatabaseRequest"
  }
