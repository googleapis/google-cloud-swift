  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let mentions = CodingKeys(stringValue: "mentions")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([EntityMention].self, forKey: .mentions) {
      self.mentions = value
    }
  ...
  public enum Type_: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .location: return try container.encode("LOCATION")
      case .organization: return try container.encode("ORGANIZATION")
      case .event: return try container.encode("EVENT")
      case .workOfArt: return try container.encode("WORK_OF_ART")
      case .consumerGood: return try container.encode("CONSUMER_GOOD")
      case .other: return try container.encode("OTHER")
      case .phoneNumber: return try container.encode("PHONE_NUMBER")
      case .address: return try container.encode("ADDRESS")
      case .date: return try container.encode("DATE")
      case .number: return try container.encode("NUMBER")
      case .price: return try container.encode("PRICE")
