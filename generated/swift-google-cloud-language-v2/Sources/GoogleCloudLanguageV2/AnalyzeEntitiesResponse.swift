...
public struct AnalyzeEntitiesResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `AnalyzeEntitiesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AnalyzeEntitiesResponse().with { $0.entities = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.language.v2.AnalyzeEntitiesResponse"
  }
