...
public struct ClassifyTextResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ClassifyTextResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ClassifyTextResponse().with { $0.categories = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.language.v2.ClassifyTextResponse"
  }
