...
public struct AnalyzeSentimentRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = AnalyzeSentimentRequest().with { $0.document = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.language.v2.AnalyzeSentimentRequest"
  }
