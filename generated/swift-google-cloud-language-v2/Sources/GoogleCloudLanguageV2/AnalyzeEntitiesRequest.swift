...
public struct AnalyzeEntitiesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `AnalyzeEntitiesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AnalyzeEntitiesRequest().with { $0.document = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.language.v2.AnalyzeEntitiesRequest"
  }
