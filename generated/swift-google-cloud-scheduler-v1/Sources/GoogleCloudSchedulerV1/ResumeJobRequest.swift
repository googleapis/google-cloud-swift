...
public struct ResumeJobRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ResumeJobRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ResumeJobRequest().with { $0.name = ... }
  /// ```
