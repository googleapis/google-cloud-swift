  ...
  Sendable
{
  ...
  /// ONTAP.
  public var peeringCommandExpiryTime: GoogleWKT.WKTTimestamp? = nil
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.peeringCommandExpiryTime = try container.decodeIfPresent(
      GoogleWKT.WKTTimestamp.self, forKey: .peeringCommandExpiryTime)
  ...
  ///   them to named cases.
  public enum CacheState: Codable, Equatable, Hashable, Sendable {
