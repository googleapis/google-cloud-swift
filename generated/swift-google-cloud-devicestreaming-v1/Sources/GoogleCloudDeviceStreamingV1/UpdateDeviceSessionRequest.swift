...
public struct UpdateDeviceSessionRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Required. DeviceSession to update.
  /// The DeviceSession's `name` field is used to identify the session to update
  /// "projects/{project_id}/deviceSessions/{session_id}"
  public var deviceSession: DeviceSession? = nil
  ...
  /// Initialize a new instance of `UpdateDeviceSessionRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateDeviceSessionRequest().with { $0.deviceSession = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.devicestreaming.v1.UpdateDeviceSessionRequest"
  }
