...
public struct Open: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `Open`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = Open().with { $0.streamId = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.devicestreaming.v1.Open"
  }
