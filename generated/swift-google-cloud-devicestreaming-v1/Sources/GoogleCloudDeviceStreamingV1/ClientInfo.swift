...
public struct ClientInfo: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ClientInfo`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ClientInfo().with { $0.client = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.devicestreaming.v1.ClientInfo"
  }
