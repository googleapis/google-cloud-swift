...
public struct StatusUpdate: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The device's state
  ...
  ///   them to named cases.
  public enum DeviceState: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("DEVICE_STATE_UNSPECIFIED")
      case .device: return try container.encode("DEVICE")
      case .recovery: return try container.encode("RECOVERY")
      case .rescue: return try container.encode("RESCUE")
      case .sideload: return try container.encode("SIDELOAD")
      ...
      case .connecting: return try container.encode("CONNECTING")
