...
public struct ClusterMaintenanceSchedule: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ClusterMaintenanceSchedule`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ClusterMaintenanceSchedule().with { $0.startTime = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.redis.cluster.v1.ClusterMaintenanceSchedule"
  }
