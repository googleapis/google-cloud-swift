...
public struct ClusterEndpoint: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// A group of PSC connections. They are created in the same VPC network, one
  /// for each service attachment in the cluster.
  public var connections: [ConnectionDetail] = []

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `ClusterEndpoint`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ClusterEndpoint().with { $0.connections = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([ConnectionDetail].self, forKey: .connections) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.redis.cluster.v1.ClusterEndpoint"
  }
