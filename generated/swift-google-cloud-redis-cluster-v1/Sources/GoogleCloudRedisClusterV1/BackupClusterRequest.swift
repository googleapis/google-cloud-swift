...
public struct BackupClusterRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `BackupClusterRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = BackupClusterRequest().with { $0.name = ... }
  /// ```
