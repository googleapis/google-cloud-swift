  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = ZoneDistributionConfig().with { $0.mode = ... }
  /// ```
  ...
  ///   them to named cases.
  public enum ZoneDistributionMode: Codable, Equatable, Hashable, Sendable {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.redis.cluster.v1.ZoneDistributionConfig"
  }
