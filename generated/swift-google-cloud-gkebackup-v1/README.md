# Google Cloud Client Libraries for Swift - Backup for GKE API
...
Add `swift-google-cloud-gkebackup-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-gkebackup-v1.git --from 0.0.0-preview
```

Then add `GoogleCloudGKEBackupV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudGKEBackupV1 <target-name> --package swift-google-cloud-gkebackup-v1
```
