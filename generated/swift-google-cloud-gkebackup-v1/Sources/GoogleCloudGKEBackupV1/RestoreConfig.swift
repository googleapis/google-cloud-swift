  ...
  Sendable
{
  ...
  /// is not empty.
  ///
  /// [google.cloud.gkebackup.v1.RestoreConfig.cluster_resource_restore_scope]: <doc:RestoreConfig/clusterResourceRestoreScope>
  ...
  public var volumeDataRestorePolicyBindings: [RestoreConfig.VolumeDataRestorePolicyBinding] = []

  /// Optional. RestoreOrder contains custom ordering to use on a Restore.
  public var restoreOrder: RestoreConfig.RestoreOrder? = nil
  ...
  public struct VolumeDataRestorePolicyBinding: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = VolumeDataRestorePolicyBinding().with { $0.policy = ... }
    /// ```
    public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
      var copy = self
      try config(&copy)
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let volumeType = try container.decodeIfPresent(
        VolumeTypeEnum.VolumeType.self, forKey: .volumeType)
      {
  ...
  public struct RestoreOrder: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = RestoreOrder().with { $0.groupKindDependencies = ... }
    /// ```
    public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
      var copy = self
      try config(&copy)
    ...
    public struct GroupKindDependency: Codable, Equatable, GoogleWKT._AnyPackable,
      Sendable
    {
      /// Required. The satisfying group kind must be restored first
      /// in order to satisfy the dependency.
      public var satisfying: RestoreConfig.GroupKind? = nil
      ...
      ///
      /// ```
      /// let value = GroupKindDependency().with { $0.satisfying = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
