...
public struct ListBackupPlansResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// The list of BackupPlans matching the given criteria.
  public var backupPlans: [BackupPlan] = []
  ...
  /// to return.
  ///
  /// [google.cloud.gkebackup.v1.ListBackupPlansRequest.page_token]: <doc:ListBackupPlansRequest/pageToken>
  ...
  /// Initialize a new instance of `ListBackupPlansResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListBackupPlansResponse().with { $0.backupPlans = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let backupPlans = CodingKeys(stringValue: "backupPlans")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([BackupPlan].self, forKey: .backupPlans) {
      self.backupPlans = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.backupPlans, forKey: .backupPlans)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkebackup.v1.ListBackupPlansResponse"
  }
