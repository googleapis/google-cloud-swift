...
public struct ListRestoresRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// [google.cloud.gkebackup.v1.ListRestoresResponse.next_page_token]: <doc:ListRestoresResponse/nextPageToken>
  ...
  /// Initialize a new instance of `ListRestoresRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListRestoresRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkebackup.v1.ListRestoresRequest"
  }
