...
public struct ListRestorePlansResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// The list of RestorePlans matching the given criteria.
  public var restorePlans: [RestorePlan] = []
  ...
  /// to return.
  ///
  /// [google.cloud.gkebackup.v1.ListRestorePlansRequest.page_token]: <doc:ListRestorePlansRequest/pageToken>
  ...
  /// Initialize a new instance of `ListRestorePlansResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListRestorePlansResponse().with { $0.restorePlans = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let restorePlans = CodingKeys(stringValue: "restorePlans")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([RestorePlan].self, forKey: .restorePlans) {
      self.restorePlans = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.restorePlans, forKey: .restorePlans)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkebackup.v1.ListRestorePlansResponse"
  }
