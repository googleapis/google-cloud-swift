  ...
  Sendable
{
  ...
  public enum VolumeBackupFormat: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("VOLUME_BACKUP_FORMAT_UNSPECIFIED")
  ...
  public enum State: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .snapshotting: return try container.encode("SNAPSHOTTING")
      ...
      case .cleanedUp: return try container.encode("CLEANED_UP")
      case .unknownIntValue(let v): return try container.encode(v)
      case .unknownStringValue(let v): return try container.encode(v)
      }
    }
