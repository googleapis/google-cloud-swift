...
public struct DeleteRestoreRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// [google.cloud.gkebackup.v1.Restore.etag]: <doc:Restore/etag>
  ...
  /// Initialize a new instance of `DeleteRestoreRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteRestoreRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkebackup.v1.DeleteRestoreRequest"
  }
