  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let groupKind = CodingKeys(stringValue: "groupKind")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.groupKind = try container.decodeIfPresent(RestoreConfig.GroupKind.self, forKey: .groupKind)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.groupKind, forKey: .groupKind)
