...
public struct ListRestoresResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// [google.cloud.gkebackup.v1.ListRestoresRequest.page_token]: <doc:ListRestoresRequest/pageToken>
  ...
  /// Initialize a new instance of `ListRestoresResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListRestoresResponse().with { $0.restores = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkebackup.v1.ListRestoresResponse"
  }
...
extension ListRestoresResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Restore] {
