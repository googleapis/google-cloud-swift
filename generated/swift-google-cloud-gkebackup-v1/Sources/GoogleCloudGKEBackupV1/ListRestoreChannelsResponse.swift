...
public struct ListRestoreChannelsResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// The list of RestoreChannels matching the given criteria.
  public var restoreChannels: [RestoreChannel] = []
  ...
  /// to return.
  ///
  /// [google.cloud.gkebackup.v1.ListRestoreChannelsRequest.page_token]: <doc:ListRestoreChannelsRequest/pageToken>
  ...
  /// Initialize a new instance of `ListRestoreChannelsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListRestoreChannelsResponse().with { $0.restoreChannels = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let restoreChannels = CodingKeys(stringValue: "restoreChannels")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([RestoreChannel].self, forKey: .restoreChannels) {
      self.restoreChannels = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.restoreChannels, forKey: .restoreChannels)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkebackup.v1.ListRestoreChannelsResponse"
  }
