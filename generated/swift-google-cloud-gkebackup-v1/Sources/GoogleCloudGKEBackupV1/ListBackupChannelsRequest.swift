...
public struct ListBackupChannelsRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// [google.cloud.gkebackup.v1.ListBackupChannelsResponse.next_page_token]: <doc:ListBackupChannelsResponse/nextPageToken>
  ...
  /// Initialize a new instance of `ListBackupChannelsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListBackupChannelsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkebackup.v1.ListBackupChannelsRequest"
  }
