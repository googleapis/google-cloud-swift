...
public struct ListRestorePlanBindingsRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// [google.cloud.gkebackup.v1.ListRestorePlanBindingsResponse.next_page_token]: <doc:ListRestorePlanBindingsResponse/nextPageToken>
  ...
  /// Initialize a new instance of `ListRestorePlanBindingsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListRestorePlanBindingsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkebackup.v1.ListRestorePlanBindingsRequest"
  }
