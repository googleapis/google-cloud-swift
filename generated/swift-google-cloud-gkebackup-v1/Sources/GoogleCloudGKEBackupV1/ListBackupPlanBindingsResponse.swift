...
public struct ListBackupPlanBindingsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The list of BackupPlanBindings matching the given criteria.
  public var backupPlanBindings: [BackupPlanBinding] = []
  ...
  /// to return.
  ///
  /// [google.cloud.gkebackup.v1.ListBackupPlanBindingsRequest.page_token]: <doc:ListBackupPlanBindingsRequest/pageToken>
  ...
  /// Initialize a new instance of `ListBackupPlanBindingsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListBackupPlanBindingsResponse().with { $0.backupPlanBindings = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let backupPlanBindings = CodingKeys(stringValue: "backupPlanBindings")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkebackup.v1.ListBackupPlanBindingsResponse"
  }
...
extension ListBackupPlanBindingsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [BackupPlanBinding] {
    return self.backupPlanBindings
  }
