...
public struct ListVolumeRestoresRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// [google.cloud.gkebackup.v1.ListVolumeRestoresResponse.next_page_token]: <doc:ListVolumeRestoresResponse/nextPageToken>
  ...
  /// Initialize a new instance of `ListVolumeRestoresRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListVolumeRestoresRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkebackup.v1.ListVolumeRestoresRequest"
  }
