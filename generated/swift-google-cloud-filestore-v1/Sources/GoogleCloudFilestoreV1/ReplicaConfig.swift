...
public struct ReplicaConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public enum State: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .removing: return try container.encode("REMOVING")
  ...
  public enum StateReason: Codable, Equatable, Sendable {
    ...
    public var intValue: Int? {
      switch self {
      case .unspecified: return 0
      case .peerInstanceUnreachable: return 1
      case .removeFailed: return 2
      case .unknownIntValue(let v): return v
      case .unknownStringValue: return nil
      }
    }
    ...
    /// Initialize from a string value.
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:StateReason/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "STATE_REASON_UNSPECIFIED": self = .unspecified
      case "PEER_INSTANCE_UNREACHABLE": self = .peerInstanceUnreachable
      case "REMOVE_FAILED": self = .removeFailed
      default: self = .unknownStringValue(stringValue)
      }
    }
    ...
    /// Initialize from an integer value.
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:StateReason/unknownIntValue(_:)).
    public init(intValue: Int) {
      switch intValue {
      case 0: self = .unspecified
      case 1: self = .peerInstanceUnreachable
      case 2: self = .removeFailed
      default: self = .unknownIntValue(intValue)
      }
    }
    ...
    public func encode(to encoder: Encoder) throws {
      var container = encoder.singleValueContainer()
      switch self {
      case .unspecified: return try container.encode("STATE_REASON_UNSPECIFIED")
      case .peerInstanceUnreachable: return try container.encode("PEER_INSTANCE_UNREACHABLE")
      case .removeFailed: return try container.encode("REMOVE_FAILED")
      case .unknownIntValue(let v): return try container.encode(v)
      case .unknownStringValue(let v): return try container.encode(v)
      }
    }
