  ...
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Replication.Role.self, forKey: .role) {
      self.role = value
    }
    if let value = try container.decodeIfPresent([ReplicaConfig].self, forKey: .replicas) {
      self.replicas = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.filestore.v1.Replication"
  }
