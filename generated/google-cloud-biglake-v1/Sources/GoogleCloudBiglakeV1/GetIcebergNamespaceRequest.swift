...
public struct GetIcebergNamespaceRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = GetIcebergNamespaceRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.biglake.v1.GetIcebergNamespaceRequest"
  }
