...
public struct ListIcebergTableIdentifiersResponse: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  /// Output only. The list of table identifiers.
  public var identifiers: [TableIdentifier] = []
  ...
  ///
  /// ```
  /// let value = ListIcebergTableIdentifiersResponse().with { $0.identifiers = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.biglake.v1.ListIcebergTableIdentifiersResponse"
  }
