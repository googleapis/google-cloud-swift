  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let subjectPrefix = CodingKeys(stringValue: "subjectPrefix")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.subjectPrefix = try container.decodeIfPresent(Swift.String.self, forKey: .subjectPrefix)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.subjectPrefix, forKey: .subjectPrefix)
