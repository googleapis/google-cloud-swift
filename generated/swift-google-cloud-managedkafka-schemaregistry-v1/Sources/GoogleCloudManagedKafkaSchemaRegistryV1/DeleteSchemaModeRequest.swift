...
public struct DeleteSchemaModeRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteSchemaModeRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteSchemaModeRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.managedkafka.schemaregistry.v1.DeleteSchemaModeRequest"
  }
