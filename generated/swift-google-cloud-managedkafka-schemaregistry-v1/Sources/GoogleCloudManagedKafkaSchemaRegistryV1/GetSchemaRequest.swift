...
public struct GetSchemaRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetSchemaRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetSchemaRequest().with { $0.name = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.subject = try container.decodeIfPresent(Swift.String.self, forKey: .subject)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.managedkafka.schemaregistry.v1.GetSchemaRequest"
  }
