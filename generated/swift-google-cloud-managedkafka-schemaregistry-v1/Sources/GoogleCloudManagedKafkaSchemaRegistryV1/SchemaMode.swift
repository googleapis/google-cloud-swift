...
public struct SchemaMode: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(SchemaMode.ModeType.self, forKey: .mode) {
      self.mode = value
    }
  ...
  ///   them to named cases.
  public enum ModeType: Codable, Equatable, Hashable, Sendable {
