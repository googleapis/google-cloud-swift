...
public struct UpdateSchemaModeRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateSchemaModeRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateSchemaModeRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.managedkafka.schemaregistry.v1.UpdateSchemaModeRequest"
  }
