...
public struct GetSchemaModeRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetSchemaModeRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetSchemaModeRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.managedkafka.schemaregistry.v1.GetSchemaModeRequest"
  }
