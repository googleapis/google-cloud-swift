...
public struct DeleteSchemaRegistryRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteSchemaRegistryRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteSchemaRegistryRequest().with { $0.name = ... }
  /// ```
