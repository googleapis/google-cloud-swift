...
public struct ListReferencedSchemasRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListReferencedSchemasRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListReferencedSchemasRequest().with { $0.parent = ... }
  /// ```
