...
public struct ImageObjectDetectionPredictionParams: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ImageObjectDetectionPredictionParams`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ImageObjectDetectionPredictionParams().with { $0.confidenceThreshold = ... }
  /// ```
