...
public struct VideoActionRecognitionPredictionParams: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `VideoActionRecognitionPredictionParams`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = VideoActionRecognitionPredictionParams().with { $0.confidenceThreshold = ... }
  /// ```
