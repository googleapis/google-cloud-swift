...
public struct ListGrantsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The list of grants.
  ...
  /// Initialize a new instance of `ListGrantsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListGrantsResponse().with { $0.grants = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.privilegedaccessmanager.v1.ListGrantsResponse"
  }
...
extension ListGrantsResponse: GoogleGax._PaginatedResponse {
