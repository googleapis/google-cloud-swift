...
///   them to named cases.
public enum DomainNotice: Codable, Equatable, Hashable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "DOMAIN_NOTICE_UNSPECIFIED"
    case .hstsPreloaded: return "HSTS_PRELOADED"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:DomainNotice/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "DOMAIN_NOTICE_UNSPECIFIED": self = .unspecified
    case "HSTS_PRELOADED": self = .hstsPreloaded
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:DomainNotice/unknownIntValue(_:)).
