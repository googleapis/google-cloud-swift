...
public struct RetrieveRegisterParametersResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = RetrieveRegisterParametersResponse().with { $0.registerParameters = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.domains.v1.RetrieveRegisterParametersResponse"
  }
