...
public struct UpdateRegistrationRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateRegistrationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateRegistrationRequest().with { $0.registration = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.domains.v1.UpdateRegistrationRequest"
  }
