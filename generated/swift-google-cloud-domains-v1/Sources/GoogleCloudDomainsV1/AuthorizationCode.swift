...
public struct AuthorizationCode: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `AuthorizationCode`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AuthorizationCode().with { $0.code = ... }
  /// ```
