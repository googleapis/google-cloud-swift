...
public struct RetrieveRegisterParametersRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `RetrieveRegisterParametersRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RetrieveRegisterParametersRequest().with { $0.domainName = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.domains.v1.RetrieveRegisterParametersRequest"
  }
