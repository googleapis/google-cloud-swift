...
public struct RetrieveTransferParametersRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `RetrieveTransferParametersRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RetrieveTransferParametersRequest().with { $0.domainName = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.domains.v1.RetrieveTransferParametersRequest"
  }
