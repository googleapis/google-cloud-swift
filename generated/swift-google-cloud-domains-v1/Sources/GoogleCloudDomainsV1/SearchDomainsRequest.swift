...
public struct SearchDomainsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SearchDomainsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SearchDomainsRequest().with { $0.query = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.domains.v1.SearchDomainsRequest"
  }
