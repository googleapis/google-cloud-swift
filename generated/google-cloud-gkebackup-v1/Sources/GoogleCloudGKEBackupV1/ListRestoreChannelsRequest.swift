...
public struct ListRestoreChannelsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  ///
  /// [google.cloud.gkebackup.v1.ListRestoreChannelsResponse.next_page_token]: <doc:ListRestoreChannelsResponse/nextPageToken>
  ...
  /// Initialize a new instance of `ListRestoreChannelsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListRestoreChannelsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkebackup.v1.ListRestoreChannelsRequest"
  }
