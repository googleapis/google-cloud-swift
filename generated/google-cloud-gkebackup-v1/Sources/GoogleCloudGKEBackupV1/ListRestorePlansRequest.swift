...
public struct ListRestorePlansRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  ///
  /// [google.cloud.gkebackup.v1.ListRestorePlansResponse.next_page_token]: <doc:ListRestorePlansResponse/nextPageToken>
  ...
  /// Initialize a new instance of `ListRestorePlansRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListRestorePlansRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkebackup.v1.ListRestorePlansRequest"
  }
