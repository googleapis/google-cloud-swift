...
/// and thresholds.
public struct NotificationsRule: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let monitoringNotificationChannels = CodingKeys(
      stringValue: "monitoringNotificationChannels")
    static let disableDefaultIamRecipients = CodingKeys(stringValue: "disableDefaultIamRecipients")
    static let enableProjectLevelRecipients = CodingKeys(
      stringValue: "enableProjectLevelRecipients")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [Swift.String].self, forKey: .monitoringNotificationChannels)
    {
      self.monitoringNotificationChannels = value
    }
    if let value = try container.decodeIfPresent(
      Swift.Bool.self, forKey: .disableDefaultIamRecipients)
    {
      self.disableDefaultIamRecipients = value
    }
    if let value = try container.decodeIfPresent(
      Swift.Bool.self, forKey: .enableProjectLevelRecipients)
    {
      self.enableProjectLevelRecipients = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(
      self.monitoringNotificationChannels, forKey: .monitoringNotificationChannels)
    try container.encode(self.disableDefaultIamRecipients, forKey: .disableDefaultIamRecipients)
    try container.encode(self.enableProjectLevelRecipients, forKey: .enableProjectLevelRecipients)
