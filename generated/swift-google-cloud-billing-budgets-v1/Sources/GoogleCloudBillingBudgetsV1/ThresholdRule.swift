...
public struct ThresholdRule: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let spendBasis = CodingKeys(stringValue: "spendBasis")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(ThresholdRule.Basis.self, forKey: .spendBasis) {
      self.spendBasis = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.spendBasis, forKey: .spendBasis)
  ...
  public enum Basis: Codable, Equatable, Sendable {
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:Basis/unknownStringValue(_:)).
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:Basis/unknownIntValue(_:)).
