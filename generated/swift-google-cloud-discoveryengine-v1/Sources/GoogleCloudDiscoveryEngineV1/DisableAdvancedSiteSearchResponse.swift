...
// limitations under the License.
  ...
  public struct DisableAdvancedSiteSearchResponse: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `DisableAdvancedSiteSearchResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DisableAdvancedSiteSearchResponse().with { $0.<placeholder> = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.DisableAdvancedSiteSearchResponse"
    }
