...
// limitations under the License.
  ...
  public struct CloudSqlSource: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(Swift.Bool.self, forKey: .offload) {
        self.offload = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.offload, forKey: .offload)
