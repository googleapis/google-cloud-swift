...
// limitations under the License.
  ...
  public struct IdentityMappingEntryOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `IdentityMappingEntryOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = IdentityMappingEntryOperationMetadata().with { $0.successCount = ... }
    /// ```
