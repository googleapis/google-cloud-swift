...
// limitations under the License.
  ...
  public struct CreateSitemapRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `CreateSitemapRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = CreateSitemapRequest().with { $0.parent = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.CreateSitemapRequest"
    }
