...
// limitations under the License.
  ...
  public struct BatchCreateTargetSiteMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `BatchCreateTargetSiteMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = BatchCreateTargetSiteMetadata().with { $0.createTime = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.BatchCreateTargetSiteMetadata"
    }
