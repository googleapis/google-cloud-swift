...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `PurgeErrorConfig`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = PurgeErrorConfig().with { $0.gcsPrefix = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.PurgeErrorConfig"
    }
