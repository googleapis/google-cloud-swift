...
// limitations under the License.
  ...
  public struct BatchUpdateUserLicensesMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `BatchUpdateUserLicensesMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = BatchUpdateUserLicensesMetadata().with { $0.createTime = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.BatchUpdateUserLicensesMetadata"
    }
