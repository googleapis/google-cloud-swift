...
// limitations under the License.
  ...
  public struct SingleRegionKey: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `SingleRegionKey`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SingleRegionKey().with { $0.kmsKey = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.SingleRegionKey"
    }
