...
// limitations under the License.
  ...
  extension Clients.EngineServiceProtocol {
    ...
    ) -> any AsyncSequence<Engine, Swift.Error> & Sendable {
    ...
    public func listEnginesByItems(
      ...
      return self.listEnginesByItems(request: request)
    }
  ...
  @available(
    *, unavailable, message: "Enable the 'EngineService' trait in Package.swift to use this client."
  )
  public final class EngineServiceClient: Sendable {
    @available(
      *, unavailable,
      message: "Enable the 'EngineService' trait in Package.swift to use this client."
    )
    public init(_ options: GoogleGax.ClientOptions = .init()) throws {}
  }
#endif
