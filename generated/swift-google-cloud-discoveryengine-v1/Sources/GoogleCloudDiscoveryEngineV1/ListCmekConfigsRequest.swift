...
// limitations under the License.
  ...
  public struct ListCmekConfigsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ListCmekConfigsRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListCmekConfigsRequest().with { $0.parent = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.ListCmekConfigsRequest"
    }
