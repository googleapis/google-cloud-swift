...
// limitations under the License.
  ...
  public struct ListCustomModelsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ListCustomModelsRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListCustomModelsRequest().with { $0.dataStore = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.ListCustomModelsRequest"
    }
