...
// limitations under the License.
  ...
  extension Clients {
    final class IdentityMappingStoreServiceTransport: IdentityMappingStoreServiceStub {
      ...
      public func createIdentityMappingStore(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v1/\(pathVariable0)/identityMappingStores"
            var query = [
      ...
      public func importIdentityMappings(
        ...
        let (path, query, configure, omitted) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                request.identityMappingStore as Swift.String?,
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                  .literal("/identityMappingStores/"), .singleWildcard,
                ],
                fieldName: "identity_mapping_store")
            else {
              return nil
            }
            let path = "/v1/\(pathVariable0):importIdentityMappings"
            let query = [
              URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
            ]
            return (path, query)
          }() {
            return (candidate.0, candidate.1, { $0.setMethod(.POST) }, ["identityMappingStore"])
          }
          var paths: [GoogleGax.PathMismatch] = []
          do {
            var builder = GoogleGax._PathMismatchBuilder()
      ...
      public func purgeIdentityMappings(
        ...
        let (path, query, configure, omitted) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v1/\(pathVariable0):purgeIdentityMappings"
            let query = [
              URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
            ]
            return (path, query)
      ...
      public func listIdentityMappings(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v1/\(pathVariable0):listIdentityMappings"
            var query = [
              URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
            ]
            let encoder = GoogleGax._QueryParameterEncoder()
