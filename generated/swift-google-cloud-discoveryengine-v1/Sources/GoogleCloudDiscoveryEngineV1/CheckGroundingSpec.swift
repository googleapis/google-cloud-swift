...
// limitations under the License.
  ...
  public struct CheckGroundingSpec: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var citationThreshold: Swift.Double? = nil
    ...
    ///
    /// ```
    /// let value = CheckGroundingSpec().with { $0.citationThreshold = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.CheckGroundingSpec"
    }
