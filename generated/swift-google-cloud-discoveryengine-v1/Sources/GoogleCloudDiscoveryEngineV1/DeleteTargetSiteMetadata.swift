...
// limitations under the License.
  ...
  public struct DeleteTargetSiteMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `DeleteTargetSiteMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DeleteTargetSiteMetadata().with { $0.createTime = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.DeleteTargetSiteMetadata"
    }
