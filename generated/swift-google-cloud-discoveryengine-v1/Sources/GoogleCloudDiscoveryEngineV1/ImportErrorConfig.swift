...
// limitations under the License.
  ...
  public struct ImportErrorConfig: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ImportErrorConfig`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ImportErrorConfig().with { $0.gcsPrefix = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.ImportErrorConfig"
    }
