...
// limitations under the License.
  ...
  public struct ListEnginesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ListEnginesRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListEnginesRequest().with { $0.parent = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.ListEnginesRequest"
    }
