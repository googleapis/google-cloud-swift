...
// limitations under the License.
  ...
  public struct DisableAdvancedSiteSearchRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `DisableAdvancedSiteSearchRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DisableAdvancedSiteSearchRequest().with { $0.siteSearchEngine = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.DisableAdvancedSiteSearchRequest"
    }
