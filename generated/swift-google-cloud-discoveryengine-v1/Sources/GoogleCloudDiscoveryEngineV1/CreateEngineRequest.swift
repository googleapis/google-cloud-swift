...
// limitations under the License.
  ...
  public struct CreateEngineRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// [google.cloud.discoveryengine.v1.Engine]: <doc:Engine>
    public var engineId: Swift.String = Swift.String()

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `CreateEngineRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = CreateEngineRequest().with { $0.parent = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let engineId = CodingKeys(stringValue: "engineId")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(Swift.String.self, forKey: .engineId) {
        self.engineId = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.engineId, forKey: .engineId)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.CreateEngineRequest"
    }
