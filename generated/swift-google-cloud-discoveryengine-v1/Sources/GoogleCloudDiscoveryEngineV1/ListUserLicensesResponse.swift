...
// limitations under the License.
    ...
    Sendable
  {
    ...
    ///
    /// [google.cloud.discoveryengine.v1.UserLicense]: <doc:UserLicense>
    ...
    /// Initialize a new instance of `ListUserLicensesResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListUserLicensesResponse().with { $0.userLicenses = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.ListUserLicensesResponse"
    }
