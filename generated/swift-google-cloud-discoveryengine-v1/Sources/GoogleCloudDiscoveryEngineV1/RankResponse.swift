...
// limitations under the License.
  ...
  public struct RankResponse: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `RankResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RankResponse().with { $0.records = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.RankResponse"
    }
