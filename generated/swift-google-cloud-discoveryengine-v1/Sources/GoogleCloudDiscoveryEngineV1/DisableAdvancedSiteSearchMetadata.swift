...
// limitations under the License.
  ...
  public struct DisableAdvancedSiteSearchMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `DisableAdvancedSiteSearchMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DisableAdvancedSiteSearchMetadata().with { $0.createTime = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.DisableAdvancedSiteSearchMetadata"
    }
