...
// limitations under the License.
  ...
  public struct DeleteIdentityMappingStoreRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `DeleteIdentityMappingStoreRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DeleteIdentityMappingStoreRequest().with { $0.name = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.DeleteIdentityMappingStoreRequest"
    }
