    ...
    Sendable
  {
    ...
    public enum Type_: Codable, Equatable, Hashable, Sendable {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        case .googleDrive: return try container.encode("GOOGLE_DRIVE")
        case .googleMail: return try container.encode("GOOGLE_MAIL")
        case .googleSites: return try container.encode("GOOGLE_SITES")
        case .googleCalendar: return try container.encode("GOOGLE_CALENDAR")
        case .googleChat: return try container.encode("GOOGLE_CHAT")
        case .googleGroups: return try container.encode("GOOGLE_GROUPS")
        case .googleKeep: return try container.encode("GOOGLE_KEEP")
        case .googlePeople: return try container.encode("GOOGLE_PEOPLE")
