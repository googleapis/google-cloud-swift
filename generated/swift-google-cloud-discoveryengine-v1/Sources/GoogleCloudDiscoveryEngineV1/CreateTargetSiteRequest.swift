...
// limitations under the License.
  ...
  public struct CreateTargetSiteRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `CreateTargetSiteRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = CreateTargetSiteRequest().with { $0.parent = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let targetSite = CodingKeys(stringValue: "targetSite")
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.targetSite = try container.decodeIfPresent(TargetSite.self, forKey: .targetSite)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encodeIfPresent(self.targetSite, forKey: .targetSite)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.CreateTargetSiteRequest"
    }
