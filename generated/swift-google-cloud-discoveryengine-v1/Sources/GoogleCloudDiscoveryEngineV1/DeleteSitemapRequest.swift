...
// limitations under the License.
  ...
  public struct DeleteSitemapRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `DeleteSitemapRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DeleteSitemapRequest().with { $0.name = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.DeleteSitemapRequest"
    }
