    ...
    Sendable
  {
    ...
    public enum ContentConfig: Codable, Equatable, Sendable {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .unspecified: return try container.encode("CONTENT_CONFIG_UNSPECIFIED")
        case .noContent: return try container.encode("NO_CONTENT")
        case .contentRequired: return try container.encode("CONTENT_REQUIRED")
        case .publicWebsite: return try container.encode("PUBLIC_WEBSITE")
        case .googleWorkspace: return try container.encode("GOOGLE_WORKSPACE")
