...
// limitations under the License.
  ...
  public struct SuggestionDenyListEntry: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// Required. Phrase to block from suggestions served. Can be maximum 125
    /// characters.
    public var blockPhrase: Swift.String = Swift.String()
    ...
    ///
    /// ```
    /// let value = SuggestionDenyListEntry().with { $0.blockPhrase = ... }
    /// ```
    ...
    ///   them to named cases.
    public enum MatchOperator: Codable, Equatable, Hashable, Sendable {
      ...
      public var stringValue: Swift.String? {
        switch self {
        case .unspecified: return "MATCH_OPERATOR_UNSPECIFIED"
      ...
      ///
      /// If the value is unknown, this initializes to [`unknownStringValue`](doc:MatchOperator/unknownStringValue(_:)).
      public init(stringValue: Swift.String) {
        switch stringValue {
        case "MATCH_OPERATOR_UNSPECIFIED": self = .unspecified
      ...
      ///
      /// If the value is unknown, this initializes to [`unknownIntValue`](doc:MatchOperator/unknownIntValue(_:)).
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .unspecified: return try container.encode("MATCH_OPERATOR_UNSPECIFIED")
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.SuggestionDenyListEntry"
    }
