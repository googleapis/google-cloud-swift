...
// limitations under the License.
  ...
  public struct ImportIdentityMappingsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ImportIdentityMappingsResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ImportIdentityMappingsResponse().with { $0.errorSamples = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.ImportIdentityMappingsResponse"
    }
