        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                  .literal("/dataStores/"), .singleWildcard, .literal("/controls/"),
                  .singleWildcard,
                ],
                fieldName: "name")
            else {
            ...
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                  .literal("/collections/"), .singleWildcard, .literal("/dataStores/"),
                  .singleWildcard, .literal("/controls/"), .singleWildcard,
                ],
                fieldName: "name")
            else {
              return nil
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              matching: [
                .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                .literal("/dataStores/"), .singleWildcard, .literal("/controls/"), .singleWildcard,
              ],
              fieldName: "name",
              expecting: "projects/*/locations/*/dataStores/*/controls/*"
            )
            paths.append(builder.build())
          }
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "name",
              expecting: "projects/*/locations/*/collections/*/dataStores/*/controls/*"
            )
            paths.append(builder.build())
          }
          do {
            ...
            builder.maybeAdd(
              ...
              matching: [
                .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                .literal("/collections/"), .singleWildcard, .literal("/engines/"), .singleWildcard,
                .literal("/controls/"), .singleWildcard,
              ],
              fieldName: "name",
              expecting: "projects/*/locations/*/collections/*/engines/*/controls/*"
            )
            paths.append(builder.build())
          }
          throw GoogleGax.RequestError.binding(GoogleGax.BindingError(paths: paths))
