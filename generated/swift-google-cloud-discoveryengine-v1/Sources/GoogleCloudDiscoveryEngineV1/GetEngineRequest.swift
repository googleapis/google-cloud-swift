...
// limitations under the License.
  ...
  public struct GetEngineRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `GetEngineRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = GetEngineRequest().with { $0.name = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.GetEngineRequest"
    }
