...
// limitations under the License.
  ...
  public struct GetIdentityMappingStoreRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `GetIdentityMappingStoreRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = GetIdentityMappingStoreRequest().with { $0.name = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.GetIdentityMappingStoreRequest"
    }
