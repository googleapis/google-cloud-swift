...
// limitations under the License.
  ...
  public struct UpdateSchemaRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `UpdateSchemaRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = UpdateSchemaRequest().with { $0.schema = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.UpdateSchemaRequest"
    }
