...
// limitations under the License.
  ...
  public struct DeleteSitemapMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `DeleteSitemapMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DeleteSitemapMetadata().with { $0.createTime = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.DeleteSitemapMetadata"
    }
