...
// limitations under the License.
  ...
  extension Clients {
    final class UserLicenseServiceTransport: UserLicenseServiceStub {
      ...
      public func listUserLicenses(
        ...
        let (path, query, configure) = try {
            ...
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  ...
                  .literal("/userStores/"), .singleWildcard,
                ],
                fieldName: "parent")
            else {
              return nil
            }
            let path = "/v1/\(pathVariable0)/userLicenses"
            var query = [
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "parent",
              expecting: "projects/*/locations/*/userStores/*"
            )
        ...
        return try await req.rpc(
          GoogleCloudDiscoveryEngineV1.ListUserLicensesResponse.self,
      ...
      public func batchUpdateUserLicenses(
        ...
        let (path, query, configure, omitted) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v1/\(pathVariable0):batchUpdateUserLicenses"
            let query = [
              URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
            ]
            return (path, query)
