...
// limitations under the License.
  ...
  public struct CreateTargetSiteMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `CreateTargetSiteMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = CreateTargetSiteMetadata().with { $0.createTime = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.CreateTargetSiteMetadata"
    }
