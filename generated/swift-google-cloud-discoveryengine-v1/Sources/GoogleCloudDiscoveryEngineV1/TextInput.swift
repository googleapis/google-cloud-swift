...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var context: ConversationContext? = nil
    ...
    ///
    /// ```
    /// let value = TextInput().with { $0.input = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.context = try container.decodeIfPresent(ConversationContext.self, forKey: .context)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.discoveryengine.v1.TextInput"
    }
