...
// limitations under the License.
    ...
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let identityMappingStores = CodingKeys(stringValue: "identityMappingStores")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [IdentityMappingStore].self, forKey: .identityMappingStores)
      {
        self.identityMappingStores = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.identityMappingStores, forKey: .identityMappingStores)
