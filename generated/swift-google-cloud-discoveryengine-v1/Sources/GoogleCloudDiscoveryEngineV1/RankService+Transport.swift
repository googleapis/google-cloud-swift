...
// limitations under the License.
  ...
  extension Clients {
    final class RankServiceTransport: RankServiceStub {
      ...
      @concurrent
      public func rank(
        request: RankRequest, options: GoogleGax.RequestOptions
        ...
        let (path, query, configure, omitted) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v1/\(pathVariable0):rank"
            let query = [
              URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
            ]
            return (path, query)
          }() {
            return (candidate.0, candidate.1, { $0.setMethod(.POST) }, ["rankingConfig"])
          }
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "ranking_config",
              expecting: "projects/*/locations/*/rankingConfigs/*"
            )
