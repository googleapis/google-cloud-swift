...
// limitations under the License.
  ...
  extension Clients {
    final class GroundedGenerationServiceRetry: GroundedGenerationServiceStub {
      let inner: any GroundedGenerationServiceStub
      let options: GoogleGax.ClientOptions

      public init(_ inner: any GroundedGenerationServiceStub, options: GoogleGax.ClientOptions) {
        self.inner = inner
      ...
      public func generateGroundedContent(
        ...
        try await self._intercept(
          ...
          action: {
            ...
            in
            return try await self.inner.generateGroundedContent(request: r, options: o)
          })
      }
      ...
      public func checkGrounding(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: CheckGroundingRequest, o: GoogleGax.RequestOptions) async throws
              -> GoogleCloudDiscoveryEngineV1.CheckGroundingResponse
            in
            return try await self.inner.checkGrounding(request: r, options: o)
          })
      }
