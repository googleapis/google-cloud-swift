...
// limitations under the License.
  ...
  extension Clients {
    final class CmekConfigServiceTransport: CmekConfigServiceStub {
      ...
      public func updateCmekConfig(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            query.append(contentsOf: try encoder.encode(request.setDefault, prefix: "setDefault"))
            return (path, query)
          }() {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                  .literal("/cmekConfigs/"), .singleWildcard,
                ],
                fieldName: "config.name")
            else {
              return nil
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "config.name",
              expecting: "projects/*/locations/*/cmekConfigs/*"
            )
            paths.append(builder.build())
          }
      ...
      public func listCmekConfigs(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v1/\(pathVariable0)/cmekConfigs"
            let query = [
              URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
            ]
            return (path, query)
