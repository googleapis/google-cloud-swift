...
// limitations under the License.
  ...
  func sample(
    client: ServingConfigServiceClient, projectId: String, locationId: String, dataStoreId: String,
      ...
      request: UpdateServingConfigRequest()
        .with {
          $0.servingConfig = ServingConfig().with {
            $0.name =
              "projects/\(projectId)/locations/\(locationId)/dataStores/\(dataStoreId)/servingConfigs/\(servingConfigId)"
          }
    ...
    static func main() async throws {
      do {
        ...
        try await sample(
          ...
          dataStoreId: "[placeholder]", servingConfigId: "[placeholder]")
      } catch {
        print("Error: \(error)")
      }
    }
