...
public struct UpdateQueryTemplateRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateQueryTemplateRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateQueryTemplateRequest().with { $0.updateMask = ... }
  /// ```
