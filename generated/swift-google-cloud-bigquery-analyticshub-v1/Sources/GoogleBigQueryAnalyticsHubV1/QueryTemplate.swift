...
public struct QueryTemplate: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let proposer = CodingKeys(stringValue: "proposer")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .proposer) {
      self.proposer = value
    }
    ...
    if let value = try container.decodeIfPresent(QueryTemplate.State.self, forKey: .state) {
      self.state = value
    }
    self.routine = try container.decodeIfPresent(Routine.self, forKey: .routine)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.proposer, forKey: .proposer)
    ...
    try container.encodeIfPresent(self.routine, forKey: .routine)
  ...
  public enum State: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .drafted: return try container.encode("DRAFTED")
