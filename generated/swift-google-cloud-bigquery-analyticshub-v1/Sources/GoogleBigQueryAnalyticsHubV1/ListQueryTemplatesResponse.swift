  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListQueryTemplatesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListQueryTemplatesResponse().with { $0.queryTemplates = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let queryTemplates = CodingKeys(stringValue: "queryTemplates")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([QueryTemplate].self, forKey: .queryTemplates) {
      self.queryTemplates = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.queryTemplates, forKey: .queryTemplates)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.analyticshub.v1.ListQueryTemplatesResponse"
  }
