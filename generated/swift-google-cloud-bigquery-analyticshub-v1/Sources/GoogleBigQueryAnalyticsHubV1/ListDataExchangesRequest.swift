...
public struct ListDataExchangesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDataExchangesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDataExchangesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.analyticshub.v1.ListDataExchangesRequest"
  }
