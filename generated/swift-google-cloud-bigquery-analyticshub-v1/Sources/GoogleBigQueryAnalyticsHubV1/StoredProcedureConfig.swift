...
/// on linked dataset.
public struct StoredProcedureConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = StoredProcedureConfig().with { $0.enabled = ... }
  /// ```
  ...
  ///   them to named cases.
  public enum StoredProcedureType: Codable, Equatable, Hashable, Sendable {
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:StoredProcedureType/unknownStringValue(_:)).
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:StoredProcedureType/unknownIntValue(_:)).
    public init(intValue: Int) {
      switch intValue {
      case 0: self = .unspecified
      case 1: self = .sqlProcedure
