...
public struct UpdateDataExchangeRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateDataExchangeRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateDataExchangeRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.analyticshub.v1.UpdateDataExchangeRequest"
  }
