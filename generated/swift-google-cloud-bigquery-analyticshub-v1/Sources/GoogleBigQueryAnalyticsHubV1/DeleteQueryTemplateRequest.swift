...
public struct DeleteQueryTemplateRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteQueryTemplateRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteQueryTemplateRequest().with { $0.name = ... }
  /// ```
