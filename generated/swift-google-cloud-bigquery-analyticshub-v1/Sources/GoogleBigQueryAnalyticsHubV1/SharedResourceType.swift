...
///   them to named cases.
public enum SharedResourceType: Codable, Equatable, Hashable, Sendable {
  /// Not specified.
  case unspecified
  ...
  public var intValue: Int? {
    ...
    case .bigqueryDataset: return 1
    case .pubsubTopic: return 2
  ...
  public var stringValue: Swift.String? {
    ...
    case .pubsubTopic: return "PUBSUB_TOPIC"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:SharedResourceType/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "SHARED_RESOURCE_TYPE_UNSPECIFIED": self = .unspecified
    case "BIGQUERY_DATASET": self = .bigqueryDataset
    case "PUBSUB_TOPIC": self = .pubsubTopic
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:SharedResourceType/unknownIntValue(_:)).
  public init(intValue: Int) {
    switch intValue {
    case 0: self = .unspecified
    case 1: self = .bigqueryDataset
    case 2: self = .pubsubTopic
