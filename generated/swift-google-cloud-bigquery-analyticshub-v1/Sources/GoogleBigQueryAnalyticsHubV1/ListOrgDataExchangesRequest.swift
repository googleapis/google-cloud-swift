...
public struct ListOrgDataExchangesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListOrgDataExchangesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListOrgDataExchangesRequest().with { $0.organization = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.analyticshub.v1.ListOrgDataExchangesRequest"
  }
