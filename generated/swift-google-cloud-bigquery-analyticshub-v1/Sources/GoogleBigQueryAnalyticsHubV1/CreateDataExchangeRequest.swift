...
public struct CreateDataExchangeRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var dataExchangeId: Swift.String = Swift.String()
  ...
  ///
  /// ```
  /// let value = CreateDataExchangeRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.analyticshub.v1.CreateDataExchangeRequest"
  }
