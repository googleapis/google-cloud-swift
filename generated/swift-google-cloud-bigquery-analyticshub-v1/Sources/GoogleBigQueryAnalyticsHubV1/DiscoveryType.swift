...
public enum DiscoveryType: Codable, Equatable, Hashable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "DISCOVERY_TYPE_UNSPECIFIED"
    case .`private`: return "DISCOVERY_TYPE_PRIVATE"
    case .`public`: return "DISCOVERY_TYPE_PUBLIC"
  ...
  public init(stringValue: Swift.String) {
    ...
    case "DISCOVERY_TYPE_PRIVATE": self = .`private`
    case "DISCOVERY_TYPE_PUBLIC": self = .`public`
