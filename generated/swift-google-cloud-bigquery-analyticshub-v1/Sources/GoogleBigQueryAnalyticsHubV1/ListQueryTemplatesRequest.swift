...
public struct ListQueryTemplatesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListQueryTemplatesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListQueryTemplatesRequest().with { $0.parent = ... }
  /// ```
