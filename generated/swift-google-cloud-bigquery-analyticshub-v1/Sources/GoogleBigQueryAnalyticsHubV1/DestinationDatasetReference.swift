...
public struct DestinationDatasetReference: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DestinationDatasetReference`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DestinationDatasetReference().with { $0.datasetId = ... }
  /// ```
