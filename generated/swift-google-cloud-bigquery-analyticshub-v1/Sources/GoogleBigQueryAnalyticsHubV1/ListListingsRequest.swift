...
public struct ListListingsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListListingsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListListingsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.analyticshub.v1.ListListingsRequest"
  }
