  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let protectedResources = CodingKeys(stringValue: "protectedResources")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [ProtectedResource].self, forKey: .protectedResources)
    {
      self.protectedResources = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.protectedResources, forKey: .protectedResources)
