...
public struct QueryRepositoryDirectoryContentsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `QueryRepositoryDirectoryContentsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = QueryRepositoryDirectoryContentsRequest().with { $0.name = ... }
  /// ```
