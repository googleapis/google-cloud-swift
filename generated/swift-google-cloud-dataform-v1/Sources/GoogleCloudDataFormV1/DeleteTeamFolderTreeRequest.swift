...
public struct DeleteTeamFolderTreeRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteTeamFolderTreeRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteTeamFolderTreeRequest().with { $0.name = ... }
  /// ```
