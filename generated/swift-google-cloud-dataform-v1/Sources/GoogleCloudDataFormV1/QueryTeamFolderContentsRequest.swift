...
public struct QueryTeamFolderContentsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Required. Resource name of the TeamFolder to list contents for.
  /// Format: `projects/*/locations/*/teamFolders/*`.
  public var teamFolder: Swift.String = Swift.String()
  ...
  /// Initialize a new instance of `QueryTeamFolderContentsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = QueryTeamFolderContentsRequest().with { $0.teamFolder = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .teamFolder) {
      self.teamFolder = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.teamFolder, forKey: .teamFolder)
