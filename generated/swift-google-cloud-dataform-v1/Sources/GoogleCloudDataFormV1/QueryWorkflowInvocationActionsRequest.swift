...
public struct QueryWorkflowInvocationActionsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `QueryWorkflowInvocationActionsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = QueryWorkflowInvocationActionsRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.QueryWorkflowInvocationActionsRequest"
  }
