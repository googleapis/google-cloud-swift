...
public struct ListWorkflowConfigsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListWorkflowConfigsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListWorkflowConfigsRequest().with { $0.parent = ... }
  /// ```
