...
public struct FetchFileDiffRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `FetchFileDiffRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FetchFileDiffRequest().with { $0.workspace = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.FetchFileDiffRequest"
  }
