...
public struct SearchFilesResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SearchFilesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SearchFilesResponse().with { $0.searchResults = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.SearchFilesResponse"
  }
...
extension SearchFilesResponse: GoogleGax._PaginatedResponse {
