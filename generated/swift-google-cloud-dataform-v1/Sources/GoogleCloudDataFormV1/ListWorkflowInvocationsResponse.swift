  ...
  Sendable
{
  ...
  public var workflowInvocations: [WorkflowInvocation] = []
  ...
  /// Initialize a new instance of `ListWorkflowInvocationsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListWorkflowInvocationsResponse().with { $0.workflowInvocations = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let workflowInvocations = CodingKeys(stringValue: "workflowInvocations")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [WorkflowInvocation].self, forKey: .workflowInvocations)
    {
      self.workflowInvocations = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.workflowInvocations, forKey: .workflowInvocations)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.ListWorkflowInvocationsResponse"
  }
