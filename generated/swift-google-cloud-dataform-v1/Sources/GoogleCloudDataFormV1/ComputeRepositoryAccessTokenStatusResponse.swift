...
public struct ComputeRepositoryAccessTokenStatusResponse: Codable, Equatable, GoogleWKT
    ._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      ComputeRepositoryAccessTokenStatusResponse.TokenStatus.self, forKey: .tokenStatus)
    {
  ...
  ///   them to named cases.
  public enum TokenStatus: Codable, Equatable, Hashable, Sendable {
