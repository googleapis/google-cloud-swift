  ...
  Sendable
{
  ...
  public var commits: [CommitLogEntry] = []
  ...
  /// Initialize a new instance of `FetchRepositoryHistoryResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FetchRepositoryHistoryResponse().with { $0.commits = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let commits = CodingKeys(stringValue: "commits")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([CommitLogEntry].self, forKey: .commits) {
      self.commits = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.commits, forKey: .commits)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.FetchRepositoryHistoryResponse"
  }
