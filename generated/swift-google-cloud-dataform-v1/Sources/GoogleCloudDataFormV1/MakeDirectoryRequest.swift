...
public struct MakeDirectoryRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `MakeDirectoryRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = MakeDirectoryRequest().with { $0.workspace = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.MakeDirectoryRequest"
  }
