...
public struct FetchGitAheadBehindRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var remoteBranch: Swift.String = Swift.String()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `FetchGitAheadBehindRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FetchGitAheadBehindRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.FetchGitAheadBehindRequest"
  }
