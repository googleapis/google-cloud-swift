...
public struct ListReleaseConfigsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListReleaseConfigsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListReleaseConfigsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.ListReleaseConfigsRequest"
  }
