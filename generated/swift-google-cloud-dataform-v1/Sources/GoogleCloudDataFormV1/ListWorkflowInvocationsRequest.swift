...
public struct ListWorkflowInvocationsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListWorkflowInvocationsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListWorkflowInvocationsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.ListWorkflowInvocationsRequest"
  }
