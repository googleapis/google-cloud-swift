  ...
  Sendable
{
  ...
  public var releaseConfigs: [ReleaseConfig] = []
  ...
  /// Initialize a new instance of `ListReleaseConfigsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListReleaseConfigsResponse().with { $0.releaseConfigs = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let releaseConfigs = CodingKeys(stringValue: "releaseConfigs")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([ReleaseConfig].self, forKey: .releaseConfigs) {
      self.releaseConfigs = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.releaseConfigs, forKey: .releaseConfigs)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.ListReleaseConfigsResponse"
  }
