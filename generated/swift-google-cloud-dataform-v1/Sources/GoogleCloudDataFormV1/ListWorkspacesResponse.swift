  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListWorkspacesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListWorkspacesResponse().with { $0.workspaces = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let workspaces = CodingKeys(stringValue: "workspaces")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Workspace].self, forKey: .workspaces) {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.workspaces, forKey: .workspaces)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.ListWorkspacesResponse"
  }
