  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let pipelineType = CodingKeys(stringValue: "pipelineType")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      PipelineConfig.PipelineType.self, forKey: .pipelineType)
    {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.pipelineType, forKey: .pipelineType)
  ...
  ///   them to named cases.
  public enum PipelineType: Codable, Equatable, Hashable, Sendable {
