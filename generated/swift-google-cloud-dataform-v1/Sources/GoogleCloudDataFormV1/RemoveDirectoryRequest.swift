...
public struct RemoveDirectoryRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `RemoveDirectoryRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RemoveDirectoryRequest().with { $0.workspace = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.RemoveDirectoryRequest"
  }
