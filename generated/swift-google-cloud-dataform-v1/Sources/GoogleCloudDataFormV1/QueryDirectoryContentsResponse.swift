  ...
  Sendable
{
  ...
  /// Initialize a new instance of `QueryDirectoryContentsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = QueryDirectoryContentsResponse().with { $0.directoryEntries = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.QueryDirectoryContentsResponse"
  }
