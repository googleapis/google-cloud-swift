...
/// operations.
public struct MoveRepositoryMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var state: MoveRepositoryMetadata.State = MoveRepositoryMetadata.State()
  ...
  /// Initialize a new instance of `MoveRepositoryMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = MoveRepositoryMetadata().with { $0.createTime = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(MoveRepositoryMetadata.State.self, forKey: .state)
    {
      self.state = value
    }
