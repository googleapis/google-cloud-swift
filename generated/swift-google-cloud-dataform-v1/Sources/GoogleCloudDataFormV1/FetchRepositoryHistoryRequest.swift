...
public struct FetchRepositoryHistoryRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `FetchRepositoryHistoryRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FetchRepositoryHistoryRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.FetchRepositoryHistoryRequest"
  }
