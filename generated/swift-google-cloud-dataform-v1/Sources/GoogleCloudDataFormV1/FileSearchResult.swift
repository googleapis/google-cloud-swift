...
public struct FileSearchResult: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `FileSearchResult`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FileSearchResult().with { $0.path = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.FileSearchResult"
  }
