  ...
  Sendable
{
  ...
  public var compilationResults: [CompilationResult] = []
  ...
  /// Initialize a new instance of `ListCompilationResultsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCompilationResultsResponse().with { $0.compilationResults = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let compilationResults = CodingKeys(stringValue: "compilationResults")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [CompilationResult].self, forKey: .compilationResults)
    {
      self.compilationResults = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.compilationResults, forKey: .compilationResults)
