  ...
  Sendable
{
  ...
  public var defaultKmsKeyName: Swift.String = Swift.String()
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let defaultKmsKeyName = CodingKeys(stringValue: "defaultKmsKeyName")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .defaultKmsKeyName) {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.defaultKmsKeyName, forKey: .defaultKmsKeyName)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.Config"
  }
