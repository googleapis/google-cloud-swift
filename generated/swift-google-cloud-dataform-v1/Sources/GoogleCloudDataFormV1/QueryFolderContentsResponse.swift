...
public struct QueryFolderContentsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [QueryFolderContentsResponse.FolderContentsEntry].self, forKey: .entries)
    {
      self.entries = value
    }
  ...
  public struct FolderContentsEntry: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// The content entry.
...
extension QueryFolderContentsResponse: GoogleGax._PaginatedResponse {
