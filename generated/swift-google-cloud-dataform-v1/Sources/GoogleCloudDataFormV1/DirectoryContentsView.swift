...
///   them to named cases.
public enum DirectoryContentsView: Codable, Equatable, Hashable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "DIRECTORY_CONTENTS_VIEW_UNSPECIFIED"
    case .basic: return "DIRECTORY_CONTENTS_VIEW_BASIC"
    case .metadata: return "DIRECTORY_CONTENTS_VIEW_METADATA"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:DirectoryContentsView/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "DIRECTORY_CONTENTS_VIEW_UNSPECIFIED": self = .unspecified
    case "DIRECTORY_CONTENTS_VIEW_BASIC": self = .basic
    case "DIRECTORY_CONTENTS_VIEW_METADATA": self = .metadata
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:DirectoryContentsView/unknownIntValue(_:)).
