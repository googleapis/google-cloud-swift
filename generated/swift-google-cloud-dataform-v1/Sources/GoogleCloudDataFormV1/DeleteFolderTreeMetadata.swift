...
/// operations.
public struct DeleteFolderTreeMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var state: DeleteFolderTreeMetadata.State = DeleteFolderTreeMetadata.State()
  ...
  /// Initialize a new instance of `DeleteFolderTreeMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteFolderTreeMetadata().with { $0.createTime = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      DeleteFolderTreeMetadata.State.self, forKey: .state)
    {
      self.state = value
    }
    if let value = try container.decodeIfPresent(Swift.Int32.self, forKey: .percentComplete) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.DeleteFolderTreeMetadata"
  }
