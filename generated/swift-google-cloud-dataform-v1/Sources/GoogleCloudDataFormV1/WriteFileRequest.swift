...
public struct WriteFileRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `WriteFileRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = WriteFileRequest().with { $0.workspace = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.WriteFileRequest"
  }
