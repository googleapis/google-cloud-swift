...
public struct ReadRepositoryFileRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ReadRepositoryFileRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ReadRepositoryFileRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.ReadRepositoryFileRequest"
  }
