...
public struct PushGitCommitsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `PushGitCommitsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = PushGitCommitsRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.PushGitCommitsRequest"
  }
