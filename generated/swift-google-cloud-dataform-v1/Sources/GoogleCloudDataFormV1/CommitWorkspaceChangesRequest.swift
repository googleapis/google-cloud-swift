...
public struct CommitWorkspaceChangesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CommitWorkspaceChangesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CommitWorkspaceChangesRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.CommitWorkspaceChangesRequest"
  }
