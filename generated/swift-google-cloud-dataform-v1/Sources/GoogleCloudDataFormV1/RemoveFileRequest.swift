...
public struct RemoveFileRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `RemoveFileRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RemoveFileRequest().with { $0.workspace = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.RemoveFileRequest"
  }
