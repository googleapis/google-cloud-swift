...
public struct CommitMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CommitMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CommitMetadata().with { $0.author = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.CommitMetadata"
  }
