...
public struct UpdateWorkflowConfigRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateWorkflowConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateWorkflowConfigRequest().with { $0.updateMask = ... }
  /// ```
