...
public struct ReadFileRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ReadFileRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ReadFileRequest().with { $0.workspace = ... }
  /// ```
