...
public struct DirectorySearchResult: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DirectorySearchResult`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DirectorySearchResult().with { $0.path = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataform.v1.DirectorySearchResult"
  }
