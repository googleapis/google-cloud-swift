...
/// service.
public struct EventTrigger: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///   them to named cases.
  public enum RetryPolicy: Codable, Equatable, Hashable, Sendable {
    /// Not specified.
    case unspecified
    /// Do not retry.
    case doNotRetry
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("RETRY_POLICY_UNSPECIFIED")
      case .doNotRetry: return try container.encode("RETRY_POLICY_DO_NOT_RETRY")
      case .retry: return try container.encode("RETRY_POLICY_RETRY")
