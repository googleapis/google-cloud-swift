  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let sourceUploadUrl = CodingKeys(stringValue: "sourceUploadUrl")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .sourceUploadUrl) {
      self.sourceUploadUrl = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.sourceUploadUrl, forKey: .sourceUploadUrl)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.functions.v2.StorageSource"
  }
