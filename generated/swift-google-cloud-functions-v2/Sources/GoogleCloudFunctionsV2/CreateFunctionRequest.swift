...
public struct CreateFunctionRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let functionId = CodingKeys(stringValue: "functionId")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.function = try container.decodeIfPresent(Function.self, forKey: .function)
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .functionId) {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.functionId, forKey: .functionId)
