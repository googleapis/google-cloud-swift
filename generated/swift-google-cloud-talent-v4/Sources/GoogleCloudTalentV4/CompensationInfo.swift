  ...
  Sendable
{
  ...
  /// [google.cloud.talent.v4.CompensationInfo.CompensationEntry.amount]: <doc:CompensationInfo/CompensationEntry/CompensationAmountOneOf/amount(_:)>
  ...
  /// [google.cloud.talent.v4.CompensationInfo.CompensationEntry.amount]: <doc:CompensationInfo/CompensationEntry/CompensationAmountOneOf/amount(_:)>
  /// [google.cloud.talent.v4.CompensationInfo.CompensationEntry.expected_units_per_year]: <doc:CompensationInfo/CompensationEntry/expectedUnitsPerYear>
  /// [google.cloud.talent.v4.CompensationInfo.CompensationEntry.range]: <doc:CompensationInfo/CompensationEntry/CompensationAmountOneOf/range(_:)>
    ...
    Sendable
  {
    ...
    public var compensationAmount: CompensationAmountOneOf? = nil
    ...
    public init(from decoder: Decoder) throws {
      ...
      var compensationAmount: CompensationAmountOneOf? = nil
  ...
  public enum CompensationType: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .bonus: return try container.encode("BONUS")
      case .signingBonus: return try container.encode("SIGNING_BONUS")
      case .equity: return try container.encode("EQUITY")
      case .profitSharing: return try container.encode("PROFIT_SHARING")
      case .commissions: return try container.encode("COMMISSIONS")
      case .tips: return try container.encode("TIPS")
      case .otherCompensationType: return try container.encode("OTHER_COMPENSATION_TYPE")
  ...
  public enum CompensationUnit: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .otherCompensationUnit: return try container.encode("OTHER_COMPENSATION_UNIT")
      case .unknownIntValue(let v): return try container.encode(v)
      case .unknownStringValue(let v): return try container.encode(v)
      }
    }
