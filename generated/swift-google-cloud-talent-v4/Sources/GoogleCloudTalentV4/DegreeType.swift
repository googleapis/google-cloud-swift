...
///   them to named cases.
public enum DegreeType: Codable, Equatable, Hashable, Sendable {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    switch self {
    case .unspecified: return try container.encode("DEGREE_TYPE_UNSPECIFIED")
    case .primaryEducation: return try container.encode("PRIMARY_EDUCATION")
    case .lowerSecondaryEducation: return try container.encode("LOWER_SECONDARY_EDUCATION")
    case .upperSecondaryEducation: return try container.encode("UPPER_SECONDARY_EDUCATION")
    case .adultRemedialEducation: return try container.encode("ADULT_REMEDIAL_EDUCATION")
    case .associatesOrEquivalent: return try container.encode("ASSOCIATES_OR_EQUIVALENT")
    case .bachelorsOrEquivalent: return try container.encode("BACHELORS_OR_EQUIVALENT")
    case .mastersOrEquivalent: return try container.encode("MASTERS_OR_EQUIVALENT")
    case .doctoralOrEquivalent: return try container.encode("DOCTORAL_OR_EQUIVALENT")
