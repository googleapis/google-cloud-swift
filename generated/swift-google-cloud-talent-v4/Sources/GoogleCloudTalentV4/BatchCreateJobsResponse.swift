...
public struct BatchCreateJobsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `BatchCreateJobsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = BatchCreateJobsResponse().with { $0.jobResults = ... }
  /// ```
