  ...
  Sendable
{
  ...
  public enum LocationType: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .country: return try container.encode("COUNTRY")
      case .administrativeArea: return try container.encode("ADMINISTRATIVE_AREA")
      case .subAdministrativeArea: return try container.encode("SUB_ADMINISTRATIVE_AREA")
      case .locality: return try container.encode("LOCALITY")
      case .postalCode: return try container.encode("POSTAL_CODE")
      case .subLocality: return try container.encode("SUB_LOCALITY")
      case .subLocality1: return try container.encode("SUB_LOCALITY_1")
      case .subLocality2: return try container.encode("SUB_LOCALITY_2")
      case .neighborhood: return try container.encode("NEIGHBORHOOD")
      case .streetAddress: return try container.encode("STREET_ADDRESS")
