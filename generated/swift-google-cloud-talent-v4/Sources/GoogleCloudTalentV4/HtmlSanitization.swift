...
///   them to named cases.
public enum HtmlSanitization: Codable, Equatable, Hashable, Sendable {
  /// Default value.
  case unspecified
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "HTML_SANITIZATION_UNSPECIFIED"
    case .disabled: return "HTML_SANITIZATION_DISABLED"
    case .simpleFormattingOnly: return "SIMPLE_FORMATTING_ONLY"
  ...
  public init(stringValue: Swift.String) {
    ...
    case "HTML_SANITIZATION_DISABLED": self = .disabled
    case "SIMPLE_FORMATTING_ONLY": self = .simpleFormattingOnly
