...
public struct LocationFilter: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public enum TelecommutePreference: Codable, Equatable, Hashable, Sendable {
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:TelecommutePreference/unknownStringValue(_:)).
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:TelecommutePreference/unknownIntValue(_:)).
    #if hasAttribute(diagnose)
      @diagnose(DeprecatedDeclaration, as: ignored)
    #endif
