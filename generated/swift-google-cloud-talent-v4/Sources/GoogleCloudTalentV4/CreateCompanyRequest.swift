...
public struct CreateCompanyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CreateCompanyRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateCompanyRequest().with { $0.parent = ... }
  /// ```
