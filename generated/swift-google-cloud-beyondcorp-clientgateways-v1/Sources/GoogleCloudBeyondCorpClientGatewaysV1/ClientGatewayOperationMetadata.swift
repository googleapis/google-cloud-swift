...
public struct ClientGatewayOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ClientGatewayOperationMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ClientGatewayOperationMetadata().with { $0.createTime = ... }
  /// ```
