...
public struct DeleteClientGatewayRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteClientGatewayRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteClientGatewayRequest().with { $0.name = ... }
  /// ```
