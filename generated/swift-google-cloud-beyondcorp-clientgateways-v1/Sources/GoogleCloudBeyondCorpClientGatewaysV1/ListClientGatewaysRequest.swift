...
public struct ListClientGatewaysRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListClientGatewaysRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListClientGatewaysRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.beyondcorp.clientgateways.v1.ListClientGatewaysRequest"
  }
