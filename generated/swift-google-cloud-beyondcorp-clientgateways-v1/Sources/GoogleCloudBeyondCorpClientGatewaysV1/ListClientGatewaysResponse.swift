  ...
  Sendable
{
  ...
  public var clientGateways: [ClientGateway] = []
  ...
  /// Initialize a new instance of `ListClientGatewaysResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListClientGatewaysResponse().with { $0.clientGateways = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let clientGateways = CodingKeys(stringValue: "clientGateways")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([ClientGateway].self, forKey: .clientGateways) {
      self.clientGateways = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.clientGateways, forKey: .clientGateways)
