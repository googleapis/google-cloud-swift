...
// limitations under the License.
  ...
  extension Clients {
    ...
    public protocol GeneratorsProtocol: Sendable {
  ...
  extension Clients.GeneratorsProtocol {
    ...
    public func listGeneratorsByItems(
      request: ListGeneratorsRequest
    ) -> some AsyncSequence<Generator, Swift.Error> & Sendable {
      self.listGeneratorsByItems(request: request, options: .init())
    }
    ...
    public func listGeneratorsByItems(
      ...
      let listRpc = {
        @Sendable (token: Swift.String) async throws
          -> GoogleCloudDialogflowCXV3.ListGeneratorsResponse in
        var request = request
    ...
    public func listGeneratorsByItems(
      ...
      return self.listGeneratorsByItems(request: request)
    }
