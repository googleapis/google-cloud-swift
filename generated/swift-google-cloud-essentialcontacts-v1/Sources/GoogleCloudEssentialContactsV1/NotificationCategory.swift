...
public enum NotificationCategory: Codable, Equatable, Sendable {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    switch self {
    case .unspecified: return try container.encode("NOTIFICATION_CATEGORY_UNSPECIFIED")
    case .all: return try container.encode("ALL")
    case .suspension: return try container.encode("SUSPENSION")
    case .security: return try container.encode("SECURITY")
    case .technical: return try container.encode("TECHNICAL")
    case .billing: return try container.encode("BILLING")
    case .legal: return try container.encode("LEGAL")
    case .productUpdates: return try container.encode("PRODUCT_UPDATES")
    case .technicalIncidents: return try container.encode("TECHNICAL_INCIDENTS")
