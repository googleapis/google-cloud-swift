  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let notificationCategories = CodingKeys(stringValue: "notificationCategories")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [NotificationCategory].self, forKey: .notificationCategories)
    {
      self.notificationCategories = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.notificationCategories, forKey: .notificationCategories)
