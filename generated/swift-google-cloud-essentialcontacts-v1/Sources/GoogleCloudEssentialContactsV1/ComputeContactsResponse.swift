...
public struct ComputeContactsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ComputeContactsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ComputeContactsResponse().with { $0.contacts = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Contact].self, forKey: .contacts) {
      self.contacts = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.essentialcontacts.v1.ComputeContactsResponse"
  }
...
extension ComputeContactsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Contact] {
