...
public struct ListContactsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListContactsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListContactsResponse().with { $0.contacts = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.essentialcontacts.v1.ListContactsResponse"
  }
...
extension ListContactsResponse: GoogleGax._PaginatedResponse {
