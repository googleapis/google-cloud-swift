...
public struct MachineDiskDetails: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Disk total Capacity.
  public var totalCapacityBytes: Swift.Int64 = Swift.Int64()

  /// Total disk free space.
  public var totalFreeBytes: Swift.Int64 = Swift.Int64()
  ...
  ///
  /// ```
  /// let value = MachineDiskDetails().with { $0.totalCapacityBytes = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.migrationcenter.v1.MachineDiskDetails"
  }
