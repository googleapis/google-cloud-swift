...
/// CPU usage sample.
public struct CpuUsageSample: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = CpuUsageSample().with { $0.utilizedPercentage = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.migrationcenter.v1.CpuUsageSample"
  }
