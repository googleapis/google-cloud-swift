...
public struct AssetPerformanceData: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = AssetPerformanceData().with { $0.dailyResourceUsageAggregations = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.migrationcenter.v1.AssetPerformanceData"
  }
