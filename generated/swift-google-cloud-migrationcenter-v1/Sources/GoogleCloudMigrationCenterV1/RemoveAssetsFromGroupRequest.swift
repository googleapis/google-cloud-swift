...
public struct RemoveAssetsFromGroupRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `RemoveAssetsFromGroupRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RemoveAssetsFromGroupRequest().with { $0.group = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.migrationcenter.v1.RemoveAssetsFromGroupRequest"
  }
