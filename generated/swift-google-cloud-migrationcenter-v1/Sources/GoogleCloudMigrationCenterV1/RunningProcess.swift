...
public struct RunningProcess: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Process ID.
  ...
  /// Initialize a new instance of `RunningProcess`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RunningProcess().with { $0.pid = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.migrationcenter.v1.RunningProcess"
  }
