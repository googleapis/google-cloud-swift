...
public struct MachineArchitectureDetails: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public enum FirmwareType: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("FIRMWARE_TYPE_UNSPECIFIED")
  ...
  public enum CpuHyperThreading: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      var container = encoder.singleValueContainer()
      switch self {
      case .unspecified: return try container.encode("CPU_HYPER_THREADING_UNSPECIFIED")
