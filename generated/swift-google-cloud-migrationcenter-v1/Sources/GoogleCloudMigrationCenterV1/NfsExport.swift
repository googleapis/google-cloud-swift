  ...
  Sendable
{
  ...
  public var exportDirectory: Swift.String = Swift.String()
  ...
  ///
  /// ```
  /// let value = NfsExport().with { $0.exportDirectory = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.migrationcenter.v1.NfsExport"
  }
