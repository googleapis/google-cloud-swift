...
public struct DeleteImportJobRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteImportJobRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteImportJobRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.migrationcenter.v1.DeleteImportJobRequest"
  }
