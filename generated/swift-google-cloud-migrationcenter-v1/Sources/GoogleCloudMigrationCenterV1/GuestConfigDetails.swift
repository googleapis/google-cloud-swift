...
public struct GuestConfigDetails: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var fstab: FstabEntryList? = nil

  /// Hosts file (/etc/hosts).
  public var hosts: HostsEntryList? = nil

  /// NFS exports.
  public var nfsExports: NfsExportList? = nil
  ...
  ///
  /// ```
  /// let value = GuestConfigDetails().with { $0.issue = ... }
  /// ```
  ...
  public enum SeLinuxMode: Codable, Equatable, Sendable {
    ...
    public var intValue: Int? {
      ...
      case .permissive: return 2
      case .enforcing: return 3
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "SE_LINUX_MODE_UNSPECIFIED"
      case .disabled: return "SE_LINUX_MODE_DISABLED"
      case .permissive: return "SE_LINUX_MODE_PERMISSIVE"
      case .enforcing: return "SE_LINUX_MODE_ENFORCING"
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:SeLinuxMode/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "SE_LINUX_MODE_UNSPECIFIED": self = .unspecified
      case "SE_LINUX_MODE_DISABLED": self = .disabled
      case "SE_LINUX_MODE_PERMISSIVE": self = .permissive
      case "SE_LINUX_MODE_ENFORCING": self = .enforcing
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:SeLinuxMode/unknownIntValue(_:)).
    public init(intValue: Int) {
      switch intValue {
      case 0: self = .unspecified
      case 1: self = .disabled
      case 2: self = .permissive
      case 3: self = .enforcing
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("SE_LINUX_MODE_UNSPECIFIED")
      case .disabled: return try container.encode("SE_LINUX_MODE_DISABLED")
      case .permissive: return try container.encode("SE_LINUX_MODE_PERMISSIVE")
      case .enforcing: return try container.encode("SE_LINUX_MODE_ENFORCING")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.migrationcenter.v1.GuestConfigDetails"
  }
