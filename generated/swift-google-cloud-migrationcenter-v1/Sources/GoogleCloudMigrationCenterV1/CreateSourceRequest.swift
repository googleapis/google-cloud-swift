...
public struct CreateSourceRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CreateSourceRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateSourceRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.migrationcenter.v1.CreateSourceRequest"
  }
