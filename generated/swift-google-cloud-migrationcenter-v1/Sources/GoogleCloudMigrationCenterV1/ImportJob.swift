  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let validationReport = CodingKeys(stringValue: "validationReport")
    static let executionReport = CodingKeys(stringValue: "executionReport")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .assetSource) {
