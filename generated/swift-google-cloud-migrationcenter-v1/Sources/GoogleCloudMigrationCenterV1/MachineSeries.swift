...
public struct MachineSeries: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `MachineSeries`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = MachineSeries().with { $0.code = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.migrationcenter.v1.MachineSeries"
  }
