...
public struct CreateReportRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var reportId: Swift.String = Swift.String()
  ...
  /// Initialize a new instance of `CreateReportRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateReportRequest().with { $0.parent = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let reportId = CodingKeys(stringValue: "reportId")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .reportId) {
      self.reportId = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.migrationcenter.v1.CreateReportRequest"
  }
