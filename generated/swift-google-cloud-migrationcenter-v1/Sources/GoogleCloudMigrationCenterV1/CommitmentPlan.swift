...
public enum CommitmentPlan: Codable, Equatable, Hashable, Sendable {
  ...
  public var stringValue: Swift.String? {
    ...
    case .`none`: return "COMMITMENT_PLAN_NONE"
    case .oneYear: return "COMMITMENT_PLAN_ONE_YEAR"
    case .threeYears: return "COMMITMENT_PLAN_THREE_YEARS"
  ...
  public init(stringValue: Swift.String) {
    ...
    case "COMMITMENT_PLAN_NONE": self = .`none`
    case "COMMITMENT_PLAN_ONE_YEAR": self = .oneYear
    case "COMMITMENT_PLAN_THREE_YEARS": self = .threeYears
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    case .`none`: return try container.encode("COMMITMENT_PLAN_NONE")
    case .oneYear: return try container.encode("COMMITMENT_PLAN_ONE_YEAR")
    case .threeYears: return try container.encode("COMMITMENT_PLAN_THREE_YEARS")
