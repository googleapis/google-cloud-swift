...
public struct UpdateImportJobRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateImportJobRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateImportJobRequest().with { $0.updateMask = ... }
  /// ```
