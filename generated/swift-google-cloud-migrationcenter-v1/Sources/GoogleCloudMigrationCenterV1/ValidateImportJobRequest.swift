  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ValidateImportJobRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ValidateImportJobRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.migrationcenter.v1.ValidateImportJobRequest"
  }
