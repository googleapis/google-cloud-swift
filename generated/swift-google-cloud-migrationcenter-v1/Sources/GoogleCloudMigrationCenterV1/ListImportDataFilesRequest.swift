  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListImportDataFilesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListImportDataFilesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.migrationcenter.v1.ListImportDataFilesRequest"
  }
