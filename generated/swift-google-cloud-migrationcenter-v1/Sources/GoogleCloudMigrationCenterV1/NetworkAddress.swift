  ...
  Sendable
{
  ...
  ///   them to named cases.
  public enum AddressAssignment: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("ADDRESS_ASSIGNMENT_UNSPECIFIED")
      case .`static`: return try container.encode("ADDRESS_ASSIGNMENT_STATIC")
      case .dhcp: return try container.encode("ADDRESS_ASSIGNMENT_DHCP")
