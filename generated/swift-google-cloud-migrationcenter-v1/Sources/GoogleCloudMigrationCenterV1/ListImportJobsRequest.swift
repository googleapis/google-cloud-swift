...
public struct ListImportJobsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var view: ImportJobView = ImportJobView()
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(ImportJobView.self, forKey: .view) {
      self.view = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.migrationcenter.v1.ListImportJobsRequest"
  }
