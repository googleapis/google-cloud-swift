  ...
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .apiConfig) {
      self.apiConfig = value
    }
    if let value = try container.decodeIfPresent(Gateway.State.self, forKey: .state) {
      self.state = value
    }
