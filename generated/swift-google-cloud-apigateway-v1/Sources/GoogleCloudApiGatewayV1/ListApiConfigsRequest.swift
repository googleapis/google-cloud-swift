...
public struct ListApiConfigsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListApiConfigsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListApiConfigsRequest().with { $0.parent = ... }
  /// ```
