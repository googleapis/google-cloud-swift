  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let managedService = CodingKeys(stringValue: "managedService")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .managedService) {
      self.managedService = value
    }
    if let value = try container.decodeIfPresent(Api.State.self, forKey: .state) {
      self.state = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.managedService, forKey: .managedService)
