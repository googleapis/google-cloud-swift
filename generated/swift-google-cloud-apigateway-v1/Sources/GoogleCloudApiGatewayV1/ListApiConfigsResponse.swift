...
public struct ListApiConfigsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// API Configs.
  ...
  /// Initialize a new instance of `ListApiConfigsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListApiConfigsResponse().with { $0.apiConfigs = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let apiConfigs = CodingKeys(stringValue: "apiConfigs")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([ApiConfig].self, forKey: .apiConfigs) {
      self.apiConfigs = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.apiConfigs, forKey: .apiConfigs)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apigateway.v1.ListApiConfigsResponse"
  }
...
extension ListApiConfigsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [ApiConfig] {
