...
public struct GetApiConfigRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = GetApiConfigRequest().with { $0.name = ... }
  /// ```
  ...
  public enum ConfigView: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("CONFIG_VIEW_UNSPECIFIED")
