...
public struct GetGoogleServiceAccountRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetGoogleServiceAccountRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetGoogleServiceAccountRequest().with { $0.projectId = ... }
  /// ```
