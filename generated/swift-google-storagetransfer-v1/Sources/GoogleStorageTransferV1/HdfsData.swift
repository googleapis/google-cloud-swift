...
public struct HdfsData: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `HdfsData`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = HdfsData().with { $0.path = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.storagetransfer.v1.HdfsData"
  }
