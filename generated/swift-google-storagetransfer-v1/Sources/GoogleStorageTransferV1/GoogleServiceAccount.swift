...
public struct GoogleServiceAccount: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Email address of the service account.
  public var accountEmail: Swift.String = Swift.String()
  ...
  ///
  /// ```
  /// let value = GoogleServiceAccount().with { $0.accountEmail = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.storagetransfer.v1.GoogleServiceAccount"
  }
