...
public struct DeleteTransferJobRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteTransferJobRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteTransferJobRequest().with { $0.jobName = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.storagetransfer.v1.DeleteTransferJobRequest"
  }
