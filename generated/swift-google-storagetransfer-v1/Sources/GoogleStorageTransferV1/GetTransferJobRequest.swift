...
public struct GetTransferJobRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetTransferJobRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetTransferJobRequest().with { $0.jobName = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.storagetransfer.v1.GetTransferJobRequest"
  }
