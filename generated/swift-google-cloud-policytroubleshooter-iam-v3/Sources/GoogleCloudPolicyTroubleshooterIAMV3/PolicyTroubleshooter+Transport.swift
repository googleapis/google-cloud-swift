...
extension Clients {
  final class PolicyTroubleshooterTransport: PolicyTroubleshooterStub {
    ...
    public func troubleshootIamPolicy(
      ...
      return try await req.rpc(
        GoogleCloudPolicyTroubleshooterIAMV3.TroubleshootIamPolicyResponse.self,
