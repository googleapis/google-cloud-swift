...
public enum AttributeType: Codable, Equatable, Hashable, Sendable {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    case .commonName: return try container.encode("COMMON_NAME")
    case .countryCode: return try container.encode("COUNTRY_CODE")
    case .organization: return try container.encode("ORGANIZATION")
    case .organizationalUnit: return try container.encode("ORGANIZATIONAL_UNIT")
    case .locality: return try container.encode("LOCALITY")
    case .province: return try container.encode("PROVINCE")
