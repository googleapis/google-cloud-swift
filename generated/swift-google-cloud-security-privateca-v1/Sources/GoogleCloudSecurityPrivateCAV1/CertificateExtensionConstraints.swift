...
/// issuance controls.
public struct CertificateExtensionConstraints: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///   them to named cases.
  public enum KnownCertificateExtension: Codable, Equatable, Hashable, Sendable {
    /// Not specified.
    case unspecified
