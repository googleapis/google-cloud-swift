...
public struct ListCertificateAuthoritiesResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The list of
...
extension ListCertificateAuthoritiesResponse: GoogleGax._PaginatedResponse {
