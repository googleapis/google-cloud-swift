  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let caPools = CodingKeys(stringValue: "caPools")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([CaPool].self, forKey: .caPools) {
      self.caPools = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.caPools, forKey: .caPools)
