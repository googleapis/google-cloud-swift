...
public struct ActivateCertificateAuthorityRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let pemCaCertificate = CodingKeys(stringValue: "pemCaCertificate")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .pemCaCertificate) {
      self.pemCaCertificate = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.pemCaCertificate, forKey: .pemCaCertificate)
