...
public enum SubjectRequestMode: Codable, Equatable, Hashable, Sendable {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    switch self {
    case .unspecified: return try container.encode("SUBJECT_REQUEST_MODE_UNSPECIFIED")
    case .`default`: return try container.encode("DEFAULT")
    case .reflectedSpiffe: return try container.encode("REFLECTED_SPIFFE")
    case .rdnSequence: return try container.encode("RDN_SEQUENCE")
