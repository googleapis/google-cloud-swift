...
public struct RevokeCertificateRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(RevocationReason.self, forKey: .reason) {
      self.reason = value
    }
