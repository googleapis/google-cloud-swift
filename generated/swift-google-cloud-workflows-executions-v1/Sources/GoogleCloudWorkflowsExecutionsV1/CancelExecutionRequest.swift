...
/// method.
///
/// [google.cloud.workflows.executions.v1.Executions.CancelExecution]: <doc:ExecutionsClient/cancelExecution(request:options:)>
public struct CancelExecutionRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
