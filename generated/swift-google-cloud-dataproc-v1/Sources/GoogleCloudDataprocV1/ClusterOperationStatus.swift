  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let innerState = CodingKeys(stringValue: "innerState")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(ClusterOperationStatus.State.self, forKey: .state)
    {
      self.state = value
    }
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .innerState) {
      self.innerState = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.innerState, forKey: .innerState)
