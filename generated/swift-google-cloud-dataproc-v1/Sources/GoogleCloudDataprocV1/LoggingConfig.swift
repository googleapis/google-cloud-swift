  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let driverLogLevels = CodingKeys(stringValue: "driverLogLevels")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [Swift.String: LoggingConfig.Level].self, forKey: .driverLogLevels)
    {
      self.driverLogLevels = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.driverLogLevels, forKey: .driverLogLevels)
  ...
  public enum Level: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .fatal: return try container.encode("FATAL")
