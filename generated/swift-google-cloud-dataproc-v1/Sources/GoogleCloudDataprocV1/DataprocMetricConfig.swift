...
public struct DataprocMetricConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///   them to named cases.
  public enum MetricSource: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .monitoringAgentDefaults: return try container.encode("MONITORING_AGENT_DEFAULTS")
      case .hdfs: return try container.encode("HDFS")
      case .spark: return try container.encode("SPARK")
      case .yarn: return try container.encode("YARN")
      case .sparkHistoryServer: return try container.encode("SPARK_HISTORY_SERVER")
      case .hiveserver2: return try container.encode("HIVESERVER2")
      case .hivemetastore: return try container.encode("HIVEMETASTORE")
      case .flink: return try container.encode("FLINK")
