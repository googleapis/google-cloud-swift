...
public struct ListWorkflowTemplatesResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListWorkflowTemplatesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListWorkflowTemplatesResponse().with { $0.templates = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([WorkflowTemplate].self, forKey: .templates) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataproc.v1.ListWorkflowTemplatesResponse"
  }
