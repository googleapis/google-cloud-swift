  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListSessionTemplatesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListSessionTemplatesResponse().with { $0.sessionTemplates = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let sessionTemplates = CodingKeys(stringValue: "sessionTemplates")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([SessionTemplate].self, forKey: .sessionTemplates)
    {
      self.sessionTemplates = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.sessionTemplates, forKey: .sessionTemplates)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataproc.v1.ListSessionTemplatesResponse"
  }
