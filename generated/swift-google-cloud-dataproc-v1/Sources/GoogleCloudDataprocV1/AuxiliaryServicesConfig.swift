...
public struct AuxiliaryServicesConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `AuxiliaryServicesConfig`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AuxiliaryServicesConfig().with { $0.metastoreConfig = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataproc.v1.AuxiliaryServicesConfig"
  }
