...
public struct ListBatchesResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListBatchesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListBatchesResponse().with { $0.batches = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let batches = CodingKeys(stringValue: "batches")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Batch].self, forKey: .batches) {
      self.batches = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataproc.v1.ListBatchesResponse"
  }
