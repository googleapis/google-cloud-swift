...
public struct NodeGroupAffinity: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let nodeGroupUri = CodingKeys(stringValue: "nodeGroupUri")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .nodeGroupUri) {
      self.nodeGroupUri = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.nodeGroupUri, forKey: .nodeGroupUri)
