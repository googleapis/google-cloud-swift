...
extension Clients {
  final class JobControllerLogging: JobControllerStub {
    let inner: any JobControllerStub
    let logger: Logger

    public init(_ inner: any JobControllerStub, logger: Logger) {
      var logger = logger
      logger[metadataKey: "gcp.artifact.id"] = "google-cloud-dataproc-v1"
      logger[metadataKey: "gcp.client.service"] = "dataproc"
      logger[metadataKey: "gcp.experimental.swift.client"] = "JobController"
      self.inner = inner
      self.logger = logger
    }
    ...
    public func submitJob(
      ...
      try await self._intercept(
        ...
        name: "submitJob",
        action: {
          (r: SubmitJobRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleCloudDataprocV1.Job
          in
          return try await self.inner.submitJob(request: r, options: o)
        })
    }
    ...
    public func submitJobAsOperation(
      ...
      try await self._intercept(
        ...
        action: {
          ...
          in
          return try await self.inner.submitJobAsOperation(request: r, options: o)
        })
    }
