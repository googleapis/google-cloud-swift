...
extension Clients {
  final class SessionTemplateControllerRetry: SessionTemplateControllerStub {
    let inner: any SessionTemplateControllerStub
    let options: GoogleCloudGax.ClientOptions

    public init(_ inner: any SessionTemplateControllerStub, options: GoogleCloudGax.ClientOptions) {
      self.inner = inner
