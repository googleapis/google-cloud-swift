...
public struct StartClusterRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `StartClusterRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = StartClusterRequest().with { $0.projectId = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataproc.v1.StartClusterRequest"
  }
