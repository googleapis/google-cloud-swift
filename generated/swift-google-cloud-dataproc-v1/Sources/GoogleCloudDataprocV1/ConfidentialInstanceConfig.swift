...
public struct ConfidentialInstanceConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var confidentialInstanceType: ConfidentialInstanceConfig.ConfidentialInstanceType =
  ...
  ///
  /// ```
  /// let value = ConfidentialInstanceConfig().with { $0.enableConfidentialCompute = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      ConfidentialInstanceConfig.ConfidentialInstanceType.self, forKey: .confidentialInstanceType)
    {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataproc.v1.ConfidentialInstanceConfig"
  }
