  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let executableFile = CodingKeys(stringValue: "executableFile")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .executableFile) {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.executableFile, forKey: .executableFile)
