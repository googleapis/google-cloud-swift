...
public struct AutotuningConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = AutotuningConfig().with { $0.scenarios = ... }
  /// ```
  ...
  ///   them to named cases.
  public enum Scenario: Codable, Equatable, Hashable, Sendable {
    /// Default value.
    case unspecified
    ...
    public var intValue: Int? {
      ...
      case .broadcastHashJoin: return 3
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "SCENARIO_UNSPECIFIED"
      case .scaling: return "SCALING"
      case .broadcastHashJoin: return "BROADCAST_HASH_JOIN"
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:Scenario/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "SCENARIO_UNSPECIFIED": self = .unspecified
      case "SCALING": self = .scaling
      case "BROADCAST_HASH_JOIN": self = .broadcastHashJoin
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:Scenario/unknownIntValue(_:)).
    public init(intValue: Int) {
      switch intValue {
      case 0: self = .unspecified
      case 2: self = .scaling
      case 3: self = .broadcastHashJoin
      case 4: self = .memory
      case 5: self = .`none`
      case 6: self = .auto
