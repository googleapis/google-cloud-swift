# Google Cloud Client Libraries for Swift - Cloud Dataproc API
...
Add `swift-google-cloud-dataproc-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-dataproc-v1.git --from 0.0.0-preview
```

Then add `GoogleCloudDataprocV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudDataprocV1 <target-name> --package swift-google-cloud-dataproc-v1
```
