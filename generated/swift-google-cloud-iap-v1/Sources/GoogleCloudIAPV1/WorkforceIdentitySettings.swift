...
/// access control.
public struct WorkforceIdentitySettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The workforce pool resources. Only one workforce pool is accepted.
  public var workforcePools: [Swift.String] = []
  ...
  ///
  /// ```
  /// let value = WorkforceIdentitySettings().with { $0.workforcePools = ... }
  /// ```
