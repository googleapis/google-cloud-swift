...
public struct ListIdentityAwareProxyClientsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListIdentityAwareProxyClientsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListIdentityAwareProxyClientsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.iap.v1.ListIdentityAwareProxyClientsRequest"
  }
