...
public struct AccessSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public enum IdentitySource: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("IDENTITY_SOURCE_UNSPECIFIED")
      case .workforceIdentityFederation:
        return try container.encode("WORKFORCE_IDENTITY_FEDERATION")
