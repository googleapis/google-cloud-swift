...
public struct UpdateIapSettingsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let iapSettings = CodingKeys(stringValue: "iapSettings")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.iapSettings = try container.decodeIfPresent(IapSettings.self, forKey: .iapSettings)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.iapSettings, forKey: .iapSettings)
