...
/// A TunnelDestGroup.
public struct TunnelDestGroup: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `TunnelDestGroup`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = TunnelDestGroup().with { $0.name = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let cidrs = CodingKeys(stringValue: "cidrs")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Swift.String].self, forKey: .cidrs) {
      self.cidrs = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.cidrs, forKey: .cidrs)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.iap.v1.TunnelDestGroup"
  }
