  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = CsmSettings().with { $0.rctokenAud = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let rctokenAud = CodingKeys(stringValue: "rctokenAud")
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.rctokenAud, forKey: .rctokenAud)
