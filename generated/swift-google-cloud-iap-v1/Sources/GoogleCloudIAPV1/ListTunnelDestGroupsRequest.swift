...
public struct ListTunnelDestGroupsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListTunnelDestGroupsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListTunnelDestGroupsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.iap.v1.ListTunnelDestGroupsRequest"
  }
