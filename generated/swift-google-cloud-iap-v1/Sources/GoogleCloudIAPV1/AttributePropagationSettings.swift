...
/// by IAP.
public struct AttributePropagationSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public enum OutputCredentials: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("OUTPUT_CREDENTIALS_UNSPECIFIED")
      case .header: return try container.encode("HEADER")
      case .jwt: return try container.encode("JWT")
      case .rctoken: return try container.encode("RCTOKEN")
