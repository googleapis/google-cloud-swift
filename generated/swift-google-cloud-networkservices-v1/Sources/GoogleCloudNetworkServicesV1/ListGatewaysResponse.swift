...
public struct ListGatewaysResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListGatewaysResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListGatewaysResponse().with { $0.gateways = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Gateway].self, forKey: .gateways) {
      self.gateways = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.ListGatewaysResponse"
  }
...
extension ListGatewaysResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Gateway] {
