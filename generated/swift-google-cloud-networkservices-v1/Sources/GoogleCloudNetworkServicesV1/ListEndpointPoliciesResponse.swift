  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let endpointPolicies = CodingKeys(stringValue: "endpointPolicies")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([EndpointPolicy].self, forKey: .endpointPolicies) {
      self.endpointPolicies = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.endpointPolicies, forKey: .endpointPolicies)
