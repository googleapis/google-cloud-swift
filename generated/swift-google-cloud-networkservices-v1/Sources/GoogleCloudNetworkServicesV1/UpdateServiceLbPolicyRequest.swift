...
public struct UpdateServiceLbPolicyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateServiceLbPolicyRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateServiceLbPolicyRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.UpdateServiceLbPolicyRequest"
  }
