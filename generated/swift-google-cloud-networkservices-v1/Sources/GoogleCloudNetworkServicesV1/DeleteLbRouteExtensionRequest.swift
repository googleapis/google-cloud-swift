...
public struct DeleteLbRouteExtensionRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteLbRouteExtensionRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteLbRouteExtensionRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.DeleteLbRouteExtensionRequest"
  }
