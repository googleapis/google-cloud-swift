  ...
  Sendable
{
  ...
  public var wasmPlugins: [WasmPlugin] = []
  ...
  /// Initialize a new instance of `ListWasmPluginsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListWasmPluginsResponse().with { $0.wasmPlugins = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let wasmPlugins = CodingKeys(stringValue: "wasmPlugins")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([WasmPlugin].self, forKey: .wasmPlugins) {
      self.wasmPlugins = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.wasmPlugins, forKey: .wasmPlugins)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.ListWasmPluginsResponse"
  }
