...
public struct UpdateAgentGatewayRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateAgentGatewayRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateAgentGatewayRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.UpdateAgentGatewayRequest"
  }
