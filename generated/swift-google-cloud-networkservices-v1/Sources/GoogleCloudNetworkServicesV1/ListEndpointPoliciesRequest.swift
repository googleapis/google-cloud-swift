...
public struct ListEndpointPoliciesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListEndpointPoliciesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListEndpointPoliciesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.ListEndpointPoliciesRequest"
  }
