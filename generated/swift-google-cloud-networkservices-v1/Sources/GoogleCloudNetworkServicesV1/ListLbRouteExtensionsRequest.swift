...
public struct ListLbRouteExtensionsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListLbRouteExtensionsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListLbRouteExtensionsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.ListLbRouteExtensionsRequest"
  }
