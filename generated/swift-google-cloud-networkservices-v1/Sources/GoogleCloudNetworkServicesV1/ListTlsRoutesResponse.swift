  ...
  Sendable
{
  ...
  ///
  /// [google.cloud.networkservices.v1.ListTlsRoutesRequest.return_partial_success]: <doc:ListTlsRoutesRequest/returnPartialSuccess>
  public var unreachable: [Swift.String] = []

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `ListTlsRoutesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListTlsRoutesResponse().with { $0.tlsRoutes = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let tlsRoutes = CodingKeys(stringValue: "tlsRoutes")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([TlsRoute].self, forKey: .tlsRoutes) {
      self.tlsRoutes = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.tlsRoutes, forKey: .tlsRoutes)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.ListTlsRoutesResponse"
  }
