...
public struct ListHttpRoutesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListHttpRoutesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListHttpRoutesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.ListHttpRoutesRequest"
  }
