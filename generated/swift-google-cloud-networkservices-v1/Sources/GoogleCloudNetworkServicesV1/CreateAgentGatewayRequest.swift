...
public struct CreateAgentGatewayRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var agentGatewayId: Swift.String = Swift.String()
  ...
  ///
  /// ```
  /// let value = CreateAgentGatewayRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.CreateAgentGatewayRequest"
  }
