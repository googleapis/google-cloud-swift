...
public struct ListMeshRouteViewsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListMeshRouteViewsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMeshRouteViewsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.ListMeshRouteViewsRequest"
  }
