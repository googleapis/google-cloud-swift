...
public struct ListWasmPluginVersionsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListWasmPluginVersionsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListWasmPluginVersionsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.ListWasmPluginVersionsRequest"
  }
