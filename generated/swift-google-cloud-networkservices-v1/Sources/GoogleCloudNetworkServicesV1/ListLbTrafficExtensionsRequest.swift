...
public struct ListLbTrafficExtensionsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListLbTrafficExtensionsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListLbTrafficExtensionsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.ListLbTrafficExtensionsRequest"
  }
