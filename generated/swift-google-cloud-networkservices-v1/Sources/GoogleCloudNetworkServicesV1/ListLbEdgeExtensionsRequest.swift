...
public struct ListLbEdgeExtensionsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListLbEdgeExtensionsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListLbEdgeExtensionsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.ListLbEdgeExtensionsRequest"
  }
