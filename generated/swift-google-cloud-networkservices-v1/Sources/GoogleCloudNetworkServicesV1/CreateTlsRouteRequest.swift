...
public struct CreateTlsRouteRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var tlsRouteId: Swift.String = Swift.String()
  ...
  ///
  /// ```
  /// let value = CreateTlsRouteRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.CreateTlsRouteRequest"
  }
