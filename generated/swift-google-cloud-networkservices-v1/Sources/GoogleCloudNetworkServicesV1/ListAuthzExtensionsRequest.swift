...
public struct ListAuthzExtensionsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListAuthzExtensionsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAuthzExtensionsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.ListAuthzExtensionsRequest"
  }
