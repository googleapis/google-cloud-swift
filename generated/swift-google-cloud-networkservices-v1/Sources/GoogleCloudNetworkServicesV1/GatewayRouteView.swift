  ...
  Sendable
{
  ...
  /// Initialize a new instance of `GatewayRouteView`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GatewayRouteView().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.GatewayRouteView"
  }
