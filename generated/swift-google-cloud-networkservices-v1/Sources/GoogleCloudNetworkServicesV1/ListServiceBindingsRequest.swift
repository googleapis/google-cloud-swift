...
public struct ListServiceBindingsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListServiceBindingsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListServiceBindingsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.ListServiceBindingsRequest"
  }
