...
public struct ListGatewayRouteViewsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// List of GatewayRouteView resources.
  public var gatewayRouteViews: [GatewayRouteView] = []
  ...
  /// Initialize a new instance of `ListGatewayRouteViewsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListGatewayRouteViewsResponse().with { $0.gatewayRouteViews = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let gatewayRouteViews = CodingKeys(stringValue: "gatewayRouteViews")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.ListGatewayRouteViewsResponse"
  }
...
extension ListGatewayRouteViewsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [GatewayRouteView] {
    return self.gatewayRouteViews
  }
