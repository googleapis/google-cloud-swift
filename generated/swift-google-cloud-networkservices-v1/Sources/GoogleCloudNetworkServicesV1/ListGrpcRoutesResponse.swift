  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let grpcRoutes = CodingKeys(stringValue: "grpcRoutes")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([GrpcRoute].self, forKey: .grpcRoutes) {
      self.grpcRoutes = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.grpcRoutes, forKey: .grpcRoutes)
