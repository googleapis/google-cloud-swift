...
public struct UpdateGatewayRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateGatewayRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateGatewayRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.UpdateGatewayRequest"
  }
