...
public enum BodySendMode: Codable, Equatable, Hashable, Sendable {
  ...
  public var intValue: Int? {
    ...
    case .streamed: return 1
    case .fullDuplexStreamed: return 2
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "BODY_SEND_MODE_UNSPECIFIED"
    case .streamed: return "BODY_SEND_MODE_STREAMED"
    case .fullDuplexStreamed: return "BODY_SEND_MODE_FULL_DUPLEX_STREAMED"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:BodySendMode/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "BODY_SEND_MODE_UNSPECIFIED": self = .unspecified
    case "BODY_SEND_MODE_STREAMED": self = .streamed
    case "BODY_SEND_MODE_FULL_DUPLEX_STREAMED": self = .fullDuplexStreamed
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:BodySendMode/unknownIntValue(_:)).
  public init(intValue: Int) {
    switch intValue {
    case 0: self = .unspecified
    case 1: self = .streamed
    case 2: self = .fullDuplexStreamed
