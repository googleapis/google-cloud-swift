...
public struct DeleteLbEdgeExtensionRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteLbEdgeExtensionRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteLbEdgeExtensionRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.DeleteLbEdgeExtensionRequest"
  }
