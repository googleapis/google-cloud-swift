...
public struct DeleteLbTrafficExtensionRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteLbTrafficExtensionRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteLbTrafficExtensionRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.DeleteLbTrafficExtensionRequest"
  }
