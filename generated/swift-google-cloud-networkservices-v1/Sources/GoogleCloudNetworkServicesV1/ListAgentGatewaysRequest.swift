...
public struct ListAgentGatewaysRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListAgentGatewaysRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAgentGatewaysRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.ListAgentGatewaysRequest"
  }
