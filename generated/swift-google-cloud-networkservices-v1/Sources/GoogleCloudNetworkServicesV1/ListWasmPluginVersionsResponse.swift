...
public struct ListWasmPluginVersionsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let wasmPluginVersions = CodingKeys(stringValue: "wasmPluginVersions")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [WasmPluginVersion].self, forKey: .wasmPluginVersions)
    {
      self.wasmPluginVersions = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.wasmPluginVersions, forKey: .wasmPluginVersions)
...
extension ListWasmPluginVersionsResponse: GoogleGax._PaginatedResponse {
