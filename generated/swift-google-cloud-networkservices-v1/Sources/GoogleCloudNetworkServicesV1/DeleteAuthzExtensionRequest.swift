...
public struct DeleteAuthzExtensionRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteAuthzExtensionRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteAuthzExtensionRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.DeleteAuthzExtensionRequest"
  }
