...
public struct UpdateServiceBindingRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateServiceBindingRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateServiceBindingRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.UpdateServiceBindingRequest"
  }
