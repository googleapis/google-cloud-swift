...
public struct ListServiceLbPoliciesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListServiceLbPoliciesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListServiceLbPoliciesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.ListServiceLbPoliciesRequest"
  }
