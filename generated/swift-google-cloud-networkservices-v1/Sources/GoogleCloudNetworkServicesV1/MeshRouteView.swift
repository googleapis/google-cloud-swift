...
public struct MeshRouteView: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var routeProjectNumber: Swift.Int64 = Swift.Int64()

  /// Output only. Location where the route exists.
  public var routeLocation: Swift.String = Swift.String()

  /// Output only. Type of the route: HttpRoute,GrpcRoute,TcpRoute, or TlsRoute
  public var routeType: Swift.String = Swift.String()
  ...
  ///
  /// ```
  /// let value = MeshRouteView().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.MeshRouteView"
  }
