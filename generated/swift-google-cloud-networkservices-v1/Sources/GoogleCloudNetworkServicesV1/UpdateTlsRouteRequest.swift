...
public struct UpdateTlsRouteRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateTlsRouteRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateTlsRouteRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.UpdateTlsRouteRequest"
  }
