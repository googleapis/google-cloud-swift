...
public struct ListServiceBindingsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// List of ServiceBinding resources.
  public var serviceBindings: [ServiceBinding] = []
  ...
  /// Initialize a new instance of `ListServiceBindingsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListServiceBindingsResponse().with { $0.serviceBindings = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([ServiceBinding].self, forKey: .serviceBindings) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.ListServiceBindingsResponse"
  }
...
extension ListServiceBindingsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [ServiceBinding] {
    return self.serviceBindings
  }
