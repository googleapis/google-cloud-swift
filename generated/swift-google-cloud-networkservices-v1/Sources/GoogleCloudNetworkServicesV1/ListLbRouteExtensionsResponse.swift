  ...
  Sendable
{
  ...
  public var lbRouteExtensions: [LbRouteExtension] = []
  ...
  /// Initialize a new instance of `ListLbRouteExtensionsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListLbRouteExtensionsResponse().with { $0.lbRouteExtensions = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let lbRouteExtensions = CodingKeys(stringValue: "lbRouteExtensions")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [LbRouteExtension].self, forKey: .lbRouteExtensions)
    {
      self.lbRouteExtensions = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.lbRouteExtensions, forKey: .lbRouteExtensions)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkservices.v1.ListLbRouteExtensionsResponse"
  }
