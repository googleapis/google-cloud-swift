...
func sample(
  ...
  let poller = try await client.deleteEndpointPolicyPollingUntilDone(
    request: DeleteEndpointPolicyRequest()
      .with {
        $0.name =
          "projects/\(projectId)/locations/\(locationId)/endpointPolicies/\(endpointPolicyId)"
      }
  )
