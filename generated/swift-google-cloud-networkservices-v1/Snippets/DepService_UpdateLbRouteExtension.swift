...
func sample(
  ...
  let poller = try await client.updateLbRouteExtension(
    withPolling: UpdateLbRouteExtensionRequest()
      .with {
        $0.lbRouteExtension = LbRouteExtension().with {
          $0.name =
  ...
  static func main() async throws {
    do {
      ...
      try await sample(
        ...
        lbRouteExtensionId: "[placeholder]")
    } catch {
      print("Error: \(error)")
    }
  }
