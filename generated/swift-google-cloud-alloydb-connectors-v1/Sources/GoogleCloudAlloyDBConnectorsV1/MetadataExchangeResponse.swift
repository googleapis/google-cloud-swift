...
public struct MetadataExchangeResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Response code.
  public var responseCode: MetadataExchangeResponse.ResponseCode =
  ...
  /// Initialize a new instance of `MetadataExchangeResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = MetadataExchangeResponse().with { $0.responseCode = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      MetadataExchangeResponse.ResponseCode.self, forKey: .responseCode)
    {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.alloydb.connectors.v1.MetadataExchangeResponse"
  }
