  ...
  Sendable
{
  ...
  /// Initialize a new instance of `VertexAutoMLVisionConfig`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = VertexAutoMLVisionConfig().with { $0.confidenceThreshold = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.VertexAutoMLVisionConfig"
  }
