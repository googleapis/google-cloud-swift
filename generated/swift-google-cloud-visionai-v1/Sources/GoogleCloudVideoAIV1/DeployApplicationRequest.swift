...
public struct DeployApplicationRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// deployment.
  public var enableMonitoring: Swift.Bool = Swift.Bool()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `DeployApplicationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeployApplicationRequest().with { $0.name = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let enableMonitoring = CodingKeys(stringValue: "enableMonitoring")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.Bool.self, forKey: .enableMonitoring) {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.enableMonitoring, forKey: .enableMonitoring)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.DeployApplicationRequest"
  }
