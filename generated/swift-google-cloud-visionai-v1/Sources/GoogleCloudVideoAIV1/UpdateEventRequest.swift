...
public struct UpdateEventRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateEventRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateEventRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.UpdateEventRequest"
  }
