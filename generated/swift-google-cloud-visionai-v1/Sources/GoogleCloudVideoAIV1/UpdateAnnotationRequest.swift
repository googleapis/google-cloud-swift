...
public struct UpdateAnnotationRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateAnnotationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateAnnotationRequest().with { $0.annotation = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.UpdateAnnotationRequest"
  }
