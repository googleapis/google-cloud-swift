...
public enum RunMode: Codable, Equatable, Hashable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "RUN_MODE_UNSPECIFIED"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:RunMode/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "RUN_MODE_UNSPECIFIED": self = .unspecified
    case "LIVE": self = .live
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:RunMode/unknownIntValue(_:)).
  public init(intValue: Int) {
    switch intValue {
    case 0: self = .unspecified
    case 1: self = .live
    case 2: self = .submission
