...
public struct ListApplicationsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListApplicationsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListApplicationsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.ListApplicationsRequest"
  }
