...
public struct SearchCapability: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The search capability to enable.
  public var type: SearchCapability.Type_ = SearchCapability.Type_()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `SearchCapability`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SearchCapability().with { $0.type = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(SearchCapability.Type_.self, forKey: .type) {
      self.type = value
    }
  ...
  public enum Type_: Codable, Equatable, Hashable, Sendable {
    ...
    public var stringValue: Swift.String? {
      ...
      case .embeddingSearch: return "EMBEDDING_SEARCH"
    ...
    public init(stringValue: Swift.String) {
      ...
      case "EMBEDDING_SEARCH": self = .embeddingSearch
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .embeddingSearch: return try container.encode("EMBEDDING_SEARCH")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.SearchCapability"
  }
