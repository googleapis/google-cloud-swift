...
public struct ReleaseLeaseRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Lease id.
  ...
  /// Initialize a new instance of `ReleaseLeaseRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ReleaseLeaseRequest().with { $0.id = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.ReleaseLeaseRequest"
  }
