...
public struct UpdateProcessorRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateProcessorRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateProcessorRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.UpdateProcessorRequest"
  }
