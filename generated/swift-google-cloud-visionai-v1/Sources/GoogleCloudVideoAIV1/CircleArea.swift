...
public struct CircleArea: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var radiusMeter: Swift.Double = Swift.Double()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `CircleArea`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CircleArea().with { $0.latitude = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let radiusMeter = CodingKeys(stringValue: "radiusMeter")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.Double.self, forKey: .radiusMeter) {
      self.radiusMeter = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.radiusMeter, forKey: .radiusMeter)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.CircleArea"
  }
