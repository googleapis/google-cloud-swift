...
public struct UpdateAnalysisRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateAnalysisRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateAnalysisRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.UpdateAnalysisRequest"
  }
