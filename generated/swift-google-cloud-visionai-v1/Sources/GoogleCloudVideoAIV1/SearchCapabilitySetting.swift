...
public struct SearchCapabilitySetting: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = SearchCapabilitySetting().with { $0.searchCapabilities = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.SearchCapabilitySetting"
  }
