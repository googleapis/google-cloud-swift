...
public struct AcquireLeaseRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The series name.
  ...
  /// The lease term.
  public var term: GoogleWKT.WKTDuration? = nil
  ...
  /// Initialize a new instance of `AcquireLeaseRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AcquireLeaseRequest().with { $0.series = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.term = try container.decodeIfPresent(GoogleWKT.WKTDuration.self, forKey: .term)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.AcquireLeaseRequest"
  }
