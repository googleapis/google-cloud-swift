...
public struct ListSeriesResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The list of Series.
  ...
  /// Initialize a new instance of `ListSeriesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListSeriesResponse().with { $0.series = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Series].self, forKey: .series) {
      self.series = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.ListSeriesResponse"
  }
...
extension ListSeriesResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Series] {
    return self.series
  }
