...
public struct HealthCheckRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `HealthCheckRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = HealthCheckRequest().with { $0.cluster = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.HealthCheckRequest"
  }
