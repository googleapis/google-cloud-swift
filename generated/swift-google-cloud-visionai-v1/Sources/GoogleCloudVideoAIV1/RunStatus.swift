...
public struct RunStatus: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The state of the Process.
  public var state: RunStatus.State = RunStatus.State()
  ...
  /// Initialize a new instance of `RunStatus`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RunStatus().with { $0.state = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(RunStatus.State.self, forKey: .state) {
      self.state = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.RunStatus"
  }
