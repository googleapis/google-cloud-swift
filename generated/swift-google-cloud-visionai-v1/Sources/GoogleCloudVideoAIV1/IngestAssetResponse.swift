  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = IngestAssetResponse().with { $0.successfullyIngestedPartition = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let successfullyIngestedPartition = CodingKeys(
      stringValue: "successfullyIngestedPartition")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.successfullyIngestedPartition = try container.decodeIfPresent(
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(
      self.successfullyIngestedPartition, forKey: .successfullyIngestedPartition)
