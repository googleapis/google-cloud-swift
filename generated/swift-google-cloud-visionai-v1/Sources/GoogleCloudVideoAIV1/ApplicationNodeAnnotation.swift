...
public struct ApplicationNodeAnnotation: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ApplicationNodeAnnotation`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ApplicationNodeAnnotation().with { $0.node = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.ApplicationNodeAnnotation"
  }
