...
public struct DeleteApplicationRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteApplicationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteApplicationRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.DeleteApplicationRequest"
  }
