...
public struct CreateApplicationRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CreateApplicationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateApplicationRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.CreateApplicationRequest"
  }
