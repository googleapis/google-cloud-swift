...
public struct ListOperatorsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListOperatorsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListOperatorsResponse().with { $0.operators = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.ListOperatorsResponse"
  }
...
extension ListOperatorsResponse: GoogleGax._PaginatedResponse {
