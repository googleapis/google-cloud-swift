...
public struct MaterializeChannelRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `MaterializeChannelRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = MaterializeChannelRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.MaterializeChannelRequest"
  }
