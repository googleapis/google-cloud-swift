  ...
  Sendable
{
  ...
  /// to obtain that page.
  ///
  /// [google.cloud.visionai.v1.ListCorporaRequest.page_token]: <doc:ListCorporaRequest/pageToken>
  public var nextPageToken: Swift.String = Swift.String()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `ListCorporaResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCorporaResponse().with { $0.corpora = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let corpora = CodingKeys(stringValue: "corpora")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Corpus].self, forKey: .corpora) {
      self.corpora = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.corpora, forKey: .corpora)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.ListCorporaResponse"
  }
