...
public struct UpdateApplicationStreamInputRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var applicationStreamInputs: [ApplicationStreamInput] = []
  ...
  /// Initialize a new instance of `UpdateApplicationStreamInputRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateApplicationStreamInputRequest().with { $0.name = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let applicationStreamInputs = CodingKeys(stringValue: "applicationStreamInputs")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [ApplicationStreamInput].self, forKey: .applicationStreamInputs)
    {
      self.applicationStreamInputs = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.applicationStreamInputs, forKey: .applicationStreamInputs)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.UpdateApplicationStreamInputRequest"
  }
