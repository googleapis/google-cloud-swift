...
public struct ListDraftsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The list of Draft.
  ...
  /// Initialize a new instance of `ListDraftsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDraftsResponse().with { $0.drafts = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let drafts = CodingKeys(stringValue: "drafts")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Draft].self, forKey: .drafts) {
      self.drafts = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.ListDraftsResponse"
  }
...
extension ListDraftsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Draft] {
    return self.drafts
  }
