...
public struct ReceivePacketsControlResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ReceivePacketsControlResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ReceivePacketsControlResponse().with { $0.heartbeat = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.ReceivePacketsControlResponse"
  }
