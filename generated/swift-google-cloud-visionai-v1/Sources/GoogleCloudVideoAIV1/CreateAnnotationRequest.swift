...
public struct CreateAnnotationRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var annotationId: Swift.String? = nil

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `CreateAnnotationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateAnnotationRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.CreateAnnotationRequest"
  }
