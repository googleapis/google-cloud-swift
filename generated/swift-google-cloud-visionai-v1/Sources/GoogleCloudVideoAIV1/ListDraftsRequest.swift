...
public struct ListDraftsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDraftsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDraftsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.ListDraftsRequest"
  }
