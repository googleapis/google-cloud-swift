...
public enum StreamAnnotationType: Codable, Equatable, Hashable, Sendable {
  ...
  public var intValue: Int? {
    ...
    case .activeZone: return 1
    case .crossingLine: return 2
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "STREAM_ANNOTATION_TYPE_UNSPECIFIED"
    case .activeZone: return "STREAM_ANNOTATION_TYPE_ACTIVE_ZONE"
    case .crossingLine: return "STREAM_ANNOTATION_TYPE_CROSSING_LINE"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:StreamAnnotationType/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "STREAM_ANNOTATION_TYPE_UNSPECIFIED": self = .unspecified
    case "STREAM_ANNOTATION_TYPE_ACTIVE_ZONE": self = .activeZone
    case "STREAM_ANNOTATION_TYPE_CROSSING_LINE": self = .crossingLine
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:StreamAnnotationType/unknownIntValue(_:)).
  public init(intValue: Int) {
    switch intValue {
    case 0: self = .unspecified
    case 1: self = .activeZone
    case 2: self = .crossingLine
