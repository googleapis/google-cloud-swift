...
public struct CreateApplicationInstancesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var applicationInstances: [ApplicationInstance] = []
  ...
  /// Initialize a new instance of `CreateApplicationInstancesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateApplicationInstancesRequest().with { $0.name = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [ApplicationInstance].self, forKey: .applicationInstances)
    {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.CreateApplicationInstancesRequest"
  }
