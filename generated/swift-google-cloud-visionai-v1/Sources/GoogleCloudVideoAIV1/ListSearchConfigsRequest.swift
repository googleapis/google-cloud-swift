...
public struct ListSearchConfigsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListSearchConfigsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListSearchConfigsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.ListSearchConfigsRequest"
  }
