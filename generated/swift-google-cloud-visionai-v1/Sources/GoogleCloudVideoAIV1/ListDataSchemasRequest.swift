...
public struct ListDataSchemasRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDataSchemasRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDataSchemasRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.ListDataSchemasRequest"
  }
