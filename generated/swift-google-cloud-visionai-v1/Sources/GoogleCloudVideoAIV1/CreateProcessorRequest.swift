  ...
  Sendable
{
  ...
  public var processorId: Swift.String = Swift.String()
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let processorId = CodingKeys(stringValue: "processorId")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .processorId) {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.processorId, forKey: .processorId)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.CreateProcessorRequest"
  }
