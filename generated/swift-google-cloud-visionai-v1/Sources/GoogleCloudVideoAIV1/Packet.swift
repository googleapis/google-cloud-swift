...
public struct Packet: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The packet header.
  public var header: PacketHeader? = nil
  ...
  ///
  /// ```
  /// let value = Packet().with { $0.header = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.header = try container.decodeIfPresent(PacketHeader.self, forKey: .header)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.Packet"
  }
