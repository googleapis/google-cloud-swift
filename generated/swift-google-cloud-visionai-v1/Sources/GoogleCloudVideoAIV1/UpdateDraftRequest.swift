...
public struct UpdateDraftRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateDraftRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateDraftRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.UpdateDraftRequest"
  }
