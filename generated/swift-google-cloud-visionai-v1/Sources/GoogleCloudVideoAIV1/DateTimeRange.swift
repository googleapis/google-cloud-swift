...
/// Datetime range type.
public struct DateTimeRange: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Start date time.
  public var start: GoogleType.DateTime? = nil

  /// End data time.
  public var end: GoogleType.DateTime? = nil

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `DateTimeRange`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DateTimeRange().with { $0.start = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.DateTimeRange"
  }
