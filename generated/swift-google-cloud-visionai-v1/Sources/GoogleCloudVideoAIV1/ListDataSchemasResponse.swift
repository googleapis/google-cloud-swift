  ...
  Sendable
{
  ...
  public var dataSchemas: [DataSchema] = []
  ...
  /// Initialize a new instance of `ListDataSchemasResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDataSchemasResponse().with { $0.dataSchemas = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let dataSchemas = CodingKeys(stringValue: "dataSchemas")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([DataSchema].self, forKey: .dataSchemas) {
      self.dataSchemas = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.dataSchemas, forKey: .dataSchemas)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.ListDataSchemasResponse"
  }
