...
public struct RenewLeaseRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Lease id.
  ...
  /// Initialize a new instance of `RenewLeaseRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RenewLeaseRequest().with { $0.id = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.RenewLeaseRequest"
  }
