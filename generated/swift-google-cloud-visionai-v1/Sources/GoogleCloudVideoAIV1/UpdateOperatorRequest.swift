...
public struct UpdateOperatorRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateOperatorRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateOperatorRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.UpdateOperatorRequest"
  }
