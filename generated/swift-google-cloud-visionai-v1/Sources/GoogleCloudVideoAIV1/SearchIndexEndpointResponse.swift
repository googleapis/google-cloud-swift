  ...
  Sendable
{
  ...
  /// Initialize a new instance of `SearchIndexEndpointResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SearchIndexEndpointResponse().with { $0.searchResultItems = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.SearchIndexEndpointResponse"
  }
