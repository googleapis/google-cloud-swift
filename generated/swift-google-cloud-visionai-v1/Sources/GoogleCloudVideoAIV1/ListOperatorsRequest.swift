...
public struct ListOperatorsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListOperatorsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListOperatorsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.ListOperatorsRequest"
  }
