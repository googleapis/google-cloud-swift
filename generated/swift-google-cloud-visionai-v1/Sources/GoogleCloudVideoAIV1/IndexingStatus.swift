...
public struct IndexingStatus: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Output only. State of this asset's indexing.
  public var state: IndexingStatus.State = IndexingStatus.State()
  ...
  /// Initialize a new instance of `IndexingStatus`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = IndexingStatus().with { $0.state = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(IndexingStatus.State.self, forKey: .state) {
      self.state = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.IndexingStatus"
  }
