  ...
  Sendable
{
  ...
  /// Initialize a new instance of `DeployedIndexReference`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeployedIndexReference().with { $0.indexEndpoint = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.DeployedIndexReference"
  }
