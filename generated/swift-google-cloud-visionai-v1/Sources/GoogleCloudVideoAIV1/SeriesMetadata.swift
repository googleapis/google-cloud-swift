...
public struct SeriesMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SeriesMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SeriesMetadata().with { $0.series = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.SeriesMetadata"
  }
