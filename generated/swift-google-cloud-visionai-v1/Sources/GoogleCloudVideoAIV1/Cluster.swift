  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let dataplaneServiceEndpoint = CodingKeys(stringValue: "dataplaneServiceEndpoint")
    static let state = CodingKeys(stringValue: "state")
    static let pscTarget = CodingKeys(stringValue: "pscTarget")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      Swift.String.self, forKey: .dataplaneServiceEndpoint)
    {
      self.dataplaneServiceEndpoint = value
    }
    if let value = try container.decodeIfPresent(Cluster.State.self, forKey: .state) {
      self.state = value
    }
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .pscTarget) {
      self.pscTarget = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.dataplaneServiceEndpoint, forKey: .dataplaneServiceEndpoint)
    try container.encode(self.state, forKey: .state)
    try container.encode(self.pscTarget, forKey: .pscTarget)
