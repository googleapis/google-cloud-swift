...
public struct GenerateStreamHlsTokenResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GenerateStreamHlsTokenResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GenerateStreamHlsTokenResponse().with { $0.token = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.GenerateStreamHlsTokenResponse"
  }
