...
public struct UpdateApplicationInstancesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var applicationInstances: [UpdateApplicationInstancesRequest.UpdateApplicationInstance] =
    []
  ...
  ///
  /// ```
  /// let value = UpdateApplicationInstancesRequest().with { $0.name = ... }
  /// ```
  ...
  public struct UpdateApplicationInstance: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = UpdateApplicationInstance().with { $0.updateMask = ... }
    /// ```
    public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
      var copy = self
      try config(&copy)
