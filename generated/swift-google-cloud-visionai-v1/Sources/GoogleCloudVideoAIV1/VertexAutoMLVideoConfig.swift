...
public struct VertexAutoMLVideoConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var blockedLabels: [Swift.String] = []
  ...
  ///
  /// ```
  /// let value = VertexAutoMLVideoConfig().with { $0.confidenceThreshold = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.VertexAutoMLVideoConfig"
  }
