...
public struct OperatorQuery: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var registry: Registry = Registry()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `OperatorQuery`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = OperatorQuery().with { $0.`operator` = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Registry.self, forKey: .registry) {
      self.registry = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.visionai.v1.OperatorQuery"
  }
