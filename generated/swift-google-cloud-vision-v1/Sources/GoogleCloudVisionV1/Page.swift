  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = Page().with { $0.property = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Block].self, forKey: .blocks) {
      self.blocks = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vision.v1.Page"
  }
