...
public struct AsyncBatchAnnotateImagesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `AsyncBatchAnnotateImagesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AsyncBatchAnnotateImagesRequest().with { $0.requests = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([AnnotateImageRequest].self, forKey: .requests) {
      self.requests = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vision.v1.AsyncBatchAnnotateImagesRequest"
  }
