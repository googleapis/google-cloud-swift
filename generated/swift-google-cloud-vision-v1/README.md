# Google Cloud Client Libraries for Swift - Cloud Vision API
...
Add `swift-google-cloud-vision-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-vision-v1.git --from 0.1.0-preview
```

Then add `GoogleCloudVisionV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudVisionV1 <target-name> --package swift-google-cloud-vision-v1
```
