...
extension Clients {
  class MetricsScopesTransport: MetricsScopesStub {
    ...
    public func getMetricsScope(
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudMonitoringMetricsScopeV1.MetricsScope.self, from: data)
    }
    ...
    {
      let path = try { () throws -> Swift.String in
        return "/v1/locations/global/metricsScopes:listMetricsScopesByMonitoredProject"
      }()
      var query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
