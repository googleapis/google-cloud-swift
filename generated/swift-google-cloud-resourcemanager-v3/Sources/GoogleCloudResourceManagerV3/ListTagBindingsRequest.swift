...
public struct ListTagBindingsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListTagBindingsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListTagBindingsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.resourcemanager.v3.ListTagBindingsRequest"
  }
