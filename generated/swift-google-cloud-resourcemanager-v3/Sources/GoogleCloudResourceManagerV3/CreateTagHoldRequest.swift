...
public struct CreateTagHoldRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let tagHold = CodingKeys(stringValue: "tagHold")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.tagHold = try container.decodeIfPresent(TagHold.self, forKey: .tagHold)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.tagHold, forKey: .tagHold)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.resourcemanager.v3.CreateTagHoldRequest"
  }
