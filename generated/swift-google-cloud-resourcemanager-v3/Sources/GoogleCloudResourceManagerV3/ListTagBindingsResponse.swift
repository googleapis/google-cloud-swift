  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let tagBindings = CodingKeys(stringValue: "tagBindings")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([TagBinding].self, forKey: .tagBindings) {
      self.tagBindings = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.tagBindings, forKey: .tagBindings)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.resourcemanager.v3.ListTagBindingsResponse"
  }
