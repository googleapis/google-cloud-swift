  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListTagKeysResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListTagKeysResponse().with { $0.tagKeys = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([TagKey].self, forKey: .tagKeys) {
      self.tagKeys = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.resourcemanager.v3.ListTagKeysResponse"
  }
