...
public struct CreateTagBindingRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let tagBinding = CodingKeys(stringValue: "tagBinding")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.tagBinding = try container.decodeIfPresent(TagBinding.self, forKey: .tagBinding)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.tagBinding, forKey: .tagBinding)
