...
public struct MoveFolderMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let sourceParent = CodingKeys(stringValue: "sourceParent")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .sourceParent) {
      self.sourceParent = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.sourceParent, forKey: .sourceParent)
