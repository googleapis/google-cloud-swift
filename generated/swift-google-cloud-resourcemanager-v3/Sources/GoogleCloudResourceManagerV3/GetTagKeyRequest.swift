...
public struct GetTagKeyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetTagKeyRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetTagKeyRequest().with { $0.name = ... }
  /// ```
