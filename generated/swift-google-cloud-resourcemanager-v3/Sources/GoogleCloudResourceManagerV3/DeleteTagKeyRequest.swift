...
public struct DeleteTagKeyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteTagKeyRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteTagKeyRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.resourcemanager.v3.DeleteTagKeyRequest"
  }
