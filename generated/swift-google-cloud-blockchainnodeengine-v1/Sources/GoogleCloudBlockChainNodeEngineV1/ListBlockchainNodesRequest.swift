...
public struct ListBlockchainNodesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListBlockchainNodesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListBlockchainNodesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.blockchainnodeengine.v1.ListBlockchainNodesRequest"
  }
