...
Add `swift-google-cloud-blockchainnodeengine-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-blockchainnodeengine-v1.git --from 0.3.0
```

Then add `GoogleCloudBlockChainNodeEngineV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudBlockChainNodeEngineV1 <target-name> --package swift-google-cloud-blockchainnodeengine-v1
```
