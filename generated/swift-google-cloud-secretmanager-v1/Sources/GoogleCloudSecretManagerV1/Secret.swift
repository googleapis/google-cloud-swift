  ...
  Sendable
{
  ...
  public enum SecretType: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("SECRET_TYPE_UNSPECIFIED")
      case .cloudSqlDbCredentials: return try container.encode("CLOUD_SQL_DB_CREDENTIALS")
      case .accessKey: return try container.encode("ACCESS_KEY")
      case .certificate: return try container.encode("CERTIFICATE")
      case .otherDbCredentials: return try container.encode("OTHER_DB_CREDENTIALS")
