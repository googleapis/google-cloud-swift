...
///
/// [google.cloud.secretmanager.v1.SecretManagerService.DisableSecretVersion]: <doc:SecretManagerServiceClient/disableSecretVersion(request:options:)>
public struct DisableSecretVersionRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
