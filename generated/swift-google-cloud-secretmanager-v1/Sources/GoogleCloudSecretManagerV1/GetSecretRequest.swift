...
///
/// [google.cloud.secretmanager.v1.SecretManagerService.GetSecret]: <doc:SecretManagerServiceClient/getSecret(request:options:)>
public struct GetSecretRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
