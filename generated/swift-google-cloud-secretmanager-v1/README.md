# Google Cloud Client Libraries for Swift - Secret Manager API
...
```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-secretmanager-v1.git --from 0.3.0
```
