...
public struct GenerateIdTokenResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GenerateIdTokenResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GenerateIdTokenResponse().with { $0.token = ... }
  /// ```
