...
public struct DriveExtensionPoint: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DriveExtensionPoint`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DriveExtensionPoint().with { $0.runFunction = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.apps.script.type.drive.DriveExtensionPoint"
  }
