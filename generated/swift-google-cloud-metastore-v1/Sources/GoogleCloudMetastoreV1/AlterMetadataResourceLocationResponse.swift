...
public struct AlterMetadataResourceLocationResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `AlterMetadataResourceLocationResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AlterMetadataResourceLocationResponse().with { $0.<placeholder> = ... }
  /// ```
