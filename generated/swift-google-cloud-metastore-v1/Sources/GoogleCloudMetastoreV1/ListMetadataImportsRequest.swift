...
public struct ListMetadataImportsRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListMetadataImportsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMetadataImportsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.metastore.v1.ListMetadataImportsRequest"
  }
