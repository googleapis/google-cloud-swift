...
extension Clients {
  final class DataprocMetastoreFederationRetry: DataprocMetastoreFederationStub {
    let inner: any DataprocMetastoreFederationStub
    let options: GoogleCloudGax.ClientOptions

    public init(_ inner: any DataprocMetastoreFederationStub, options: GoogleCloudGax.ClientOptions)
    {
      self.inner = inner
