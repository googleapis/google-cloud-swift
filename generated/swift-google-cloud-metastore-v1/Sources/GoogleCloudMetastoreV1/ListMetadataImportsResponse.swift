  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let metadataImports = CodingKeys(stringValue: "metadataImports")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([MetadataImport].self, forKey: .metadataImports) {
      self.metadataImports = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.metadataImports, forKey: .metadataImports)
