  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = Secret().with { $0.cloudSecret = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let cloudSecret = try container.decodeIfPresent(Swift.String.self, forKey: .cloudSecret) {
  ...
  public enum OneOf_Value: Codable, Equatable, Sendable {
    ...
    case cloudSecret(Swift.String)
  }

  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.metastore.v1.Secret"
  }
