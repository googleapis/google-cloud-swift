...
public struct RestoreServiceRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  public var restoreType: Restore.RestoreType = Restore.RestoreType()
  ...
  /// Initialize a new instance of `RestoreServiceRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RestoreServiceRequest().with { $0.service = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let restoreType = CodingKeys(stringValue: "restoreType")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Restore.RestoreType.self, forKey: .restoreType) {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.restoreType, forKey: .restoreType)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.metastore.v1.RestoreServiceRequest"
  }
