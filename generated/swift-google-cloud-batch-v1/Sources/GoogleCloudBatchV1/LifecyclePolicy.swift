...
public struct LifecyclePolicy: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public struct ActionCondition: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
  ...
  public enum Action: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .retryTask: return try container.encode("RETRY_TASK")
      case .failTask: return try container.encode("FAIL_TASK")
