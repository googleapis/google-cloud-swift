  ...
  Sendable
{
  ...
  /// Initialize a new instance of `DiagnoseRouterRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DiagnoseRouterRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.edgenetwork.v1.DiagnoseRouterRequest"
  }
