...
public struct ListInterconnectsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListInterconnectsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListInterconnectsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.edgenetwork.v1.ListInterconnectsRequest"
  }
