...
public struct ListRoutersResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The list of Router
  ...
  /// Initialize a new instance of `ListRoutersResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListRoutersResponse().with { $0.routers = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.edgenetwork.v1.ListRoutersResponse"
  }
...
extension ListRoutersResponse: GoogleGax._PaginatedResponse {
