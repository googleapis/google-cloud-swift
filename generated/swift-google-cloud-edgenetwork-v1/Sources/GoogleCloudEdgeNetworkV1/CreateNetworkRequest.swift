...
public struct CreateNetworkRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CreateNetworkRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateNetworkRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.edgenetwork.v1.CreateNetworkRequest"
  }
