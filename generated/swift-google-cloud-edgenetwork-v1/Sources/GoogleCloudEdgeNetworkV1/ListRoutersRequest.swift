...
public struct ListRoutersRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListRoutersRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListRoutersRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.edgenetwork.v1.ListRoutersRequest"
  }
