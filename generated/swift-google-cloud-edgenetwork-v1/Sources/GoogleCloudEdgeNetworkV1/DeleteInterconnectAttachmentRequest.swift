...
public struct DeleteInterconnectAttachmentRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteInterconnectAttachmentRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteInterconnectAttachmentRequest().with { $0.name = ... }
  /// ```
