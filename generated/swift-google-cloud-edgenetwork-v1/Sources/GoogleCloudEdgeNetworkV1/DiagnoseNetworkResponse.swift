  ...
  Sendable
{
    ...
    Sendable
  {
    ...
    public enum MacsecStatus: Codable, Equatable, Sendable {
      ...
      ///
      /// If the value is unknown, this initializes to [`unknownStringValue`](doc:MacsecStatus/unknownStringValue(_:)).
      ...
      ///
      /// If the value is unknown, this initializes to [`unknownIntValue`](doc:MacsecStatus/unknownIntValue(_:)).
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        case .secure: return try container.encode("SECURE")
        case .unsecure: return try container.encode("UNSECURE")
