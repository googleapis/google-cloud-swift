...
public struct LinkLayerAddress: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `LinkLayerAddress`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = LinkLayerAddress().with { $0.macAddress = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.edgenetwork.v1.LinkLayerAddress"
  }
