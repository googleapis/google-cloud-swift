...
public struct ListInterconnectAttachmentsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListInterconnectAttachmentsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListInterconnectAttachmentsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.edgenetwork.v1.ListInterconnectAttachmentsRequest"
  }
