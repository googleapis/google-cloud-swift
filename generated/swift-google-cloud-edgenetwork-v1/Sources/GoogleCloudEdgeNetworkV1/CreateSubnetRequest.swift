...
public struct CreateSubnetRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CreateSubnetRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateSubnetRequest().with { $0.parent = ... }
  /// ```
