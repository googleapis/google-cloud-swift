...
public enum RemotePeeringNetworkType: Codable, Equatable, Hashable, Sendable {
  ...
  public var intValue: Int? {
    ...
    case .customerInternal: return 1
    case .customerInternet: return 2
  ...
  public var stringValue: Swift.String? {
    ...
    case .customerInternet: return "REMOTE_PEERING_NETWORK_TYPE_CUSTOMER_INTERNET"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:RemotePeeringNetworkType/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    ...
    case "REMOTE_PEERING_NETWORK_TYPE_CUSTOMER_INTERNET": self = .customerInternet
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:RemotePeeringNetworkType/unknownIntValue(_:)).
  public init(intValue: Int) {
    switch intValue {
    case 0: self = .unspecified
    case 1: self = .customerInternal
    case 2: self = .customerInternet
