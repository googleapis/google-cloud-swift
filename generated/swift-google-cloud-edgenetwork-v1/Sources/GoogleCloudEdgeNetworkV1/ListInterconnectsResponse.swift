...
public struct ListInterconnectsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The list of Interconnect
  public var interconnects: [Interconnect] = []
  ...
  /// Initialize a new instance of `ListInterconnectsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListInterconnectsResponse().with { $0.interconnects = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Interconnect].self, forKey: .interconnects) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.edgenetwork.v1.ListInterconnectsResponse"
  }
...
extension ListInterconnectsResponse: GoogleGax._PaginatedResponse {
