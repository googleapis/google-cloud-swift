...
/// zone.
public struct DiagnoseInterconnectRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DiagnoseInterconnectRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DiagnoseInterconnectRequest().with { $0.name = ... }
  /// ```
