...
public struct ListWorkloadsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListWorkloadsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListWorkloadsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.orchestration.airflow.service.v1.ListWorkloadsRequest"
  }
