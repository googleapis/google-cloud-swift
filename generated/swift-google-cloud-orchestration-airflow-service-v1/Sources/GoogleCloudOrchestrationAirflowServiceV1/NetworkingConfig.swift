...
/// environment.
public struct NetworkingConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Optional. Indicates the user requested specific connection type between
  /// Tenant and Customer projects. You cannot set networking connection type in
  /// public IP environment.
  public var connectionType: NetworkingConfig.ConnectionType = NetworkingConfig.ConnectionType()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `NetworkingConfig`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = NetworkingConfig().with { $0.connectionType = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      NetworkingConfig.ConnectionType.self, forKey: .connectionType)
    {
  ...
  public enum ConnectionType: Codable, Equatable, Sendable {
    ...
    public var intValue: Int? {
      ...
      case .vpcPeering: return 1
      case .privateServiceConnect: return 2
    ...
    public init(intValue: Int) {
      ...
      case 1: self = .vpcPeering
      case 2: self = .privateServiceConnect
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.orchestration.airflow.service.v1.NetworkingConfig"
  }
