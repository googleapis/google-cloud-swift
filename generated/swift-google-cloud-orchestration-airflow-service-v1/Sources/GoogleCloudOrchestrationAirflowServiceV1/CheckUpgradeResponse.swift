  ...
  Sendable
{
  ...
  ///   them to named cases.
  public enum ConflictResult: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("CONFLICT_RESULT_UNSPECIFIED")
      case .conflict: return try container.encode("CONFLICT")
      case .noConflict: return try container.encode("NO_CONFLICT")
