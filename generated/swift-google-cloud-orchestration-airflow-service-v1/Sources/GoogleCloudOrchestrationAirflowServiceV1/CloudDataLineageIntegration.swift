...
public struct CloudDataLineageIntegration: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CloudDataLineageIntegration`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CloudDataLineageIntegration().with { $0.enabled = ... }
  /// ```
