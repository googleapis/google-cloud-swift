...
public struct ListUserWorkloadsConfigMapsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListUserWorkloadsConfigMapsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListUserWorkloadsConfigMapsRequest().with { $0.parent = ... }
  /// ```
