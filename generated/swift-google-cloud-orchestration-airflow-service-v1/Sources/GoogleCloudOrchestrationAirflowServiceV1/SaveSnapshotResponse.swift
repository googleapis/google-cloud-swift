...
public struct SaveSnapshotResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SaveSnapshotResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SaveSnapshotResponse().with { $0.snapshotPath = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.orchestration.airflow.service.v1.SaveSnapshotResponse"
  }
