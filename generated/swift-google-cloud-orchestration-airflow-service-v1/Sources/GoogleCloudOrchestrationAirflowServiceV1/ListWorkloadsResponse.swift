  ...
  Sendable
{
  ...
  public enum ComposerWorkloadType: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .celeryWorker: return try container.encode("CELERY_WORKER")
      case .kubernetesWorker: return try container.encode("KUBERNETES_WORKER")
      case .kubernetesOperatorPod: return try container.encode("KUBERNETES_OPERATOR_POD")
      case .scheduler: return try container.encode("SCHEDULER")
      case .dagProcessor: return try container.encode("DAG_PROCESSOR")
      case .triggerer: return try container.encode("TRIGGERER")
      case .webServer: return try container.encode("WEB_SERVER")
...
extension ListWorkloadsResponse: GoogleGax._PaginatedResponse {
