  ...
  Sendable
{
  ...
  public var userWorkloadsSecrets: [UserWorkloadsSecret] = []
  ...
  /// Initialize a new instance of `ListUserWorkloadsSecretsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListUserWorkloadsSecretsResponse().with { $0.userWorkloadsSecrets = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let userWorkloadsSecrets = CodingKeys(stringValue: "userWorkloadsSecrets")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [UserWorkloadsSecret].self, forKey: .userWorkloadsSecrets)
    {
      self.userWorkloadsSecrets = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.userWorkloadsSecrets, forKey: .userWorkloadsSecrets)
