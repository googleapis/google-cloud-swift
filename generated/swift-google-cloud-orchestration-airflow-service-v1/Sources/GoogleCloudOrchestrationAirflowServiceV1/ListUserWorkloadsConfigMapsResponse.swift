  ...
  Sendable
{
  ...
  public var userWorkloadsConfigMaps: [UserWorkloadsConfigMap] = []
  ...
  /// Initialize a new instance of `ListUserWorkloadsConfigMapsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListUserWorkloadsConfigMapsResponse().with { $0.userWorkloadsConfigMaps = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let userWorkloadsConfigMaps = CodingKeys(stringValue: "userWorkloadsConfigMaps")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [UserWorkloadsConfigMap].self, forKey: .userWorkloadsConfigMaps)
    {
      self.userWorkloadsConfigMaps = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.userWorkloadsConfigMaps, forKey: .userWorkloadsConfigMaps)
