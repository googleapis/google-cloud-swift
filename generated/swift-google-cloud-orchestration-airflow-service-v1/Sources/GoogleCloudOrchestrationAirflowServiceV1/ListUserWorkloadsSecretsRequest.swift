...
public struct ListUserWorkloadsSecretsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListUserWorkloadsSecretsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListUserWorkloadsSecretsRequest().with { $0.parent = ... }
  /// ```
