...
/// environments).
public struct DatabaseFailoverRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Target environment:
  ...
  /// Initialize a new instance of `DatabaseFailoverRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DatabaseFailoverRequest().with { $0.environment = ... }
  /// ```
