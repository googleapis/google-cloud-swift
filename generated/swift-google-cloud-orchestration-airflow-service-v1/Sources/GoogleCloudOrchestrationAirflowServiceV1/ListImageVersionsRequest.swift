...
public struct ListImageVersionsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var includePastReleases: Swift.Bool = Swift.Bool()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `ListImageVersionsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListImageVersionsRequest().with { $0.parent = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let includePastReleases = CodingKeys(stringValue: "includePastReleases")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.Bool.self, forKey: .includePastReleases) {
      self.includePastReleases = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.includePastReleases, forKey: .includePastReleases)
