    ...
    request: UpdateEndpointRequest()
      .with {
        $0.endpoint = Endpoint().with {
          $0.name =
            "projects/\(projectId)/locations/\(locationId)/namespaces/\(namespaceId)/services/\(serviceId)/endpoints/\(endpointId)"
        }
  ...
  static func main() async throws {
    do {
      ...
      try await sample(
        ...
        namespaceId: "[placeholder]", serviceId: "[placeholder]", endpointId: "[placeholder]")
    } catch {
      print("Error: \(error)")
    }
  }
