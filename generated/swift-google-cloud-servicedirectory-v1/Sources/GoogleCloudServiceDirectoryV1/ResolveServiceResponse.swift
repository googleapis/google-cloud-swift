...
public struct ResolveServiceResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ResolveServiceResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ResolveServiceResponse().with { $0.service = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.servicedirectory.v1.ResolveServiceResponse"
  }
