...
/// Firewall).
public struct WafSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let wafService = CodingKeys(stringValue: "wafService")
    static let wafFeature = CodingKeys(stringValue: "wafFeature")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(WafSettings.WafFeature.self, forKey: .wafFeature) {
      self.wafFeature = value
    }
