  ...
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      TransactionEvent.TransactionEventType.self, forKey: .eventType)
    {
  ...
  public enum TransactionEventType: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("TRANSACTION_EVENT_TYPE_UNSPECIFIED")
      case .merchantApprove: return try container.encode("MERCHANT_APPROVE")
      case .merchantDeny: return try container.encode("MERCHANT_DENY")
      case .manualReview: return try container.encode("MANUAL_REVIEW")
      case .authorization: return try container.encode("AUTHORIZATION")
      case .authorizationDecline: return try container.encode("AUTHORIZATION_DECLINE")
      case .paymentCapture: return try container.encode("PAYMENT_CAPTURE")
      case .paymentCaptureDecline: return try container.encode("PAYMENT_CAPTURE_DECLINE")
      case .cancel: return try container.encode("CANCEL")
      case .chargebackInquiry: return try container.encode("CHARGEBACK_INQUIRY")
      case .chargebackAlert: return try container.encode("CHARGEBACK_ALERT")
      case .fraudNotification: return try container.encode("FRAUD_NOTIFICATION")
      case .chargeback: return try container.encode("CHARGEBACK")
      case .chargebackRepresentment: return try container.encode("CHARGEBACK_REPRESENTMENT")
      case .chargebackReverse: return try container.encode("CHARGEBACK_REVERSE")
      case .refundRequest: return try container.encode("REFUND_REQUEST")
      case .refundDecline: return try container.encode("REFUND_DECLINE")
      case .refund: return try container.encode("REFUND")
      case .refundReverse: return try container.encode("REFUND_REVERSE")
