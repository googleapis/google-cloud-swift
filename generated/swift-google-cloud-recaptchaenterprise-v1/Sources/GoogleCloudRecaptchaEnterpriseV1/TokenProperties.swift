...
public struct TokenProperties: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public enum InvalidReason: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("INVALID_REASON_UNSPECIFIED")
      case .unknownInvalidReason: return try container.encode("UNKNOWN_INVALID_REASON")
      case .malformed: return try container.encode("MALFORMED")
      case .expired: return try container.encode("EXPIRED")
      case .dupe: return try container.encode("DUPE")
      case .missing: return try container.encode("MISSING")
      case .browserError: return try container.encode("BROWSER_ERROR")
      case .unexpectedAction: return try container.encode("UNEXPECTED_ACTION")
      case .keyMismatch: return try container.encode("KEY_MISMATCH")
      case .domainMismatch: return try container.encode("DOMAIN_MISMATCH")
