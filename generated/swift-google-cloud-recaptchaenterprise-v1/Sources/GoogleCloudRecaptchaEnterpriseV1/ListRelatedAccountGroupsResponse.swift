  ...
  Sendable
{
  ...
  public var relatedAccountGroups: [RelatedAccountGroup] = []
  ...
  /// Initialize a new instance of `ListRelatedAccountGroupsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListRelatedAccountGroupsResponse().with { $0.relatedAccountGroups = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let relatedAccountGroups = CodingKeys(stringValue: "relatedAccountGroups")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [RelatedAccountGroup].self, forKey: .relatedAccountGroups)
    {
      self.relatedAccountGroups = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.relatedAccountGroups, forKey: .relatedAccountGroups)
