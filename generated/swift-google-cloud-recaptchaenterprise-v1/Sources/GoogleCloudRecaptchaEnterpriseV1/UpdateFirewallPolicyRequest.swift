...
public struct UpdateFirewallPolicyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateFirewallPolicyRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateFirewallPolicyRequest().with { $0.firewallPolicy = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.recaptchaenterprise.v1.UpdateFirewallPolicyRequest"
  }
