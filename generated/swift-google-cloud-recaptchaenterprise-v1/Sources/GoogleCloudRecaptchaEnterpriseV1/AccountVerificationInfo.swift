...
public struct AccountVerificationInfo: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let latestVerificationResult = CodingKeys(stringValue: "latestVerificationResult")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [EndpointVerificationInfo].self, forKey: .endpoints)
    {
    ...
    if let value = try container.decodeIfPresent(
      AccountVerificationInfo.Result.self, forKey: .latestVerificationResult)
    {
      self.latestVerificationResult = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.latestVerificationResult, forKey: .latestVerificationResult)
