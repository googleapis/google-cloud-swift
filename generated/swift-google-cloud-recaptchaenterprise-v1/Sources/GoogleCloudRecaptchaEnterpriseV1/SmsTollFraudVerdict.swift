...
public struct SmsTollFraudVerdict: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = SmsTollFraudVerdict().with { $0.risk = ... }
  /// ```
  ...
  ///   them to named cases.
  public enum SmsTollFraudReason: Codable, Equatable, Hashable, Sendable {
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "SMS_TOLL_FRAUD_REASON_UNSPECIFIED"
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:SmsTollFraudReason/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "SMS_TOLL_FRAUD_REASON_UNSPECIFIED": self = .unspecified
      case "INVALID_PHONE_NUMBER": self = .invalidPhoneNumber
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:SmsTollFraudReason/unknownIntValue(_:)).
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.recaptchaenterprise.v1.SmsTollFraudVerdict"
  }
