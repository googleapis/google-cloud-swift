...
public struct ListIpOverridesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListIpOverridesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListIpOverridesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.recaptchaenterprise.v1.ListIpOverridesRequest"
  }
