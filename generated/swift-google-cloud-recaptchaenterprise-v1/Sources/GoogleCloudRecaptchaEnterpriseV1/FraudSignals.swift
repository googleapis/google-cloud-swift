    ...
    Sendable
  {
    ...
    public enum CardLabel: Codable, Equatable, Sendable {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        case .prepaid: return try container.encode("PREPAID")
        case .virtual: return try container.encode("VIRTUAL")
        case .unexpectedLocation: return try container.encode("UNEXPECTED_LOCATION")
