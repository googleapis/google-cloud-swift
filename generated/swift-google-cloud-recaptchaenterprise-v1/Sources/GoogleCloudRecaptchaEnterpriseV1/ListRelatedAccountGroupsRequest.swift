...
public struct ListRelatedAccountGroupsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListRelatedAccountGroupsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListRelatedAccountGroupsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.recaptchaenterprise.v1.ListRelatedAccountGroupsRequest"
  }
