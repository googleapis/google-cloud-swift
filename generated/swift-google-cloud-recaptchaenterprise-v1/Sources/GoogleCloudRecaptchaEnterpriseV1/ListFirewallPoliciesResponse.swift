  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListFirewallPoliciesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListFirewallPoliciesResponse().with { $0.firewallPolicies = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.recaptchaenterprise.v1.ListFirewallPoliciesResponse"
  }
