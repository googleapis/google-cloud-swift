...
public struct RelatedAccountGroupMembership: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `RelatedAccountGroupMembership`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RelatedAccountGroupMembership().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.recaptchaenterprise.v1.RelatedAccountGroupMembership"
  }
