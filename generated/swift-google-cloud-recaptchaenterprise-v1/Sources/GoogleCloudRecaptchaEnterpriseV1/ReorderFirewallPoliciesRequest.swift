...
public struct ReorderFirewallPoliciesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ReorderFirewallPoliciesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ReorderFirewallPoliciesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.recaptchaenterprise.v1.ReorderFirewallPoliciesRequest"
  }
