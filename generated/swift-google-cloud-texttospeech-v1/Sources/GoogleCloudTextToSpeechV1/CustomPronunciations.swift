...
public struct CustomPronunciations: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CustomPronunciations`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CustomPronunciations().with { $0.pronunciations = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.texttospeech.v1.CustomPronunciations"
  }
