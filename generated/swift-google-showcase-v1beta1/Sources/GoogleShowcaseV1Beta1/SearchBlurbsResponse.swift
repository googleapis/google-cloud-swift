...
public struct SearchBlurbsResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SearchBlurbsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SearchBlurbsResponse().with { $0.blurbs = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let blurbs = CodingKeys(stringValue: "blurbs")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Blurb].self, forKey: .blurbs) {
      self.blurbs = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.blurbs, forKey: .blurbs)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.showcase.v1beta1.SearchBlurbsResponse"
  }
