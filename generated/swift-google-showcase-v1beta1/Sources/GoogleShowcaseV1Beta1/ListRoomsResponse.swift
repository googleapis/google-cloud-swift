...
/// method.
public struct ListRoomsResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListRoomsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListRoomsResponse().with { $0.rooms = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let rooms = CodingKeys(stringValue: "rooms")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Room].self, forKey: .rooms) {
      self.rooms = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.rooms, forKey: .rooms)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.showcase.v1beta1.ListRoomsResponse"
  }
