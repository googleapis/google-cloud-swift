...
public struct ReportSessionResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  /// The state of the report.
  public var result: ReportSessionResponse.Result = ReportSessionResponse.Result()
  ...
  ///
  /// ```
  /// let value = ReportSessionResponse().with { $0.result = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.showcase.v1beta1.ReportSessionResponse"
  }
