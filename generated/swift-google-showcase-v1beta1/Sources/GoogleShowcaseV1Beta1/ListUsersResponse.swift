...
/// method.
public struct ListUsersResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListUsersResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListUsersResponse().with { $0.users = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([User].self, forKey: .users) {
      self.users = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.showcase.v1beta1.ListUsersResponse"
  }
