        ...
        if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
          guard
            let pathVariable0 = GoogleCloudGax._RoutingMatcher.value(
              request.name as Swift.String?, matching: [.literal("rooms/"), .singleWildcard])
          else {
            return nil
          }
    ...
    public func updateRoom(
      ...
      let (path, query, configure) = try {
        ...
        if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
          guard
            let pathVariable0 = GoogleCloudGax._RoutingMatcher.value(
              request.room.map({ $0.name }), matching: [.literal("rooms/"), .singleWildcard])
          else {
            return nil
          }
          let path = "/v1beta1/\(pathVariable0)"
    ...
    public func createBlurb(
      ...
      let (path, query, configure) = try {
        ...
        if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
          guard
            let pathVariable0 = GoogleCloudGax._RoutingMatcher.value(
              request.parent as Swift.String?, matching: [.literal("rooms/"), .singleWildcard])
          else {
            return nil
          }
