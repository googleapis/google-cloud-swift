  ...
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Session.Version.self, forKey: .version) {
      self.version = value
    }
  ...
  public enum Version: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .v1Latest: return try container.encode("V1_LATEST")
      case .v10: return try container.encode("V1_0")
