...
/// method.
public struct ListBlurbsResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListBlurbsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListBlurbsResponse().with { $0.blurbs = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.showcase.v1beta1.ListBlurbsResponse"
  }
