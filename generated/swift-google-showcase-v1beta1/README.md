...
Add `swift-google-showcase-v1beta1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-showcase-v1beta1.git --from 0.0.0-preview
```

Then add `GoogleShowcaseV1Beta1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleShowcaseV1Beta1 <target-name> --package swift-google-showcase-v1beta1
```
