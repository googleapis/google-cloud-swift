...
///   them to named cases.
public enum IngressTraffic: Codable, Equatable, Hashable, Sendable {
  /// Unspecified
  case unspecified
  ...
  public var intValue: Int? {
    ...
    case .internalLoadBalancer: return 3
    case .`none`: return 4
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "INGRESS_TRAFFIC_UNSPECIFIED"
    case .all: return "INGRESS_TRAFFIC_ALL"
    case .internalOnly: return "INGRESS_TRAFFIC_INTERNAL_ONLY"
    case .internalLoadBalancer: return "INGRESS_TRAFFIC_INTERNAL_LOAD_BALANCER"
    case .`none`: return "INGRESS_TRAFFIC_NONE"
  ...
  public init(stringValue: Swift.String) {
    ...
    case "INGRESS_TRAFFIC_ALL": self = .all
    case "INGRESS_TRAFFIC_INTERNAL_ONLY": self = .internalOnly
    case "INGRESS_TRAFFIC_INTERNAL_LOAD_BALANCER": self = .internalLoadBalancer
    case "INGRESS_TRAFFIC_NONE": self = .`none`
  ...
  public init(intValue: Int) {
    ...
    case 3: self = .internalLoadBalancer
    case 4: self = .`none`
