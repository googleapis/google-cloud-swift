...
public struct ListWorkerPoolsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let workerPools = CodingKeys(stringValue: "workerPools")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([WorkerPool].self, forKey: .workerPools) {
      self.workerPools = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.workerPools, forKey: .workerPools)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.run.v2.ListWorkerPoolsResponse"
  }
...
extension ListWorkerPoolsResponse: GoogleGax._PaginatedResponse {
