...
public struct DeleteTriggerRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteTriggerRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteTriggerRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.eventarc.v1.DeleteTriggerRequest"
  }
