...
public struct ListPipelinesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListPipelinesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPipelinesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.eventarc.v1.ListPipelinesRequest"
  }
