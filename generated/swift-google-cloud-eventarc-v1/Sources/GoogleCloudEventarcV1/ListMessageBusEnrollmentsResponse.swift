...
public struct ListMessageBusEnrollmentsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The requested enrollments, up to the number specified in `page_size`.
  public var enrollments: [Swift.String] = []
  ...
  /// Initialize a new instance of `ListMessageBusEnrollmentsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMessageBusEnrollmentsResponse().with { $0.enrollments = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let enrollments = CodingKeys(stringValue: "enrollments")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Swift.String].self, forKey: .enrollments) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.eventarc.v1.ListMessageBusEnrollmentsResponse"
  }
