  ...
  Sendable
{
  ...
  public var destinations: [Pipeline.Destination] = []
  ...
  public var mediations: [Pipeline.Mediation] = []
  ...
  /// errors.
  public var inputPayloadFormat: Pipeline.MessagePayloadFormat? = nil
  ...
  public var retryPolicy: Pipeline.RetryPolicy? = nil
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let mediations = CodingKeys(stringValue: "mediations")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Pipeline.Destination].self, forKey: .destinations)
    {
      self.destinations = value
    }
    if let value = try container.decodeIfPresent([Pipeline.Mediation].self, forKey: .mediations) {
      self.mediations = value
    }
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .cryptoKeyName) {
      self.cryptoKeyName = value
    }
    self.inputPayloadFormat = try container.decodeIfPresent(
      Pipeline.MessagePayloadFormat.self, forKey: .inputPayloadFormat)
    ...
    self.retryPolicy = try container.decodeIfPresent(
      Pipeline.RetryPolicy.self, forKey: .retryPolicy)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.mediations, forKey: .mediations)
    try container.encode(self.cryptoKeyName, forKey: .cryptoKeyName)
    try container.encodeIfPresent(self.inputPayloadFormat, forKey: .inputPayloadFormat)
  ...
  public struct MessagePayloadFormat: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `MessagePayloadFormat`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = MessagePayloadFormat().with { $0.protobuf = ... }
    /// ```
    public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
      var copy = self
      try config(&copy)
    ...
    public struct JsonFormat: Codable, Equatable, GoogleWKT._AnyPackable,
      Sendable
    {
      @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

      /// Initialize a new instance of `JsonFormat`.
      public init() {}
      ...
      ///
      /// ```
      /// let value = JsonFormat().with { $0.<placeholder> = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
    ...
    public struct ProtobufFormat: Codable, Equatable, GoogleWKT._AnyPackable,
      Sendable
    {
      /// Optional. The entire schema definition is stored in this field.
      public var schemaDefinition: Swift.String = Swift.String()

      @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

      /// Initialize a new instance of `ProtobufFormat`.
      public init() {}
      ...
      ///
      /// ```
      /// let value = ProtobufFormat().with { $0.schemaDefinition = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      private struct CodingKeys: CodingKey {
        ...
        static let schemaDefinition = CodingKeys(stringValue: "schemaDefinition")
    ...
    public struct AvroFormat: Codable, Equatable, GoogleWKT._AnyPackable,
      Sendable
    {
      /// Optional. The entire schema definition is stored in this field.
      public var schemaDefinition: Swift.String = Swift.String()
      ...
      /// Initialize a new instance of `AvroFormat`.
      public init() {}
      ...
      ///
      /// ```
      /// let value = AvroFormat().with { $0.schemaDefinition = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
    ...
    Sendable
  {
    ...
    public var networkConfig: Pipeline.Destination.NetworkConfig? = nil
    ...
    public var authenticationConfig: Pipeline.Destination.AuthenticationConfig? = nil
    ...
    ///
    /// ```
    /// let value = Destination().with { $0.networkConfig = ... }
    /// ```
    public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
      var copy = self
      try config(&copy)
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.authenticationConfig = try container.decodeIfPresent(
        Pipeline.Destination.AuthenticationConfig.self, forKey: .authenticationConfig)
      ...
      let destinationDescriptorCheckAndSet = {
        if destinationDescriptor != nil {
          throw DecodingError.dataCorrupted(
            DecodingError.Context(
              codingPath: decoder.codingPath,
              debugDescription: "Multiple values set for oneof 'destinationDescriptor'"))
        }
      ...
      if let workflow = try container.decodeIfPresent(Swift.String.self, forKey: .workflow) {
        try destinationDescriptorCheckAndSet(.workflow(workflow))
      }
      if let messageBus = try container.decodeIfPresent(Swift.String.self, forKey: .messageBus) {
        try destinationDescriptorCheckAndSet(.messageBus(messageBus))
      }
      if let topic = try container.decodeIfPresent(Swift.String.self, forKey: .topic) {
        try destinationDescriptorCheckAndSet(.topic(topic))
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encodeIfPresent(self.outputPayloadFormat, forKey: .outputPayloadFormat)

      if let choice = self.destinationDescriptor {
        switch choice {
        ...
        case .messageBus(let value):
          try container.encode(value, forKey: .messageBus)
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = NetworkConfig().with { $0.networkAttachment = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
    ...
    public struct HttpEndpoint: Codable, Equatable, GoogleWKT._AnyPackable,
      Sendable
    {
      ...
      public var messageBindingTemplate: Swift.String = Swift.String()
      ...
      private struct CodingKeys: CodingKey {
        ...
        static let messageBindingTemplate = CodingKeys(stringValue: "messageBindingTemplate")
      ...
      public init(from decoder: Decoder) throws {
        ...
        if let value = try container.decodeIfPresent(
          Swift.String.self, forKey: .messageBindingTemplate)
        {
          self.messageBindingTemplate = value
        }
        for key in container.allKeys where !CodingKeys._knownKeys.contains(key.stringValue) {
          self._unknownFields.json[key.stringValue] = try container.decode(
            GoogleWKT.WKTValue.self, forKey: key)
    ...
    public struct AuthenticationConfig: Codable, Equatable, GoogleWKT._AnyPackable,
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = AuthenticationConfig().with { $0.googleOidc = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      private struct CodingKeys: CodingKey {
        ...
        static let googleOidc = CodingKeys(stringValue: "googleOidc")
      ...
      public init(from decoder: Decoder) throws {
        ...
        let authenticationMethodDescriptorCheckAndSet = {
          if authenticationMethodDescriptor != nil {
            throw DecodingError.dataCorrupted(
              DecodingError.Context(
                codingPath: decoder.codingPath,
                debugDescription: "Multiple values set for oneof 'authenticationMethodDescriptor'"))
          }
        ...
        self.authenticationMethodDescriptor = authenticationMethodDescriptor
        for key in container.allKeys where !CodingKeys._knownKeys.contains(key.stringValue) {
          self._unknownFields.json[key.stringValue] = try container.decode(
            GoogleWKT.WKTValue.self, forKey: key)
        }
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        if let choice = self.authenticationMethodDescriptor {
          switch choice {
          case .googleOidc(let value):
            try container.encode(value, forKey: .googleOidc)
        ...
        Sendable
      {
        ...
        ///
        /// ```
        /// let value = OidcToken().with { $0.serviceAccount = ... }
        /// ```
        public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
          var copy = self
          try config(&copy)
      ...
      public struct OAuthToken: Codable, Equatable, GoogleWKT._AnyPackable,
        Sendable
      {
        ...
        ///
        /// ```
        /// let value = OAuthToken().with { $0.serviceAccount = ... }
        /// ```
        public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
          var copy = self
          try config(&copy)
  ...
  public struct Mediation: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `Mediation`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = Mediation().with { $0.transformation = ... }
    /// ```
    public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
      var copy = self
      try config(&copy)
    ...
    public init(from decoder: Decoder) throws {
      ...
      let mediationDescriptorCheckAndSet = {
        if mediationDescriptor != nil {
          throw DecodingError.dataCorrupted(
            DecodingError.Context(
              codingPath: decoder.codingPath,
              debugDescription: "Multiple values set for oneof 'mediationDescriptor'"))
        }
      ...
      self.mediationDescriptor = mediationDescriptor
      for key in container.allKeys where !CodingKeys._knownKeys.contains(key.stringValue) {
        self._unknownFields.json[key.stringValue] = try container.decode(
          GoogleWKT.WKTValue.self, forKey: key)
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      if let choice = self.mediationDescriptor {
        switch choice {
        case .transformation(let value):
          try container.encode(value, forKey: .transformation)
        }
      }
      for (key, value) in self._unknownFields.json {
        try container.encode(value, forKey: CodingKeys(stringValue: key))
      ...
      Sendable
    {
      ...
      ///     representation of the CloudEvent. To convert that data to a JSON
      ///     string it can be chained with the toJsonString function.
      public var transformationTemplate: Swift.String = Swift.String()
      ...
      ///
      /// ```
      /// let value = Transformation().with { $0.transformationTemplate = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      private struct CodingKeys: CodingKey {
        ...
        static let transformationTemplate = CodingKeys(stringValue: "transformationTemplate")
      ...
      public init(from decoder: Decoder) throws {
        ...
        {
          self.transformationTemplate = value
        }
        for key in container.allKeys where !CodingKeys._knownKeys.contains(key.stringValue) {
          self._unknownFields.json[key.stringValue] = try container.decode(
            GoogleWKT.WKTValue.self, forKey: key)
    ...
    Sendable
  {
    ...
    /// is 5.
    public var minRetryDelay: GoogleWKT.WKTDuration? = nil

    /// Optional. The maximum amount of seconds to wait between retry attempts.
    /// The value must be between 1 and 600. The default value for this field
    /// is 60.
    public var maxRetryDelay: GoogleWKT.WKTDuration? = nil
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let minRetryDelay = CodingKeys(stringValue: "minRetryDelay")
      static let maxRetryDelay = CodingKeys(stringValue: "maxRetryDelay")
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.minRetryDelay = try container.decodeIfPresent(
        GoogleWKT.WKTDuration.self, forKey: .minRetryDelay)
      self.maxRetryDelay = try container.decodeIfPresent(
        GoogleWKT.WKTDuration.self, forKey: .maxRetryDelay)
      for key in container.allKeys where !CodingKeys._knownKeys.contains(key.stringValue) {
        self._unknownFields.json[key.stringValue] = try container.decode(
          GoogleWKT.WKTValue.self, forKey: key)
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encodeIfPresent(self.maxRetryDelay, forKey: .maxRetryDelay)
      for (key, value) in self._unknownFields.json {
        try container.encode(value, forKey: CodingKeys(stringValue: key))
      }
    }
