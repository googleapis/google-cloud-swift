  ...
  Sendable
{
  ...
  /// `page_size`.
  public var channelConnections: [ChannelConnection] = []
  ...
  /// Initialize a new instance of `ListChannelConnectionsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListChannelConnectionsResponse().with { $0.channelConnections = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let channelConnections = CodingKeys(stringValue: "channelConnections")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [ChannelConnection].self, forKey: .channelConnections)
    {
      self.channelConnections = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.channelConnections, forKey: .channelConnections)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.eventarc.v1.ListChannelConnectionsResponse"
  }
