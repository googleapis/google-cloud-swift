...
public struct CreateTriggerRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CreateTriggerRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateTriggerRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.eventarc.v1.CreateTriggerRequest"
  }
