...
public struct ListTriggersRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListTriggersRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListTriggersRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.eventarc.v1.ListTriggersRequest"
  }
