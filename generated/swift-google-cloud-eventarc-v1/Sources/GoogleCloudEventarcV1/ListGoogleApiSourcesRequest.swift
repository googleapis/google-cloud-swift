...
public struct ListGoogleApiSourcesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListGoogleApiSourcesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListGoogleApiSourcesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.eventarc.v1.ListGoogleApiSourcesRequest"
  }
