...
public struct ListMessageBusEnrollmentsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListMessageBusEnrollmentsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMessageBusEnrollmentsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.eventarc.v1.ListMessageBusEnrollmentsRequest"
  }
