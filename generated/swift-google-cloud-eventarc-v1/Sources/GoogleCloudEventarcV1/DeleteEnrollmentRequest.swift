...
public struct DeleteEnrollmentRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteEnrollmentRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteEnrollmentRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.eventarc.v1.DeleteEnrollmentRequest"
  }
