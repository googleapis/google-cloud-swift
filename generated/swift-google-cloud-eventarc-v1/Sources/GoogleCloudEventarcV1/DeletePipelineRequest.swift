...
public struct DeletePipelineRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeletePipelineRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeletePipelineRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.eventarc.v1.DeletePipelineRequest"
  }
