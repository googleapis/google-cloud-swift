  ...
  Sendable
{
  ...
  public var googleApiSources: [GoogleApiSource] = []
  ...
  /// Initialize a new instance of `ListGoogleApiSourcesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListGoogleApiSourcesResponse().with { $0.googleApiSources = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let googleApiSources = CodingKeys(stringValue: "googleApiSources")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([GoogleApiSource].self, forKey: .googleApiSources)
    {
      self.googleApiSources = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.googleApiSources, forKey: .googleApiSources)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.eventarc.v1.ListGoogleApiSourcesResponse"
  }
