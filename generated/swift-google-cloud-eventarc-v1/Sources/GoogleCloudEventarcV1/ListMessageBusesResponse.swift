  ...
  Sendable
{
  ...
  public var messageBuses: [MessageBus] = []
  ...
  /// Initialize a new instance of `ListMessageBusesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMessageBusesResponse().with { $0.messageBuses = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let messageBuses = CodingKeys(stringValue: "messageBuses")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([MessageBus].self, forKey: .messageBuses) {
      self.messageBuses = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.messageBuses, forKey: .messageBuses)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.eventarc.v1.ListMessageBusesResponse"
  }
