...
public struct DeleteGoogleApiSourceRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteGoogleApiSourceRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteGoogleApiSourceRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.eventarc.v1.DeleteGoogleApiSourceRequest"
  }
