...
public struct UpdateEnrollmentRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateEnrollmentRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateEnrollmentRequest().with { $0.enrollment = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.eventarc.v1.UpdateEnrollmentRequest"
  }
