...
public struct ListMessageBusesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListMessageBusesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMessageBusesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.eventarc.v1.ListMessageBusesRequest"
  }
