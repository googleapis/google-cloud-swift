...
public struct CreateGoogleApiSourceRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CreateGoogleApiSourceRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateGoogleApiSourceRequest().with { $0.parent = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let googleApiSource = CodingKeys(stringValue: "googleApiSource")
    static let googleApiSourceId = CodingKeys(stringValue: "googleApiSourceId")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .googleApiSourceId) {
      self.googleApiSourceId = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.googleApiSourceId, forKey: .googleApiSourceId)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.eventarc.v1.CreateGoogleApiSourceRequest"
  }
