  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListTriggersResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListTriggersResponse().with { $0.triggers = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Trigger].self, forKey: .triggers) {
      self.triggers = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.eventarc.v1.ListTriggersResponse"
  }
