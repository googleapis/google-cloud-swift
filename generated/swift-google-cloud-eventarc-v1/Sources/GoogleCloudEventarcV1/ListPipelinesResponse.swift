  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListPipelinesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPipelinesResponse().with { $0.pipelines = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let pipelines = CodingKeys(stringValue: "pipelines")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Pipeline].self, forKey: .pipelines) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.eventarc.v1.ListPipelinesResponse"
  }
