...
public struct ListCloudLocationsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Output only. List of cloud locations.
  public var cloudLocations: [CloudLocation] = []
  ...
  /// Initialize a new instance of `ListCloudLocationsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCloudLocationsResponse().with { $0.cloudLocations = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let cloudLocations = CodingKeys(stringValue: "cloudLocations")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.locationfinder.v1.ListCloudLocationsResponse"
  }
...
extension ListCloudLocationsResponse: GoogleGax._PaginatedResponse {
