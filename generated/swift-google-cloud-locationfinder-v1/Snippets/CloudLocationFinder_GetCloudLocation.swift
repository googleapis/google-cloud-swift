...
func sample(
  ...
  let response = try await client.getCloudLocation(
    request: GetCloudLocationRequest()
      .with {
        $0.name = "projects/\(projectId)/locations/\(locationId)/cloudLocations/\(cloudLocationId)"
      }
  )
