...
extension Clients {
  final class BatchServiceRetry: BatchServiceStub {
    let inner: any BatchServiceStub
    let options: GoogleCloudGax.ClientOptions

    public init(_ inner: any BatchServiceStub, options: GoogleCloudGax.ClientOptions) {
      self.inner = inner
      ...
      try await self._intercept(
        ...
        action: {
          (r: ListJobsRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleCloudBatchV1.ListJobsResponse
          in
