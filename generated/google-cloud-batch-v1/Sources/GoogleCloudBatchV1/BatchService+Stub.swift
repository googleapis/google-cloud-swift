...
extension Clients {
  ...
  class BatchServiceTransport: BatchServiceStub {
    let inner: GoogleCloudGax.HTTPClient

    public init(_ options: GoogleCloudGax.ClientOptions = .init()) throws {
      self.inner = try GoogleCloudGax.HTTPClient(
        from: options, withDefaultEndpoint: "https://batch.googleapis.com")
    }
    ...
    public func createJob(
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudBatchV1.Job.self, from: data)
    }
    ...
    public func deleteJob(
      ...
      let encoder = GoogleCloudGax.QueryParameterEncoder()
      query.append(contentsOf: try encoder.encode(request.reason, prefix: "reason"))
      query.append(contentsOf: try encoder.encode(request.requestId, prefix: "requestId"))
      var req = try await self.inner.Request(path: path, query: query)
    ...
    public func listJobs(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudBatchV1.ListJobsResponse.self, from: data)
    }
    ...
    public func getTask(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudBatchV1.Task.self, from: data)
    }
    ...
    public func listTasks(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudBatchV1.ListTasksResponse.self, from: data)
    }
