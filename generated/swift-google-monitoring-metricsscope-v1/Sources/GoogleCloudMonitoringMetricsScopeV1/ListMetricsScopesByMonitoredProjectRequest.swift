  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = ListMetricsScopesByMonitoredProjectRequest().with { $0.monitoredResourceContainer = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let monitoredResourceContainer = CodingKeys(stringValue: "monitoredResourceContainer")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      Swift.String.self, forKey: .monitoredResourceContainer)
    {
      self.monitoredResourceContainer = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.monitoredResourceContainer, forKey: .monitoredResourceContainer)
