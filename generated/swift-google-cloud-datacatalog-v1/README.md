# Google Cloud Client Libraries for Swift - Google Cloud Data Catalog API
...
Add `swift-google-cloud-datacatalog-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-datacatalog-v1.git --from 0.3.0
```

Then add `GoogleCloudDataCatalogV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudDataCatalogV1 <target-name> --package swift-google-cloud-datacatalog-v1
```
