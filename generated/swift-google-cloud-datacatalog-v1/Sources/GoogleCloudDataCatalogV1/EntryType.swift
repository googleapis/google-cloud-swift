...
public enum EntryType: Codable, Equatable, Sendable {
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:EntryType/unknownStringValue(_:)).
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:EntryType/unknownIntValue(_:)).
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    switch self {
    case .unspecified: return try container.encode("ENTRY_TYPE_UNSPECIFIED")
    case .table: return try container.encode("TABLE")
    case .dataStream: return try container.encode("DATA_STREAM")
    ...
    case .dataSourceConnection: return try container.encode("DATA_SOURCE_CONNECTION")
    case .routine: return try container.encode("ROUTINE")
    case .lake: return try container.encode("LAKE")
    case .zone: return try container.encode("ZONE")
    case .service: return try container.encode("SERVICE")
    case .databaseSchema: return try container.encode("DATABASE_SCHEMA")
    case .dashboard: return try container.encode("DASHBOARD")
    case .explore: return try container.encode("EXPLORE")
    case .look: return try container.encode("LOOK")
    case .featureOnlineStore: return try container.encode("FEATURE_ONLINE_STORE")
    case .featureView: return try container.encode("FEATURE_VIEW")
    case .featureGroup: return try container.encode("FEATURE_GROUP")
