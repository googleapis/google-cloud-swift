  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = FeatureOnlineStoreSpec().with { $0.storageType = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      FeatureOnlineStoreSpec.StorageType.self, forKey: .storageType)
    {
  ...
  public enum StorageType: Codable, Equatable, Sendable {
    ...
    public var intValue: Int? {
      ...
      case .bigtable: return 1
      case .optimized: return 2
    ...
    public init(stringValue: Swift.String) {
      ...
      case "BIGTABLE": self = .bigtable
      case "OPTIMIZED": self = .optimized
    ...
    public init(intValue: Int) {
      ...
      case 1: self = .bigtable
      case 2: self = .optimized
