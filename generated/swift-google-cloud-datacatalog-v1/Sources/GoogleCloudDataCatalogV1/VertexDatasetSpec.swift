  ...
  Sendable
{
  ...
  public enum DataType: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .conversation: return try container.encode("CONVERSATION")
      case .timeSeries: return try container.encode("TIME_SERIES")
      case .document: return try container.encode("DOCUMENT")
      case .textToSpeech: return try container.encode("TEXT_TO_SPEECH")
      case .translation: return try container.encode("TRANSLATION")
      case .storeVision: return try container.encode("STORE_VISION")
      case .enterpriseKnowledgeGraph: return try container.encode("ENTERPRISE_KNOWLEDGE_GRAPH")
      case .textPrompt: return try container.encode("TEXT_PROMPT")
