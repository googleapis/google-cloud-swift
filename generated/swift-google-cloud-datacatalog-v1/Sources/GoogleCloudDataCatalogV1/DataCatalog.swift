...
extension Clients.DataCatalogProtocol {
  ...
  ) -> any AsyncSequence<SearchCatalogResult, Swift.Error> {
    self.searchCatalog(byItem: byItem, options: .init())
  }
  ...
  public func searchCatalog(
    ...
    return self.searchCatalog(byItem: request)
  }
  ...
  public func getEntryGroup(
    name: Swift.String,
    readMask: GoogleWKT.WKTFieldMask?,
  ) async throws -> GoogleCloudDataCatalogV1.EntryGroup {
    let request = GetEntryGroupRequest().with {
      $0.name = name
      $0.readMask = readMask
