...
public struct ModifyEntryContactsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ModifyEntryContactsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ModifyEntryContactsRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datacatalog.v1.ModifyEntryContactsRequest"
  }
