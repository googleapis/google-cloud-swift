  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListTaxonomiesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListTaxonomiesResponse().with { $0.taxonomies = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datacatalog.v1.ListTaxonomiesResponse"
  }
