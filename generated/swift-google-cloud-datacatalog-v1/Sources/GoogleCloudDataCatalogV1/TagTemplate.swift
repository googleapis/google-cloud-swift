...
public struct TagTemplate: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let isPubliclyReadable = CodingKeys(stringValue: "isPubliclyReadable")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.Bool.self, forKey: .isPubliclyReadable) {
      self.isPubliclyReadable = value
    }
    if let value = try container.decodeIfPresent(
      [Swift.String: TagTemplateField].self, forKey: .fields)
    {
      self.fields = value
    }
    if let value = try container.decodeIfPresent(
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.isPubliclyReadable, forKey: .isPubliclyReadable)
  ...
  public enum DataplexTransferStatus: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("DATAPLEX_TRANSFER_STATUS_UNSPECIFIED")
      case .migrated: return try container.encode("MIGRATED")
      case .transferred: return try container.encode("TRANSFERRED")
