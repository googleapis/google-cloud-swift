...
public struct DataplexTableSpec: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var externalTables: [DataplexExternalTable] = []
  ...
  ///
  /// ```
  /// let value = DataplexTableSpec().with { $0.externalTables = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datacatalog.v1.DataplexTableSpec"
  }
