...
public struct ListPolicyTagsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListPolicyTagsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPolicyTagsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datacatalog.v1.ListPolicyTagsRequest"
  }
