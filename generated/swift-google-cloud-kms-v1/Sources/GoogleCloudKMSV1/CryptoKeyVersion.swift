  ...
  Sendable
{
  ...
  /// [google.cloud.kms.v1.CryptoKeyVersion.state]: <doc:CryptoKeyVersion/state>
  public var destroyEventTime: GoogleWKT.WKTTimestamp? = nil
  ...
  ///
  /// [google.cloud.kms.v1.CryptoKeyVersion]: <doc:CryptoKeyVersion>
  public var importTime: GoogleWKT.WKTTimestamp? = nil
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.destroyEventTime = try container.decodeIfPresent(
      GoogleWKT.WKTTimestamp.self, forKey: .destroyEventTime)
    ...
    self.importTime = try container.decodeIfPresent(
      GoogleWKT.WKTTimestamp.self, forKey: .importTime)
  ...
  public enum CryptoKeyVersionAlgorithm: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .googleSymmetricEncryption: return try container.encode("GOOGLE_SYMMETRIC_ENCRYPTION")
      case .rsaSignPss2048Sha256: return try container.encode("RSA_SIGN_PSS_2048_SHA256")
      case .rsaSignPss3072Sha256: return try container.encode("RSA_SIGN_PSS_3072_SHA256")
      case .rsaSignPss4096Sha256: return try container.encode("RSA_SIGN_PSS_4096_SHA256")
      case .rsaSignPkcs12048Sha256: return try container.encode("RSA_SIGN_PKCS1_2048_SHA256")
      case .rsaSignPkcs13072Sha256: return try container.encode("RSA_SIGN_PKCS1_3072_SHA256")
      case .rsaSignPkcs14096Sha256: return try container.encode("RSA_SIGN_PKCS1_4096_SHA256")
      case .rsaDecryptOaep2048Sha256: return try container.encode("RSA_DECRYPT_OAEP_2048_SHA256")
      case .rsaDecryptOaep3072Sha256: return try container.encode("RSA_DECRYPT_OAEP_3072_SHA256")
      case .rsaDecryptOaep4096Sha256: return try container.encode("RSA_DECRYPT_OAEP_4096_SHA256")
      case .ecSignP256Sha256: return try container.encode("EC_SIGN_P256_SHA256")
      case .ecSignP384Sha384: return try container.encode("EC_SIGN_P384_SHA384")
      case .rsaSignPss4096Sha512: return try container.encode("RSA_SIGN_PSS_4096_SHA512")
      case .rsaSignPkcs14096Sha512: return try container.encode("RSA_SIGN_PKCS1_4096_SHA512")
      case .rsaDecryptOaep4096Sha512: return try container.encode("RSA_DECRYPT_OAEP_4096_SHA512")
      case .externalSymmetricEncryption:
        return try container.encode("EXTERNAL_SYMMETRIC_ENCRYPTION")
      case .aes256Gcm: return try container.encode("AES_256_GCM")
      case .rsaSignRawPkcs12048: return try container.encode("RSA_SIGN_RAW_PKCS1_2048")
      case .rsaSignRawPkcs13072: return try container.encode("RSA_SIGN_RAW_PKCS1_3072")
      case .rsaSignRawPkcs14096: return try container.encode("RSA_SIGN_RAW_PKCS1_4096")
      case .ecSignSecp256K1Sha256: return try container.encode("EC_SIGN_SECP256K1_SHA256")
      case .hmacSha256: return try container.encode("HMAC_SHA256")
      case .hmacSha1: return try container.encode("HMAC_SHA1")
      case .hmacSha384: return try container.encode("HMAC_SHA384")
      case .hmacSha512: return try container.encode("HMAC_SHA512")
      case .hmacSha224: return try container.encode("HMAC_SHA224")
      case .rsaDecryptOaep2048Sha1: return try container.encode("RSA_DECRYPT_OAEP_2048_SHA1")
      case .rsaDecryptOaep3072Sha1: return try container.encode("RSA_DECRYPT_OAEP_3072_SHA1")
      case .rsaDecryptOaep4096Sha1: return try container.encode("RSA_DECRYPT_OAEP_4096_SHA1")
      case .ecSignEd25519: return try container.encode("EC_SIGN_ED25519")
      case .aes128Gcm: return try container.encode("AES_128_GCM")
      case .aes128Cbc: return try container.encode("AES_128_CBC")
      case .aes256Cbc: return try container.encode("AES_256_CBC")
      case .aes128Ctr: return try container.encode("AES_128_CTR")
      case .aes256Ctr: return try container.encode("AES_256_CTR")
      case .mlKem768: return try container.encode("ML_KEM_768")
      case .mlKem1024: return try container.encode("ML_KEM_1024")
      case .pqSignMlDsa65: return try container.encode("PQ_SIGN_ML_DSA_65")
      case .pqSignSlhDsaSha2128S: return try container.encode("PQ_SIGN_SLH_DSA_SHA2_128S")
      case .pqSignHashSlhDsaSha2128SSha256:
        return try container.encode("PQ_SIGN_HASH_SLH_DSA_SHA2_128S_SHA256")
      case .kemXwing: return try container.encode("KEM_XWING")
      case .pqSignMlDsa65ExternalMu: return try container.encode("PQ_SIGN_ML_DSA_65_EXTERNAL_MU")
      case .pqSignMlDsa44: return try container.encode("PQ_SIGN_ML_DSA_44")
      case .pqSignMlDsa87: return try container.encode("PQ_SIGN_ML_DSA_87")
      case .pqSignMlDsa44ExternalMu: return try container.encode("PQ_SIGN_ML_DSA_44_EXTERNAL_MU")
      case .pqSignMlDsa87ExternalMu: return try container.encode("PQ_SIGN_ML_DSA_87_EXTERNAL_MU")
      case .aes256Kwp: return try container.encode("AES_256_KWP")
  ...
  public enum CryptoKeyVersionState: Codable, Equatable, Hashable, Sendable {
    ...
    /// [google.cloud.kms.v1.KeyManagementService.RestoreCryptoKeyVersion]: <doc:KeyManagementServiceClient/restoreCryptoKeyVersion(request:options:)>
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .pendingImport: return try container.encode("PENDING_IMPORT")
      case .importFailed: return try container.encode("IMPORT_FAILED")
      case .generationFailed: return try container.encode("GENERATION_FAILED")
      case .pendingExternalDestruction: return try container.encode("PENDING_EXTERNAL_DESTRUCTION")
      case .externalDestructionFailed: return try container.encode("EXTERNAL_DESTRUCTION_FAILED")
      case .unknownIntValue(let v): return try container.encode(v)
      case .unknownStringValue(let v): return try container.encode(v)
      }
    }
