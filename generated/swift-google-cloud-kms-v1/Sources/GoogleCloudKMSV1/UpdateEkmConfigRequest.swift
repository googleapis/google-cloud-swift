...
public struct UpdateEkmConfigRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let ekmConfig = CodingKeys(stringValue: "ekmConfig")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.ekmConfig = try container.decodeIfPresent(EkmConfig.self, forKey: .ekmConfig)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.ekmConfig, forKey: .ekmConfig)
