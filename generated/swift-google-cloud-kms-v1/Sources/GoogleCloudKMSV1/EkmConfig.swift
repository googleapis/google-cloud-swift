...
public struct EkmConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let defaultEkmConnection = CodingKeys(stringValue: "defaultEkmConnection")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .defaultEkmConnection) {
      self.defaultEkmConnection = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.defaultEkmConnection, forKey: .defaultEkmConnection)
