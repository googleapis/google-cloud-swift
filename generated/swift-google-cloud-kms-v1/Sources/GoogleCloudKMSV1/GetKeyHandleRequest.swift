...
///
/// [google.cloud.kms.v1.Autokey.GetKeyHandle]: <doc:AutokeyClient/getKeyHandle(request:options:)>
public struct GetKeyHandleRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
