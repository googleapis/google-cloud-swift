...
public struct KeyOperationAttestation: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public struct CertificateChains: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
  ...
  ///   them to named cases.
  public enum AttestationFormat: Codable, Equatable, Hashable, Sendable {
    /// Not specified.
    case unspecified
