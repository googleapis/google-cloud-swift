  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let keyHandles = CodingKeys(stringValue: "keyHandles")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([KeyHandle].self, forKey: .keyHandles) {
      self.keyHandles = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.keyHandles, forKey: .keyHandles)
