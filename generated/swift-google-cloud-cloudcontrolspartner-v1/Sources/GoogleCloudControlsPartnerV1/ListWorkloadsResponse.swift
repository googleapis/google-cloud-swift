  ...
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Workload].self, forKey: .workloads) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.cloudcontrolspartner.v1.ListWorkloadsResponse"
  }
...
extension ListWorkloadsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Workload] {
