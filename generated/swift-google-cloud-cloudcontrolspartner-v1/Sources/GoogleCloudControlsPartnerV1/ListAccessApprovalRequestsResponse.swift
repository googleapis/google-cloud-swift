...
public struct ListAccessApprovalRequestsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// List of access approval requests
  public var accessApprovalRequests: [AccessApprovalRequest] = []
  ...
  /// Initialize a new instance of `ListAccessApprovalRequestsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAccessApprovalRequestsResponse().with { $0.accessApprovalRequests = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let accessApprovalRequests = CodingKeys(stringValue: "accessApprovalRequests")
  ...
  public init(from decoder: Decoder) throws {
    ...
    {
      self.accessApprovalRequests = value
    }
...
extension ListAccessApprovalRequestsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [AccessApprovalRequest] {
    return self.accessApprovalRequests
  }
