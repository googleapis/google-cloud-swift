...
public struct UpdateCustomerRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateCustomerRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateCustomerRequest().with { $0.customer = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.cloudcontrolspartner.v1.UpdateCustomerRequest"
  }
