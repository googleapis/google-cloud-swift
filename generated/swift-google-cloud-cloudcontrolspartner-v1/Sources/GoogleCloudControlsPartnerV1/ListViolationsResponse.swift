...
public struct ListViolationsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// List of violation
  ...
  /// Initialize a new instance of `ListViolationsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListViolationsResponse().with { $0.violations = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Violation].self, forKey: .violations) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.cloudcontrolspartner.v1.ListViolationsResponse"
  }
...
extension ListViolationsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Violation] {
