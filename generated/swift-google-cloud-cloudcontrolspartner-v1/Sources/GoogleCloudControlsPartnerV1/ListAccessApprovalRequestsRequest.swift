...
public struct ListAccessApprovalRequestsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListAccessApprovalRequestsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAccessApprovalRequestsRequest().with { $0.parent = ... }
  /// ```
