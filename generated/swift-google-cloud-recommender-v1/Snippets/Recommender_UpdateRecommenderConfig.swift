...
func sample(client: RecommenderClient, projectId: String, locationId: String, recommenderId: String)
  async throws
{
  let response = try await client.updateRecommenderConfig(
    request: UpdateRecommenderConfigRequest()
      .with {
        $0.recommenderConfig = RecommenderConfig().with {
          $0.name =
