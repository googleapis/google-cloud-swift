...
public struct GetInsightTypeConfigRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetInsightTypeConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetInsightTypeConfigRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.recommender.v1.GetInsightTypeConfigRequest"
  }
