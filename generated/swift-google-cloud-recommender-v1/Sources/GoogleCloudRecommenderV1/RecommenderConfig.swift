...
public struct RecommenderConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let recommenderGenerationConfig = CodingKeys(stringValue: "recommenderGenerationConfig")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.recommenderGenerationConfig = try container.decodeIfPresent(
      RecommenderGenerationConfig.self, forKey: .recommenderGenerationConfig)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(
      self.recommenderGenerationConfig, forKey: .recommenderGenerationConfig)
