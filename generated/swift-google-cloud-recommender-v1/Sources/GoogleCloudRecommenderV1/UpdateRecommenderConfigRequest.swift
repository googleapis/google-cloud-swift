...
public struct UpdateRecommenderConfigRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Required. The RecommenderConfig to update.
  public var recommenderConfig: RecommenderConfig? = nil
  ...
  /// Initialize a new instance of `UpdateRecommenderConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateRecommenderConfigRequest().with { $0.recommenderConfig = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let recommenderConfig = CodingKeys(stringValue: "recommenderConfig")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.recommenderConfig = try container.decodeIfPresent(
      RecommenderConfig.self, forKey: .recommenderConfig)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.recommender.v1.UpdateRecommenderConfigRequest"
  }
