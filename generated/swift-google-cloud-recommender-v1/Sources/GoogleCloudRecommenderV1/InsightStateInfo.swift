...
public struct InsightStateInfo: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Insight state.
  public var state: InsightStateInfo.State = InsightStateInfo.State()
  ...
  /// Initialize a new instance of `InsightStateInfo`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = InsightStateInfo().with { $0.state = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(InsightStateInfo.State.self, forKey: .state) {
      self.state = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.recommender.v1.InsightStateInfo"
  }
