...
public struct UpdateInsightTypeConfigRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateInsightTypeConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateInsightTypeConfigRequest().with { $0.insightTypeConfig = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let insightTypeConfig = CodingKeys(stringValue: "insightTypeConfig")
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.insightTypeConfig, forKey: .insightTypeConfig)
