...
/// recommendation.
public struct RecommenderGenerationConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `RecommenderGenerationConfig`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RecommenderGenerationConfig().with { $0.params = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.recommender.v1.RecommenderGenerationConfig"
  }
