  ...
  Sendable
{
  ...
  /// Initialize a new instance of `SecurityProjection`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SecurityProjection().with { $0.details = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.recommender.v1.SecurityProjection"
  }
