  ...
  Sendable
{
  ...
  public var overview: GoogleWKT.WKTStruct? = nil
  ...
  ///
  /// ```
  /// let value = RecommendationContent().with { $0.operationGroups = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let operationGroups = CodingKeys(stringValue: "operationGroups")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.overview = try container.decodeIfPresent(GoogleWKT.WKTStruct.self, forKey: .overview)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.operationGroups, forKey: .operationGroups)
