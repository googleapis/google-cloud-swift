...
public struct PostdeployJobRun: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var failureCause: PostdeployJobRun.FailureCause = PostdeployJobRun.FailureCause()
  ...
  /// Initialize a new instance of `PostdeployJobRun`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = PostdeployJobRun().with { $0.build = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      PostdeployJobRun.FailureCause.self, forKey: .failureCause)
    {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.PostdeployJobRun"
  }
