...
public struct ListTargetsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The `Target` objects.
  ...
  /// Initialize a new instance of `ListTargetsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListTargetsResponse().with { $0.targets = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Target].self, forKey: .targets) {
      self.targets = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.ListTargetsResponse"
  }
...
extension ListTargetsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Target] {
    return self.targets
  }
