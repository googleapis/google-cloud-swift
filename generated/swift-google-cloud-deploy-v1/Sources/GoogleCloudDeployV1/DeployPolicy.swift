  ...
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [DeployPolicyResourceSelector].self, forKey: .selectors)
    {
  ...
  public enum Invoker: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("INVOKER_UNSPECIFIED")
      case .user: return try container.encode("USER")
      case .deployAutomation: return try container.encode("DEPLOY_AUTOMATION")
