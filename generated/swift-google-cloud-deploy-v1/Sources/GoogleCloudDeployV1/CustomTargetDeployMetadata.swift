...
/// deploy operation.
public struct CustomTargetDeployMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CustomTargetDeployMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CustomTargetDeployMetadata().with { $0.skipMessage = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.CustomTargetDeployMetadata"
  }
