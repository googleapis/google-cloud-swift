...
public struct ListDeliveryPipelinesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDeliveryPipelinesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDeliveryPipelinesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.ListDeliveryPipelinesRequest"
  }
