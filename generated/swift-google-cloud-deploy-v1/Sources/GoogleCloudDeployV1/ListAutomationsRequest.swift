...
public struct ListAutomationsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListAutomationsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAutomationsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.ListAutomationsRequest"
  }
