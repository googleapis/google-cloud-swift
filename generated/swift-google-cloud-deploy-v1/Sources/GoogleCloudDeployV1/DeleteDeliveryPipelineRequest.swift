...
public struct DeleteDeliveryPipelineRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteDeliveryPipelineRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteDeliveryPipelineRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.DeleteDeliveryPipelineRequest"
  }
