...
public struct ListTargetsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListTargetsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListTargetsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.ListTargetsRequest"
  }
