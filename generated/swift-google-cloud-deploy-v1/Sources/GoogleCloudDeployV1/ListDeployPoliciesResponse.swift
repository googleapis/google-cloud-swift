  ...
  Sendable
{
  ...
  public var deployPolicies: [DeployPolicy] = []
  ...
  /// Initialize a new instance of `ListDeployPoliciesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDeployPoliciesResponse().with { $0.deployPolicies = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let deployPolicies = CodingKeys(stringValue: "deployPolicies")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([DeployPolicy].self, forKey: .deployPolicies) {
      self.deployPolicies = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.deployPolicies, forKey: .deployPolicies)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.ListDeployPoliciesResponse"
  }
