...
public struct CreateDeliveryPipelineRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var deliveryPipelineId: Swift.String = Swift.String()

  /// Required. The `DeliveryPipeline` to create.
  public var deliveryPipeline: DeliveryPipeline? = nil
  ...
  ///
  /// ```
  /// let value = CreateDeliveryPipelineRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.CreateDeliveryPipelineRequest"
  }
