...
public struct UpdateDeployPolicyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateDeployPolicyRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateDeployPolicyRequest().with { $0.updateMask = ... }
  /// ```
