...
public struct ListAutomationRunsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListAutomationRunsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAutomationRunsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.ListAutomationRunsRequest"
  }
