...
public struct CreateAutomationRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CreateAutomationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateAutomationRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.CreateAutomationRequest"
  }
