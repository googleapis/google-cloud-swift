...
public struct ListAutomationsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListAutomationsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAutomationsResponse().with { $0.automations = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let automations = CodingKeys(stringValue: "automations")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Automation].self, forKey: .automations) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.ListAutomationsResponse"
  }
...
extension ListAutomationsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Automation] {
