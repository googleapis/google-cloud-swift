...
public struct ListJobRunsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListJobRunsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListJobRunsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.ListJobRunsRequest"
  }
