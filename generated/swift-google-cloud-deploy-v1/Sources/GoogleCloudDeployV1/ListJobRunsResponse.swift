...
public struct ListJobRunsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The `JobRun` objects.
  ...
  /// Initialize a new instance of `ListJobRunsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListJobRunsResponse().with { $0.jobRuns = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let jobRuns = CodingKeys(stringValue: "jobRuns")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([JobRun].self, forKey: .jobRuns) {
      self.jobRuns = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.jobRuns, forKey: .jobRuns)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.ListJobRunsResponse"
  }
...
extension ListJobRunsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [JobRun] {
    return self.jobRuns
  }
