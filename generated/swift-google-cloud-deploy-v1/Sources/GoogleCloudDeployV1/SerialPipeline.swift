...
public struct SerialPipeline: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SerialPipeline`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SerialPipeline().with { $0.stages = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.SerialPipeline"
  }
