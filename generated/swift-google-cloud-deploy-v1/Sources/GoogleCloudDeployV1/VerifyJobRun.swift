...
public struct VerifyJobRun: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let eventLogPath = CodingKeys(stringValue: "eventLogPath")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .eventLogPath) {
      self.eventLogPath = value
    }
    if let value = try container.decodeIfPresent(
      VerifyJobRun.FailureCause.self, forKey: .failureCause)
    {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.eventLogPath, forKey: .eventLogPath)
