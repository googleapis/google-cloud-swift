...
public struct DeleteAutomationRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteAutomationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteAutomationRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.DeleteAutomationRequest"
  }
