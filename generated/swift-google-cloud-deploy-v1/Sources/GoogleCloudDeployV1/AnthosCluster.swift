...
public struct AnthosCluster: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `AnthosCluster`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AnthosCluster().with { $0.membership = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.AnthosCluster"
  }
