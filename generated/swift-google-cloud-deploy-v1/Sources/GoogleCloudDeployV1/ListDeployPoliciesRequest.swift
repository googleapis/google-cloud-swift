...
public struct ListDeployPoliciesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDeployPoliciesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDeployPoliciesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.ListDeployPoliciesRequest"
  }
