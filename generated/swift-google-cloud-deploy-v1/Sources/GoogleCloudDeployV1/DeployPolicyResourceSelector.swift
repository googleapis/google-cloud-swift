...
public struct DeployPolicyResourceSelector: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.target = try container.decodeIfPresent(TargetAttribute.self, forKey: .target)
