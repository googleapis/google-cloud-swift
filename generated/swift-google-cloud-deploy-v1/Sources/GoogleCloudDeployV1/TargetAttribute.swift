...
public struct TargetAttribute: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `TargetAttribute`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = TargetAttribute().with { $0.id = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.TargetAttribute"
  }
