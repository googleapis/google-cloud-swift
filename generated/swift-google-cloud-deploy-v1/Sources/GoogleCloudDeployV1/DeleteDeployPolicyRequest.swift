...
public struct DeleteDeployPolicyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteDeployPolicyRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteDeployPolicyRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.DeleteDeployPolicyRequest"
  }
