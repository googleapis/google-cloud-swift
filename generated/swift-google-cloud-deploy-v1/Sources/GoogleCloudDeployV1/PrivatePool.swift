...
public struct PrivatePool: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `PrivatePool`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = PrivatePool().with { $0.workerPool = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.PrivatePool"
  }
