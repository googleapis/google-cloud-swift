...
public struct DeliveryPipelineNotificationEvent: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeliveryPipelineNotificationEvent`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeliveryPipelineNotificationEvent().with { $0.message = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.DeliveryPipelineNotificationEvent"
  }
