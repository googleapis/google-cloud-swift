...
public struct AdvanceRolloutOperation: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `AdvanceRolloutOperation`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AdvanceRolloutOperation().with { $0.sourcePhase = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let sourcePhase = CodingKeys(stringValue: "sourcePhase")
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.sourcePhase, forKey: .sourcePhase)
