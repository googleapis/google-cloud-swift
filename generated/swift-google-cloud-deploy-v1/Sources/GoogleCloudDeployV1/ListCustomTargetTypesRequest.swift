...
public struct ListCustomTargetTypesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListCustomTargetTypesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCustomTargetTypesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.ListCustomTargetTypesRequest"
  }
