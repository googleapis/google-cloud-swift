...
public struct CreateDeployPolicyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var deployPolicyId: Swift.String = Swift.String()
  ...
  /// Initialize a new instance of `CreateDeployPolicyRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateDeployPolicyRequest().with { $0.parent = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let deployPolicyId = CodingKeys(stringValue: "deployPolicyId")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .deployPolicyId) {
      self.deployPolicyId = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.deployPolicyId, forKey: .deployPolicyId)
    try container.encodeIfPresent(self.deployPolicy, forKey: .deployPolicy)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.CreateDeployPolicyRequest"
  }
