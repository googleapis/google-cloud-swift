...
public struct CreateCustomTargetTypeRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CreateCustomTargetTypeRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateCustomTargetTypeRequest().with { $0.parent = ... }
  /// ```
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.customTargetType, forKey: .customTargetType)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.CreateCustomTargetTypeRequest"
  }
