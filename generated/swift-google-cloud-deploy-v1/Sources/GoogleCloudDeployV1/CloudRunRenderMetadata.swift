...
/// `Release` render.
public struct CloudRunRenderMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CloudRunRenderMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CloudRunRenderMetadata().with { $0.service = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.CloudRunRenderMetadata"
  }
