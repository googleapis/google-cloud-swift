...
public struct UpdateDeliveryPipelineRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateDeliveryPipelineRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateDeliveryPipelineRequest().with { $0.updateMask = ... }
  /// ```
