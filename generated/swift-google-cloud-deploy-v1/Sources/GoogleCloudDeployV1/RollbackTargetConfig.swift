...
public struct RollbackTargetConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `RollbackTargetConfig`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RollbackTargetConfig().with { $0.rollout = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.RollbackTargetConfig"
  }
