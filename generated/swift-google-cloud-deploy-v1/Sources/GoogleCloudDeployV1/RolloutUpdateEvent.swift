...
public struct RolloutUpdateEvent: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///   them to named cases.
  public enum RolloutUpdateType: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("ROLLOUT_UPDATE_TYPE_UNSPECIFIED")
      ...
      case .approvalRequired: return try container.encode("APPROVAL_REQUIRED")
      case .approved: return try container.encode("APPROVED")
      case .rejected: return try container.encode("REJECTED")
      case .advanceRequired: return try container.encode("ADVANCE_REQUIRED")
