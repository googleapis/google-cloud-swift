...
public struct DeleteCustomTargetTypeRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteCustomTargetTypeRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteCustomTargetTypeRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.deploy.v1.DeleteCustomTargetTypeRequest"
  }
