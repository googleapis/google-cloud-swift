...
extension Clients {
  final class FirewallTransport: FirewallStub {
    ...
    public func listIngressRules(
      ...
      let (path, query, configure) = try {
        ...
        if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
          ...
          let path = "/v1/\(pathVariable0)/firewall/ingressRules"
          var query = [
      ...
      let (path, query, configure, omitted) = try {
        ...
        if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
          guard
            let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
              ...
              matching: [.literal("apps/"), .singleWildcard, .literal("/firewall/ingressRules")],
              fieldName: "name")
          else {
            return nil
          }
          let path = "/v1/\(pathVariable0):batchUpdate"
          let query = [
            URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
          ]
          return (path, query)
        ...
        do {
          ...
          builder.maybeAdd(
            ...
            matching: [.literal("apps/"), .singleWildcard, .literal("/firewall/ingressRules")],
            fieldName: "name",
            expecting: "apps/*/firewall/ingressRules"
          )
          paths.append(builder.build())
        }
        throw GoogleGax.RequestError.binding(GoogleGax.BindingError(paths: paths))
        ...
        if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
          guard
            let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
              request.name as Swift.String?,
              matching: [
                .literal("apps/"), .singleWildcard, .literal("/firewall/ingressRules/"),
                .singleWildcard,
              ],
              fieldName: "name")
          else {
