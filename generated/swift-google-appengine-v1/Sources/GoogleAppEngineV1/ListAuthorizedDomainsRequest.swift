...
public struct ListAuthorizedDomainsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListAuthorizedDomainsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAuthorizedDomainsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.appengine.v1.ListAuthorizedDomainsRequest"
  }
