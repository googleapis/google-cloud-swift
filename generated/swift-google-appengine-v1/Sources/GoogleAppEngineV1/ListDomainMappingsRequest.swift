...
public struct ListDomainMappingsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDomainMappingsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDomainMappingsRequest().with { $0.parent = ... }
  /// ```
