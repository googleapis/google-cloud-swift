  ...
  Sendable
{
  ...
  public var certificates: [AuthorizedCertificate] = []
  ...
  /// Initialize a new instance of `ListAuthorizedCertificatesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAuthorizedCertificatesResponse().with { $0.certificates = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [AuthorizedCertificate].self, forKey: .certificates)
    {
