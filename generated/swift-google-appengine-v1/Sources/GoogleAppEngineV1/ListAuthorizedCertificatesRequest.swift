...
public struct ListAuthorizedCertificatesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var view: AuthorizedCertificateView = AuthorizedCertificateView()
  ...
  /// Initialize a new instance of `ListAuthorizedCertificatesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAuthorizedCertificatesRequest().with { $0.parent = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(AuthorizedCertificateView.self, forKey: .view) {
      self.view = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.appengine.v1.ListAuthorizedCertificatesRequest"
  }
