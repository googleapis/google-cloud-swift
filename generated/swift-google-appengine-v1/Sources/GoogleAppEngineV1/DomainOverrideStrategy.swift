...
public enum DomainOverrideStrategy: Codable, Equatable, Hashable, Sendable {
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:DomainOverrideStrategy/unknownStringValue(_:)).
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:DomainOverrideStrategy/unknownIntValue(_:)).
