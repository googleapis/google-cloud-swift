...
public struct UpdateDomainMappingRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var domainMapping: DomainMapping? = nil
  ...
  /// Initialize a new instance of `UpdateDomainMappingRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateDomainMappingRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.appengine.v1.UpdateDomainMappingRequest"
  }
