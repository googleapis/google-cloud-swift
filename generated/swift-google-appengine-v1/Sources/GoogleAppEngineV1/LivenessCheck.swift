  ...
  Sendable
{
  ...
  public var initialDelay: GoogleWKT.WKTDuration? = nil
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let initialDelay = CodingKeys(stringValue: "initialDelay")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.initialDelay = try container.decodeIfPresent(
      GoogleWKT.WKTDuration.self, forKey: .initialDelay)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.initialDelay, forKey: .initialDelay)
