...
public struct SslSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var sslManagementType: SslSettings.SslManagementType = SslSettings.SslManagementType()
  ...
  ///
  /// ```
  /// let value = SslSettings().with { $0.certificateId = ... }
  /// ```
  ...
  ///   them to named cases.
  public enum SslManagementType: Codable, Equatable, Hashable, Sendable {
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "SSL_MANAGEMENT_TYPE_UNSPECIFIED"
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:SslManagementType/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "SSL_MANAGEMENT_TYPE_UNSPECIFIED": self = .unspecified
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:SslManagementType/unknownIntValue(_:)).
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("SSL_MANAGEMENT_TYPE_UNSPECIFIED")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.appengine.v1.SslSettings"
  }
