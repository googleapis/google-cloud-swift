...
///   them to named cases.
public enum AuthFailAction: Codable, Equatable, Hashable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "AUTH_FAIL_ACTION_UNSPECIFIED"
    case .redirect: return "AUTH_FAIL_ACTION_REDIRECT"
    case .unauthorized: return "AUTH_FAIL_ACTION_UNAUTHORIZED"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:AuthFailAction/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "AUTH_FAIL_ACTION_UNSPECIFIED": self = .unspecified
    case "AUTH_FAIL_ACTION_REDIRECT": self = .redirect
    case "AUTH_FAIL_ACTION_UNAUTHORIZED": self = .unauthorized
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:AuthFailAction/unknownIntValue(_:)).
