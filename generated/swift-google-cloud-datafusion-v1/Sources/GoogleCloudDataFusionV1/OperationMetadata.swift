  ...
  Sendable
{
  ...
  public var additionalStatus: [Swift.String: Swift.String] = [:]
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let additionalStatus = CodingKeys(stringValue: "additionalStatus")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [Swift.String: Swift.String].self, forKey: .additionalStatus)
    {
      self.additionalStatus = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.additionalStatus, forKey: .additionalStatus)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datafusion.v1.OperationMetadata"
  }
