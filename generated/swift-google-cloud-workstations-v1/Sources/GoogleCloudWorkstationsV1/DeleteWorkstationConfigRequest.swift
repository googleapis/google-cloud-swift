...
public struct DeleteWorkstationConfigRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteWorkstationConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteWorkstationConfigRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.workstations.v1.DeleteWorkstationConfigRequest"
  }
