...
public struct ListUsableWorkstationConfigsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListUsableWorkstationConfigsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListUsableWorkstationConfigsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.workstations.v1.ListUsableWorkstationConfigsRequest"
  }
