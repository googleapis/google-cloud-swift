...
public struct ListUsableWorkstationsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListUsableWorkstationsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListUsableWorkstationsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.workstations.v1.ListUsableWorkstationsRequest"
  }
