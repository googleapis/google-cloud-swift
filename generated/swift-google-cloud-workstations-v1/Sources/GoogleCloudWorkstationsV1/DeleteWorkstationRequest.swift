...
public struct DeleteWorkstationRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteWorkstationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteWorkstationRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.workstations.v1.DeleteWorkstationRequest"
  }
