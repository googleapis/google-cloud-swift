...
public struct ListWorkstationClustersRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListWorkstationClustersRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListWorkstationClustersRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.workstations.v1.ListWorkstationClustersRequest"
  }
