...
extension Clients {
  final class WorkloadIdentityTransport: WorkloadIdentityStub {
      ...
      let (path, query, configure, omitted) = try {
          ...
          guard
            let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
              ...
              matching: [
                ...
                .literal("/serviceProducers/"), .singleWildcard,
              ],
              fieldName: "parent")
          else {
            return nil
          }
          let path = "/v1/\(pathVariable0):generateServiceAgents"
          let query = [
          ...
          guard
            let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
              ...
              matching: [
                ...
                .singleWildcard, .literal("/serviceProducers/"), .singleWildcard,
              ],
              fieldName: "parent")
          else {
            return nil
        ...
        do {
          ...
          builder.maybeAdd(
            ...
            fieldName: "parent",
            expecting: "projects/*/locations/*/serviceProducers/*"
          )
        ...
        do {
          ...
          builder.maybeAdd(
            ...
            fieldName: "parent",
            expecting: "folders/*/locations/*/serviceProducers/*"
          )
          paths.append(builder.build())
        }
        do {
          ...
          builder.maybeAdd(
            ...
            fieldName: "parent",
            expecting: "organizations/*/locations/*/serviceProducers/*"
          )
          paths.append(builder.build())
        }
