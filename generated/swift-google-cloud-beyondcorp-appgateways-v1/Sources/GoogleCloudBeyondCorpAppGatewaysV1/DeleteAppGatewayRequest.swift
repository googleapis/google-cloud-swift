...
public struct DeleteAppGatewayRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteAppGatewayRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteAppGatewayRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.beyondcorp.appgateways.v1.DeleteAppGatewayRequest"
  }
