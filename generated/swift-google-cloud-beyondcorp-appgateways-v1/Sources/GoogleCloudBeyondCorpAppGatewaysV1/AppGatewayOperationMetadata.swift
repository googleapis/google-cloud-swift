...
public struct AppGatewayOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `AppGatewayOperationMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AppGatewayOperationMetadata().with { $0.createTime = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.beyondcorp.appgateways.v1.AppGatewayOperationMetadata"
  }
