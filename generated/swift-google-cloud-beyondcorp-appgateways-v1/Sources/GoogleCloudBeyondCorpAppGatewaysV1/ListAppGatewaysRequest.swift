...
public struct ListAppGatewaysRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListAppGatewaysRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAppGatewaysRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.beyondcorp.appgateways.v1.ListAppGatewaysRequest"
  }
