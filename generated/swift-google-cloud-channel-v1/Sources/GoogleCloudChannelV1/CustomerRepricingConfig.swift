...
public struct CustomerRepricingConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let repricingConfig = CodingKeys(stringValue: "repricingConfig")
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.repricingConfig, forKey: .repricingConfig)
