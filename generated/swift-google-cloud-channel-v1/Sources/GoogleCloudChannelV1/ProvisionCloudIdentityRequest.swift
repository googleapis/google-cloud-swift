...
public struct ProvisionCloudIdentityRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.user = try container.decodeIfPresent(AdminUser.self, forKey: .user)
