...
public struct ListEntitlementsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// to obtain that page.
  ///
  /// [google.cloud.channel.v1.ListEntitlementsRequest.page_token]: <doc:ListEntitlementsRequest/pageToken>
  public var nextPageToken: Swift.String = Swift.String()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `ListEntitlementsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListEntitlementsResponse().with { $0.entitlements = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let entitlements = CodingKeys(stringValue: "entitlements")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Entitlement].self, forKey: .entitlements) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.channel.v1.ListEntitlementsResponse"
  }
...
extension ListEntitlementsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Entitlement] {
