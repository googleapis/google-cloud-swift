...
public struct Media: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Title of the media.
  ...
  /// Type of the media.
  public var type: MediaType = MediaType()
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(MediaType.self, forKey: .type) {
      self.type = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.channel.v1.Media"
  }
