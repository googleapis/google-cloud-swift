...
///   them to named cases.
public enum ChannelPartnerLinkState: Codable, Equatable, Hashable, Sendable {
  /// Not used.
  case unspecified
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "CHANNEL_PARTNER_LINK_STATE_UNSPECIFIED"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:ChannelPartnerLinkState/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "CHANNEL_PARTNER_LINK_STATE_UNSPECIFIED": self = .unspecified
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:ChannelPartnerLinkState/unknownIntValue(_:)).
