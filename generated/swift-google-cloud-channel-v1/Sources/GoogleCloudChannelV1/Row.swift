  ...
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([ReportValue].self, forKey: .values) {
      self.values = value
    }
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .partitionKey) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.channel.v1.Row"
  }
