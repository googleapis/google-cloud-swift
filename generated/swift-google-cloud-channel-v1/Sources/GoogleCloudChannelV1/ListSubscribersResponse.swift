...
public struct ListSubscribersResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListSubscribersResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListSubscribersResponse().with { $0.topic = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Swift.String].self, forKey: .serviceAccounts) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.channel.v1.ListSubscribersResponse"
  }
