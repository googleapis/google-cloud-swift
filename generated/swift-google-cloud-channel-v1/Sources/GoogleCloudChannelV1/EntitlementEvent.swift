...
public struct EntitlementEvent: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(EntitlementEvent.Type_.self, forKey: .eventType) {
  ...
  public enum Type_: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .paidServiceStarted: return try container.encode("PAID_SERVICE_STARTED")
      case .licenseAssignmentChanged: return try container.encode("LICENSE_ASSIGNMENT_CHANGED")
