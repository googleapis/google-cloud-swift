...
///   them to named cases.
public enum ChannelPartnerLinkView: Codable, Equatable, Hashable, Sendable {
  ...
  ///
  /// [google.cloud.channel.v1.ChannelPartnerLink.channel_partner_cloud_identity_info]: <doc:ChannelPartnerLink/channelPartnerCloudIdentityInfo>
  case basic
  /// Includes all fields.
  case full
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:ChannelPartnerLinkView/unknownStringValue(_:)).
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:ChannelPartnerLinkView/unknownIntValue(_:)).
