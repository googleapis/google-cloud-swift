...
public struct PriceByResource: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var pricePhases: [PricePhase] = []

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `PriceByResource`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = PriceByResource().with { $0.resourceType = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let pricePhases = CodingKeys(stringValue: "pricePhases")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([PricePhase].self, forKey: .pricePhases) {
      self.pricePhases = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.pricePhases, forKey: .pricePhases)
