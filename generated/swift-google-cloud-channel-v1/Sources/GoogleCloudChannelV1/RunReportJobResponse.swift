...
public struct RunReportJobResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// [google.cloud.channel.v1.FetchReportResultsRequest.report_job]: <doc:FetchReportResultsRequest/reportJob>
  public var reportJob: ReportJob? = nil
  ...
  public var reportMetadata: ReportResultsMetadata? = nil

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `RunReportJobResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RunReportJobResponse().with { $0.reportJob = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.reportJob = try container.decodeIfPresent(ReportJob.self, forKey: .reportJob)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.reportJob, forKey: .reportJob)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.channel.v1.RunReportJobResponse"
  }
