  ...
  Sendable
{
  ...
  public var transferableSkus: [TransferableSku] = []
  ...
  /// to obtain that page.
  ///
  /// [google.cloud.channel.v1.ListTransferableSkusRequest.page_token]: <doc:ListTransferableSkusRequest/pageToken>
  public var nextPageToken: Swift.String = Swift.String()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `ListTransferableSkusResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListTransferableSkusResponse().with { $0.transferableSkus = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let transferableSkus = CodingKeys(stringValue: "transferableSkus")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([TransferableSku].self, forKey: .transferableSkus)
    {
      self.transferableSkus = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.transferableSkus, forKey: .transferableSkus)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.channel.v1.ListTransferableSkusResponse"
  }
