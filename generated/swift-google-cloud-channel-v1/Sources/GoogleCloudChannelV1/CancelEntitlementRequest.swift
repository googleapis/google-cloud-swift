...
public struct CancelEntitlementRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CancelEntitlementRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CancelEntitlementRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.channel.v1.CancelEntitlementRequest"
  }
