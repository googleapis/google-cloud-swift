  ...
  Sendable
{
  ...
  public var customerRepricingConfigs: [CustomerRepricingConfig] = []
  ...
  /// to obtain that page.
  ///
  /// [google.cloud.channel.v1.ListCustomerRepricingConfigsRequest.page_token]: <doc:ListCustomerRepricingConfigsRequest/pageToken>
  public var nextPageToken: Swift.String = Swift.String()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `ListCustomerRepricingConfigsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCustomerRepricingConfigsResponse().with { $0.customerRepricingConfigs = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let customerRepricingConfigs = CodingKeys(stringValue: "customerRepricingConfigs")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [CustomerRepricingConfig].self, forKey: .customerRepricingConfigs)
    {
      self.customerRepricingConfigs = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.customerRepricingConfigs, forKey: .customerRepricingConfigs)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.channel.v1.ListCustomerRepricingConfigsResponse"
  }
