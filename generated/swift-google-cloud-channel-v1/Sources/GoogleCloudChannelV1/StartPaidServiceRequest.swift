...
public struct StartPaidServiceRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `StartPaidServiceRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = StartPaidServiceRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.channel.v1.StartPaidServiceRequest"
  }
