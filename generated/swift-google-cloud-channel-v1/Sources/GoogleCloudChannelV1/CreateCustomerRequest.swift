...
///
/// [google.cloud.channel.v1.CloudChannelService.CreateCustomer]: <doc:CloudChannelServiceClient/createCustomer(request:options:)>
public struct CreateCustomerRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.channel.v1.CreateCustomerRequest"
  }
