...
public struct TransferEntitlementsToGoogleRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `TransferEntitlementsToGoogleRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = TransferEntitlementsToGoogleRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.channel.v1.TransferEntitlementsToGoogleRequest"
  }
