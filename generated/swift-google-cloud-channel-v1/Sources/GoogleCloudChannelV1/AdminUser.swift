...
public struct AdminUser: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var givenName: Swift.String = Swift.String()
  ...
  /// Initialize a new instance of `AdminUser`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AdminUser().with { $0.email = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let givenName = CodingKeys(stringValue: "givenName")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .givenName) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.channel.v1.AdminUser"
  }
