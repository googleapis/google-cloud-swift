...
public struct DeleteCustomerRepricingConfigRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteCustomerRepricingConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteCustomerRepricingConfigRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.channel.v1.DeleteCustomerRepricingConfigRequest"
  }
