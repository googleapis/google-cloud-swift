...
public struct LookupOfferRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `LookupOfferRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = LookupOfferRequest().with { $0.entitlement = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.channel.v1.LookupOfferRequest"
  }
