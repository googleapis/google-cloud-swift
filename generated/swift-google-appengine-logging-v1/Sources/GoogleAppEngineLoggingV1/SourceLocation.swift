...
public struct SourceLocation: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SourceLocation`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SourceLocation().with { $0.file = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.appengine.logging.v1.SourceLocation"
  }
