...
Add `swift-google-cloud-commerce-consumer-procurement-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-commerce-consumer-procurement-v1.git --from 0.0.0-preview
```

Then add `GoogleCloudCommerceConsumerProcurementV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudCommerceConsumerProcurementV1 <target-name> --package swift-google-cloud-commerce-consumer-procurement-v1
```
