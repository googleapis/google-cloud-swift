  ...
  Sendable
{
  ...
  public var licensedUsers: [LicensedUser] = []
  ...
  /// Initialize a new instance of `EnumerateLicensedUsersResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = EnumerateLicensedUsersResponse().with { $0.licensedUsers = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let licensedUsers = CodingKeys(stringValue: "licensedUsers")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([LicensedUser].self, forKey: .licensedUsers) {
      self.licensedUsers = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.licensedUsers, forKey: .licensedUsers)
