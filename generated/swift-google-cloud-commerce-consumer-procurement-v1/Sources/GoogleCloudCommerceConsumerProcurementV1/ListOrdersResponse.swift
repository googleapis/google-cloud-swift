...
public struct ListOrdersResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListOrdersResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListOrdersResponse().with { $0.orders = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let orders = CodingKeys(stringValue: "orders")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Order].self, forKey: .orders) {
      self.orders = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.commerce.consumer.procurement.v1.ListOrdersResponse"
  }
...
extension ListOrdersResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Order] {
    return self.orders
  }
