...
public struct PlaceOrderRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([LineItemInfo].self, forKey: .lineItemInfo) {
      self.lineItemInfo = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.lineItemInfo, forKey: .lineItemInfo)
