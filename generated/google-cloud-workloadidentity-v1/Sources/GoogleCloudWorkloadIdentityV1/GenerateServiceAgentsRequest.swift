...
/// location.
public struct GenerateServiceAgentsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GenerateServiceAgentsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GenerateServiceAgentsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.workloadidentity.v1.GenerateServiceAgentsRequest"
  }
