# Google Cloud Client Libraries for Swift - Cloud Memorystore for Memcached API
...
Add `swift-google-cloud-memcache-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-memcache-v1.git --from 0.3.0
```

Then add `GoogleCloudMemcacheV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudMemcacheV1 <target-name> --package swift-google-cloud-memcache-v1
```
