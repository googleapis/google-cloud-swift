...
// limitations under the License.
    ...
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = InstancesRotateEntraIdCertificateRequest().with { $0.rotateEntraIdCertificateContext = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let rotateEntraIdCertificateContext = CodingKeys(
        stringValue: "rotateEntraIdCertificateContext")
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.rotateEntraIdCertificateContext = try container.decodeIfPresent(
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encodeIfPresent(
        self.rotateEntraIdCertificateContext, forKey: .rotateEntraIdCertificateContext)
