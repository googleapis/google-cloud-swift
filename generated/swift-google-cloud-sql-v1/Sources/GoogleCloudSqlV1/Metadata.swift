...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var sqlStatementExecutionTime: GoogleWKT.Duration? = nil
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let sqlStatementExecutionTime = CodingKeys(stringValue: "sqlStatementExecutionTime")
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.sqlStatementExecutionTime = try container.decodeIfPresent(
        GoogleWKT.Duration.self, forKey: .sqlStatementExecutionTime)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.sql.v1.Metadata"
    }
