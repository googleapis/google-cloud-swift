...
// limitations under the License.
  ...
  public struct SqlInstancesRotateEntraIdCertificateRequest: Codable, Equatable, GoogleCloudWKT
      ._AnyPackable,
    Sendable
  {
    ...
    public var body: InstancesRotateEntraIdCertificateRequest? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleCloudWKT._UnknownFields = .init()

    /// Initialize a new instance of `SqlInstancesRotateEntraIdCertificateRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SqlInstancesRotateEntraIdCertificateRequest().with { $0.instance = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.body = try container.decodeIfPresent(
        InstancesRotateEntraIdCertificateRequest.self, forKey: .body)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.sql.v1.SqlInstancesRotateEntraIdCertificateRequest"
    }
