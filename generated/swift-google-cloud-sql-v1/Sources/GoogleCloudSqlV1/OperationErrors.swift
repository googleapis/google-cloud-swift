...
// limitations under the License.
  ...
  public struct OperationErrors: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([OperationError].self, forKey: .errors) {
        self.errors = value
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.sql.v1.OperationErrors"
    }
