...
// limitations under the License.
  ...
  extension Clients {
    final class SqlFeatureEligibilityServiceRetry: SqlFeatureEligibilityServiceStub {
      let inner: any SqlFeatureEligibilityServiceStub
      let options: GoogleGax.ClientOptions

      public init(_ inner: any SqlFeatureEligibilityServiceStub, options: GoogleGax.ClientOptions) {
        self.inner = inner
