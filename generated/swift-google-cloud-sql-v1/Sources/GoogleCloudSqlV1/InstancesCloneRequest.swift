...
// limitations under the License.
    ...
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let cloneContext = CodingKeys(stringValue: "cloneContext")
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.cloneContext = try container.decodeIfPresent(CloneContext.self, forKey: .cloneContext)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encodeIfPresent(self.cloneContext, forKey: .cloneContext)
