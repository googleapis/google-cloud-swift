...
// limitations under the License.
  ...
  public struct FailoverContext: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(Swift.Int64.self, forKey: .settingsVersion) {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.settingsVersion, forKey: .settingsVersion)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.sql.v1.FailoverContext"
    }
