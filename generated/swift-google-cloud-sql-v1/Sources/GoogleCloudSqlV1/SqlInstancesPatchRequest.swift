...
// limitations under the License.
  ...
  public struct SqlInstancesPatchRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let reconcilePscNetworking = CodingKeys(stringValue: "reconcilePscNetworking")
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.reconcilePscNetworking = try container.decodeIfPresent(
        Swift.Bool.self, forKey: .reconcilePscNetworking)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encodeIfPresent(self.reconcilePscNetworking, forKey: .reconcilePscNetworking)
