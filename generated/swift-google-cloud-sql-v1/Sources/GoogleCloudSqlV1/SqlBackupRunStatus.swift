...
// limitations under the License.
  ...
  public enum SqlBackupRunStatus: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("SQL_BACKUP_RUN_STATUS_UNSPECIFIED")
      case .enqueued: return try container.encode("ENQUEUED")
      case .overdue: return try container.encode("OVERDUE")
      ...
      case .deletionPending: return try container.encode("DELETION_PENDING")
