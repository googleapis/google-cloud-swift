...
// limitations under the License.
  ...
  /// Flags list response.
  public struct FlagsListResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Flag].self, forKey: .items) {
        self.items = value
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.sql.v1.FlagsListResponse"
    }
