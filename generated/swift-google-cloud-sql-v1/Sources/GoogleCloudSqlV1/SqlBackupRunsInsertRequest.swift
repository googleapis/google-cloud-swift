...
// limitations under the License.
  ...
  public struct SqlBackupRunsInsertRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    public var body: BackupRun? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleCloudWKT._UnknownFields = .init()

    /// Initialize a new instance of `SqlBackupRunsInsertRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SqlBackupRunsInsertRequest().with { $0.instance = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.body = try container.decodeIfPresent(BackupRun.self, forKey: .body)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.sql.v1.SqlBackupRunsInsertRequest"
    }
