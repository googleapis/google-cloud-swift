...
// limitations under the License.
  ...
  public struct SqlInstancesResetSslConfigRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    public enum ResetSslMode: Codable, Equatable, Sendable {
      ...
      public var stringValue: Swift.String? {
        switch self {
        case .unspecified: return "RESET_SSL_MODE_UNSPECIFIED"
        case .all: return "ALL"
        case .syncFromPrimary: return "SYNC_FROM_PRIMARY"
      ...
      ///
      /// If the value is unknown, this initializes to [`unknownStringValue`](doc:ResetSslMode/unknownStringValue(_:)).
      public init(stringValue: Swift.String) {
        switch stringValue {
        case "RESET_SSL_MODE_UNSPECIFIED": self = .unspecified
        case "ALL": self = .all
        case "SYNC_FROM_PRIMARY": self = .syncFromPrimary
      ...
      ///
      /// If the value is unknown, this initializes to [`unknownIntValue`](doc:ResetSslMode/unknownIntValue(_:)).
      public init(intValue: Int) {
        switch intValue {
        case 0: self = .unspecified
        case 1: self = .all
        case 2: self = .syncFromPrimary
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .unspecified: return try container.encode("RESET_SSL_MODE_UNSPECIFIED")
        case .all: return try container.encode("ALL")
        case .syncFromPrimary: return try container.encode("SYNC_FROM_PRIMARY")
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.sql.v1.SqlInstancesResetSslConfigRequest"
    }
