...
// limitations under the License.
  ...
  /// actions.
  public struct PreCheckResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let actionsRequired = CodingKeys(stringValue: "actionsRequired")
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.messageType = try container.decodeIfPresent(
        PreCheckResponse.MessageType.self, forKey: .messageType)
      if let value = try container.decodeIfPresent([Swift.String].self, forKey: .actionsRequired) {
        self.actionsRequired = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.actionsRequired, forKey: .actionsRequired)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.sql.v1.PreCheckResponse"
    }
