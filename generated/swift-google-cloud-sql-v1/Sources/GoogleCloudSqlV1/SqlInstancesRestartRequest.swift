...
// limitations under the License.
  ...
  public struct SqlInstancesRestartRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `SqlInstancesRestartRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SqlInstancesRestartRequest().with { $0.instance = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.sql.v1.SqlInstancesRestartRequest"
    }
