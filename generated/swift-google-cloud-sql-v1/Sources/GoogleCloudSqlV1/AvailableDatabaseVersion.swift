...
// limitations under the License.
  ...
  public struct AvailableDatabaseVersion: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let majorVersion = CodingKeys(stringValue: "majorVersion")
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.majorVersion = try container.decodeIfPresent(Swift.String.self, forKey: .majorVersion)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encodeIfPresent(self.majorVersion, forKey: .majorVersion)
