    ...
    Sendable
  {
    ...
    public enum PartialResultMode: Codable, Equatable, Sendable {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .unspecified: return try container.encode("PARTIAL_RESULT_MODE_UNSPECIFIED")
        case .failPartialResult: return try container.encode("FAIL_PARTIAL_RESULT")
        case .allowPartialResult: return try container.encode("ALLOW_PARTIAL_RESULT")
