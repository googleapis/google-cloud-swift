...
// limitations under the License.
  ...
  public struct SqlInstancesReleaseSsrsLeaseResponse: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `SqlInstancesReleaseSsrsLeaseResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SqlInstancesReleaseSsrsLeaseResponse().with { $0.operationId = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.sql.v1.SqlInstancesReleaseSsrsLeaseResponse"
    }
