...
// limitations under the License.
...
#if SqlBackupRunsService || SqlBackupsService
  import Foundation
  ...
  ///   them to named cases.
  public enum SqlBackupKind: Codable, Equatable, Hashable, Sendable {
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "SQL_BACKUP_KIND_UNSPECIFIED"
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:SqlBackupKind/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "SQL_BACKUP_KIND_UNSPECIFIED": self = .unspecified
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:SqlBackupKind/unknownIntValue(_:)).
