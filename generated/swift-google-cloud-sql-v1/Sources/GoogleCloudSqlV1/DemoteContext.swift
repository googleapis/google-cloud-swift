...
// limitations under the License.
  ...
  public struct DemoteContext: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let sourceRepresentativeInstanceName = CodingKeys(
        stringValue: "sourceRepresentativeInstanceName")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        Swift.String.self, forKey: .sourceRepresentativeInstanceName)
      {
        self.sourceRepresentativeInstanceName = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(
        self.sourceRepresentativeInstanceName, forKey: .sourceRepresentativeInstanceName)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.sql.v1.DemoteContext"
    }
