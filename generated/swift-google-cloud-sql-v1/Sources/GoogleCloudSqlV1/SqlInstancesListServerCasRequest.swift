...
// limitations under the License.
  ...
  public struct SqlInstancesListServerCasRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `SqlInstancesListServerCasRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SqlInstancesListServerCasRequest().with { $0.instance = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.sql.v1.SqlInstancesListServerCasRequest"
    }
