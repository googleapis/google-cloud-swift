...
// limitations under the License.
  ...
  public struct SqlInstancesExportRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.body = try container.decodeIfPresent(InstancesExportRequest.self, forKey: .body)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.sql.v1.SqlInstancesExportRequest"
    }
