...
// limitations under the License.
  ...
  public struct SqlInstancesStopReplicaRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `SqlInstancesStopReplicaRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SqlInstancesStopReplicaRequest().with { $0.instance = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.sql.v1.SqlInstancesStopReplicaRequest"
    }
