...
// limitations under the License.
  ...
  public struct SqlInstancesPointInTimeRestoreRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.context = try container.decodeIfPresent(PointInTimeRestoreContext.self, forKey: .context)
