...
// limitations under the License.
  ...
  public struct SqlInstancesGetDiskShrinkConfigResponse: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let minimalTargetSizeGb = CodingKeys(stringValue: "minimalTargetSizeGb")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(Swift.Int64.self, forKey: .minimalTargetSizeGb) {
        self.minimalTargetSizeGb = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.minimalTargetSizeGb, forKey: .minimalTargetSizeGb)
