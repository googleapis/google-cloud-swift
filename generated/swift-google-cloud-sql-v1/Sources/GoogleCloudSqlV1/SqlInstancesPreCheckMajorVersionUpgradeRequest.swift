...
// limitations under the License.
  ...
  public struct SqlInstancesPreCheckMajorVersionUpgradeRequest: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// upgrade operation.
    public var body: InstancesPreCheckMajorVersionUpgradeRequest? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `SqlInstancesPreCheckMajorVersionUpgradeRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SqlInstancesPreCheckMajorVersionUpgradeRequest().with { $0.instance = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.body = try container.decodeIfPresent(
        InstancesPreCheckMajorVersionUpgradeRequest.self, forKey: .body)
