...
public struct ListMavenArtifactsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListMavenArtifactsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMavenArtifactsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.devtools.artifactregistry.v1.ListMavenArtifactsRequest"
  }
