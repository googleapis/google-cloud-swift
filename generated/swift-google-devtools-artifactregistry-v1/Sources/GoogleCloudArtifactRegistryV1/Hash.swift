...
public struct Hash: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Hash.HashType.self, forKey: .type) {
      self.type = value
    }
  ...
  ///   them to named cases.
  public enum HashType: Codable, Equatable, Hashable, Sendable {
    /// Unspecified.
    case unspecified
    /// SHA256 hash.
    case sha256
    ...
    public var stringValue: Swift.String? {
      ...
      case .md5: return "MD5"
      case .dirsumSha256: return "DIRSUM_SHA256"
    ...
    public init(stringValue: Swift.String) {
      ...
      case "MD5": self = .md5
      case "DIRSUM_SHA256": self = .dirsumSha256
