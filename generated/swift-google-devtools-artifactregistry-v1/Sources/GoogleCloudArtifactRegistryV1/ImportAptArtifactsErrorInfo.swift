...
public struct ImportAptArtifactsErrorInfo: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ImportAptArtifactsErrorInfo`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ImportAptArtifactsErrorInfo().with { $0.gcsSource = ... }
  /// ```
