  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListRulesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListRulesResponse().with { $0.rules = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.devtools.artifactregistry.v1.ListRulesResponse"
  }
