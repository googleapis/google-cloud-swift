...
public struct BatchDeleteVersionsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `BatchDeleteVersionsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = BatchDeleteVersionsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.devtools.artifactregistry.v1.BatchDeleteVersionsRequest"
  }
