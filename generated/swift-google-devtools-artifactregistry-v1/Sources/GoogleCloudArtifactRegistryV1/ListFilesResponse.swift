...
public struct ListFilesResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The files returned.
  ...
  /// Initialize a new instance of `ListFilesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListFilesResponse().with { $0.files = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.devtools.artifactregistry.v1.ListFilesResponse"
  }
...
extension ListFilesResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [File] {
    return self.files
  }
