...
public struct UpdateRuleRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateRuleRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateRuleRequest().with { $0.rule = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.devtools.artifactregistry.v1.UpdateRuleRequest"
  }
