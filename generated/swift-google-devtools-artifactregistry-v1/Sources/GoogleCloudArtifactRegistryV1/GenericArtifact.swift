...
public struct GenericArtifact: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GenericArtifact`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GenericArtifact().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.devtools.artifactregistry.v1.GenericArtifact"
  }
