...
public struct ListDockerImagesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDockerImagesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDockerImagesRequest().with { $0.parent = ... }
  /// ```
