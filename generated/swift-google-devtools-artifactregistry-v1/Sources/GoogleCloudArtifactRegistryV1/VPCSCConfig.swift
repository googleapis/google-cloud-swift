  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let vpcscPolicy = CodingKeys(stringValue: "vpcscPolicy")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(VPCSCConfig.VPCSCPolicy.self, forKey: .vpcscPolicy)
    {
      self.vpcscPolicy = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.vpcscPolicy, forKey: .vpcscPolicy)
