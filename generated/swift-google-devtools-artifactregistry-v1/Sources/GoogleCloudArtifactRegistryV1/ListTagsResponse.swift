...
public struct ListTagsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The tags returned.
  public var tags: [Tag] = []
  ...
  /// Initialize a new instance of `ListTagsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListTagsResponse().with { $0.tags = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.devtools.artifactregistry.v1.ListTagsResponse"
  }
...
extension ListTagsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Tag] {
    return self.tags
  }
