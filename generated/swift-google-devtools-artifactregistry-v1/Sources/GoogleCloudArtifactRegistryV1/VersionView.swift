...
public enum VersionView: Codable, Equatable, Hashable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "VERSION_VIEW_UNSPECIFIED"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:VersionView/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "VERSION_VIEW_UNSPECIFIED": self = .unspecified
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:VersionView/unknownIntValue(_:)).
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    switch self {
    case .unspecified: return try container.encode("VERSION_VIEW_UNSPECIFIED")
