...
public struct ListPythonPackagesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListPythonPackagesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPythonPackagesRequest().with { $0.parent = ... }
  /// ```
