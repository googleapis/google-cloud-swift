...
public struct CleanupPolicyMostRecentVersions: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let keepCount = CodingKeys(stringValue: "keepCount")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.keepCount = try container.decodeIfPresent(Swift.Int32.self, forKey: .keepCount)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.keepCount, forKey: .keepCount)
