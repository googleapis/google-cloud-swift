...
public struct UpdateFileRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Required. The File that replaces the resource on the server.
  public var file: File? = nil
  ...
  /// Initialize a new instance of `UpdateFileRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateFileRequest().with { $0.file = ... }
  /// ```
