...
public struct LustrePath: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `LustrePath`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = LustrePath().with { $0.path = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.lustre.v1.LustrePath"
  }
