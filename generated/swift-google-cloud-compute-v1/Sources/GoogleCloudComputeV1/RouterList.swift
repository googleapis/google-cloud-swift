...
// limitations under the License.
  ...
  public struct RouterList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: RouterList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `RouterList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RouterList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Router].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(RouterList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.RouterList.warning] field.
    ///
    /// [google.cloud.compute.v1.RouterList.warning]: <doc:RouterList/Warning>
      ...
      Sendable
    {
      ...
      public var code: RouterList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [RouterList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(RouterList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent([RouterList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.RouterList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.RouterList.warning.data]: <doc:RouterList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.RouterList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.RouterList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.RouterList.warning.code]: <doc:RouterList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.RouterList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.RouterList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension RouterList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [Router] {
      return self.items
    }
