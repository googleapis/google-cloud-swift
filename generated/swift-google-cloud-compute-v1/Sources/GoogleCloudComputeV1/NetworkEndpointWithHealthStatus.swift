...
// limitations under the License.
  ...
  public struct NetworkEndpointWithHealthStatus: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = NetworkEndpointWithHealthStatus().with { $0.healths = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.NetworkEndpointWithHealthStatus"
    }
