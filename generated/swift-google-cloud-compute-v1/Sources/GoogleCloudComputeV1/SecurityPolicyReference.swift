...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `SecurityPolicyReference`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SecurityPolicyReference().with { $0.securityPolicy = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.SecurityPolicyReference"
    }
