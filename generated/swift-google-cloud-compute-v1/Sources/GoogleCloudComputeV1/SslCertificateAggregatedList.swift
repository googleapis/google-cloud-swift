...
// limitations under the License.
  ...
  public struct SslCertificateAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: SslCertificatesScopedList] = [:]
    ...
    public var warning: SslCertificateAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `SslCertificateAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SslCertificateAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: SslCertificatesScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        SslCertificateAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.SslCertificateAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.SslCertificateAggregatedList.warning]: <doc:SslCertificateAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: SslCertificateAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [SslCertificateAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          SslCertificateAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [SslCertificateAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.SslCertificateAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.SslCertificateAggregatedList.warning.data]: <doc:SslCertificateAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.SslCertificateAggregatedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.SslCertificateAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.SslCertificateAggregatedList.warning.code]: <doc:SslCertificateAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.SslCertificateAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.SslCertificateAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension SslCertificateAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, SslCertificatesScopedList)] {
