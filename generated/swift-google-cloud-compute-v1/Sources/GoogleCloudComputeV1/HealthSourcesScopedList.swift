...
// limitations under the License.
  ...
  public struct HealthSourcesScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// A list of HealthSources contained in this scope.
    public var healthSources: [HealthSource] = []

    /// Informational warning which replaces the list of
    /// health sources when the list is empty.
    public var warning: HealthSourcesScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `HealthSourcesScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = HealthSourcesScopedList().with { $0.healthSources = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([HealthSource].self, forKey: .healthSources) {
        self.healthSources = value
      }
      self.warning = try container.decodeIfPresent(
        HealthSourcesScopedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.HealthSourcesScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.HealthSourcesScopedList.warning]: <doc:HealthSourcesScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: HealthSourcesScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [HealthSourcesScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          HealthSourcesScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [HealthSourcesScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.HealthSourcesScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.HealthSourcesScopedList.warning.data]: <doc:HealthSourcesScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.HealthSourcesScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.HealthSourcesScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.HealthSourcesScopedList.warning.code]: <doc:HealthSourcesScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.HealthSourcesScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.HealthSourcesScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
