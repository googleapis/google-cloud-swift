...
// limitations under the License.
  ...
  public struct NetworkFirewallPolicyAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: FirewallPoliciesScopedList] = [:]
    ...
    public var warning: NetworkFirewallPolicyAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `NetworkFirewallPolicyAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = NetworkFirewallPolicyAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: FirewallPoliciesScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        NetworkFirewallPolicyAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.NetworkFirewallPolicyAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.NetworkFirewallPolicyAggregatedList.warning]: <doc:NetworkFirewallPolicyAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: NetworkFirewallPolicyAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [NetworkFirewallPolicyAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          NetworkFirewallPolicyAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [NetworkFirewallPolicyAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.NetworkFirewallPolicyAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.NetworkFirewallPolicyAggregatedList.warning.data]: <doc:NetworkFirewallPolicyAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.NetworkFirewallPolicyAggregatedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.NetworkFirewallPolicyAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.NetworkFirewallPolicyAggregatedList.warning.code]: <doc:NetworkFirewallPolicyAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return
          "type.googleapis.com/google.cloud.compute.v1.NetworkFirewallPolicyAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.NetworkFirewallPolicyAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension NetworkFirewallPolicyAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, FirewallPoliciesScopedList)] {
