...
// limitations under the License.
  ...
  public struct BackendBucketUsedBy: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = BackendBucketUsedBy().with { $0.reference = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.BackendBucketUsedBy"
    }
