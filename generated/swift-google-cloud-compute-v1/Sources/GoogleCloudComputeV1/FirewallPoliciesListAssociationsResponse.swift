...
// limitations under the License.
    ...
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = FirewallPoliciesListAssociationsResponse().with { $0.associations = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.FirewallPoliciesListAssociationsResponse"
    }
