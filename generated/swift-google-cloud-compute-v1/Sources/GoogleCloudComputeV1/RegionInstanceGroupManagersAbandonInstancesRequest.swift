...
// limitations under the License.
  ...
  public struct RegionInstanceGroupManagersAbandonInstancesRequest: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `RegionInstanceGroupManagersAbandonInstancesRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RegionInstanceGroupManagersAbandonInstancesRequest().with { $0.instances = ... }
    /// ```
