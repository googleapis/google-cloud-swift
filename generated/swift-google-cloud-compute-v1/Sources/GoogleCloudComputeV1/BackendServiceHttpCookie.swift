...
// limitations under the License.
  ...
  public struct BackendServiceHttpCookie: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// Name of the cookie.
    ...
    /// Initialize a new instance of `BackendServiceHttpCookie`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = BackendServiceHttpCookie().with { $0.name = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.BackendServiceHttpCookie"
    }
