...
// limitations under the License.
  ...
  public struct ResourcePoliciesScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// A list of resourcePolicies contained in this scope.
    public var resourcePolicies: [ResourcePolicy] = []

    /// Informational warning which replaces the list of resourcePolicies when
    /// the list is empty.
    public var warning: ResourcePoliciesScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ResourcePoliciesScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ResourcePoliciesScopedList().with { $0.resourcePolicies = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([ResourcePolicy].self, forKey: .resourcePolicies)
      {
        self.resourcePolicies = value
      }
      self.warning = try container.decodeIfPresent(
        ResourcePoliciesScopedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.ResourcePoliciesScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.ResourcePoliciesScopedList.warning]: <doc:ResourcePoliciesScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: ResourcePoliciesScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [ResourcePoliciesScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          ResourcePoliciesScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [ResourcePoliciesScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.ResourcePoliciesScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.ResourcePoliciesScopedList.warning.data]: <doc:ResourcePoliciesScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.ResourcePoliciesScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.ResourcePoliciesScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.ResourcePoliciesScopedList.warning.code]: <doc:ResourcePoliciesScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.ResourcePoliciesScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ResourcePoliciesScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
