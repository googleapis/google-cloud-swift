...
// limitations under the License.
  ...
  public struct BackendServiceCdnPolicy: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var bypassCacheOnRequestHeaders: [BackendServiceCdnPolicyBypassCacheOnRequestHeader] = []

    /// The CacheKeyPolicy for this CdnPolicy.
    public var cacheKeyPolicy: CacheKeyPolicy? = nil
    ...
    /// to CACHE_ALL_STATIC.
    public var cacheMode: BackendServiceCdnPolicy.CacheMode? = nil
    ...
    public var negativeCachingPolicy: [BackendServiceCdnPolicyNegativeCachingPolicy] = []
    ...
    /// Initialize a new instance of `BackendServiceCdnPolicy`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = BackendServiceCdnPolicy().with { $0.bypassCacheOnRequestHeaders = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [BackendServiceCdnPolicyBypassCacheOnRequestHeader].self,
      ...
      self.cacheKeyPolicy = try container.decodeIfPresent(
        CacheKeyPolicy.self, forKey: .cacheKeyPolicy)
      self.cacheMode = try container.decodeIfPresent(
        BackendServiceCdnPolicy.CacheMode.self, forKey: .cacheMode)
      ...
      if let value = try container.decodeIfPresent(
        [BackendServiceCdnPolicyNegativeCachingPolicy].self, forKey: .negativeCachingPolicy)
      {
    ...
    /// The enumerated type for the [cacheMode][google.cloud.compute.v1.BackendServiceCdnPolicy.cacheMode] field.
    ///
    /// [google.cloud.compute.v1.BackendServiceCdnPolicy.cacheMode]: <doc:BackendServiceCdnPolicy/CacheMode>
    ///
    ...
    public enum CacheMode: Codable, Equatable, Hashable, Sendable {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        case .invalidCacheMode: return try container.encode("INVALID_CACHE_MODE")
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.BackendServiceCdnPolicy"
    }
