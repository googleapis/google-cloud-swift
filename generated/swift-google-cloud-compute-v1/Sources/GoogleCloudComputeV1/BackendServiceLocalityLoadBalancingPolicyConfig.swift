...
// limitations under the License.
  ...
  public struct BackendServiceLocalityLoadBalancingPolicyConfig: Codable, Equatable, GoogleWKT
    ...
    Sendable
  {
    public var customPolicy: BackendServiceLocalityLoadBalancingPolicyConfigCustomPolicy? = nil
    ...
    ///
    /// ```
    /// let value = BackendServiceLocalityLoadBalancingPolicyConfig().with { $0.customPolicy = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.customPolicy = try container.decodeIfPresent(
        BackendServiceLocalityLoadBalancingPolicyConfigCustomPolicy.self, forKey: .customPolicy)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encodeIfPresent(self.customPolicy, forKey: .customPolicy)
