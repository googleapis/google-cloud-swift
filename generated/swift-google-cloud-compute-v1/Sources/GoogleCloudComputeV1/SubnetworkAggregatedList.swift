...
// limitations under the License.
  ...
  public struct SubnetworkAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: SubnetworksScopedList] = [:]
    ...
    public var warning: SubnetworkAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `SubnetworkAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SubnetworkAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: SubnetworksScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        SubnetworkAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.SubnetworkAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.SubnetworkAggregatedList.warning]: <doc:SubnetworkAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: SubnetworkAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [SubnetworkAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          SubnetworkAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [SubnetworkAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.SubnetworkAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.SubnetworkAggregatedList.warning.data]: <doc:SubnetworkAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.SubnetworkAggregatedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.SubnetworkAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.SubnetworkAggregatedList.warning.code]: <doc:SubnetworkAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.SubnetworkAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.SubnetworkAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension SubnetworkAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, SubnetworksScopedList)] {
