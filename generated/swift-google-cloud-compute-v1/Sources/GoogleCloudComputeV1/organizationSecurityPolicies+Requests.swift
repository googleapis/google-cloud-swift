...
// limitations under the License.
  ...
  extension OrganizationSecurityPoliciesClient {
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = AddAssociationRequest().with { $0.replaceExistingAssociation = ... }
      /// ```
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = AddRuleRequest().with { $0.requestId = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = CopyRulesRequest().with { $0.requestId = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      private struct CodingKeys: CodingKey {
        ...
        static let requestId = CodingKeys(stringValue: "requestId")
        static let securityPolicy = CodingKeys(stringValue: "securityPolicy")
        static let sourceSecurityPolicy = CodingKeys(stringValue: "sourceSecurityPolicy")
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.sourceSecurityPolicy = try container.decodeIfPresent(
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(self.requestId, forKey: .requestId)
        try container.encode(self.securityPolicy, forKey: .securityPolicy)
        try container.encodeIfPresent(self.sourceSecurityPolicy, forKey: .sourceSecurityPolicy)
        for (key, value) in self._unknownFields.json {
          try container.encode(value, forKey: CodingKeys(stringValue: key))
        }
      }
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = DeleteRequest().with { $0.requestId = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = GetRequest().with { $0.securityPolicy = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = GetAssociationRequest().with { $0.name = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = ListAssociationsRequest().with { $0.targetResource = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = MoveRequest().with { $0.parentId = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = PatchRequest().with { $0.requestId = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = RemoveAssociationRequest().with { $0.name = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
