...
// limitations under the License.
  ...
  public struct TargetSslProxiesSetProxyHeaderRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = TargetSslProxiesSetProxyHeaderRequest().with { $0.proxyHeader = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.proxyHeader = try container.decodeIfPresent(
        TargetSslProxiesSetProxyHeaderRequest.ProxyHeader.self, forKey: .proxyHeader)
    ...
    /// The enumerated type for the [proxyHeader][google.cloud.compute.v1.TargetSslProxiesSetProxyHeaderRequest.proxyHeader] field.
    ///
    /// [google.cloud.compute.v1.TargetSslProxiesSetProxyHeaderRequest.proxyHeader]: <doc:TargetSslProxiesSetProxyHeaderRequest/ProxyHeader>
    ///
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.TargetSslProxiesSetProxyHeaderRequest"
    }
