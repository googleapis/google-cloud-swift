...
// limitations under the License.
  ...
  public struct HostsListResponse: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: HostsListResponse.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `HostsListResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = HostsListResponse().with { $0.etag = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Host].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(HostsListResponse.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.HostsListResponse.warning] field.
    ///
    /// [google.cloud.compute.v1.HostsListResponse.warning]: <doc:HostsListResponse/Warning>
      ...
      Sendable
    {
      ...
      public var code: HostsListResponse.Warning.Code? = nil
      ...
      ///   }]
      public var data: [HostsListResponse.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          HostsListResponse.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [HostsListResponse.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.HostsListResponse.warning.data] field.
      ///
      /// [google.cloud.compute.v1.HostsListResponse.warning.data]: <doc:HostsListResponse/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.HostsListResponse.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.HostsListResponse.warning.code] field.
      ///
      /// [google.cloud.compute.v1.HostsListResponse.warning.code]: <doc:HostsListResponse/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.HostsListResponse.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.HostsListResponse"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension HostsListResponse: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [Host] {
      return self.items
    }
