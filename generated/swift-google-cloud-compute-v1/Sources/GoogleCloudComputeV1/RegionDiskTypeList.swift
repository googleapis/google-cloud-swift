...
// limitations under the License.
  ...
  public struct RegionDiskTypeList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: RegionDiskTypeList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `RegionDiskTypeList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RegionDiskTypeList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([DiskType].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        RegionDiskTypeList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.RegionDiskTypeList.warning] field.
    ///
    /// [google.cloud.compute.v1.RegionDiskTypeList.warning]: <doc:RegionDiskTypeList/Warning>
      ...
      Sendable
    {
      ...
      public var code: RegionDiskTypeList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [RegionDiskTypeList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          RegionDiskTypeList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [RegionDiskTypeList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.RegionDiskTypeList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.RegionDiskTypeList.warning.data]: <doc:RegionDiskTypeList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.RegionDiskTypeList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.RegionDiskTypeList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.RegionDiskTypeList.warning.code]: <doc:RegionDiskTypeList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.RegionDiskTypeList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.RegionDiskTypeList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension RegionDiskTypeList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [DiskType] {
      return self.items
    }
