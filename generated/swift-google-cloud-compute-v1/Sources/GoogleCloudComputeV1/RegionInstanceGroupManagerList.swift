...
// limitations under the License.
  ...
  public struct RegionInstanceGroupManagerList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: RegionInstanceGroupManagerList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `RegionInstanceGroupManagerList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RegionInstanceGroupManagerList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.warning = try container.decodeIfPresent(
        RegionInstanceGroupManagerList.Warning.self, forKey: .warning)
    ...
    ///
    /// [google.cloud.compute.v1.RegionInstanceGroupManagerList.warning]: <doc:RegionInstanceGroupManagerList/Warning>
      ...
      Sendable
    {
      ...
      public var code: RegionInstanceGroupManagerList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [RegionInstanceGroupManagerList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          RegionInstanceGroupManagerList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [RegionInstanceGroupManagerList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      ///
      /// [google.cloud.compute.v1.RegionInstanceGroupManagerList.warning.data]: <doc:RegionInstanceGroupManagerList/Warning/Data>
      ...
      ///
      /// [google.cloud.compute.v1.RegionInstanceGroupManagerList.warning.code]: <doc:RegionInstanceGroupManagerList/Warning/Code>
      ///
  ...
  extension RegionInstanceGroupManagerList: GoogleGax._PaginatedResponse {
