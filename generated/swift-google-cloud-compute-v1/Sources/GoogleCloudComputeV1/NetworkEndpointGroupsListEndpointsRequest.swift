...
// limitations under the License.
  ...
  public struct NetworkEndpointGroupsListEndpointsRequest: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.healthStatus = try container.decodeIfPresent(
        NetworkEndpointGroupsListEndpointsRequest.HealthStatus.self, forKey: .healthStatus)
    ...
    public enum HealthStatus: Codable, Equatable, Hashable, Sendable {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .show: return try container.encode("SHOW")
