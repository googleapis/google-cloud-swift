...
// limitations under the License.
  ...
  public final class RegionSnapshotsClient: Clients.RegionSnapshotsProtocol, Sendable {
    ...
    /// @Snippet(path: "regionSnapshots_delete")
    public func delete(
      withPolling: RegionSnapshotsClient.DeleteRequest, options: GoogleGax.RequestOptions
    ...
    /// @Snippet(path: "regionSnapshots_insert")
    public func insert(
      withPolling: RegionSnapshotsClient.InsertRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
    ...
    /// @Snippet(path: "regionSnapshots_setLabels")
    public func setLabels(
      withPolling: RegionSnapshotsClient.SetLabelsRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
    ...
    /// @Snippet(path: "regionSnapshots_updateKmsKey")
    public func updateKmsKey(
      withPolling: RegionSnapshotsClient.UpdateKmsKeyRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
  ...
  @available(
    *, unavailable,
    message: "Enable the 'RegionSnapshots' trait in Package.swift to use this client."
  )
  public final class RegionSnapshotsClient: Sendable {
    @available(
      *, unavailable,
      message: "Enable the 'RegionSnapshots' trait in Package.swift to use this client."
    )
