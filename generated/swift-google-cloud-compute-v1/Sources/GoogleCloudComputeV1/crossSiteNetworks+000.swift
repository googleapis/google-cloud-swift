...
// limitations under the License.
  ...
  public final class CrossSiteNetworksClient: Clients.CrossSiteNetworksProtocol, Sendable {
    ...
    /// @Snippet(path: "crossSiteNetworks_delete")
    public func delete(
      withPolling: CrossSiteNetworksClient.DeleteRequest, options: GoogleGax.RequestOptions
    ...
    /// @Snippet(path: "crossSiteNetworks_insert")
    public func insert(
      withPolling: CrossSiteNetworksClient.InsertRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
    ...
    /// @Snippet(path: "crossSiteNetworks_patch")
    public func patch(
      withPolling: CrossSiteNetworksClient.PatchRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
