      ...
      Sendable
    {
      ...
      public init(from decoder: Decoder) throws {
        ...
        if let value = try container.decodeIfPresent(
          [InstanceGroupManagerResizeRequestStatusLastAttempt.Error.Errors].self, forKey: .errors)
        {
          self.errors = value
        }
        for key in container.allKeys where !CodingKeys._knownKeys.contains(key.stringValue) {
        ...
        Sendable
      {
        ...
        public init(from decoder: Decoder) throws {
          ...
          if let value = try container.decodeIfPresent(
            [InstanceGroupManagerResizeRequestStatusLastAttempt.Error.Errors.ErrorDetails].self,
            forKey: .errorDetails)
          {
