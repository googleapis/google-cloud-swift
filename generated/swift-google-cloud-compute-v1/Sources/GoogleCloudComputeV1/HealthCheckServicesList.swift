...
// limitations under the License.
  ...
  public struct HealthCheckServicesList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [HealthCheckService] = []
    ...
    public var warning: HealthCheckServicesList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `HealthCheckServicesList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = HealthCheckServicesList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([HealthCheckService].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        HealthCheckServicesList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.HealthCheckServicesList.warning] field.
    ///
    /// [google.cloud.compute.v1.HealthCheckServicesList.warning]: <doc:HealthCheckServicesList/Warning>
      ...
      Sendable
    {
      ...
      public var code: HealthCheckServicesList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [HealthCheckServicesList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          HealthCheckServicesList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [HealthCheckServicesList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.HealthCheckServicesList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.HealthCheckServicesList.warning.data]: <doc:HealthCheckServicesList/Warning/Data>
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.HealthCheckServicesList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.HealthCheckServicesList.warning.code]: <doc:HealthCheckServicesList/Warning/Code>
      ///
  ...
  extension HealthCheckServicesList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [HealthCheckService] {
      return self.items
    }
