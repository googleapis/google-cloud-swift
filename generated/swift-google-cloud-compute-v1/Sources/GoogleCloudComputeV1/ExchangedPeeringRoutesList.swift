...
// limitations under the License.
  ...
  public struct ExchangedPeeringRoutesList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [ExchangedPeeringRoute] = []
    ...
    public var warning: ExchangedPeeringRoutesList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ExchangedPeeringRoutesList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ExchangedPeeringRoutesList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([ExchangedPeeringRoute].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        ExchangedPeeringRoutesList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.ExchangedPeeringRoutesList.warning] field.
    ///
    /// [google.cloud.compute.v1.ExchangedPeeringRoutesList.warning]: <doc:ExchangedPeeringRoutesList/Warning>
      ...
      Sendable
    {
      ...
      public var code: ExchangedPeeringRoutesList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [ExchangedPeeringRoutesList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          ExchangedPeeringRoutesList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [ExchangedPeeringRoutesList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.ExchangedPeeringRoutesList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.ExchangedPeeringRoutesList.warning.data]: <doc:ExchangedPeeringRoutesList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.ExchangedPeeringRoutesList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.ExchangedPeeringRoutesList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.ExchangedPeeringRoutesList.warning.code]: <doc:ExchangedPeeringRoutesList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.ExchangedPeeringRoutesList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ExchangedPeeringRoutesList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension ExchangedPeeringRoutesList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [ExchangedPeeringRoute] {
      return self.items
    }
