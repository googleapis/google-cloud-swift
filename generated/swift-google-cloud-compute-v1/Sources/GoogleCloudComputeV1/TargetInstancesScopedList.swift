...
// limitations under the License.
  ...
  public struct TargetInstancesScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// the list is empty.
    public var warning: TargetInstancesScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `TargetInstancesScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = TargetInstancesScopedList().with { $0.targetInstances = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let targetInstances = CodingKeys(stringValue: "targetInstances")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([TargetInstance].self, forKey: .targetInstances)
      {
        self.targetInstances = value
      }
      self.warning = try container.decodeIfPresent(
        TargetInstancesScopedList.Warning.self, forKey: .warning)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.targetInstances, forKey: .targetInstances)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.TargetInstancesScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.TargetInstancesScopedList.warning]: <doc:TargetInstancesScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: TargetInstancesScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [TargetInstancesScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          TargetInstancesScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [TargetInstancesScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.TargetInstancesScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.TargetInstancesScopedList.warning.data]: <doc:TargetInstancesScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.TargetInstancesScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.TargetInstancesScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.TargetInstancesScopedList.warning.code]: <doc:TargetInstancesScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.TargetInstancesScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.TargetInstancesScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
