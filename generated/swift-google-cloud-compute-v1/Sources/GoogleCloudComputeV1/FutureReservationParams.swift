...
// limitations under the License.
  ...
  public struct FutureReservationParams: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `FutureReservationParams`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = FutureReservationParams().with { $0.resourceManagerTags = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.FutureReservationParams"
    }
