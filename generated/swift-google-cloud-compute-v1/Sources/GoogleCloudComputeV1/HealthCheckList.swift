...
// limitations under the License.
  ...
  public struct HealthCheckList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: HealthCheckList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `HealthCheckList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = HealthCheckList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([HealthCheck].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(HealthCheckList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.HealthCheckList.warning] field.
    ///
    /// [google.cloud.compute.v1.HealthCheckList.warning]: <doc:HealthCheckList/Warning>
      ...
      Sendable
    {
      ...
      public var code: HealthCheckList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [HealthCheckList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(HealthCheckList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [HealthCheckList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.HealthCheckList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.HealthCheckList.warning.data]: <doc:HealthCheckList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.HealthCheckList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.HealthCheckList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.HealthCheckList.warning.code]: <doc:HealthCheckList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.HealthCheckList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.HealthCheckList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension HealthCheckList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [HealthCheck] {
      return self.items
    }
