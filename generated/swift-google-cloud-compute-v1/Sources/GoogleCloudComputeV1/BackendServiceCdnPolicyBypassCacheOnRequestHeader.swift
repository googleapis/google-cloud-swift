...
// limitations under the License.
  ...
  public struct BackendServiceCdnPolicyBypassCacheOnRequestHeader: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = BackendServiceCdnPolicyBypassCacheOnRequestHeader().with { $0.headerName = ... }
    /// ```
