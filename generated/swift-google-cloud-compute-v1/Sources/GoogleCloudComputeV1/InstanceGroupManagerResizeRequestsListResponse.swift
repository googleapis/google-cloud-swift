...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var warning: InstanceGroupManagerResizeRequestsListResponse.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `InstanceGroupManagerResizeRequestsListResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstanceGroupManagerResizeRequestsListResponse().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.warning = try container.decodeIfPresent(
        InstanceGroupManagerResizeRequestsListResponse.Warning.self, forKey: .warning)
      ...
      Sendable
    {
      ...
      public var code: InstanceGroupManagerResizeRequestsListResponse.Warning.Code? = nil
      ...
      ///   }]
      public var data: [InstanceGroupManagerResizeRequestsListResponse.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          InstanceGroupManagerResizeRequestsListResponse.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [InstanceGroupManagerResizeRequestsListResponse.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      ///
      /// [google.cloud.compute.v1.InstanceGroupManagerResizeRequestsListResponse.warning.code]: <doc:InstanceGroupManagerResizeRequestsListResponse/Warning/Code>
      ///
