...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var items: [ReliabilityRisk] = []
    ...
    public var warning: ReliabilityRisksListResponse.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ReliabilityRisksListResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ReliabilityRisksListResponse().with { $0.etag = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([ReliabilityRisk].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        ReliabilityRisksListResponse.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.ReliabilityRisksListResponse.warning] field.
    ///
    /// [google.cloud.compute.v1.ReliabilityRisksListResponse.warning]: <doc:ReliabilityRisksListResponse/Warning>
      ...
      Sendable
    {
      ...
      public var code: ReliabilityRisksListResponse.Warning.Code? = nil
      ...
      ///   }]
      public var data: [ReliabilityRisksListResponse.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        if let value = try container.decodeIfPresent(
          [ReliabilityRisksListResponse.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.ReliabilityRisksListResponse.warning.data] field.
      ///
      /// [google.cloud.compute.v1.ReliabilityRisksListResponse.warning.data]: <doc:ReliabilityRisksListResponse/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.ReliabilityRisksListResponse.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.ReliabilityRisksListResponse.warning.code] field.
      ///
      /// [google.cloud.compute.v1.ReliabilityRisksListResponse.warning.code]: <doc:ReliabilityRisksListResponse/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.ReliabilityRisksListResponse.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ReliabilityRisksListResponse"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
