...
// limitations under the License.
  ...
  public struct SslPoliciesScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: SslPoliciesScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `SslPoliciesScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SslPoliciesScopedList().with { $0.sslPolicies = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let sslPolicies = CodingKeys(stringValue: "sslPolicies")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([SslPolicy].self, forKey: .sslPolicies) {
        self.sslPolicies = value
      }
      self.warning = try container.decodeIfPresent(
        SslPoliciesScopedList.Warning.self, forKey: .warning)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.sslPolicies, forKey: .sslPolicies)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.SslPoliciesScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.SslPoliciesScopedList.warning]: <doc:SslPoliciesScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: SslPoliciesScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [SslPoliciesScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          SslPoliciesScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [SslPoliciesScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.SslPoliciesScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.SslPoliciesScopedList.warning.data]: <doc:SslPoliciesScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.SslPoliciesScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.SslPoliciesScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.SslPoliciesScopedList.warning.code]: <doc:SslPoliciesScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.SslPoliciesScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.SslPoliciesScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
