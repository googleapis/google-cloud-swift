...
// limitations under the License.
  ...
  public final class InstantSnapshotGroupsClient: Clients.InstantSnapshotGroupsProtocol, Sendable {
    ...
    /// @Snippet(path: "instantSnapshotGroups_delete")
    public func delete(
      withPolling: InstantSnapshotGroupsClient.DeleteRequest, options: GoogleGax.RequestOptions
    ...
    /// @Snippet(path: "instantSnapshotGroups_insert")
    public func insert(
      withPolling: InstantSnapshotGroupsClient.InsertRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
  ...
  extension Clients {
    ...
    public protocol InstantSnapshotGroupsProtocol: Sendable {
  ...
  @available(
    *, unavailable,
    message: "Enable the 'InstantSnapshotGroups' trait in Package.swift to use this client."
  )
  public final class InstantSnapshotGroupsClient: Sendable {
    @available(
      *, unavailable,
      message: "Enable the 'InstantSnapshotGroups' trait in Package.swift to use this client."
    )
