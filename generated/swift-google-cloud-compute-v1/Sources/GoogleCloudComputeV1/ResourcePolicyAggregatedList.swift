...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var items: [Swift.String: ResourcePoliciesScopedList] = [:]
    ...
    public var warning: ResourcePolicyAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ResourcePolicyAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ResourcePolicyAggregatedList().with { $0.etag = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: ResourcePoliciesScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        ResourcePolicyAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.ResourcePolicyAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.ResourcePolicyAggregatedList.warning]: <doc:ResourcePolicyAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: ResourcePolicyAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [ResourcePolicyAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          ResourcePolicyAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [ResourcePolicyAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.ResourcePolicyAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.ResourcePolicyAggregatedList.warning.data]: <doc:ResourcePolicyAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.ResourcePolicyAggregatedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.ResourcePolicyAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.ResourcePolicyAggregatedList.warning.code]: <doc:ResourcePolicyAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.ResourcePolicyAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ResourcePolicyAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
