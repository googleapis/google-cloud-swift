...
// limitations under the License.
  ...
  public struct InstanceGroupList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: InstanceGroupList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `InstanceGroupList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstanceGroupList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.warning = try container.decodeIfPresent(InstanceGroupList.Warning.self, forKey: .warning)
    ...
    ///
    /// [google.cloud.compute.v1.InstanceGroupList.warning]: <doc:InstanceGroupList/Warning>
      ...
      Sendable
    {
      ...
      public var code: InstanceGroupList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [InstanceGroupList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          InstanceGroupList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [InstanceGroupList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      ///
      /// [google.cloud.compute.v1.InstanceGroupList.warning.data]: <doc:InstanceGroupList/Warning/Data>
      ...
      ///
      /// [google.cloud.compute.v1.InstanceGroupList.warning.code]: <doc:InstanceGroupList/Warning/Code>
      ///
  ...
  extension InstanceGroupList: GoogleGax._PaginatedResponse {
