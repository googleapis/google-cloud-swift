...
// limitations under the License.
      ...
      Sendable
  {
    ...
    /// Initialize a new instance of `GlobalVmExtensionPolicyRolloutOperationRolloutStatusRolloutMetadataLocationRolloutStatus`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = GlobalVmExtensionPolicyRolloutOperationRolloutStatusRolloutMetadataLocationRolloutStatus().with { $0.state = ... }
    /// ```
    ...
    /// The enumerated type for the [state][google.cloud.compute.v1.GlobalVmExtensionPolicyRolloutOperationRolloutStatusRolloutMetadataLocationRolloutStatus.state] field.
    ///
    ...
    public enum State: Codable, Equatable, Hashable, Sendable {
      ...
      public var stringValue: Swift.String? {
        ...
        case .locationRolloutStateNotStarted: return "LOCATION_ROLLOUT_STATE_NOT_STARTED"
        case .locationRolloutStateSkipped: return "LOCATION_ROLLOUT_STATE_SKIPPED"
        case .locationRolloutStateUnspecified: return "LOCATION_ROLLOUT_STATE_UNSPECIFIED"
      ...
      public init(stringValue: Swift.String) {
        switch stringValue {
        case "LOCATION_ROLLOUT_STATE_COMPLETED": self = .locationRolloutStateCompleted
        case "LOCATION_ROLLOUT_STATE_FAILED": self = .locationRolloutStateFailed
        case "LOCATION_ROLLOUT_STATE_NOT_STARTED": self = .locationRolloutStateNotStarted
        case "LOCATION_ROLLOUT_STATE_SKIPPED": self = .locationRolloutStateSkipped
        case "LOCATION_ROLLOUT_STATE_UNSPECIFIED": self = .locationRolloutStateUnspecified
    ...
    public static var _anyTypeUrl: Swift.String {
      return
        "type.googleapis.com/google.cloud.compute.v1.GlobalVmExtensionPolicyRolloutOperationRolloutStatusRolloutMetadataLocationRolloutStatus"
    }
