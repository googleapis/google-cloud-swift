...
// limitations under the License.
  ...
  extension Clients {
    final class HttpsHealthChecksTransport: HttpsHealthChecksStub {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            guard
              let pathVariable1 = try GoogleGax._RoutingMatcher.pathValue(
                request.httpsHealthCheck as Swift.String?,
                matching: [.singleWildcard],
            ...
            let path =
              "/compute/v1/projects/\(pathVariable0)/global/httpsHealthChecks/\(pathVariable1)"
            var query = [
      ...
      public func `get`(
        ...
        req.addHeader(name: GoogleGax._HeaderNames.apiClient, value: Clients.clientHeader)
        return try await req.rpc(
          GoogleCloudComputeV1.HttpsHealthCheck.self, timeout: options.attemptTimeout
        ).get()
      }
      ...
      public func insert(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/compute/v1/projects/\(pathVariable0)/global/httpsHealthChecks"
            var query = [
              URLQueryItem(name: "$alt", value: "json")
            ]
            let encoder = GoogleGax._QueryParameterEncoder()
      ...
      public func list(
        ...
        req.addHeader(name: GoogleGax._HeaderNames.apiClient, value: Clients.clientHeader)
        return try await req.rpc(
          GoogleCloudComputeV1.HttpsHealthCheckList.self, timeout: options.attemptTimeout
        ).get()
      }
      ...
      public func testIamPermissions(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path =
              "/compute/v1/projects/\(pathVariable0)/global/httpsHealthChecks/\(pathVariable1)/testIamPermissions"
            let query = [
              URLQueryItem(name: "$alt", value: "json")
            ]
            return (path, query)
