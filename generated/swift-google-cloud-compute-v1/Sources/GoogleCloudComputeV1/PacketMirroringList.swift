...
// limitations under the License.
  ...
  public struct PacketMirroringList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [PacketMirroring] = []
    ...
    public var warning: PacketMirroringList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `PacketMirroringList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = PacketMirroringList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([PacketMirroring].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        PacketMirroringList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.PacketMirroringList.warning] field.
    ///
    /// [google.cloud.compute.v1.PacketMirroringList.warning]: <doc:PacketMirroringList/Warning>
      ...
      Sendable
    {
      ...
      public var code: PacketMirroringList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [PacketMirroringList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          PacketMirroringList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [PacketMirroringList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.PacketMirroringList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.PacketMirroringList.warning.data]: <doc:PacketMirroringList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.PacketMirroringList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.PacketMirroringList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.PacketMirroringList.warning.code]: <doc:PacketMirroringList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.PacketMirroringList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.PacketMirroringList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension PacketMirroringList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [PacketMirroring] {
      return self.items
    }
