...
// limitations under the License.
  ...
  public struct InstanceGroupManagersResumeInstancesRequest: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `InstanceGroupManagersResumeInstancesRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstanceGroupManagersResumeInstancesRequest().with { $0.instances = ... }
    /// ```
