...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var items: [VmExtensionPolicy] = []
    ...
    public var warning: VmExtensionPolicyList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `VmExtensionPolicyList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = VmExtensionPolicyList().with { $0.etag = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([VmExtensionPolicy].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        VmExtensionPolicyList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.VmExtensionPolicyList.warning] field.
    ///
    /// [google.cloud.compute.v1.VmExtensionPolicyList.warning]: <doc:VmExtensionPolicyList/Warning>
      ...
      Sendable
    {
      ...
      public var code: VmExtensionPolicyList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [VmExtensionPolicyList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          VmExtensionPolicyList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [VmExtensionPolicyList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.VmExtensionPolicyList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.VmExtensionPolicyList.warning.data]: <doc:VmExtensionPolicyList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.VmExtensionPolicyList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.VmExtensionPolicyList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.VmExtensionPolicyList.warning.code]: <doc:VmExtensionPolicyList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.VmExtensionPolicyList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.VmExtensionPolicyList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
