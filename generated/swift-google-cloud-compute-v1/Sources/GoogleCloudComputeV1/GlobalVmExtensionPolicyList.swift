...
// limitations under the License.
  ...
  public struct GlobalVmExtensionPolicyList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [GlobalVmExtensionPolicy] = []
    ...
    public var warning: GlobalVmExtensionPolicyList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `GlobalVmExtensionPolicyList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = GlobalVmExtensionPolicyList().with { $0.etag = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([GlobalVmExtensionPolicy].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        GlobalVmExtensionPolicyList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.GlobalVmExtensionPolicyList.warning] field.
    ///
    /// [google.cloud.compute.v1.GlobalVmExtensionPolicyList.warning]: <doc:GlobalVmExtensionPolicyList/Warning>
      ...
      Sendable
    {
      ...
      public var code: GlobalVmExtensionPolicyList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [GlobalVmExtensionPolicyList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          GlobalVmExtensionPolicyList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [GlobalVmExtensionPolicyList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.GlobalVmExtensionPolicyList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.GlobalVmExtensionPolicyList.warning.data]: <doc:GlobalVmExtensionPolicyList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.GlobalVmExtensionPolicyList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.GlobalVmExtensionPolicyList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.GlobalVmExtensionPolicyList.warning.code]: <doc:GlobalVmExtensionPolicyList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.GlobalVmExtensionPolicyList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.GlobalVmExtensionPolicyList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension GlobalVmExtensionPolicyList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [GlobalVmExtensionPolicy] {
      return self.items
    }
