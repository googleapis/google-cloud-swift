...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `RegionNetworkEndpointGroupsAttachEndpointsRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RegionNetworkEndpointGroupsAttachEndpointsRequest().with { $0.networkEndpoints = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return
        "type.googleapis.com/google.cloud.compute.v1.RegionNetworkEndpointGroupsAttachEndpointsRequest"
    }
