...
// limitations under the License.
  ...
  public struct TargetInstanceAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: TargetInstancesScopedList] = [:]
    ...
    public var warning: TargetInstanceAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `TargetInstanceAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = TargetInstanceAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: TargetInstancesScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        TargetInstanceAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.TargetInstanceAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.TargetInstanceAggregatedList.warning]: <doc:TargetInstanceAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: TargetInstanceAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [TargetInstanceAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          TargetInstanceAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [TargetInstanceAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.TargetInstanceAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.TargetInstanceAggregatedList.warning.data]: <doc:TargetInstanceAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.TargetInstanceAggregatedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.TargetInstanceAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.TargetInstanceAggregatedList.warning.code]: <doc:TargetInstanceAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.TargetInstanceAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.TargetInstanceAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension TargetInstanceAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, TargetInstancesScopedList)] {
