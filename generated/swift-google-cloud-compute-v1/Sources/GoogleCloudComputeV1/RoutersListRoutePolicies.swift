...
// limitations under the License.
  ...
  public struct RoutersListRoutePolicies: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: RoutersListRoutePolicies.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `RoutersListRoutePolicies`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RoutersListRoutePolicies().with { $0.etag = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([RoutePolicy].self, forKey: .result) {
        self.result = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        RoutersListRoutePolicies.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.RoutersListRoutePolicies.warning] field.
    ///
    /// [google.cloud.compute.v1.RoutersListRoutePolicies.warning]: <doc:RoutersListRoutePolicies/Warning>
      ...
      Sendable
    {
      ...
      public var code: RoutersListRoutePolicies.Warning.Code? = nil
      ...
      ///   }]
      public var data: [RoutersListRoutePolicies.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          RoutersListRoutePolicies.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [RoutersListRoutePolicies.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.RoutersListRoutePolicies.warning.data] field.
      ///
      /// [google.cloud.compute.v1.RoutersListRoutePolicies.warning.data]: <doc:RoutersListRoutePolicies/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.RoutersListRoutePolicies.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.RoutersListRoutePolicies.warning.code] field.
      ///
      /// [google.cloud.compute.v1.RoutersListRoutePolicies.warning.code]: <doc:RoutersListRoutePolicies/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.RoutersListRoutePolicies.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.RoutersListRoutePolicies"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension RoutersListRoutePolicies: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [RoutePolicy] {
      return self.result
    }
