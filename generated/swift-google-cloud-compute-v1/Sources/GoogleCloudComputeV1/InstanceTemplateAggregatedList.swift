...
// limitations under the License.
  ...
  public struct InstanceTemplateAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: InstanceTemplatesScopedList] = [:]
    ...
    public var warning: InstanceTemplateAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `InstanceTemplateAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstanceTemplateAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: InstanceTemplatesScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        InstanceTemplateAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.InstanceTemplateAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.InstanceTemplateAggregatedList.warning]: <doc:InstanceTemplateAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: InstanceTemplateAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [InstanceTemplateAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          InstanceTemplateAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [InstanceTemplateAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.InstanceTemplateAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.InstanceTemplateAggregatedList.warning.data]: <doc:InstanceTemplateAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.InstanceTemplateAggregatedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.InstanceTemplateAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.InstanceTemplateAggregatedList.warning.code]: <doc:InstanceTemplateAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.InstanceTemplateAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InstanceTemplateAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension InstanceTemplateAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, InstanceTemplatesScopedList)] {
