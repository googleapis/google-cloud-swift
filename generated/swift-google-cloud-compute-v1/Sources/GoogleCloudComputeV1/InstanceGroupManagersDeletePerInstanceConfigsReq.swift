...
// limitations under the License.
  ...
  public struct InstanceGroupManagersDeletePerInstanceConfigsReq: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = InstanceGroupManagersDeletePerInstanceConfigsReq().with { $0.names = ... }
    /// ```
