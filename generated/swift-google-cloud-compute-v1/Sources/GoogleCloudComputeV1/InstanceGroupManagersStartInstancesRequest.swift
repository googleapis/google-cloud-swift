...
// limitations under the License.
  ...
  public struct InstanceGroupManagersStartInstancesRequest: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = InstanceGroupManagersStartInstancesRequest().with { $0.instances = ... }
    /// ```
