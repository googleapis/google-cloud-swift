...
// limitations under the License.
  ...
  public struct InstanceGroupsListInstances: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: InstanceGroupsListInstances.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `InstanceGroupsListInstances`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstanceGroupsListInstances().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.warning = try container.decodeIfPresent(
        InstanceGroupsListInstances.Warning.self, forKey: .warning)
    ...
    ///
    /// [google.cloud.compute.v1.InstanceGroupsListInstances.warning]: <doc:InstanceGroupsListInstances/Warning>
      ...
      Sendable
    {
      ...
      public var code: InstanceGroupsListInstances.Warning.Code? = nil
      ...
      ///   }]
      public var data: [InstanceGroupsListInstances.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          InstanceGroupsListInstances.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [InstanceGroupsListInstances.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      ///
      /// [google.cloud.compute.v1.InstanceGroupsListInstances.warning.data]: <doc:InstanceGroupsListInstances/Warning/Data>
      ...
      ///
      /// [google.cloud.compute.v1.InstanceGroupsListInstances.warning.code]: <doc:InstanceGroupsListInstances/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.InstanceGroupsListInstances.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InstanceGroupsListInstances"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension InstanceGroupsListInstances: GoogleGax._PaginatedResponse {
