    ...
    final class RegionHealthCheckServicesTransport: RegionHealthCheckServicesStub {
      ...
      public func aggregatedList(
        ...
        return try await req.rpc(
          GoogleCloudComputeV1.HealthCheckServiceAggregatedList.self,
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            guard
              let pathVariable2 = try GoogleGax._RoutingMatcher.pathValue(
                request.healthCheckService as Swift.String?,
                matching: [.singleWildcard],
                fieldName: "healthCheckService")
            else {
              return nil
            }
            let path =
      ...
      public func `get`(
        ...
        req.addHeader(name: GoogleGax._HeaderNames.apiClient, value: Clients.clientHeader)
        return try await req.rpc(
          GoogleCloudComputeV1.HealthCheckService.self, timeout: options.attemptTimeout
        ).get()
      }
      ...
      public func list(
        ...
        req.addHeader(name: GoogleGax._HeaderNames.apiClient, value: Clients.clientHeader)
        return try await req.rpc(
          GoogleCloudComputeV1.HealthCheckServicesList.self, timeout: options.attemptTimeout
        ).get()
      }
