...
// limitations under the License.
  ...
  public struct RegionSnapshotUpdateKmsKeyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `RegionSnapshotUpdateKmsKeyRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RegionSnapshotUpdateKmsKeyRequest().with { $0.kmsKeyName = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.RegionSnapshotUpdateKmsKeyRequest"
    }
