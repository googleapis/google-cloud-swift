...
// limitations under the License.
  ...
  public struct InstanceGroupManagersListErrorsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `InstanceGroupManagersListErrorsResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstanceGroupManagersListErrorsResponse().with { $0.items = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InstanceGroupManagersListErrorsResponse"
    }
  ...
  extension InstanceGroupManagersListErrorsResponse: GoogleGax._PaginatedResponse {
