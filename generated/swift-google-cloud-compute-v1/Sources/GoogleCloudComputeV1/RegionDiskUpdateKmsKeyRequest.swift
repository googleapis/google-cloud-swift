...
// limitations under the License.
  ...
  public struct RegionDiskUpdateKmsKeyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `RegionDiskUpdateKmsKeyRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RegionDiskUpdateKmsKeyRequest().with { $0.kmsKeyName = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.RegionDiskUpdateKmsKeyRequest"
    }
