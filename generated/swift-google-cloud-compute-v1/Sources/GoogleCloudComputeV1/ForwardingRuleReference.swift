...
// limitations under the License.
  ...
  public struct ForwardingRuleReference: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ForwardingRuleReference`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ForwardingRuleReference().with { $0.forwardingRule = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ForwardingRuleReference"
    }
