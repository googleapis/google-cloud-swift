...
// limitations under the License.
  ...
  public struct OperationAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: OperationsScopedList] = [:]
    ...
    public var warning: OperationAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `OperationAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = OperationAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: OperationsScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        OperationAggregatedList.Warning.self, forKey: .warning)
    ...
    ///
    /// [google.cloud.compute.v1.OperationAggregatedList.warning]: <doc:OperationAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: OperationAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [OperationAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          OperationAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [OperationAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      ///
      /// [google.cloud.compute.v1.OperationAggregatedList.warning.data]: <doc:OperationAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.OperationAggregatedList.warning.data"
        }
      ...
      ///
      /// [google.cloud.compute.v1.OperationAggregatedList.warning.code]: <doc:OperationAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.OperationAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.OperationAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension OperationAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, OperationsScopedList)] {
