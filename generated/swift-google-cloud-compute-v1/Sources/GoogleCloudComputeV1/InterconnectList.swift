...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var warning: InterconnectList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `InterconnectList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InterconnectList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Interconnect].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(InterconnectList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.InterconnectList.warning] field.
    ///
    /// [google.cloud.compute.v1.InterconnectList.warning]: <doc:InterconnectList/Warning>
      ...
      Sendable
    {
      ...
      public var code: InterconnectList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [InterconnectList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(InterconnectList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [InterconnectList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.InterconnectList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.InterconnectList.warning.data]: <doc:InterconnectList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.InterconnectList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.InterconnectList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.InterconnectList.warning.code]: <doc:InterconnectList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.InterconnectList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InterconnectList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension InterconnectList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [Interconnect] {
      return self.items
    }
