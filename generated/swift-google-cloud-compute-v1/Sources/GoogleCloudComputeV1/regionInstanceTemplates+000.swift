...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// @Snippet(path: "regionInstanceTemplates_delete")
    public func delete(
      withPolling: RegionInstanceTemplatesClient.DeleteRequest, options: GoogleGax.RequestOptions
    ...
    /// @Snippet(path: "regionInstanceTemplates_insert")
    public func insert(
      withPolling: RegionInstanceTemplatesClient.InsertRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
