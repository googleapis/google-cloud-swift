...
// limitations under the License.
  ...
  public struct StoragePoolsScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: StoragePoolsScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `StoragePoolsScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = StoragePoolsScopedList().with { $0.storagePools = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.warning = try container.decodeIfPresent(
        StoragePoolsScopedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.StoragePoolsScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.StoragePoolsScopedList.warning]: <doc:StoragePoolsScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: StoragePoolsScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [StoragePoolsScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          StoragePoolsScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [StoragePoolsScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.StoragePoolsScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.StoragePoolsScopedList.warning.data]: <doc:StoragePoolsScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.StoragePoolsScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.StoragePoolsScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.StoragePoolsScopedList.warning.code]: <doc:StoragePoolsScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.StoragePoolsScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.StoragePoolsScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
