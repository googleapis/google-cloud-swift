...
// limitations under the License.
  ...
  public struct HttpsHealthCheckList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: HttpsHealthCheckList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `HttpsHealthCheckList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = HttpsHealthCheckList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([HttpsHealthCheck].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        HttpsHealthCheckList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.HttpsHealthCheckList.warning] field.
    ///
    /// [google.cloud.compute.v1.HttpsHealthCheckList.warning]: <doc:HttpsHealthCheckList/Warning>
      ...
      Sendable
    {
      ...
      public var code: HttpsHealthCheckList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [HttpsHealthCheckList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          HttpsHealthCheckList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [HttpsHealthCheckList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.HttpsHealthCheckList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.HttpsHealthCheckList.warning.data]: <doc:HttpsHealthCheckList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.HttpsHealthCheckList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.HttpsHealthCheckList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.HttpsHealthCheckList.warning.code]: <doc:HttpsHealthCheckList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.HttpsHealthCheckList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.HttpsHealthCheckList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension HttpsHealthCheckList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [HttpsHealthCheck] {
      return self.items
    }
