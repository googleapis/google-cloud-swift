...
// limitations under the License.
  ...
  public struct ResourcePolicyList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [ResourcePolicy] = []
    ...
    public var warning: ResourcePolicyList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ResourcePolicyList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ResourcePolicyList().with { $0.etag = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([ResourcePolicy].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        ResourcePolicyList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.ResourcePolicyList.warning] field.
    ///
    /// [google.cloud.compute.v1.ResourcePolicyList.warning]: <doc:ResourcePolicyList/Warning>
      ...
      Sendable
    {
      ...
      public var code: ResourcePolicyList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [ResourcePolicyList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          ResourcePolicyList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [ResourcePolicyList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.ResourcePolicyList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.ResourcePolicyList.warning.data]: <doc:ResourcePolicyList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.ResourcePolicyList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.ResourcePolicyList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.ResourcePolicyList.warning.code]: <doc:ResourcePolicyList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.ResourcePolicyList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ResourcePolicyList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension ResourcePolicyList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [ResourcePolicy] {
      return self.items
    }
