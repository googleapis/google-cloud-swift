...
// limitations under the License.
  ...
  public struct PreviewFeatureRolloutOperationRolloutInput: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    public enum PredefinedRolloutPlan: Codable, Equatable, Hashable, Sendable {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .rolloutPlanFastRollout: return try container.encode("ROLLOUT_PLAN_FAST_ROLLOUT")
        case .rolloutPlanTwoDayRollout: return try container.encode("ROLLOUT_PLAN_TWO_DAY_ROLLOUT")
        case .rolloutPlanUnspecified: return try container.encode("ROLLOUT_PLAN_UNSPECIFIED")
