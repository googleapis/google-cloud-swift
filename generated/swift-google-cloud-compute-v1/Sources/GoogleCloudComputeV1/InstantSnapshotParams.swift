...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `InstantSnapshotParams`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstantSnapshotParams().with { $0.resourceManagerTags = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InstantSnapshotParams"
    }
