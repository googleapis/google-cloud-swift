...
// limitations under the License.
  ...
  public struct UrlMapsAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: UrlMapsScopedList] = [:]
    ...
    public var warning: UrlMapsAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `UrlMapsAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = UrlMapsAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: UrlMapsScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        UrlMapsAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.UrlMapsAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.UrlMapsAggregatedList.warning]: <doc:UrlMapsAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: UrlMapsAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [UrlMapsAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          UrlMapsAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [UrlMapsAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.UrlMapsAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.UrlMapsAggregatedList.warning.data]: <doc:UrlMapsAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.UrlMapsAggregatedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.UrlMapsAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.UrlMapsAggregatedList.warning.code]: <doc:UrlMapsAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.UrlMapsAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.UrlMapsAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension UrlMapsAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, UrlMapsScopedList)] {
