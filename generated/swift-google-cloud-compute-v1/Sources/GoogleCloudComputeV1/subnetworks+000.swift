...
// limitations under the License.
  ...
  extension Clients {
    ...
    public protocol SubnetworksProtocol: Sendable {
  ...
  @available(
    *, unavailable, message: "Enable the 'Subnetworks' trait in Package.swift to use this client."
  )
  public final class SubnetworksClient: Sendable {
    @available(
      *, unavailable, message: "Enable the 'Subnetworks' trait in Package.swift to use this client."
    )
    public init(_ options: GoogleGax.ClientOptions = .init()) throws {}
