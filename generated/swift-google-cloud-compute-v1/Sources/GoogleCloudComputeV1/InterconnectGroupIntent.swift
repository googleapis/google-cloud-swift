...
// limitations under the License.
  ...
  public struct InterconnectGroupIntent: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    public var topologyCapability: InterconnectGroupIntent.TopologyCapability? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `InterconnectGroupIntent`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InterconnectGroupIntent().with { $0.topologyCapability = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let topologyCapability = CodingKeys(stringValue: "topologyCapability")
    ...
    /// The enumerated type for the [topologyCapability][google.cloud.compute.v1.InterconnectGroupIntent.topologyCapability] field.
    ///
    /// [google.cloud.compute.v1.InterconnectGroupIntent.topologyCapability]: <doc:InterconnectGroupIntent/TopologyCapability>
    ///
    ...
    public enum TopologyCapability: Codable, Equatable, Sendable {
      ...
      ///
      /// If the value is unknown, this initializes to [`unknownStringValue`](doc:TopologyCapability/unknownStringValue(_:)).
