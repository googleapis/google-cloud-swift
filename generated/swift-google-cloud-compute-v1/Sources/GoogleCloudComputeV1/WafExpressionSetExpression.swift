...
// limitations under the License.
  ...
  public struct WafExpressionSetExpression: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let sensitivity = CodingKeys(stringValue: "sensitivity")
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.sensitivity = try container.decodeIfPresent(Swift.Int32.self, forKey: .sensitivity)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encodeIfPresent(self.sensitivity, forKey: .sensitivity)
