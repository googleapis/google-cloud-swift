...
// limitations under the License.
  ...
  public struct AddressList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: AddressList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `AddressList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = AddressList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Address].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(AddressList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.AddressList.warning] field.
    ///
    /// [google.cloud.compute.v1.AddressList.warning]: <doc:AddressList/Warning>
      ...
      Sendable
    {
      ...
      public var code: AddressList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [AddressList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(AddressList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent([AddressList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.AddressList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.AddressList.warning.data]: <doc:AddressList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.AddressList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.AddressList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.AddressList.warning.code]: <doc:AddressList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.AddressList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.AddressList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension AddressList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [Address] {
      return self.items
    }
