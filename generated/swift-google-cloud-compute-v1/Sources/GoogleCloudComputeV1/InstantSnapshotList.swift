...
// limitations under the License.
  ...
  public struct InstantSnapshotList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [InstantSnapshot] = []
    ...
    public var warning: InstantSnapshotList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `InstantSnapshotList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstantSnapshotList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([InstantSnapshot].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        InstantSnapshotList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.InstantSnapshotList.warning] field.
    ///
    /// [google.cloud.compute.v1.InstantSnapshotList.warning]: <doc:InstantSnapshotList/Warning>
      ...
      Sendable
    {
      ...
      public var code: InstantSnapshotList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [InstantSnapshotList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          InstantSnapshotList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [InstantSnapshotList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.InstantSnapshotList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.InstantSnapshotList.warning.data]: <doc:InstantSnapshotList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.InstantSnapshotList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.InstantSnapshotList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.InstantSnapshotList.warning.code]: <doc:InstantSnapshotList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.InstantSnapshotList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InstantSnapshotList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension InstantSnapshotList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [InstantSnapshot] {
      return self.items
    }
