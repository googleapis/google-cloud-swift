...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var warning: StoragePoolList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `StoragePoolList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = StoragePoolList().with { $0.etag = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([StoragePool].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(StoragePoolList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.StoragePoolList.warning] field.
    ///
    /// [google.cloud.compute.v1.StoragePoolList.warning]: <doc:StoragePoolList/Warning>
      ...
      Sendable
    {
      ...
      public var code: StoragePoolList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [StoragePoolList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(StoragePoolList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [StoragePoolList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.StoragePoolList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.StoragePoolList.warning.data]: <doc:StoragePoolList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.StoragePoolList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.StoragePoolList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.StoragePoolList.warning.code]: <doc:StoragePoolList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.StoragePoolList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.StoragePoolList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
