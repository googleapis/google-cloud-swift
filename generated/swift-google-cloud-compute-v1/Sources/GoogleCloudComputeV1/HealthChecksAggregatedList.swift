...
// limitations under the License.
  ...
  public struct HealthChecksAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: HealthChecksScopedList] = [:]
    ...
    public var warning: HealthChecksAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `HealthChecksAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = HealthChecksAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: HealthChecksScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        HealthChecksAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.HealthChecksAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.HealthChecksAggregatedList.warning]: <doc:HealthChecksAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: HealthChecksAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [HealthChecksAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          HealthChecksAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [HealthChecksAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.HealthChecksAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.HealthChecksAggregatedList.warning.data]: <doc:HealthChecksAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.HealthChecksAggregatedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.HealthChecksAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.HealthChecksAggregatedList.warning.code]: <doc:HealthChecksAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.HealthChecksAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.HealthChecksAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension HealthChecksAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, HealthChecksScopedList)] {
