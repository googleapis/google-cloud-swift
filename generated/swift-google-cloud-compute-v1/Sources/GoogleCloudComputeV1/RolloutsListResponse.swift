...
// limitations under the License.
  ...
  public struct RolloutsListResponse: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: RolloutsListResponse.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `RolloutsListResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RolloutsListResponse().with { $0.etag = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Rollout].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        RolloutsListResponse.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.RolloutsListResponse.warning] field.
    ///
    /// [google.cloud.compute.v1.RolloutsListResponse.warning]: <doc:RolloutsListResponse/Warning>
      ...
      Sendable
    {
      ...
      public var code: RolloutsListResponse.Warning.Code? = nil
      ...
      ///   }]
      public var data: [RolloutsListResponse.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          RolloutsListResponse.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [RolloutsListResponse.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.RolloutsListResponse.warning.data] field.
      ///
      /// [google.cloud.compute.v1.RolloutsListResponse.warning.data]: <doc:RolloutsListResponse/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.RolloutsListResponse.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.RolloutsListResponse.warning.code] field.
      ///
      /// [google.cloud.compute.v1.RolloutsListResponse.warning.code]: <doc:RolloutsListResponse/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.RolloutsListResponse.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.RolloutsListResponse"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension RolloutsListResponse: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [Rollout] {
      return self.items
    }
