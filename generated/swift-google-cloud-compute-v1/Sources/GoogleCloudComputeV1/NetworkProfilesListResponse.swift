...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var items: [NetworkProfile] = []
    ...
    public var warning: NetworkProfilesListResponse.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `NetworkProfilesListResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = NetworkProfilesListResponse().with { $0.etag = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([NetworkProfile].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        NetworkProfilesListResponse.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.NetworkProfilesListResponse.warning] field.
    ///
    /// [google.cloud.compute.v1.NetworkProfilesListResponse.warning]: <doc:NetworkProfilesListResponse/Warning>
      ...
      Sendable
    {
      ...
      public var code: NetworkProfilesListResponse.Warning.Code? = nil
      ...
      ///   }]
      public var data: [NetworkProfilesListResponse.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          NetworkProfilesListResponse.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [NetworkProfilesListResponse.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.NetworkProfilesListResponse.warning.data] field.
      ///
      /// [google.cloud.compute.v1.NetworkProfilesListResponse.warning.data]: <doc:NetworkProfilesListResponse/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.NetworkProfilesListResponse.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.NetworkProfilesListResponse.warning.code] field.
      ///
      /// [google.cloud.compute.v1.NetworkProfilesListResponse.warning.code]: <doc:NetworkProfilesListResponse/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.NetworkProfilesListResponse.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.NetworkProfilesListResponse"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
