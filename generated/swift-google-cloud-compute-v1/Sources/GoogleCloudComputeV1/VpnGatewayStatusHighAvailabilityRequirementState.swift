...
// limitations under the License.
  ...
  public struct VpnGatewayStatusHighAvailabilityRequirementState: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    /// Indicates the high availability requirement state for the VPN connection.
    /// Valid values are CONNECTION_REDUNDANCY_MET,CONNECTION_REDUNDANCY_NOT_MET.
    public var state: VpnGatewayStatusHighAvailabilityRequirementState.State? = nil
    ...
    ///
    /// ```
    /// let value = VpnGatewayStatusHighAvailabilityRequirementState().with { $0.state = ... }
    /// ```
