...
// limitations under the License.
  ...
  public struct InstanceGroupManagersListPerInstanceConfigsResp: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    public var warning: InstanceGroupManagersListPerInstanceConfigsResp.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `InstanceGroupManagersListPerInstanceConfigsResp`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstanceGroupManagersListPerInstanceConfigsResp().with { $0.items = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.warning = try container.decodeIfPresent(
        InstanceGroupManagersListPerInstanceConfigsResp.Warning.self, forKey: .warning)
      ...
      Sendable
    {
      ...
      public var code: InstanceGroupManagersListPerInstanceConfigsResp.Warning.Code? = nil
      ...
      ///   }]
      public var data: [InstanceGroupManagersListPerInstanceConfigsResp.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          InstanceGroupManagersListPerInstanceConfigsResp.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [InstanceGroupManagersListPerInstanceConfigsResp.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      ///
      /// [google.cloud.compute.v1.InstanceGroupManagersListPerInstanceConfigsResp.warning.code]: <doc:InstanceGroupManagersListPerInstanceConfigsResp/Warning/Code>
      ///
  ...
  extension InstanceGroupManagersListPerInstanceConfigsResp: GoogleGax._PaginatedResponse {
