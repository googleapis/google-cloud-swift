...
// limitations under the License.
  ...
  public struct RouterParams: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `RouterParams`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RouterParams().with { $0.resourceManagerTags = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.RouterParams"
    }
