...
// limitations under the License.
  ...
  extension Clients {
    ...
    public protocol RolloutPlansProtocol: Sendable {
  ...
  extension Clients.RolloutPlansProtocol {
    ...
    public func deletePollingUntilDone(
      request: RolloutPlansClient.DeleteRequest
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
    ...
    public func insertPollingUntilDone(
      request: RolloutPlansClient.InsertRequest
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
  ...
  @available(
    *, unavailable, message: "Enable the 'RolloutPlans' trait in Package.swift to use this client."
  )
  public final class RolloutPlansClient: Sendable {
    @available(
      *, unavailable,
      message: "Enable the 'RolloutPlans' trait in Package.swift to use this client."
    )
    public init(_ options: GoogleGax.ClientOptions = .init()) throws {}
  }
#endif
