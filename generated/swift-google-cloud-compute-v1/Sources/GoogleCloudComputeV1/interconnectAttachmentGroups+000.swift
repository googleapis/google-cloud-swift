...
// limitations under the License.
  ...
  extension Clients {
    ...
    public protocol InterconnectAttachmentGroupsProtocol: Sendable {
  ...
  extension Clients.InterconnectAttachmentGroupsProtocol {
    ...
    /// @Snippet(path: "interconnectAttachmentGroups_list")
    public func list(
      byItem: InterconnectAttachmentGroupsClient.ListRequest, options: GoogleGax.RequestOptions
    ) -> any AsyncSequence<InterconnectAttachmentGroup, Swift.Error> {
      let listRpc = {
  ...
  @available(
    *, unavailable,
    message: "Enable the 'InterconnectAttachmentGroups' trait in Package.swift to use this client."
  )
  public final class InterconnectAttachmentGroupsClient: Sendable {
    @available(
      *, unavailable,
      message:
        "Enable the 'InterconnectAttachmentGroups' trait in Package.swift to use this client."
    )
    public init(_ options: GoogleGax.ClientOptions = .init()) throws {}
  }
#endif
