...
// limitations under the License.
  ...
  public struct SnapshotParams: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `SnapshotParams`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SnapshotParams().with { $0.resourceManagerTags = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.SnapshotParams"
    }
