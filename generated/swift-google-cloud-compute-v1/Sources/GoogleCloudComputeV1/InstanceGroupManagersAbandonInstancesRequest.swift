...
// limitations under the License.
  ...
  public struct InstanceGroupManagersAbandonInstancesRequest: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `InstanceGroupManagersAbandonInstancesRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstanceGroupManagersAbandonInstancesRequest().with { $0.instances = ... }
    /// ```
