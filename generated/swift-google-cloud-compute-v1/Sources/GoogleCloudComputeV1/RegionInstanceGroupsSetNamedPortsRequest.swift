...
// limitations under the License.
  ...
  public struct RegionInstanceGroupsSetNamedPortsRequest: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = RegionInstanceGroupsSetNamedPortsRequest().with { $0.fingerprint = ... }
    /// ```
