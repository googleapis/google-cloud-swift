...
// limitations under the License.
  ...
  public struct SnapshotList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: SnapshotList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `SnapshotList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SnapshotList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Snapshot].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(SnapshotList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.SnapshotList.warning] field.
    ///
    /// [google.cloud.compute.v1.SnapshotList.warning]: <doc:SnapshotList/Warning>
      ...
      Sendable
    {
      ...
      public var code: SnapshotList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [SnapshotList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(SnapshotList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [SnapshotList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.SnapshotList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.SnapshotList.warning.data]: <doc:SnapshotList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.SnapshotList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.SnapshotList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.SnapshotList.warning.code]: <doc:SnapshotList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.SnapshotList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.SnapshotList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension SnapshotList: GoogleGax._PaginatedResponse {
