...
// limitations under the License.
  ...
  public struct NetworkAttachmentList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [NetworkAttachment] = []
    ...
    public var warning: NetworkAttachmentList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `NetworkAttachmentList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = NetworkAttachmentList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([NetworkAttachment].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        NetworkAttachmentList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.NetworkAttachmentList.warning] field.
    ///
    /// [google.cloud.compute.v1.NetworkAttachmentList.warning]: <doc:NetworkAttachmentList/Warning>
      ...
      Sendable
    {
      ...
      public var code: NetworkAttachmentList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [NetworkAttachmentList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          NetworkAttachmentList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [NetworkAttachmentList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.NetworkAttachmentList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.NetworkAttachmentList.warning.data]: <doc:NetworkAttachmentList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.NetworkAttachmentList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.NetworkAttachmentList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.NetworkAttachmentList.warning.code]: <doc:NetworkAttachmentList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.NetworkAttachmentList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.NetworkAttachmentList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension NetworkAttachmentList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [NetworkAttachment] {
      return self.items
    }
