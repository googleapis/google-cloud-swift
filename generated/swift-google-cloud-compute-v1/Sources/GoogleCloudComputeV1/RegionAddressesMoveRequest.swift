...
// limitations under the License.
  ...
  public struct RegionAddressesMoveRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = RegionAddressesMoveRequest().with { $0.description = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.destinationAddress = try container.decodeIfPresent(
        Swift.String.self, forKey: .destinationAddress)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.RegionAddressesMoveRequest"
    }
