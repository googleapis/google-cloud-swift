...
// limitations under the License.
  ...
  public struct LicensesListResponse: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: LicensesListResponse.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `LicensesListResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = LicensesListResponse().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([License].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        LicensesListResponse.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.LicensesListResponse.warning] field.
    ///
    /// [google.cloud.compute.v1.LicensesListResponse.warning]: <doc:LicensesListResponse/Warning>
      ...
      Sendable
    {
      ...
      public var code: LicensesListResponse.Warning.Code? = nil
      ...
      ///   }]
      public var data: [LicensesListResponse.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          LicensesListResponse.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [LicensesListResponse.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.LicensesListResponse.warning.data] field.
      ///
      /// [google.cloud.compute.v1.LicensesListResponse.warning.data]: <doc:LicensesListResponse/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.LicensesListResponse.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.LicensesListResponse.warning.code] field.
      ///
      /// [google.cloud.compute.v1.LicensesListResponse.warning.code]: <doc:LicensesListResponse/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.LicensesListResponse.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.LicensesListResponse"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension LicensesListResponse: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [License] {
      return self.items
    }
