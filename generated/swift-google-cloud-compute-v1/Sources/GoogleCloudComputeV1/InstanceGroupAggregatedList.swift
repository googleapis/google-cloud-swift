...
// limitations under the License.
  ...
  public struct InstanceGroupAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: InstanceGroupsScopedList] = [:]
    ...
    public var warning: InstanceGroupAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `InstanceGroupAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstanceGroupAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: InstanceGroupsScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        InstanceGroupAggregatedList.Warning.self, forKey: .warning)
    ...
    ///
    /// [google.cloud.compute.v1.InstanceGroupAggregatedList.warning]: <doc:InstanceGroupAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: InstanceGroupAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [InstanceGroupAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          InstanceGroupAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [InstanceGroupAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      ///
      /// [google.cloud.compute.v1.InstanceGroupAggregatedList.warning.data]: <doc:InstanceGroupAggregatedList/Warning/Data>
      ...
      ///
      /// [google.cloud.compute.v1.InstanceGroupAggregatedList.warning.code]: <doc:InstanceGroupAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.InstanceGroupAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InstanceGroupAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension InstanceGroupAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, InstanceGroupsScopedList)] {
