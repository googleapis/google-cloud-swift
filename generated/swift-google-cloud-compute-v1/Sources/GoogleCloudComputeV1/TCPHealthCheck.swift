...
// limitations under the License.
  ...
  public struct TCPHealthCheck: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var portSpecification: TCPHealthCheck.PortSpecification? = nil

    /// Specifies the type of proxy header to append before sending data to the
    /// backend, either NONE or PROXY_V1. The default
    /// is NONE.
    public var proxyHeader: TCPHealthCheck.ProxyHeader? = nil
    ...
    public var request: Swift.String? = nil
    ...
    /// Initialize a new instance of `TCPHealthCheck`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = TCPHealthCheck().with { $0.port = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.portSpecification = try container.decodeIfPresent(
        TCPHealthCheck.PortSpecification.self, forKey: .portSpecification)
      self.proxyHeader = try container.decodeIfPresent(
        TCPHealthCheck.ProxyHeader.self, forKey: .proxyHeader)
      self.request = try container.decodeIfPresent(Swift.String.self, forKey: .request)
    ...
    /// The enumerated type for the [portSpecification][google.cloud.compute.v1.TCPHealthCheck.portSpecification] field.
    ///
    /// [google.cloud.compute.v1.TCPHealthCheck.portSpecification]: <doc:TCPHealthCheck/PortSpecification>
    ///
    ...
    /// The enumerated type for the [proxyHeader][google.cloud.compute.v1.TCPHealthCheck.proxyHeader] field.
    ///
    /// [google.cloud.compute.v1.TCPHealthCheck.proxyHeader]: <doc:TCPHealthCheck/ProxyHeader>
    ///
    /// - Note: Adding cases to this enumeration is not considered a breaking change.
    ///   Always include an `@unknown default:` case when switching over this type.
    ///   Do not pattern-match against `unknownStringValue`
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.TCPHealthCheck"
    }
