...
// limitations under the License.
  ...
  public struct SecurityPolicyRuleMatcherConfig: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = SecurityPolicyRuleMatcherConfig().with { $0.srcIpRanges = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.SecurityPolicyRuleMatcherConfig"
    }
