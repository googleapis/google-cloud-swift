...
// limitations under the License.
  ...
  public struct BackendBucketListUsable: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: BackendBucketListUsable.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `BackendBucketListUsable`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = BackendBucketListUsable().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([BackendBucket].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        BackendBucketListUsable.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.BackendBucketListUsable.warning] field.
    ///
    /// [google.cloud.compute.v1.BackendBucketListUsable.warning]: <doc:BackendBucketListUsable/Warning>
      ...
      Sendable
    {
      ...
      public var code: BackendBucketListUsable.Warning.Code? = nil
      ...
      ///   }]
      public var data: [BackendBucketListUsable.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          BackendBucketListUsable.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [BackendBucketListUsable.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.BackendBucketListUsable.warning.data] field.
      ///
      /// [google.cloud.compute.v1.BackendBucketListUsable.warning.data]: <doc:BackendBucketListUsable/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.BackendBucketListUsable.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.BackendBucketListUsable.warning.code] field.
      ///
      /// [google.cloud.compute.v1.BackendBucketListUsable.warning.code]: <doc:BackendBucketListUsable/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.BackendBucketListUsable.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.BackendBucketListUsable"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension BackendBucketListUsable: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [BackendBucket] {
      return self.items
    }
