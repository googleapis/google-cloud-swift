...
// limitations under the License.
  ...
  public struct AcceleratorTypeList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: AcceleratorTypeList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `AcceleratorTypeList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = AcceleratorTypeList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([AcceleratorType].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        AcceleratorTypeList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.AcceleratorTypeList.warning] field.
    ///
    /// [google.cloud.compute.v1.AcceleratorTypeList.warning]: <doc:AcceleratorTypeList/Warning>
      ...
      Sendable
    {
      ...
      public var code: AcceleratorTypeList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [AcceleratorTypeList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          AcceleratorTypeList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [AcceleratorTypeList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.AcceleratorTypeList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.AcceleratorTypeList.warning.data]: <doc:AcceleratorTypeList/Warning/Data>
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.AcceleratorTypeList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.AcceleratorTypeList.warning.code]: <doc:AcceleratorTypeList/Warning/Code>
      ///
  ...
  extension AcceleratorTypeList: GoogleGax._PaginatedResponse {
