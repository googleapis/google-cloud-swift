...
// limitations under the License.
  ...
  public final class TargetGrpcProxiesClient: Clients.TargetGrpcProxiesProtocol, Sendable {
    ...
    /// @Snippet(path: "targetGrpcProxies_delete")
    public func delete(
      withPolling: TargetGrpcProxiesClient.DeleteRequest, options: GoogleGax.RequestOptions
    ...
    /// @Snippet(path: "targetGrpcProxies_insert")
    public func insert(
      withPolling: TargetGrpcProxiesClient.InsertRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
    ...
    /// @Snippet(path: "targetGrpcProxies_patch")
    public func patch(
      withPolling: TargetGrpcProxiesClient.PatchRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
