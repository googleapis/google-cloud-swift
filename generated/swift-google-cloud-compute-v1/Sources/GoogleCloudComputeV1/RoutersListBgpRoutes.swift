...
// limitations under the License.
  ...
  public struct RoutersListBgpRoutes: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: RoutersListBgpRoutes.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `RoutersListBgpRoutes`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RoutersListBgpRoutes().with { $0.etag = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([BgpRoute].self, forKey: .result) {
        self.result = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        RoutersListBgpRoutes.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.RoutersListBgpRoutes.warning] field.
    ///
    /// [google.cloud.compute.v1.RoutersListBgpRoutes.warning]: <doc:RoutersListBgpRoutes/Warning>
      ...
      Sendable
    {
      ...
      public var code: RoutersListBgpRoutes.Warning.Code? = nil
      ...
      ///   }]
      public var data: [RoutersListBgpRoutes.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          RoutersListBgpRoutes.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [RoutersListBgpRoutes.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.RoutersListBgpRoutes.warning.data] field.
      ///
      /// [google.cloud.compute.v1.RoutersListBgpRoutes.warning.data]: <doc:RoutersListBgpRoutes/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.RoutersListBgpRoutes.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.RoutersListBgpRoutes.warning.code] field.
      ///
      /// [google.cloud.compute.v1.RoutersListBgpRoutes.warning.code]: <doc:RoutersListBgpRoutes/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.RoutersListBgpRoutes.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.RoutersListBgpRoutes"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension RoutersListBgpRoutes: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [BgpRoute] {
      return self.result
    }
