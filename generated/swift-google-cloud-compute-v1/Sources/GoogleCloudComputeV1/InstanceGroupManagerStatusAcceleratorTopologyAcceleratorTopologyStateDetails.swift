...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var error:
      InstanceGroupManagerStatusAcceleratorTopologyAcceleratorTopologyStateDetails.Error? = nil
    ...
    ///
    /// ```
    /// let value = InstanceGroupManagerStatusAcceleratorTopologyAcceleratorTopologyStateDetails().with { $0.error = ... }
    /// ```
