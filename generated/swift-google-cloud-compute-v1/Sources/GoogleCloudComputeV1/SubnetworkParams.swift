...
// limitations under the License.
  ...
  public struct SubnetworkParams: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `SubnetworkParams`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SubnetworkParams().with { $0.resourceManagerTags = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.SubnetworkParams"
    }
