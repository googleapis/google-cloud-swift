...
// limitations under the License.
  ...
  extension Clients {
    final class ReservationSubBlocksTransport: ReservationSubBlocksStub {
      ...
      public func `get`(
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            guard
              let pathVariable3 = try GoogleGax._RoutingMatcher.pathValue(
                request.reservationSubBlock as Swift.String?,
                matching: [.singleWildcard],
                fieldName: "reservationSubBlock")
            else {
              return nil
            }
            let path =
        ...
        return try await req.rpc(
          GoogleCloudComputeV1.ReservationSubBlocksGetResponse.self, timeout: options.attemptTimeout
        ).get()
      }
      ...
      public func list(
        ...
        req.addHeader(name: GoogleGax._HeaderNames.apiClient, value: Clients.clientHeader)
        return try await req.rpc(
          GoogleCloudComputeV1.ReservationSubBlocksListResponse.self,
