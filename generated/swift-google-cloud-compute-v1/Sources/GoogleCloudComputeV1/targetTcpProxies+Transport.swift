...
// limitations under the License.
  ...
  extension Clients {
    final class TargetTcpProxiesTransport: TargetTcpProxiesStub {
      ...
      public func aggregatedList(
        ...
        return try await req.rpc(
          GoogleCloudComputeV1.TargetTcpProxyAggregatedList.self, timeout: options.attemptTimeout
        ).get()
      }
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            guard
              let pathVariable1 = try GoogleGax._RoutingMatcher.pathValue(
                request.targetTcpProxy as Swift.String?,
                matching: [.singleWildcard],
                fieldName: "targetTcpProxy")
            else {
              return nil
            }
            let path =
