...
// limitations under the License.
  ...
  public struct UrlMapValidationResult: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = UrlMapValidationResult().with { $0.loadErrors = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.UrlMapValidationResult"
    }
