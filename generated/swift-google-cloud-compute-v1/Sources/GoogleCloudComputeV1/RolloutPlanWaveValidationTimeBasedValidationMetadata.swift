...
// limitations under the License.
  ...
  public struct RolloutPlanWaveValidationTimeBasedValidationMetadata: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = RolloutPlanWaveValidationTimeBasedValidationMetadata().with { $0.waitDuration = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return
        "type.googleapis.com/google.cloud.compute.v1.RolloutPlanWaveValidationTimeBasedValidationMetadata"
    }
