...
// limitations under the License.
  ...
  public struct InstancesBulkInsertOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// Status information per location (location name is key).
    /// Example key: zones/us-central1-a
    public var perLocationStatus: [Swift.String: BulkInsertOperationStatus] = [:]

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `InstancesBulkInsertOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstancesBulkInsertOperationMetadata().with { $0.perLocationStatus = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let perLocationStatus = CodingKeys(stringValue: "perLocationStatus")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: BulkInsertOperationStatus].self, forKey: .perLocationStatus)
      {
        self.perLocationStatus = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.perLocationStatus, forKey: .perLocationStatus)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InstancesBulkInsertOperationMetadata"
    }
