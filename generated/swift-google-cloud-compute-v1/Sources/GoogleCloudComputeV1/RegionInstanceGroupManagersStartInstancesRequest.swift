...
// limitations under the License.
  ...
  public struct RegionInstanceGroupManagersStartInstancesRequest: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `RegionInstanceGroupManagersStartInstancesRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RegionInstanceGroupManagersStartInstancesRequest().with { $0.instances = ... }
    /// ```
