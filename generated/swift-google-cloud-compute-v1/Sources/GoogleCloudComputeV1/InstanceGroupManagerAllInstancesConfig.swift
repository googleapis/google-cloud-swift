...
// limitations under the License.
  ...
  public struct InstanceGroupManagerAllInstancesConfig: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var properties: InstancePropertiesPatch? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `InstanceGroupManagerAllInstancesConfig`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstanceGroupManagerAllInstancesConfig().with { $0.properties = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.properties = try container.decodeIfPresent(
        InstancePropertiesPatch.self, forKey: .properties)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InstanceGroupManagerAllInstancesConfig"
    }
