...
// limitations under the License.
  ...
  public struct InstanceManagedByIgmErrorManagedInstanceError: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `InstanceManagedByIgmErrorManagedInstanceError`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstanceManagedByIgmErrorManagedInstanceError().with { $0.code = ... }
    /// ```
