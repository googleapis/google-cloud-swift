...
// limitations under the License.
  ...
  public struct MachineTypesScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// list is empty.
    public var warning: MachineTypesScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `MachineTypesScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = MachineTypesScopedList().with { $0.machineTypes = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([MachineType].self, forKey: .machineTypes) {
        self.machineTypes = value
      }
      self.warning = try container.decodeIfPresent(
        MachineTypesScopedList.Warning.self, forKey: .warning)
    ...
    ///
    /// [google.cloud.compute.v1.MachineTypesScopedList.warning]: <doc:MachineTypesScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: MachineTypesScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [MachineTypesScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          MachineTypesScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [MachineTypesScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      ///
      /// [google.cloud.compute.v1.MachineTypesScopedList.warning.data]: <doc:MachineTypesScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.MachineTypesScopedList.warning.data"
        }
      ...
      ///
      /// [google.cloud.compute.v1.MachineTypesScopedList.warning.code]: <doc:MachineTypesScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.MachineTypesScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.MachineTypesScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
