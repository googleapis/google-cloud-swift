...
// limitations under the License.
  ...
  extension NetworkProfilesClient {
    ...
    ///
    /// [google.cloud.compute.v1.networkProfiles.get]: <doc:NetworkProfilesClient/`get`(request:options:)>
    public struct GetRequest: Codable, Equatable, GoogleWKT._AnyPackable,
      Sendable
    {
      /// Name of the network profile to return.
      public var networkProfile: Swift.String = Swift.String()
      ...
      ///
      /// ```
      /// let value = GetRequest().with { $0.networkProfile = ... }
      /// ```
      ...
      public init(from decoder: Decoder) throws {
        ...
        if let value = try container.decodeIfPresent(Swift.String.self, forKey: .networkProfile) {
          self.networkProfile = value
        }
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.networkProfiles.getRequest"
      }
    ...
    ///
    /// [google.cloud.compute.v1.networkProfiles.list]: <doc:NetworkProfilesClient/list(request:options:)>
      ...
      Sendable
    {
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.networkProfiles.listRequest"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
