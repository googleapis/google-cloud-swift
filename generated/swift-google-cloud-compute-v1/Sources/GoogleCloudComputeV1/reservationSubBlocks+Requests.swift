...
// limitations under the License.
  ...
  extension ReservationSubBlocksClient {
      ...
      Sendable
    {
      ...
      public var reservationSubBlock: Swift.String = Swift.String()

      /// View of the subBlock.
      public var view: ReservationSubBlocksClient.GetRequest.View? = nil
      ...
      ///
      /// ```
      /// let value = GetRequest().with { $0.parentName = ... }
      /// ```
      ...
      private struct CodingKeys: CodingKey {
        ...
        static let reservationSubBlock = CodingKeys(stringValue: "reservationSubBlock")
      ...
      public init(from decoder: Decoder) throws {
        ...
        if let value = try container.decodeIfPresent(
          Swift.String.self, forKey: .reservationSubBlock)
        {
          self.reservationSubBlock = value
        }
        self.view = try container.decodeIfPresent(
          ReservationSubBlocksClient.GetRequest.View.self, forKey: .view)
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(self.reservationSubBlock, forKey: .reservationSubBlock)
      ...
      /// The enumerated type for the [view][google.cloud.compute.v1.reservationSubBlocks.getRequest.view] field.
      ///
      /// [google.cloud.compute.v1.reservationSubBlocks.getRequest.view]: <doc:ReservationSubBlocksClient/GetRequest/View>
      ///
      ...
      public enum View: Codable, Equatable, Hashable, Sendable {
        ...
        public init(stringValue: Swift.String) {
          switch stringValue {
          case "SUB_BLOCK_VIEW_BASIC": self = .subBlockViewBasic
          case "SUB_BLOCK_VIEW_FULL": self = .subBlockViewFull
          case "SUB_BLOCK_VIEW_UNSPECIFIED": self = .subBlockViewUnspecified
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.reservationSubBlocks.getRequest"
      }
      ...
      Sendable
    {
      ...
      public static var _anyTypeUrl: Swift.String {
        return
          "type.googleapis.com/google.cloud.compute.v1.reservationSubBlocks.getIamPolicyRequest"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = GetVersionRequest().with { $0.parentName = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.body = try container.decodeIfPresent(
          ReservationSubBlocksGetVersionRequest.self, forKey: .body)
        for key in container.allKeys where !CodingKeys._knownKeys.contains(key.stringValue) {
          self._unknownFields.json[key.stringValue] = try container.decode(
            GoogleWKT.WKTValue.self, forKey: key)
        }
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.reservationSubBlocks.getVersionRequest"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
      ...
      Sendable
    {
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.reservationSubBlocks.listRequest"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = PerformMaintenanceRequest().with { $0.parentName = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      public static var _anyTypeUrl: Swift.String {
        return
          "type.googleapis.com/google.cloud.compute.v1.reservationSubBlocks.performMaintenanceRequest"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public struct ReportFaultyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
      Sendable
    {
      /// The name of the parent reservation and parent block. In the format of
      /// reservations/{reservation_name}/reservationBlocks/{reservation_block_name}
      ...
      ///
      /// ```
      /// let value = ReportFaultyRequest().with { $0.parentName = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.body = try container.decodeIfPresent(
          ReservationSubBlocksReportFaultyRequest.self, forKey: .body)
        for key in container.allKeys where !CodingKeys._knownKeys.contains(key.stringValue) {
          self._unknownFields.json[key.stringValue] = try container.decode(
            GoogleWKT.WKTValue.self, forKey: key)
        }
      ...
      public static var _anyTypeUrl: Swift.String {
        return
          "type.googleapis.com/google.cloud.compute.v1.reservationSubBlocks.reportFaultyRequest"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
      ...
      Sendable
    {
      ...
      public static var _anyTypeUrl: Swift.String {
        return
          "type.googleapis.com/google.cloud.compute.v1.reservationSubBlocks.setIamPolicyRequest"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
      ...
      Sendable
    {
      ...
      public static var _anyTypeUrl: Swift.String {
        return
          "type.googleapis.com/google.cloud.compute.v1.reservationSubBlocks.testIamPermissionsRequest"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
