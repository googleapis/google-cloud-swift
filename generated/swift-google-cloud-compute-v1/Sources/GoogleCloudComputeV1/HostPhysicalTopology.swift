...
// limitations under the License.
  ...
  public struct HostPhysicalTopology: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `HostPhysicalTopology`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = HostPhysicalTopology().with { $0.block = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.HostPhysicalTopology"
    }
