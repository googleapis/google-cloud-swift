...
// limitations under the License.
      ...
      .OrganizationSecurityPoliciesProtocol, Sendable
  {
    ...
    public func copyRulesPollingUntilDone(
      ...
      let rawOp = try await self.copyRules(request: request, options: options)
      let initialState = try extractStatus(rawOp)
      let poll = {
        @Sendable () async throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
    ...
    public func getRule(
      request: OrganizationSecurityPoliciesClient.GetRuleRequest, options: GoogleGax.RequestOptions
  ...
  extension Clients {
    ...
    public protocol OrganizationSecurityPoliciesProtocol: Sendable {
  ...
  extension Clients.OrganizationSecurityPoliciesProtocol {
    ...
    public func copyRulesPollingUntilDone(
      ...
      return try await self.copyRulesPollingUntilDone(request: request)
    }
  ...
  @available(
    *, unavailable,
    message: "Enable the 'OrganizationSecurityPolicies' trait in Package.swift to use this client."
  )
  public final class OrganizationSecurityPoliciesClient: Sendable {
    @available(
      *, unavailable,
      message:
        "Enable the 'OrganizationSecurityPolicies' trait in Package.swift to use this client."
    )
    public init(_ options: GoogleGax.ClientOptions = .init()) throws {}
  }
#endif
