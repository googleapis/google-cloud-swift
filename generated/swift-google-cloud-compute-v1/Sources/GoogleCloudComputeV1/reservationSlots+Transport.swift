...
// limitations under the License.
  ...
  extension Clients {
    final class ReservationSlotsTransport: ReservationSlotsStub {
      ...
      public func `get`(
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            guard
              let pathVariable2 = try GoogleGax._RoutingMatcher.pathValue(
                request.parentName as Swift.String?,
            ...
            guard
              let pathVariable3 = try GoogleGax._RoutingMatcher.pathValue(
                request.reservationSlot as Swift.String?,
                matching: [.singleWildcard],
                fieldName: "reservationSlot")
            else {
              return nil
            }
            let path =
        ...
        return try await req.rpc(
          GoogleCloudComputeV1.ReservationSlotsGetResponse.self, timeout: options.attemptTimeout
        ).get()
      }
      ...
      public func list(
        ...
        req.addHeader(name: GoogleGax._HeaderNames.apiClient, value: Clients.clientHeader)
        return try await req.rpc(
          GoogleCloudComputeV1.ReservationSlotsListResponse.self, timeout: options.attemptTimeout
        ).get()
      }
