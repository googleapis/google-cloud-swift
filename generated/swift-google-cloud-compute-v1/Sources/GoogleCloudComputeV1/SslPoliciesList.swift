...
// limitations under the License.
  ...
  public struct SslPoliciesList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: SslPoliciesList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `SslPoliciesList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SslPoliciesList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([SslPolicy].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(SslPoliciesList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.SslPoliciesList.warning] field.
    ///
    /// [google.cloud.compute.v1.SslPoliciesList.warning]: <doc:SslPoliciesList/Warning>
      ...
      Sendable
    {
      ...
      public var code: SslPoliciesList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [SslPoliciesList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(SslPoliciesList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [SslPoliciesList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.SslPoliciesList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.SslPoliciesList.warning.data]: <doc:SslPoliciesList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.SslPoliciesList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.SslPoliciesList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.SslPoliciesList.warning.code]: <doc:SslPoliciesList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.SslPoliciesList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.SslPoliciesList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension SslPoliciesList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [SslPolicy] {
      return self.items
    }
