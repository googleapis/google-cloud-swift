...
// limitations under the License.
  ...
  public struct NetworkEndpointGroupsListNetworkEndpoints: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    public var items: [NetworkEndpointWithHealthStatus] = []
    ...
    public var warning: NetworkEndpointGroupsListNetworkEndpoints.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `NetworkEndpointGroupsListNetworkEndpoints`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = NetworkEndpointGroupsListNetworkEndpoints().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [NetworkEndpointWithHealthStatus].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        NetworkEndpointGroupsListNetworkEndpoints.Warning.self, forKey: .warning)
      ...
      Sendable
    {
      ...
      public var code: NetworkEndpointGroupsListNetworkEndpoints.Warning.Code? = nil
      ...
      ///   }]
      public var data: [NetworkEndpointGroupsListNetworkEndpoints.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          NetworkEndpointGroupsListNetworkEndpoints.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [NetworkEndpointGroupsListNetworkEndpoints.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.NetworkEndpointGroupsListNetworkEndpoints.warning.code] field.
      ///
      /// [google.cloud.compute.v1.NetworkEndpointGroupsListNetworkEndpoints.warning.code]: <doc:NetworkEndpointGroupsListNetworkEndpoints/Warning/Code>
      ///
  ...
  extension NetworkEndpointGroupsListNetworkEndpoints: GoogleGax._PaginatedResponse {
