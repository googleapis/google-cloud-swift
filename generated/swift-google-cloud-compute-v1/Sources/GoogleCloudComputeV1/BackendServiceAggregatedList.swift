...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var items: [Swift.String: BackendServicesScopedList] = [:]
    ...
    public var warning: BackendServiceAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `BackendServiceAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = BackendServiceAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: BackendServicesScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        BackendServiceAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.BackendServiceAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.BackendServiceAggregatedList.warning]: <doc:BackendServiceAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: BackendServiceAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [BackendServiceAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          BackendServiceAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [BackendServiceAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.BackendServiceAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.BackendServiceAggregatedList.warning.data]: <doc:BackendServiceAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.BackendServiceAggregatedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.BackendServiceAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.BackendServiceAggregatedList.warning.code]: <doc:BackendServiceAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.BackendServiceAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.BackendServiceAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
