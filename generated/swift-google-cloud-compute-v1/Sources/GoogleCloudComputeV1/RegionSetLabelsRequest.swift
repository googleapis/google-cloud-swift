...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `RegionSetLabelsRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RegionSetLabelsRequest().with { $0.labelFingerprint = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.RegionSetLabelsRequest"
    }
