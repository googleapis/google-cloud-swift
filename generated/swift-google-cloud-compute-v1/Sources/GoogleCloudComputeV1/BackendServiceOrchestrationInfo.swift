...
// limitations under the License.
  ...
  /// the backend service.
  public struct BackendServiceOrchestrationInfo: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = BackendServiceOrchestrationInfo().with { $0.resourceUri = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.BackendServiceOrchestrationInfo"
    }
