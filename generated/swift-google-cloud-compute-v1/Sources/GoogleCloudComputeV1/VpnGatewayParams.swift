...
// limitations under the License.
  ...
  public struct VpnGatewayParams: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `VpnGatewayParams`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = VpnGatewayParams().with { $0.resourceManagerTags = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.VpnGatewayParams"
    }
