...
// limitations under the License.
  ...
  public struct NotificationEndpointsScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// A list of NotificationEndpoints contained in this scope.
    public var resources: [NotificationEndpoint] = []

    /// Informational warning which replaces the list of
    /// notification endpoints when the list is empty.
    public var warning: NotificationEndpointsScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `NotificationEndpointsScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = NotificationEndpointsScopedList().with { $0.resources = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([NotificationEndpoint].self, forKey: .resources)
      {
        self.resources = value
      }
      self.warning = try container.decodeIfPresent(
        NotificationEndpointsScopedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.NotificationEndpointsScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.NotificationEndpointsScopedList.warning]: <doc:NotificationEndpointsScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: NotificationEndpointsScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [NotificationEndpointsScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          NotificationEndpointsScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [NotificationEndpointsScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.NotificationEndpointsScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.NotificationEndpointsScopedList.warning.data]: <doc:NotificationEndpointsScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.NotificationEndpointsScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.NotificationEndpointsScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.NotificationEndpointsScopedList.warning.code]: <doc:NotificationEndpointsScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.NotificationEndpointsScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.NotificationEndpointsScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
