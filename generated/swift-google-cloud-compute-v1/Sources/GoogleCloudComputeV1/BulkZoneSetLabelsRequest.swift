...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `BulkZoneSetLabelsRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = BulkZoneSetLabelsRequest().with { $0.requests = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.BulkZoneSetLabelsRequest"
    }
