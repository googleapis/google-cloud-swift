...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var warning: VpnGatewayList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `VpnGatewayList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = VpnGatewayList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([VpnGateway].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(VpnGatewayList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.VpnGatewayList.warning] field.
    ///
    /// [google.cloud.compute.v1.VpnGatewayList.warning]: <doc:VpnGatewayList/Warning>
      ...
      Sendable
    {
      ...
      public var code: VpnGatewayList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [VpnGatewayList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(VpnGatewayList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [VpnGatewayList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.VpnGatewayList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.VpnGatewayList.warning.data]: <doc:VpnGatewayList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.VpnGatewayList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.VpnGatewayList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.VpnGatewayList.warning.code]: <doc:VpnGatewayList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.VpnGatewayList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.VpnGatewayList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
