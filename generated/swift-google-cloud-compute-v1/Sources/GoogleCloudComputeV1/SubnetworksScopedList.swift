...
// limitations under the License.
  ...
  public struct SubnetworksScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// is empty.
    public var warning: SubnetworksScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `SubnetworksScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SubnetworksScopedList().with { $0.subnetworks = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Subnetwork].self, forKey: .subnetworks) {
        self.subnetworks = value
      }
      self.warning = try container.decodeIfPresent(
        SubnetworksScopedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.SubnetworksScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.SubnetworksScopedList.warning]: <doc:SubnetworksScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: SubnetworksScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [SubnetworksScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          SubnetworksScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [SubnetworksScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.SubnetworksScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.SubnetworksScopedList.warning.data]: <doc:SubnetworksScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.SubnetworksScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.SubnetworksScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.SubnetworksScopedList.warning.code]: <doc:SubnetworksScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.SubnetworksScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.SubnetworksScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
