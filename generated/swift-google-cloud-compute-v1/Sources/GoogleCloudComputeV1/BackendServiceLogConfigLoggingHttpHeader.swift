...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `BackendServiceLogConfigLoggingHttpHeader`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = BackendServiceLogConfigLoggingHttpHeader().with { $0.headerName = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.BackendServiceLogConfigLoggingHttpHeader"
    }
