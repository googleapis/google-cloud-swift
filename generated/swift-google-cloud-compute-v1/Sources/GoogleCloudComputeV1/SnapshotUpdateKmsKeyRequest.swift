...
// limitations under the License.
  ...
  public struct SnapshotUpdateKmsKeyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = SnapshotUpdateKmsKeyRequest().with { $0.kmsKeyName = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.SnapshotUpdateKmsKeyRequest"
    }
