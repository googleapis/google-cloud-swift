...
// limitations under the License.
  ...
  public struct ExternalVpnGatewayParams: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ExternalVpnGatewayParams`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ExternalVpnGatewayParams().with { $0.resourceManagerTags = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ExternalVpnGatewayParams"
    }
