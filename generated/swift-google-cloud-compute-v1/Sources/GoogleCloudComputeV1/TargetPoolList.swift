...
// limitations under the License.
  ...
  public struct TargetPoolList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: TargetPoolList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `TargetPoolList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = TargetPoolList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([TargetPool].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(TargetPoolList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.TargetPoolList.warning] field.
    ///
    /// [google.cloud.compute.v1.TargetPoolList.warning]: <doc:TargetPoolList/Warning>
      ...
      Sendable
    {
      ...
      public var code: TargetPoolList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [TargetPoolList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(TargetPoolList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [TargetPoolList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.TargetPoolList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.TargetPoolList.warning.data]: <doc:TargetPoolList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.TargetPoolList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.TargetPoolList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.TargetPoolList.warning.code]: <doc:TargetPoolList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.TargetPoolList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.TargetPoolList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension TargetPoolList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [TargetPool] {
      return self.items
    }
