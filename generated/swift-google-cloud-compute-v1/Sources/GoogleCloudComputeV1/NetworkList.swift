...
// limitations under the License.
  ...
  public struct NetworkList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: NetworkList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `NetworkList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = NetworkList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Network].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(NetworkList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.NetworkList.warning] field.
    ///
    /// [google.cloud.compute.v1.NetworkList.warning]: <doc:NetworkList/Warning>
      ...
      Sendable
    {
      ...
      public var code: NetworkList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [NetworkList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(NetworkList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent([NetworkList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.NetworkList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.NetworkList.warning.data]: <doc:NetworkList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.NetworkList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.NetworkList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.NetworkList.warning.code]: <doc:NetworkList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.NetworkList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.NetworkList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension NetworkList: GoogleGax._PaginatedResponse {
