...
// limitations under the License.
  ...
  public struct InstanceGroupManagerList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: InstanceGroupManagerList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `InstanceGroupManagerList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstanceGroupManagerList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([InstanceGroupManager].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        InstanceGroupManagerList.Warning.self, forKey: .warning)
    ...
    ///
    /// [google.cloud.compute.v1.InstanceGroupManagerList.warning]: <doc:InstanceGroupManagerList/Warning>
      ...
      Sendable
    {
      ...
      public var code: InstanceGroupManagerList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [InstanceGroupManagerList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          InstanceGroupManagerList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [InstanceGroupManagerList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      ///
      /// [google.cloud.compute.v1.InstanceGroupManagerList.warning.data]: <doc:InstanceGroupManagerList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.InstanceGroupManagerList.warning.data"
        }
      ...
      ///
      /// [google.cloud.compute.v1.InstanceGroupManagerList.warning.code]: <doc:InstanceGroupManagerList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.InstanceGroupManagerList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InstanceGroupManagerList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension InstanceGroupManagerList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [InstanceGroupManager] {
      return self.items
    }
