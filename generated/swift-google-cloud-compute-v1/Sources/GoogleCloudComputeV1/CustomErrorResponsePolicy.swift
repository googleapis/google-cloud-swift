...
// limitations under the License.
  ...
  public struct CustomErrorResponsePolicy: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let errorResponseRules = CodingKeys(stringValue: "errorResponseRules")
      static let errorService = CodingKeys(stringValue: "errorService")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [CustomErrorResponsePolicyCustomErrorResponseRule].self, forKey: .errorResponseRules)
      {
        self.errorResponseRules = value
      }
      self.errorService = try container.decodeIfPresent(Swift.String.self, forKey: .errorService)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.errorResponseRules, forKey: .errorResponseRules)
      try container.encodeIfPresent(self.errorService, forKey: .errorService)
