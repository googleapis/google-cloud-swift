...
// limitations under the License.
  ...
  public struct AllocationAggregateReservation: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// Output only. [Output only] List of resources currently in use.
    public var inUseResources: [AllocationAggregateReservationReservedResourceInfo] = []
    ...
    ///
    /// ```
    /// let value = AllocationAggregateReservation().with { $0.inUseResources = ... }
    /// ```
