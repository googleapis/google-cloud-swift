...
// limitations under the License.
  ...
  public struct BackendServiceList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: BackendServiceList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `BackendServiceList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = BackendServiceList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([BackendService].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        BackendServiceList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.BackendServiceList.warning] field.
    ///
    /// [google.cloud.compute.v1.BackendServiceList.warning]: <doc:BackendServiceList/Warning>
      ...
      Sendable
    {
      ...
      public var code: BackendServiceList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [BackendServiceList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          BackendServiceList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [BackendServiceList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.BackendServiceList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.BackendServiceList.warning.data]: <doc:BackendServiceList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.BackendServiceList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.BackendServiceList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.BackendServiceList.warning.code]: <doc:BackendServiceList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.BackendServiceList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.BackendServiceList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension BackendServiceList: GoogleGax._PaginatedResponse {
