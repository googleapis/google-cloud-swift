...
// limitations under the License.
  ...
  public struct MachineTypeAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: MachineTypesScopedList] = [:]
    ...
    public var warning: MachineTypeAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `MachineTypeAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = MachineTypeAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: MachineTypesScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        MachineTypeAggregatedList.Warning.self, forKey: .warning)
    ...
    ///
    /// [google.cloud.compute.v1.MachineTypeAggregatedList.warning]: <doc:MachineTypeAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: MachineTypeAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [MachineTypeAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          MachineTypeAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [MachineTypeAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      ///
      /// [google.cloud.compute.v1.MachineTypeAggregatedList.warning.data]: <doc:MachineTypeAggregatedList/Warning/Data>
      ...
      ///
      /// [google.cloud.compute.v1.MachineTypeAggregatedList.warning.code]: <doc:MachineTypeAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.MachineTypeAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.MachineTypeAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension MachineTypeAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, MachineTypesScopedList)] {
