...
// limitations under the License.
  ...
  public struct AcceleratorTypesScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [AcceleratorType].self, forKey: .acceleratorTypes)
      {
        self.acceleratorTypes = value
      }
      self.warning = try container.decodeIfPresent(
        AcceleratorTypesScopedList.Warning.self, forKey: .warning)
      ...
      Sendable
    {
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          AcceleratorTypesScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [AcceleratorTypesScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
