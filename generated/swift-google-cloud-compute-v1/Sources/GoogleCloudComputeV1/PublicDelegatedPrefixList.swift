...
// limitations under the License.
  ...
  public struct PublicDelegatedPrefixList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [PublicDelegatedPrefix] = []
    ...
    public var warning: PublicDelegatedPrefixList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `PublicDelegatedPrefixList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = PublicDelegatedPrefixList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([PublicDelegatedPrefix].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        PublicDelegatedPrefixList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.PublicDelegatedPrefixList.warning] field.
    ///
    /// [google.cloud.compute.v1.PublicDelegatedPrefixList.warning]: <doc:PublicDelegatedPrefixList/Warning>
      ...
      Sendable
    {
      ...
      public var code: PublicDelegatedPrefixList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [PublicDelegatedPrefixList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          PublicDelegatedPrefixList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [PublicDelegatedPrefixList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.PublicDelegatedPrefixList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.PublicDelegatedPrefixList.warning.data]: <doc:PublicDelegatedPrefixList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.PublicDelegatedPrefixList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.PublicDelegatedPrefixList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.PublicDelegatedPrefixList.warning.code]: <doc:PublicDelegatedPrefixList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.PublicDelegatedPrefixList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.PublicDelegatedPrefixList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension PublicDelegatedPrefixList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [PublicDelegatedPrefix] {
      return self.items
    }
