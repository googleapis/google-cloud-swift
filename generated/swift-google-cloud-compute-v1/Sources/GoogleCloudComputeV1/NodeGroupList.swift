...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var warning: NodeGroupList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `NodeGroupList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = NodeGroupList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([NodeGroup].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(NodeGroupList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.NodeGroupList.warning] field.
    ///
    /// [google.cloud.compute.v1.NodeGroupList.warning]: <doc:NodeGroupList/Warning>
      ...
      Sendable
    {
      ...
      public var code: NodeGroupList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [NodeGroupList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(NodeGroupList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [NodeGroupList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.NodeGroupList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.NodeGroupList.warning.data]: <doc:NodeGroupList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.NodeGroupList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.NodeGroupList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.NodeGroupList.warning.code]: <doc:NodeGroupList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.NodeGroupList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.NodeGroupList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension NodeGroupList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [NodeGroup] {
      return self.items
    }
