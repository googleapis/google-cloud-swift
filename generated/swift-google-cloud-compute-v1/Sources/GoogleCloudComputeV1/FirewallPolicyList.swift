...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var items: [FirewallPolicy] = []
    ...
    public var warning: FirewallPolicyList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `FirewallPolicyList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = FirewallPolicyList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([FirewallPolicy].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        FirewallPolicyList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.FirewallPolicyList.warning] field.
    ///
    /// [google.cloud.compute.v1.FirewallPolicyList.warning]: <doc:FirewallPolicyList/Warning>
      ...
      Sendable
    {
      ...
      public var code: FirewallPolicyList.Warning.Code? = nil
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          FirewallPolicyList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [FirewallPolicyList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.FirewallPolicyList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.FirewallPolicyList.warning.data]: <doc:FirewallPolicyList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.FirewallPolicyList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.FirewallPolicyList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.FirewallPolicyList.warning.code]: <doc:FirewallPolicyList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.FirewallPolicyList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.FirewallPolicyList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension FirewallPolicyList: GoogleGax._PaginatedResponse {
