...
// limitations under the License.
  ...
  public struct RegionAutoscalerList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: RegionAutoscalerList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `RegionAutoscalerList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RegionAutoscalerList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Autoscaler].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        RegionAutoscalerList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.RegionAutoscalerList.warning] field.
    ///
    /// [google.cloud.compute.v1.RegionAutoscalerList.warning]: <doc:RegionAutoscalerList/Warning>
      ...
      Sendable
    {
      ...
      public var code: RegionAutoscalerList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [RegionAutoscalerList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          RegionAutoscalerList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [RegionAutoscalerList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.RegionAutoscalerList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.RegionAutoscalerList.warning.data]: <doc:RegionAutoscalerList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.RegionAutoscalerList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.RegionAutoscalerList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.RegionAutoscalerList.warning.code]: <doc:RegionAutoscalerList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.RegionAutoscalerList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.RegionAutoscalerList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension RegionAutoscalerList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [Autoscaler] {
      return self.items
    }
