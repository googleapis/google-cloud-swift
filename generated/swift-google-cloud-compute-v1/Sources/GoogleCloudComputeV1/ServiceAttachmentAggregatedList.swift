...
// limitations under the License.
  ...
  public struct ServiceAttachmentAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: ServiceAttachmentsScopedList] = [:]
    ...
    public var warning: ServiceAttachmentAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ServiceAttachmentAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ServiceAttachmentAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: ServiceAttachmentsScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        ServiceAttachmentAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.ServiceAttachmentAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.ServiceAttachmentAggregatedList.warning]: <doc:ServiceAttachmentAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: ServiceAttachmentAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [ServiceAttachmentAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          ServiceAttachmentAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [ServiceAttachmentAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.ServiceAttachmentAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.ServiceAttachmentAggregatedList.warning.data]: <doc:ServiceAttachmentAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.ServiceAttachmentAggregatedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.ServiceAttachmentAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.ServiceAttachmentAggregatedList.warning.code]: <doc:ServiceAttachmentAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.ServiceAttachmentAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ServiceAttachmentAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension ServiceAttachmentAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, ServiceAttachmentsScopedList)] {
