...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var warning: MachineTypeList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `MachineTypeList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = MachineTypeList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([MachineType].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(MachineTypeList.Warning.self, forKey: .warning)
    ...
    ///
    /// [google.cloud.compute.v1.MachineTypeList.warning]: <doc:MachineTypeList/Warning>
      ...
      Sendable
    {
      ...
      public var code: MachineTypeList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [MachineTypeList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(MachineTypeList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [MachineTypeList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      ///
      /// [google.cloud.compute.v1.MachineTypeList.warning.data]: <doc:MachineTypeList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.MachineTypeList.warning.data"
        }
      ...
      ///
      /// [google.cloud.compute.v1.MachineTypeList.warning.code]: <doc:MachineTypeList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.MachineTypeList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.MachineTypeList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension MachineTypeList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [MachineType] {
      return self.items
    }
