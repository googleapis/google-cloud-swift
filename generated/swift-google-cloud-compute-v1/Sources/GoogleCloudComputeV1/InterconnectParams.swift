...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `InterconnectParams`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InterconnectParams().with { $0.resourceManagerTags = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InterconnectParams"
    }
