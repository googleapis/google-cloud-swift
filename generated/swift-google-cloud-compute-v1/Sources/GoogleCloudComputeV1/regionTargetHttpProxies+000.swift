...
// limitations under the License.
  ...
  public final class RegionTargetHttpProxiesClient: Clients.RegionTargetHttpProxiesProtocol,
    Sendable
  {
    ...
    /// @Snippet(path: "regionTargetHttpProxies_delete")
    public func delete(
      withPolling: RegionTargetHttpProxiesClient.DeleteRequest, options: GoogleGax.RequestOptions
    ...
    /// @Snippet(path: "regionTargetHttpProxies_insert")
    public func insert(
      withPolling: RegionTargetHttpProxiesClient.InsertRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
    ...
    /// @Snippet(path: "regionTargetHttpProxies_setUrlMap")
    public func setUrlMap(
      withPolling: RegionTargetHttpProxiesClient.SetUrlMapRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
  ...
  @available(
    *, unavailable,
    message: "Enable the 'RegionTargetHttpProxies' trait in Package.swift to use this client."
  )
  public final class RegionTargetHttpProxiesClient: Sendable {
    @available(
      *, unavailable,
      message: "Enable the 'RegionTargetHttpProxies' trait in Package.swift to use this client."
    )
