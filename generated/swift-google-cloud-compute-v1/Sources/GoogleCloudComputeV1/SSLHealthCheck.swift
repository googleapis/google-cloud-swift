...
// limitations under the License.
  ...
  public struct SSLHealthCheck: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var portSpecification: SSLHealthCheck.PortSpecification? = nil

    /// Specifies the type of proxy header to append before sending data to the
    /// backend, either NONE or PROXY_V1. The default
    /// is NONE.
    public var proxyHeader: SSLHealthCheck.ProxyHeader? = nil
    ...
    /// Initialize a new instance of `SSLHealthCheck`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SSLHealthCheck().with { $0.port = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.portSpecification = try container.decodeIfPresent(
        SSLHealthCheck.PortSpecification.self, forKey: .portSpecification)
      self.proxyHeader = try container.decodeIfPresent(
        SSLHealthCheck.ProxyHeader.self, forKey: .proxyHeader)
    ...
    /// The enumerated type for the [portSpecification][google.cloud.compute.v1.SSLHealthCheck.portSpecification] field.
    ///
    ...
    /// The enumerated type for the [proxyHeader][google.cloud.compute.v1.SSLHealthCheck.proxyHeader] field.
    ///
    /// [google.cloud.compute.v1.SSLHealthCheck.proxyHeader]: <doc:SSLHealthCheck/ProxyHeader>
    ///
    /// - Note: Adding cases to this enumeration is not considered a breaking change.
    ///   Always include an `@unknown default:` case when switching over this type.
    ///   Do not pattern-match against `unknownStringValue`
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.SSLHealthCheck"
    }
