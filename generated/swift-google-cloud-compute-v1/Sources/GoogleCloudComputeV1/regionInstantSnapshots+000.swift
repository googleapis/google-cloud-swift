...
// limitations under the License.
  ...
  public final class RegionInstantSnapshotsClient: Clients.RegionInstantSnapshotsProtocol, Sendable
  {
    ...
    /// @Snippet(path: "regionInstantSnapshots_delete")
    public func delete(
      withPolling: RegionInstantSnapshotsClient.DeleteRequest, options: GoogleGax.RequestOptions
    ...
    /// @Snippet(path: "regionInstantSnapshots_insert")
    public func insert(
      withPolling: RegionInstantSnapshotsClient.InsertRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
    ...
    /// @Snippet(path: "regionInstantSnapshots_setLabels")
    public func setLabels(
      withPolling: RegionInstantSnapshotsClient.SetLabelsRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
  ...
  extension Clients {
    ...
    public protocol RegionInstantSnapshotsProtocol: Sendable {
  ...
  @available(
    *, unavailable,
    message: "Enable the 'RegionInstantSnapshots' trait in Package.swift to use this client."
  )
  public final class RegionInstantSnapshotsClient: Sendable {
    @available(
      *, unavailable,
      message: "Enable the 'RegionInstantSnapshots' trait in Package.swift to use this client."
    )
