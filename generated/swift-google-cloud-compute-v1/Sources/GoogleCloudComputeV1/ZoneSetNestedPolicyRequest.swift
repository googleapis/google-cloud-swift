...
// limitations under the License.
  ...
  public struct ZoneSetNestedPolicyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ZoneSetNestedPolicyRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ZoneSetNestedPolicyRequest().with { $0.bindings = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ZoneSetNestedPolicyRequest"
    }
