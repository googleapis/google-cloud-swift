...
// limitations under the License.
    ...
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let keyValue = CodingKeys(stringValue: "keyValue")
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.keyName = try container.decodeIfPresent(Swift.String.self, forKey: .keyName)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encodeIfPresent(self.keyName, forKey: .keyName)
      try container.encodeIfPresent(self.keyValue, forKey: .keyValue)
