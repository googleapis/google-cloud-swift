...
// limitations under the License.
  ...
  public struct RegionInstanceGroupsListInstances: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: RegionInstanceGroupsListInstances.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `RegionInstanceGroupsListInstances`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RegionInstanceGroupsListInstances().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([InstanceWithNamedPorts].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        RegionInstanceGroupsListInstances.Warning.self, forKey: .warning)
    ...
    ///
    /// [google.cloud.compute.v1.RegionInstanceGroupsListInstances.warning]: <doc:RegionInstanceGroupsListInstances/Warning>
      ...
      Sendable
    {
      ...
      public var code: RegionInstanceGroupsListInstances.Warning.Code? = nil
      ...
      ///   }]
      public var data: [RegionInstanceGroupsListInstances.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          RegionInstanceGroupsListInstances.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [RegionInstanceGroupsListInstances.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      ///
      /// [google.cloud.compute.v1.RegionInstanceGroupsListInstances.warning.data]: <doc:RegionInstanceGroupsListInstances/Warning/Data>
      ...
      ///
      /// [google.cloud.compute.v1.RegionInstanceGroupsListInstances.warning.code]: <doc:RegionInstanceGroupsListInstances/Warning/Code>
      ///
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.RegionInstanceGroupsListInstances"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension RegionInstanceGroupsListInstances: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [InstanceWithNamedPorts] {
      return self.items
    }
