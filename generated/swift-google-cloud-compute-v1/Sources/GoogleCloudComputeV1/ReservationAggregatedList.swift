...
// limitations under the License.
  ...
  public struct ReservationAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: ReservationsScopedList] = [:]
    ...
    public var warning: ReservationAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ReservationAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ReservationAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: ReservationsScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        ReservationAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.ReservationAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.ReservationAggregatedList.warning]: <doc:ReservationAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: ReservationAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [ReservationAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          ReservationAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [ReservationAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.ReservationAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.ReservationAggregatedList.warning.data]: <doc:ReservationAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.ReservationAggregatedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.ReservationAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.ReservationAggregatedList.warning.code]: <doc:ReservationAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.ReservationAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ReservationAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension ReservationAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, ReservationsScopedList)] {
