...
// limitations under the License.
  ...
  public struct RoutersListNamedSets: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([NamedSet].self, forKey: .result) {
        self.result = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        RoutersListNamedSets.Warning.self, forKey: .warning)
      ...
      Sendable
    {
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          RoutersListNamedSets.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [RoutersListNamedSets.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
  ...
  extension RoutersListNamedSets: GoogleGax._PaginatedResponse {
