...
// limitations under the License.
  ...
  public struct InstancesScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: InstancesScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `InstancesScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstancesScopedList().with { $0.instances = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.warning = try container.decodeIfPresent(
        InstancesScopedList.Warning.self, forKey: .warning)
    ...
    ///
    /// [google.cloud.compute.v1.InstancesScopedList.warning]: <doc:InstancesScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: InstancesScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [InstancesScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          InstancesScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [InstancesScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      ///
      /// [google.cloud.compute.v1.InstancesScopedList.warning.data]: <doc:InstancesScopedList/Warning/Data>
      ...
      ///
      /// [google.cloud.compute.v1.InstancesScopedList.warning.code]: <doc:InstancesScopedList/Warning/Code>
      ///
