...
// limitations under the License.
  ...
  public struct NetworkEndpointGroupsScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// Output only. [Output Only] The list ofnetwork
    /// endpoint groups that are contained in this scope.
    public var networkEndpointGroups: [NetworkEndpointGroup] = []

    /// Output only. [Output Only] An informational warning that replaces the list of network
    /// endpoint groups when the list is empty.
    public var warning: NetworkEndpointGroupsScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `NetworkEndpointGroupsScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = NetworkEndpointGroupsScopedList().with { $0.networkEndpointGroups = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [NetworkEndpointGroup].self, forKey: .networkEndpointGroups)
      {
        self.networkEndpointGroups = value
      }
      self.warning = try container.decodeIfPresent(
        NetworkEndpointGroupsScopedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.NetworkEndpointGroupsScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.NetworkEndpointGroupsScopedList.warning]: <doc:NetworkEndpointGroupsScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: NetworkEndpointGroupsScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [NetworkEndpointGroupsScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          NetworkEndpointGroupsScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [NetworkEndpointGroupsScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.NetworkEndpointGroupsScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.NetworkEndpointGroupsScopedList.warning.data]: <doc:NetworkEndpointGroupsScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.NetworkEndpointGroupsScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.NetworkEndpointGroupsScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.NetworkEndpointGroupsScopedList.warning.code]: <doc:NetworkEndpointGroupsScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.NetworkEndpointGroupsScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.NetworkEndpointGroupsScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
