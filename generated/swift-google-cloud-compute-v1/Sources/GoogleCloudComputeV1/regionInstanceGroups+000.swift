...
// limitations under the License.
  ...
  extension Clients {
    ...
    public protocol RegionInstanceGroupsProtocol: Sendable {
  ...
  @available(
    *, unavailable,
    message: "Enable the 'RegionInstanceGroups' trait in Package.swift to use this client."
  )
  public final class RegionInstanceGroupsClient: Sendable {
    @available(
      *, unavailable,
      message: "Enable the 'RegionInstanceGroups' trait in Package.swift to use this client."
    )
