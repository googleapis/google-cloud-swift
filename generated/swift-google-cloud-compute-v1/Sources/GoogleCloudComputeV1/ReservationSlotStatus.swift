...
// limitations under the License.
  ...
  public struct ReservationSlotStatus: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var rdmaIpAddresses: [Swift.String] = []
    ...
    ///
    /// ```
    /// let value = ReservationSlotStatus().with { $0.physicalTopology = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ReservationSlotStatus"
    }
