...
// limitations under the License.
  ...
  public final class HttpHealthChecksClient: Clients.HttpHealthChecksProtocol, Sendable {
    ...
    /// @Snippet(path: "httpHealthChecks_delete")
    public func delete(
      withPolling: HttpHealthChecksClient.DeleteRequest, options: GoogleGax.RequestOptions
    ...
    /// @Snippet(path: "httpHealthChecks_insert")
    public func insert(
      withPolling: HttpHealthChecksClient.InsertRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
    ...
    /// @Snippet(path: "httpHealthChecks_patch")
    public func patch(
      withPolling: HttpHealthChecksClient.PatchRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
    ...
    /// @Snippet(path: "httpHealthChecks_update")
    public func update(
      withPolling: HttpHealthChecksClient.UpdateRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
  ...
  extension Clients.HttpHealthChecksProtocol {
    ...
    ) -> any AsyncSequence<HttpHealthCheck, Swift.Error> {
    ...
    /// @Snippet(path: "httpHealthChecks_list")
    public func list(
      byItem: HttpHealthChecksClient.ListRequest, options: GoogleGax.RequestOptions
    ) -> any AsyncSequence<HttpHealthCheck, Swift.Error> {
      let listRpc = {
