...
// limitations under the License.
  ...
  public struct ServerBinding: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    public var type: ServerBinding.Type_? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ServerBinding`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ServerBinding().with { $0.type = ... }
    /// ```
    ...
    /// The enumerated type for the [type][google.cloud.compute.v1.ServerBinding.type] field.
    ///
    ...
    public enum Type_: Codable, Equatable, Hashable, Sendable {
      ...
      public var stringValue: Swift.String {
        ...
        case .serverBindingTypeUnspecified: return "SERVER_BINDING_TYPE_UNSPECIFIED"
      ...
      public init(stringValue: Swift.String) {
        ...
        case "SERVER_BINDING_TYPE_UNSPECIFIED": self = .serverBindingTypeUnspecified
