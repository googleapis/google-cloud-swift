...
// limitations under the License.
  ...
  /// reservation.
  public struct FutureReservationStatusExistingMatchingUsageInfo: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = FutureReservationStatusExistingMatchingUsageInfo().with { $0.count = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return
        "type.googleapis.com/google.cloud.compute.v1.FutureReservationStatusExistingMatchingUsageInfo"
    }
