...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var warning: WireGroupList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `WireGroupList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = WireGroupList().with { $0.etag = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([WireGroup].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(WireGroupList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.WireGroupList.warning] field.
    ///
    /// [google.cloud.compute.v1.WireGroupList.warning]: <doc:WireGroupList/Warning>
      ...
      Sendable
    {
      ...
      public var code: WireGroupList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [WireGroupList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(WireGroupList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [WireGroupList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.WireGroupList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.WireGroupList.warning.data]: <doc:WireGroupList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.WireGroupList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.WireGroupList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.WireGroupList.warning.code]: <doc:WireGroupList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.WireGroupList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.WireGroupList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
