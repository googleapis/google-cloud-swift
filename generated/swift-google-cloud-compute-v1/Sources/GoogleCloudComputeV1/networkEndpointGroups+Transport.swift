...
// limitations under the License.
  ...
  extension Clients {
    final class NetworkEndpointGroupsTransport: NetworkEndpointGroupsStub {
      ...
      public func aggregatedList(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/compute/v1/projects/\(pathVariable0)/aggregated/networkEndpointGroups"
            var query = [
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            guard
              let pathVariable2 = try GoogleGax._RoutingMatcher.pathValue(
                request.networkEndpointGroup as Swift.String?,
                matching: [.singleWildcard],
                fieldName: "networkEndpointGroup")
            else {
              return nil
            }
            let path =
