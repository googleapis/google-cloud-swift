...
// limitations under the License.
  ...
  public struct RolloutPlansListResponse: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: RolloutPlansListResponse.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `RolloutPlansListResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RolloutPlansListResponse().with { $0.etag = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([RolloutPlan].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        RolloutPlansListResponse.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.RolloutPlansListResponse.warning] field.
    ///
    /// [google.cloud.compute.v1.RolloutPlansListResponse.warning]: <doc:RolloutPlansListResponse/Warning>
      ...
      Sendable
    {
      ...
      public var code: RolloutPlansListResponse.Warning.Code? = nil
      ...
      ///   }]
      public var data: [RolloutPlansListResponse.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          RolloutPlansListResponse.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [RolloutPlansListResponse.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.RolloutPlansListResponse.warning.data] field.
      ///
      /// [google.cloud.compute.v1.RolloutPlansListResponse.warning.data]: <doc:RolloutPlansListResponse/Warning/Data>
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.RolloutPlansListResponse.warning.code] field.
      ///
      /// [google.cloud.compute.v1.RolloutPlansListResponse.warning.code]: <doc:RolloutPlansListResponse/Warning/Code>
      ///
  ...
  extension RolloutPlansListResponse: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [RolloutPlan] {
      return self.items
    }
