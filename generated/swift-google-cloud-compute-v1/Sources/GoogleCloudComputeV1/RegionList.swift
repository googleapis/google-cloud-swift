...
// limitations under the License.
  ...
  public struct RegionList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: RegionList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `RegionList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RegionList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Region].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(RegionList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.RegionList.warning] field.
    ///
    /// [google.cloud.compute.v1.RegionList.warning]: <doc:RegionList/Warning>
      ...
      Sendable
    {
      ...
      public var code: RegionList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [RegionList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(RegionList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent([RegionList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.RegionList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.RegionList.warning.data]: <doc:RegionList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.RegionList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.RegionList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.RegionList.warning.code]: <doc:RegionList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.RegionList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.RegionList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension RegionList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [Region] {
      return self.items
    }
