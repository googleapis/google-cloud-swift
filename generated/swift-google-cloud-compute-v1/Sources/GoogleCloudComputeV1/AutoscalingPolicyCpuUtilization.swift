...
// limitations under the License.
  ...
  public struct AutoscalingPolicyCpuUtilization: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let predictiveMethod = CodingKeys(stringValue: "predictiveMethod")
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.predictiveMethod = try container.decodeIfPresent(
        AutoscalingPolicyCpuUtilization.PredictiveMethod.self, forKey: .predictiveMethod)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encodeIfPresent(self.predictiveMethod, forKey: .predictiveMethod)
    ...
    public enum PredictiveMethod: Codable, Equatable, Hashable, Sendable {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        case .optimizeAvailability: return try container.encode("OPTIMIZE_AVAILABILITY")
