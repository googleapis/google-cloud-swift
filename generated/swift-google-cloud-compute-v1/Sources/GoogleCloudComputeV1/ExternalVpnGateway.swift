...
// limitations under the License.
  ...
  public struct ExternalVpnGateway: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public enum RedundancyType: Codable, Equatable, Hashable, Sendable {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .fourIpsRedundancy: return try container.encode("FOUR_IPS_REDUNDANCY")
        case .singleIpInternallyRedundant:
          return try container.encode("SINGLE_IP_INTERNALLY_REDUNDANT")
        case .twoIpsRedundancy: return try container.encode("TWO_IPS_REDUNDANCY")
