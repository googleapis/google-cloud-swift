...
// limitations under the License.
  ...
  extension ReliabilityRisksClient {
    ...
    ///
    /// [google.cloud.compute.v1.reliabilityRisks.get]: <doc:ReliabilityRisksClient/`get`(request:options:)>
      ...
      Sendable
    {
      ...
      public var reliabilityRisk: Swift.String = Swift.String()
      ...
      private struct CodingKeys: CodingKey {
        ...
        static let reliabilityRisk = CodingKeys(stringValue: "reliabilityRisk")
      ...
      public init(from decoder: Decoder) throws {
        ...
        if let value = try container.decodeIfPresent(Swift.String.self, forKey: .reliabilityRisk) {
          self.reliabilityRisk = value
        }
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(self.reliabilityRisk, forKey: .reliabilityRisk)
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.reliabilityRisks.getRequest"
      }
    ...
    ///
    /// [google.cloud.compute.v1.reliabilityRisks.list]: <doc:ReliabilityRisksClient/list(request:options:)>
      ...
      Sendable
    {
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.reliabilityRisks.listRequest"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
