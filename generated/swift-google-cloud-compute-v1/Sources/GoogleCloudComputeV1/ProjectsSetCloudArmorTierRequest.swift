...
// limitations under the License.
  ...
  public struct ProjectsSetCloudArmorTierRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = ProjectsSetCloudArmorTierRequest().with { $0.cloudArmorTier = ... }
    /// ```
