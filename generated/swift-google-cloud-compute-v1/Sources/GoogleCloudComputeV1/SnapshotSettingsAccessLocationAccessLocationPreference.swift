...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `SnapshotSettingsAccessLocationAccessLocationPreference`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SnapshotSettingsAccessLocationAccessLocationPreference().with { $0.region = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return
        "type.googleapis.com/google.cloud.compute.v1.SnapshotSettingsAccessLocationAccessLocationPreference"
    }
