...
// limitations under the License.
  ...
  public struct CommitmentAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: CommitmentsScopedList] = [:]
    ...
    public var warning: CommitmentAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `CommitmentAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = CommitmentAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: CommitmentsScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        CommitmentAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.CommitmentAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.CommitmentAggregatedList.warning]: <doc:CommitmentAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: CommitmentAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [CommitmentAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          CommitmentAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [CommitmentAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.CommitmentAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.CommitmentAggregatedList.warning.data]: <doc:CommitmentAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.CommitmentAggregatedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.CommitmentAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.CommitmentAggregatedList.warning.code]: <doc:CommitmentAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.CommitmentAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.CommitmentAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension CommitmentAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, CommitmentsScopedList)] {
