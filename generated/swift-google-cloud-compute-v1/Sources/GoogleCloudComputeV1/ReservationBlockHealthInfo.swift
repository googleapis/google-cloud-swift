...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var degradedSubBlockCount: Swift.Int32? = nil

    /// The health status of the reservation block.
    public var healthStatus: ReservationBlockHealthInfo.HealthStatus? = nil
    ...
    ///
    /// ```
    /// let value = ReservationBlockHealthInfo().with { $0.degradedSubBlockCount = ... }
    /// ```
