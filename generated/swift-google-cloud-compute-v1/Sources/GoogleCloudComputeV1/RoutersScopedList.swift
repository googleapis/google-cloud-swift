...
// limitations under the License.
  ...
  public struct RoutersScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// the list is empty.
    public var warning: RoutersScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `RoutersScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RoutersScopedList().with { $0.routers = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let routers = CodingKeys(stringValue: "routers")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Router].self, forKey: .routers) {
        self.routers = value
      }
      self.warning = try container.decodeIfPresent(RoutersScopedList.Warning.self, forKey: .warning)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.routers, forKey: .routers)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.RoutersScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.RoutersScopedList.warning]: <doc:RoutersScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: RoutersScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [RoutersScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          RoutersScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [RoutersScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.RoutersScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.RoutersScopedList.warning.data]: <doc:RoutersScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.RoutersScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.RoutersScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.RoutersScopedList.warning.code]: <doc:RoutersScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.RoutersScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.RoutersScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
