...
// limitations under the License.
  ...
  public final class RegionNetworkEndpointGroupsClient: Clients.RegionNetworkEndpointGroupsProtocol,
    Sendable
  {
  ...
  @available(
    *, unavailable,
    message: "Enable the 'RegionNetworkEndpointGroups' trait in Package.swift to use this client."
  )
  public final class RegionNetworkEndpointGroupsClient: Sendable {
    @available(
      *, unavailable,
      message: "Enable the 'RegionNetworkEndpointGroups' trait in Package.swift to use this client."
    )
