...
// limitations under the License.
  ...
  public final class RoutesClient: Clients.RoutesProtocol, Sendable {
    ...
    /// @Snippet(path: "routes_delete")
    public func delete(
      withPolling: RoutesClient.DeleteRequest, options: GoogleGax.RequestOptions
    ...
    /// @Snippet(path: "routes_insert")
    public func insert(
      withPolling: RoutesClient.InsertRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
  ...
  @available(
    *, unavailable, message: "Enable the 'Routes' trait in Package.swift to use this client."
  )
  public final class RoutesClient: Sendable {
    @available(
      *, unavailable, message: "Enable the 'Routes' trait in Package.swift to use this client."
    )
    public init(_ options: GoogleGax.ClientOptions = .init()) throws {}
