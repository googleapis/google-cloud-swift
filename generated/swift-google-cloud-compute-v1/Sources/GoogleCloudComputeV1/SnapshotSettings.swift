...
// limitations under the License.
  ...
  public struct SnapshotSettings: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = SnapshotSettings().with { $0.accessLocation = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let accessLocation = CodingKeys(stringValue: "accessLocation")
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.accessLocation = try container.decodeIfPresent(
        SnapshotSettingsAccessLocation.self, forKey: .accessLocation)
      self.storageLocation = try container.decodeIfPresent(
        SnapshotSettingsStorageLocationSettings.self, forKey: .storageLocation)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encodeIfPresent(self.accessLocation, forKey: .accessLocation)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.SnapshotSettings"
    }
