...
// limitations under the License.
  ...
  public struct NodeGroupAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: NodeGroupsScopedList] = [:]
    ...
    public var warning: NodeGroupAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `NodeGroupAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = NodeGroupAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: NodeGroupsScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        NodeGroupAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.NodeGroupAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.NodeGroupAggregatedList.warning]: <doc:NodeGroupAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: NodeGroupAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [NodeGroupAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          NodeGroupAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [NodeGroupAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.NodeGroupAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.NodeGroupAggregatedList.warning.data]: <doc:NodeGroupAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.NodeGroupAggregatedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.NodeGroupAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.NodeGroupAggregatedList.warning.code]: <doc:NodeGroupAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.NodeGroupAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.NodeGroupAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension NodeGroupAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, NodeGroupsScopedList)] {
