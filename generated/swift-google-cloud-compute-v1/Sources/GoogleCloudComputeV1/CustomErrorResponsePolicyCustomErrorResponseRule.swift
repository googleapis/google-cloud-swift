...
// limitations under the License.
    ...
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let matchResponseCodes = CodingKeys(stringValue: "matchResponseCodes")
      static let overrideResponseCode = CodingKeys(stringValue: "overrideResponseCode")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Swift.String].self, forKey: .matchResponseCodes)
      {
        self.matchResponseCodes = value
      }
      self.overrideResponseCode = try container.decodeIfPresent(
        Swift.Int32.self, forKey: .overrideResponseCode)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.matchResponseCodes, forKey: .matchResponseCodes)
      try container.encodeIfPresent(self.overrideResponseCode, forKey: .overrideResponseCode)
