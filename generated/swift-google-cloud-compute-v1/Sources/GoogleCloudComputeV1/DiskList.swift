...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var warning: DiskList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `DiskList`.
    public init() {}
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Disk].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(DiskList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.DiskList.warning] field.
    ///
    /// [google.cloud.compute.v1.DiskList.warning]: <doc:DiskList/Warning>
      ...
      Sendable
    {
      ...
      public var code: DiskList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [DiskList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(DiskList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent([DiskList.Warning.Data].self, forKey: .data) {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.DiskList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.DiskList.warning.data]: <doc:DiskList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.DiskList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.DiskList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.DiskList.warning.code]: <doc:DiskList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.DiskList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.DiskList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
