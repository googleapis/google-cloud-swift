...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// the list is empty.
    public var warning: DisksScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `DisksScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DisksScopedList().with { $0.disks = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Disk].self, forKey: .disks) {
        self.disks = value
      }
    ...
    /// The message type for the [warning][google.cloud.compute.v1.DisksScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.DisksScopedList.warning]: <doc:DisksScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: DisksScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [DisksScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(DisksScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [DisksScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.DisksScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.DisksScopedList.warning.data]: <doc:DisksScopedList/Warning/Data>
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.DisksScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.DisksScopedList.warning.code]: <doc:DisksScopedList/Warning/Code>
      ///
