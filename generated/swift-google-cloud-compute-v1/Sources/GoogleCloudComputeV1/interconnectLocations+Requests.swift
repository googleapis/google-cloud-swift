...
// limitations under the License.
  ...
  extension InterconnectLocationsClient {
      ...
      Sendable
    {
      ...
      public var interconnectLocation: Swift.String = Swift.String()
      ...
      ///
      /// ```
      /// let value = GetRequest().with { $0.interconnectLocation = ... }
      /// ```
      ...
      private struct CodingKeys: CodingKey {
        ...
        static let interconnectLocation = CodingKeys(stringValue: "interconnectLocation")
      ...
      public init(from decoder: Decoder) throws {
        ...
        {
          self.interconnectLocation = value
        }
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(self.interconnectLocation, forKey: .interconnectLocation)
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.interconnectLocations.getRequest"
      }
      ...
      Sendable
    {
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.interconnectLocations.listRequest"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
