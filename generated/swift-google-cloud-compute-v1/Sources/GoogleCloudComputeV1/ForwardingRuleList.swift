...
// limitations under the License.
  ...
  public struct ForwardingRuleList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: ForwardingRuleList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ForwardingRuleList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ForwardingRuleList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([ForwardingRule].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        ForwardingRuleList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.ForwardingRuleList.warning] field.
    ///
    /// [google.cloud.compute.v1.ForwardingRuleList.warning]: <doc:ForwardingRuleList/Warning>
      ...
      Sendable
    {
      ...
      public var code: ForwardingRuleList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [ForwardingRuleList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          ForwardingRuleList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [ForwardingRuleList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.ForwardingRuleList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.ForwardingRuleList.warning.data]: <doc:ForwardingRuleList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.ForwardingRuleList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.ForwardingRuleList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.ForwardingRuleList.warning.code]: <doc:ForwardingRuleList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.ForwardingRuleList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ForwardingRuleList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension ForwardingRuleList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [ForwardingRule] {
      return self.items
    }
