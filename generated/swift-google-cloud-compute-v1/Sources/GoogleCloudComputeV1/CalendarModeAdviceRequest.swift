...
// limitations under the License.
  ...
  /// future.
  public struct CalendarModeAdviceRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = CalendarModeAdviceRequest().with { $0.futureResourcesSpecs = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.CalendarModeAdviceRequest"
    }
