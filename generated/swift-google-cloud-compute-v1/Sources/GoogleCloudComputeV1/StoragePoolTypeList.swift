...
// limitations under the License.
  ...
  public struct StoragePoolTypeList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [StoragePoolType] = []
    ...
    public var warning: StoragePoolTypeList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `StoragePoolTypeList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = StoragePoolTypeList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([StoragePoolType].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        StoragePoolTypeList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.StoragePoolTypeList.warning] field.
    ///
    /// [google.cloud.compute.v1.StoragePoolTypeList.warning]: <doc:StoragePoolTypeList/Warning>
      ...
      Sendable
    {
      ...
      public var code: StoragePoolTypeList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [StoragePoolTypeList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          StoragePoolTypeList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [StoragePoolTypeList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.StoragePoolTypeList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.StoragePoolTypeList.warning.data]: <doc:StoragePoolTypeList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.StoragePoolTypeList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.StoragePoolTypeList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.StoragePoolTypeList.warning.code]: <doc:StoragePoolTypeList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.StoragePoolTypeList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.StoragePoolTypeList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension StoragePoolTypeList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [StoragePoolType] {
      return self.items
    }
