...
// limitations under the License.
  ...
  public struct RegionInstanceGroupManagersSetTemplateRequest: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = RegionInstanceGroupManagersSetTemplateRequest().with { $0.instanceTemplate = ... }
    /// ```
