...
// limitations under the License.
  ...
  public struct VpnGatewaysScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: VpnGatewaysScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `VpnGatewaysScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = VpnGatewaysScopedList().with { $0.vpnGateways = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let vpnGateways = CodingKeys(stringValue: "vpnGateways")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([VpnGateway].self, forKey: .vpnGateways) {
        self.vpnGateways = value
      }
      self.warning = try container.decodeIfPresent(
        VpnGatewaysScopedList.Warning.self, forKey: .warning)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.vpnGateways, forKey: .vpnGateways)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.VpnGatewaysScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.VpnGatewaysScopedList.warning]: <doc:VpnGatewaysScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: VpnGatewaysScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [VpnGatewaysScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          VpnGatewaysScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [VpnGatewaysScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.VpnGatewaysScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.VpnGatewaysScopedList.warning.data]: <doc:VpnGatewaysScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.VpnGatewaysScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.VpnGatewaysScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.VpnGatewaysScopedList.warning.code]: <doc:VpnGatewaysScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.VpnGatewaysScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.VpnGatewaysScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
