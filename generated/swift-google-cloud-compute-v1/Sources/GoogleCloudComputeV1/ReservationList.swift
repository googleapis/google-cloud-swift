...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var warning: ReservationList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ReservationList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ReservationList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Reservation].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(ReservationList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.ReservationList.warning] field.
    ///
    /// [google.cloud.compute.v1.ReservationList.warning]: <doc:ReservationList/Warning>
      ...
      Sendable
    {
      ...
      public var code: ReservationList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [ReservationList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(ReservationList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [ReservationList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.ReservationList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.ReservationList.warning.data]: <doc:ReservationList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.ReservationList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.ReservationList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.ReservationList.warning.code]: <doc:ReservationList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.ReservationList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ReservationList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
