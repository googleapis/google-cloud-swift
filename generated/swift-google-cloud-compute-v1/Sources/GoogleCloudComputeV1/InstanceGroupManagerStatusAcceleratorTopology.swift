...
// limitations under the License.
  ...
  public struct InstanceGroupManagerStatusAcceleratorTopology: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.state = try container.decodeIfPresent(
        InstanceGroupManagerStatusAcceleratorTopology.State.self, forKey: .state)
      self.stateDetails = try container.decodeIfPresent(
        InstanceGroupManagerStatusAcceleratorTopologyAcceleratorTopologyStateDetails.self,
        forKey: .stateDetails)
    ...
    public enum State: Codable, Equatable, Hashable, Sendable {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        case .deactivating: return try container.encode("DEACTIVATING")
        case .failed: return try container.encode("FAILED")
        case .incomplete: return try container.encode("INCOMPLETE")
        case .reactivating: return try container.encode("REACTIVATING")
