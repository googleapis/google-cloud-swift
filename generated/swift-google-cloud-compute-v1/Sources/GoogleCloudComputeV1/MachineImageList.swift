...
// limitations under the License.
  ...
  public struct MachineImageList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: MachineImageList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `MachineImageList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = MachineImageList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([MachineImage].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(MachineImageList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.MachineImageList.warning] field.
    ///
    /// [google.cloud.compute.v1.MachineImageList.warning]: <doc:MachineImageList/Warning>
      ...
      Sendable
    {
      ...
      public var code: MachineImageList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [MachineImageList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(MachineImageList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [MachineImageList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.MachineImageList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.MachineImageList.warning.data]: <doc:MachineImageList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.MachineImageList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.MachineImageList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.MachineImageList.warning.code]: <doc:MachineImageList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.MachineImageList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.MachineImageList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension MachineImageList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [MachineImage] {
      return self.items
    }
