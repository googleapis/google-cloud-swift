...
// limitations under the License.
  ...
  public struct InstanceGroupManagerStatusStatefulPerInstanceConfigs: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = InstanceGroupManagerStatusStatefulPerInstanceConfigs().with { $0.allEffective = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let allEffective = CodingKeys(stringValue: "allEffective")
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.allEffective = try container.decodeIfPresent(Swift.Bool.self, forKey: .allEffective)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encodeIfPresent(self.allEffective, forKey: .allEffective)
