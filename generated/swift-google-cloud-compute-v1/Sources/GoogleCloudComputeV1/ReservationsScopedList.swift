...
// limitations under the License.
  ...
  public struct ReservationsScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// the list is empty.
    public var warning: ReservationsScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ReservationsScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ReservationsScopedList().with { $0.reservations = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.warning = try container.decodeIfPresent(
        ReservationsScopedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.ReservationsScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.ReservationsScopedList.warning]: <doc:ReservationsScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: ReservationsScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [ReservationsScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          ReservationsScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [ReservationsScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.ReservationsScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.ReservationsScopedList.warning.data]: <doc:ReservationsScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.ReservationsScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.ReservationsScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.ReservationsScopedList.warning.code]: <doc:ReservationsScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.ReservationsScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ReservationsScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
