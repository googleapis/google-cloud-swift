...
// limitations under the License.
  ...
  public struct RegionInstanceGroupManagersCreateInstancesRequest: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `RegionInstanceGroupManagersCreateInstancesRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RegionInstanceGroupManagersCreateInstancesRequest().with { $0.instances = ... }
    /// ```
