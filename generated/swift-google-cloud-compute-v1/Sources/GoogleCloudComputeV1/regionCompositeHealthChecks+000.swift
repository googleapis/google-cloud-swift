...
// limitations under the License.
  ...
  public final class RegionCompositeHealthChecksClient: Clients.RegionCompositeHealthChecksProtocol,
    Sendable
  {
    ...
    public func getHealth(
      request: RegionCompositeHealthChecksClient.GetHealthRequest, options: GoogleGax.RequestOptions
    ...
    /// @Snippet(path: "regionCompositeHealthChecks_patch")
    public func patch(
      withPolling: RegionCompositeHealthChecksClient.PatchRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
  ...
  @available(
    *, unavailable,
    message: "Enable the 'RegionCompositeHealthChecks' trait in Package.swift to use this client."
  )
  public final class RegionCompositeHealthChecksClient: Sendable {
    @available(
      *, unavailable,
      message: "Enable the 'RegionCompositeHealthChecks' trait in Package.swift to use this client."
    )
