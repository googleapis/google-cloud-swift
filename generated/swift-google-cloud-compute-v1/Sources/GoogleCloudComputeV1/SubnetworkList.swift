...
// limitations under the License.
  ...
  public struct SubnetworkList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: SubnetworkList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `SubnetworkList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SubnetworkList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Subnetwork].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(SubnetworkList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.SubnetworkList.warning] field.
    ///
    /// [google.cloud.compute.v1.SubnetworkList.warning]: <doc:SubnetworkList/Warning>
      ...
      Sendable
    {
      ...
      public var code: SubnetworkList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [SubnetworkList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(SubnetworkList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [SubnetworkList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.SubnetworkList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.SubnetworkList.warning.data]: <doc:SubnetworkList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.SubnetworkList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.SubnetworkList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.SubnetworkList.warning.code]: <doc:SubnetworkList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.SubnetworkList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.SubnetworkList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension SubnetworkList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [Subnetwork] {
      return self.items
    }
