...
// limitations under the License.
  ...
  /// and Zones.
  public struct Region: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var quotaStatusWarning: Region.QuotaStatusWarning? = nil
    ...
    public var status: Region.Status? = nil
    ...
    ///
    /// ```
    /// let value = Region().with { $0.creationTimestamp = ... }
    /// ```
    ...
    public struct QuotaStatusWarning: Codable, Equatable, GoogleWKT._AnyPackable,
      Sendable
    {
      /// [Output Only] A warning code, if applicable. For example, Compute
      /// Engine returns NO_RESULTS_ON_PAGE if there
      /// are no results in the response.
      public var code: Region.QuotaStatusWarning.Code? = nil
      ...
      ///   }]
      public var data: [Region.QuotaStatusWarning.Data] = []
      ...
      ///
      /// ```
      /// let value = QuotaStatusWarning().with { $0.code = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.Region.quotaStatusWarning.code] field.
      ///
      /// [google.cloud.compute.v1.Region.quotaStatusWarning.code]: <doc:Region/QuotaStatusWarning/Code>
      ///
    ...
    /// The enumerated type for the [status][google.cloud.compute.v1.Region.status] field.
    ///
    /// [google.cloud.compute.v1.Region.status]: <doc:Region/Status>
    ///
    /// - Note: Adding cases to this enumeration is not considered a breaking change.
    ///   Always include an `@unknown default:` case when switching over this type.
    ///   Do not pattern-match against `unknownStringValue`
