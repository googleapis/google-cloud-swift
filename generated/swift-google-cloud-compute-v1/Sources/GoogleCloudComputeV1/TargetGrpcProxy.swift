...
// limitations under the License.
  ...
  public struct TargetGrpcProxy: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let validateForProxyless = CodingKeys(stringValue: "validateForProxyless")
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encodeIfPresent(self.validateForProxyless, forKey: .validateForProxyless)
