...
// limitations under the License.
  ...
  public struct PreservedStatePreservedNetworkIp: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.autoDelete = try container.decodeIfPresent(
        PreservedStatePreservedNetworkIp.AutoDelete.self, forKey: .autoDelete)
      self.ipAddress = try container.decodeIfPresent(
        PreservedStatePreservedNetworkIpIpAddress.self, forKey: .ipAddress)
