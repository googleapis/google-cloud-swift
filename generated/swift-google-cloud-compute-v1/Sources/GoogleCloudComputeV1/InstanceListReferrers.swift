...
// limitations under the License.
  ...
  public struct InstanceListReferrers: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: InstanceListReferrers.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `InstanceListReferrers`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstanceListReferrers().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Reference].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        InstanceListReferrers.Warning.self, forKey: .warning)
    ...
    ///
    /// [google.cloud.compute.v1.InstanceListReferrers.warning]: <doc:InstanceListReferrers/Warning>
      ...
      Sendable
    {
      ...
      public var code: InstanceListReferrers.Warning.Code? = nil
      ...
      ///   }]
      public var data: [InstanceListReferrers.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          InstanceListReferrers.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [InstanceListReferrers.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      ///
      /// [google.cloud.compute.v1.InstanceListReferrers.warning.data]: <doc:InstanceListReferrers/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.InstanceListReferrers.warning.data"
        }
      ...
      ///
      /// [google.cloud.compute.v1.InstanceListReferrers.warning.code]: <doc:InstanceListReferrers/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.InstanceListReferrers.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InstanceListReferrers"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension InstanceListReferrers: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [Reference] {
      return self.items
    }
