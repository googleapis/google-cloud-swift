...
// limitations under the License.
  ...
  public struct InstanceGroupManagersListManagedInstancesResponse: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let managedInstances = CodingKeys(stringValue: "managedInstances")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [ManagedInstance].self, forKey: .managedInstances)
      {
        self.managedInstances = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.managedInstances, forKey: .managedInstances)
  ...
  extension InstanceGroupManagersListManagedInstancesResponse: GoogleGax._PaginatedResponse {
