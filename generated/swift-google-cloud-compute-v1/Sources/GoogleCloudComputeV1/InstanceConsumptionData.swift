...
// limitations under the License.
  ...
  public struct InstanceConsumptionData: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// Output only. Resources consumed by the instance.
    public var consumptionInfo: InstanceConsumptionInfo? = nil
    ...
    ///
    /// ```
    /// let value = InstanceConsumptionData().with { $0.consumptionInfo = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InstanceConsumptionData"
    }
