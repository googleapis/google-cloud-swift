...
// limitations under the License.
  ...
  public struct InstanceGroupManagerStatusStateful: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let hasStatefulConfig = CodingKeys(stringValue: "hasStatefulConfig")
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.perInstanceConfigs = try container.decodeIfPresent(
        InstanceGroupManagerStatusStatefulPerInstanceConfigs.self, forKey: .perInstanceConfigs)
