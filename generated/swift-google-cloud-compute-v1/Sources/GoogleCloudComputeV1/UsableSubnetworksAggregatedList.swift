...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// scopes.
    public var scopedWarnings: [SubnetworksScopedWarning] = []
    ...
    public var warning: UsableSubnetworksAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `UsableSubnetworksAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = UsableSubnetworksAggregatedList().with { $0.id = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let scopedWarnings = CodingKeys(stringValue: "scopedWarnings")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([UsableSubnetwork].self, forKey: .items) {
        self.items = value
      }
      self.kind = try container.decodeIfPresent(Swift.String.self, forKey: .kind)
      self.nextPageToken = try container.decodeIfPresent(Swift.String.self, forKey: .nextPageToken)
      if let value = try container.decodeIfPresent(
        [SubnetworksScopedWarning].self, forKey: .scopedWarnings)
      {
        self.scopedWarnings = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        UsableSubnetworksAggregatedList.Warning.self, forKey: .warning)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.scopedWarnings, forKey: .scopedWarnings)
      ...
      Sendable
    {
      ...
      public var code: UsableSubnetworksAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [UsableSubnetworksAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          UsableSubnetworksAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [UsableSubnetworksAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.UsableSubnetworksAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.UsableSubnetworksAggregatedList.warning.code]: <doc:UsableSubnetworksAggregatedList/Warning/Code>
      ///
