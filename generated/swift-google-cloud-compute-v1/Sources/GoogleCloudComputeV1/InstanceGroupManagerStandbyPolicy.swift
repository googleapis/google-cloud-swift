...
// limitations under the License.
  ...
  public struct InstanceGroupManagerStandbyPolicy: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = InstanceGroupManagerStandbyPolicy().with { $0.initialDelaySec = ... }
    /// ```
    ...
    public enum Mode: Codable, Equatable, Hashable, Sendable {
      ...
      public var stringValue: Swift.String? {
        ...
        case .scaleOutPool: return "SCALE_OUT_POOL"
      ...
      public init(stringValue: Swift.String) {
        ...
        case "SCALE_OUT_POOL": self = .scaleOutPool
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InstanceGroupManagerStandbyPolicy"
    }
