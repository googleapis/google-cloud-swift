...
// limitations under the License.
  ...
  public struct VpnTunnel: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public enum Status: Codable, Equatable, Sendable {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        case .authorizationError: return try container.encode("AUTHORIZATION_ERROR")
        case .deprovisioning: return try container.encode("DEPROVISIONING")
        case .established: return try container.encode("ESTABLISHED")
        case .failed: return try container.encode("FAILED")
        case .firstHandshake: return try container.encode("FIRST_HANDSHAKE")
        case .negotiationFailure: return try container.encode("NEGOTIATION_FAILURE")
        case .networkError: return try container.encode("NETWORK_ERROR")
        case .noIncomingPackets: return try container.encode("NO_INCOMING_PACKETS")
