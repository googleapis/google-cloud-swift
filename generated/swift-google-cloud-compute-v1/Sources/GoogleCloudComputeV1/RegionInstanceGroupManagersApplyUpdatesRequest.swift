...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var minimalAction: RegionInstanceGroupManagersApplyUpdatesRequest.MinimalAction? = nil
    ...
    ///
    /// ```
    /// let value = RegionInstanceGroupManagersApplyUpdatesRequest().with { $0.allInstances = ... }
    /// ```
