...
// limitations under the License.
  ...
  public struct BackendServiceHAPolicyLeaderNetworkEndpoint: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = BackendServiceHAPolicyLeaderNetworkEndpoint().with { $0.instance = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return
        "type.googleapis.com/google.cloud.compute.v1.BackendServiceHAPolicyLeaderNetworkEndpoint"
    }
