...
// limitations under the License.
  ...
  public struct PathMatcher: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = PathMatcher().with { $0.defaultCustomErrorResponsePolicy = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.PathMatcher"
    }
