...
// limitations under the License.
  ...
  public struct ReservationParams: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ReservationParams`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ReservationParams().with { $0.resourceManagerTags = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ReservationParams"
    }
