...
// limitations under the License.
  ...
  public struct FutureReservationsListResponse: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [FutureReservation] = []
    ...
    public var warning: FutureReservationsListResponse.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `FutureReservationsListResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = FutureReservationsListResponse().with { $0.etag = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([FutureReservation].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        FutureReservationsListResponse.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.FutureReservationsListResponse.warning] field.
    ///
    /// [google.cloud.compute.v1.FutureReservationsListResponse.warning]: <doc:FutureReservationsListResponse/Warning>
      ...
      Sendable
    {
      ...
      public var code: FutureReservationsListResponse.Warning.Code? = nil
      ...
      ///   }]
      public var data: [FutureReservationsListResponse.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          FutureReservationsListResponse.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [FutureReservationsListResponse.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.FutureReservationsListResponse.warning.data] field.
      ///
      /// [google.cloud.compute.v1.FutureReservationsListResponse.warning.data]: <doc:FutureReservationsListResponse/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.FutureReservationsListResponse.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.FutureReservationsListResponse.warning.code] field.
      ///
      /// [google.cloud.compute.v1.FutureReservationsListResponse.warning.code]: <doc:FutureReservationsListResponse/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.FutureReservationsListResponse.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.FutureReservationsListResponse"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension FutureReservationsListResponse: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [FutureReservation] {
      return self.items
    }
