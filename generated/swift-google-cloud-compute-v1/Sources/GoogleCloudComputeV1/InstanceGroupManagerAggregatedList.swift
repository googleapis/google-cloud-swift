...
// limitations under the License.
  ...
  public struct InstanceGroupManagerAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: InstanceGroupManagersScopedList] = [:]
    ...
    public var warning: InstanceGroupManagerAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `InstanceGroupManagerAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstanceGroupManagerAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: InstanceGroupManagersScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        InstanceGroupManagerAggregatedList.Warning.self, forKey: .warning)
    ...
    ///
    /// [google.cloud.compute.v1.InstanceGroupManagerAggregatedList.warning]: <doc:InstanceGroupManagerAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: InstanceGroupManagerAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [InstanceGroupManagerAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          InstanceGroupManagerAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [InstanceGroupManagerAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      ///
      /// [google.cloud.compute.v1.InstanceGroupManagerAggregatedList.warning.data]: <doc:InstanceGroupManagerAggregatedList/Warning/Data>
      ...
      ///
      /// [google.cloud.compute.v1.InstanceGroupManagerAggregatedList.warning.code]: <doc:InstanceGroupManagerAggregatedList/Warning/Code>
      ///
  ...
  extension InstanceGroupManagerAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, InstanceGroupManagersScopedList)] {
