...
// limitations under the License.
  ...
  extension Clients {
    ...
    public protocol ZonesProtocol: Sendable {
      /// See `ZonesClient.`get``.
      func `get`(
        request: ZonesClient.GetRequest, options: GoogleGax.RequestOptions
      ) async throws -> GoogleCloudComputeV1.Zone
  ...
  @available(
    *, unavailable, message: "Enable the 'Zones' trait in Package.swift to use this client."
  )
  public final class ZonesClient: Sendable {
    @available(
      *, unavailable, message: "Enable the 'Zones' trait in Package.swift to use this client."
    )
    public init(_ options: GoogleGax.ClientOptions = .init()) throws {}
