...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `FirewallParams`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = FirewallParams().with { $0.resourceManagerTags = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.FirewallParams"
    }
