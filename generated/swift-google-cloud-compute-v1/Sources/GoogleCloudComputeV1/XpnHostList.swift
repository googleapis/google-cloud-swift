...
// limitations under the License.
  ...
  public struct XpnHostList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: XpnHostList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `XpnHostList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = XpnHostList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Project].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(XpnHostList.Warning.self, forKey: .warning)
    ...
    ///
    /// [google.cloud.compute.v1.XpnHostList.warning]: <doc:XpnHostList/Warning>
      ...
      Sendable
    {
      ...
      public var code: XpnHostList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [XpnHostList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(XpnHostList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent([XpnHostList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      ///
      /// [google.cloud.compute.v1.XpnHostList.warning.data]: <doc:XpnHostList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.XpnHostList.warning.data"
        }
      ...
      ///
      /// [google.cloud.compute.v1.XpnHostList.warning.code]: <doc:XpnHostList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.XpnHostList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.XpnHostList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension XpnHostList: GoogleGax._PaginatedResponse {
