...
// limitations under the License.
  ...
  public struct MachineImageParams: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `MachineImageParams`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = MachineImageParams().with { $0.resourceManagerTags = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.MachineImageParams"
    }
