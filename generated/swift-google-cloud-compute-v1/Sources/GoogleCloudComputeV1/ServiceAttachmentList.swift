...
// limitations under the License.
  ...
  public struct ServiceAttachmentList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [ServiceAttachment] = []
    ...
    public var warning: ServiceAttachmentList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ServiceAttachmentList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ServiceAttachmentList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([ServiceAttachment].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        ServiceAttachmentList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.ServiceAttachmentList.warning] field.
    ///
    /// [google.cloud.compute.v1.ServiceAttachmentList.warning]: <doc:ServiceAttachmentList/Warning>
      ...
      Sendable
    {
      ...
      public var code: ServiceAttachmentList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [ServiceAttachmentList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          ServiceAttachmentList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [ServiceAttachmentList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.ServiceAttachmentList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.ServiceAttachmentList.warning.data]: <doc:ServiceAttachmentList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.ServiceAttachmentList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.ServiceAttachmentList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.ServiceAttachmentList.warning.code]: <doc:ServiceAttachmentList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.ServiceAttachmentList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ServiceAttachmentList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension ServiceAttachmentList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [ServiceAttachment] {
      return self.items
    }
