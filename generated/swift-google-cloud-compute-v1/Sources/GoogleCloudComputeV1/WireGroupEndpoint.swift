...
// limitations under the License.
  ...
  public struct WireGroupEndpoint: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = WireGroupEndpoint().with { $0.interconnects = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: WireGroupEndpointInterconnect].self, forKey: .interconnects)
      {
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.WireGroupEndpoint"
    }
