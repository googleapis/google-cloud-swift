...
// limitations under the License.
  ...
  public struct HttpHealthCheckList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: HttpHealthCheckList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `HttpHealthCheckList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = HttpHealthCheckList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([HttpHealthCheck].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        HttpHealthCheckList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.HttpHealthCheckList.warning] field.
    ///
    /// [google.cloud.compute.v1.HttpHealthCheckList.warning]: <doc:HttpHealthCheckList/Warning>
      ...
      Sendable
    {
      ...
      public var code: HttpHealthCheckList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [HttpHealthCheckList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          HttpHealthCheckList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [HttpHealthCheckList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.HttpHealthCheckList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.HttpHealthCheckList.warning.data]: <doc:HttpHealthCheckList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.HttpHealthCheckList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.HttpHealthCheckList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.HttpHealthCheckList.warning.code]: <doc:HttpHealthCheckList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.HttpHealthCheckList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.HttpHealthCheckList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension HttpHealthCheckList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [HttpHealthCheck] {
      return self.items
    }
