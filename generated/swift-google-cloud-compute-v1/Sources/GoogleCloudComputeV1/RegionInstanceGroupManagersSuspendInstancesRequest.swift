...
// limitations under the License.
  ...
  public struct RegionInstanceGroupManagersSuspendInstancesRequest: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    public var forceSuspend: Swift.Bool? = nil
    ...
    /// Initialize a new instance of `RegionInstanceGroupManagersSuspendInstancesRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RegionInstanceGroupManagersSuspendInstancesRequest().with { $0.forceSuspend = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let forceSuspend = CodingKeys(stringValue: "forceSuspend")
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.forceSuspend = try container.decodeIfPresent(Swift.Bool.self, forKey: .forceSuspend)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encodeIfPresent(self.forceSuspend, forKey: .forceSuspend)
