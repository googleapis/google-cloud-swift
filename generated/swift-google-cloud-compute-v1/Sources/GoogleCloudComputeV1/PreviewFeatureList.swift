...
// limitations under the License.
  ...
  public struct PreviewFeatureList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [PreviewFeature] = []
    ...
    public var warning: PreviewFeatureList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `PreviewFeatureList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = PreviewFeatureList().with { $0.etag = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([PreviewFeature].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        PreviewFeatureList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.PreviewFeatureList.warning] field.
    ///
    /// [google.cloud.compute.v1.PreviewFeatureList.warning]: <doc:PreviewFeatureList/Warning>
      ...
      Sendable
    {
      ...
      public var code: PreviewFeatureList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [PreviewFeatureList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          PreviewFeatureList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [PreviewFeatureList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.PreviewFeatureList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.PreviewFeatureList.warning.data]: <doc:PreviewFeatureList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.PreviewFeatureList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.PreviewFeatureList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.PreviewFeatureList.warning.code]: <doc:PreviewFeatureList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.PreviewFeatureList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.PreviewFeatureList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension PreviewFeatureList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [PreviewFeature] {
      return self.items
    }
