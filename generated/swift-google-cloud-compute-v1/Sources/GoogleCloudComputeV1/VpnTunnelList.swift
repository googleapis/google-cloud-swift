...
// limitations under the License.
  ...
  public struct VpnTunnelList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: VpnTunnelList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `VpnTunnelList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = VpnTunnelList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([VpnTunnel].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(VpnTunnelList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.VpnTunnelList.warning] field.
    ///
    /// [google.cloud.compute.v1.VpnTunnelList.warning]: <doc:VpnTunnelList/Warning>
      ...
      Sendable
    {
      ...
      public var code: VpnTunnelList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [VpnTunnelList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(VpnTunnelList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [VpnTunnelList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.VpnTunnelList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.VpnTunnelList.warning.data]: <doc:VpnTunnelList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.VpnTunnelList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.VpnTunnelList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.VpnTunnelList.warning.code]: <doc:VpnTunnelList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.VpnTunnelList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.VpnTunnelList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension VpnTunnelList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [VpnTunnel] {
      return self.items
    }
