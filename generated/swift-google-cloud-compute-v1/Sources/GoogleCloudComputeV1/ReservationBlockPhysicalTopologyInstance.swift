...
// limitations under the License.
  ...
  public struct ReservationBlockPhysicalTopologyInstance: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    /// The InstanceId of the instance
    public var instanceId: Swift.UInt64? = nil

    /// Output only. The PhysicalHostTopology of instances within a Block resource.
    public var physicalHostTopology: ReservationBlockPhysicalTopologyInstancePhysicalHostTopology? =
      nil
    ...
    ///
    /// ```
    /// let value = ReservationBlockPhysicalTopologyInstance().with { $0.instanceId = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ReservationBlockPhysicalTopologyInstance"
    }
