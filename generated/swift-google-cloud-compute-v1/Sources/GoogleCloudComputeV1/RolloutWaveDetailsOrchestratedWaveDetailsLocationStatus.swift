...
// limitations under the License.
  ...
  public struct RolloutWaveDetailsOrchestratedWaveDetailsLocationStatus: Codable, Equatable,
    GoogleWKT._AnyPackable,
    Sendable
  {
    /// Output only. Location state of the wave.
    public var state: RolloutWaveDetailsOrchestratedWaveDetailsLocationStatus.State? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `RolloutWaveDetailsOrchestratedWaveDetailsLocationStatus`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RolloutWaveDetailsOrchestratedWaveDetailsLocationStatus().with { $0.state = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.state = try container.decodeIfPresent(
        RolloutWaveDetailsOrchestratedWaveDetailsLocationStatus.State.self, forKey: .state)
    ...
    /// The enumerated type for the [state][google.cloud.compute.v1.RolloutWaveDetailsOrchestratedWaveDetailsLocationStatus.state] field.
    ///
    ...
    public enum State: Codable, Equatable, Sendable {
      ...
      public var stringValue: Swift.String? {
        ...
        case .pending: return "STATE_PENDING"
        case .skipped: return "STATE_SKIPPED"
        case .succeeded: return "STATE_SUCCEEDED"
      ...
      public init(stringValue: Swift.String) {
        ...
        case "STATE_PENDING": self = .pending
        case "STATE_SKIPPED": self = .skipped
        case "STATE_SUCCEEDED": self = .succeeded
