...
// limitations under the License.
  ...
  public struct TargetVpnGatewayParams: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `TargetVpnGatewayParams`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = TargetVpnGatewayParams().with { $0.resourceManagerTags = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.TargetVpnGatewayParams"
    }
