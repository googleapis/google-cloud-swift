...
// limitations under the License.
  ...
  public struct InstanceGroupsScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: InstanceGroupsScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `InstanceGroupsScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstanceGroupsScopedList().with { $0.instanceGroups = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let instanceGroups = CodingKeys(stringValue: "instanceGroups")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([InstanceGroup].self, forKey: .instanceGroups) {
        self.instanceGroups = value
      }
      self.warning = try container.decodeIfPresent(
        InstanceGroupsScopedList.Warning.self, forKey: .warning)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.instanceGroups, forKey: .instanceGroups)
    ...
    ///
    /// [google.cloud.compute.v1.InstanceGroupsScopedList.warning]: <doc:InstanceGroupsScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: InstanceGroupsScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [InstanceGroupsScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          InstanceGroupsScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [InstanceGroupsScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      ///
      /// [google.cloud.compute.v1.InstanceGroupsScopedList.warning.data]: <doc:InstanceGroupsScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.InstanceGroupsScopedList.warning.data"
        }
      ...
      ///
      /// [google.cloud.compute.v1.InstanceGroupsScopedList.warning.code]: <doc:InstanceGroupsScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.InstanceGroupsScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InstanceGroupsScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
