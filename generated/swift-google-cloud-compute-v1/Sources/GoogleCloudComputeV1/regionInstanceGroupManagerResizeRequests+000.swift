...
// limitations under the License.
  ...
  extension Clients {
    ...
    public protocol RegionInstanceGroupManagerResizeRequestsProtocol: Sendable {
  ...
  @available(
    *, unavailable,
    message:
      "Enable the 'RegionInstanceGroupManagerResizeRequests' trait in Package.swift to use this client."
  )
  public final class RegionInstanceGroupManagerResizeRequestsClient: Sendable {
    @available(
      *, unavailable,
      message:
        "Enable the 'RegionInstanceGroupManagerResizeRequests' trait in Package.swift to use this client."
