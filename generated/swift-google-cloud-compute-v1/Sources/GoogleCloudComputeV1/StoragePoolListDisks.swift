...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var items: [StoragePoolDisk] = []
    ...
    public var warning: StoragePoolListDisks.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `StoragePoolListDisks`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = StoragePoolListDisks().with { $0.etag = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([StoragePoolDisk].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        StoragePoolListDisks.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.StoragePoolListDisks.warning] field.
    ///
    /// [google.cloud.compute.v1.StoragePoolListDisks.warning]: <doc:StoragePoolListDisks/Warning>
      ...
      Sendable
    {
      ...
      public var code: StoragePoolListDisks.Warning.Code? = nil
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          StoragePoolListDisks.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [StoragePoolListDisks.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.StoragePoolListDisks.warning.data] field.
      ///
      /// [google.cloud.compute.v1.StoragePoolListDisks.warning.data]: <doc:StoragePoolListDisks/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.StoragePoolListDisks.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.StoragePoolListDisks.warning.code] field.
      ///
      /// [google.cloud.compute.v1.StoragePoolListDisks.warning.code]: <doc:StoragePoolListDisks/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.StoragePoolListDisks.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.StoragePoolListDisks"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
