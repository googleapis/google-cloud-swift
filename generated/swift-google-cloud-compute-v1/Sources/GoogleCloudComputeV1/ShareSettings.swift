...
// limitations under the License.
  ...
  public struct ShareSettings: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = ShareSettings().with { $0.projectMap = ... }
    /// ```
    ...
    public enum ShareType: Codable, Equatable, Hashable, Sendable {
      ...
      public var stringValue: Swift.String? {
        ...
        case .unspecified: return "SHARE_TYPE_UNSPECIFIED"
        case .specificProjects: return "SPECIFIC_PROJECTS"
      ...
      ///
      /// If the value is unknown, this initializes to [`unknownStringValue`](doc:ShareType/unknownStringValue(_:)).
      public init(stringValue: Swift.String) {
        switch stringValue {
        case "LOCAL": self = .local
        case "ORGANIZATION": self = .organization
        case "SHARE_TYPE_UNSPECIFIED": self = .unspecified
        case "SPECIFIC_PROJECTS": self = .specificProjects
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ShareSettings"
    }
