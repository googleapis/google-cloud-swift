...
// limitations under the License.
  ...
  public struct TargetInstanceList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: TargetInstanceList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `TargetInstanceList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = TargetInstanceList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([TargetInstance].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        TargetInstanceList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.TargetInstanceList.warning] field.
    ///
    /// [google.cloud.compute.v1.TargetInstanceList.warning]: <doc:TargetInstanceList/Warning>
      ...
      Sendable
    {
      ...
      public var code: TargetInstanceList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [TargetInstanceList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          TargetInstanceList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [TargetInstanceList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.TargetInstanceList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.TargetInstanceList.warning.data]: <doc:TargetInstanceList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.TargetInstanceList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.TargetInstanceList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.TargetInstanceList.warning.code]: <doc:TargetInstanceList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.TargetInstanceList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.TargetInstanceList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension TargetInstanceList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [TargetInstance] {
      return self.items
    }
