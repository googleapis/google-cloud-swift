...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `ForwardingRuleAttachedExtension`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ForwardingRuleAttachedExtension().with { $0.reference = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ForwardingRuleAttachedExtension"
    }
