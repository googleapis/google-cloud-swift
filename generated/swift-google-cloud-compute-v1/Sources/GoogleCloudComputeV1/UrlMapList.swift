...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var warning: UrlMapList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `UrlMapList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = UrlMapList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([UrlMap].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(UrlMapList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.UrlMapList.warning] field.
    ///
    /// [google.cloud.compute.v1.UrlMapList.warning]: <doc:UrlMapList/Warning>
      ...
      Sendable
    {
      ...
      public var code: UrlMapList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [UrlMapList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(UrlMapList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent([UrlMapList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.UrlMapList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.UrlMapList.warning.data]: <doc:UrlMapList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.UrlMapList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.UrlMapList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.UrlMapList.warning.code]: <doc:UrlMapList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.UrlMapList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.UrlMapList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
