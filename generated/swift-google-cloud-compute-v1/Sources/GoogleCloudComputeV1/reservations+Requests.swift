  ...
  extension ReservationsClient {
      ...
      Sendable
    {
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.body = try container.decodeIfPresent(Reservation.self, forKey: .body)
        for key in container.allKeys where !CodingKeys._knownKeys.contains(key.stringValue) {
          self._unknownFields.json[key.stringValue] = try container.decode(
            GoogleWKT.WKTValue.self, forKey: key)
        }
      ...
      Sendable
    {
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.body = try container.decodeIfPresent(
          ReservationsPerformMaintenanceRequest.self, forKey: .body)
        for key in container.allKeys where !CodingKeys._knownKeys.contains(key.stringValue) {
          self._unknownFields.json[key.stringValue] = try container.decode(
            GoogleWKT.WKTValue.self, forKey: key)
        }
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = ResizeRequest().with { $0.project = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.body = try container.decodeIfPresent(ReservationsResizeRequest.self, forKey: .body)
        for key in container.allKeys where !CodingKeys._knownKeys.contains(key.stringValue) {
          self._unknownFields.json[key.stringValue] = try container.decode(
            GoogleWKT.WKTValue.self, forKey: key)
        }
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = UpdateRequest().with { $0.paths = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
