...
// limitations under the License.
  ...
  public final class RegionHealthCheckServicesClient: Clients.RegionHealthCheckServicesProtocol,
    Sendable
  {
    ...
    /// @Snippet(path: "regionHealthCheckServices_delete")
    public func delete(
      withPolling: RegionHealthCheckServicesClient.DeleteRequest, options: GoogleGax.RequestOptions
    ...
    /// @Snippet(path: "regionHealthCheckServices_insert")
    public func insert(
      withPolling: RegionHealthCheckServicesClient.InsertRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
    ...
    /// @Snippet(path: "regionHealthCheckServices_patch")
    public func patch(
      withPolling: RegionHealthCheckServicesClient.PatchRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
  ...
  extension Clients {
    ...
    public protocol RegionHealthCheckServicesProtocol: Sendable {
  ...
  @available(
    *, unavailable,
    message: "Enable the 'RegionHealthCheckServices' trait in Package.swift to use this client."
  )
  public final class RegionHealthCheckServicesClient: Sendable {
    @available(
      *, unavailable,
      message: "Enable the 'RegionHealthCheckServices' trait in Package.swift to use this client."
    )
