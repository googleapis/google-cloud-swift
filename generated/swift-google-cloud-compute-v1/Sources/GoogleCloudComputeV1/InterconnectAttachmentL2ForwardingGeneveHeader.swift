...
// limitations under the License.
  ...
  public struct InterconnectAttachmentL2ForwardingGeneveHeader: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = InterconnectAttachmentL2ForwardingGeneveHeader().with { $0.vni = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let vni = CodingKeys(stringValue: "vni")
    ...
    public static var _anyTypeUrl: Swift.String {
      return
        "type.googleapis.com/google.cloud.compute.v1.InterconnectAttachmentL2ForwardingGeneveHeader"
    }
