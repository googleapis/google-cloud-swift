...
// limitations under the License.
  ...
  public struct GetVersionOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    public var inlineSbomInfo: GetVersionOperationMetadataSbomInfo? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `GetVersionOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = GetVersionOperationMetadata().with { $0.inlineSbomInfo = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let inlineSbomInfo = CodingKeys(stringValue: "inlineSbomInfo")
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.inlineSbomInfo = try container.decodeIfPresent(
        GetVersionOperationMetadataSbomInfo.self, forKey: .inlineSbomInfo)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encodeIfPresent(self.inlineSbomInfo, forKey: .inlineSbomInfo)
