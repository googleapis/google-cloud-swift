...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var items: [ReservationSubBlock] = []
    ...
    public var warning: ReservationSubBlocksListResponse.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ReservationSubBlocksListResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ReservationSubBlocksListResponse().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([ReservationSubBlock].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        ReservationSubBlocksListResponse.Warning.self, forKey: .warning)
      ...
      Sendable
    {
      ...
      public var code: ReservationSubBlocksListResponse.Warning.Code? = nil
      ...
      ///   }]
      public var data: [ReservationSubBlocksListResponse.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          ReservationSubBlocksListResponse.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [ReservationSubBlocksListResponse.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.ReservationSubBlocksListResponse.warning.code] field.
      ///
      /// [google.cloud.compute.v1.ReservationSubBlocksListResponse.warning.code]: <doc:ReservationSubBlocksListResponse/Warning/Code>
      ///
