...
#if TargetHttpsProxies || TargetSslProxies
  import Foundation
  @_spi(GoogleCloudInternal) public import GoogleWKT

  public struct SslPolicyReference: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = SslPolicyReference().with { $0.sslPolicy = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.SslPolicyReference"
    }
