...
// limitations under the License.
  ...
  public struct SetCommonInstanceMetadataOperationMetadata: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let perLocationOperations = CodingKeys(stringValue: "perLocationOperations")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: SetCommonInstanceMetadataOperationMetadataPerLocationOperationInfo].self,
        forKey: .perLocationOperations)
      {
        self.perLocationOperations = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.perLocationOperations, forKey: .perLocationOperations)
