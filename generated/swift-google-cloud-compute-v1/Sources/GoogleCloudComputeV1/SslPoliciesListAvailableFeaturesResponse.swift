...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `SslPoliciesListAvailableFeaturesResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SslPoliciesListAvailableFeaturesResponse().with { $0.features = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.SslPoliciesListAvailableFeaturesResponse"
    }
