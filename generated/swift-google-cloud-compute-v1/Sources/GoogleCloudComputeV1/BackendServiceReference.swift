...
// limitations under the License.
  ...
  public struct BackendServiceReference: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `BackendServiceReference`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = BackendServiceReference().with { $0.backendService = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.BackendServiceReference"
    }
