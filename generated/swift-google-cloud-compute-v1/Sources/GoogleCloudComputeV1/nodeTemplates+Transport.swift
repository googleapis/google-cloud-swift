...
// limitations under the License.
  ...
  extension Clients {
    final class NodeTemplatesTransport: NodeTemplatesStub {
      ...
      public func aggregatedList(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/compute/v1/projects/\(pathVariable0)/aggregated/nodeTemplates"
            var query = [
        ...
        return try await req.rpc(
          GoogleCloudComputeV1.NodeTemplateAggregatedList.self, timeout: options.attemptTimeout
        ).get()
      }
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            guard
              let pathVariable2 = try GoogleGax._RoutingMatcher.pathValue(
                request.nodeTemplate as Swift.String?,
                matching: [.singleWildcard],
                fieldName: "nodeTemplate")
            else {
              return nil
            }
            let path =
              "/compute/v1/projects/\(pathVariable0)/regions/\(pathVariable1)/nodeTemplates/\(pathVariable2)"
            var query = [
              URLQueryItem(name: "$alt", value: "json")
            ]
            let encoder = GoogleGax._QueryParameterEncoder()
      ...
      public func `get`(
        ...
        req.addHeader(name: GoogleGax._HeaderNames.apiClient, value: Clients.clientHeader)
        return try await req.rpc(
          GoogleCloudComputeV1.NodeTemplate.self, timeout: options.attemptTimeout
        ).get()
      }
      ...
      public func getIamPolicy(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path =
              "/compute/v1/projects/\(pathVariable0)/regions/\(pathVariable1)/nodeTemplates/\(pathVariable2)/getIamPolicy"
            var query = [
              URLQueryItem(name: "$alt", value: "json")
            ]
            let encoder = GoogleGax._QueryParameterEncoder()
      ...
      public func insert(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path =
              "/compute/v1/projects/\(pathVariable0)/regions/\(pathVariable1)/nodeTemplates"
            var query = [
              URLQueryItem(name: "$alt", value: "json")
            ]
            let encoder = GoogleGax._QueryParameterEncoder()
      ...
      public func list(
        ...
        req.addHeader(name: GoogleGax._HeaderNames.apiClient, value: Clients.clientHeader)
        return try await req.rpc(
          GoogleCloudComputeV1.NodeTemplateList.self, timeout: options.attemptTimeout
        ).get()
      }
      ...
      public func setIamPolicy(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path =
              "/compute/v1/projects/\(pathVariable0)/regions/\(pathVariable1)/nodeTemplates/\(pathVariable2)/setIamPolicy"
            let query = [
              URLQueryItem(name: "$alt", value: "json")
            ]
            return (path, query)
      ...
      public func testIamPermissions(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path =
              "/compute/v1/projects/\(pathVariable0)/regions/\(pathVariable1)/nodeTemplates/\(pathVariable2)/testIamPermissions"
            let query = [
              URLQueryItem(name: "$alt", value: "json")
            ]
            return (path, query)
