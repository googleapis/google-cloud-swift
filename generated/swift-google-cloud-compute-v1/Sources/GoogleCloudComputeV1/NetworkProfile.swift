...
// limitations under the License.
  ...
  public struct NetworkProfile: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let profileType = CodingKeys(stringValue: "profileType")
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.features = try container.decodeIfPresent(
        NetworkProfileNetworkFeatures.self, forKey: .features)
      self.id = try container.decodeIfPresent(Swift.UInt64.self, forKey: .id)
      self.kind = try container.decodeIfPresent(Swift.String.self, forKey: .kind)
      self.location = try container.decodeIfPresent(NetworkProfileLocation.self, forKey: .location)
      self.name = try container.decodeIfPresent(Swift.String.self, forKey: .name)
      self.profileType = try container.decodeIfPresent(
        NetworkProfileProfileType.self, forKey: .profileType)
