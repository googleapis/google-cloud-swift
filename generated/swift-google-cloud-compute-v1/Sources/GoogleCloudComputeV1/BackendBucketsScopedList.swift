...
// limitations under the License.
  ...
  public struct BackendBucketsScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// A list of BackendBuckets contained in this scope.
    public var backendBuckets: [BackendBucket] = []

    /// Informational warning which replaces the list of
    /// backend services when the list is empty.
    public var warning: BackendBucketsScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `BackendBucketsScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = BackendBucketsScopedList().with { $0.backendBuckets = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let backendBuckets = CodingKeys(stringValue: "backendBuckets")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([BackendBucket].self, forKey: .backendBuckets) {
        self.backendBuckets = value
      }
      self.warning = try container.decodeIfPresent(
        BackendBucketsScopedList.Warning.self, forKey: .warning)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.backendBuckets, forKey: .backendBuckets)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.BackendBucketsScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.BackendBucketsScopedList.warning]: <doc:BackendBucketsScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: BackendBucketsScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [BackendBucketsScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          BackendBucketsScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [BackendBucketsScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.BackendBucketsScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.BackendBucketsScopedList.warning.data]: <doc:BackendBucketsScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.BackendBucketsScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.BackendBucketsScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.BackendBucketsScopedList.warning.code]: <doc:BackendBucketsScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.BackendBucketsScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.BackendBucketsScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
