...
// limitations under the License.
  ...
  public struct DiskTypeAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: DiskTypesScopedList] = [:]
    ...
    public var warning: DiskTypeAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `DiskTypeAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DiskTypeAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: DiskTypesScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        DiskTypeAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.DiskTypeAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.DiskTypeAggregatedList.warning]: <doc:DiskTypeAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: DiskTypeAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [DiskTypeAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          DiskTypeAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [DiskTypeAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.DiskTypeAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.DiskTypeAggregatedList.warning.data]: <doc:DiskTypeAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.DiskTypeAggregatedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.DiskTypeAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.DiskTypeAggregatedList.warning.code]: <doc:DiskTypeAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.DiskTypeAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.DiskTypeAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension DiskTypeAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, DiskTypesScopedList)] {
