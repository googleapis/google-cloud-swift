...
// limitations under the License.
    ...
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = GRPCTLSHealthCheck().with { $0.grpcServiceName = ... }
    /// ```
    ...
    ///
    /// [google.cloud.compute.v1.GRPCTLSHealthCheck.portSpecification]: <doc:GRPCTLSHealthCheck/PortSpecification>
    ///
