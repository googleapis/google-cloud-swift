...
// limitations under the License.
  ...
  public struct GetHealthOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// Output only. The health information.
    public var healthInfo: GetHealthOperationMetadataHealthInfo? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `GetHealthOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = GetHealthOperationMetadata().with { $0.healthInfo = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.healthInfo = try container.decodeIfPresent(
        GetHealthOperationMetadataHealthInfo.self, forKey: .healthInfo)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.GetHealthOperationMetadata"
    }
