...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var portSpecification: HTTP2HealthCheck.PortSpecification? = nil

    /// Specifies the type of proxy header to append before sending data to the
    /// backend, either NONE or PROXY_V1. The default
    /// is NONE.
    public var proxyHeader: HTTP2HealthCheck.ProxyHeader? = nil
    ...
    /// Initialize a new instance of `HTTP2HealthCheck`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = HTTP2HealthCheck().with { $0.host = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.portSpecification = try container.decodeIfPresent(
        HTTP2HealthCheck.PortSpecification.self, forKey: .portSpecification)
      self.proxyHeader = try container.decodeIfPresent(
        HTTP2HealthCheck.ProxyHeader.self, forKey: .proxyHeader)
    ...
    /// The enumerated type for the [portSpecification][google.cloud.compute.v1.HTTP2HealthCheck.portSpecification] field.
    ///
    /// [google.cloud.compute.v1.HTTP2HealthCheck.portSpecification]: <doc:HTTP2HealthCheck/PortSpecification>
    ///
    ...
    /// The enumerated type for the [proxyHeader][google.cloud.compute.v1.HTTP2HealthCheck.proxyHeader] field.
    ///
    /// [google.cloud.compute.v1.HTTP2HealthCheck.proxyHeader]: <doc:HTTP2HealthCheck/ProxyHeader>
    ///
    /// - Note: Adding cases to this enumeration is not considered a breaking change.
    ///   Always include an `@unknown default:` case when switching over this type.
    ///   Do not pattern-match against `unknownStringValue`
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.HTTP2HealthCheck"
    }
