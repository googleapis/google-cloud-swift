...
// limitations under the License.
  ...
  public struct ReservationBlocksListResponse: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [ReservationBlock] = []
    ...
    public var warning: ReservationBlocksListResponse.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ReservationBlocksListResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ReservationBlocksListResponse().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([ReservationBlock].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        ReservationBlocksListResponse.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.ReservationBlocksListResponse.warning] field.
    ///
    /// [google.cloud.compute.v1.ReservationBlocksListResponse.warning]: <doc:ReservationBlocksListResponse/Warning>
      ...
      Sendable
    {
      ...
      public var code: ReservationBlocksListResponse.Warning.Code? = nil
      ...
      ///   }]
      public var data: [ReservationBlocksListResponse.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          ReservationBlocksListResponse.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [ReservationBlocksListResponse.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.ReservationBlocksListResponse.warning.data] field.
      ///
      /// [google.cloud.compute.v1.ReservationBlocksListResponse.warning.data]: <doc:ReservationBlocksListResponse/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.ReservationBlocksListResponse.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.ReservationBlocksListResponse.warning.code] field.
      ///
      /// [google.cloud.compute.v1.ReservationBlocksListResponse.warning.code]: <doc:ReservationBlocksListResponse/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.ReservationBlocksListResponse.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ReservationBlocksListResponse"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension ReservationBlocksListResponse: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [ReservationBlock] {
      return self.items
    }
