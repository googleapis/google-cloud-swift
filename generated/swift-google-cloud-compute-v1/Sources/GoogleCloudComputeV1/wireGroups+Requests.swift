...
// limitations under the License.
  ...
  extension WireGroupsClient {
      ...
      Sendable
    {
      ...
      public var wireGroup: Swift.String = Swift.String()
      ...
      ///
      /// ```
      /// let value = DeleteRequest().with { $0.crossSiteNetwork = ... }
      /// ```
      ...
      private struct CodingKeys: CodingKey {
        ...
        static let crossSiteNetwork = CodingKeys(stringValue: "crossSiteNetwork")
        static let project = CodingKeys(stringValue: "project")
        static let requestId = CodingKeys(stringValue: "requestId")
        static let wireGroup = CodingKeys(stringValue: "wireGroup")
      ...
      public init(from decoder: Decoder) throws {
        ...
        if let value = try container.decodeIfPresent(Swift.String.self, forKey: .wireGroup) {
          self.wireGroup = value
        }
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(self.wireGroup, forKey: .wireGroup)
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = GetRequest().with { $0.crossSiteNetwork = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = InsertRequest().with { $0.crossSiteNetwork = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.body = try container.decodeIfPresent(WireGroup.self, forKey: .body)
        for key in container.allKeys where !CodingKeys._knownKeys.contains(key.stringValue) {
          self._unknownFields.json[key.stringValue] = try container.decode(
            GoogleWKT.WKTValue.self, forKey: key)
        }
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = ListRequest().with { $0.crossSiteNetwork = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = PatchRequest().with { $0.crossSiteNetwork = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
