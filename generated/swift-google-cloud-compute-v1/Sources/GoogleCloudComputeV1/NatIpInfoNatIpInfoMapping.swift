...
// limitations under the License.
  ...
  public struct NatIpInfoNatIpInfoMapping: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// Output only. Specifies whether NAT IP is auto or manual.
    public var mode: NatIpInfoNatIpInfoMapping.Mode? = nil
    ...
    ///
    /// ```
    /// let value = NatIpInfoNatIpInfoMapping().with { $0.mode = ... }
    /// ```
    ...
    ///
    /// [google.cloud.compute.v1.NatIpInfoNatIpInfoMapping.mode]: <doc:NatIpInfoNatIpInfoMapping/Mode>
    ///
    ...
    /// The enumerated type for the [usage][google.cloud.compute.v1.NatIpInfoNatIpInfoMapping.usage] field.
    ///
    /// [google.cloud.compute.v1.NatIpInfoNatIpInfoMapping.usage]: <doc:NatIpInfoNatIpInfoMapping/Usage>
    ///
    /// - Note: Adding cases to this enumeration is not considered a breaking change.
    ///   Always include an `@unknown default:` case when switching over this type.
    ///   Do not pattern-match against `unknownStringValue`
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.NatIpInfoNatIpInfoMapping"
    }
