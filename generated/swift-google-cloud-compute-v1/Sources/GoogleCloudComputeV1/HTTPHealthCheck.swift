...
// limitations under the License.
  ...
  public struct HTTPHealthCheck: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = HTTPHealthCheck().with { $0.host = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.portSpecification = try container.decodeIfPresent(
        HTTPHealthCheck.PortSpecification.self, forKey: .portSpecification)
      self.proxyHeader = try container.decodeIfPresent(
        HTTPHealthCheck.ProxyHeader.self, forKey: .proxyHeader)
    ...
    /// The enumerated type for the [portSpecification][google.cloud.compute.v1.HTTPHealthCheck.portSpecification] field.
    ///
    ...
    /// The enumerated type for the [proxyHeader][google.cloud.compute.v1.HTTPHealthCheck.proxyHeader] field.
    ///
    /// [google.cloud.compute.v1.HTTPHealthCheck.proxyHeader]: <doc:HTTPHealthCheck/ProxyHeader>
    ///
    /// - Note: Adding cases to this enumeration is not considered a breaking change.
    ///   Always include an `@unknown default:` case when switching over this type.
    ///   Do not pattern-match against `unknownStringValue`
