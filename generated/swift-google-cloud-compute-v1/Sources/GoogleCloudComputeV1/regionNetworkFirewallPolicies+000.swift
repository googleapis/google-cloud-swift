...
// limitations under the License.
      ...
      .RegionNetworkFirewallPoliciesProtocol, Sendable
  {
    ...
    public func getRule(
      request: RegionNetworkFirewallPoliciesClient.GetRuleRequest, options: GoogleGax.RequestOptions
  ...
  extension Clients {
    ...
    public protocol RegionNetworkFirewallPoliciesProtocol: Sendable {
  ...
  extension Clients.RegionNetworkFirewallPoliciesProtocol {
    ...
    /// @Snippet(path: "regionNetworkFirewallPolicies_list")
    public func list(
      byItem: RegionNetworkFirewallPoliciesClient.ListRequest, options: GoogleGax.RequestOptions
    ) -> any AsyncSequence<FirewallPolicy, Swift.Error> {
      let listRpc = {
  ...
  @available(
    *, unavailable,
    message: "Enable the 'RegionNetworkFirewallPolicies' trait in Package.swift to use this client."
  )
  public final class RegionNetworkFirewallPoliciesClient: Sendable {
    @available(
      *, unavailable,
      message:
        "Enable the 'RegionNetworkFirewallPolicies' trait in Package.swift to use this client."
    )
    public init(_ options: GoogleGax.ClientOptions = .init()) throws {}
  }
#endif
