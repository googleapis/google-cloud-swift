...
// limitations under the License.
  ...
  public struct RegionInstanceGroupManagersResumeInstancesRequest: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `RegionInstanceGroupManagersResumeInstancesRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RegionInstanceGroupManagersResumeInstancesRequest().with { $0.instances = ... }
    /// ```
