...
// limitations under the License.
  ...
  public struct InstantSnapshotAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: InstantSnapshotsScopedList] = [:]
    ...
    public var warning: InstantSnapshotAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `InstantSnapshotAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstantSnapshotAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: InstantSnapshotsScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        InstantSnapshotAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.InstantSnapshotAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.InstantSnapshotAggregatedList.warning]: <doc:InstantSnapshotAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: InstantSnapshotAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [InstantSnapshotAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          InstantSnapshotAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [InstantSnapshotAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.InstantSnapshotAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.InstantSnapshotAggregatedList.warning.data]: <doc:InstantSnapshotAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.InstantSnapshotAggregatedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.InstantSnapshotAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.InstantSnapshotAggregatedList.warning.code]: <doc:InstantSnapshotAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.InstantSnapshotAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InstantSnapshotAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension InstantSnapshotAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, InstantSnapshotsScopedList)] {
