...
// limitations under the License.
  ...
  public struct DistributionPolicyZoneConfiguration: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// The URL of thezone.
    ...
    ///
    /// ```
    /// let value = DistributionPolicyZoneConfiguration().with { $0.zone = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.DistributionPolicyZoneConfiguration"
    }
