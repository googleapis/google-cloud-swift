...
// limitations under the License.
  ...
  extension HostsClient {
      ...
      Sendable
    {
      ...
      public var association: Swift.String = Swift.String()
      ...
      ///
      /// ```
      /// let value = GetRequest().with { $0.association = ... }
      /// ```
      ...
      private struct CodingKeys: CodingKey {
        ...
        static let association = CodingKeys(stringValue: "association")
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.hosts.getRequest"
      }
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = GetVersionRequest().with { $0.association = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.body = try container.decodeIfPresent(HostsGetVersionRequest.self, forKey: .body)
        for key in container.allKeys where !CodingKeys._knownKeys.contains(key.stringValue) {
          self._unknownFields.json[key.stringValue] = try container.decode(
            GoogleWKT.WKTValue.self, forKey: key)
        }
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.hosts.getVersionRequest"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = ListRequest().with { $0.association = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.hosts.listRequest"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
