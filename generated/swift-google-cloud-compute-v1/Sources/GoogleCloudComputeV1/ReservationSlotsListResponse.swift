...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var items: [ReservationSlot] = []
    ...
    public var warning: ReservationSlotsListResponse.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ReservationSlotsListResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ReservationSlotsListResponse().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([ReservationSlot].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        ReservationSlotsListResponse.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.ReservationSlotsListResponse.warning] field.
    ///
    /// [google.cloud.compute.v1.ReservationSlotsListResponse.warning]: <doc:ReservationSlotsListResponse/Warning>
      ...
      Sendable
    {
      ...
      public var code: ReservationSlotsListResponse.Warning.Code? = nil
      ...
      ///   }]
      public var data: [ReservationSlotsListResponse.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          ReservationSlotsListResponse.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [ReservationSlotsListResponse.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.ReservationSlotsListResponse.warning.data] field.
      ///
      /// [google.cloud.compute.v1.ReservationSlotsListResponse.warning.data]: <doc:ReservationSlotsListResponse/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.ReservationSlotsListResponse.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.ReservationSlotsListResponse.warning.code] field.
      ///
      /// [google.cloud.compute.v1.ReservationSlotsListResponse.warning.code]: <doc:ReservationSlotsListResponse/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.ReservationSlotsListResponse.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ReservationSlotsListResponse"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension ReservationSlotsListResponse: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [ReservationSlot] {
      return self.items
    }
