...
// limitations under the License.
  ...
  public struct SecurityPolicyList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: SecurityPolicyList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `SecurityPolicyList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SecurityPolicyList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([SecurityPolicy].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        SecurityPolicyList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.SecurityPolicyList.warning] field.
    ///
    /// [google.cloud.compute.v1.SecurityPolicyList.warning]: <doc:SecurityPolicyList/Warning>
      ...
      Sendable
    {
      ...
      public var code: SecurityPolicyList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [SecurityPolicyList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          SecurityPolicyList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [SecurityPolicyList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.SecurityPolicyList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.SecurityPolicyList.warning.data]: <doc:SecurityPolicyList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.SecurityPolicyList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.SecurityPolicyList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.SecurityPolicyList.warning.code]: <doc:SecurityPolicyList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.SecurityPolicyList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.SecurityPolicyList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension SecurityPolicyList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [SecurityPolicy] {
      return self.items
    }
