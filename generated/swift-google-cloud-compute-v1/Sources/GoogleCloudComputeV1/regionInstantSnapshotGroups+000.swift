...
// limitations under the License.
  ...
  public final class RegionInstantSnapshotGroupsClient: Clients.RegionInstantSnapshotGroupsProtocol,
    Sendable
  {
  ...
  extension Clients {
    ...
    public protocol RegionInstantSnapshotGroupsProtocol: Sendable {
  ...
  extension Clients.RegionInstantSnapshotGroupsProtocol {
    ...
    /// @Snippet(path: "regionInstantSnapshotGroups_list")
    public func list(
      byItem: RegionInstantSnapshotGroupsClient.ListRequest, options: GoogleGax.RequestOptions
    ) -> any AsyncSequence<InstantSnapshotGroup, Swift.Error> {
      let listRpc = {
  ...
  @available(
    *, unavailable,
    message: "Enable the 'RegionInstantSnapshotGroups' trait in Package.swift to use this client."
  )
  public final class RegionInstantSnapshotGroupsClient: Sendable {
    @available(
      *, unavailable,
      message: "Enable the 'RegionInstantSnapshotGroups' trait in Package.swift to use this client."
    )
