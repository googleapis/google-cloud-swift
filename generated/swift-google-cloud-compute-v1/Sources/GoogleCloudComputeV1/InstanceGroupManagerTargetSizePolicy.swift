...
// limitations under the License.
  ...
  public struct InstanceGroupManagerTargetSizePolicy: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.mode = try container.decodeIfPresent(
        InstanceGroupManagerTargetSizePolicy.Mode.self, forKey: .mode)
    ...
    public enum Mode: Codable, Equatable, Sendable {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .bulk: return try container.encode("BULK")
        case .individual: return try container.encode("INDIVIDUAL")
        case .unspecifiedMode: return try container.encode("UNSPECIFIED_MODE")
