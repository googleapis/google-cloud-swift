...
// limitations under the License.
  ...
  public final class RegionTargetTcpProxiesClient: Clients.RegionTargetTcpProxiesProtocol, Sendable
  {
    ...
    /// @Snippet(path: "regionTargetTcpProxies_delete")
    public func delete(
      withPolling: RegionTargetTcpProxiesClient.DeleteRequest, options: GoogleGax.RequestOptions
    ...
    /// @Snippet(path: "regionTargetTcpProxies_insert")
    public func insert(
      withPolling: RegionTargetTcpProxiesClient.InsertRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
  ...
  extension Clients {
    ...
    public protocol RegionTargetTcpProxiesProtocol: Sendable {
  ...
  @available(
    *, unavailable,
    message: "Enable the 'RegionTargetTcpProxies' trait in Package.swift to use this client."
  )
  public final class RegionTargetTcpProxiesClient: Sendable {
    @available(
      *, unavailable,
      message: "Enable the 'RegionTargetTcpProxies' trait in Package.swift to use this client."
    )
