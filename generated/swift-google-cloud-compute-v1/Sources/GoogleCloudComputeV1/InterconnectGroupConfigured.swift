...
// limitations under the License.
  ...
  /// resource.
  public struct InterconnectGroupConfigured: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.topologyCapability = try container.decodeIfPresent(
        InterconnectGroupConfiguredTopologyCapability.self, forKey: .topologyCapability)
