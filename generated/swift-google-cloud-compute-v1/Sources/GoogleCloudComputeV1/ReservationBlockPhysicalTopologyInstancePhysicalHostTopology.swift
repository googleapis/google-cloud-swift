...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `ReservationBlockPhysicalTopologyInstancePhysicalHostTopology`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ReservationBlockPhysicalTopologyInstancePhysicalHostTopology().with { $0.host = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return
        "type.googleapis.com/google.cloud.compute.v1.ReservationBlockPhysicalTopologyInstancePhysicalHostTopology"
    }
