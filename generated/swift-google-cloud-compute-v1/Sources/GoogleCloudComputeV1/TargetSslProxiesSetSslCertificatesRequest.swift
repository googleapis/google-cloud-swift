...
// limitations under the License.
  ...
  public struct TargetSslProxiesSetSslCertificatesRequest: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = TargetSslProxiesSetSslCertificatesRequest().with { $0.sslCertificates = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.TargetSslProxiesSetSslCertificatesRequest"
    }
