...
// limitations under the License.
  ...
  public final class ReservationBlocksClient: Clients.ReservationBlocksProtocol, Sendable {
    ...
    public func testIamPermissions(
      request: ReservationBlocksClient.TestIamPermissionsRequest, options: GoogleGax.RequestOptions
  ...
  extension Clients.ReservationBlocksProtocol {
    ...
    ) -> any AsyncSequence<ReservationBlock, Swift.Error> & Sendable {
  ...
  @available(
    *, unavailable,
    message: "Enable the 'ReservationBlocks' trait in Package.swift to use this client."
  )
  public final class ReservationBlocksClient: Sendable {
    @available(
      *, unavailable,
      message: "Enable the 'ReservationBlocks' trait in Package.swift to use this client."
    )
