...
// limitations under the License.
  ...
  public struct ShareSettingsProjectConfig: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = ShareSettingsProjectConfig().with { $0.projectId = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ShareSettingsProjectConfig"
    }
