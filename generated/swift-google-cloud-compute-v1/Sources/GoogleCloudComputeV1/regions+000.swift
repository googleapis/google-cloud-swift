...
// limitations under the License.
  ...
  public final class RegionsClient: Clients.RegionsProtocol, Sendable {
  ...
  extension Clients.RegionsProtocol {
    ...
    ) -> some AsyncSequence<Region, Swift.Error> & Sendable {
  ...
  @available(
    *, unavailable, message: "Enable the 'Regions' trait in Package.swift to use this client."
  )
  public final class RegionsClient: Sendable {
    @available(
      *, unavailable, message: "Enable the 'Regions' trait in Package.swift to use this client."
    )
    public init(_ options: GoogleGax.ClientOptions = .init()) throws {}
