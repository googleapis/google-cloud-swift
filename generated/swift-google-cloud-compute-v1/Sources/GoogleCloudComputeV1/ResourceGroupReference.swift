...
// limitations under the License.
  ...
  public struct ResourceGroupReference: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = ResourceGroupReference().with { $0.group = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ResourceGroupReference"
    }
