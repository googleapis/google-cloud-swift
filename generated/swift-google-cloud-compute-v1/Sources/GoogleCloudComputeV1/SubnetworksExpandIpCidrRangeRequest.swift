...
// limitations under the License.
  ...
  public struct SubnetworksExpandIpCidrRangeRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = SubnetworksExpandIpCidrRangeRequest().with { $0.ipCidrRange = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.SubnetworksExpandIpCidrRangeRequest"
    }
