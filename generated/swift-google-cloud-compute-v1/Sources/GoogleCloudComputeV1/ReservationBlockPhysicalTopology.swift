...
// limitations under the License.
  ...
  public struct ReservationBlockPhysicalTopology: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var instances: [ReservationBlockPhysicalTopologyInstance] = []

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ReservationBlockPhysicalTopology`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ReservationBlockPhysicalTopology().with { $0.block = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [ReservationBlockPhysicalTopologyInstance].self, forKey: .instances)
      {
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ReservationBlockPhysicalTopology"
    }
