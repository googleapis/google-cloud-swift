...
// limitations under the License.
  ...
  public struct SslCertificatesScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// List of SslCertificates contained in this scope.
    public var sslCertificates: [SslCertificate] = []

    /// Informational warning which replaces the list of
    /// backend services when the list is empty.
    public var warning: SslCertificatesScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `SslCertificatesScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SslCertificatesScopedList().with { $0.sslCertificates = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([SslCertificate].self, forKey: .sslCertificates)
      {
        self.sslCertificates = value
      }
      self.warning = try container.decodeIfPresent(
        SslCertificatesScopedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.SslCertificatesScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.SslCertificatesScopedList.warning]: <doc:SslCertificatesScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: SslCertificatesScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [SslCertificatesScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          SslCertificatesScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [SslCertificatesScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.SslCertificatesScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.SslCertificatesScopedList.warning.data]: <doc:SslCertificatesScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.SslCertificatesScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.SslCertificatesScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.SslCertificatesScopedList.warning.code]: <doc:SslCertificatesScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.SslCertificatesScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.SslCertificatesScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
