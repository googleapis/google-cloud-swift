...
// limitations under the License.
  ...
  public struct InstanceGroupManagersCreateInstancesRequest: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `InstanceGroupManagersCreateInstancesRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstanceGroupManagersCreateInstancesRequest().with { $0.instances = ... }
    /// ```
