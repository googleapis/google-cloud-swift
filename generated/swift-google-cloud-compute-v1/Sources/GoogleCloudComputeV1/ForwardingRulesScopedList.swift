...
// limitations under the License.
  ...
  public struct ForwardingRulesScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// the list is empty.
    public var warning: ForwardingRulesScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ForwardingRulesScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ForwardingRulesScopedList().with { $0.forwardingRules = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([ForwardingRule].self, forKey: .forwardingRules)
      {
        self.forwardingRules = value
      }
      self.warning = try container.decodeIfPresent(
        ForwardingRulesScopedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.ForwardingRulesScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.ForwardingRulesScopedList.warning]: <doc:ForwardingRulesScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: ForwardingRulesScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [ForwardingRulesScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          ForwardingRulesScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [ForwardingRulesScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.ForwardingRulesScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.ForwardingRulesScopedList.warning.data]: <doc:ForwardingRulesScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.ForwardingRulesScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.ForwardingRulesScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.ForwardingRulesScopedList.warning.code]: <doc:ForwardingRulesScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.ForwardingRulesScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ForwardingRulesScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
