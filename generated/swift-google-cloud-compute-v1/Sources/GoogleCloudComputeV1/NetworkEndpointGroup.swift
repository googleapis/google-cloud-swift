...
// limitations under the License.
  ...
  ///    API
  public struct NetworkEndpointGroup: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public enum NetworkEndpointType: Codable, Equatable, Hashable, Sendable {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .gceVmIp: return try container.encode("GCE_VM_IP")
        case .gceVmIpDedicatedBackend: return try container.encode("GCE_VM_IP_DEDICATED_BACKEND")
        case .gceVmIpPort: return try container.encode("GCE_VM_IP_PORT")
        case .gceVmIpPortmap: return try container.encode("GCE_VM_IP_PORTMAP")
        case .internetFqdnPort: return try container.encode("INTERNET_FQDN_PORT")
        case .internetIpPort: return try container.encode("INTERNET_IP_PORT")
