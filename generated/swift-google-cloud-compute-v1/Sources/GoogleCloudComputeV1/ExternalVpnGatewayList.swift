...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var items: [ExternalVpnGateway] = []
    ...
    public var warning: ExternalVpnGatewayList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ExternalVpnGatewayList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ExternalVpnGatewayList().with { $0.etag = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([ExternalVpnGateway].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        ExternalVpnGatewayList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.ExternalVpnGatewayList.warning] field.
    ///
    /// [google.cloud.compute.v1.ExternalVpnGatewayList.warning]: <doc:ExternalVpnGatewayList/Warning>
      ...
      Sendable
    {
      ...
      public var code: ExternalVpnGatewayList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [ExternalVpnGatewayList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          ExternalVpnGatewayList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [ExternalVpnGatewayList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.ExternalVpnGatewayList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.ExternalVpnGatewayList.warning.data]: <doc:ExternalVpnGatewayList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.ExternalVpnGatewayList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.ExternalVpnGatewayList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.ExternalVpnGatewayList.warning.code]: <doc:ExternalVpnGatewayList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.ExternalVpnGatewayList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ExternalVpnGatewayList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
