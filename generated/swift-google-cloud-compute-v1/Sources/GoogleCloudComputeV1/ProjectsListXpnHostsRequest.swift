...
// limitations under the License.
  ...
  public struct ProjectsListXpnHostsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = ProjectsListXpnHostsRequest().with { $0.organization = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.organization = try container.decodeIfPresent(Swift.String.self, forKey: .organization)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ProjectsListXpnHostsRequest"
    }
