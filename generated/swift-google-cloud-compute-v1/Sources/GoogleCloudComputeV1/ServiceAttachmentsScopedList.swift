...
// limitations under the License.
  ...
  public struct ServiceAttachmentsScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// A list of ServiceAttachments contained in this scope.
    public var serviceAttachments: [ServiceAttachment] = []

    /// Informational warning which replaces the list of
    /// service attachments when the list is empty.
    public var warning: ServiceAttachmentsScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ServiceAttachmentsScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ServiceAttachmentsScopedList().with { $0.serviceAttachments = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let serviceAttachments = CodingKeys(stringValue: "serviceAttachments")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [ServiceAttachment].self, forKey: .serviceAttachments)
      {
        self.serviceAttachments = value
      }
      self.warning = try container.decodeIfPresent(
        ServiceAttachmentsScopedList.Warning.self, forKey: .warning)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.serviceAttachments, forKey: .serviceAttachments)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.ServiceAttachmentsScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.ServiceAttachmentsScopedList.warning]: <doc:ServiceAttachmentsScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: ServiceAttachmentsScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [ServiceAttachmentsScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          ServiceAttachmentsScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [ServiceAttachmentsScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.ServiceAttachmentsScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.ServiceAttachmentsScopedList.warning.data]: <doc:ServiceAttachmentsScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.ServiceAttachmentsScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.ServiceAttachmentsScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.ServiceAttachmentsScopedList.warning.code]: <doc:ServiceAttachmentsScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.ServiceAttachmentsScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ServiceAttachmentsScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
