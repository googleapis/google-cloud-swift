...
// limitations under the License.
  ...
  extension RolloutsClient {
    ...
    public struct AdvanceRequest: Codable, Equatable, GoogleWKT._AnyPackable,
      Sendable
    {
      ...
      /// Initialize a new instance of `AdvanceRequest`.
      public init() {}
      ...
      ///
      /// ```
      /// let value = AdvanceRequest().with { $0.currentWaveNumber = ... }
      /// ```
      ...
      Sendable
    {
      ...
      /// both.
      public var rollback: Swift.Bool? = nil
      ...
      ///
      /// ```
      /// let value = CancelRequest().with { $0.project = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.requestId = try container.decodeIfPresent(Swift.String.self, forKey: .requestId)
        self.rollback = try container.decodeIfPresent(Swift.Bool.self, forKey: .rollback)
        if let value = try container.decodeIfPresent(Swift.String.self, forKey: .rollout) {
          self.rollout = value
        }
        for key in container.allKeys where !CodingKeys._knownKeys.contains(key.stringValue) {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(self.project, forKey: .project)
        try container.encodeIfPresent(self.requestId, forKey: .requestId)
        try container.encodeIfPresent(self.rollback, forKey: .rollback)
        try container.encode(self.rollout, forKey: .rollout)
        for (key, value) in self._unknownFields.json {
          try container.encode(value, forKey: CodingKeys(stringValue: key))
        }
    ...
    public struct PauseRequest: Codable, Equatable, GoogleWKT._AnyPackable,
      Sendable
    {
      ...
      /// Initialize a new instance of `PauseRequest`.
      public init() {}
      ...
      ///
      /// ```
      /// let value = PauseRequest().with { $0.etag = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = ResumeRequest().with { $0.etag = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
