...
// limitations under the License.
  ...
  public struct VmExtensionPoliciesScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// List of VmExtensionPolicy resources contained in this scope.
    public var vmExtensionPolicies: [VmExtensionPolicy] = []

    /// Informational warning which replaces the list of
    /// backend services when the list is empty.
    public var warning: VmExtensionPoliciesScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `VmExtensionPoliciesScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = VmExtensionPoliciesScopedList().with { $0.vmExtensionPolicies = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let vmExtensionPolicies = CodingKeys(stringValue: "vmExtensionPolicies")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [VmExtensionPolicy].self, forKey: .vmExtensionPolicies)
      {
        self.vmExtensionPolicies = value
      }
      self.warning = try container.decodeIfPresent(
        VmExtensionPoliciesScopedList.Warning.self, forKey: .warning)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.vmExtensionPolicies, forKey: .vmExtensionPolicies)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.VmExtensionPoliciesScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.VmExtensionPoliciesScopedList.warning]: <doc:VmExtensionPoliciesScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: VmExtensionPoliciesScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [VmExtensionPoliciesScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          VmExtensionPoliciesScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [VmExtensionPoliciesScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.VmExtensionPoliciesScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.VmExtensionPoliciesScopedList.warning.data]: <doc:VmExtensionPoliciesScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.VmExtensionPoliciesScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.VmExtensionPoliciesScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.VmExtensionPoliciesScopedList.warning.code]: <doc:VmExtensionPoliciesScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.VmExtensionPoliciesScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.VmExtensionPoliciesScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
