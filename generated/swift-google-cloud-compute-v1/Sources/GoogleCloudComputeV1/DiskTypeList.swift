...
// limitations under the License.
  ...
  public struct DiskTypeList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: DiskTypeList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `DiskTypeList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DiskTypeList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.warning = try container.decodeIfPresent(DiskTypeList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.DiskTypeList.warning] field.
    ///
    /// [google.cloud.compute.v1.DiskTypeList.warning]: <doc:DiskTypeList/Warning>
      ...
      Sendable
    {
      ...
      public var code: DiskTypeList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [DiskTypeList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(DiskTypeList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [DiskTypeList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.DiskTypeList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.DiskTypeList.warning.data]: <doc:DiskTypeList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.DiskTypeList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.DiskTypeList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.DiskTypeList.warning.code]: <doc:DiskTypeList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.DiskTypeList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.DiskTypeList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension DiskTypeList: GoogleGax._PaginatedResponse {
