...
// limitations under the License.
  ...
  public struct LocationPolicyLocation: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = LocationPolicyLocation().with { $0.constraints = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.constraints = try container.decodeIfPresent(
        LocationPolicyLocationConstraints.self, forKey: .constraints)
      self.preference = try container.decodeIfPresent(
        LocationPolicyLocation.Preference.self, forKey: .preference)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.LocationPolicyLocation"
    }
