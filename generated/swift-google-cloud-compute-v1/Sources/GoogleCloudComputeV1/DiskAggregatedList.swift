...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var items: [Swift.String: DisksScopedList] = [:]
    ...
    public var warning: DiskAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `DiskAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DiskAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: DisksScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        DiskAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.DiskAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.DiskAggregatedList.warning]: <doc:DiskAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: DiskAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [DiskAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          DiskAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [DiskAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.DiskAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.DiskAggregatedList.warning.data]: <doc:DiskAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.DiskAggregatedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.DiskAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.DiskAggregatedList.warning.code]: <doc:DiskAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.DiskAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.DiskAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension DiskAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, DisksScopedList)] {
