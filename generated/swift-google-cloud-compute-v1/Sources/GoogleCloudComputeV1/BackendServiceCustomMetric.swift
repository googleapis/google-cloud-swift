...
// limitations under the License.
  ...
  /// locality_lb_policy.
  public struct BackendServiceCustomMetric: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.dryRun = try container.decodeIfPresent(Swift.Bool.self, forKey: .dryRun)
