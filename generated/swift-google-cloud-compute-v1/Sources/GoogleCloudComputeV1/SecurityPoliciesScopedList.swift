...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var securityPolicies: [SecurityPolicy] = []

    /// Informational warning which replaces the list of
    /// security policies when the list is empty.
    public var warning: SecurityPoliciesScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `SecurityPoliciesScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SecurityPoliciesScopedList().with { $0.securityPolicies = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let securityPolicies = CodingKeys(stringValue: "securityPolicies")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([SecurityPolicy].self, forKey: .securityPolicies)
      {
        self.securityPolicies = value
      }
      self.warning = try container.decodeIfPresent(
        SecurityPoliciesScopedList.Warning.self, forKey: .warning)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.securityPolicies, forKey: .securityPolicies)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.SecurityPoliciesScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.SecurityPoliciesScopedList.warning]: <doc:SecurityPoliciesScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: SecurityPoliciesScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [SecurityPoliciesScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          SecurityPoliciesScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [SecurityPoliciesScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.SecurityPoliciesScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.SecurityPoliciesScopedList.warning.data]: <doc:SecurityPoliciesScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.SecurityPoliciesScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.SecurityPoliciesScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.SecurityPoliciesScopedList.warning.code]: <doc:SecurityPoliciesScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.SecurityPoliciesScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.SecurityPoliciesScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
