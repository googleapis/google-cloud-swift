...
// limitations under the License.
  ...
  public struct GlobalSetPolicyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `GlobalSetPolicyRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = GlobalSetPolicyRequest().with { $0.bindings = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.GlobalSetPolicyRequest"
    }
