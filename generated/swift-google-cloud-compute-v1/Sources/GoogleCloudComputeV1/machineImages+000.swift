...
// limitations under the License.
  ...
  public final class MachineImagesClient: Clients.MachineImagesProtocol, Sendable {
    ...
    /// @Snippet(path: "machineImages_delete")
    public func delete(
      withPolling: MachineImagesClient.DeleteRequest, options: GoogleGax.RequestOptions
    ...
    /// @Snippet(path: "machineImages_insert")
    public func insert(
      withPolling: MachineImagesClient.InsertRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
    ...
    /// @Snippet(path: "machineImages_setLabels")
    public func setLabels(
      withPolling: MachineImagesClient.SetLabelsRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
