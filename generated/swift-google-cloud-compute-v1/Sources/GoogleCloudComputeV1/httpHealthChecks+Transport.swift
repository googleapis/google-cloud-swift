...
// limitations under the License.
  ...
  extension Clients {
    final class HttpHealthChecksTransport: HttpHealthChecksStub {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            guard
              let pathVariable1 = try GoogleGax._RoutingMatcher.pathValue(
                request.httpHealthCheck as Swift.String?,
                matching: [.singleWildcard],
            ...
            let path =
              "/compute/v1/projects/\(pathVariable0)/global/httpHealthChecks/\(pathVariable1)"
            var query = [
      ...
      public func insert(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/compute/v1/projects/\(pathVariable0)/global/httpHealthChecks"
            var query = [
              URLQueryItem(name: "$alt", value: "json")
            ]
            let encoder = GoogleGax._QueryParameterEncoder()
