...
// limitations under the License.
  ...
  public final class RolloutsClient: Clients.RolloutsProtocol, Sendable {
    ...
    ///
    /// @Snippet(path: "rollouts_getOperation")
    func getOperation(
  ...
  @available(
    *, unavailable, message: "Enable the 'Rollouts' trait in Package.swift to use this client."
  )
  public final class RolloutsClient: Sendable {
    @available(
      *, unavailable, message: "Enable the 'Rollouts' trait in Package.swift to use this client."
    )
    public init(_ options: GoogleGax.ClientOptions = .init()) throws {}
