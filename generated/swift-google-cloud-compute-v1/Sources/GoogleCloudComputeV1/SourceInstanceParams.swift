...
// limitations under the License.
  ...
  public struct SourceInstanceParams: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let diskConfigs = CodingKeys(stringValue: "diskConfigs")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [DiskInstantiationConfig].self, forKey: .diskConfigs)
      {
        self.diskConfigs = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.diskConfigs, forKey: .diskConfigs)
