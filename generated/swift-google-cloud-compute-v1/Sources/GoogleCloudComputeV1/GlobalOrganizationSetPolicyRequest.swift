...
// limitations under the License.
  ...
  public struct GlobalOrganizationSetPolicyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `GlobalOrganizationSetPolicyRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = GlobalOrganizationSetPolicyRequest().with { $0.bindings = ... }
    /// ```
