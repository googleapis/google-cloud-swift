...
// limitations under the License.
  ...
  extension Clients {
    final class RegionDiskTypesTransport: RegionDiskTypesStub {
      ...
      public func `get`(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path =
              "/compute/v1/projects/\(pathVariable0)/regions/\(pathVariable1)/diskTypes/\(pathVariable2)"
            let query = [
      ...
      public func list(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/compute/v1/projects/\(pathVariable0)/regions/\(pathVariable1)/diskTypes"
            var query = [
              URLQueryItem(name: "$alt", value: "json")
            ]
