...
// limitations under the License.
  ...
  public struct SecurityPolicyUserDefinedField: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = SecurityPolicyUserDefinedField().with { $0.base = ... }
    /// ```
    ...
    ///
    /// [google.cloud.compute.v1.SecurityPolicyUserDefinedField.base]: <doc:SecurityPolicyUserDefinedField/Base>
    ///
    ...
    ///   them to named cases.
    public enum Base: Codable, Equatable, Hashable, Sendable {
      case ipv4
      case ipv6
      case tcp
      case udp
      ...
      ///
      /// If the value is unknown, this initializes to [`unknownStringValue`](doc:Base/unknownStringValue(_:)).
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.SecurityPolicyUserDefinedField"
    }
