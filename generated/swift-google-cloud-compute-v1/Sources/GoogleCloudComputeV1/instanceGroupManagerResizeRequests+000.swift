...
// limitations under the License.
  ...
  @available(
    *, unavailable,
    message:
      "Enable the 'InstanceGroupManagerResizeRequests' trait in Package.swift to use this client."
  )
  public final class InstanceGroupManagerResizeRequestsClient: Sendable {
    @available(
      *, unavailable,
      message:
        "Enable the 'InstanceGroupManagerResizeRequests' trait in Package.swift to use this client."
