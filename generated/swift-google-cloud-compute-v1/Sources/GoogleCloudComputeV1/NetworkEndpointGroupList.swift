...
// limitations under the License.
  ...
  public struct NetworkEndpointGroupList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [NetworkEndpointGroup] = []
    ...
    public var warning: NetworkEndpointGroupList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `NetworkEndpointGroupList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = NetworkEndpointGroupList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([NetworkEndpointGroup].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        NetworkEndpointGroupList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.NetworkEndpointGroupList.warning] field.
    ///
    /// [google.cloud.compute.v1.NetworkEndpointGroupList.warning]: <doc:NetworkEndpointGroupList/Warning>
      ...
      Sendable
    {
      ...
      public var code: NetworkEndpointGroupList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [NetworkEndpointGroupList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          NetworkEndpointGroupList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [NetworkEndpointGroupList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.NetworkEndpointGroupList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.NetworkEndpointGroupList.warning.data]: <doc:NetworkEndpointGroupList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.NetworkEndpointGroupList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.NetworkEndpointGroupList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.NetworkEndpointGroupList.warning.code]: <doc:NetworkEndpointGroupList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.NetworkEndpointGroupList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.NetworkEndpointGroupList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension NetworkEndpointGroupList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [NetworkEndpointGroup] {
      return self.items
    }
