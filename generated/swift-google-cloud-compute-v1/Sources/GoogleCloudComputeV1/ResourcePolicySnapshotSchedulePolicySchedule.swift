...
// limitations under the License.
  ...
  public struct ResourcePolicySnapshotSchedulePolicySchedule: Codable, Equatable, GoogleWKT
    ...
    Sendable
  {
    public var dailySchedule: ResourcePolicyDailyCycle? = nil

    public var hourlySchedule: ResourcePolicyHourlyCycle? = nil
    ...
    ///
    /// ```
    /// let value = ResourcePolicySnapshotSchedulePolicySchedule().with { $0.dailySchedule = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return
        "type.googleapis.com/google.cloud.compute.v1.ResourcePolicySnapshotSchedulePolicySchedule"
    }
