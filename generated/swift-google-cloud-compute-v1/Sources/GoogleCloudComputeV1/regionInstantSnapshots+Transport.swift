...
// limitations under the License.
  ...
  extension Clients {
    final class RegionInstantSnapshotsTransport: RegionInstantSnapshotsStub {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            guard
              let pathVariable2 = try GoogleGax._RoutingMatcher.pathValue(
                request.instantSnapshot as Swift.String?,
                matching: [.singleWildcard],
                fieldName: "instantSnapshot")
            else {
              return nil
            }
            let path =
              "/compute/v1/projects/\(pathVariable0)/regions/\(pathVariable1)/instantSnapshots/\(pathVariable2)"
            var query = [
      ...
      public func getIamPolicy(
        request: RegionInstantSnapshotsClient.GetIamPolicyRequest, options: GoogleGax.RequestOptions
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path =
              "/compute/v1/projects/\(pathVariable0)/regions/\(pathVariable1)/instantSnapshots/\(pathVariable2)/getIamPolicy"
            var query = [
              URLQueryItem(name: "$alt", value: "json")
            ]
            let encoder = GoogleGax._QueryParameterEncoder()
      ...
      public func insert(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path =
              "/compute/v1/projects/\(pathVariable0)/regions/\(pathVariable1)/instantSnapshots"
            var query = [
              URLQueryItem(name: "$alt", value: "json")
            ]
            let encoder = GoogleGax._QueryParameterEncoder()
      ...
      public func setIamPolicy(
        request: RegionInstantSnapshotsClient.SetIamPolicyRequest, options: GoogleGax.RequestOptions
      ) async throws -> GoogleCloudComputeV1.Policy {
        let (path, query, configure) = try {
          () throws -> (Swift.String, [URLQueryItem], (inout GoogleGax._HTTPClientRequest) -> Void)
          in
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path =
              "/compute/v1/projects/\(pathVariable0)/regions/\(pathVariable1)/instantSnapshots/\(pathVariable2)/setIamPolicy"
            let query = [
              URLQueryItem(name: "$alt", value: "json")
            ]
            return (path, query)
      ...
      public func setLabels(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path =
              "/compute/v1/projects/\(pathVariable0)/regions/\(pathVariable1)/instantSnapshots/\(pathVariable2)/setLabels"
            var query = [
              URLQueryItem(name: "$alt", value: "json")
            ]
            let encoder = GoogleGax._QueryParameterEncoder()
      ...
      public func testIamPermissions(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path =
              "/compute/v1/projects/\(pathVariable0)/regions/\(pathVariable1)/instantSnapshots/\(pathVariable2)/testIamPermissions"
            let query = [
              URLQueryItem(name: "$alt", value: "json")
            ]
            return (path, query)
