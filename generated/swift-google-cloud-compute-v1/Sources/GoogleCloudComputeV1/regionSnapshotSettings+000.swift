...
// limitations under the License.
  ...
  public final class RegionSnapshotSettingsClient: Clients.RegionSnapshotSettingsProtocol, Sendable
  {
    ...
    /// @Snippet(path: "regionSnapshotSettings_patch")
    public func patch(
      withPolling: RegionSnapshotSettingsClient.PatchRequest, options: GoogleGax.RequestOptions
  ...
  @available(
    *, unavailable,
    message: "Enable the 'RegionSnapshotSettings' trait in Package.swift to use this client."
  )
  public final class RegionSnapshotSettingsClient: Sendable {
    @available(
      *, unavailable,
      message: "Enable the 'RegionSnapshotSettings' trait in Package.swift to use this client."
    )
