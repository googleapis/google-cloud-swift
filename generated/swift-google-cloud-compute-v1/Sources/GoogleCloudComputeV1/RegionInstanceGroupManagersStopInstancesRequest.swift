...
// limitations under the License.
  ...
  public struct RegionInstanceGroupManagersStopInstancesRequest: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `RegionInstanceGroupManagersStopInstancesRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RegionInstanceGroupManagersStopInstancesRequest().with { $0.forceStop = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let forceStop = CodingKeys(stringValue: "forceStop")
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.forceStop = try container.decodeIfPresent(Swift.Bool.self, forKey: .forceStop)
