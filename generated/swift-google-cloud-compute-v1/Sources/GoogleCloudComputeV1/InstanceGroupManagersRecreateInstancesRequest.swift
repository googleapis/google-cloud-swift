...
// limitations under the License.
  ...
  public struct InstanceGroupManagersRecreateInstancesRequest: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `InstanceGroupManagersRecreateInstancesRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstanceGroupManagersRecreateInstancesRequest().with { $0.instances = ... }
    /// ```
