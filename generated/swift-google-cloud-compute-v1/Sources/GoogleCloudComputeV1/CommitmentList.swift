...
// limitations under the License.
  ...
  public struct CommitmentList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: CommitmentList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `CommitmentList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = CommitmentList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Commitment].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(CommitmentList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.CommitmentList.warning] field.
    ///
    /// [google.cloud.compute.v1.CommitmentList.warning]: <doc:CommitmentList/Warning>
      ...
      Sendable
    {
      ...
      public var code: CommitmentList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [CommitmentList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(CommitmentList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [CommitmentList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.CommitmentList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.CommitmentList.warning.data]: <doc:CommitmentList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.CommitmentList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.CommitmentList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.CommitmentList.warning.code]: <doc:CommitmentList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.CommitmentList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.CommitmentList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension CommitmentList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [Commitment] {
      return self.items
    }
