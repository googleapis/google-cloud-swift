...
// limitations under the License.
  ...
  public struct RegionInstanceGroupList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: RegionInstanceGroupList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `RegionInstanceGroupList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RegionInstanceGroupList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([InstanceGroup].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        RegionInstanceGroupList.Warning.self, forKey: .warning)
    ...
    ///
    /// [google.cloud.compute.v1.RegionInstanceGroupList.warning]: <doc:RegionInstanceGroupList/Warning>
      ...
      Sendable
    {
      ...
      public var code: RegionInstanceGroupList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [RegionInstanceGroupList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          RegionInstanceGroupList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [RegionInstanceGroupList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      ///
      /// [google.cloud.compute.v1.RegionInstanceGroupList.warning.data]: <doc:RegionInstanceGroupList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.RegionInstanceGroupList.warning.data"
        }
      ...
      ///
      /// [google.cloud.compute.v1.RegionInstanceGroupList.warning.code]: <doc:RegionInstanceGroupList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.RegionInstanceGroupList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.RegionInstanceGroupList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension RegionInstanceGroupList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [InstanceGroup] {
      return self.items
    }
