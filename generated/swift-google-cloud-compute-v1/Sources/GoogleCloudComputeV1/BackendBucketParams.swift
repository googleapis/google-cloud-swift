...
// limitations under the License.
  ...
  public struct BackendBucketParams: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `BackendBucketParams`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = BackendBucketParams().with { $0.resourceManagerTags = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.BackendBucketParams"
    }
