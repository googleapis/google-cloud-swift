...
// limitations under the License.
  ...
  public struct HelpLink: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `HelpLink`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = HelpLink().with { $0.description = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.HelpLink"
    }
