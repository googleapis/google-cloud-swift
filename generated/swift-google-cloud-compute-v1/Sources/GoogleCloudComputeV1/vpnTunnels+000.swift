...
// limitations under the License.
  ...
  public final class VpnTunnelsClient: Clients.VpnTunnelsProtocol, Sendable {
    ...
    /// @Snippet(path: "vpnTunnels_delete")
    public func delete(
      withPolling: VpnTunnelsClient.DeleteRequest, options: GoogleGax.RequestOptions
    ...
    /// @Snippet(path: "vpnTunnels_insert")
    public func insert(
      withPolling: VpnTunnelsClient.InsertRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
    ...
    /// @Snippet(path: "vpnTunnels_setLabels")
    public func setLabels(
      withPolling: VpnTunnelsClient.SetLabelsRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
  ...
  extension Clients {
    ...
    public protocol VpnTunnelsProtocol: Sendable {
  ...
  extension Clients.VpnTunnelsProtocol {
    ...
    ) -> any AsyncSequence<(Swift.String, VpnTunnelsScopedList), Swift.Error> {
    ...
    /// @Snippet(path: "vpnTunnels_aggregatedList")
    public func aggregatedList(
      byItem: VpnTunnelsClient.AggregatedListRequest, options: GoogleGax.RequestOptions
    ) -> any AsyncSequence<(Swift.String, VpnTunnelsScopedList), Swift.Error> {
      let listRpc = {
    ...
    ) -> any AsyncSequence<VpnTunnel, Swift.Error> {
    ...
    /// @Snippet(path: "vpnTunnels_list")
    public func list(
      byItem: VpnTunnelsClient.ListRequest, options: GoogleGax.RequestOptions
    ) -> any AsyncSequence<VpnTunnel, Swift.Error> {
  ...
  @available(
    *, unavailable, message: "Enable the 'VpnTunnels' trait in Package.swift to use this client."
  )
  public final class VpnTunnelsClient: Sendable {
    @available(
      *, unavailable, message: "Enable the 'VpnTunnels' trait in Package.swift to use this client."
    )
    public init(_ options: GoogleGax.ClientOptions = .init()) throws {}
