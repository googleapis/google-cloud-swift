...
// limitations under the License.
  ...
  extension Clients {
    ...
    public protocol RegionDiskTypesProtocol: Sendable {
  ...
  @available(
    *, unavailable,
    message: "Enable the 'RegionDiskTypes' trait in Package.swift to use this client."
  )
  public final class RegionDiskTypesClient: Sendable {
    @available(
      *, unavailable,
      message: "Enable the 'RegionDiskTypes' trait in Package.swift to use this client."
    )
