...
// limitations under the License.
  ...
  public struct LicenseParams: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `LicenseParams`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = LicenseParams().with { $0.resourceManagerTags = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.LicenseParams"
    }
