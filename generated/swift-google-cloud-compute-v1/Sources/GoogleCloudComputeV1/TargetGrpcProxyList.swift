...
// limitations under the License.
  ...
  public struct TargetGrpcProxyList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [TargetGrpcProxy] = []
    ...
    public var warning: TargetGrpcProxyList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `TargetGrpcProxyList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = TargetGrpcProxyList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([TargetGrpcProxy].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        TargetGrpcProxyList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.TargetGrpcProxyList.warning] field.
    ///
    /// [google.cloud.compute.v1.TargetGrpcProxyList.warning]: <doc:TargetGrpcProxyList/Warning>
      ...
      Sendable
    {
      ...
      public var code: TargetGrpcProxyList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [TargetGrpcProxyList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          TargetGrpcProxyList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [TargetGrpcProxyList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.TargetGrpcProxyList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.TargetGrpcProxyList.warning.data]: <doc:TargetGrpcProxyList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.TargetGrpcProxyList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.TargetGrpcProxyList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.TargetGrpcProxyList.warning.code]: <doc:TargetGrpcProxyList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.TargetGrpcProxyList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.TargetGrpcProxyList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension TargetGrpcProxyList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [TargetGrpcProxy] {
      return self.items
    }
