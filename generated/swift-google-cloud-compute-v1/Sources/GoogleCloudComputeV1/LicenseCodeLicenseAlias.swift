...
// limitations under the License.
  ...
  public struct LicenseCodeLicenseAlias: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `LicenseCodeLicenseAlias`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = LicenseCodeLicenseAlias().with { $0.description = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.LicenseCodeLicenseAlias"
    }
