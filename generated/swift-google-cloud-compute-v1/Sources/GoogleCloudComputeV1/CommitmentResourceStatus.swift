...
// limitations under the License.
    ...
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = CommitmentResourceStatus().with { $0.customTermEligibilityEndTimestamp = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let customTermEligibilityEndTimestamp = CodingKeys(
        stringValue: "customTermEligibilityEndTimestamp")
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.customTermEligibilityEndTimestamp = try container.decodeIfPresent(
        Swift.String.self, forKey: .customTermEligibilityEndTimestamp)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encodeIfPresent(
        self.customTermEligibilityEndTimestamp, forKey: .customTermEligibilityEndTimestamp)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.CommitmentResourceStatus"
    }
