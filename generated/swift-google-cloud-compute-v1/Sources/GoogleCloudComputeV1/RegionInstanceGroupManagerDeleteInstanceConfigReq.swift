...
// limitations under the License.
  ...
  public struct RegionInstanceGroupManagerDeleteInstanceConfigReq: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `RegionInstanceGroupManagerDeleteInstanceConfigReq`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RegionInstanceGroupManagerDeleteInstanceConfigReq().with { $0.names = ... }
    /// ```
