...
// limitations under the License.
  ...
  public struct TargetVpnGatewaysScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: TargetVpnGatewaysScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `TargetVpnGatewaysScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = TargetVpnGatewaysScopedList().with { $0.targetVpnGateways = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let targetVpnGateways = CodingKeys(stringValue: "targetVpnGateways")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [TargetVpnGateway].self, forKey: .targetVpnGateways)
      {
        self.targetVpnGateways = value
      }
      self.warning = try container.decodeIfPresent(
        TargetVpnGatewaysScopedList.Warning.self, forKey: .warning)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.targetVpnGateways, forKey: .targetVpnGateways)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.TargetVpnGatewaysScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.TargetVpnGatewaysScopedList.warning]: <doc:TargetVpnGatewaysScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: TargetVpnGatewaysScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [TargetVpnGatewaysScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          TargetVpnGatewaysScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [TargetVpnGatewaysScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.TargetVpnGatewaysScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.TargetVpnGatewaysScopedList.warning.data]: <doc:TargetVpnGatewaysScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.TargetVpnGatewaysScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.TargetVpnGatewaysScopedList.warning.code] field.
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.TargetVpnGatewaysScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.TargetVpnGatewaysScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
