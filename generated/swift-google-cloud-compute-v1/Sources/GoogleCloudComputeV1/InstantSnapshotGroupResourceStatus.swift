...
// limitations under the License.
  ...
  public struct InstantSnapshotGroupResourceStatus: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// Output only. [Output Only]
    public var consistencyMembershipResolutionTime: GoogleWKT.WKTTimestamp? = nil
    ...
    ///
    /// ```
    /// let value = InstantSnapshotGroupResourceStatus().with { $0.consistencyMembershipResolutionTime = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.consistencyMembershipResolutionTime = try container.decodeIfPresent(
        GoogleWKT.WKTTimestamp.self, forKey: .consistencyMembershipResolutionTime)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InstantSnapshotGroupResourceStatus"
    }
