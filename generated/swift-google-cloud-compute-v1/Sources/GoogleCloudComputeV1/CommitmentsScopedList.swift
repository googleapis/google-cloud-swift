...
// limitations under the License.
  ...
  public struct CommitmentsScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: CommitmentsScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `CommitmentsScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = CommitmentsScopedList().with { $0.commitments = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let commitments = CodingKeys(stringValue: "commitments")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Commitment].self, forKey: .commitments) {
        self.commitments = value
      }
      self.warning = try container.decodeIfPresent(
        CommitmentsScopedList.Warning.self, forKey: .warning)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.commitments, forKey: .commitments)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.CommitmentsScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.CommitmentsScopedList.warning]: <doc:CommitmentsScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: CommitmentsScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [CommitmentsScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          CommitmentsScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [CommitmentsScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.CommitmentsScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.CommitmentsScopedList.warning.data]: <doc:CommitmentsScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.CommitmentsScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.CommitmentsScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.CommitmentsScopedList.warning.code]: <doc:CommitmentsScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.CommitmentsScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.CommitmentsScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
