...
// limitations under the License.
  ...
  public final class RegionSslPoliciesClient: Clients.RegionSslPoliciesProtocol, Sendable {
    ...
    /// @Snippet(path: "regionSslPolicies_delete")
    public func delete(
      withPolling: RegionSslPoliciesClient.DeleteRequest, options: GoogleGax.RequestOptions
    ...
    /// @Snippet(path: "regionSslPolicies_insert")
    public func insert(
      withPolling: RegionSslPoliciesClient.InsertRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
    ...
    /// @Snippet(path: "regionSslPolicies_patch")
    public func patch(
      withPolling: RegionSslPoliciesClient.PatchRequest, options: GoogleGax.RequestOptions
    ) async throws -> any GoogleGax.PollableOperation<GoogleCloudComputeV1.Operation> {
      let extractStatus = {
        (op: GoogleCloudComputeV1.Operation) throws
          -> GoogleGax._PollableOperationImpl<GoogleCloudComputeV1.Operation>.State in
