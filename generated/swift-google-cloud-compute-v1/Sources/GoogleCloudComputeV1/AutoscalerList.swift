...
// limitations under the License.
  ...
  public struct AutoscalerList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: AutoscalerList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `AutoscalerList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = AutoscalerList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.warning = try container.decodeIfPresent(AutoscalerList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.AutoscalerList.warning] field.
    ///
    /// [google.cloud.compute.v1.AutoscalerList.warning]: <doc:AutoscalerList/Warning>
      ...
      Sendable
    {
      ...
      public var code: AutoscalerList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [AutoscalerList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(AutoscalerList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [AutoscalerList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.AutoscalerList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.AutoscalerList.warning.data]: <doc:AutoscalerList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.AutoscalerList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.AutoscalerList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.AutoscalerList.warning.code]: <doc:AutoscalerList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.AutoscalerList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.AutoscalerList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension AutoscalerList: GoogleGax._PaginatedResponse {
