...
// limitations under the License.
  ...
  public struct NetworkEndpointGroupAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: NetworkEndpointGroupsScopedList] = [:]
    ...
    public var warning: NetworkEndpointGroupAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `NetworkEndpointGroupAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = NetworkEndpointGroupAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: NetworkEndpointGroupsScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        NetworkEndpointGroupAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.NetworkEndpointGroupAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.NetworkEndpointGroupAggregatedList.warning]: <doc:NetworkEndpointGroupAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: NetworkEndpointGroupAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [NetworkEndpointGroupAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          NetworkEndpointGroupAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [NetworkEndpointGroupAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.NetworkEndpointGroupAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.NetworkEndpointGroupAggregatedList.warning.data]: <doc:NetworkEndpointGroupAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.NetworkEndpointGroupAggregatedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.NetworkEndpointGroupAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.NetworkEndpointGroupAggregatedList.warning.code]: <doc:NetworkEndpointGroupAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return
          "type.googleapis.com/google.cloud.compute.v1.NetworkEndpointGroupAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.NetworkEndpointGroupAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension NetworkEndpointGroupAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, NetworkEndpointGroupsScopedList)] {
