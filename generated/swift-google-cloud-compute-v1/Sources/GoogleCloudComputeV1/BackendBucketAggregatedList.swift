...
// limitations under the License.
  ...
  public struct BackendBucketAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: BackendBucketsScopedList] = [:]
    ...
    public var warning: BackendBucketAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `BackendBucketAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = BackendBucketAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: BackendBucketsScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        BackendBucketAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.BackendBucketAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.BackendBucketAggregatedList.warning]: <doc:BackendBucketAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: BackendBucketAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [BackendBucketAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          BackendBucketAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [BackendBucketAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.BackendBucketAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.BackendBucketAggregatedList.warning.data]: <doc:BackendBucketAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.BackendBucketAggregatedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.BackendBucketAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.BackendBucketAggregatedList.warning.code]: <doc:BackendBucketAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.BackendBucketAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.BackendBucketAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension BackendBucketAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, BackendBucketsScopedList)] {
