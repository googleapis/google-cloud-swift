...
// limitations under the License.
  ...
  public struct PacketMirroringsScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// A list of packetMirrorings contained in this scope.
    public var packetMirrorings: [PacketMirroring] = []

    /// Informational warning which replaces the list of packetMirrorings when the
    /// list is empty.
    public var warning: PacketMirroringsScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `PacketMirroringsScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = PacketMirroringsScopedList().with { $0.packetMirrorings = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let packetMirrorings = CodingKeys(stringValue: "packetMirrorings")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [PacketMirroring].self, forKey: .packetMirrorings)
      {
        self.packetMirrorings = value
      }
      self.warning = try container.decodeIfPresent(
        PacketMirroringsScopedList.Warning.self, forKey: .warning)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.packetMirrorings, forKey: .packetMirrorings)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.PacketMirroringsScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.PacketMirroringsScopedList.warning]: <doc:PacketMirroringsScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: PacketMirroringsScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [PacketMirroringsScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          PacketMirroringsScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [PacketMirroringsScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.PacketMirroringsScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.PacketMirroringsScopedList.warning.data]: <doc:PacketMirroringsScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.PacketMirroringsScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.PacketMirroringsScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.PacketMirroringsScopedList.warning.code]: <doc:PacketMirroringsScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.PacketMirroringsScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.PacketMirroringsScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
