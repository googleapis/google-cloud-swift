...
// limitations under the License.
  ...
  public struct UrlMapsScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// A list of UrlMaps contained in this scope.
    public var urlMaps: [UrlMap] = []

    /// Informational warning which replaces the list of
    /// backend services when the list is empty.
    public var warning: UrlMapsScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `UrlMapsScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = UrlMapsScopedList().with { $0.urlMaps = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let urlMaps = CodingKeys(stringValue: "urlMaps")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([UrlMap].self, forKey: .urlMaps) {
        self.urlMaps = value
      }
      self.warning = try container.decodeIfPresent(UrlMapsScopedList.Warning.self, forKey: .warning)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.urlMaps, forKey: .urlMaps)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.UrlMapsScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.UrlMapsScopedList.warning]: <doc:UrlMapsScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: UrlMapsScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [UrlMapsScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          UrlMapsScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [UrlMapsScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.UrlMapsScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.UrlMapsScopedList.warning.data]: <doc:UrlMapsScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.UrlMapsScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.UrlMapsScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.UrlMapsScopedList.warning.code]: <doc:UrlMapsScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.UrlMapsScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.UrlMapsScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
