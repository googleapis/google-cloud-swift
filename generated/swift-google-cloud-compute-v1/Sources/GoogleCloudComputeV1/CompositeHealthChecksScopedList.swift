...
// limitations under the License.
  ...
  public struct CompositeHealthChecksScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// A list of CompositeHealthChecks contained in this scope.
    public var compositeHealthChecks: [CompositeHealthCheck] = []

    /// Informational warning which replaces the list of composite health checks
    /// when the list is empty.
    public var warning: CompositeHealthChecksScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `CompositeHealthChecksScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = CompositeHealthChecksScopedList().with { $0.compositeHealthChecks = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let compositeHealthChecks = CodingKeys(stringValue: "compositeHealthChecks")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [CompositeHealthCheck].self, forKey: .compositeHealthChecks)
      {
        self.compositeHealthChecks = value
      }
      self.warning = try container.decodeIfPresent(
        CompositeHealthChecksScopedList.Warning.self, forKey: .warning)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.compositeHealthChecks, forKey: .compositeHealthChecks)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.CompositeHealthChecksScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.CompositeHealthChecksScopedList.warning]: <doc:CompositeHealthChecksScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: CompositeHealthChecksScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [CompositeHealthChecksScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          CompositeHealthChecksScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [CompositeHealthChecksScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.CompositeHealthChecksScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.CompositeHealthChecksScopedList.warning.data]: <doc:CompositeHealthChecksScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.CompositeHealthChecksScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.CompositeHealthChecksScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.CompositeHealthChecksScopedList.warning.code]: <doc:CompositeHealthChecksScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.CompositeHealthChecksScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.CompositeHealthChecksScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
