...
// limitations under the License.
  ...
  public struct InstanceGroupManagersSuspendInstancesRequest: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `InstanceGroupManagersSuspendInstancesRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstanceGroupManagersSuspendInstancesRequest().with { $0.forceSuspend = ... }
    /// ```
