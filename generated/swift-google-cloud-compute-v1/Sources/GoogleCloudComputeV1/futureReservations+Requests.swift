...
// limitations under the License.
  ...
  extension FutureReservationsClient {
      ...
      Sendable
    {
      ...
      public var futureReservation: Swift.String = Swift.String()
      ...
      ///
      /// ```
      /// let value = CancelRequest().with { $0.futureReservation = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      private struct CodingKeys: CodingKey {
        ...
        static let futureReservation = CodingKeys(stringValue: "futureReservation")
        static let project = CodingKeys(stringValue: "project")
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        if let value = try container.decodeIfPresent(Swift.String.self, forKey: .futureReservation)
        {
          self.futureReservation = value
        }
        if let value = try container.decodeIfPresent(Swift.String.self, forKey: .project) {
          self.project = value
        }
      ...
      public func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: CodingKeys.self)
        try container.encode(self.futureReservation, forKey: .futureReservation)
        try container.encode(self.project, forKey: .project)
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = DeleteRequest().with { $0.futureReservation = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = GetRequest().with { $0.futureReservation = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      Sendable
    {
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.body = try container.decodeIfPresent(FutureReservation.self, forKey: .body)
        for key in container.allKeys where !CodingKeys._knownKeys.contains(key.stringValue) {
          self._unknownFields.json[key.stringValue] = try container.decode(
            GoogleWKT.WKTValue.self, forKey: key)
        }
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = UpdateRequest().with { $0.futureReservation = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
