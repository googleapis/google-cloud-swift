...
// limitations under the License.
  ...
  public struct PacketMirroringAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: PacketMirroringsScopedList] = [:]
    ...
    public var warning: PacketMirroringAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `PacketMirroringAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = PacketMirroringAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: PacketMirroringsScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        PacketMirroringAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.PacketMirroringAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.PacketMirroringAggregatedList.warning]: <doc:PacketMirroringAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: PacketMirroringAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [PacketMirroringAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          PacketMirroringAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [PacketMirroringAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.PacketMirroringAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.PacketMirroringAggregatedList.warning.data]: <doc:PacketMirroringAggregatedList/Warning/Data>
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.PacketMirroringAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.PacketMirroringAggregatedList.warning.code]: <doc:PacketMirroringAggregatedList/Warning/Code>
      ///
  ...
  extension PacketMirroringAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, PacketMirroringsScopedList)] {
