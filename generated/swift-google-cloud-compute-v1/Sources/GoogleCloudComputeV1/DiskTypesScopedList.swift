...
// limitations under the License.
  ...
  public struct DiskTypesScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: DiskTypesScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `DiskTypesScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DiskTypesScopedList().with { $0.diskTypes = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let diskTypes = CodingKeys(stringValue: "diskTypes")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([DiskType].self, forKey: .diskTypes) {
        self.diskTypes = value
      }
      self.warning = try container.decodeIfPresent(
        DiskTypesScopedList.Warning.self, forKey: .warning)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.diskTypes, forKey: .diskTypes)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.DiskTypesScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.DiskTypesScopedList.warning]: <doc:DiskTypesScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: DiskTypesScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [DiskTypesScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          DiskTypesScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [DiskTypesScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.DiskTypesScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.DiskTypesScopedList.warning.data]: <doc:DiskTypesScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.DiskTypesScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.DiskTypesScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.DiskTypesScopedList.warning.code]: <doc:DiskTypesScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.DiskTypesScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.DiskTypesScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
