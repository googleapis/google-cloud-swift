...
// limitations under the License.
    ...
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = SnapshotSettingsAccessLocation().with { $0.locations = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: SnapshotSettingsAccessLocationAccessLocationPreference].self,
        forKey: .locations)
      {
    ...
    /// The enumerated type for the [policy][google.cloud.compute.v1.SnapshotSettingsAccessLocation.policy] field.
    ///
    ...
    public enum Policy: Codable, Equatable, Sendable {
      ...
      public var stringValue: Swift.String? {
        ...
        case .specificRegions: return "SPECIFIC_REGIONS"
      ...
      public init(stringValue: Swift.String) {
        ...
        case "SPECIFIC_REGIONS": self = .specificRegions
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        case .specificRegions: return try container.encode("SPECIFIC_REGIONS")
