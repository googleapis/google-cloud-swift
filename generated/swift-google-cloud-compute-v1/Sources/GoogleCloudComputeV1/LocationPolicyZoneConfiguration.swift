...
// limitations under the License.
  ...
  public struct LocationPolicyZoneConfiguration: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// The URL of the zone.
    ...
    ///
    /// ```
    /// let value = LocationPolicyZoneConfiguration().with { $0.zone = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.LocationPolicyZoneConfiguration"
    }
