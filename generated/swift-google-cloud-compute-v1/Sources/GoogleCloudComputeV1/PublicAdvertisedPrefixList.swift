...
// limitations under the License.
  ...
  public struct PublicAdvertisedPrefixList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [PublicAdvertisedPrefix] = []
    ...
    public var warning: PublicAdvertisedPrefixList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `PublicAdvertisedPrefixList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = PublicAdvertisedPrefixList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([PublicAdvertisedPrefix].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        PublicAdvertisedPrefixList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.PublicAdvertisedPrefixList.warning] field.
    ///
    /// [google.cloud.compute.v1.PublicAdvertisedPrefixList.warning]: <doc:PublicAdvertisedPrefixList/Warning>
      ...
      Sendable
    {
      ...
      public var code: PublicAdvertisedPrefixList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [PublicAdvertisedPrefixList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          PublicAdvertisedPrefixList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [PublicAdvertisedPrefixList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.PublicAdvertisedPrefixList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.PublicAdvertisedPrefixList.warning.data]: <doc:PublicAdvertisedPrefixList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.PublicAdvertisedPrefixList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.PublicAdvertisedPrefixList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.PublicAdvertisedPrefixList.warning.code]: <doc:PublicAdvertisedPrefixList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.PublicAdvertisedPrefixList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.PublicAdvertisedPrefixList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension PublicAdvertisedPrefixList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [PublicAdvertisedPrefix] {
      return self.items
    }
