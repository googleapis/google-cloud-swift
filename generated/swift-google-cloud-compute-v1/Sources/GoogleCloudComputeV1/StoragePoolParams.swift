...
// limitations under the License.
  ...
  public struct StoragePoolParams: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `StoragePoolParams`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = StoragePoolParams().with { $0.resourceManagerTags = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.StoragePoolParams"
    }
