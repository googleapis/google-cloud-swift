...
// limitations under the License.
  ...
  public struct RegionInstanceGroupManagersRecreateRequest: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `RegionInstanceGroupManagersRecreateRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RegionInstanceGroupManagersRecreateRequest().with { $0.instances = ... }
    /// ```
