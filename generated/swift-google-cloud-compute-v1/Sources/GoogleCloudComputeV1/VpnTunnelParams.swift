...
// limitations under the License.
  ...
  public struct VpnTunnelParams: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `VpnTunnelParams`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = VpnTunnelParams().with { $0.resourceManagerTags = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.VpnTunnelParams"
    }
