...
// limitations under the License.
  ...
  public struct NodeTypeList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: NodeTypeList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `NodeTypeList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = NodeTypeList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([NodeType].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(NodeTypeList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.NodeTypeList.warning] field.
    ///
    /// [google.cloud.compute.v1.NodeTypeList.warning]: <doc:NodeTypeList/Warning>
      ...
      Sendable
    {
      ...
      public var code: NodeTypeList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [NodeTypeList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(NodeTypeList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [NodeTypeList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.NodeTypeList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.NodeTypeList.warning.data]: <doc:NodeTypeList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.NodeTypeList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.NodeTypeList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.NodeTypeList.warning.code]: <doc:NodeTypeList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.NodeTypeList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.NodeTypeList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension NodeTypeList: GoogleGax._PaginatedResponse {
