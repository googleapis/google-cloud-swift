...
// limitations under the License.
  ...
  public struct AddressAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: AddressesScopedList] = [:]
    ...
    public var warning: AddressAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `AddressAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = AddressAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: AddressesScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        AddressAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.AddressAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.AddressAggregatedList.warning]: <doc:AddressAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: AddressAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [AddressAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          AddressAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [AddressAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.AddressAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.AddressAggregatedList.warning.data]: <doc:AddressAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.AddressAggregatedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.AddressAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.AddressAggregatedList.warning.code]: <doc:AddressAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.AddressAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.AddressAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension AddressAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, AddressesScopedList)] {
