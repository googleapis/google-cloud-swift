...
// limitations under the License.
  ...
  public struct TargetVpnGatewayList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: TargetVpnGatewayList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `TargetVpnGatewayList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = TargetVpnGatewayList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([TargetVpnGateway].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        TargetVpnGatewayList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.TargetVpnGatewayList.warning] field.
    ///
    /// [google.cloud.compute.v1.TargetVpnGatewayList.warning]: <doc:TargetVpnGatewayList/Warning>
      ...
      Sendable
    {
      ...
      public var code: TargetVpnGatewayList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [TargetVpnGatewayList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          TargetVpnGatewayList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [TargetVpnGatewayList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.TargetVpnGatewayList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.TargetVpnGatewayList.warning.data]: <doc:TargetVpnGatewayList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.TargetVpnGatewayList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.TargetVpnGatewayList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.TargetVpnGatewayList.warning.code]: <doc:TargetVpnGatewayList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.TargetVpnGatewayList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.TargetVpnGatewayList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension TargetVpnGatewayList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [TargetVpnGateway] {
      return self.items
    }
