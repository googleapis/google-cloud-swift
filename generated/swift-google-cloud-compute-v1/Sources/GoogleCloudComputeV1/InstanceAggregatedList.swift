...
// limitations under the License.
  ...
  public struct InstanceAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: InstancesScopedList] = [:]
    ...
    public var warning: InstanceAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `InstanceAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstanceAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: InstancesScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        InstanceAggregatedList.Warning.self, forKey: .warning)
    ...
    ///
    /// [google.cloud.compute.v1.InstanceAggregatedList.warning]: <doc:InstanceAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: InstanceAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [InstanceAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          InstanceAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [InstanceAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      ///
      /// [google.cloud.compute.v1.InstanceAggregatedList.warning.data]: <doc:InstanceAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.InstanceAggregatedList.warning.data"
        }
      ...
      ///
      /// [google.cloud.compute.v1.InstanceAggregatedList.warning.code]: <doc:InstanceAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.InstanceAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InstanceAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension InstanceAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, InstancesScopedList)] {
