...
// limitations under the License.
  ...
  public struct HealthCheckServicesScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// A list of HealthCheckServices contained in this scope.
    public var resources: [HealthCheckService] = []

    /// Informational warning which replaces the list of
    /// backend services when the list is empty.
    public var warning: HealthCheckServicesScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `HealthCheckServicesScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = HealthCheckServicesScopedList().with { $0.resources = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([HealthCheckService].self, forKey: .resources) {
        self.resources = value
      }
      self.warning = try container.decodeIfPresent(
        HealthCheckServicesScopedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.HealthCheckServicesScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.HealthCheckServicesScopedList.warning]: <doc:HealthCheckServicesScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: HealthCheckServicesScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [HealthCheckServicesScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          HealthCheckServicesScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [HealthCheckServicesScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.HealthCheckServicesScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.HealthCheckServicesScopedList.warning.data]: <doc:HealthCheckServicesScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.HealthCheckServicesScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.HealthCheckServicesScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.HealthCheckServicesScopedList.warning.code]: <doc:HealthCheckServicesScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.HealthCheckServicesScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.HealthCheckServicesScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
