...
// limitations under the License.
  ...
  public struct FirewallList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: FirewallList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `FirewallList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = FirewallList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Firewall].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(FirewallList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.FirewallList.warning] field.
    ///
    /// [google.cloud.compute.v1.FirewallList.warning]: <doc:FirewallList/Warning>
      ...
      Sendable
    {
      ...
      public var code: FirewallList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [FirewallList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(FirewallList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [FirewallList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.FirewallList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.FirewallList.warning.data]: <doc:FirewallList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.FirewallList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.FirewallList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.FirewallList.warning.code]: <doc:FirewallList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.FirewallList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.FirewallList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension FirewallList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [Firewall] {
      return self.items
    }
