...
// limitations under the License.
  ...
  extension NetworkEdgeSecurityServicesClient {
      ...
      Sendable
    {
      ...
      public var networkEdgeSecurityService: Swift.String = Swift.String()
      ...
      ///
      /// ```
      /// let value = DeleteRequest().with { $0.networkEdgeSecurityService = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      private struct CodingKeys: CodingKey {
        ...
        static let networkEdgeSecurityService = CodingKeys(
          stringValue: "networkEdgeSecurityService")
        static let project = CodingKeys(stringValue: "project")
      ...
      public init(from decoder: Decoder) throws {
        ...
        if let value = try container.decodeIfPresent(
          Swift.String.self, forKey: .networkEdgeSecurityService)
        {
          self.networkEdgeSecurityService = value
        }
        if let value = try container.decodeIfPresent(Swift.String.self, forKey: .project) {
          self.project = value
        }
      ...
      public func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: CodingKeys.self)
        try container.encode(self.networkEdgeSecurityService, forKey: .networkEdgeSecurityService)
        try container.encode(self.project, forKey: .project)
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = GetRequest().with { $0.networkEdgeSecurityService = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      Sendable
    {
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.body = try container.decodeIfPresent(NetworkEdgeSecurityService.self, forKey: .body)
        for key in container.allKeys where !CodingKeys._knownKeys.contains(key.stringValue) {
          self._unknownFields.json[key.stringValue] = try container.decode(
            GoogleWKT.WKTValue.self, forKey: key)
        }
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = PatchRequest().with { $0.networkEdgeSecurityService = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
