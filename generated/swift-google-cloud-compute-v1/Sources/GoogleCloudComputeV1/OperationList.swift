...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var warning: OperationList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `OperationList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = OperationList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.warning = try container.decodeIfPresent(OperationList.Warning.self, forKey: .warning)
    ...
    ///
    /// [google.cloud.compute.v1.OperationList.warning]: <doc:OperationList/Warning>
      ...
      Sendable
    {
      ...
      public var code: OperationList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [OperationList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(OperationList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [OperationList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      ///
      /// [google.cloud.compute.v1.OperationList.warning.data]: <doc:OperationList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.OperationList.warning.data"
        }
      ...
      ///
      /// [google.cloud.compute.v1.OperationList.warning.code]: <doc:OperationList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.OperationList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.OperationList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
