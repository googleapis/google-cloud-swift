...
// limitations under the License.
  ...
  public struct HealthCheckServiceAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: HealthCheckServicesScopedList] = [:]
    ...
    public var warning: HealthCheckServiceAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `HealthCheckServiceAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = HealthCheckServiceAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: HealthCheckServicesScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        HealthCheckServiceAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.HealthCheckServiceAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.HealthCheckServiceAggregatedList.warning]: <doc:HealthCheckServiceAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: HealthCheckServiceAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [HealthCheckServiceAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          HealthCheckServiceAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [HealthCheckServiceAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.HealthCheckServiceAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.HealthCheckServiceAggregatedList.warning.data]: <doc:HealthCheckServiceAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.HealthCheckServiceAggregatedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.HealthCheckServiceAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.HealthCheckServiceAggregatedList.warning.code]: <doc:HealthCheckServiceAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return
          "type.googleapis.com/google.cloud.compute.v1.HealthCheckServiceAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.HealthCheckServiceAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension HealthCheckServiceAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, HealthCheckServicesScopedList)] {
