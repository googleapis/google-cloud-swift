...
// limitations under the License.
  ...
  public struct InstanceGroupManagersScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// is empty.
    public var warning: InstanceGroupManagersScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `InstanceGroupManagersScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstanceGroupManagersScopedList().with { $0.instanceGroupManagers = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let instanceGroupManagers = CodingKeys(stringValue: "instanceGroupManagers")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [InstanceGroupManager].self, forKey: .instanceGroupManagers)
      {
        self.instanceGroupManagers = value
      }
      self.warning = try container.decodeIfPresent(
        InstanceGroupManagersScopedList.Warning.self, forKey: .warning)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.instanceGroupManagers, forKey: .instanceGroupManagers)
    ...
    ///
    /// [google.cloud.compute.v1.InstanceGroupManagersScopedList.warning]: <doc:InstanceGroupManagersScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: InstanceGroupManagersScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [InstanceGroupManagersScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          InstanceGroupManagersScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [InstanceGroupManagersScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      ///
      /// [google.cloud.compute.v1.InstanceGroupManagersScopedList.warning.data]: <doc:InstanceGroupManagersScopedList/Warning/Data>
      ...
      ///
      /// [google.cloud.compute.v1.InstanceGroupManagersScopedList.warning.code]: <doc:InstanceGroupManagersScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.InstanceGroupManagersScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InstanceGroupManagersScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
