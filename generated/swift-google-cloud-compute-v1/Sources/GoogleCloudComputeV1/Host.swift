...
// limitations under the License.
    ...
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let aliasLinks = CodingKeys(stringValue: "aliasLinks")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Swift.String].self, forKey: .aliasLinks) {
        self.aliasLinks = value
      }
      ...
      self.state = try container.decodeIfPresent(Host.State.self, forKey: .state)
      self.status = try container.decodeIfPresent(HostStatus.self, forKey: .status)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.aliasLinks, forKey: .aliasLinks)
