...
// limitations under the License.
  ...
  public struct InstanceGroupManagerInstanceLifecyclePolicyOnRepair: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let allowChangingZone = CodingKeys(stringValue: "allowChangingZone")
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.allowChangingZone = try container.decodeIfPresent(
        InstanceGroupManagerInstanceLifecyclePolicyOnRepair.AllowChangingZone.self,
        forKey: .allowChangingZone)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encodeIfPresent(self.allowChangingZone, forKey: .allowChangingZone)
