...
// limitations under the License.
  ...
  public struct HealthSourceAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: HealthSourcesScopedList] = [:]
    ...
    public var warning: HealthSourceAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `HealthSourceAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = HealthSourceAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: HealthSourcesScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        HealthSourceAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.HealthSourceAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.HealthSourceAggregatedList.warning]: <doc:HealthSourceAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: HealthSourceAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [HealthSourceAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          HealthSourceAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [HealthSourceAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.HealthSourceAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.HealthSourceAggregatedList.warning.data]: <doc:HealthSourceAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.HealthSourceAggregatedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.HealthSourceAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.HealthSourceAggregatedList.warning.code]: <doc:HealthSourceAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.HealthSourceAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.HealthSourceAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension HealthSourceAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, HealthSourcesScopedList)] {
