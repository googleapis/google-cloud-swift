...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var warning: InterconnectLocationList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `InterconnectLocationList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InterconnectLocationList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([InterconnectLocation].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        InterconnectLocationList.Warning.self, forKey: .warning)
      ...
      Sendable
    {
      ...
      public var code: InterconnectLocationList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [InterconnectLocationList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          InterconnectLocationList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [InterconnectLocationList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.InterconnectLocationList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.InterconnectLocationList.warning.code]: <doc:InterconnectLocationList/Warning/Code>
      ///
