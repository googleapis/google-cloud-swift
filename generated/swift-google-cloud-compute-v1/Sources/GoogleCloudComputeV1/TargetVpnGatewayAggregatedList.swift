...
// limitations under the License.
  ...
  public struct TargetVpnGatewayAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: TargetVpnGatewaysScopedList] = [:]
    ...
    public var warning: TargetVpnGatewayAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `TargetVpnGatewayAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = TargetVpnGatewayAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: TargetVpnGatewaysScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        TargetVpnGatewayAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.TargetVpnGatewayAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.TargetVpnGatewayAggregatedList.warning]: <doc:TargetVpnGatewayAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: TargetVpnGatewayAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [TargetVpnGatewayAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          TargetVpnGatewayAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [TargetVpnGatewayAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.TargetVpnGatewayAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.TargetVpnGatewayAggregatedList.warning.data]: <doc:TargetVpnGatewayAggregatedList/Warning/Data>
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.TargetVpnGatewayAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.TargetVpnGatewayAggregatedList.warning.code]: <doc:TargetVpnGatewayAggregatedList/Warning/Code>
      ///
  ...
  extension TargetVpnGatewayAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, TargetVpnGatewaysScopedList)] {
