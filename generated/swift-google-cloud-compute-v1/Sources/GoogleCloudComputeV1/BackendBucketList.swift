...
// limitations under the License.
  ...
  public struct BackendBucketList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: BackendBucketList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `BackendBucketList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = BackendBucketList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.warning = try container.decodeIfPresent(BackendBucketList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.BackendBucketList.warning] field.
    ///
    /// [google.cloud.compute.v1.BackendBucketList.warning]: <doc:BackendBucketList/Warning>
      ...
      Sendable
    {
      ...
      public var code: BackendBucketList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [BackendBucketList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          BackendBucketList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [BackendBucketList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.BackendBucketList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.BackendBucketList.warning.data]: <doc:BackendBucketList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.BackendBucketList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.BackendBucketList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.BackendBucketList.warning.code]: <doc:BackendBucketList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.BackendBucketList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.BackendBucketList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension BackendBucketList: GoogleGax._PaginatedResponse {
