...
// limitations under the License.
  ...
  public struct InstancesGetEffectiveFirewallsResponseEffectiveFirewallPolicy: Codable, Equatable,
    ...
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = InstancesGetEffectiveFirewallsResponseEffectiveFirewallPolicy().with { $0.displayName = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.type = try container.decodeIfPresent(
        InstancesGetEffectiveFirewallsResponseEffectiveFirewallPolicy.Type_.self, forKey: .type)
    ...
    ///
    /// [google.cloud.compute.v1.InstancesGetEffectiveFirewallsResponseEffectiveFirewallPolicy.type]: <doc:InstancesGetEffectiveFirewallsResponseEffectiveFirewallPolicy/Type_>
    ///
    ...
    public enum Type_: Codable, Equatable, Sendable {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        case .networkRegional: return try container.encode("NETWORK_REGIONAL")
        case .systemGlobal: return try container.encode("SYSTEM_GLOBAL")
        case .systemRegional: return try container.encode("SYSTEM_REGIONAL")
