...
// limitations under the License.
  ...
  public struct InterconnectGroupInterconnect: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = InterconnectGroupInterconnect().with { $0.interconnect = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InterconnectGroupInterconnect"
    }
