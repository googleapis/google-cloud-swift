...
// limitations under the License.
  ...
  public struct ListInstantSnapshotGroups: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [InstantSnapshotGroup] = []
    ...
    public var warning: ListInstantSnapshotGroups.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ListInstantSnapshotGroups`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListInstantSnapshotGroups().with { $0.etag = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([InstantSnapshotGroup].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        ListInstantSnapshotGroups.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.ListInstantSnapshotGroups.warning] field.
    ///
    /// [google.cloud.compute.v1.ListInstantSnapshotGroups.warning]: <doc:ListInstantSnapshotGroups/Warning>
      ...
      Sendable
    {
      ...
      public var code: ListInstantSnapshotGroups.Warning.Code? = nil
      ...
      ///   }]
      public var data: [ListInstantSnapshotGroups.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          ListInstantSnapshotGroups.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [ListInstantSnapshotGroups.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.ListInstantSnapshotGroups.warning.data] field.
      ///
      /// [google.cloud.compute.v1.ListInstantSnapshotGroups.warning.data]: <doc:ListInstantSnapshotGroups/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.ListInstantSnapshotGroups.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.ListInstantSnapshotGroups.warning.code] field.
      ///
      /// [google.cloud.compute.v1.ListInstantSnapshotGroups.warning.code]: <doc:ListInstantSnapshotGroups/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.ListInstantSnapshotGroups.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ListInstantSnapshotGroups"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension ListInstantSnapshotGroups: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [InstantSnapshotGroup] {
      return self.items
    }
