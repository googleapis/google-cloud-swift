...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var warning: InterconnectAttachmentList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `InterconnectAttachmentList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InterconnectAttachmentList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([InterconnectAttachment].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        InterconnectAttachmentList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.InterconnectAttachmentList.warning] field.
    ///
    /// [google.cloud.compute.v1.InterconnectAttachmentList.warning]: <doc:InterconnectAttachmentList/Warning>
      ...
      Sendable
    {
      ...
      public var code: InterconnectAttachmentList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [InterconnectAttachmentList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          InterconnectAttachmentList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [InterconnectAttachmentList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.InterconnectAttachmentList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.InterconnectAttachmentList.warning.data]: <doc:InterconnectAttachmentList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.InterconnectAttachmentList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.InterconnectAttachmentList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.InterconnectAttachmentList.warning.code]: <doc:InterconnectAttachmentList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.InterconnectAttachmentList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InterconnectAttachmentList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
