...
// limitations under the License.
  ...
  public struct ZoneSetPolicyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ZoneSetPolicyRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ZoneSetPolicyRequest().with { $0.bindings = ... }
    /// ```
