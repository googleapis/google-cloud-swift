...
// limitations under the License.
  ...
  extension InstantSnapshotGroupsClient {
      ...
      Sendable
    {
      ...
      public var instantSnapshotGroup: Swift.String = Swift.String()
      ...
      ///
      /// ```
      /// let value = DeleteRequest().with { $0.instantSnapshotGroup = ... }
      /// ```
      ...
      private struct CodingKeys: CodingKey {
        ...
        static let instantSnapshotGroup = CodingKeys(stringValue: "instantSnapshotGroup")
      ...
      public init(from decoder: Decoder) throws {
        ...
        {
          self.instantSnapshotGroup = value
        }
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = GetRequest().with { $0.instantSnapshotGroup = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
