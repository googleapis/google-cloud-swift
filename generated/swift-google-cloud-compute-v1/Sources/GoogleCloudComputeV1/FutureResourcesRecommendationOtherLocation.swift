...
// limitations under the License.
  ...
  public struct FutureResourcesRecommendationOtherLocation: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.status = try container.decodeIfPresent(
        FutureResourcesRecommendationOtherLocation.Status.self, forKey: .status)
