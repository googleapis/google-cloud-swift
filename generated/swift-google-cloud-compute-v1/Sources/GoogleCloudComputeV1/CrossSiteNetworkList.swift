...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var items: [CrossSiteNetwork] = []
    ...
    public var warning: CrossSiteNetworkList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `CrossSiteNetworkList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = CrossSiteNetworkList().with { $0.etag = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([CrossSiteNetwork].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        CrossSiteNetworkList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.CrossSiteNetworkList.warning] field.
    ///
    /// [google.cloud.compute.v1.CrossSiteNetworkList.warning]: <doc:CrossSiteNetworkList/Warning>
      ...
      Sendable
    {
      ...
      public var code: CrossSiteNetworkList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [CrossSiteNetworkList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          CrossSiteNetworkList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [CrossSiteNetworkList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.CrossSiteNetworkList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.CrossSiteNetworkList.warning.data]: <doc:CrossSiteNetworkList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.CrossSiteNetworkList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.CrossSiteNetworkList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.CrossSiteNetworkList.warning.code]: <doc:CrossSiteNetworkList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.CrossSiteNetworkList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.CrossSiteNetworkList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
