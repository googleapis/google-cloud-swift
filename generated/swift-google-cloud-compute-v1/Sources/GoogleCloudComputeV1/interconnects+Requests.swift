...
// limitations under the License.
  ...
  extension InterconnectsClient {
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = DeleteRequest().with { $0.interconnect = ... }
      /// ```
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = GetRequest().with { $0.interconnect = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
    ...
    public struct GetDiagnosticsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
      Sendable
    {
      ...
      /// Initialize a new instance of `GetDiagnosticsRequest`.
      public init() {}
      ...
      ///
      /// ```
      /// let value = GetDiagnosticsRequest().with { $0.interconnect = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
    ...
    public struct GetMacsecConfigRequest: Codable, Equatable, GoogleWKT._AnyPackable,
      Sendable
    {
      /// Name of the interconnect resource to query.
      public var interconnect: Swift.String = Swift.String()
      ...
      /// Initialize a new instance of `GetMacsecConfigRequest`.
      public init() {}
      ...
      ///
      /// ```
      /// let value = GetMacsecConfigRequest().with { $0.interconnect = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      Sendable
    {
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.requestId = try container.decodeIfPresent(Swift.String.self, forKey: .requestId)
        self.body = try container.decodeIfPresent(Interconnect.self, forKey: .body)
        for key in container.allKeys where !CodingKeys._knownKeys.contains(key.stringValue) {
          self._unknownFields.json[key.stringValue] = try container.decode(
            GoogleWKT.WKTValue.self, forKey: key)
        }
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = PatchRequest().with { $0.interconnect = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
