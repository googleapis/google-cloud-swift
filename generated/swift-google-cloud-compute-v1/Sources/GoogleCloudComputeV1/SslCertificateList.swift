...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var warning: SslCertificateList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `SslCertificateList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SslCertificateList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([SslCertificate].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        SslCertificateList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.SslCertificateList.warning] field.
    ///
    /// [google.cloud.compute.v1.SslCertificateList.warning]: <doc:SslCertificateList/Warning>
      ...
      Sendable
    {
      ...
      public var code: SslCertificateList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [SslCertificateList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          SslCertificateList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [SslCertificateList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.SslCertificateList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.SslCertificateList.warning.data]: <doc:SslCertificateList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.SslCertificateList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.SslCertificateList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.SslCertificateList.warning.code]: <doc:SslCertificateList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.SslCertificateList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.SslCertificateList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
