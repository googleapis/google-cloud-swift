...
// limitations under the License.
  ...
  public struct NodeTemplateAggregatedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [Swift.String: NodeTemplatesScopedList] = [:]
    ...
    public var warning: NodeTemplateAggregatedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `NodeTemplateAggregatedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = NodeTemplateAggregatedList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [Swift.String: NodeTemplatesScopedList].self, forKey: .items)
      {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        NodeTemplateAggregatedList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.NodeTemplateAggregatedList.warning] field.
    ///
    /// [google.cloud.compute.v1.NodeTemplateAggregatedList.warning]: <doc:NodeTemplateAggregatedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: NodeTemplateAggregatedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [NodeTemplateAggregatedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          NodeTemplateAggregatedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [NodeTemplateAggregatedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.NodeTemplateAggregatedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.NodeTemplateAggregatedList.warning.data]: <doc:NodeTemplateAggregatedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.NodeTemplateAggregatedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.NodeTemplateAggregatedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.NodeTemplateAggregatedList.warning.code]: <doc:NodeTemplateAggregatedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.NodeTemplateAggregatedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.NodeTemplateAggregatedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension NodeTemplateAggregatedList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [(Swift.String, NodeTemplatesScopedList)] {
