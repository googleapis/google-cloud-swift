...
// limitations under the License.
  ...
  extension Clients.ReservationSlotsProtocol {
    ...
    public func getHealth(request: ReservationSlotsClient.GetHealthRequest) async throws
  ...
  @available(
    *, unavailable,
    message: "Enable the 'ReservationSlots' trait in Package.swift to use this client."
  )
  public final class ReservationSlotsClient: Sendable {
    @available(
      *, unavailable,
      message: "Enable the 'ReservationSlots' trait in Package.swift to use this client."
    )
