...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var warning: RouteList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `RouteList`.
    public init() {}
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Route].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(RouteList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.RouteList.warning] field.
    ///
    /// [google.cloud.compute.v1.RouteList.warning]: <doc:RouteList/Warning>
      ...
      Sendable
    {
      ...
      public var code: RouteList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [RouteList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(RouteList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent([RouteList.Warning.Data].self, forKey: .data) {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.RouteList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.RouteList.warning.data]: <doc:RouteList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.RouteList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.RouteList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.RouteList.warning.code]: <doc:RouteList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.RouteList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.RouteList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
