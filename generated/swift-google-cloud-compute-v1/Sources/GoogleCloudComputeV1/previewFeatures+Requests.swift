...
// limitations under the License.
  ...
  extension PreviewFeaturesClient {
    ...
    ///
    /// [google.cloud.compute.v1.previewFeatures.get]: <doc:PreviewFeaturesClient/`get`(request:options:)>
    public struct GetRequest: Codable, Equatable, GoogleWKT._AnyPackable,
      Sendable
    {
      /// Name of the PreviewFeature for this request.
      public var previewFeature: Swift.String = Swift.String()
      ...
      ///
      /// ```
      /// let value = GetRequest().with { $0.previewFeature = ... }
      /// ```
      ...
      private struct CodingKeys: CodingKey {
        ...
        static let previewFeature = CodingKeys(stringValue: "previewFeature")
      ...
      public init(from decoder: Decoder) throws {
        ...
        if let value = try container.decodeIfPresent(Swift.String.self, forKey: .previewFeature) {
          self.previewFeature = value
        }
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(self.previewFeature, forKey: .previewFeature)
    ...
    ///
    /// [google.cloud.compute.v1.previewFeatures.list]: <doc:PreviewFeaturesClient/list(request:options:)>
    ...
    ///
    /// [google.cloud.compute.v1.previewFeatures.update]: <doc:PreviewFeaturesClient/update(request:options:)>
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = UpdateRequest().with { $0.previewFeature = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.body = try container.decodeIfPresent(PreviewFeature.self, forKey: .body)
        for key in container.allKeys where !CodingKeys._knownKeys.contains(key.stringValue) {
          self._unknownFields.json[key.stringValue] = try container.decode(
            GoogleWKT.WKTValue.self, forKey: key)
        }
