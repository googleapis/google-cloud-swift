...
// limitations under the License.
  ...
  extension Clients {
    final class ZoneOperationsTransport: ZoneOperationsStub {
      ...
      public func list(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/compute/v1/projects/\(pathVariable0)/zones/\(pathVariable1)/operations"
            var query = [
              URLQueryItem(name: "$alt", value: "json")
            ]
      ...
      public func wait(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path =
              "/compute/v1/projects/\(pathVariable0)/zones/\(pathVariable1)/operations/\(pathVariable2)/wait"
            let query = [
              URLQueryItem(name: "$alt", value: "json")
            ]
            return (path, query)
