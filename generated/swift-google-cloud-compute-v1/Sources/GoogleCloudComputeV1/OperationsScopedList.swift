...
// limitations under the License.
  ...
  public struct OperationsScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: OperationsScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `OperationsScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = OperationsScopedList().with { $0.operations = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.warning = try container.decodeIfPresent(
        OperationsScopedList.Warning.self, forKey: .warning)
    ...
    ///
    /// [google.cloud.compute.v1.OperationsScopedList.warning]: <doc:OperationsScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: OperationsScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [OperationsScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          OperationsScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [OperationsScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      ///
      /// [google.cloud.compute.v1.OperationsScopedList.warning.data]: <doc:OperationsScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.OperationsScopedList.warning.data"
        }
      ...
      ///
      /// [google.cloud.compute.v1.OperationsScopedList.warning.code]: <doc:OperationsScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.OperationsScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.OperationsScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
