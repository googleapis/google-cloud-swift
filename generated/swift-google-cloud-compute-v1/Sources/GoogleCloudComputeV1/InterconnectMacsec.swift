...
// limitations under the License.
  ...
  /// on-premises router.
  public struct InterconnectMacsec: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var failOpen: Swift.Bool? = nil
    ...
    ///
    /// ```
    /// let value = InterconnectMacsec().with { $0.failOpen = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InterconnectMacsec"
    }
