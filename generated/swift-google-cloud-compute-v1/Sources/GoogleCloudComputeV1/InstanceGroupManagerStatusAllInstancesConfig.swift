...
// limitations under the License.
  ...
  public struct InstanceGroupManagerStatusAllInstancesConfig: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = InstanceGroupManagerStatusAllInstancesConfig().with { $0.currentRevision = ... }
    /// ```
