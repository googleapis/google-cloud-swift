...
// limitations under the License.
  ...
  public struct NotificationEndpointList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [NotificationEndpoint] = []
    ...
    public var warning: NotificationEndpointList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `NotificationEndpointList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = NotificationEndpointList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([NotificationEndpoint].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        NotificationEndpointList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.NotificationEndpointList.warning] field.
    ///
    /// [google.cloud.compute.v1.NotificationEndpointList.warning]: <doc:NotificationEndpointList/Warning>
      ...
      Sendable
    {
      ...
      public var code: NotificationEndpointList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [NotificationEndpointList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          NotificationEndpointList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [NotificationEndpointList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.NotificationEndpointList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.NotificationEndpointList.warning.data]: <doc:NotificationEndpointList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.NotificationEndpointList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.NotificationEndpointList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.NotificationEndpointList.warning.code]: <doc:NotificationEndpointList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.NotificationEndpointList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.NotificationEndpointList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension NotificationEndpointList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [NotificationEndpoint] {
      return self.items
    }
