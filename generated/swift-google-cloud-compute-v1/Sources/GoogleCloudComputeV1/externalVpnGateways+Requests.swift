...
// limitations under the License.
  ...
  extension ExternalVpnGatewaysClient {
      ...
      Sendable
    {
      ...
      public var externalVpnGateway: Swift.String = Swift.String()
      ...
      ///
      /// ```
      /// let value = DeleteRequest().with { $0.externalVpnGateway = ... }
      /// ```
      ...
      private struct CodingKeys: CodingKey {
        ...
        static let externalVpnGateway = CodingKeys(stringValue: "externalVpnGateway")
      ...
      Sendable
    {
      ...
      ///
      /// ```
      /// let value = GetRequest().with { $0.externalVpnGateway = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
      ...
      Sendable
    {
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.requestId = try container.decodeIfPresent(Swift.String.self, forKey: .requestId)
        self.body = try container.decodeIfPresent(ExternalVpnGateway.self, forKey: .body)
        for key in container.allKeys where !CodingKeys._knownKeys.contains(key.stringValue) {
          self._unknownFields.json[key.stringValue] = try container.decode(
            GoogleWKT.WKTValue.self, forKey: key)
        }
