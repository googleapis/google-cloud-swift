...
// limitations under the License.
  ...
  public struct HealthSourceList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var warning: HealthSourceList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `HealthSourceList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = HealthSourceList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([HealthSource].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(HealthSourceList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.HealthSourceList.warning] field.
    ///
    /// [google.cloud.compute.v1.HealthSourceList.warning]: <doc:HealthSourceList/Warning>
      ...
      Sendable
    {
      ...
      public var code: HealthSourceList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [HealthSourceList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(HealthSourceList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [HealthSourceList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.HealthSourceList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.HealthSourceList.warning.data]: <doc:HealthSourceList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.HealthSourceList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.HealthSourceList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.HealthSourceList.warning.code]: <doc:HealthSourceList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.HealthSourceList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.HealthSourceList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension HealthSourceList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [HealthSource] {
      return self.items
    }
