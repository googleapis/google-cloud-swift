...
// limitations under the License.
  ...
  public struct Subsetting: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.policy = try container.decodeIfPresent(Subsetting.Policy.self, forKey: .policy)
    ...
    public enum Policy: Codable, Equatable, Hashable, Sendable {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .consistentHashSubsetting: return try container.encode("CONSISTENT_HASH_SUBSETTING")
