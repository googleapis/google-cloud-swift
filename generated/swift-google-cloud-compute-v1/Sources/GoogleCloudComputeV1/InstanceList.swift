...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var warning: InstanceList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `InstanceList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InstanceList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Instance].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(InstanceList.Warning.self, forKey: .warning)
    ...
    ///
    /// [google.cloud.compute.v1.InstanceList.warning]: <doc:InstanceList/Warning>
      ...
      Sendable
    {
      ...
      public var code: InstanceList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [InstanceList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.code = try container.decodeIfPresent(InstanceList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [InstanceList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      ///
      /// [google.cloud.compute.v1.InstanceList.warning.data]: <doc:InstanceList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.InstanceList.warning.data"
        }
      ...
      ///
      /// [google.cloud.compute.v1.InstanceList.warning.code]: <doc:InstanceList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.InstanceList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InstanceList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
