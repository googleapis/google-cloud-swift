...
// limitations under the License.
  ...
  public struct ImageParams: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ImageParams`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ImageParams().with { $0.resourceManagerTags = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.ImageParams"
    }
