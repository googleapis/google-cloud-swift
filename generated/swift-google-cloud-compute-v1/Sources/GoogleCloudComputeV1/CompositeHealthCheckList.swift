...
// limitations under the License.
  ...
  public struct CompositeHealthCheckList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var items: [CompositeHealthCheck] = []
    ...
    public var warning: CompositeHealthCheckList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `CompositeHealthCheckList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = CompositeHealthCheckList().with { $0.id = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([CompositeHealthCheck].self, forKey: .items) {
        self.items = value
      }
      ...
      self.warning = try container.decodeIfPresent(
        CompositeHealthCheckList.Warning.self, forKey: .warning)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.CompositeHealthCheckList.warning] field.
    ///
    /// [google.cloud.compute.v1.CompositeHealthCheckList.warning]: <doc:CompositeHealthCheckList/Warning>
      ...
      Sendable
    {
      ...
      public var code: CompositeHealthCheckList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [CompositeHealthCheckList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          CompositeHealthCheckList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [CompositeHealthCheckList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.CompositeHealthCheckList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.CompositeHealthCheckList.warning.data]: <doc:CompositeHealthCheckList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return "type.googleapis.com/google.cloud.compute.v1.CompositeHealthCheckList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.CompositeHealthCheckList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.CompositeHealthCheckList.warning.code]: <doc:CompositeHealthCheckList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.CompositeHealthCheckList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.CompositeHealthCheckList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
  ...
  extension CompositeHealthCheckList: GoogleGax._PaginatedResponse {
    public func _getPaginatedItems() -> [CompositeHealthCheck] {
      return self.items
    }
