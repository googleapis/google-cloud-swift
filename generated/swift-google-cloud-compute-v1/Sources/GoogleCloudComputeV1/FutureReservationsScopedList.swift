...
// limitations under the License.
  ...
  public struct FutureReservationsScopedList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// A list of future reservations contained in this scope.
    public var futureReservations: [FutureReservation] = []

    /// Informational warning which replaces the list of future reservations when
    /// the list is empty.
    public var warning: FutureReservationsScopedList.Warning? = nil

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `FutureReservationsScopedList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = FutureReservationsScopedList().with { $0.futureReservations = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let futureReservations = CodingKeys(stringValue: "futureReservations")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [FutureReservation].self, forKey: .futureReservations)
      {
        self.futureReservations = value
      }
      self.warning = try container.decodeIfPresent(
        FutureReservationsScopedList.Warning.self, forKey: .warning)
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.futureReservations, forKey: .futureReservations)
    ...
    /// The message type for the [warning][google.cloud.compute.v1.FutureReservationsScopedList.warning] field.
    ///
    /// [google.cloud.compute.v1.FutureReservationsScopedList.warning]: <doc:FutureReservationsScopedList/Warning>
      ...
      Sendable
    {
      ...
      public var code: FutureReservationsScopedList.Warning.Code? = nil
      ...
      ///   }]
      public var data: [FutureReservationsScopedList.Warning.Data] = []
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.code = try container.decodeIfPresent(
          FutureReservationsScopedList.Warning.Code.self, forKey: .code)
        if let value = try container.decodeIfPresent(
          [FutureReservationsScopedList.Warning.Data].self, forKey: .data)
        {
          self.data = value
        }
      ...
      /// The message type for the [data][google.cloud.compute.v1.FutureReservationsScopedList.warning.data] field.
      ///
      /// [google.cloud.compute.v1.FutureReservationsScopedList.warning.data]: <doc:FutureReservationsScopedList/Warning/Data>
        ...
        Sendable
      {
        ...
        public static var _anyTypeUrl: Swift.String {
          return
            "type.googleapis.com/google.cloud.compute.v1.FutureReservationsScopedList.warning.data"
        }
      ...
      /// The enumerated type for the [code][google.cloud.compute.v1.FutureReservationsScopedList.warning.code] field.
      ///
      /// [google.cloud.compute.v1.FutureReservationsScopedList.warning.code]: <doc:FutureReservationsScopedList/Warning/Code>
      ///
      ...
      public static var _anyTypeUrl: Swift.String {
        return "type.googleapis.com/google.cloud.compute.v1.FutureReservationsScopedList.warning"
      }
      public init(fromAny any: GoogleWKT.WKTAny) throws {
        self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.FutureReservationsScopedList"
    }
    public init(fromAny any: GoogleWKT.WKTAny) throws {
      self = try GoogleWKT._slowAnyDeserialize(Self.self, from: any)
    }
