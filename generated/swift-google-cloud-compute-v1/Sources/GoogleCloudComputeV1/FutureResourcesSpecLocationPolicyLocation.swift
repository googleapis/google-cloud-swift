...
// limitations under the License.
    ...
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = FutureResourcesSpecLocationPolicyLocation().with { $0.preference = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.FutureResourcesSpecLocationPolicyLocation"
    }
