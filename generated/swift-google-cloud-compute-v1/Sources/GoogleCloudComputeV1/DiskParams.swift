...
// limitations under the License.
  ...
  public struct DiskParams: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `DiskParams`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DiskParams().with { $0.resourceManagerTags = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.DiskParams"
    }
