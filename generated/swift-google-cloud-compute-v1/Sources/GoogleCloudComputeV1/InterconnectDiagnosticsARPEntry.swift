...
// limitations under the License.
  ...
  public struct InterconnectDiagnosticsARPEntry: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `InterconnectDiagnosticsARPEntry`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = InterconnectDiagnosticsARPEntry().with { $0.ipAddress = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.compute.v1.InterconnectDiagnosticsARPEntry"
    }
