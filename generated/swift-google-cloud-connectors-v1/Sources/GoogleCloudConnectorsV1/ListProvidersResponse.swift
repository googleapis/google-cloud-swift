  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListProvidersResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListProvidersResponse().with { $0.providers = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Provider].self, forKey: .providers) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.connectors.v1.ListProvidersResponse"
  }
