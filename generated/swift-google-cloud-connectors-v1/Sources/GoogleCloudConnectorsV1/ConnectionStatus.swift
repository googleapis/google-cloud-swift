...
public struct ConnectionStatus: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// State.
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(ConnectionStatus.State.self, forKey: .state) {
      self.state = value
    }
  ...
  public enum State: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .authorizationRequired: return try container.encode("AUTHORIZATION_REQUIRED")
