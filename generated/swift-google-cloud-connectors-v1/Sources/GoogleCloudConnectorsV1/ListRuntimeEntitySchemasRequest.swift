...
public struct ListRuntimeEntitySchemasRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListRuntimeEntitySchemasRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListRuntimeEntitySchemasRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.connectors.v1.ListRuntimeEntitySchemasRequest"
  }
