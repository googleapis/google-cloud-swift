  ...
  Sendable
{
  ...
  public var source: ExtractionRule.Source? = nil
  ...
  ///
  /// ```
  /// let value = ExtractionRule().with { $0.source = ... }
  /// ```
  ...
  {
    /// Type of the source.
    public var sourceType: ExtractionRule.SourceType = ExtractionRule.SourceType()
    ...
    ///
    /// ```
    /// let value = Source().with { $0.sourceType = ... }
    /// ```
    public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
      var copy = self
      try config(&copy)
  ...
  public enum SourceType: Codable, Equatable, Sendable {
    ...
    public var stringValue: Swift.String? {
      ...
      case .configVariable: return "CONFIG_VARIABLE"
    ...
    public init(stringValue: Swift.String) {
      ...
      case "CONFIG_VARIABLE": self = .configVariable
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .configVariable: return try container.encode("CONFIG_VARIABLE")
