...
/// specified.
public struct LockConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `LockConfig`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = LockConfig().with { $0.locked = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.connectors.v1.LockConfig"
  }
