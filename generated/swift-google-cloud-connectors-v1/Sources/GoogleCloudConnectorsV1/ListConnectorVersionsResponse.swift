  ...
  Sendable
{
  ...
  public var connectorVersions: [ConnectorVersion] = []
  ...
  /// Initialize a new instance of `ListConnectorVersionsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListConnectorVersionsResponse().with { $0.connectorVersions = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let connectorVersions = CodingKeys(stringValue: "connectorVersions")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [ConnectorVersion].self, forKey: .connectorVersions)
    {
      self.connectorVersions = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.connectorVersions, forKey: .connectorVersions)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.connectors.v1.ListConnectorVersionsResponse"
  }
