  ...
  Sendable
{
  ...
  /// Initialize a new instance of `CreateMetricDescriptorRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateMetricDescriptorRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.monitoring.v3.CreateMetricDescriptorRequest"
  }
