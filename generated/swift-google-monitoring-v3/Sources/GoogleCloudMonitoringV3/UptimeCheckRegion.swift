...
public enum UptimeCheckRegion: Codable, Equatable, Hashable, Sendable {
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:UptimeCheckRegion/unknownStringValue(_:)).
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:UptimeCheckRegion/unknownIntValue(_:)).
