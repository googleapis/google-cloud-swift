...
public struct ListUptimeCheckConfigsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Required. The
  ...
  /// Initialize a new instance of `ListUptimeCheckConfigsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListUptimeCheckConfigsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.monitoring.v3.ListUptimeCheckConfigsRequest"
  }
