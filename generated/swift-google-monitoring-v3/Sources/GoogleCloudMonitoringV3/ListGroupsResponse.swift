  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = ListGroupsResponse().with { $0.group = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Group].self, forKey: .group) {
      self.group = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.monitoring.v3.ListGroupsResponse"
  }
