...
public struct UpdateServiceLevelObjectiveRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateServiceLevelObjectiveRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateServiceLevelObjectiveRequest().with { $0.serviceLevelObjective = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.monitoring.v3.UpdateServiceLevelObjectiveRequest"
  }
