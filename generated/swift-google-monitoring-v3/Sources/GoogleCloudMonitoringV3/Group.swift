  ...
  Sendable
{
  ...
  public var isCluster: Swift.Bool = Swift.Bool()
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let isCluster = CodingKeys(stringValue: "isCluster")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.Bool.self, forKey: .isCluster) {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.isCluster, forKey: .isCluster)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.monitoring.v3.Group"
  }
