  ...
  Sendable
{
  ...
  public var serviceLevelObjectives: [ServiceLevelObjective] = []
  ...
  /// Initialize a new instance of `ListServiceLevelObjectivesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListServiceLevelObjectivesResponse().with { $0.serviceLevelObjectives = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let serviceLevelObjectives = CodingKeys(stringValue: "serviceLevelObjectives")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [ServiceLevelObjective].self, forKey: .serviceLevelObjectives)
    {
      self.serviceLevelObjectives = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.serviceLevelObjectives, forKey: .serviceLevelObjectives)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.monitoring.v3.ListServiceLevelObjectivesResponse"
  }
