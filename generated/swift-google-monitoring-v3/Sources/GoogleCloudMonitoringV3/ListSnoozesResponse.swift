  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let snoozes = CodingKeys(stringValue: "snoozes")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Snooze].self, forKey: .snoozes) {
      self.snoozes = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.snoozes, forKey: .snoozes)
