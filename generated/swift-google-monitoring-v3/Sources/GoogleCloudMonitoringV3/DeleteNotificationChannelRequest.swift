...
public struct DeleteNotificationChannelRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteNotificationChannelRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteNotificationChannelRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.monitoring.v3.DeleteNotificationChannelRequest"
  }
