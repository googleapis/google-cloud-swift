...
public struct AutoscalerStatus: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The high-level Autoscaler state.
  public var state: AutoscalerState = AutoscalerState()

  /// The detailed description of Autoscaler status.
  public var details: Swift.String = Swift.String()

  /// The cluster update operation ID.
  public var updateClusterOperationId: Swift.String = Swift.String()
  ...
  ///
  /// ```
  /// let value = AutoscalerStatus().with { $0.state = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataproc.logging.AutoscalerStatus"
  }
