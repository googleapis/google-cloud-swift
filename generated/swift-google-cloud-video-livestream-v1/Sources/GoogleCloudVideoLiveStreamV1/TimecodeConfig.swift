  ...
  Sendable
{
  ...
  ///   them to named cases.
  public enum TimecodeSource: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("TIMECODE_SOURCE_UNSPECIFIED")
      case .mediaTimestamp: return try container.encode("MEDIA_TIMESTAMP")
      case .embeddedTimecode: return try container.encode("EMBEDDED_TIMECODE")
