...
public struct GetClipRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetClipRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetClipRequest().with { $0.name = ... }
  /// ```
