  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let logSeverity = CodingKeys(stringValue: "logSeverity")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(LogConfig.LogSeverity.self, forKey: .logSeverity) {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.logSeverity, forKey: .logSeverity)
  ...
  public enum LogSeverity: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("LOG_SEVERITY_UNSPECIFIED")
