...
public struct ListClipsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The list of Clip
  ...
  /// Initialize a new instance of `ListClipsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListClipsResponse().with { $0.clips = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let clips = CodingKeys(stringValue: "clips")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Clip].self, forKey: .clips) {
      self.clips = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.clips, forKey: .clips)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.video.livestream.v1.ListClipsResponse"
  }
...
extension ListClipsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Clip] {
    return self.clips
  }
