...
public struct CreateInputRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let inputId = CodingKeys(stringValue: "inputId")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .inputId) {
      self.inputId = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.inputId, forKey: .inputId)
