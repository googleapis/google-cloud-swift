...
public struct UpdatePoolRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdatePoolRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdatePoolRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.pool = try container.decodeIfPresent(Pool.self, forKey: .pool)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.video.livestream.v1.UpdatePoolRequest"
  }
