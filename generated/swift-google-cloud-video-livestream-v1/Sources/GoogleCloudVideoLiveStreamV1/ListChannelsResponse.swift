...
public struct ListChannelsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// A list of channels.
  ...
  /// Initialize a new instance of `ListChannelsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListChannelsResponse().with { $0.channels = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Channel].self, forKey: .channels) {
      self.channels = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.video.livestream.v1.ListChannelsResponse"
  }
...
extension ListChannelsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Channel] {
