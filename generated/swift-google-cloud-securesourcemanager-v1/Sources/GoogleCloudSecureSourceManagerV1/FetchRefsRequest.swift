...
public struct FetchRefsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `FetchRefsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FetchRefsRequest().with { $0.repository = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securesourcemanager.v1.FetchRefsRequest"
  }
