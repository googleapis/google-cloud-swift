...
public struct OpenIssueRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `OpenIssueRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = OpenIssueRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securesourcemanager.v1.OpenIssueRequest"
  }
