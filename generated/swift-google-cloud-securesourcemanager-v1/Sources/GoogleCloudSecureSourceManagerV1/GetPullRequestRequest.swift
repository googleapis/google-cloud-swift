  ...
  Sendable
{
  ...
  /// Initialize a new instance of `GetPullRequestRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetPullRequestRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securesourcemanager.v1.GetPullRequestRequest"
  }
