...
public struct ListBranchRulesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListBranchRulesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListBranchRulesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securesourcemanager.v1.ListBranchRulesRequest"
  }
