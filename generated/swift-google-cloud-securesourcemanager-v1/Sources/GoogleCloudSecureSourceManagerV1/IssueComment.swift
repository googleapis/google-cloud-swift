...
public struct IssueComment: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `IssueComment`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = IssueComment().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securesourcemanager.v1.IssueComment"
  }
