...
public struct UnresolvePullRequestCommentsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UnresolvePullRequestCommentsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UnresolvePullRequestCommentsRequest().with { $0.parent = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let autoFill = CodingKeys(stringValue: "autoFill")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.Bool.self, forKey: .autoFill) {
      self.autoFill = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.autoFill, forKey: .autoFill)
