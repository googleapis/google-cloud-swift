  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListPullRequestsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPullRequestsResponse().with { $0.pullRequests = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let pullRequests = CodingKeys(stringValue: "pullRequests")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([PullRequest].self, forKey: .pullRequests) {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.pullRequests, forKey: .pullRequests)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securesourcemanager.v1.ListPullRequestsResponse"
  }
