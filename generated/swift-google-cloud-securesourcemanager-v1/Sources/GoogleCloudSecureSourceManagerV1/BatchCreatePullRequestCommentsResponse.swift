...
public struct BatchCreatePullRequestCommentsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = BatchCreatePullRequestCommentsResponse().with { $0.pullRequestComments = ... }
  /// ```
