...
public struct UnresolvePullRequestCommentsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UnresolvePullRequestCommentsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UnresolvePullRequestCommentsResponse().with { $0.pullRequestComments = ... }
  /// ```
