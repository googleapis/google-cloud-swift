...
public struct Hook: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public struct PushOption: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
  ...
  ///   them to named cases.
  public enum HookEventType: Codable, Equatable, Hashable, Sendable {
    /// Unspecified.
    case unspecified
