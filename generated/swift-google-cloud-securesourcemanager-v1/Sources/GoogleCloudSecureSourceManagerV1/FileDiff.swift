...
/// request.
public struct FileDiff: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var action: FileDiff.Action = FileDiff.Action()
  ...
  ///
  /// ```
  /// let value = FileDiff().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securesourcemanager.v1.FileDiff"
  }
