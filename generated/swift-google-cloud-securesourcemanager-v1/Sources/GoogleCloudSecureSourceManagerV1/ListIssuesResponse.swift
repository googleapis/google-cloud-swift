...
public struct ListIssuesResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The list of issues.
  ...
  /// Initialize a new instance of `ListIssuesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListIssuesResponse().with { $0.issues = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securesourcemanager.v1.ListIssuesResponse"
  }
...
extension ListIssuesResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Issue] {
    return self.issues
  }
