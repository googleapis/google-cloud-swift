...
public struct TreeEntry: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Output only. The type of the object (TREE, BLOB, COMMIT).  Output-only.
  public var type: TreeEntry.ObjectType = TreeEntry.ObjectType()
  ...
  ///
  /// ```
  /// let value = TreeEntry().with { $0.type = ... }
  /// ```
  ...
  public enum ObjectType: Codable, Equatable, Sendable {
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "OBJECT_TYPE_UNSPECIFIED"
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:ObjectType/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "OBJECT_TYPE_UNSPECIFIED": self = .unspecified
      case "TREE": self = .tree
      case "BLOB": self = .blob
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:ObjectType/unknownIntValue(_:)).
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securesourcemanager.v1.TreeEntry"
  }
