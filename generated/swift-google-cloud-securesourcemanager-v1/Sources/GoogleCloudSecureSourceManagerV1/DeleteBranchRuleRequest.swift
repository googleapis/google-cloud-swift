  ...
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteBranchRuleRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteBranchRuleRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securesourcemanager.v1.DeleteBranchRuleRequest"
  }
