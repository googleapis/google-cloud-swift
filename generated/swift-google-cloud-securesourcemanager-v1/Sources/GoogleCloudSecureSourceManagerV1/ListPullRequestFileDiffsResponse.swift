  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListPullRequestFileDiffsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPullRequestFileDiffsResponse().with { $0.fileDiffs = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let fileDiffs = CodingKeys(stringValue: "fileDiffs")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([FileDiff].self, forKey: .fileDiffs) {
      self.fileDiffs = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.fileDiffs, forKey: .fileDiffs)
