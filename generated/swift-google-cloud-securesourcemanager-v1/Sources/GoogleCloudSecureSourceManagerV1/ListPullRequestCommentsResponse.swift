  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListPullRequestCommentsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPullRequestCommentsResponse().with { $0.pullRequestComments = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securesourcemanager.v1.ListPullRequestCommentsResponse"
  }
