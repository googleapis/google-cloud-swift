...
public struct ListPullRequestCommentsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListPullRequestCommentsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPullRequestCommentsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securesourcemanager.v1.ListPullRequestCommentsRequest"
  }
