...
public struct FetchBlobResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `FetchBlobResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FetchBlobResponse().with { $0.sha = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securesourcemanager.v1.FetchBlobResponse"
  }
