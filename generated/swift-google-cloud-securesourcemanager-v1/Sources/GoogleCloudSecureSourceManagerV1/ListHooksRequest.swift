...
public struct ListHooksRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListHooksRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListHooksRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securesourcemanager.v1.ListHooksRequest"
  }
