...
public struct CreateIssueRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CreateIssueRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateIssueRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securesourcemanager.v1.CreateIssueRequest"
  }
