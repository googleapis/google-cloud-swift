...
public struct UpdatePullRequestCommentRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdatePullRequestCommentRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdatePullRequestCommentRequest().with { $0.pullRequestComment = ... }
  /// ```
