...
public struct TextClassificationPredictionInstance: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `TextClassificationPredictionInstance`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = TextClassificationPredictionInstance().with { $0.content = ... }
  /// ```
