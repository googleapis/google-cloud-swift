...
public struct ImageSegmentationPredictionInstance: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ImageSegmentationPredictionInstance`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ImageSegmentationPredictionInstance().with { $0.content = ... }
  /// ```
