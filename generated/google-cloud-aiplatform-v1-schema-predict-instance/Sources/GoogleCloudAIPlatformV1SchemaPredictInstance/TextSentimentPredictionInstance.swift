...
public struct TextSentimentPredictionInstance: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `TextSentimentPredictionInstance`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = TextSentimentPredictionInstance().with { $0.content = ... }
  /// ```
