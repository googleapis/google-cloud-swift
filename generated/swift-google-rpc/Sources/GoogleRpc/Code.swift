...
public enum Code: Codable, Equatable, Hashable, Sendable {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    case .alreadyExists: return try container.encode("ALREADY_EXISTS")
    ...
    case .failedPrecondition: return try container.encode("FAILED_PRECONDITION")
    case .aborted: return try container.encode("ABORTED")
    case .outOfRange: return try container.encode("OUT_OF_RANGE")
    ...
    case .unauthenticated: return try container.encode("UNAUTHENTICATED")
