...
func sample(client: SecurityCenterClient, organizationId: String, muteConfigId: String) async throws
{
  let response = try await client.updateMuteConfig(
...
struct SnippetRunner {
  static func main() async throws {
    do {
      ...
      try await sample(
        client: client, organizationId: "[placeholder]", muteConfigId: "[placeholder]")
    } catch {
      print("Error: \(error)")
    }
  }
