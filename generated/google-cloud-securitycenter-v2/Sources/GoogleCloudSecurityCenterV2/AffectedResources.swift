...
public struct AffectedResources: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  /// The count of resources affected by the finding.
  public var count: Swift.Int64 = Swift.Int64()

  /// Initialize a new instance of `AffectedResources`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AffectedResources().with { $0.count = ... }
  /// ```
