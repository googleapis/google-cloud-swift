...
public struct GetNotificationConfigRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetNotificationConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetNotificationConfigRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securitycenter.v2.GetNotificationConfigRequest"
  }
