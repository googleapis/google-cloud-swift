...
/// default is global.
public struct GetMuteConfigRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetMuteConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetMuteConfigRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securitycenter.v2.GetMuteConfigRequest"
  }
