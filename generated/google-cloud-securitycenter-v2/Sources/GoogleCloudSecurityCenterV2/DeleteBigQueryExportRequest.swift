...
public struct DeleteBigQueryExportRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteBigQueryExportRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteBigQueryExportRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securitycenter.v2.DeleteBigQueryExportRequest"
  }
