...
/// resource.
public struct ListAttackPathsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListAttackPathsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAttackPathsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securitycenter.v2.ListAttackPathsRequest"
  }
