...
public struct DeleteNotificationConfigRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteNotificationConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteNotificationConfigRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securitycenter.v2.DeleteNotificationConfigRequest"
  }
