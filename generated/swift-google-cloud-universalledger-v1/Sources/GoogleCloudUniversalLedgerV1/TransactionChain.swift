...
public struct TransactionChain: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var units: [Foundation.Data] = []

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `TransactionChain`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = TransactionChain().with { $0.units = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Foundation.Data].self, forKey: .units) {
      self.units = value
    }
