...
///   them to named cases.
public enum SettlementMode: Codable, Equatable, Hashable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "SETTLEMENT_MODE_UNSPECIFIED"
    case .deferred: return "SETTLEMENT_MODE_DEFERRED"
    case .instant: return "SETTLEMENT_MODE_INSTANT"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:SettlementMode/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "SETTLEMENT_MODE_UNSPECIFIED": self = .unspecified
    case "SETTLEMENT_MODE_DEFERRED": self = .deferred
    case "SETTLEMENT_MODE_INSTANT": self = .instant
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:SettlementMode/unknownIntValue(_:)).
  public init(intValue: Int) {
    switch intValue {
    case 0: self = .unspecified
    case 1: self = .deferred
    case 2: self = .instant
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    switch self {
    case .unspecified: return try container.encode("SETTLEMENT_MODE_UNSPECIFIED")
    case .deferred: return try container.encode("SETTLEMENT_MODE_DEFERRED")
    case .instant: return try container.encode("SETTLEMENT_MODE_INSTANT")
