...
public struct SubmitTransactionResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SubmitTransactionResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SubmitTransactionResponse().with { $0.transactionDigestHex = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.universalledger.v1.SubmitTransactionResponse"
  }
