...
public struct QueryTransactionStateResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = QueryTransactionStateResponse().with { $0.transactionAttempts = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.universalledger.v1.QueryTransactionStateResponse"
  }
