...
public struct CreateTokenManager: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CreateTokenManager`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateTokenManager().with { $0.publicKey = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.universalledger.v1.CreateTokenManager"
  }
