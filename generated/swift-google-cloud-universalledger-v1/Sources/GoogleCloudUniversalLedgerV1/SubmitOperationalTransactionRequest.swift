...
public struct SubmitOperationalTransactionRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var serializedSignedOperationalTransaction: Foundation.Data = Foundation.Data()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `SubmitOperationalTransactionRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SubmitOperationalTransactionRequest().with { $0.endpoint = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let serializedSignedOperationalTransaction = CodingKeys(
      stringValue: "serializedSignedOperationalTransaction")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      Foundation.Data.self, forKey: .serializedSignedOperationalTransaction)
    {
      self.serializedSignedOperationalTransaction = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(
      self.serializedSignedOperationalTransaction, forKey: .serializedSignedOperationalTransaction)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.universalledger.v1.SubmitOperationalTransactionRequest"
  }
