...
public struct QueryAccountResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `QueryAccountResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = QueryAccountResponse().with { $0.account = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.universalledger.v1.QueryAccountResponse"
  }
