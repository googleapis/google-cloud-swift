...
///   them to named cases.
public enum ContractPermission: Codable, Equatable, Hashable, Sendable {
  /// Invalid permission.
  case unspecified
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "CONTRACT_PERMISSION_UNSPECIFIED"
    case .storage: return "CONTRACT_PERMISSION_STORAGE"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:ContractPermission/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "CONTRACT_PERMISSION_UNSPECIFIED": self = .unspecified
    case "CONTRACT_PERMISSION_STORAGE": self = .storage
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:ContractPermission/unknownIntValue(_:)).
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    switch self {
    case .unspecified: return try container.encode("CONTRACT_PERMISSION_UNSPECIFIED")
    case .storage: return try container.encode("CONTRACT_PERMISSION_STORAGE")
