...
/// Operator.
public struct QualifiedCurrencyValue: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Required. The Currency Operator ID administering the currency.
  public var operatorId: Swift.String = Swift.String()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `QualifiedCurrencyValue`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = QualifiedCurrencyValue().with { $0.operatorId = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.universalledger.v1.QualifiedCurrencyValue"
  }
