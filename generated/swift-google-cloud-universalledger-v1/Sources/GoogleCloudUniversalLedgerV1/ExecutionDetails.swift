...
public struct ExecutionDetails: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ExecutionDetails`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ExecutionDetails().with { $0.roundId = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.universalledger.v1.ExecutionDetails"
  }
