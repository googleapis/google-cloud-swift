...
public struct AutoMlImageObjectDetectionMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      AutoMlImageObjectDetectionMetadata.SuccessfulStopReason.self, forKey: .successfulStopReason)
    {
