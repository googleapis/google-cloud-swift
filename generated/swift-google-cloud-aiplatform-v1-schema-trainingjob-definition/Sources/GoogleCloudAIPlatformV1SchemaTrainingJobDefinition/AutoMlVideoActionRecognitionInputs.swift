...
public struct AutoMlVideoActionRecognitionInputs: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = AutoMlVideoActionRecognitionInputs().with { $0.modelType = ... }
  /// ```
  ...
  public enum ModelType: Codable, Equatable, Sendable {
    ...
    public var intValue: Int? {
      ...
      case .mobileCoralVersatile1: return 4
    ...
    public init(intValue: Int) {
      ...
      case 4: self = .mobileCoralVersatile1
