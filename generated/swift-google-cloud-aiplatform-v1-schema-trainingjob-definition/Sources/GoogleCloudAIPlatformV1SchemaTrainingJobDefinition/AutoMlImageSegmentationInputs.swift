...
public struct AutoMlImageSegmentationInputs: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public enum ModelType: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .cloudLowAccuracy1: return try container.encode("CLOUD_LOW_ACCURACY_1")
