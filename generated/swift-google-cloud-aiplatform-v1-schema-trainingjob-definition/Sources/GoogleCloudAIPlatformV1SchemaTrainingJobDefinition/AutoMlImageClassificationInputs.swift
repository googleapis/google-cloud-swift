...
public struct AutoMlImageClassificationInputs: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  public var modelType: AutoMlImageClassificationInputs.ModelType =
  ...
  public var multiLabel: Swift.Bool = Swift.Bool()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `AutoMlImageClassificationInputs`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AutoMlImageClassificationInputs().with { $0.modelType = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let multiLabel = CodingKeys(stringValue: "multiLabel")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      AutoMlImageClassificationInputs.ModelType.self, forKey: .modelType)
    {
  ...
  public enum ModelType: Codable, Equatable, Hashable, Sendable {
    ...
    public var intValue: Int? {
      ...
      case .cloud: return 1
      case .mobileTfLowLatency1: return 2
      case .mobileTfVersatile1: return 3
      case .mobileTfHighAccuracy1: return 4
    ...
    public init(intValue: Int) {
      ...
      case 1: self = .cloud
      case 2: self = .mobileTfLowLatency1
      case 3: self = .mobileTfVersatile1
      case 4: self = .mobileTfHighAccuracy1
