  ...
  Sendable
{
  ...
  public var inputs: AutoMlVideoClassificationInputs? = nil

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `AutoMlVideoClassification`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AutoMlVideoClassification().with { $0.inputs = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.inputs = try container.decodeIfPresent(
      AutoMlVideoClassificationInputs.self, forKey: .inputs)
