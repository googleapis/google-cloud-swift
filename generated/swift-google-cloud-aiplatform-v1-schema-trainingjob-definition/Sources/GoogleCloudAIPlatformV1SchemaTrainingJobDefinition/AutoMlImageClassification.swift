  ...
  Sendable
{
  ...
  public var inputs: AutoMlImageClassificationInputs? = nil
  ...
  ///
  /// ```
  /// let value = AutoMlImageClassification().with { $0.inputs = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.inputs = try container.decodeIfPresent(
      AutoMlImageClassificationInputs.self, forKey: .inputs)
