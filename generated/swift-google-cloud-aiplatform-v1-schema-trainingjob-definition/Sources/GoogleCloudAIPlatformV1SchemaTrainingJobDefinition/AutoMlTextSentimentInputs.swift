  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let sentimentMax = CodingKeys(stringValue: "sentimentMax")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.Int32.self, forKey: .sentimentMax) {
      self.sentimentMax = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.sentimentMax, forKey: .sentimentMax)
