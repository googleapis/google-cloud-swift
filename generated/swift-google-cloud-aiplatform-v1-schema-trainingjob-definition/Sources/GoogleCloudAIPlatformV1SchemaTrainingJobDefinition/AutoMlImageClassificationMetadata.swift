...
public struct AutoMlImageClassificationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = AutoMlImageClassificationMetadata().with { $0.costMilliNodeHours = ... }
  /// ```
