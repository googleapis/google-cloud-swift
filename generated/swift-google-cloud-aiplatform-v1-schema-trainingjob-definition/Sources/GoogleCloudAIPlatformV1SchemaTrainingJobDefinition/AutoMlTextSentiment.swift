...
public struct AutoMlTextSentiment: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The input parameters of this TrainingJob.
  public var inputs: AutoMlTextSentimentInputs? = nil

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `AutoMlTextSentiment`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AutoMlTextSentiment().with { $0.inputs = ... }
  /// ```
