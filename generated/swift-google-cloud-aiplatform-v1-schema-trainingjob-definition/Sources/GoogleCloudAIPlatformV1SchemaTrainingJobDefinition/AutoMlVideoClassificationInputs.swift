...
public struct AutoMlVideoClassificationInputs: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  public var modelType: AutoMlVideoClassificationInputs.ModelType =
    AutoMlVideoClassificationInputs.ModelType()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `AutoMlVideoClassificationInputs`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AutoMlVideoClassificationInputs().with { $0.modelType = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      AutoMlVideoClassificationInputs.ModelType.self, forKey: .modelType)
    {
  ...
  public enum ModelType: Codable, Equatable, Sendable {
    ...
    public var intValue: Int? {
      ...
      case .mobileJetsonVersatile1: return 3
    ...
    public init(intValue: Int) {
      ...
      case 3: self = .mobileJetsonVersatile1
