...
public struct FetchModelServersResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Output only. List of available model servers. Open-source model servers use
  /// simplified, lowercase names (e.g., `vllm`).
  public var modelServers: [Swift.String] = []
  ...
  /// Initialize a new instance of `FetchModelServersResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FetchModelServersResponse().with { $0.modelServers = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let modelServers = CodingKeys(stringValue: "modelServers")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Swift.String].self, forKey: .modelServers) {
      self.modelServers = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.modelServers, forKey: .modelServers)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkerecommender.v1.FetchModelServersResponse"
  }
