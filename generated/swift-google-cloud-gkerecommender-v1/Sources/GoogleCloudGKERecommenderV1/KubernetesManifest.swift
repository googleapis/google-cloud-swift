...
public struct KubernetesManifest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `KubernetesManifest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = KubernetesManifest().with { $0.kind = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkerecommender.v1.KubernetesManifest"
  }
