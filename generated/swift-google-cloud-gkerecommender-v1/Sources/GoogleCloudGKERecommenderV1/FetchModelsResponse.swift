...
public struct FetchModelsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `FetchModelsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FetchModelsResponse().with { $0.models = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkerecommender.v1.FetchModelsResponse"
  }
