...
public struct ListStreamsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListStreamsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListStreamsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datastream.v1.ListStreamsRequest"
  }
