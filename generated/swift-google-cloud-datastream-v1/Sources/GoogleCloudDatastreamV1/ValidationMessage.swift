  ...
  Sendable
{
  ...
  public var level: ValidationMessage.Level = ValidationMessage.Level()
  ...
  ///
  /// ```
  /// let value = ValidationMessage().with { $0.message = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(ValidationMessage.Level.self, forKey: .level) {
      self.level = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datastream.v1.ValidationMessage"
  }
