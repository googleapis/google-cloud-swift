...
public struct SqlServerProfile: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SqlServerProfile`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SqlServerProfile().with { $0.hostname = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datastream.v1.SqlServerProfile"
  }
