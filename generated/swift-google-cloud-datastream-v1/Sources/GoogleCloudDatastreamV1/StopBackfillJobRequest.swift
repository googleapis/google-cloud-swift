...
/// object.
public struct StopBackfillJobRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `StopBackfillJobRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = StopBackfillJobRequest().with { $0.object = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datastream.v1.StopBackfillJobRequest"
  }
