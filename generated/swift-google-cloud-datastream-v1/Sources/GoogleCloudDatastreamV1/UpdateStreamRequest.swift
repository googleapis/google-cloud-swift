...
public struct UpdateStreamRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateStreamRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateStreamRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datastream.v1.UpdateStreamRequest"
  }
