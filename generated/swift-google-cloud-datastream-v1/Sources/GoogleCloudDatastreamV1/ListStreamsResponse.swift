...
public struct ListStreamsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// List of streams
  ...
  /// Initialize a new instance of `ListStreamsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListStreamsResponse().with { $0.streams = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Stream].self, forKey: .streams) {
      self.streams = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datastream.v1.ListStreamsResponse"
  }
...
extension ListStreamsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Stream] {
    return self.streams
  }
