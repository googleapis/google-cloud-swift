...
public struct HostAddress: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `HostAddress`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = HostAddress().with { $0.hostname = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datastream.v1.HostAddress"
  }
