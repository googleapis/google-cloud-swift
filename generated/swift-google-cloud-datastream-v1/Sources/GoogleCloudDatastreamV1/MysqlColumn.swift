...
/// MySQL Column.
public struct MysqlColumn: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Column name.
  ...
  /// Initialize a new instance of `MysqlColumn`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = MysqlColumn().with { $0.column = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datastream.v1.MysqlColumn"
  }
