...
public struct CreateRouteRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CreateRouteRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateRouteRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datastream.v1.CreateRouteRequest"
  }
