...
/// SQLServer Column.
public struct SqlServerColumn: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Column name.
  ...
  /// Initialize a new instance of `SqlServerColumn`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SqlServerColumn().with { $0.column = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datastream.v1.SqlServerColumn"
  }
