...
public struct StartBackfillJobRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `StartBackfillJobRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = StartBackfillJobRequest().with { $0.object = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datastream.v1.StartBackfillJobRequest"
  }
