...
public struct ListStreamObjectsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListStreamObjectsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListStreamObjectsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datastream.v1.ListStreamObjectsRequest"
  }
