  ...
  Sendable
{
  ...
  public var validationResult: ValidationResult? = nil
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let validationResult = CodingKeys(stringValue: "validationResult")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.validationResult = try container.decodeIfPresent(
      ValidationResult.self, forKey: .validationResult)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.validationResult, forKey: .validationResult)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datastream.v1.OperationMetadata"
  }
