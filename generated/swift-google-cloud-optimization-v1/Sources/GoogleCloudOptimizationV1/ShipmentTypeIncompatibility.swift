...
public struct ShipmentTypeIncompatibility: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let incompatibilityMode = CodingKeys(stringValue: "incompatibilityMode")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      ShipmentTypeIncompatibility.IncompatibilityMode.self, forKey: .incompatibilityMode)
    {
      self.incompatibilityMode = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.incompatibilityMode, forKey: .incompatibilityMode)
