...
public struct CapacityQuantity: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CapacityQuantity`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CapacityQuantity().with { $0.type = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.optimization.v1.CapacityQuantity"
  }
