...
public struct OptimizeToursValidationError: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public struct FieldReference: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
