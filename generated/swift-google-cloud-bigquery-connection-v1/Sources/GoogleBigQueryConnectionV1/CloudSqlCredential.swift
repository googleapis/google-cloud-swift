...
public struct CloudSqlCredential: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CloudSqlCredential`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CloudSqlCredential().with { $0.username = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.connection.v1.CloudSqlCredential"
  }
