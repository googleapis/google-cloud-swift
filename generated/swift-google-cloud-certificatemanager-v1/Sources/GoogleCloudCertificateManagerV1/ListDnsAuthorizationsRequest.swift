...
public struct ListDnsAuthorizationsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDnsAuthorizationsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDnsAuthorizationsRequest().with { $0.parent = ... }
  /// ```
