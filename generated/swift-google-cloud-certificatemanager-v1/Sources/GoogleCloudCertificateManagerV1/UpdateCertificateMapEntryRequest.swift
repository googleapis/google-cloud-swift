...
public struct UpdateCertificateMapEntryRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateCertificateMapEntryRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateCertificateMapEntryRequest().with { $0.certificateMapEntry = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.certificatemanager.v1.UpdateCertificateMapEntryRequest"
  }
