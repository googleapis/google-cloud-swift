...
public struct DeleteCertificateIssuanceConfigRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteCertificateIssuanceConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteCertificateIssuanceConfigRequest().with { $0.name = ... }
  /// ```
