  ...
  Sendable
{
  ...
  public var certificateIssuanceConfigs: [CertificateIssuanceConfig] = []
  ...
  /// Initialize a new instance of `ListCertificateIssuanceConfigsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCertificateIssuanceConfigsResponse().with { $0.certificateIssuanceConfigs = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let certificateIssuanceConfigs = CodingKeys(stringValue: "certificateIssuanceConfigs")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [CertificateIssuanceConfig].self, forKey: .certificateIssuanceConfigs)
    {
      self.certificateIssuanceConfigs = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.certificateIssuanceConfigs, forKey: .certificateIssuanceConfigs)
