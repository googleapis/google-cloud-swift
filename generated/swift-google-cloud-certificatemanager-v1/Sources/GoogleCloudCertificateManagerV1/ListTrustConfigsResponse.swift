  ...
  Sendable
{
  ...
  public var trustConfigs: [TrustConfig] = []
  ...
  /// Initialize a new instance of `ListTrustConfigsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListTrustConfigsResponse().with { $0.trustConfigs = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let trustConfigs = CodingKeys(stringValue: "trustConfigs")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([TrustConfig].self, forKey: .trustConfigs) {
      self.trustConfigs = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.trustConfigs, forKey: .trustConfigs)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.certificatemanager.v1.ListTrustConfigsResponse"
  }
