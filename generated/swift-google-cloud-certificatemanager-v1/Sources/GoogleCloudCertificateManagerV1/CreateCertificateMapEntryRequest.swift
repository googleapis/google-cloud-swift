...
public struct CreateCertificateMapEntryRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var certificateMapEntryId: Swift.String = Swift.String()
  ...
  ///
  /// ```
  /// let value = CreateCertificateMapEntryRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.certificatemanager.v1.CreateCertificateMapEntryRequest"
  }
