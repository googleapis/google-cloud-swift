...
public struct ListTrustConfigsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListTrustConfigsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListTrustConfigsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.certificatemanager.v1.ListTrustConfigsRequest"
  }
