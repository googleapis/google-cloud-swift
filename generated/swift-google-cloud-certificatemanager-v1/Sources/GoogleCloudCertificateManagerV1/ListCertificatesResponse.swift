...
public struct ListCertificatesResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Certificate].self, forKey: .certificates) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.certificatemanager.v1.ListCertificatesResponse"
  }
...
extension ListCertificatesResponse: GoogleGax._PaginatedResponse {
