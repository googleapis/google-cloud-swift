...
public struct CreateTrustConfigRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// `[a-z0-9-]{1,63}`.
  public var trustConfigId: Swift.String = Swift.String()
  ...
  ///
  /// ```
  /// let value = CreateTrustConfigRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.certificatemanager.v1.CreateTrustConfigRequest"
  }
