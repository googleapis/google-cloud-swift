...
public struct UpdateDnsAuthorizationRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateDnsAuthorizationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateDnsAuthorizationRequest().with { $0.dnsAuthorization = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.certificatemanager.v1.UpdateDnsAuthorizationRequest"
  }
