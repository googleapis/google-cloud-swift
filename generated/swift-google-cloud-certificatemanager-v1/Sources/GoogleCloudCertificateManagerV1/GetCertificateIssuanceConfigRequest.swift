...
public struct GetCertificateIssuanceConfigRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetCertificateIssuanceConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetCertificateIssuanceConfigRequest().with { $0.name = ... }
  /// ```
