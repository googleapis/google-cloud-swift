  ...
  Sendable
{
  ...
  public var certificateMapEntries: [CertificateMapEntry] = []
  ...
  /// Initialize a new instance of `ListCertificateMapEntriesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCertificateMapEntriesResponse().with { $0.certificateMapEntries = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let certificateMapEntries = CodingKeys(stringValue: "certificateMapEntries")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [CertificateMapEntry].self, forKey: .certificateMapEntries)
    {
      self.certificateMapEntries = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.certificateMapEntries, forKey: .certificateMapEntries)
