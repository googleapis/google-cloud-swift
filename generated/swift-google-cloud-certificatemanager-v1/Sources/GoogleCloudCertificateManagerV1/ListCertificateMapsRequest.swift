...
public struct ListCertificateMapsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListCertificateMapsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCertificateMapsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.certificatemanager.v1.ListCertificateMapsRequest"
  }
