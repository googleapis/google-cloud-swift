...
public struct ListCertificateIssuanceConfigsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListCertificateIssuanceConfigsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCertificateIssuanceConfigsRequest().with { $0.parent = ... }
  /// ```
