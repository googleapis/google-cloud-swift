...
public struct ListDnsAuthorizationsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// A list of dns authorizations for the parent resource.
  public var dnsAuthorizations: [DnsAuthorization] = []
  ...
  /// Initialize a new instance of `ListDnsAuthorizationsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDnsAuthorizationsResponse().with { $0.dnsAuthorizations = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [DnsAuthorization].self, forKey: .dnsAuthorizations)
    {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.certificatemanager.v1.ListDnsAuthorizationsResponse"
  }
...
extension ListDnsAuthorizationsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [DnsAuthorization] {
    return self.dnsAuthorizations
  }
