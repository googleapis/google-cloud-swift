...
public struct UpdateCertificateMapRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateCertificateMapRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateCertificateMapRequest().with { $0.certificateMap = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.certificatemanager.v1.UpdateCertificateMapRequest"
  }
