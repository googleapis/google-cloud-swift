...
public struct CreateQaScorecardRevisionRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var qaScorecardRevision: QaScorecardRevision? = nil
  ...
  ///
  /// ```
  /// let value = CreateQaScorecardRevisionRequest().with { $0.parent = ... }
  /// ```
