...
public struct DeleteQaScorecardRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteQaScorecardRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteQaScorecardRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.contactcenterinsights.v1.DeleteQaScorecardRequest"
  }
