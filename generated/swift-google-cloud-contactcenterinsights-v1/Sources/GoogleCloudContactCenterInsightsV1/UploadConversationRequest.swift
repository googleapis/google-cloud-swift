...
public struct UploadConversationRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UploadConversationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UploadConversationRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.contactcenterinsights.v1.UploadConversationRequest"
  }
