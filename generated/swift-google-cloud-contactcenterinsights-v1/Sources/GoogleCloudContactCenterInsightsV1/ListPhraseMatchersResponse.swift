  ...
  Sendable
{
  ...
  public var phraseMatchers: [PhraseMatcher] = []
  ...
  /// Initialize a new instance of `ListPhraseMatchersResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPhraseMatchersResponse().with { $0.phraseMatchers = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([PhraseMatcher].self, forKey: .phraseMatchers) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.contactcenterinsights.v1.ListPhraseMatchersResponse"
  }
