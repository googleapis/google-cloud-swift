...
public struct ListFeedbackLabelsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListFeedbackLabelsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListFeedbackLabelsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.contactcenterinsights.v1.ListFeedbackLabelsRequest"
  }
