  ...
  Sendable
{
  ...
  /// Initialize a new instance of `SmartReplyData`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SmartReplyData().with { $0.reply = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.contactcenterinsights.v1.SmartReplyData"
  }
