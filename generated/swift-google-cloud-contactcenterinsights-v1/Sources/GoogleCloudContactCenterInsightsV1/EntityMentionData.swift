  ...
  Sendable
{
  ...
  public var entityUniqueId: Swift.String = Swift.String()

  /// The type of the entity mention.
  public var type: EntityMentionData.MentionType = EntityMentionData.MentionType()
  ...
  ///
  /// ```
  /// let value = EntityMentionData().with { $0.entityUniqueId = ... }
  /// ```
  ...
  ///   them to named cases.
  public enum MentionType: Codable, Equatable, Hashable, Sendable {
    /// Unspecified.
    case unspecified
    /// Proper noun.
    case proper
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "MENTION_TYPE_UNSPECIFIED"
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:MentionType/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "MENTION_TYPE_UNSPECIFIED": self = .unspecified
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:MentionType/unknownIntValue(_:)).
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("MENTION_TYPE_UNSPECIFIED")
      case .proper: return try container.encode("PROPER")
      case .common: return try container.encode("COMMON")
