...
public struct ListPhraseMatchersRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListPhraseMatchersRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPhraseMatchersRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.contactcenterinsights.v1.ListPhraseMatchersRequest"
  }
