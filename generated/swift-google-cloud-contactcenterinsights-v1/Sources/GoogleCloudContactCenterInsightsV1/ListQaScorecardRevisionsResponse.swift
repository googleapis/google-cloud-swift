...
public struct ListQaScorecardRevisionsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The QaScorecards under the parent.
  public var qaScorecardRevisions: [QaScorecardRevision] = []
  ...
  /// Initialize a new instance of `ListQaScorecardRevisionsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListQaScorecardRevisionsResponse().with { $0.qaScorecardRevisions = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [QaScorecardRevision].self, forKey: .qaScorecardRevisions)
    {
...
extension ListQaScorecardRevisionsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [QaScorecardRevision] {
    return self.qaScorecardRevisions
  }
