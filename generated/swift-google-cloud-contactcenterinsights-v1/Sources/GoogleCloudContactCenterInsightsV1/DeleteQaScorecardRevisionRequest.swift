...
public struct DeleteQaScorecardRevisionRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteQaScorecardRevisionRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteQaScorecardRevisionRequest().with { $0.name = ... }
  /// ```
