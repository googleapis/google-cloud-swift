  ...
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([View].self, forKey: .views) {
      self.views = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.contactcenterinsights.v1.ListViewsResponse"
  }
...
extension ListViewsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [View] {
    return self.views
  }
