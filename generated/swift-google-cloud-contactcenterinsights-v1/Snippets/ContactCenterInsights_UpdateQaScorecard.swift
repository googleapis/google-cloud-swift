...
func sample(
  ...
  let response = try await client.updateQaScorecard(
    request: UpdateQaScorecardRequest()
      .with {
        $0.qaScorecard = QaScorecard().with {
          $0.name = "projects/\(projectId)/locations/\(locationId)/qaScorecards/\(qaScorecardId)"
        }
