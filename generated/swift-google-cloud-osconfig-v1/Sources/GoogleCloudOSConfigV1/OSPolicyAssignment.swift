...
public struct OSPolicyAssignment: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Resource name.
  ///
  ...
  ///            present.
  public struct LabelSet: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
  ...
  public struct InstanceFilter: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    Sendable
  {
    ...
    /// applied.
    public var minWaitDuration: GoogleWKT.WKTDuration? = nil
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.minWaitDuration = try container.decodeIfPresent(
        GoogleWKT.WKTDuration.self, forKey: .minWaitDuration)
      for key in container.allKeys where !CodingKeys._knownKeys.contains(key.stringValue) {
        self._unknownFields.json[key.stringValue] = try container.decode(
          GoogleWKT.WKTValue.self, forKey: key)
      }
  ...
  public enum RolloutState: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("ROLLOUT_STATE_UNSPECIFIED")
