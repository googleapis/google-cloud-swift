  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let classifications = CodingKeys(stringValue: "classifications")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [WindowsUpdateSettings.Classification].self, forKey: .classifications)
    {
  ...
  public enum Classification: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .featurePack: return try container.encode("FEATURE_PACK")
      case .servicePack: return try container.encode("SERVICE_PACK")
      case .tool: return try container.encode("TOOL")
      case .updateRollup: return try container.encode("UPDATE_ROLLUP")
