  ...
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.adminUsers = try container.decodeIfPresent(ClusterUser.self, forKey: .adminUsers)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.adminUsers, forKey: .adminUsers)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.edgecontainer.v1.Authorization"
  }
