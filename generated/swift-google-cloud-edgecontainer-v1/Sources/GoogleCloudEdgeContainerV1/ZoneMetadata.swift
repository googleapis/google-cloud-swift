...
public struct ZoneMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let rackTypes = CodingKeys(stringValue: "rackTypes")
    static let configData = CodingKeys(stringValue: "configData")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Quota].self, forKey: .quota) {
      self.quota = value
    }
    if let value = try container.decodeIfPresent(
      [Swift.String: ZoneMetadata.RackType].self, forKey: .rackTypes)
    {
      self.rackTypes = value
    }
    self.configData = try container.decodeIfPresent(ConfigData.self, forKey: .configData)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.quota, forKey: .quota)
    try container.encode(self.rackTypes, forKey: .rackTypes)
    try container.encodeIfPresent(self.configData, forKey: .configData)
  ...
  public enum RackType: Codable, Equatable, Sendable {
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:RackType/unknownStringValue(_:)).
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:RackType/unknownIntValue(_:)).
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("RACK_TYPE_UNSPECIFIED")
      case .base: return try container.encode("BASE")
      case .expansion: return try container.encode("EXPANSION")
