...
public struct ListMachinesResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListMachinesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMachinesResponse().with { $0.machines = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let machines = CodingKeys(stringValue: "machines")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Machine].self, forKey: .machines) {
      self.machines = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.machines, forKey: .machines)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.edgecontainer.v1.ListMachinesResponse"
  }
...
extension ListMachinesResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Machine] {
