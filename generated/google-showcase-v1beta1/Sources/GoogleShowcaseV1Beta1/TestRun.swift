...
public struct TestRun: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  /// The name of the test.
  /// The tests/* portion of the names are hard-coded, and do not change
  /// from session to session.
  public var test: Swift.String = Swift.String()
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.showcase.v1beta1.TestRun"
  }
