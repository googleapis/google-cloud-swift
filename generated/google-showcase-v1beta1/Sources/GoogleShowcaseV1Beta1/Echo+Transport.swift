...
extension Clients {
  final class EchoTransport: EchoStub {
    ...
    public func echoErrorDetails(
      ...
      let path = try { () throws -> Swift.String in
        return "/v1beta1/echo:error-details"
      }()
      let query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int"),
        URLQueryItem(name: "$apiVersion", value: "v1_20240408"),
    ...
    public func failEchoWithDetails(
      ...
      let path = try { () throws -> Swift.String in
        return "/v1beta1/echo:failWithDetails"
      }()
      let query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int"),
        URLQueryItem(name: "$apiVersion", value: "v1_20240408"),
    ...
    public func pagedExpand(
      ...
      let path = try { () throws -> Swift.String in
        return "/v1beta1/echo:pagedExpand"
      }()
      let query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int"),
        URLQueryItem(name: "$apiVersion", value: "v1_20240408"),
    ...
    public func pagedExpandLegacy(
      ...
      let path = try { () throws -> Swift.String in
        return "/v1beta1/echo:pagedExpandLegacy"
      }()
      let query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int"),
        URLQueryItem(name: "$apiVersion", value: "v1_20240408"),
    ...
    public func pagedExpandLegacyMapped(
      ...
      let path = try { () throws -> Swift.String in
        return "/v1beta1/echo:pagedExpandLegacyMapped"
      }()
      let query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int"),
        URLQueryItem(name: "$apiVersion", value: "v1_20240408"),
