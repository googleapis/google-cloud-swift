...
extension Clients {
  final class MessagingTransport: MessagingStub {
    ...
    public func updateRoom(
      ...
      let path = try { () throws -> Swift.String in
        guard let pathVariable0 = request.room.map({ $0.name }), !pathVariable0.isEmpty else {
          throw GoogleCloudGax.RequestError.binding("'request.room.name' is not set or is empty")
        }
        return "/v1beta1/\(pathVariable0)"
      }()
      var query = [
    ...
    public func createBlurb(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1beta1/\(pathVariable0)/blurbs"
      }()
      let query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
    ...
    public func updateBlurb(
      ...
      let path = try { () throws -> Swift.String in
        guard let pathVariable0 = request.blurb.map({ $0.name }), !pathVariable0.isEmpty else {
          throw GoogleCloudGax.RequestError.binding("'request.blurb.name' is not set or is empty")
        }
        return "/v1beta1/\(pathVariable0)"
      }()
      var query = [
    ...
    public func searchBlurbs(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1beta1/\(pathVariable0)/blurbs:search"
      }()
      let query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
    ...
    public func streamBlurbs(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1beta1/\(pathVariable0)/blurbs:stream"
      }()
      let query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
    ...
    public func sendBlurbs(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1beta1/\(pathVariable0)/blurbs:send"
      }()
      let query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
