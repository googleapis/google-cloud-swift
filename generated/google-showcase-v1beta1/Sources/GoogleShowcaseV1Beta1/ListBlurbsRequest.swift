...
/// method.
public struct ListBlurbsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListBlurbsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListBlurbsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.showcase.v1beta1.ListBlurbsRequest"
  }
