...
extension Clients {
  final class IdentityLogging: IdentityStub {
    let inner: any IdentityStub
    let logger: Logger

    public init(_ inner: any IdentityStub, logger: Logger) {
      var logger = logger
      logger[metadataKey: "gcp.artifact.id"] = "google-showcase-v1beta1"
      logger[metadataKey: "gcp.client.service"] = "localhost:7469"
      logger[metadataKey: "gcp.experimental.swift.client"] = "Identity"
      self.inner = inner
      self.logger = logger
    }
