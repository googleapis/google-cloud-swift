...
public struct GetLoginProfileRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetLoginProfileRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetLoginProfileRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.oslogin.v1.GetLoginProfileRequest"
  }
