...
public struct ImportSshPublicKeyResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The login profile information for the user.
  public var loginProfile: LoginProfile? = nil
  ...
  ///
  /// ```
  /// let value = ImportSshPublicKeyResponse().with { $0.loginProfile = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.oslogin.v1.ImportSshPublicKeyResponse"
  }
