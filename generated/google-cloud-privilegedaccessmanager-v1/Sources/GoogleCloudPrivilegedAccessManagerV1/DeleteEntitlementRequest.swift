...
public struct DeleteEntitlementRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteEntitlementRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteEntitlementRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.privilegedaccessmanager.v1.DeleteEntitlementRequest"
  }
