...
public struct CheckOnboardingStatusRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CheckOnboardingStatusRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CheckOnboardingStatusRequest().with { $0.parent = ... }
  /// ```
