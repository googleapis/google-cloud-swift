...
public struct DenyGrantRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DenyGrantRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DenyGrantRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.privilegedaccessmanager.v1.DenyGrantRequest"
  }
