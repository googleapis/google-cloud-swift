...
public struct ApproveGrantRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ApproveGrantRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ApproveGrantRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.privilegedaccessmanager.v1.ApproveGrantRequest"
  }
