...
public struct CloudControlAssessmentDetails: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The number of findings for the cloud control.
  public var findingsCount: Swift.Int32 = Swift.Int32()
  ...
  ///
  /// ```
  /// let value = CloudControlAssessmentDetails().with { $0.findingsCount = ... }
  /// ```
