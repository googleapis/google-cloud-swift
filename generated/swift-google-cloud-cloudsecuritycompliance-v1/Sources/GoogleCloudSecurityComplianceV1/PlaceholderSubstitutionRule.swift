...
public struct PlaceholderSubstitutionRule: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `PlaceholderSubstitutionRule`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = PlaceholderSubstitutionRule().with { $0.attribute = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.cloudsecuritycompliance.v1.PlaceholderSubstitutionRule"
  }
