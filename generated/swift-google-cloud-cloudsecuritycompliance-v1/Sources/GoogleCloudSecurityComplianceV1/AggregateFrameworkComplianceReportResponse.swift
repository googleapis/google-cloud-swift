...
public struct AggregateFrameworkComplianceReportResponse: Codable, Equatable, GoogleWKT
    ._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = AggregateFrameworkComplianceReportResponse().with { $0.aggregatedComplianceReports = ... }
  /// ```
