...
public struct SimilarControls: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SimilarControls`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SimilarControls().with { $0.framework = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.cloudsecuritycompliance.v1.SimilarControls"
  }
