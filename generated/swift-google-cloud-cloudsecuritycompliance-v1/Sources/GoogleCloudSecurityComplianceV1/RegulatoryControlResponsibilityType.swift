...
///   them to named cases.
public enum RegulatoryControlResponsibilityType: Codable, Equatable, Hashable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "REGULATORY_CONTROL_RESPONSIBILITY_TYPE_UNSPECIFIED"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:RegulatoryControlResponsibilityType/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "REGULATORY_CONTROL_RESPONSIBILITY_TYPE_UNSPECIFIED": self = .unspecified
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:RegulatoryControlResponsibilityType/unknownIntValue(_:)).
  public init(intValue: Int) {
    switch intValue {
    case 0: self = .unspecified
    case 1: self = .google
    case 2: self = .customer
    case 3: self = .shared
