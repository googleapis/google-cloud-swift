...
public struct AttributeSubstitutionRule: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `AttributeSubstitutionRule`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AttributeSubstitutionRule().with { $0.attribute = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.cloudsecuritycompliance.v1.AttributeSubstitutionRule"
  }
