  ...
  Sendable
{
  ...
  public var controlComplianceSummaries: [ControlComplianceSummary] = []
  ...
  ///
  /// ```
  /// let value = ListControlComplianceSummariesResponse().with { $0.controlComplianceSummaries = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let controlComplianceSummaries = CodingKeys(stringValue: "controlComplianceSummaries")
  ...
  public init(from decoder: Decoder) throws {
    ...
    {
      self.controlComplianceSummaries = value
    }
