  ...
  Sendable
{
  ...
  public var frameworkComplianceSummaries: [FrameworkComplianceSummary] = []
  ...
  /// Initialize a new instance of `ListFrameworkComplianceSummariesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListFrameworkComplianceSummariesResponse().with { $0.frameworkComplianceSummaries = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let frameworkComplianceSummaries = CodingKeys(
      stringValue: "frameworkComplianceSummaries")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [FrameworkComplianceSummary].self, forKey: .frameworkComplianceSummaries)
    {
      self.frameworkComplianceSummaries = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.frameworkComplianceSummaries, forKey: .frameworkComplianceSummaries)
