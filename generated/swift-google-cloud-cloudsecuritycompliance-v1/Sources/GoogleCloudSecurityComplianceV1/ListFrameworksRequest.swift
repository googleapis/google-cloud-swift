...
public struct ListFrameworksRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListFrameworksRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListFrameworksRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.cloudsecuritycompliance.v1.ListFrameworksRequest"
  }
