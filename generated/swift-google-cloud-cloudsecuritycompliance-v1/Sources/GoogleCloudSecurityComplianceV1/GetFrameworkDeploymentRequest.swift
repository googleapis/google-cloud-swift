...
public struct GetFrameworkDeploymentRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetFrameworkDeploymentRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetFrameworkDeploymentRequest().with { $0.name = ... }
  /// ```
