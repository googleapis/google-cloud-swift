...
public struct CloudControlDeploymentReference: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CloudControlDeploymentReference`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CloudControlDeploymentReference().with { $0.cloudControlDeployment = ... }
  /// ```
