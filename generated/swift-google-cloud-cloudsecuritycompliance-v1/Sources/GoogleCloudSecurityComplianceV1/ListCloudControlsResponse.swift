  ...
  Sendable
{
  ...
  public var cloudControls: [CloudControl] = []
  ...
  /// Initialize a new instance of `ListCloudControlsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCloudControlsResponse().with { $0.cloudControls = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let cloudControls = CodingKeys(stringValue: "cloudControls")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([CloudControl].self, forKey: .cloudControls) {
      self.cloudControls = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.cloudControls, forKey: .cloudControls)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.cloudsecuritycompliance.v1.ListCloudControlsResponse"
  }
