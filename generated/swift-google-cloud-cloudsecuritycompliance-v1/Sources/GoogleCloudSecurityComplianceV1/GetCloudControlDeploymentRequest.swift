...
public struct GetCloudControlDeploymentRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetCloudControlDeploymentRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetCloudControlDeploymentRequest().with { $0.name = ... }
  /// ```
