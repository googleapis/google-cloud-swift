...
public struct ListFrameworkComplianceSummariesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(FrameworkComplianceSummaryView.self, forKey: .view)
    {
      self.view = value
    }
