...
public struct GetFrameworkAuditRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetFrameworkAuditRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetFrameworkAuditRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.cloudsecuritycompliance.v1.GetFrameworkAuditRequest"
  }
