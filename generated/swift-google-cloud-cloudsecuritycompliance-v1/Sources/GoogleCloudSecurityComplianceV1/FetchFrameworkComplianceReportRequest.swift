...
public struct FetchFrameworkComplianceReportRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `FetchFrameworkComplianceReportRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FetchFrameworkComplianceReportRequest().with { $0.name = ... }
  /// ```
