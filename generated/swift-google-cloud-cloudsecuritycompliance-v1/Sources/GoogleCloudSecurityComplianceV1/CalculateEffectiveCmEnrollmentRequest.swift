...
public struct CalculateEffectiveCmEnrollmentRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CalculateEffectiveCmEnrollmentRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CalculateEffectiveCmEnrollmentRequest().with { $0.name = ... }
  /// ```
