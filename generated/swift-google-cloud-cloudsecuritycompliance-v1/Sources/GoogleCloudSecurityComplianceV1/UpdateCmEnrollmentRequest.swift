...
public struct UpdateCmEnrollmentRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateCmEnrollmentRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateCmEnrollmentRequest().with { $0.cmEnrollment = ... }
  /// ```
