...
public struct RegexpPattern: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `RegexpPattern`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RegexpPattern().with { $0.pattern = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.cloudsecuritycompliance.v1.RegexpPattern"
  }
