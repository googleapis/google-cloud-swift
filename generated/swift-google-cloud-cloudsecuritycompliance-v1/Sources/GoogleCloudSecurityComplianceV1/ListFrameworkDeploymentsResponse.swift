  ...
  Sendable
{
  ...
  public var frameworkDeployments: [FrameworkDeployment] = []
  ...
  /// Initialize a new instance of `ListFrameworkDeploymentsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListFrameworkDeploymentsResponse().with { $0.frameworkDeployments = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let frameworkDeployments = CodingKeys(stringValue: "frameworkDeployments")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [FrameworkDeployment].self, forKey: .frameworkDeployments)
    {
      self.frameworkDeployments = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.frameworkDeployments, forKey: .frameworkDeployments)
