...
public struct ObservationDetails: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Output only. The current value.
  public var currentValue: Swift.String = Swift.String()
  ...
  /// Initialize a new instance of `ObservationDetails`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ObservationDetails().with { $0.currentValue = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let currentValue = CodingKeys(stringValue: "currentValue")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .currentValue) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.cloudsecuritycompliance.v1.ObservationDetails"
  }
