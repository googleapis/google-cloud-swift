  ...
  Sendable
{
  ...
  public var frameworkAudits: [FrameworkAudit] = []
  ...
  /// Initialize a new instance of `ListFrameworkAuditsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListFrameworkAuditsResponse().with { $0.frameworkAudits = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let frameworkAudits = CodingKeys(stringValue: "frameworkAudits")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([FrameworkAudit].self, forKey: .frameworkAudits) {
      self.frameworkAudits = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.frameworkAudits, forKey: .frameworkAudits)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.cloudsecuritycompliance.v1.ListFrameworkAuditsResponse"
  }
