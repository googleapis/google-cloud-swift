  ...
  Sendable
{
  ...
  public var compliantCount: Swift.Int32 = Swift.Int32()
  ...
  ///
  /// ```
  /// let value = ReportSummary().with { $0.totalCount = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.cloudsecuritycompliance.v1.ReportSummary"
  }
