...
extension Clients {
  final class CmEnrollmentServiceTransport: CmEnrollmentServiceStub {
    ...
    public func updateCmEnrollment(
      ...
      let (path, query, configure) = try {
        ...
        if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
          guard
            let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
              request.cmEnrollment.map({ $0.name }),
              matching: [
                .literal("organizations/"), .singleWildcard, .literal("/locations/"),
                .singleWildcard, .literal("/cmEnrollment"),
              ],
              fieldName: "cm_enrollment.name")
          else {
            return nil
          }
        ...
        do {
          ...
          builder.maybeAdd(
            ...
            fieldName: "cm_enrollment.name",
            expecting: "organizations/*/locations/*/cmEnrollment"
          )
        ...
        do {
          ...
          builder.maybeAdd(
            ...
            fieldName: "cm_enrollment.name",
            expecting: "folders/*/locations/*/cmEnrollment"
          )
          paths.append(builder.build())
        }
        do {
          ...
          builder.maybeAdd(
            ...
            fieldName: "cm_enrollment.name",
            expecting: "projects/*/locations/*/cmEnrollment"
          )
          paths.append(builder.build())
        }
      ...
      return try await req.rpc(
        GoogleCloudSecurityComplianceV1.CmEnrollment.self, timeout: options.attemptTimeout
      ).get()
    }
    ...
    public func calculateEffectiveCmEnrollment(
      ...
      let (path, query, configure) = try {
        ...
        if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
          ...
          let path = "/v1/\(pathVariable0):calculate"
          let query = [
            URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
          ]
          return (path, query)
