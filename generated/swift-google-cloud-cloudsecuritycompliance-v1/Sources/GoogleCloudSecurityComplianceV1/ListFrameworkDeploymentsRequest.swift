...
public struct ListFrameworkDeploymentsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListFrameworkDeploymentsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListFrameworkDeploymentsRequest().with { $0.parent = ... }
  /// ```
