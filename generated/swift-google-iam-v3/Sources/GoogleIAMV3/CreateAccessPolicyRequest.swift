  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let accessPolicyId = CodingKeys(stringValue: "accessPolicyId")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .accessPolicyId) {
      self.accessPolicyId = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.accessPolicyId, forKey: .accessPolicyId)
