...
public struct SearchAccessPolicyBindingsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SearchAccessPolicyBindingsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SearchAccessPolicyBindingsResponse().with { $0.policyBindings = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([PolicyBinding].self, forKey: .policyBindings) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.iam.v3.SearchAccessPolicyBindingsResponse"
  }
...
extension SearchAccessPolicyBindingsResponse: GoogleGax._PaginatedResponse {
