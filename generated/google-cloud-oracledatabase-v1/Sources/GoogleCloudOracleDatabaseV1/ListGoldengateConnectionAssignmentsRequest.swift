...
public struct ListGoldengateConnectionAssignmentsRequest: Codable, Equatable, GoogleCloudWkt
    ._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListGoldengateConnectionAssignmentsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListGoldengateConnectionAssignmentsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return
      "type.googleapis.com/google.cloud.oracledatabase.v1.ListGoldengateConnectionAssignmentsRequest"
  }
