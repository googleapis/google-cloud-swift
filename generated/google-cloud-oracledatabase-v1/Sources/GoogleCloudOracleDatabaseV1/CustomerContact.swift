...
public struct CustomerContact: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CustomerContact`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CustomerContact().with { $0.email = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.oracledatabase.v1.CustomerContact"
  }
