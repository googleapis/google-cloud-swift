  ...
  public func createCloudExadataInfrastructure(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try CloudExadataInfrastructure(fromAny: anyValueUnwrapped)
  ...
  public func createCloudVmCluster(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try CloudVmCluster(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createOdbNetwork(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try OdbNetwork(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createOdbSubnet(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try OdbSubnet(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createExadbVmCluster(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try ExadbVmCluster(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createExascaleDbStorageVault(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try ExascaleDbStorageVault(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createDbSystem(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try DbSystem(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createGoldengateDeployment(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try GoldengateDeployment(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createGoldengateConnection(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try GoldengateConnection(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func createGoldengateConnectionAssignment(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try GoldengateConnectionAssignment(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
