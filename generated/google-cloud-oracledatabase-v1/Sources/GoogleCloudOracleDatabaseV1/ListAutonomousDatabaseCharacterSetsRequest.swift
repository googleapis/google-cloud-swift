...
public struct ListAutonomousDatabaseCharacterSetsRequest: Codable, Equatable, GoogleCloudWkt
    ._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListAutonomousDatabaseCharacterSetsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAutonomousDatabaseCharacterSetsRequest().with { $0.parent = ... }
  /// ```
