...
public struct DatabaseCharacterSet: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  public var characterSetType: DatabaseCharacterSet.CharacterSetType =
  ...
  ///
  /// ```
  /// let value = DatabaseCharacterSet().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.oracledatabase.v1.DatabaseCharacterSet"
  }
