...
/// attributes.
public struct NameValuePair: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `NameValuePair`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = NameValuePair().with { $0.key = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.oracledatabase.v1.NameValuePair"
  }
