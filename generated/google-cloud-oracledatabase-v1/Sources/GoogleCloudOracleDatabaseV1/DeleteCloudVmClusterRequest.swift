...
public struct DeleteCloudVmClusterRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteCloudVmClusterRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteCloudVmClusterRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.oracledatabase.v1.DeleteCloudVmClusterRequest"
  }
