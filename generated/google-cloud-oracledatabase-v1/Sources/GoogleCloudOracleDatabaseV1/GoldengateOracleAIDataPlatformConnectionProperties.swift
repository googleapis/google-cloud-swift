...
public struct GoldengateOracleAIDataPlatformConnectionProperties: Codable, Equatable, GoogleCloudWkt
    ._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GoldengateOracleAIDataPlatformConnectionProperties`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GoldengateOracleAIDataPlatformConnectionProperties().with { $0.technologyType = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return
      "type.googleapis.com/google.cloud.oracledatabase.v1.GoldengateOracleAIDataPlatformConnectionProperties"
  }
