  ...
  Sendable
{
  ...
  public var autonomousDatabaseCharacterSets: [AutonomousDatabaseCharacterSet] = []
  ...
  ///
  /// ```
  /// let value = ListAutonomousDatabaseCharacterSetsResponse().with { $0.autonomousDatabaseCharacterSets = ... }
  /// ```
