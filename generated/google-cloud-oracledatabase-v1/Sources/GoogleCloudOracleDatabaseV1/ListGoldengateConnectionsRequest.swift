...
public struct ListGoldengateConnectionsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListGoldengateConnectionsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListGoldengateConnectionsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.oracledatabase.v1.ListGoldengateConnectionsRequest"
  }
