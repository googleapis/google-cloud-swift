...
public struct OdbSubnet: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  public var purpose: OdbSubnet.Purpose = OdbSubnet.Purpose()
  ...
  ///
  /// ```
  /// let value = OdbSubnet().with { $0.name = ... }
  /// ```
  ...
  public enum Purpose: Codable, Equatable, Sendable {
    ...
    public var intValue: Int? {
      ...
      case .clientSubnet: return 1
      case .backupSubnet: return 2
    ...
    public var stringValue: Swift.String? {
      ...
      case .clientSubnet: return "CLIENT_SUBNET"
      case .backupSubnet: return "BACKUP_SUBNET"
    ...
    public init(stringValue: Swift.String) {
      ...
      case "CLIENT_SUBNET": self = .clientSubnet
      case "BACKUP_SUBNET": self = .backupSubnet
    ...
    public init(intValue: Int) {
      ...
      case 1: self = .clientSubnet
      case 2: self = .backupSubnet
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.oracledatabase.v1.OdbSubnet"
  }
