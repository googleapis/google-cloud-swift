...
public struct ListDatabaseCharacterSetsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDatabaseCharacterSetsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDatabaseCharacterSetsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.oracledatabase.v1.ListDatabaseCharacterSetsRequest"
  }
