...
public struct ListGoldengateConnectionTypesRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListGoldengateConnectionTypesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListGoldengateConnectionTypesRequest().with { $0.parent = ... }
  /// ```
