...
public struct ListDatabasesRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDatabasesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDatabasesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.oracledatabase.v1.ListDatabasesRequest"
  }
