...
///
/// [google.datastore.admin.v1.DatastoreAdmin.CreateIndex]: <doc:DatastoreAdminClient/createIndex(request:options:)>
  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = CreateIndexRequest().with { $0.projectId = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.datastore.admin.v1.CreateIndexRequest"
  }
