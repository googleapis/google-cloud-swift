...
///
/// [google.datastore.admin.v1.DatastoreAdmin.ImportEntities]: <doc:DatastoreAdminClient/importEntities(request:options:)>
public struct ImportEntitiesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = ImportEntitiesRequest().with { $0.projectId = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.datastore.admin.v1.ImportEntitiesRequest"
  }
