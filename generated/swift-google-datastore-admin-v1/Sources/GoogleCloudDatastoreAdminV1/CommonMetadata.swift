...
public struct CommonMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(CommonMetadata.State.self, forKey: .state) {
      self.state = value
    }
