...
///
/// [google.datastore.admin.v1.DatastoreAdmin.GetIndex]: <doc:DatastoreAdminClient/getIndex(request:options:)>
public struct GetIndexRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetIndexRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetIndexRequest().with { $0.projectId = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.datastore.admin.v1.GetIndexRequest"
  }
