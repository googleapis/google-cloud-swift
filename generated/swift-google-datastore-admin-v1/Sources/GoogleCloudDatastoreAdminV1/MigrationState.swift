...
///   them to named cases.
public enum MigrationState: Codable, Equatable, Hashable, Sendable {
  /// Unspecified.
  case unspecified
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:MigrationState/unknownStringValue(_:)).
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:MigrationState/unknownIntValue(_:)).
