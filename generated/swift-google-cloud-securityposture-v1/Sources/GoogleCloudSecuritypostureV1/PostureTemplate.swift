...
public struct PostureTemplate: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var state: PostureTemplate.State = PostureTemplate.State()
  ...
  /// Initialize a new instance of `PostureTemplate`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = PostureTemplate().with { $0.name = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let policySets = CodingKeys(stringValue: "policySets")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(PostureTemplate.State.self, forKey: .state) {
      self.state = value
    }
    if let value = try container.decodeIfPresent([PolicySet].self, forKey: .policySets) {
      self.policySets = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.policySets, forKey: .policySets)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securityposture.v1.PostureTemplate"
  }
