...
public struct ListPostureTemplatesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListPostureTemplatesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPostureTemplatesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securityposture.v1.ListPostureTemplatesRequest"
  }
