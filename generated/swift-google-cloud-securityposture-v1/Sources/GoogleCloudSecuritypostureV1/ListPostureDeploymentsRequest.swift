...
public struct ListPostureDeploymentsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListPostureDeploymentsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPostureDeploymentsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securityposture.v1.ListPostureDeploymentsRequest"
  }
