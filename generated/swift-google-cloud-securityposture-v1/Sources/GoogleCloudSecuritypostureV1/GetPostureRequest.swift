...
public struct GetPostureRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetPostureRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetPostureRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securityposture.v1.GetPostureRequest"
  }
