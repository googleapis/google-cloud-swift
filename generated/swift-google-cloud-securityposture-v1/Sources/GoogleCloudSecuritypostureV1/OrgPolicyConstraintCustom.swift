...
public struct OrgPolicyConstraintCustom: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `OrgPolicyConstraintCustom`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = OrgPolicyConstraintCustom().with { $0.customConstraint = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securityposture.v1.OrgPolicyConstraintCustom"
  }
