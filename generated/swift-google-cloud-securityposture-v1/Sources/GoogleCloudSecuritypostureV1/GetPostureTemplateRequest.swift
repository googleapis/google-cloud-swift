...
public struct GetPostureTemplateRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetPostureTemplateRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetPostureTemplateRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securityposture.v1.GetPostureTemplateRequest"
  }
