  ...
  Sendable
{
  ...
  public var postureTemplates: [PostureTemplate] = []
  ...
  /// Initialize a new instance of `ListPostureTemplatesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPostureTemplatesResponse().with { $0.postureTemplates = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let postureTemplates = CodingKeys(stringValue: "postureTemplates")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([PostureTemplate].self, forKey: .postureTemplates)
    {
      self.postureTemplates = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.postureTemplates, forKey: .postureTemplates)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securityposture.v1.ListPostureTemplatesResponse"
  }
