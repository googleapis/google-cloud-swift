...
public struct ListPostureRevisionsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListPostureRevisionsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPostureRevisionsRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securityposture.v1.ListPostureRevisionsRequest"
  }
