...
public struct ListPosturesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListPosturesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPosturesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securityposture.v1.ListPosturesRequest"
  }
