...
public struct TeradataDialect: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  /// Which Teradata sub-dialect mode the user specifies.
  public var mode: TeradataDialect.Mode = TeradataDialect.Mode()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleCloudWKT._UnknownFields = .init()

  /// Initialize a new instance of `TeradataDialect`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = TeradataDialect().with { $0.mode = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(TeradataDialect.Mode.self, forKey: .mode) {
      self.mode = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.migration.v2.TeradataDialect"
  }
