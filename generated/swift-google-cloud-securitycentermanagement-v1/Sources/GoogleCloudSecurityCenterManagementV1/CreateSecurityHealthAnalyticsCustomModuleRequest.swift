...
public struct CreateSecurityHealthAnalyticsCustomModuleRequest: Codable, Equatable, GoogleWKT
    ._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CreateSecurityHealthAnalyticsCustomModuleRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateSecurityHealthAnalyticsCustomModuleRequest().with { $0.parent = ... }
  /// ```
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(
      self.securityHealthAnalyticsCustomModule, forKey: .securityHealthAnalyticsCustomModule)
