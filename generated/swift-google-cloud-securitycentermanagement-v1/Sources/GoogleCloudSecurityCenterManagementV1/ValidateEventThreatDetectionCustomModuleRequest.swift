...
public struct ValidateEventThreatDetectionCustomModuleRequest: Codable, Equatable, GoogleWKT
    ._AnyPackable,
  Sendable
{
  ...
  /// messages.
  public var rawText: Swift.String = Swift.String()
  ...
  /// Initialize a new instance of `ValidateEventThreatDetectionCustomModuleRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ValidateEventThreatDetectionCustomModuleRequest().with { $0.parent = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let rawText = CodingKeys(stringValue: "rawText")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .rawText) {
      self.rawText = value
    }
