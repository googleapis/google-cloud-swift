...
public struct ListDescendantSecurityHealthAnalyticsCustomModulesRequest: Codable, Equatable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListDescendantSecurityHealthAnalyticsCustomModulesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDescendantSecurityHealthAnalyticsCustomModulesRequest().with { $0.parent = ... }
  /// ```
