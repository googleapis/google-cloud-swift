  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListEventThreatDetectionCustomModulesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListEventThreatDetectionCustomModulesResponse().with { $0.eventThreatDetectionCustomModules = ... }
  /// ```
