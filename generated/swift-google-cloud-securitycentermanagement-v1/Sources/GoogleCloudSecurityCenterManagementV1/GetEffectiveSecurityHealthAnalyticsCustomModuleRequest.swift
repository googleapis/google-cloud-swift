...
///
/// [google.cloud.securitycentermanagement.v1.SecurityCenterManagement.GetEffectiveSecurityHealthAnalyticsCustomModule]: <doc:SecurityCenterManagementClient/getEffectiveSecurityHealthAnalyticsCustomModule(request:options:)>
public struct GetEffectiveSecurityHealthAnalyticsCustomModuleRequest: Codable, Equatable, GoogleWKT
    ._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetEffectiveSecurityHealthAnalyticsCustomModuleRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetEffectiveSecurityHealthAnalyticsCustomModuleRequest().with { $0.name = ... }
  /// ```
