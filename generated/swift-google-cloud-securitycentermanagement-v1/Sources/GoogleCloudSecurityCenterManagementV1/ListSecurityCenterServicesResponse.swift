  ...
  Sendable
{
  ...
  public var securityCenterServices: [SecurityCenterService] = []
  ...
  /// Initialize a new instance of `ListSecurityCenterServicesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListSecurityCenterServicesResponse().with { $0.securityCenterServices = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let securityCenterServices = CodingKeys(stringValue: "securityCenterServices")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [SecurityCenterService].self, forKey: .securityCenterServices)
    {
      self.securityCenterServices = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.securityCenterServices, forKey: .securityCenterServices)
