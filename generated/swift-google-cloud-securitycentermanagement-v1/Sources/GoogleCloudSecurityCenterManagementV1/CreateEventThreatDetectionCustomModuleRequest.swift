...
public struct CreateEventThreatDetectionCustomModuleRequest: Codable, Equatable, GoogleWKT
    ._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let eventThreatDetectionCustomModule = CodingKeys(
      stringValue: "eventThreatDetectionCustomModule")
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(
      self.eventThreatDetectionCustomModule, forKey: .eventThreatDetectionCustomModule)
