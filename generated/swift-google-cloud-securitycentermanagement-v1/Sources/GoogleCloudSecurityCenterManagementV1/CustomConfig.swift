...
public struct CustomConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.customOutput = try container.decodeIfPresent(
      CustomConfig.CustomOutputSpec.self, forKey: .customOutput)
    self.resourceSelector = try container.decodeIfPresent(
      CustomConfig.ResourceSelector.self, forKey: .resourceSelector)
    if let value = try container.decodeIfPresent(CustomConfig.Severity.self, forKey: .severity) {
      self.severity = value
    }
  ...
  public struct CustomOutputSpec: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
      ...
      Sendable
    {
      ...
      private struct CodingKeys: CodingKey {
        ...
        static let valueExpression = CodingKeys(stringValue: "valueExpression")
      ...
      public init(from decoder: Decoder) throws {
        ...
        self.valueExpression = try container.decodeIfPresent(
          GoogleType.Expr.self, forKey: .valueExpression)
        for key in container.allKeys where !CodingKeys._knownKeys.contains(key.stringValue) {
          self._unknownFields.json[key.stringValue] = try container.decode(
            GoogleWKT.WKTValue.self, forKey: key)
        }
