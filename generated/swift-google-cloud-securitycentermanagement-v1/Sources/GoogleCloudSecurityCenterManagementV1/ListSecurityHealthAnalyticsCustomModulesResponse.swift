  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = ListSecurityHealthAnalyticsCustomModulesResponse().with { $0.securityHealthAnalyticsCustomModules = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let securityHealthAnalyticsCustomModules = CodingKeys(
      stringValue: "securityHealthAnalyticsCustomModules")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [SecurityHealthAnalyticsCustomModule].self, forKey: .securityHealthAnalyticsCustomModules)
    {
      self.securityHealthAnalyticsCustomModules = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(
      self.securityHealthAnalyticsCustomModules, forKey: .securityHealthAnalyticsCustomModules)
...
extension ListSecurityHealthAnalyticsCustomModulesResponse: GoogleGax._PaginatedResponse {
