  ...
  Sendable
{
  ...
  ///   them to named cases.
  public enum Origin: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("ORIGIN_UNSPECIFIED")
      case .cloudConsole: return try container.encode("CLOUD_CONSOLE")
      case .autoAdjuster: return try container.encode("AUTO_ADJUSTER")
