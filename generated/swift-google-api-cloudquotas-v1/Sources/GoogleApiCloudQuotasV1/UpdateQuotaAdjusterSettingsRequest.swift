...
public struct UpdateQuotaAdjusterSettingsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let quotaAdjusterSettings = CodingKeys(stringValue: "quotaAdjusterSettings")
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.quotaAdjusterSettings, forKey: .quotaAdjusterSettings)
