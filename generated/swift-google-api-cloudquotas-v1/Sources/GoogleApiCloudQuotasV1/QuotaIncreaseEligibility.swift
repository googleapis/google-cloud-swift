...
public struct QuotaIncreaseEligibility: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///   them to named cases.
  public enum IneligibilityReason: Codable, Equatable, Hashable, Sendable {
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:IneligibilityReason/unknownStringValue(_:)).
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:IneligibilityReason/unknownIntValue(_:)).
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .noValidBillingAccount: return try container.encode("NO_VALID_BILLING_ACCOUNT")
      case .other: return try container.encode("OTHER")
      case .notSupported: return try container.encode("NOT_SUPPORTED")
      case .notEnoughUsageHistory: return try container.encode("NOT_ENOUGH_USAGE_HISTORY")
