...
public struct ListQuotaInfosRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListQuotaInfosRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListQuotaInfosRequest().with { $0.parent = ... }
  /// ```
