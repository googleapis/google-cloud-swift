  ...
  Sendable
{
  ...
  public var quotaPreferences: [QuotaPreference] = []
  ...
  /// Initialize a new instance of `ListQuotaPreferencesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListQuotaPreferencesResponse().with { $0.quotaPreferences = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let quotaPreferences = CodingKeys(stringValue: "quotaPreferences")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([QuotaPreference].self, forKey: .quotaPreferences)
    {
      self.quotaPreferences = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.quotaPreferences, forKey: .quotaPreferences)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.api.cloudquotas.v1.ListQuotaPreferencesResponse"
  }
