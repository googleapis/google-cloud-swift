...
/// batch workload.
public struct SparkBatch: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = SparkBatch().with { $0.mainJarFileUri = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataproc.v1.SparkBatch"
  }
