...
public struct ListSessionTemplatesRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListSessionTemplatesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListSessionTemplatesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.dataproc.v1.ListSessionTemplatesRequest"
  }
