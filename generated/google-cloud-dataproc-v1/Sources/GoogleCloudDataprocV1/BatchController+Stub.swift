...
extension Clients {
  ...
  class BatchControllerTransport: BatchControllerStub {
    ...
    public func createBatch(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/batches"
      }()
      var query = [
    ...
    public func getBatch(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudDataprocV1.Batch.self, from: data)
    }
    ...
    public func listBatches(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudDataprocV1.ListBatchesResponse.self, from: data)
    }
