...
extension Clients {
  class NodeGroupControllerTransport: NodeGroupControllerStub {
    ...
    public func createNodeGroup(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/nodeGroups"
      }()
      var query = [
    ...
    public func resizeNodeGroup(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0):resize"
      }()
      let query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
    ...
    public func getNodeGroup(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudDataprocV1.NodeGroup.self, from: data)
    }
