...
extension Clients {
  final class AutoscalingPolicyServiceLogging: AutoscalingPolicyServiceStub {
    let inner: any AutoscalingPolicyServiceStub
    let logger: Logger

    public init(_ inner: any AutoscalingPolicyServiceStub, logger: Logger) {
      var logger = logger
      logger[metadataKey: "gcp.artifact.id"] = "google-cloud-dataproc-v1"
      logger[metadataKey: "gcp.client.service"] = "dataproc"
      logger[metadataKey: "gcp.experimental.swift.client"] = "AutoscalingPolicyService"
      self.inner = inner
      self.logger = logger
    }
