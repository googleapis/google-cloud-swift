...
extension Clients {
  final class SessionControllerLogging: SessionControllerStub {
    let inner: any SessionControllerStub
    let logger: Logger

    public init(_ inner: any SessionControllerStub, logger: Logger) {
      var logger = logger
      logger[metadataKey: "gcp.artifact.id"] = "google-cloud-dataproc-v1"
      logger[metadataKey: "gcp.client.service"] = "dataproc"
      logger[metadataKey: "gcp.experimental.swift.client"] = "SessionController"
      self.inner = inner
      self.logger = logger
    }
    ...
    public func terminateSession(
      ...
      try await self._intercept(
        ...
        action: {
          (r: TerminateSessionRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleLongRunning.Operation
          in
          return try await self.inner.terminateSession(request: r, options: o)
        })
    }
