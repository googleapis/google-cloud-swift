...
extension Clients {
  class AutoscalingPolicyServiceTransport: AutoscalingPolicyServiceStub {
    ...
    public func createAutoscalingPolicy(
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudDataprocV1.AutoscalingPolicy.self, from: data)
    }
    ...
    public func listAutoscalingPolicies(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudDataprocV1.ListAutoscalingPoliciesResponse.self, from: data)
    }
