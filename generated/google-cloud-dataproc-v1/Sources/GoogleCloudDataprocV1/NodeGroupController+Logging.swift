...
extension Clients {
  final class NodeGroupControllerLogging: NodeGroupControllerStub {
    let inner: any NodeGroupControllerStub
    let logger: Logger

    public init(_ inner: any NodeGroupControllerStub, logger: Logger) {
      var logger = logger
      logger[metadataKey: "gcp.artifact.id"] = "google-cloud-dataproc-v1"
      logger[metadataKey: "gcp.client.service"] = "dataproc"
      logger[metadataKey: "gcp.experimental.swift.client"] = "NodeGroupController"
      self.inner = inner
      self.logger = logger
    }
    ...
    public func createNodeGroup(
      ...
      try await self._intercept(
        ...
        action: {
          (r: CreateNodeGroupRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleLongRunning.Operation
          in
          return try await self.inner.createNodeGroup(request: r, options: o)
        })
    }
    ...
    public func resizeNodeGroup(
      ...
      try await self._intercept(
        ...
        action: {
          (r: ResizeNodeGroupRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleLongRunning.Operation
          in
          return try await self.inner.resizeNodeGroup(request: r, options: o)
        })
    }
    ...
    public func getNodeGroup(
      ...
      try await self._intercept(
        ...
        name: "getNodeGroup",
        action: {
          (r: GetNodeGroupRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleCloudDataprocV1.NodeGroup
          in
          return try await self.inner.getNodeGroup(request: r, options: o)
        })
    }
