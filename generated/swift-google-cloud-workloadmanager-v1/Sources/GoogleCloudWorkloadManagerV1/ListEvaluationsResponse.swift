...
public struct ListEvaluationsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListEvaluationsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListEvaluationsResponse().with { $0.evaluations = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let evaluations = CodingKeys(stringValue: "evaluations")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Evaluation].self, forKey: .evaluations) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.workloadmanager.v1.ListEvaluationsResponse"
  }
...
extension ListEvaluationsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Evaluation] {
