...
public struct ListExecutionResultsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListExecutionResultsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListExecutionResultsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.workloadmanager.v1.ListExecutionResultsRequest"
  }
