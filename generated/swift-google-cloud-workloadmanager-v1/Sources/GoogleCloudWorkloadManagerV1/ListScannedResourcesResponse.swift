  ...
  Sendable
{
  ...
  public var scannedResources: [ScannedResource] = []
  ...
  /// Initialize a new instance of `ListScannedResourcesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListScannedResourcesResponse().with { $0.scannedResources = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let scannedResources = CodingKeys(stringValue: "scannedResources")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.workloadmanager.v1.ListScannedResourcesResponse"
  }
