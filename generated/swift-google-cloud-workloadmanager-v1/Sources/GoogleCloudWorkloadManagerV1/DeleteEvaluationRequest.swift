...
public struct DeleteEvaluationRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteEvaluationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteEvaluationRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.workloadmanager.v1.DeleteEvaluationRequest"
  }
