  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let executionResults = CodingKeys(stringValue: "executionResults")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([ExecutionResult].self, forKey: .executionResults)
    {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.executionResults, forKey: .executionResults)
