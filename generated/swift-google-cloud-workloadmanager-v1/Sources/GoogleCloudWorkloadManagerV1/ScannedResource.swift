...
/// A scanned resource.
public struct ScannedResource: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Resource name.
  ...
  /// Initialize a new instance of `ScannedResource`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ScannedResource().with { $0.resource = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.workloadmanager.v1.ScannedResource"
  }
