...
Add `swift-google-cloud-eventarc-publishing-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-eventarc-publishing-v1.git --from 0.3.0
```

Then add `GoogleCloudEventarcPublishingV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudEventarcPublishingV1 <target-name> --package swift-google-cloud-eventarc-publishing-v1
```
