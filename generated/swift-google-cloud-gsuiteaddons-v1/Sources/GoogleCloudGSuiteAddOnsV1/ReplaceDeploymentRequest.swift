...
public struct ReplaceDeploymentRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ReplaceDeploymentRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ReplaceDeploymentRequest().with { $0.deployment = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gsuiteaddons.v1.ReplaceDeploymentRequest"
  }
