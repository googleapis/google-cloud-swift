  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let oauthClientId = CodingKeys(stringValue: "oauthClientId")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .oauthClientId) {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.oauthClientId, forKey: .oauthClientId)
