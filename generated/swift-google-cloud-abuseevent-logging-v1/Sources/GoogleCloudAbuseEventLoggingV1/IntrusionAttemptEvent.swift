  ...
  Sendable
{
  ...
  public var detectedIntrusionStartTime: GoogleWKT.WKTTimestamp? = nil

  /// Detected end time of the intrusion attempt.
  public var detectedIntrusionEndTime: GoogleWKT.WKTTimestamp? = nil
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.detectedIntrusionStartTime = try container.decodeIfPresent(
      GoogleWKT.WKTTimestamp.self, forKey: .detectedIntrusionStartTime)
    self.detectedIntrusionEndTime = try container.decodeIfPresent(
      GoogleWKT.WKTTimestamp.self, forKey: .detectedIntrusionEndTime)
