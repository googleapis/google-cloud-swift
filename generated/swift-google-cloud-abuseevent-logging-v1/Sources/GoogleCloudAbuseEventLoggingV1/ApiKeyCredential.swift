...
public struct ApiKeyCredential: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ApiKeyCredential`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ApiKeyCredential().with { $0.apiKey = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.abuseevent.logging.v1.ApiKeyCredential"
  }
