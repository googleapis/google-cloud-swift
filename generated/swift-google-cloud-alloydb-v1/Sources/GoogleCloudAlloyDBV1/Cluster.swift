  ...
  Sendable
{
    ...
    Sendable
  {
    ...
    public var upgradeTime: GoogleWKT.WKTTimestamp? = nil

    /// grace end time of the cluster.
    public var graceEndTime: GoogleWKT.WKTTimestamp? = nil
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.upgradeTime = try container.decodeIfPresent(
        GoogleWKT.WKTTimestamp.self, forKey: .upgradeTime)
      self.graceEndTime = try container.decodeIfPresent(
        GoogleWKT.WKTTimestamp.self, forKey: .graceEndTime)
      for key in container.allKeys where !CodingKeys._knownKeys.contains(key.stringValue) {
        self._unknownFields.json[key.stringValue] = try container.decode(
          GoogleWKT.WKTValue.self, forKey: key)
      }
