  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let caSource = CodingKeys(stringValue: "caSource")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(SslConfig.SslMode.self, forKey: .sslMode) {
      self.sslMode = value
    }
    if let value = try container.decodeIfPresent(SslConfig.CaSource.self, forKey: .caSource) {
      self.caSource = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.caSource, forKey: .caSource)
