...
public struct SwitchoverClusterRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SwitchoverClusterRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SwitchoverClusterRequest().with { $0.name = ... }
  /// ```
