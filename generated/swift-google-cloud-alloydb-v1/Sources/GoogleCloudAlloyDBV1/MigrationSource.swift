  ...
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      MigrationSource.MigrationSourceType.self, forKey: .sourceType)
    {
  ...
  public enum MigrationSourceType: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("MIGRATION_SOURCE_TYPE_UNSPECIFIED")
      case .dms: return try container.encode("DMS")
