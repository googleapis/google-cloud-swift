...
public struct ListSupportedDatabaseFlagsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListSupportedDatabaseFlagsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListSupportedDatabaseFlagsRequest().with { $0.parent = ... }
  /// ```
