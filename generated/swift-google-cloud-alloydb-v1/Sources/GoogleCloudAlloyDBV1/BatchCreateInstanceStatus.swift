...
public struct BatchCreateInstanceStatus: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let errorMsg = CodingKeys(stringValue: "errorMsg")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      BatchCreateInstanceStatus.State.self, forKey: .state)
    {
      self.state = value
    }
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .errorMsg) {
      self.errorMsg = value
    }
    self.error = try container.decodeIfPresent(GoogleRpc.Status.self, forKey: .error)
    if let value = try container.decodeIfPresent(Instance.InstanceType.self, forKey: .type) {
      self.type = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.errorMsg, forKey: .errorMsg)
