...
public struct ListServersRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var view: ServerView = ServerView()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `ListServersRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListServersRequest().with { $0.parent = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(ServerView.self, forKey: .view) {
      self.view = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ftp.v1.ListServersRequest"
  }
