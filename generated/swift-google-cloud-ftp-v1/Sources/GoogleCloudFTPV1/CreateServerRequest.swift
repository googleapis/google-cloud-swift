...
public struct CreateServerRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var serverId: Swift.String = Swift.String()
  ...
  /// Initialize a new instance of `CreateServerRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateServerRequest().with { $0.parent = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .serverId) {
      self.serverId = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ftp.v1.CreateServerRequest"
  }
