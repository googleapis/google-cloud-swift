...
public struct ListServersResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The list of Server
  ...
  /// Initialize a new instance of `ListServersResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListServersResponse().with { $0.servers = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Server].self, forKey: .servers) {
      self.servers = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ftp.v1.ListServersResponse"
  }
...
extension ListServersResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Server] {
    return self.servers
  }
