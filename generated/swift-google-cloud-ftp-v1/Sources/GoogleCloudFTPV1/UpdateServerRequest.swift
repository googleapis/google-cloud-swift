...
public struct UpdateServerRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateServerRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateServerRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ftp.v1.UpdateServerRequest"
  }
