...
/// error.
public struct DeleteServerRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteServerRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteServerRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ftp.v1.DeleteServerRequest"
  }
