...
public struct CreateEventRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CreateEventRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateEventRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.video.livestream.v1.CreateEventRequest"
  }
