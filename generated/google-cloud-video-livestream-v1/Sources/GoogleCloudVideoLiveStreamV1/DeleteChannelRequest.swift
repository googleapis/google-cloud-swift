...
public struct DeleteChannelRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteChannelRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteChannelRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.video.livestream.v1.DeleteChannelRequest"
  }
