# Google Cloud Client Libraries for Swift - Cloud IDS API
...
Add `swift-google-cloud-ids-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-ids-v1.git --from 0.3.0
```

Then add `GoogleCloudIDSV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudIDSV1 <target-name> --package swift-google-cloud-ids-v1
```
