...
public struct ResourceDriftTerraformInfo: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ResourceDriftTerraformInfo`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ResourceDriftTerraformInfo().with { $0.address = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.config.v1.ResourceDriftTerraformInfo"
  }
