  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = TerraformVersion().with { $0.name = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let supportTime = CodingKeys(stringValue: "supportTime")
    static let deprecateTime = CodingKeys(stringValue: "deprecateTime")
    static let obsoleteTime = CodingKeys(stringValue: "obsoleteTime")
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.supportTime, forKey: .supportTime)
    try container.encodeIfPresent(self.deprecateTime, forKey: .deprecateTime)
    try container.encodeIfPresent(self.obsoleteTime, forKey: .obsoleteTime)
