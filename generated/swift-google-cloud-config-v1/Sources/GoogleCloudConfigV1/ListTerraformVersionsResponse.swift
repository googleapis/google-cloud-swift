  ...
  Sendable
{
  ...
  public var terraformVersions: [TerraformVersion] = []
  ...
  /// Initialize a new instance of `ListTerraformVersionsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListTerraformVersionsResponse().with { $0.terraformVersions = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let terraformVersions = CodingKeys(stringValue: "terraformVersions")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [TerraformVersion].self, forKey: .terraformVersions)
    {
      self.terraformVersions = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.terraformVersions, forKey: .terraformVersions)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.config.v1.ListTerraformVersionsResponse"
  }
