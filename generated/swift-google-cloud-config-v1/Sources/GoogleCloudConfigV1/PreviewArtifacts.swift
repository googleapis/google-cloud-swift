...
public struct PreviewArtifacts: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `PreviewArtifacts`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = PreviewArtifacts().with { $0.content = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.config.v1.PreviewArtifacts"
  }
