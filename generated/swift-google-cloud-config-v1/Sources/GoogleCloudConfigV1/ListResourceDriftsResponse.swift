...
public struct ListResourceDriftsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListResourceDriftsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListResourceDriftsResponse().with { $0.resourceDrifts = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let resourceDrifts = CodingKeys(stringValue: "resourceDrifts")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([ResourceDrift].self, forKey: .resourceDrifts) {
      self.resourceDrifts = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.resourceDrifts, forKey: .resourceDrifts)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.config.v1.ListResourceDriftsResponse"
  }
...
extension ListResourceDriftsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [ResourceDrift] {
    return self.resourceDrifts
  }
