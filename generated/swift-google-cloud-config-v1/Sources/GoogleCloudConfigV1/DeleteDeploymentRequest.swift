...
public struct DeleteDeploymentRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteDeploymentRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteDeploymentRequest().with { $0.name = ... }
  /// ```
  ...
  public enum DeletePolicy: Codable, Equatable, Hashable, Sendable {
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "DELETE_POLICY_UNSPECIFIED"
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:DeletePolicy/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "DELETE_POLICY_UNSPECIFIED": self = .unspecified
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:DeletePolicy/unknownIntValue(_:)).
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.config.v1.DeleteDeploymentRequest"
  }
