...
///   them to named cases.
public enum QuotaValidation: Codable, Equatable, Hashable, Sendable {
  /// The default value.
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    switch self {
    case .unspecified: return try container.encode("QUOTA_VALIDATION_UNSPECIFIED")
    case .enabled: return try container.encode("ENABLED")
    case .enforced: return try container.encode("ENFORCED")
