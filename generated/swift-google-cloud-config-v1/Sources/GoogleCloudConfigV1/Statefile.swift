...
public struct Statefile: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `Statefile`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = Statefile().with { $0.signedUri = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.config.v1.Statefile"
  }
