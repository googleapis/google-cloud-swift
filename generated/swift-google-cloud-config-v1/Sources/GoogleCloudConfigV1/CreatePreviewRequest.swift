...
public struct CreatePreviewRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var previewId: Swift.String = Swift.String()
  ...
  /// Initialize a new instance of `CreatePreviewRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreatePreviewRequest().with { $0.parent = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let previewId = CodingKeys(stringValue: "previewId")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .previewId) {
      self.previewId = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.previewId, forKey: .previewId)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.config.v1.CreatePreviewRequest"
  }
