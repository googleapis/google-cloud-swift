...
public struct DeploymentSource: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeploymentSource`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeploymentSource().with { $0.deployment = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.config.v1.DeploymentSource"
  }
