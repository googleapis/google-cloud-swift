  ...
  Sendable
{
  ...
  public var deploymentGroups: [DeploymentGroup] = []
  ...
  /// Initialize a new instance of `ListDeploymentGroupsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDeploymentGroupsResponse().with { $0.deploymentGroups = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let deploymentGroups = CodingKeys(stringValue: "deploymentGroups")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([DeploymentGroup].self, forKey: .deploymentGroups)
    {
      self.deploymentGroups = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.deploymentGroups, forKey: .deploymentGroups)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.config.v1.ListDeploymentGroupsResponse"
  }
