...
public struct ResourceTerraformInfo: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ResourceTerraformInfo`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ResourceTerraformInfo().with { $0.address = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.config.v1.ResourceTerraformInfo"
  }
