  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let resourceChanges = CodingKeys(stringValue: "resourceChanges")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([ResourceChange].self, forKey: .resourceChanges) {
      self.resourceChanges = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.resourceChanges, forKey: .resourceChanges)
