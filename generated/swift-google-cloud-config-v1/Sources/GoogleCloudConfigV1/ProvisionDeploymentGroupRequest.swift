...
public struct ProvisionDeploymentGroupRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var deploymentSpecs: [Swift.String: DeploymentSpec] = [:]

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `ProvisionDeploymentGroupRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ProvisionDeploymentGroupRequest().with { $0.name = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let deploymentSpecs = CodingKeys(stringValue: "deploymentSpecs")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [Swift.String: DeploymentSpec].self, forKey: .deploymentSpecs)
    {
      self.deploymentSpecs = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.deploymentSpecs, forKey: .deploymentSpecs)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.config.v1.ProvisionDeploymentGroupRequest"
  }
