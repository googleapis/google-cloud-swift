...
public struct DeleteDeploymentGroupRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let deploymentReferencePolicy = CodingKeys(stringValue: "deploymentReferencePolicy")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      DeleteDeploymentGroupRequest.DeploymentReferencePolicy.self,
      forKey: .deploymentReferencePolicy)
    {
      self.deploymentReferencePolicy = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.deploymentReferencePolicy, forKey: .deploymentReferencePolicy)
