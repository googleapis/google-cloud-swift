...
public struct ResourceCAIInfo: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ResourceCAIInfo`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ResourceCAIInfo().with { $0.fullResourceName = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.config.v1.ResourceCAIInfo"
  }
