...
public struct ListTerraformVersionsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListTerraformVersionsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListTerraformVersionsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.config.v1.ListTerraformVersionsRequest"
  }
