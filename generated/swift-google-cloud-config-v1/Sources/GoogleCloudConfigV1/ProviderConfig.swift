...
public struct ProviderConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.sourceType = try container.decodeIfPresent(
      ProviderConfig.ProviderSource.self, forKey: .sourceType)
  ...
  ///   them to named cases.
  public enum ProviderSource: Codable, Equatable, Hashable, Sendable {
