  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListResourcesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListResourcesResponse().with { $0.resources = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Resource].self, forKey: .resources) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.config.v1.ListResourcesResponse"
  }
