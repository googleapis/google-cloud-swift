  ...
  Sendable
{
  ...
  public var standardSupportEndTime: GoogleWKT.WKTTimestamp? = nil

  /// The end of extended support timestamp.
  public var extendedSupportEndTime: GoogleWKT.WKTTimestamp? = nil
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.standardSupportEndTime = try container.decodeIfPresent(
      GoogleWKT.WKTTimestamp.self, forKey: .standardSupportEndTime)
    self.extendedSupportEndTime = try container.decodeIfPresent(
      GoogleWKT.WKTTimestamp.self, forKey: .extendedSupportEndTime)
