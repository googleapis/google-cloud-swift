...
// limitations under the License.
  ...
  public struct GetEnvironmentHistoryRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `GetEnvironmentHistoryRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = GetEnvironmentHistoryRequest().with { $0.parent = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.GetEnvironmentHistoryRequest"
    }
