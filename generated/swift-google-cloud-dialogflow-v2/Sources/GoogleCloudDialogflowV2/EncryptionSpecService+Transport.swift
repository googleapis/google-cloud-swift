...
// limitations under the License.
  ...
  extension Clients {
    final class EncryptionSpecServiceTransport: EncryptionSpecServiceStub {
      ...
      public func getEncryptionSpec(
        ...
        return try await req.rpc(
          GoogleCloudDialogflowV2.EncryptionSpec.self, timeout: options.attemptTimeout
        ).get()
      }
      ...
      public func initializeEncryptionSpec(
        ...
        let (path, query, configure, omitted) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v2/\(pathVariable0):initialize"
            let query = [
              URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
            ]
            return (path, query)
