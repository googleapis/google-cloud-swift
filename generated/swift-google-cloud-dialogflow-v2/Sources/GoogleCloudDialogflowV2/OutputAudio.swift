...
// limitations under the License.
  ...
  public struct OutputAudio: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// Instructs the speech synthesizer how to generate the speech
    /// audio.
    public var config: OutputAudioConfig? = nil
    ...
    /// Initialize a new instance of `OutputAudio`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = OutputAudio().with { $0.config = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.config = try container.decodeIfPresent(OutputAudioConfig.self, forKey: .config)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.OutputAudio"
    }
