...
// limitations under the License.
  ...
  extension Clients {
    final class ParticipantsTransport: ParticipantsStub {
      ...
      public func createParticipant(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v2/\(pathVariable0)/participants"
            let query = [
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/conversations/"),
                  .singleWildcard, .literal("/participants/"), .singleWildcard,
                ],
                fieldName: "name")
            else {
              return nil
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                  .literal("/conversations/"), .singleWildcard, .literal("/participants/"),
                  .singleWildcard,
                ],
                fieldName: "name")
            else {
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "name",
              expecting: "projects/*/conversations/*/participants/*"
            )
            paths.append(builder.build())
          }
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "name",
              expecting: "projects/*/locations/*/conversations/*/participants/*"
            )
            paths.append(builder.build())
          }
          throw GoogleGax.RequestError.binding(GoogleGax.BindingError(paths: paths))
      ...
      public func updateParticipant(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                request.participant.map({ $0.name }),
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/conversations/"),
                  .singleWildcard, .literal("/participants/"), .singleWildcard,
                ],
      ...
      public func analyzeContent(
        ...
        let (path, query, configure, omitted) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                request.participant as Swift.String?,
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/conversations/"),
                  .singleWildcard, .literal("/participants/"), .singleWildcard,
                ],
            ...
            let path = "/v2/\(pathVariable0):analyzeContent"
            let query = [
              URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
            ]
            return (path, query)
          }() {
            return (candidate.0, candidate.1, { $0.setMethod(.POST) }, ["participant"])
          }
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
      ...
      public func suggestArticles(
        ...
        let (path, query, configure, omitted) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v2/\(pathVariable0)/suggestions:suggestArticles"
            let query = [
              URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
            ]
            return (path, query)
      ...
      public func suggestFaqAnswers(
        ...
        let (path, query, configure, omitted) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v2/\(pathVariable0)/suggestions:suggestFaqAnswers"
            let query = [
              URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
            ]
            return (path, query)
      ...
      public func suggestSmartReplies(
        ...
        let (path, query, configure, omitted) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v2/\(pathVariable0)/suggestions:suggestSmartReplies"
            let query = [
              URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
            ]
            return (path, query)
      ...
      public func suggestKnowledgeAssist(
        ...
        let (path, query, configure, omitted) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v2/\(pathVariable0)/suggestions:suggestKnowledgeAssist"
            let query = [
              URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
            ]
            return (path, query)
