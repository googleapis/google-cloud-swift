...
// limitations under the License.
  ...
  public struct ListConversationDatasetsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ListConversationDatasetsRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListConversationDatasetsRequest().with { $0.parent = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.ListConversationDatasetsRequest"
    }
