...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var conversationModelEvaluation: Swift.String = Swift.String()
    ...
    public var state: CreateConversationModelEvaluationOperationMetadata.State =
    ...
    ///
    /// ```
    /// let value = CreateConversationModelEvaluationOperationMetadata().with { $0.conversationModelEvaluation = ... }
    /// ```
