...
// limitations under the License.
  ...
  public struct ValidationError: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// The severity of the error.
    public var severity: ValidationError.Severity = ValidationError.Severity()
    ...
    ///
    /// ```
    /// let value = ValidationError().with { $0.severity = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(ValidationError.Severity.self, forKey: .severity)
      {
        self.severity = value
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.ValidationError"
    }
