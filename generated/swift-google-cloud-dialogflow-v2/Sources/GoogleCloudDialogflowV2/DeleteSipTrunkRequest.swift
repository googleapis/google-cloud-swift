...
// limitations under the License.
  ...
  public struct DeleteSipTrunkRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `DeleteSipTrunkRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DeleteSipTrunkRequest().with { $0.name = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.DeleteSipTrunkRequest"
    }
