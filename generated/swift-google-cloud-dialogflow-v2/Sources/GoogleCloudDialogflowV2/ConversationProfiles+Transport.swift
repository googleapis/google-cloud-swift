...
// limitations under the License.
  ...
  extension Clients {
    final class ConversationProfilesTransport: ConversationProfilesStub {
      ...
      public func listConversationProfiles(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v2/\(pathVariable0)/conversationProfiles"
            var query = [
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/conversationProfiles/"),
                  .singleWildcard,
                ],
                fieldName: "name")
            else {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                  .literal("/conversationProfiles/"), .singleWildcard,
                ],
                fieldName: "name")
            else {
              return nil
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "name",
              expecting: "projects/*/conversationProfiles/*"
            )
            paths.append(builder.build())
          }
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "name",
              expecting: "projects/*/locations/*/conversationProfiles/*"
            )
            paths.append(builder.build())
          }
          throw GoogleGax.RequestError.binding(GoogleGax.BindingError(paths: paths))
      ...
      public func updateConversationProfile(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                request.conversationProfile.map({ $0.name }),
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/conversationProfiles/"),
                  .singleWildcard,
                ],
                fieldName: "conversation_profile.name")
            else {
              return nil
            }
            let path = "/v2/\(pathVariable0)"
      ...
      public func setSuggestionFeatureConfig(
        ...
        let (path, query, configure, omitted) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                request.conversationProfile as Swift.String?,
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/conversationProfiles/"),
                  .singleWildcard,
                ],
                fieldName: "conversation_profile")
            else {
              return nil
            }
            let path = "/v2/\(pathVariable0):setSuggestionFeatureConfig"
            let query = [
              URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
            ]
            return (path, query)
          }() {
            return (candidate.0, candidate.1, { $0.setMethod(.POST) }, ["conversationProfile"])
          }
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
      ...
      public func clearSuggestionFeatureConfig(
        ...
        let (path, query, configure, omitted) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v2/\(pathVariable0):clearSuggestionFeatureConfig"
            let query = [
              URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
            ]
            return (path, query)
