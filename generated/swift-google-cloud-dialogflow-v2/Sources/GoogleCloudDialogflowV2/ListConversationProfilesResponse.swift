...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `ListConversationProfilesResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListConversationProfilesResponse().with { $0.conversationProfiles = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let conversationProfiles = CodingKeys(stringValue: "conversationProfiles")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [ConversationProfile].self, forKey: .conversationProfiles)
      {
        self.conversationProfiles = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.conversationProfiles, forKey: .conversationProfiles)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.ListConversationProfilesResponse"
    }
