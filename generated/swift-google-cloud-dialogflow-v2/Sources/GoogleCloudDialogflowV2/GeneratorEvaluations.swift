...
// limitations under the License.
  ...
  public final class GeneratorEvaluationsClient: Clients.GeneratorEvaluationsProtocol, Sendable {
    ...
    public func deleteGeneratorEvaluation(
      request: DeleteGeneratorEvaluationRequest, options: GoogleGax.RequestOptions
    ) async throws {
  ...
  extension Clients.GeneratorEvaluationsProtocol {
    ...
    ) -> any AsyncSequence<GeneratorEvaluation, Swift.Error> {
      self.listGeneratorEvaluations(byItem: byItem, options: .init())
    }
    ...
    /// @Snippet(path: "GeneratorEvaluations_ListGeneratorEvaluations")
    public func listGeneratorEvaluations(
      byItem: ListGeneratorEvaluationsRequest, options: GoogleGax.RequestOptions
    ) -> any AsyncSequence<GeneratorEvaluation, Swift.Error> {
      let listRpc = {
    ...
    public func listGeneratorEvaluations(
      ...
      return self.listGeneratorEvaluations(byItem: request)
    }
  ...
  @available(
    *, unavailable,
    message: "Enable the 'GeneratorEvaluations' trait in Package.swift to use this client."
  )
  public final class GeneratorEvaluationsClient: Sendable {
    @available(
      *, unavailable,
      message: "Enable the 'GeneratorEvaluations' trait in Package.swift to use this client."
    )
