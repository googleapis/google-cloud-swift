...
// limitations under the License.
  ...
  extension Clients {
    final class DocumentsTransport: DocumentsStub {
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/knowledgeBases/"),
                  .singleWildcard,
                ],
                fieldName: "parent")
            else {
            ...
            let path = "/v2/\(pathVariable0)/documents"
            var query = [
            ...
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  ...
                  .literal("/knowledgeBases/"), .singleWildcard,
                ],
                fieldName: "parent")
            else {
              return nil
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                request.parent as Swift.String?,
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/agent/knowledgeBases/"),
                  .singleWildcard,
                ],
                fieldName: "parent")
            else {
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "parent",
              expecting: "projects/*/knowledgeBases/*"
            )
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "parent",
              expecting: "projects/*/locations/*/knowledgeBases/*"
            )
            paths.append(builder.build())
          }
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "parent",
              expecting: "projects/*/agent/knowledgeBases/*"
            )
            paths.append(builder.build())
          }
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/knowledgeBases/"),
                  .singleWildcard, .literal("/documents/"), .singleWildcard,
                ],
                fieldName: "name")
            else {
              return nil
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                  .literal("/knowledgeBases/"), .singleWildcard, .literal("/documents/"),
                  .singleWildcard,
                ],
                fieldName: "name")
            else {
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "name",
              expecting: "projects/*/knowledgeBases/*/documents/*"
            )
            paths.append(builder.build())
          }
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "name",
              expecting: "projects/*/locations/*/knowledgeBases/*/documents/*"
            )
            paths.append(builder.build())
          }
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "name",
              expecting: "projects/*/agent/knowledgeBases/*/documents/*"
            )
            paths.append(builder.build())
          }
          throw GoogleGax.RequestError.binding(GoogleGax.BindingError(paths: paths))
      ...
      public func importDocuments(
        ...
        let (path, query, configure, omitted) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v2/\(pathVariable0)/documents:import"
            let query = [
              URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
            ]
            return (path, query)
      ...
      public func reloadDocument(
        ...
        let (path, query, configure, omitted) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v2/\(pathVariable0):reload"
            let query = [
              URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
            ]
            return (path, query)
      ...
      public func exportDocument(
        ...
        let (path, query, configure, omitted) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v2/\(pathVariable0):export"
            let query = [
              URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
            ]
            return (path, query)
