...
// limitations under the License.
  ...
  extension Clients.ConversationDatasetsProtocol {
    ...
    public func listConversationDatasetsByItems(
      ...
      return self.listConversationDatasetsByItems(request: request)
    }
  ...
  @available(
    *, unavailable,
    message: "Enable the 'ConversationDatasets' trait in Package.swift to use this client."
  )
  public final class ConversationDatasetsClient: Sendable {
    @available(
      *, unavailable,
      message: "Enable the 'ConversationDatasets' trait in Package.swift to use this client."
    )
