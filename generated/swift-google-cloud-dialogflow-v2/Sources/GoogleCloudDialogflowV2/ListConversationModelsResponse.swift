...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var conversationModels: [ConversationModel] = []
    ...
    /// Initialize a new instance of `ListConversationModelsResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListConversationModelsResponse().with { $0.conversationModels = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let conversationModels = CodingKeys(stringValue: "conversationModels")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [ConversationModel].self, forKey: .conversationModels)
      {
        self.conversationModels = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.conversationModels, forKey: .conversationModels)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.ListConversationModelsResponse"
    }
