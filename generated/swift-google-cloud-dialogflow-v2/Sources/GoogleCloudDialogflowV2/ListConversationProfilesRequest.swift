...
// limitations under the License.
  ...
  public struct ListConversationProfilesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ListConversationProfilesRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListConversationProfilesRequest().with { $0.parent = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.ListConversationProfilesRequest"
    }
