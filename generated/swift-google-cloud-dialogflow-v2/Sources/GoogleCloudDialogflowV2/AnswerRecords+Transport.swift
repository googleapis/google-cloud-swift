...
// limitations under the License.
  ...
  extension Clients {
    final class AnswerRecordsTransport: AnswerRecordsStub {
      ...
      public func listAnswerRecords(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v2/\(pathVariable0)/answerRecords"
            var query = [
      ...
      public func updateAnswerRecord(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                request.answerRecord.map({ $0.name }),
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/answerRecords/"),
                  .singleWildcard,
                ],
                fieldName: "answer_record.name")
            else {
              return nil
            }
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                  .literal("/answerRecords/"), .singleWildcard,
                ],
                fieldName: "answer_record.name")
            else {
              return nil
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "answer_record.name",
              expecting: "projects/*/answerRecords/*"
            )
            paths.append(builder.build())
          }
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "answer_record.name",
              expecting: "projects/*/locations/*/answerRecords/*"
            )
            paths.append(builder.build())
          }
          throw GoogleGax.RequestError.binding(GoogleGax.BindingError(paths: paths))
        ...
        return try await req.rpc(
          GoogleCloudDialogflowV2.AnswerRecord.self, timeout: options.attemptTimeout
        ).get()
      }
