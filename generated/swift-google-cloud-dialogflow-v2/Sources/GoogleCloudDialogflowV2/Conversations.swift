...
// limitations under the License.
  ...
  extension Clients.ConversationsProtocol {
    ...
    public func listConversationsByItems(
      ...
      let listRpc = {
        @Sendable (token: Swift.String) async throws
          -> GoogleCloudDialogflowV2.ListConversationsResponse in
        var request = request
    ...
    ) -> any AsyncSequence<Message, Swift.Error> & Sendable {
    ...
    public func listMessagesByItems(
      ...
      return self.listMessagesByItems(request: request)
    }
  ...
  @available(
    *, unavailable, message: "Enable the 'Conversations' trait in Package.swift to use this client."
  )
  public final class ConversationsClient: Sendable {
    @available(
      *, unavailable,
      message: "Enable the 'Conversations' trait in Package.swift to use this client."
    )
    public init(_ options: GoogleGax.ClientOptions = .init()) throws {}
  }
#endif
