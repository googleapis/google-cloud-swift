...
// limitations under the License.
  ...
  public struct ListConversationModelsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ListConversationModelsRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListConversationModelsRequest().with { $0.parent = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.ListConversationModelsRequest"
    }
