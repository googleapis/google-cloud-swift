...
// limitations under the License.
  ...
  public struct FreeFormContext: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `FreeFormContext`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = FreeFormContext().with { $0.text = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.FreeFormContext"
    }
