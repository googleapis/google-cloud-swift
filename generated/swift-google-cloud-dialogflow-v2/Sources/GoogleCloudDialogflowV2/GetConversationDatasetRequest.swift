...
// limitations under the License.
  ...
  public struct GetConversationDatasetRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `GetConversationDatasetRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = GetConversationDatasetRequest().with { $0.name = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.GetConversationDatasetRequest"
    }
