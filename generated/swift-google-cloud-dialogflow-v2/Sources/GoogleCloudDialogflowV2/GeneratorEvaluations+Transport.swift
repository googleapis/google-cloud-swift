...
// limitations under the License.
  ...
  extension Clients {
    final class GeneratorEvaluationsTransport: GeneratorEvaluationsStub {
        ...
        let (path, query, configure) = try {
            ...
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  ...
                  .literal("/generators/"), .singleWildcard,
                ],
                fieldName: "parent")
            else {
              return nil
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "parent",
              expecting: "projects/*/locations/*/generators/*"
            )
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                  .literal("/generators/"), .singleWildcard, .literal("/evaluations/"),
                  .singleWildcard,
                ],
                fieldName: "name")
            else {
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "name",
              expecting: "projects/*/locations/*/generators/*/evaluations/*"
            )
            paths.append(builder.build())
          }
          throw GoogleGax.RequestError.binding(GoogleGax.BindingError(paths: paths))
