...
// limitations under the License.
  ...
  public struct UndeployConversationModelRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `UndeployConversationModelRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = UndeployConversationModelRequest().with { $0.name = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.UndeployConversationModelRequest"
    }
