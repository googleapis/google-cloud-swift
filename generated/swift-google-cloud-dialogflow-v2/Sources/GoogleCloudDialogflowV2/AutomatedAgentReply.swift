...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var automatedAgentReplyType: AutomatedAgentReply.AutomatedAgentReplyType =
    ...
    ///
    /// ```
    /// let value = AutomatedAgentReply().with { $0.detectIntentResponse = ... }
    /// ```
    ...
    public enum AutomatedAgentReplyType: Codable, Equatable, Sendable {
      ...
      public var stringValue: Swift.String? {
        switch self {
        case .unspecified: return "AUTOMATED_AGENT_REPLY_TYPE_UNSPECIFIED"
      ...
      ///
      /// If the value is unknown, this initializes to [`unknownStringValue`](doc:AutomatedAgentReplyType/unknownStringValue(_:)).
      public init(stringValue: Swift.String) {
        switch stringValue {
        case "AUTOMATED_AGENT_REPLY_TYPE_UNSPECIFIED": self = .unspecified
      ...
      ///
      /// If the value is unknown, this initializes to [`unknownIntValue`](doc:AutomatedAgentReplyType/unknownIntValue(_:)).
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.AutomatedAgentReply"
    }
