...
// limitations under the License.
  ...
  public struct SummarizationSectionList: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `SummarizationSectionList`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SummarizationSectionList().with { $0.summarizationSections = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.SummarizationSectionList"
    }
