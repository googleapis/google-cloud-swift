...
// limitations under the License.
  ...
  public struct ListParticipantsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ListParticipantsRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListParticipantsRequest().with { $0.parent = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.ListParticipantsRequest"
    }
