...
// limitations under the License.
  ...
  public struct SearchAgentsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `SearchAgentsResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SearchAgentsResponse().with { $0.agents = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.SearchAgentsResponse"
    }
  ...
  extension SearchAgentsResponse: GoogleGax._PaginatedResponse {
