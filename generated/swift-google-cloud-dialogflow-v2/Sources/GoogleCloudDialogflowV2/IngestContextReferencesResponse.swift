...
// limitations under the License.
  ...
  public struct IngestContextReferencesResponse: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `IngestContextReferencesResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = IngestContextReferencesResponse().with { $0.ingestedContextReferences = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.IngestContextReferencesResponse"
    }
