...
// limitations under the License.
  ...
  public struct ListConversationModelEvaluationsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ListConversationModelEvaluationsRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListConversationModelEvaluationsRequest().with { $0.parent = ... }
    /// ```
