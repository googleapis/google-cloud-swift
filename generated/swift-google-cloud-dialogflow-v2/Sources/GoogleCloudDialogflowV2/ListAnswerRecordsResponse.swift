...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var answerRecords: [AnswerRecord] = []
    ...
    ///
    /// [google.cloud.dialogflow.v2.ListAnswerRecordsRequest.page_token]: <doc:ListAnswerRecordsRequest/pageToken>
    public var nextPageToken: Swift.String = Swift.String()

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ListAnswerRecordsResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListAnswerRecordsResponse().with { $0.answerRecords = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let answerRecords = CodingKeys(stringValue: "answerRecords")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([AnswerRecord].self, forKey: .answerRecords) {
        self.answerRecords = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.answerRecords, forKey: .answerRecords)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.ListAnswerRecordsResponse"
    }
