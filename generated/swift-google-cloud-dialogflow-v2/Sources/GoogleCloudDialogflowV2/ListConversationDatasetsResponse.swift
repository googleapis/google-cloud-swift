...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var conversationDatasets: [ConversationDataset] = []
    ...
    /// Initialize a new instance of `ListConversationDatasetsResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListConversationDatasetsResponse().with { $0.conversationDatasets = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let conversationDatasets = CodingKeys(stringValue: "conversationDatasets")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [ConversationDataset].self, forKey: .conversationDatasets)
      {
        self.conversationDatasets = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.conversationDatasets, forKey: .conversationDatasets)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.ListConversationDatasetsResponse"
    }
