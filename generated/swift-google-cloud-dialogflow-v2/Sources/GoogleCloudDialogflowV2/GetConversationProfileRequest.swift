...
// limitations under the License.
  ...
  public struct GetConversationProfileRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `GetConversationProfileRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = GetConversationProfileRequest().with { $0.name = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.GetConversationProfileRequest"
    }
