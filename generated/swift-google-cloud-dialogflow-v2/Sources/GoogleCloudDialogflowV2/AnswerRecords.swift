...
// limitations under the License.
  ...
  extension Clients {
    ...
    public protocol AnswerRecordsProtocol: Sendable {
  ...
  extension Clients.AnswerRecordsProtocol {
    ...
    ) -> any AsyncSequence<AnswerRecord, Swift.Error> {
      self.listAnswerRecords(byItem: byItem, options: .init())
    }
    ...
    public func listAnswerRecords(
      ...
      return self.listAnswerRecords(byItem: request)
    }
  ...
  @available(
    *, unavailable, message: "Enable the 'AnswerRecords' trait in Package.swift to use this client."
  )
  public final class AnswerRecordsClient: Sendable {
    @available(
      *, unavailable,
      message: "Enable the 'AnswerRecords' trait in Package.swift to use this client."
    )
    public init(_ options: GoogleGax.ClientOptions = .init()) throws {}
  }
#endif
