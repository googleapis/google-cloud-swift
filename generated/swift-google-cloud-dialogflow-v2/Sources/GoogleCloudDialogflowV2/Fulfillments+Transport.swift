...
// limitations under the License.
  ...
  extension Clients {
    final class FulfillmentsTransport: FulfillmentsStub {
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [.literal("projects/"), .singleWildcard, .literal("/agent/fulfillment")],
                fieldName: "name")
            else {
              return nil
            }
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              matching: [.literal("projects/"), .singleWildcard, .literal("/agent/fulfillment")],
              fieldName: "name",
              expecting: "projects/*/agent/fulfillment"
            )
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "name",
              expecting: "projects/*/locations/*/agent/fulfillment"
            )
            paths.append(builder.build())
          }
      ...
      public func updateFulfillment(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                request.fulfillment.map({ $0.name }),
                matching: [.literal("projects/"), .singleWildcard, .literal("/agent/fulfillment")],
                fieldName: "fulfillment.name")
            else {
              return nil
            }
            let path = "/v2/\(pathVariable0)"
