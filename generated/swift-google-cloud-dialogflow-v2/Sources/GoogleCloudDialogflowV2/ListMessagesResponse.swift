...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `ListMessagesResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListMessagesResponse().with { $0.messages = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.ListMessagesResponse"
    }
