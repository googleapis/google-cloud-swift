...
// limitations under the License.
  ...
  extension Clients {
    final class ContextsTransport: ContextsStub {
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/agent/sessions/"),
                  .singleWildcard,
                ],
                fieldName: "parent")
            else {
            ...
            let path = "/v2/\(pathVariable0)/contexts"
            var query = [
            ...
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  ...
                  .singleWildcard, .literal("/users/"), .singleWildcard, .literal("/sessions/"),
                  .singleWildcard,
                ],
                fieldName: "parent")
            else {
            ...
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  ...
                  .literal("/agent/sessions/"), .singleWildcard,
                ],
                fieldName: "parent")
            else {
              return nil
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                  .literal("/agent/environments/"), .singleWildcard, .literal("/users/"),
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "parent",
              expecting: "projects/*/agent/sessions/*"
            )
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "parent",
              expecting: "projects/*/agent/environments/*/users/*/sessions/*"
            )
            paths.append(builder.build())
          }
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "parent",
              expecting: "projects/*/locations/*/agent/sessions/*"
            )
            paths.append(builder.build())
          }
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "parent",
              expecting: "projects/*/locations/*/agent/environments/*/users/*/sessions/*"
            )
            paths.append(builder.build())
          }
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/agent/sessions/"),
                  .singleWildcard, .literal("/contexts/"), .singleWildcard,
                ],
                fieldName: "name")
            else {
              return nil
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                  .literal("/agent/sessions/"), .singleWildcard, .literal("/contexts/"),
                  .singleWildcard,
                ],
                fieldName: "name")
            else {
            ...
            guard
              let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
                ...
                matching: [
                  .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                  .literal("/agent/environments/"), .singleWildcard, .literal("/users/"),
                  .singleWildcard, .literal("/sessions/"), .singleWildcard, .literal("/contexts/"),
                  .singleWildcard,
                ],
                fieldName: "name")
            else {
          ...
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "name",
              expecting: "projects/*/agent/sessions/*/contexts/*"
            )
            paths.append(builder.build())
          }
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "name",
              expecting: "projects/*/agent/environments/*/users/*/sessions/*/contexts/*"
            )
            paths.append(builder.build())
          }
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "name",
              expecting: "projects/*/locations/*/agent/sessions/*/contexts/*"
            )
            paths.append(builder.build())
          }
          do {
            ...
            builder.maybeAdd(
              ...
              fieldName: "name",
              expecting: "projects/*/locations/*/agent/environments/*/users/*/sessions/*/contexts/*"
            )
            paths.append(builder.build())
          }
          throw GoogleGax.RequestError.binding(GoogleGax.BindingError(paths: paths))
      ...
      public func deleteAllContexts(
        request: DeleteAllContextsRequest, options: GoogleGax.RequestOptions
      ) async throws {
        let (path, query, configure) = try {
          () throws -> (Swift.String, [URLQueryItem], (inout GoogleGax._HTTPClientRequest) -> Void)
          in
