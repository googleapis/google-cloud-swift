...
// limitations under the License.
    ...
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = NotificationConfig().with { $0.topic = ... }
    /// ```
    ...
    public enum MessageFormat: Codable, Equatable, Sendable {
      ...
      public var stringValue: Swift.String? {
        switch self {
        case .unspecified: return "MESSAGE_FORMAT_UNSPECIFIED"
      ...
      ///
      /// If the value is unknown, this initializes to [`unknownStringValue`](doc:MessageFormat/unknownStringValue(_:)).
      public init(stringValue: Swift.String) {
        switch stringValue {
        case "MESSAGE_FORMAT_UNSPECIFIED": self = .unspecified
      ...
      ///
      /// If the value is unknown, this initializes to [`unknownIntValue`](doc:MessageFormat/unknownIntValue(_:)).
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .unspecified: return try container.encode("MESSAGE_FORMAT_UNSPECIFIED")
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.NotificationConfig"
    }
