...
// limitations under the License.
  ...
  ///
  /// [google.cloud.dialogflow.v2.EntityTypes.BatchCreateEntities]: <doc:EntityTypesClient/batchCreateEntities(request:options:)>
  public struct BatchCreateEntitiesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `BatchCreateEntitiesRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = BatchCreateEntitiesRequest().with { $0.parent = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.BatchCreateEntitiesRequest"
    }
