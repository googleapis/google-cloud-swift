...
// limitations under the License.
  ...
  public struct MessageEntry: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// Optional. Participant role of the message.
    public var role: MessageEntry.Role = MessageEntry.Role()
    ...
    /// Initialize a new instance of `MessageEntry`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = MessageEntry().with { $0.role = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(MessageEntry.Role.self, forKey: .role) {
        self.role = value
      }
