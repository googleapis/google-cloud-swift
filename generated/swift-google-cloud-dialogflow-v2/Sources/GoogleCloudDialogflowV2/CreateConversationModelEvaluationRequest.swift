...
// limitations under the License.
    ...
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = CreateConversationModelEvaluationRequest().with { $0.parent = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.conversationModelEvaluation = try container.decodeIfPresent(
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encodeIfPresent(
        self.conversationModelEvaluation, forKey: .conversationModelEvaluation)
