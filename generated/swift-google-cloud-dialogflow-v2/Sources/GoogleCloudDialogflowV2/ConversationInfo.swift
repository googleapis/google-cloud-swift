...
// limitations under the License.
  ...
  public struct ConversationInfo: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ConversationInfo`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ConversationInfo().with { $0.languageCode = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.ConversationInfo"
    }
