...
// limitations under the License.
  ...
  public struct DeleteConversationDatasetRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `DeleteConversationDatasetRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DeleteConversationDatasetRequest().with { $0.name = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.DeleteConversationDatasetRequest"
    }
