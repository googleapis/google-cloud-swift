...
// limitations under the License.
  ...
  public struct DeleteConversationModelOperationMetadata: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `DeleteConversationModelOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DeleteConversationModelOperationMetadata().with { $0.conversationModel = ... }
    /// ```
