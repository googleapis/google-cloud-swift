...
// limitations under the License.
  ...
  public struct SummarizationSection: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(Swift.String.self, forKey: .definition) {
        self.definition = value
      }
      if let value = try container.decodeIfPresent(SummarizationSection.Type_.self, forKey: .type) {
        self.type = value
      }
    ...
    public enum Type_: Codable, Equatable, Sendable {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        case .customerDefined: return try container.encode("CUSTOMER_DEFINED")
        case .situationConcise: return try container.encode("SITUATION_CONCISE")
        case .actionConcise: return try container.encode("ACTION_CONCISE")
