  ...
  extension Clients {
    final class GeneratorsTransport: GeneratorsStub {
      ...
      public func createGenerator(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            let path = "/v2/\(pathVariable0)/generators"
            var query = [
        ...
        return try await req.rpc(
          GoogleCloudDialogflowV2.Generator.self, timeout: options.attemptTimeout
        ).get()
      }
      ...
      public func listGenerators(
        ...
        req.addHeader(name: GoogleGax._HeaderNames.apiClient, value: Clients.clientHeader)
        return try await req.rpc(
          GoogleCloudDialogflowV2.ListGeneratorsResponse.self, timeout: options.attemptTimeout
        ).get()
      }
