...
// limitations under the License.
  ...
  public struct GetValidationResultRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `GetValidationResultRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = GetValidationResultRequest().with { $0.parent = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.dialogflow.v2.GetValidationResultRequest"
    }
