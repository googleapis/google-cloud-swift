...
// limitations under the License.
  ...
  ///
  /// [google.cloud.dialogflow.v2.Documents.ExportDocument]: <doc:DocumentsClient/exportDocument(request:options:)>
  public struct ExportDocumentRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
