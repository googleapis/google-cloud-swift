  ...
  Sendable
{
  ...
  /// Initialize a new instance of `CreateServiceConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateServiceConfigRequest().with { $0.serviceName = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.api.servicemanagement.v1.CreateServiceConfigRequest"
  }
