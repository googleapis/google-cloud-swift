  ...
  Sendable
{
  ...
  public var services: [ManagedService] = []
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([ManagedService].self, forKey: .services) {
      self.services = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.api.servicemanagement.v1.ListServicesResponse"
  }
...
extension ListServicesResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [ManagedService] {
