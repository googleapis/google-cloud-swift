...
public struct SubmitConfigSourceRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  public var configSource: ConfigSource? = nil
  ...
  /// Initialize a new instance of `SubmitConfigSourceRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SubmitConfigSourceRequest().with { $0.serviceName = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.configSource = try container.decodeIfPresent(ConfigSource.self, forKey: .configSource)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.api.servicemanagement.v1.SubmitConfigSourceRequest"
  }
