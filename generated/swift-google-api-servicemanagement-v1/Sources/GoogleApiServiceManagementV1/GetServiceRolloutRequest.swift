...
public struct GetServiceRolloutRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetServiceRolloutRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetServiceRolloutRequest().with { $0.serviceName = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.api.servicemanagement.v1.GetServiceRolloutRequest"
  }
