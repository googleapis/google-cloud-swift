...
public struct GetServiceRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetServiceRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetServiceRequest().with { $0.serviceName = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.api.servicemanagement.v1.GetServiceRequest"
  }
