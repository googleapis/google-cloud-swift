...
Add `swift-google-api-servicemanagement-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-api-servicemanagement-v1.git --from 0.1.0-preview
```

Then add `GoogleApiServiceManagementV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleApiServiceManagementV1 <target-name> --package swift-google-api-servicemanagement-v1
```
