...
public struct OmnichannelOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `OmnichannelOperationMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = OmnichannelOperationMetadata().with { $0.createTime = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ces.v1.OmnichannelOperationMetadata"
  }
