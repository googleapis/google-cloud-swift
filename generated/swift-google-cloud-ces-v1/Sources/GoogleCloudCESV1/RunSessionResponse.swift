...
public struct RunSessionResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `RunSessionResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RunSessionResponse().with { $0.outputs = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([SessionOutput].self, forKey: .outputs) {
      self.outputs = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ces.v1.RunSessionResponse"
  }
