...
public struct GenerateChatTokenResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let chatToken = CodingKeys(stringValue: "chatToken")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .chatToken) {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.chatToken, forKey: .chatToken)
