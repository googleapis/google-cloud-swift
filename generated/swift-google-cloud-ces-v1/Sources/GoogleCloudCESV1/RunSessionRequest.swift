...
public struct RunSessionRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Required. The configuration for the session.
  public var config: SessionConfig? = nil

  /// Required. Inputs for the session.
  public var inputs: [SessionInput] = []

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `RunSessionRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RunSessionRequest().with { $0.config = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.config = try container.decodeIfPresent(SessionConfig.self, forKey: .config)
    if let value = try container.decodeIfPresent([SessionInput].self, forKey: .inputs) {
      self.inputs = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ces.v1.RunSessionRequest"
  }
