  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let supportedInterfaces = CodingKeys(stringValue: "supportedInterfaces")
    static let version = CodingKeys(stringValue: "version")
    static let skills = CodingKeys(stringValue: "skills")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [AgentInterface].self, forKey: .supportedInterfaces)
    {
      self.supportedInterfaces = value
    }
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .version) {
      self.version = value
    }
    if let value = try container.decodeIfPresent([AgentSkill].self, forKey: .skills) {
      self.skills = value
    }
