...
extension Clients {
  final class ToolServiceTransport: ToolServiceStub {
    ...
    public func executeTool(
      ...
      let (path, query, configure, omitted) = try {
        ...
        if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
          ...
          let path = "/v1/\(pathVariable0):executeTool"
          let query = [
      ...
      return try await req.rpc(
        GoogleCloudCESV1.ExecuteToolResponse.self, timeout: options.attemptTimeout
      ).get()
    }
    ...
    public func retrieveToolSchema(
      ...
      let (path, query, configure, omitted) = try {
        ...
        if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
          ...
          let path = "/v1/\(pathVariable0):retrieveToolSchema"
          let query = [
            URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
          ]
          return (path, query)
      ...
      try req.setBody(json: request, omitting: omitted)
      return try await req.rpc(
        GoogleCloudCESV1.RetrieveToolSchemaResponse.self, timeout: options.attemptTimeout
      ).get()
    }
    ...
    public func retrieveTools(
      ...
      let (path, query, configure, omitted) = try {
        ...
        if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
          guard
            let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
              request.toolset as Swift.String?,
              matching: [
                .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
          ...
          let path = "/v1/\(pathVariable0):retrieveTools"
          let query = [
            URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
          ]
          return (path, query)
        }() {
          return (candidate.0, candidate.1, { $0.setMethod(.POST) }, ["toolset"])
        }
        var paths: [GoogleGax.PathMismatch] = []
        do {
          var builder = GoogleGax._PathMismatchBuilder()
      ...
      try req.setBody(json: request, omitting: omitted)
      return try await req.rpc(
        GoogleCloudCESV1.RetrieveToolsResponse.self, timeout: options.attemptTimeout
      ).get()
    }
