  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let appVersions = CodingKeys(stringValue: "appVersions")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([AppVersion].self, forKey: .appVersions) {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.appVersions, forKey: .appVersions)
