...
public struct TimeZoneSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `TimeZoneSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = TimeZoneSettings().with { $0.timeZone = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ces.v1.TimeZoneSettings"
  }
