  ...
  Sendable
{
  ...
  ///
  /// [google.cloud.ces.v1.AgentService.ListConversations]: <doc:AgentServiceClient/listConversations(request:options:)>
  /// [google.cloud.ces.v1.ListConversationsResponse.next_page_token]: <doc:ListConversationsResponse/nextPageToken>
  ...
  public var sources: [Conversation.Source] = []
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Conversation.Source].self, forKey: .sources) {
      self.sources = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ces.v1.ListConversationsRequest"
  }
