  ...
  Sendable
{
  ...
  /// subsequent pages.
  ///
  /// [google.cloud.ces.v1.ListToolsetsRequest.page_token]: <doc:ListToolsetsRequest/pageToken>
  public var nextPageToken: Swift.String = Swift.String()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `ListToolsetsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListToolsetsResponse().with { $0.toolsets = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ces.v1.ListToolsetsResponse"
  }
