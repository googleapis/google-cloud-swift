...
public struct EndpointControlPolicy: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Optional. The scope in which this policy's allowed_origins list is
  /// enforced.
  public var enforcementScope: EndpointControlPolicy.EnforcementScope =
  ...
  ///
  /// ```
  /// let value = EndpointControlPolicy().with { $0.enforcementScope = ... }
  /// ```
  ...
  ///   them to named cases.
  public enum EnforcementScope: Codable, Equatable, Hashable, Sendable {
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "ENFORCEMENT_SCOPE_UNSPECIFIED"
      case .vpcscOnly: return "VPCSC_ONLY"
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:EnforcementScope/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "ENFORCEMENT_SCOPE_UNSPECIFIED": self = .unspecified
      case "VPCSC_ONLY": self = .vpcscOnly
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:EnforcementScope/unknownIntValue(_:)).
    public init(intValue: Int) {
      switch intValue {
      case 0: self = .unspecified
      case 1: self = .vpcscOnly
      case 2: self = .always
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ces.v1.EndpointControlPolicy"
  }
