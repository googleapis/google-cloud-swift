  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let invalid = CodingKeys(stringValue: "invalid")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.Bool.self, forKey: .invalid) {
      self.invalid = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.invalid, forKey: .invalid)
