  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let endpointControlPolicy = CodingKeys(stringValue: "endpointControlPolicy")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.endpointControlPolicy = try container.decodeIfPresent(
      EndpointControlPolicy.self, forKey: .endpointControlPolicy)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.endpointControlPolicy, forKey: .endpointControlPolicy)
