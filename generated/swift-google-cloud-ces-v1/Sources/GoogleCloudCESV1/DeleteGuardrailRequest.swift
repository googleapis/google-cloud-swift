...
public struct DeleteGuardrailRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteGuardrailRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteGuardrailRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ces.v1.DeleteGuardrailRequest"
  }
