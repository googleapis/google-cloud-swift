...
public struct ListAppVersionsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// [google.cloud.ces.v1.AgentService.ListAppVersions]: <doc:AgentServiceClient/listAppVersions(request:options:)>
  /// [google.cloud.ces.v1.ListAppVersionsResponse.next_page_token]: <doc:ListAppVersionsResponse/nextPageToken>
  ...
  /// Initialize a new instance of `ListAppVersionsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAppVersionsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ces.v1.ListAppVersionsRequest"
  }
