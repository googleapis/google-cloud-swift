...
public struct Omnichannel: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let integrationConfig = CodingKeys(stringValue: "integrationConfig")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.integrationConfig = try container.decodeIfPresent(
      OmnichannelIntegrationConfig.self, forKey: .integrationConfig)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.integrationConfig, forKey: .integrationConfig)
