...
///   them to named cases.
public enum ExecutionType: Codable, Equatable, Hashable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "EXECUTION_TYPE_UNSPECIFIED"
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    switch self {
    case .unspecified: return try container.encode("EXECUTION_TYPE_UNSPECIFIED")
