...
///
/// [google.cloud.ces.v1.AgentService.DeleteApp]: <doc:AgentServiceClient/deleteApp(request:options:)>
public struct DeleteAppRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteAppRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteAppRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ces.v1.DeleteAppRequest"
  }
