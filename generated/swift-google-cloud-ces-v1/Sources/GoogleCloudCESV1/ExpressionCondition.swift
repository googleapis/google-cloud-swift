...
public struct ExpressionCondition: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ExpressionCondition`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ExpressionCondition().with { $0.expression = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ces.v1.ExpressionCondition"
  }
