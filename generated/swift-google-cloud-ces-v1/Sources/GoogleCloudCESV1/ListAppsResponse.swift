...
///
/// [google.cloud.ces.v1.AgentService.ListApps]: <doc:AgentServiceClient/listApps(request:options:)>
public struct ListAppsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The list of apps.
  public var apps: [App] = []
  ...
  /// subsequent pages.
  ///
  /// [google.cloud.ces.v1.ListAppsRequest.page_token]: <doc:ListAppsRequest/pageToken>
  ...
  /// Initialize a new instance of `ListAppsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAppsResponse().with { $0.apps = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let apps = CodingKeys(stringValue: "apps")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([App].self, forKey: .apps) {
      self.apps = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ces.v1.ListAppsResponse"
  }
...
extension ListAppsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [App] {
    return self.apps
  }
