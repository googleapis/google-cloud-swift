...
public struct RecognitionResult: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `RecognitionResult`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RecognitionResult().with { $0.transcript = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ces.v1.RecognitionResult"
  }
