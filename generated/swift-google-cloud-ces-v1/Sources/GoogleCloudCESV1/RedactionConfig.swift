  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let enableRedaction = CodingKeys(stringValue: "enableRedaction")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.Bool.self, forKey: .enableRedaction) {
      self.enableRedaction = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.enableRedaction, forKey: .enableRedaction)
