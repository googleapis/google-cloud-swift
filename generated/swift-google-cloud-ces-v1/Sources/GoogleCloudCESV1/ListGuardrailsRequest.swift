...
public struct ListGuardrailsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListGuardrailsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListGuardrailsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ces.v1.ListGuardrailsRequest"
  }
