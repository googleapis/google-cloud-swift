...
public struct ListGuardrailsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// subsequent pages.
  ///
  /// [google.cloud.ces.v1.ListGuardrailsRequest.page_token]: <doc:ListGuardrailsRequest/pageToken>
  public var nextPageToken: Swift.String = Swift.String()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `ListGuardrailsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListGuardrailsResponse().with { $0.guardrails = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ces.v1.ListGuardrailsResponse"
  }
...
extension ListGuardrailsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Guardrail] {
