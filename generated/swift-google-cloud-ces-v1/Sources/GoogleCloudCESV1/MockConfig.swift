...
public struct MockConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///   them to named cases.
  public enum UnmatchedToolCallBehavior: Codable, Equatable, Hashable, Sendable {
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:UnmatchedToolCallBehavior/unknownStringValue(_:)).
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:UnmatchedToolCallBehavior/unknownIntValue(_:)).
