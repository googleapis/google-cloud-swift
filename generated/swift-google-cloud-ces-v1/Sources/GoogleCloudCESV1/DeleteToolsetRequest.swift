...
///
/// [google.cloud.ces.v1.AgentService.DeleteToolset]: <doc:AgentServiceClient/deleteToolset(request:options:)>
public struct DeleteToolsetRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
