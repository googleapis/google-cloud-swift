...
public struct AgentTool: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `AgentTool`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AgentTool().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ces.v1.AgentTool"
  }
