...
public struct ExportAppRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let exportFormat = CodingKeys(stringValue: "exportFormat")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      ExportAppRequest.ExportFormat.self, forKey: .exportFormat)
    {
  ...
  public enum ExportFormat: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("EXPORT_FORMAT_UNSPECIFIED")
