...
public struct ListToolsetsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListToolsetsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListToolsetsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ces.v1.ListToolsetsRequest"
  }
