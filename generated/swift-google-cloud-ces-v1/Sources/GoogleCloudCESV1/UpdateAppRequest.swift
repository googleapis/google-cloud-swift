...
///
/// [google.cloud.ces.v1.AgentService.UpdateApp]: <doc:AgentServiceClient/updateApp(request:options:)>
public struct UpdateAppRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateAppRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateAppRequest().with { $0.app = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ces.v1.UpdateAppRequest"
  }
