...
public struct WebSearchQuery: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `WebSearchQuery`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = WebSearchQuery().with { $0.query = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.ces.v1.WebSearchQuery"
  }
