...
public struct CloudSqlDiscoveryTarget: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  public var filter: DiscoveryCloudSqlFilter? = nil

  /// In addition to matching the filter, these conditions must be true
  /// before a profile is generated.
  public var conditions: DiscoveryCloudSqlConditions? = nil
  ...
  ///
  /// ```
  /// let value = CloudSqlDiscoveryTarget().with { $0.filter = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.conditions = try container.decodeIfPresent(
      DiscoveryCloudSqlConditions.self, forKey: .conditions)
