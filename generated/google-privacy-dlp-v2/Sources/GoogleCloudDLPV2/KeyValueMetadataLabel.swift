...
public struct KeyValueMetadataLabel: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `KeyValueMetadataLabel`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = KeyValueMetadataLabel().with { $0.key = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.privacy.dlp.v2.KeyValueMetadataLabel"
  }
