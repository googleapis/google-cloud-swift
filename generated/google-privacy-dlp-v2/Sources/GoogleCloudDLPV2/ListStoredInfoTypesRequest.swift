...
public struct ListStoredInfoTypesRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListStoredInfoTypesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListStoredInfoTypesRequest().with { $0.parent = ... }
  /// ```
