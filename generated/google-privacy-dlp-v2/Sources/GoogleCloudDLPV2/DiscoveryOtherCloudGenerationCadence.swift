...
/// capacity.
public struct DiscoveryOtherCloudGenerationCadence: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DiscoveryOtherCloudGenerationCadence`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DiscoveryOtherCloudGenerationCadence().with { $0.refreshFrequency = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.privacy.dlp.v2.DiscoveryOtherCloudGenerationCadence"
  }
