...
public struct DatabaseResourceCollection: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DatabaseResourceCollection`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DatabaseResourceCollection().with { $0.includeRegexes = ... }
  /// ```
