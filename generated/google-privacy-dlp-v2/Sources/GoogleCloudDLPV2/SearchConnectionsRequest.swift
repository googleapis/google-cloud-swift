...
public struct SearchConnectionsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SearchConnectionsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SearchConnectionsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.privacy.dlp.v2.SearchConnectionsRequest"
  }
