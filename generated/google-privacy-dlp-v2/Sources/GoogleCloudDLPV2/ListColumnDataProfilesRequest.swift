...
public struct ListColumnDataProfilesRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListColumnDataProfilesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListColumnDataProfilesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.privacy.dlp.v2.ListColumnDataProfilesRequest"
  }
