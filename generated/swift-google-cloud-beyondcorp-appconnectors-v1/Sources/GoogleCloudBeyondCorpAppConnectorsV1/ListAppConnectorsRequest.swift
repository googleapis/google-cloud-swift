...
public struct ListAppConnectorsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListAppConnectorsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAppConnectorsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.beyondcorp.appconnectors.v1.ListAppConnectorsRequest"
  }
