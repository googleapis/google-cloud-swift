...
public struct AppConnectorOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `AppConnectorOperationMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AppConnectorOperationMetadata().with { $0.createTime = ... }
  /// ```
