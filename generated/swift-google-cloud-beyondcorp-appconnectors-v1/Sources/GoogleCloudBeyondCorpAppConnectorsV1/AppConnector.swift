...
public struct AppConnector: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let principalInfo = CodingKeys(stringValue: "principalInfo")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(AppConnector.State.self, forKey: .state) {
      self.state = value
    }
    self.principalInfo = try container.decodeIfPresent(
      AppConnector.PrincipalInfo.self, forKey: .principalInfo)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.principalInfo, forKey: .principalInfo)
  ...
  public struct PrincipalInfo: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
