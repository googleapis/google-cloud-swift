...
public struct DeleteAppConnectorRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteAppConnectorRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteAppConnectorRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.beyondcorp.appconnectors.v1.DeleteAppConnectorRequest"
  }
