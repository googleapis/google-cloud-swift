...
public struct DeleteProcessorMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteProcessorMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteProcessorMetadata().with { $0.commonMetadata = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.documentai.v1.DeleteProcessorMetadata"
  }
