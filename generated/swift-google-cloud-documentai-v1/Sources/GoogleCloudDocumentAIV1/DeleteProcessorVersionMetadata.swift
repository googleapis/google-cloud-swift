...
public struct DeleteProcessorVersionMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteProcessorVersionMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteProcessorVersionMetadata().with { $0.commonMetadata = ... }
  /// ```
