...
public struct DeployProcessorVersionMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeployProcessorVersionMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeployProcessorVersionMetadata().with { $0.commonMetadata = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.documentai.v1.DeployProcessorVersionMetadata"
  }
