...
public struct FetchProcessorTypesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `FetchProcessorTypesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FetchProcessorTypesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.documentai.v1.FetchProcessorTypesRequest"
  }
