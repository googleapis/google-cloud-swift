...
public struct ListProcessorTypesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListProcessorTypesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListProcessorTypesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.documentai.v1.ListProcessorTypesRequest"
  }
