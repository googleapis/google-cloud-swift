...
public struct EnableProcessorMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `EnableProcessorMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = EnableProcessorMetadata().with { $0.commonMetadata = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.documentai.v1.EnableProcessorMetadata"
  }
