...
public struct UndeployProcessorVersionMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UndeployProcessorVersionMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UndeployProcessorVersionMetadata().with { $0.commonMetadata = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.documentai.v1.UndeployProcessorVersionMetadata"
  }
