...
public struct DisableProcessorMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DisableProcessorMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DisableProcessorMetadata().with { $0.commonMetadata = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.documentai.v1.DisableProcessorMetadata"
  }
