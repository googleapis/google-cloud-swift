...
public struct GcsDocument: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GcsDocument`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GcsDocument().with { $0.gcsUri = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.documentai.v1.GcsDocument"
  }
