...
public struct SetDefaultProcessorVersionMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SetDefaultProcessorVersionMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SetDefaultProcessorVersionMetadata().with { $0.commonMetadata = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.documentai.v1.SetDefaultProcessorVersionMetadata"
  }
