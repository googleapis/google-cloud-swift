  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let workflows = CodingKeys(stringValue: "workflows")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Workflow].self, forKey: .workflows) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.workflows.v1.ListWorkflowRevisionsResponse"
  }
