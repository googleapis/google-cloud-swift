...
/// method.
///
/// [google.cloud.workflows.v1.Workflows.DeleteWorkflow]: <doc:WorkflowsClient/deleteWorkflow(request:options:)>
public struct DeleteWorkflowRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
