...
Add `swift-google-cloud-securitycenter-v2` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-securitycenter-v2.git --from 0.0.0-preview
```

Then add `GoogleCloudSecurityCenterV2` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudSecurityCenterV2 <target-name> --package swift-google-cloud-securitycenter-v2
```
