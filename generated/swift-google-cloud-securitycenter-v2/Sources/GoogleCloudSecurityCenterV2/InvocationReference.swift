...
public struct InvocationReference: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `InvocationReference`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = InvocationReference().with { $0.invocationId = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securitycenter.v2.InvocationReference"
  }
