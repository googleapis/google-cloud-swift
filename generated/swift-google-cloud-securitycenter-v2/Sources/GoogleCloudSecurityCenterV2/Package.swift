...
public struct Package: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var packageVersion: Swift.String = Swift.String()
  ...
  ///
  /// ```
  /// let value = Package().with { $0.packageName = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let packageVersion = CodingKeys(stringValue: "packageVersion")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .packageVersion) {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.packageVersion, forKey: .packageVersion)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securitycenter.v2.Package"
  }
