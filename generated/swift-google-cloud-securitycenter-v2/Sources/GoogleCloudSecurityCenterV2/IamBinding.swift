...
/// removal, or state.
public struct IamBinding: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  /// The action that was performed on a Binding.
  public var action: IamBinding.Action = IamBinding.Action()
  ...
  /// Initialize a new instance of `IamBinding`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = IamBinding().with { $0.action = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(IamBinding.Action.self, forKey: .action) {
      self.action = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securitycenter.v2.IamBinding"
  }
