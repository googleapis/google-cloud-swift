...
public struct BulkMuteFindingsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let muteState = CodingKeys(stringValue: "muteState")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      BulkMuteFindingsRequest.MuteState.self, forKey: .muteState)
    {
      self.muteState = value
    }
  ...
  ///   them to named cases.
  public enum MuteState: Codable, Equatable, Hashable, Sendable {
    /// Unused.
    case unspecified
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("MUTE_STATE_UNSPECIFIED")
