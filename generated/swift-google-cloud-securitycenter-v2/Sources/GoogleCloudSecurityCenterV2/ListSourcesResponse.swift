...
public struct ListSourcesResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListSourcesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListSourcesResponse().with { $0.sources = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Source].self, forKey: .sources) {
      self.sources = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securitycenter.v2.ListSourcesResponse"
  }
