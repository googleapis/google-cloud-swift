  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let mostRecentEditor = CodingKeys(stringValue: "mostRecentEditor")
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.mostRecentEditor, forKey: .mostRecentEditor)
  ...
  ///   them to named cases.
  public enum MuteConfigType: Codable, Equatable, Hashable, Sendable {
    /// Unused.
    case unspecified
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("MUTE_CONFIG_TYPE_UNSPECIFIED")
