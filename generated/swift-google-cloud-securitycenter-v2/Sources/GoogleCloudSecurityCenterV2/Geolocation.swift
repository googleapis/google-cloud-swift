...
public struct Geolocation: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// A CLDR.
  ...
  /// Initialize a new instance of `Geolocation`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = Geolocation().with { $0.regionCode = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.securitycenter.v2.Geolocation"
  }
