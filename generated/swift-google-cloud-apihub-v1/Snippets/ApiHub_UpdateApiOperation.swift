...
func sample(
  ...
  let response = try await client.updateApiOperation(
    request: UpdateApiOperationRequest()
      .with {
        $0.apiOperation = ApiOperation().with {
          $0.name =
  ...
  static func main() async throws {
    do {
      ...
      try await sample(
        ...
        apiId: "[placeholder]", versionId: "[placeholder]", operationId: "[placeholder]")
    } catch {
      print("Error: \(error)")
    }
  }
