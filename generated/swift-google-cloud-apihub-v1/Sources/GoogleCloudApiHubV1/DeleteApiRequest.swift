...
///
/// [google.cloud.apihub.v1.ApiHub.DeleteApi]: <doc:ApiHubClient/deleteApi(request:options:)>
public struct DeleteApiRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
