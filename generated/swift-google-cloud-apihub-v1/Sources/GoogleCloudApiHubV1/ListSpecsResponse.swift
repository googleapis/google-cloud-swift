  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListSpecsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListSpecsResponse().with { $0.specs = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Spec].self, forKey: .specs) {
      self.specs = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apihub.v1.ListSpecsResponse"
  }
