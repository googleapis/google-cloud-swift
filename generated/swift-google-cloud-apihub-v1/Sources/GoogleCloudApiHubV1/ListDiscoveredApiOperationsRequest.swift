...
public struct ListDiscoveredApiOperationsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDiscoveredApiOperationsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDiscoveredApiOperationsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apihub.v1.ListDiscoveredApiOperationsRequest"
  }
