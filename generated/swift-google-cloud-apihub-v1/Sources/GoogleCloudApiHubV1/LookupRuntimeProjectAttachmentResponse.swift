...
public struct LookupRuntimeProjectAttachmentResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = LookupRuntimeProjectAttachmentResponse().with { $0.runtimeProjectAttachment = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apihub.v1.LookupRuntimeProjectAttachmentResponse"
  }
