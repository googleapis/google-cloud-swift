...
extension Clients {
  final class LintingServiceTransport: LintingServiceStub {
    ...
    public func getStyleGuide(
      ...
      let (path, query, configure) = try {
          ...
          guard
            let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
              ...
              matching: [
                ...
                .literal("/plugins/"), .singleWildcard, .literal("/styleGuide"),
              ],
              fieldName: "name")
          else {
            return nil
        ...
        do {
          ...
          builder.maybeAdd(
            ...
            fieldName: "name",
            expecting: "projects/*/locations/*/plugins/*/styleGuide"
          )
      ...
      return try await req.rpc(
        GoogleCloudApiHubV1.StyleGuide.self, timeout: options.attemptTimeout
      ).get()
    }
    ...
    public func updateStyleGuide(
      ...
      let (path, query, configure) = try {
        ...
        if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
          guard
            let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
              request.styleGuide.map({ $0.name }),
              matching: [
                .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                .literal("/plugins/"), .singleWildcard, .literal("/styleGuide"),
              ],
              fieldName: "style_guide.name")
          else {
            return nil
          }
          let path = "/v1/\(pathVariable0)"
      ...
      configure(&req)
      req.addHeader(name: GoogleGax._HeaderNames.apiClient, value: Clients.clientHeader)
      if let body = request.styleGuide {
    ...
    public func getStyleGuideContents(
      ...
      req.addHeader(name: GoogleGax._HeaderNames.apiClient, value: Clients.clientHeader)
      return try await req.rpc(
        GoogleCloudApiHubV1.StyleGuideContents.self, timeout: options.attemptTimeout
      ).get()
    }
    ...
    public func lintSpec(
      ...
      let (path, query, configure, omitted) = try {
        ...
        if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
          ...
          let path = "/v1/\(pathVariable0):lint"
          let query = [
            URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
          ]
          return (path, query)
