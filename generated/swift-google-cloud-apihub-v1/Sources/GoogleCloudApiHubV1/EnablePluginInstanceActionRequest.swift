...
public struct EnablePluginInstanceActionRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `EnablePluginInstanceActionRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = EnablePluginInstanceActionRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apihub.v1.EnablePluginInstanceActionRequest"
  }
