...
public struct GetRuntimeProjectAttachmentRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetRuntimeProjectAttachmentRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetRuntimeProjectAttachmentRequest().with { $0.name = ... }
  /// ```
