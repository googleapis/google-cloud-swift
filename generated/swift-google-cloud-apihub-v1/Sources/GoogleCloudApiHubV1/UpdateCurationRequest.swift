...
public struct UpdateCurationRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateCurationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateCurationRequest().with { $0.curation = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apihub.v1.UpdateCurationRequest"
  }
