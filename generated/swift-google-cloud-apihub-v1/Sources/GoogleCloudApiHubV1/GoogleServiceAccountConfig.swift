...
public struct GoogleServiceAccountConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GoogleServiceAccountConfig`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GoogleServiceAccountConfig().with { $0.serviceAccount = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apihub.v1.GoogleServiceAccountConfig"
  }
