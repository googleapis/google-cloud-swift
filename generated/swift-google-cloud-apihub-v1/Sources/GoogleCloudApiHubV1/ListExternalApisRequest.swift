...
public struct ListExternalApisRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListExternalApisRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListExternalApisRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apihub.v1.ListExternalApisRequest"
  }
