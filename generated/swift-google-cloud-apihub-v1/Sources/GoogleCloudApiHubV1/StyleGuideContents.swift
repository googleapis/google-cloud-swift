...
public struct StyleGuideContents: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `StyleGuideContents`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = StyleGuideContents().with { $0.contents = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apihub.v1.StyleGuideContents"
  }
