  ...
  Sendable
{
  ...
  public var resource: ApiHubResource? = nil
  ...
  ///
  /// ```
  /// let value = SearchResult().with { $0.resource = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.resource = try container.decodeIfPresent(ApiHubResource.self, forKey: .resource)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apihub.v1.SearchResult"
  }
