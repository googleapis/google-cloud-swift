  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListApisResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListApisResponse().with { $0.apis = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Api].self, forKey: .apis) {
      self.apis = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apihub.v1.ListApisResponse"
  }
