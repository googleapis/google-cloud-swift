...
public enum PluginCategory: Codable, Equatable, Hashable, Sendable {
  ...
  public var intValue: Int? {
    ...
    case .apiGateway: return 1
    case .apiProducer: return 2
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "PLUGIN_CATEGORY_UNSPECIFIED"
    case .apiGateway: return "API_GATEWAY"
    case .apiProducer: return "API_PRODUCER"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:PluginCategory/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "PLUGIN_CATEGORY_UNSPECIFIED": self = .unspecified
    case "API_GATEWAY": self = .apiGateway
    case "API_PRODUCER": self = .apiProducer
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:PluginCategory/unknownIntValue(_:)).
  public init(intValue: Int) {
    switch intValue {
    case 0: self = .unspecified
    case 1: self = .apiGateway
    case 2: self = .apiProducer
