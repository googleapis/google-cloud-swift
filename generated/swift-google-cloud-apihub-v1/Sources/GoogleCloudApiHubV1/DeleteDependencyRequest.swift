...
public struct DeleteDependencyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteDependencyRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteDependencyRequest().with { $0.name = ... }
  /// ```
