  ...
  Sendable
{
  ...
  public var discoveredApiObservations: [DiscoveredApiObservation] = []
  ...
  /// Initialize a new instance of `ListDiscoveredApiObservationsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDiscoveredApiObservationsResponse().with { $0.discoveredApiObservations = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let discoveredApiObservations = CodingKeys(stringValue: "discoveredApiObservations")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [DiscoveredApiObservation].self, forKey: .discoveredApiObservations)
    {
      self.discoveredApiObservations = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.discoveredApiObservations, forKey: .discoveredApiObservations)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apihub.v1.ListDiscoveredApiObservationsResponse"
  }
