...
public struct OpenApiSpecDetails: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(OpenApiSpecDetails.Format.self, forKey: .format) {
      self.format = value
    }
