  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListDependenciesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDependenciesResponse().with { $0.dependencies = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apihub.v1.ListDependenciesResponse"
  }
