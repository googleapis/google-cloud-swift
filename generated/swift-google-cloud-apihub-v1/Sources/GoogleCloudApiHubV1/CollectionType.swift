...
///   them to named cases.
public enum CollectionType: Codable, Equatable, Hashable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "COLLECTION_TYPE_UNSPECIFIED"
    case .upsert: return "COLLECTION_TYPE_UPSERT"
    case .delete: return "COLLECTION_TYPE_DELETE"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:CollectionType/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "COLLECTION_TYPE_UNSPECIFIED": self = .unspecified
    case "COLLECTION_TYPE_UPSERT": self = .upsert
    case "COLLECTION_TYPE_DELETE": self = .delete
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:CollectionType/unknownIntValue(_:)).
