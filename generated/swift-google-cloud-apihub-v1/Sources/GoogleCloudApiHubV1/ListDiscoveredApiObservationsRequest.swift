...
public struct ListDiscoveredApiObservationsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDiscoveredApiObservationsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDiscoveredApiObservationsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apihub.v1.ListDiscoveredApiObservationsRequest"
  }
