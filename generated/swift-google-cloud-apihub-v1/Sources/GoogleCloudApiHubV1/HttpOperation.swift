...
/// The HTTP Operation.
public struct HttpOperation: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.path = try container.decodeIfPresent(Path.self, forKey: .path)
    if let value = try container.decodeIfPresent(HttpOperation.Method.self, forKey: .method) {
      self.method = value
    }
