  ...
  Sendable
{
  ...
  public var pluginInstances: [PluginInstance] = []
  ...
  /// Initialize a new instance of `ListPluginInstancesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPluginInstancesResponse().with { $0.pluginInstances = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let pluginInstances = CodingKeys(stringValue: "pluginInstances")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([PluginInstance].self, forKey: .pluginInstances) {
      self.pluginInstances = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.pluginInstances, forKey: .pluginInstances)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apihub.v1.ListPluginInstancesResponse"
  }
