...
/// method's request.
///
/// [google.cloud.apihub.v1.RuntimeProjectAttachmentService.CreateRuntimeProjectAttachment]: <doc:RuntimeProjectAttachmentServiceClient/createRuntimeProjectAttachment(request:options:)>
public struct CreateRuntimeProjectAttachmentRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var runtimeProjectAttachmentId: Swift.String = Swift.String()
  ...
  ///
  /// ```
  /// let value = CreateRuntimeProjectAttachmentRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apihub.v1.CreateRuntimeProjectAttachmentRequest"
  }
