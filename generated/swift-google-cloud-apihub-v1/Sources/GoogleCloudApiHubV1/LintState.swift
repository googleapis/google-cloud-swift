...
public enum LintState: Codable, Equatable, Hashable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "LINT_STATE_UNSPECIFIED"
    case .success: return "LINT_STATE_SUCCESS"
    case .error: return "LINT_STATE_ERROR"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:LintState/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "LINT_STATE_UNSPECIFIED": self = .unspecified
    case "LINT_STATE_SUCCESS": self = .success
    case "LINT_STATE_ERROR": self = .error
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:LintState/unknownIntValue(_:)).
