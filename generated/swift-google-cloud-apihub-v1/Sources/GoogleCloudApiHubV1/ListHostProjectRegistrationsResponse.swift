  ...
  Sendable
{
  ...
  public var hostProjectRegistrations: [HostProjectRegistration] = []
  ...
  /// Initialize a new instance of `ListHostProjectRegistrationsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListHostProjectRegistrationsResponse().with { $0.hostProjectRegistrations = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let hostProjectRegistrations = CodingKeys(stringValue: "hostProjectRegistrations")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [HostProjectRegistration].self, forKey: .hostProjectRegistrations)
    {
      self.hostProjectRegistrations = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.hostProjectRegistrations, forKey: .hostProjectRegistrations)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apihub.v1.ListHostProjectRegistrationsResponse"
  }
