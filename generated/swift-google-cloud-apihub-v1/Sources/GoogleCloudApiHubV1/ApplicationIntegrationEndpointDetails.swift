...
/// curation.
public struct ApplicationIntegrationEndpointDetails: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ApplicationIntegrationEndpointDetails`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ApplicationIntegrationEndpointDetails().with { $0.uri = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apihub.v1.ApplicationIntegrationEndpointDetails"
  }
