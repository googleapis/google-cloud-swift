  ...
  Sendable
{
  ...
  public var runtimeProjectAttachments: [RuntimeProjectAttachment] = []
  ...
  /// Initialize a new instance of `ListRuntimeProjectAttachmentsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListRuntimeProjectAttachmentsResponse().with { $0.runtimeProjectAttachments = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let runtimeProjectAttachments = CodingKeys(stringValue: "runtimeProjectAttachments")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [RuntimeProjectAttachment].self, forKey: .runtimeProjectAttachments)
    {
      self.runtimeProjectAttachments = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.runtimeProjectAttachments, forKey: .runtimeProjectAttachments)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apihub.v1.ListRuntimeProjectAttachmentsResponse"
  }
