...
public struct DependencyErrorDetail: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Optional. Error in the dependency.
  public var error: DependencyErrorDetail.Error = DependencyErrorDetail.Error()
  ...
  ///
  /// ```
  /// let value = DependencyErrorDetail().with { $0.error = ... }
  /// ```
  ...
  public enum Error: Codable, Equatable, Hashable, Sendable {
    ...
    public var intValue: Int? {
      ...
      case .supplierNotFound: return 1
      case .supplierRecreated: return 2
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "ERROR_UNSPECIFIED"
      case .supplierNotFound: return "SUPPLIER_NOT_FOUND"
      case .supplierRecreated: return "SUPPLIER_RECREATED"
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:Error/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "ERROR_UNSPECIFIED": self = .unspecified
      case "SUPPLIER_NOT_FOUND": self = .supplierNotFound
      case "SUPPLIER_RECREATED": self = .supplierRecreated
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:Error/unknownIntValue(_:)).
    public init(intValue: Int) {
      switch intValue {
      case 0: self = .unspecified
      case 1: self = .supplierNotFound
      case 2: self = .supplierRecreated
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apihub.v1.DependencyErrorDetail"
  }
