  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListAttributesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAttributesResponse().with { $0.attributes = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Attribute].self, forKey: .attributes) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apihub.v1.ListAttributesResponse"
  }
