  ...
  Sendable
{
  ...
  public enum ValueType: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .multiSelect: return try container.encode("MULTI_SELECT")
      case .multiString: return try container.encode("MULTI_STRING")
      case .multiInt: return try container.encode("MULTI_INT")
