...
public struct ActionExecutionDetail: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ActionExecutionDetail`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ActionExecutionDetail().with { $0.actionId = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apihub.v1.ActionExecutionDetail"
  }
