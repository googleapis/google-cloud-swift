  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ApiData`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ApiData().with { $0.apiMetadataList = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let apiMetadataList = CodingKeys(stringValue: "apiMetadataList")
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    if let choice = self.data {
      switch choice {
      case .apiMetadataList(let value):
        try container.encode(value, forKey: .apiMetadataList)
      }
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apihub.v1.ApiData"
  }
