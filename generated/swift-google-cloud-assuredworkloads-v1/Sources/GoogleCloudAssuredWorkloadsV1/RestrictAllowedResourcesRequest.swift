...
public struct RestrictAllowedResourcesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var restrictionType: RestrictAllowedResourcesRequest.RestrictionType =
    RestrictAllowedResourcesRequest.RestrictionType()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `RestrictAllowedResourcesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RestrictAllowedResourcesRequest().with { $0.name = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let restrictionType = CodingKeys(stringValue: "restrictionType")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      RestrictAllowedResourcesRequest.RestrictionType.self, forKey: .restrictionType)
    {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.restrictionType, forKey: .restrictionType)
  ...
  public enum RestrictionType: Codable, Equatable, Hashable, Sendable {
    ...
    public var intValue: Int? {
      ...
      case .allowAllGcpResources: return 1
      case .allowCompliantResources: return 2
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "RESTRICTION_TYPE_UNSPECIFIED"
      case .allowAllGcpResources: return "ALLOW_ALL_GCP_RESOURCES"
      case .allowCompliantResources: return "ALLOW_COMPLIANT_RESOURCES"
    ...
    public init(stringValue: Swift.String) {
      ...
      case "ALLOW_ALL_GCP_RESOURCES": self = .allowAllGcpResources
      case "ALLOW_COMPLIANT_RESOURCES": self = .allowCompliantResources
    ...
    public init(intValue: Int) {
      ...
      case 1: self = .allowAllGcpResources
      case 2: self = .allowCompliantResources
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.assuredworkloads.v1.RestrictAllowedResourcesRequest"
  }
