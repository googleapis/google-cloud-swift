  ...
  Sendable
{
  ...
  /// this violation.
  public var orgPolicyConstraint: Swift.String = Swift.String()
  ...
  public var auditLogLink: Swift.String = Swift.String()
  ...
  public var acknowledged: Swift.Bool = Swift.Bool()
    ...
    Sendable
  {
    ...
    ///   them to named cases.
    public enum RemediationType: Codable, Equatable, Hashable, Sendable {
  ...
  public enum State: Codable, Equatable, Hashable, Sendable {
    ...
    public init(intValue: Int) {
      ...
      case 3: self = .unresolved
      case 4: self = .exception
      default: self = .unknownIntValue(intValue)
      }
    }
