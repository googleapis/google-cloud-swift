...
/// Next Id: 4
public struct AcknowledgeViolationRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `AcknowledgeViolationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AcknowledgeViolationRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.assuredworkloads.v1.AcknowledgeViolationRequest"
  }
