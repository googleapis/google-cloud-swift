  ...
  Sendable
{
    ...
    Sendable
  {
    ...
    public enum SetupState: Codable, Equatable, Sendable {
      ...
      /// Initialize from a string value.
      ///
      /// If the value is unknown, this initializes to [`unknownStringValue`](doc:SetupState/unknownStringValue(_:)).
      public init(stringValue: Swift.String) {
        switch stringValue {
      ...
      /// Initialize from an integer value.
      ///
      /// If the value is unknown, this initializes to [`unknownIntValue`](doc:SetupState/unknownIntValue(_:)).
      public init(intValue: Int) {
        switch intValue {
        case 0: self = .unspecified
    ...
    public enum SetupError: Codable, Equatable, Sendable {
      ...
      /// Initialize from a string value.
      ///
      /// If the value is unknown, this initializes to [`unknownStringValue`](doc:SetupError/unknownStringValue(_:)).
      public init(stringValue: Swift.String) {
        switch stringValue {
      ...
      /// Initialize from an integer value.
      ///
      /// If the value is unknown, this initializes to [`unknownIntValue`](doc:SetupError/unknownIntValue(_:)).
      public init(intValue: Int) {
        switch intValue {
        case 0: self = .unspecified
  ...
  public enum ComplianceRegime: Codable, Equatable, Sendable {
    ...
    /// Initialize from a string value.
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:ComplianceRegime/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
    ...
    /// Initialize from an integer value.
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:ComplianceRegime/unknownIntValue(_:)).
    public init(intValue: Int) {
      switch intValue {
      case 0: self = .unspecified
      case 1: self = .il4
  ...
  public enum KajEnrollmentState: Codable, Equatable, Sendable {
    ...
    /// Initialize from a string value.
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:KajEnrollmentState/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
    ...
    /// Initialize from an integer value.
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:KajEnrollmentState/unknownIntValue(_:)).
    public init(intValue: Int) {
      switch intValue {
      case 0: self = .unspecified
      case 1: self = .pending
