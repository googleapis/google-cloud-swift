...
public struct UpdateCollectorRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateCollectorRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateCollectorRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.rapidmigrationassessment.v1.UpdateCollectorRequest"
  }
