...
public struct DeleteCollectorRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteCollectorRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteCollectorRequest().with { $0.name = ... }
  /// ```
