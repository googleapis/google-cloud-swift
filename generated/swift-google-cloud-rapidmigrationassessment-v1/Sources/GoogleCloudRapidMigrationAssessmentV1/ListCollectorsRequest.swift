...
public struct ListCollectorsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListCollectorsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCollectorsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.rapidmigrationassessment.v1.ListCollectorsRequest"
  }
