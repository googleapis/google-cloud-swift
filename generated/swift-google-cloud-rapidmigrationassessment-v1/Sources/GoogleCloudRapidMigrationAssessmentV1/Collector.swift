...
public struct Collector: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// name of resource.
  ...
  public enum State: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .initializing: return try container.encode("STATE_INITIALIZING")
      case .readyToUse: return try container.encode("STATE_READY_TO_USE")
      case .registered: return try container.encode("STATE_REGISTERED")
      case .active: return try container.encode("STATE_ACTIVE")
      case .paused: return try container.encode("STATE_PAUSED")
      case .deleting: return try container.encode("STATE_DELETING")
      case .decommissioned: return try container.encode("STATE_DECOMMISSIONED")
