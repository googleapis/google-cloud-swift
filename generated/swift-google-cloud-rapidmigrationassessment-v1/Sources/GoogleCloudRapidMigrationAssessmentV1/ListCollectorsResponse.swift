  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListCollectorsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCollectorsResponse().with { $0.collectors = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let collectors = CodingKeys(stringValue: "collectors")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Collector].self, forKey: .collectors) {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.collectors, forKey: .collectors)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.rapidmigrationassessment.v1.ListCollectorsResponse"
  }
