...
public struct ResolveAppConnectionsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ResolveAppConnectionsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ResolveAppConnectionsRequest().with { $0.parent = ... }
  /// ```
