...
public struct UpdateAppConnectionRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateAppConnectionRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateAppConnectionRequest().with { $0.updateMask = ... }
  /// ```
