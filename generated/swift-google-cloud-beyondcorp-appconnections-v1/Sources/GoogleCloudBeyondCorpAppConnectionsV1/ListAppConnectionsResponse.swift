...
public struct ListAppConnectionsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// A list of BeyondCorp AppConnections in the project.
  public var appConnections: [AppConnection] = []
  ...
  /// Initialize a new instance of `ListAppConnectionsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAppConnectionsResponse().with { $0.appConnections = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let appConnections = CodingKeys(stringValue: "appConnections")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([AppConnection].self, forKey: .appConnections) {
      self.appConnections = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.appConnections, forKey: .appConnections)
...
extension ListAppConnectionsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [AppConnection] {
