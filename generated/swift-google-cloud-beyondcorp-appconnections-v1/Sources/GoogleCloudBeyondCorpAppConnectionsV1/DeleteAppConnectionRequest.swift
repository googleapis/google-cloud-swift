...
public struct DeleteAppConnectionRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteAppConnectionRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteAppConnectionRequest().with { $0.name = ... }
  /// ```
