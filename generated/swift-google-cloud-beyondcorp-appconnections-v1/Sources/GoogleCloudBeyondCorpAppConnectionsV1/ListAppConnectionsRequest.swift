...
public struct ListAppConnectionsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListAppConnectionsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAppConnectionsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.beyondcorp.appconnections.v1.ListAppConnectionsRequest"
  }
