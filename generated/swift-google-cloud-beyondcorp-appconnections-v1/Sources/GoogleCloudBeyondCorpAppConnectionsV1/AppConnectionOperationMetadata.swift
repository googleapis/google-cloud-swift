...
public struct AppConnectionOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `AppConnectionOperationMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AppConnectionOperationMetadata().with { $0.createTime = ... }
  /// ```
