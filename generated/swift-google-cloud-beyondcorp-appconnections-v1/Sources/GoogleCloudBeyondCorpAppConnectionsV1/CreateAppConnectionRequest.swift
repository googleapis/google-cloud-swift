...
public struct CreateAppConnectionRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var appConnectionId: Swift.String = Swift.String()
  ...
  /// Initialize a new instance of `CreateAppConnectionRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateAppConnectionRequest().with { $0.parent = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let appConnectionId = CodingKeys(stringValue: "appConnectionId")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .appConnectionId) {
      self.appConnectionId = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.appConnectionId, forKey: .appConnectionId)
