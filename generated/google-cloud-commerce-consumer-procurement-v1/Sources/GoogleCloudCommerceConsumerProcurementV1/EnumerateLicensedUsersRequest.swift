...
public struct EnumerateLicensedUsersRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `EnumerateLicensedUsersRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = EnumerateLicensedUsersRequest().with { $0.parent = ... }
  /// ```
