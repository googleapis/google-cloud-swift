...
extension Clients {
  ...
  class ConsumerProcurementServiceTransport: ConsumerProcurementServiceStub {
    ...
    public func placeOrder(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/orders:place"
      }()
      let query = [
    ...
    public func getOrder(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudCommerceConsumerProcurementV1.Order.self, from: data)
    }
    ...
    public func listOrders(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/orders"
      }()
      var query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudCommerceConsumerProcurementV1.ListOrdersResponse.self, from: data)
    }
    ...
    public func modifyOrder(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0):modify"
      }()
      let query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
