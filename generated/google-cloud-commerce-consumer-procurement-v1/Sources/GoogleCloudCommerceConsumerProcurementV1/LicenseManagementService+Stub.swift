...
extension Clients {
  ...
  class LicenseManagementServiceTransport: LicenseManagementServiceStub {
    ...
    public func getLicensePool(
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudCommerceConsumerProcurementV1.LicensePool.self, from: data)
    }
    ...
    public func assign(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudCommerceConsumerProcurementV1.AssignResponse.self, from: data)
    }
    ...
    public func unassign(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudCommerceConsumerProcurementV1.UnassignResponse.self, from: data)
    }
    ...
    public func enumerateLicensedUsers(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudCommerceConsumerProcurementV1.EnumerateLicensedUsersResponse.self, from: data)
    }
