...
public struct ListFederationsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListFederationsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListFederationsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.metastore.v1.ListFederationsRequest"
  }
