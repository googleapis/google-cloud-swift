...
public struct DatabaseDumpSpec: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  /// Initialize a new instance of `DatabaseDumpSpec`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DatabaseDumpSpec().with { $0.<placeholder> = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.metastore.v1.DatabaseDumpSpec"
  }
