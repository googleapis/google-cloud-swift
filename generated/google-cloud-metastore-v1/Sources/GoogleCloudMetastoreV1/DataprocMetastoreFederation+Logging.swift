...
extension Clients {
  final class DataprocMetastoreFederationLogging: DataprocMetastoreFederationStub {
    let inner: any DataprocMetastoreFederationStub
    let logger: Logger

    public init(_ inner: any DataprocMetastoreFederationStub, logger: Logger) {
      var logger = logger
      logger[metadataKey: "gcp.artifact.id"] = "google-cloud-metastore-v1"
      logger[metadataKey: "gcp.client.service"] = "metastore"
      logger[metadataKey: "gcp.experimental.swift.client"] = "DataprocMetastoreFederation"
      self.inner = inner
      self.logger = logger
    }
    ...
    public func listFederations(
      ...
      try await self._intercept(
        ...
        action: {
          (r: ListFederationsRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleCloudMetastoreV1.ListFederationsResponse
          in
          return try await self.inner.listFederations(request: r, options: o)
        })
    }
    ...
    public func getFederation(
      ...
      try await self._intercept(
        ...
        name: "getFederation",
        action: {
          (r: GetFederationRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleCloudMetastoreV1.Federation
          in
          return try await self.inner.getFederation(request: r, options: o)
        })
    }
    ...
    public func createFederation(
      ...
      try await self._intercept(
        ...
        action: {
          (r: CreateFederationRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleLongRunning.Operation
          in
          return try await self.inner.createFederation(request: r, options: o)
        })
    }
    ...
    public func updateFederation(
      ...
      try await self._intercept(
        ...
        action: {
          (r: UpdateFederationRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleLongRunning.Operation
          in
          return try await self.inner.updateFederation(request: r, options: o)
        })
    }
    ...
    public func deleteFederation(
      ...
      try await self._intercept(
        ...
        action: {
          (r: DeleteFederationRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleLongRunning.Operation
          in
          return try await self.inner.deleteFederation(request: r, options: o)
        })
    }
