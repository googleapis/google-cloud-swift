...
Add `swift-google-privacy-dlp-v2` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-privacy-dlp-v2.git --from 0.1.0-preview
```

Then add `GoogleCloudDLPV2` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudDLPV2 <target-name> --package swift-google-privacy-dlp-v2
```
