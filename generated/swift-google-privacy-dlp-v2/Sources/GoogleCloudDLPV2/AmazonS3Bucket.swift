...
/// Amazon S3 bucket.
public struct AmazonS3Bucket: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The AWS account.
  public var awsAccount: AwsAccount? = nil
  ...
  /// Initialize a new instance of `AmazonS3Bucket`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AmazonS3Bucket().with { $0.awsAccount = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let awsAccount = CodingKeys(stringValue: "awsAccount")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.privacy.dlp.v2.AmazonS3Bucket"
  }
