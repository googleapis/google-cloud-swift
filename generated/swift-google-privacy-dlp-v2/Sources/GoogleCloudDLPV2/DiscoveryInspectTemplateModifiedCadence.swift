...
public struct DiscoveryInspectTemplateModifiedCadence: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DiscoveryInspectTemplateModifiedCadence`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DiscoveryInspectTemplateModifiedCadence().with { $0.frequency = ... }
  /// ```
