  ...
  Sendable
{
  ...
  public enum LocationCategory: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .argentina: return try container.encode("ARGENTINA")
      case .australia: return try container.encode("AUSTRALIA")
      case .belgium: return try container.encode("BELGIUM")
      case .brazil: return try container.encode("BRAZIL")
      case .canada: return try container.encode("CANADA")
      case .chile: return try container.encode("CHILE")
      case .china: return try container.encode("CHINA")
      case .colombia: return try container.encode("COLOMBIA")
      case .denmark: return try container.encode("DENMARK")
      case .france: return try container.encode("FRANCE")
      case .finland: return try container.encode("FINLAND")
      case .germany: return try container.encode("GERMANY")
      case .hongKong: return try container.encode("HONG_KONG")
      case .india: return try container.encode("INDIA")
      case .indonesia: return try container.encode("INDONESIA")
      case .ireland: return try container.encode("IRELAND")
      case .israel: return try container.encode("ISRAEL")
      case .italy: return try container.encode("ITALY")
      case .japan: return try container.encode("JAPAN")
      case .korea: return try container.encode("KOREA")
      case .mexico: return try container.encode("MEXICO")
      case .theNetherlands: return try container.encode("THE_NETHERLANDS")
      case .norway: return try container.encode("NORWAY")
      case .paraguay: return try container.encode("PARAGUAY")
      case .peru: return try container.encode("PERU")
      case .poland: return try container.encode("POLAND")
      case .portugal: return try container.encode("PORTUGAL")
      case .singapore: return try container.encode("SINGAPORE")
      case .southAfrica: return try container.encode("SOUTH_AFRICA")
      case .spain: return try container.encode("SPAIN")
      case .sweden: return try container.encode("SWEDEN")
      case .taiwan: return try container.encode("TAIWAN")
      case .thailand: return try container.encode("THAILAND")
      case .turkey: return try container.encode("TURKEY")
      case .unitedKingdom: return try container.encode("UNITED_KINGDOM")
      case .unitedStates: return try container.encode("UNITED_STATES")
      case .uruguay: return try container.encode("URUGUAY")
      case .venezuela: return try container.encode("VENEZUELA")
      case .`internal`: return try container.encode("INTERNAL")
      case .newZealand: return try container.encode("NEW_ZEALAND")
      case .croatia: return try container.encode("CROATIA")
      case .switzerland: return try container.encode("SWITZERLAND")
      case .russia: return try container.encode("RUSSIA")
      case .ukraine: return try container.encode("UKRAINE")
      case .uzbekistan: return try container.encode("UZBEKISTAN")
      case .kazakhstan: return try container.encode("KAZAKHSTAN")
      case .azerbaijan: return try container.encode("AZERBAIJAN")
      case .belarus: return try container.encode("BELARUS")
      case .armenia: return try container.encode("ARMENIA")
      case .czechia: return try container.encode("CZECHIA")
      case .austria: return try container.encode("AUSTRIA")
  ...
  public enum IndustryCategory: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .finance: return try container.encode("FINANCE")
      case .health: return try container.encode("HEALTH")
      case .telecommunications: return try container.encode("TELECOMMUNICATIONS")
      case .unknownIntValue(let v): return try container.encode(v)
      case .unknownStringValue(let v): return try container.encode(v)
      }
    }
  ...
  public enum TypeCategory: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .pii: return try container.encode("PII")
      case .spii: return try container.encode("SPII")
      case .demographic: return try container.encode("DEMOGRAPHIC")
      case .credential: return try container.encode("CREDENTIAL")
      case .governmentId: return try container.encode("GOVERNMENT_ID")
      case .document: return try container.encode("DOCUMENT")
      case .contextualInformation: return try container.encode("CONTEXTUAL_INFORMATION")
