...
///   them to named cases.
public enum ContentOption: Codable, Equatable, Hashable, Sendable {
  /// Includes entire content of a file or a data stream.
  case contentUnspecified
  ...
  public var stringValue: Swift.String? {
    ...
    case .contentImage: return "CONTENT_IMAGE"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:ContentOption/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "CONTENT_UNSPECIFIED": self = .contentUnspecified
    case "CONTENT_TEXT": self = .contentText
    case "CONTENT_IMAGE": self = .contentImage
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:ContentOption/unknownIntValue(_:)).
