...
public enum FileType: Codable, Equatable, Sendable {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    case .binaryFile: return try container.encode("BINARY_FILE")
    case .textFile: return try container.encode("TEXT_FILE")
    case .image: return try container.encode("IMAGE")
    case .word: return try container.encode("WORD")
    ...
    case .powerpoint: return try container.encode("POWERPOINT")
    case .excel: return try container.encode("EXCEL")
