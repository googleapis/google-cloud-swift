...
public struct ListContentPoliciesResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let contentPolicies = CodingKeys(stringValue: "contentPolicies")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([ContentPolicy].self, forKey: .contentPolicies) {
      self.contentPolicies = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.contentPolicies, forKey: .contentPolicies)
...
extension ListContentPoliciesResponse: GoogleGax._PaginatedResponse {
