...
public struct CloudStorageResourceReference: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CloudStorageResourceReference`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CloudStorageResourceReference().with { $0.bucketName = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.privacy.dlp.v2.CloudStorageResourceReference"
  }
