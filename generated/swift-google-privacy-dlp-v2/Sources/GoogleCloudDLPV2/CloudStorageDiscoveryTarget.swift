...
public struct CloudStorageDiscoveryTarget: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var filter: DiscoveryCloudStorageFilter? = nil
  ...
  /// Initialize a new instance of `CloudStorageDiscoveryTarget`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CloudStorageDiscoveryTarget().with { $0.filter = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.filter = try container.decodeIfPresent(DiscoveryCloudStorageFilter.self, forKey: .filter)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.privacy.dlp.v2.CloudStorageDiscoveryTarget"
  }
