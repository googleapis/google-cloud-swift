...
public struct StorageMetadataLabel: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Label name.
  ...
  /// Initialize a new instance of `StorageMetadataLabel`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = StorageMetadataLabel().with { $0.key = ... }
  /// ```
