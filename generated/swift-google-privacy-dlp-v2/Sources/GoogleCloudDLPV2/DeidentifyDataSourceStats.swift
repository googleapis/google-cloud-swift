...
public struct DeidentifyDataSourceStats: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var transformationCount: Swift.Int64 = Swift.Int64()
  ...
  ///
  /// ```
  /// let value = DeidentifyDataSourceStats().with { $0.transformedBytes = ... }
  /// ```
