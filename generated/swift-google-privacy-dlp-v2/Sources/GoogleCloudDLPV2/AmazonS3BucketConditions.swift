  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let bucketTypes = CodingKeys(stringValue: "bucketTypes")
    static let objectStorageClasses = CodingKeys(stringValue: "objectStorageClasses")
  ...
  public init(from decoder: Decoder) throws {
    ...
    {
      self.bucketTypes = value
    }
    if let value = try container.decodeIfPresent(
      [AmazonS3BucketConditions.ObjectStorageClass].self, forKey: .objectStorageClasses)
    {
      self.objectStorageClasses = value
    }
