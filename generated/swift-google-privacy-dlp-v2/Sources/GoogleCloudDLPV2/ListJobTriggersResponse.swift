...
public struct ListJobTriggersResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// List of triggeredJobs, up to page_size in ListJobTriggersRequest.
  public var jobTriggers: [JobTrigger] = []
  ...
  /// Initialize a new instance of `ListJobTriggersResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListJobTriggersResponse().with { $0.jobTriggers = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let jobTriggers = CodingKeys(stringValue: "jobTriggers")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([JobTrigger].self, forKey: .jobTriggers) {
      self.jobTriggers = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.jobTriggers, forKey: .jobTriggers)
