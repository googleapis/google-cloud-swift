...
public struct CryptoReplaceFfxFpeConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///   them to named cases.
  public enum FfxCommonNativeAlphabet: Codable, Equatable, Hashable, Sendable {
    /// Unused.
    case unspecified
    /// `[0-9]` (radix of 10)
    case numeric
