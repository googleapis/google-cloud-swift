  ...
  Sendable
{
  ...
  public var tableDataProfiles: [TableDataProfile] = []
  ...
  /// Initialize a new instance of `ListTableDataProfilesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListTableDataProfilesResponse().with { $0.tableDataProfiles = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let tableDataProfiles = CodingKeys(stringValue: "tableDataProfiles")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [TableDataProfile].self, forKey: .tableDataProfiles)
    {
      self.tableDataProfiles = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.tableDataProfiles, forKey: .tableDataProfiles)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.privacy.dlp.v2.ListTableDataProfilesResponse"
  }
