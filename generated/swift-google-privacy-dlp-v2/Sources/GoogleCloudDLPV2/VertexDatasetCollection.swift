...
public struct VertexDatasetCollection: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let vertexDatasetRegexes = CodingKeys(stringValue: "vertexDatasetRegexes")
