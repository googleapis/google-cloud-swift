...
public struct ColumnDataProfile: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///   expecting specific values to remain unparsed; future releases may promote
  ///   them to named cases.
  public enum ColumnDataType: Codable, Equatable, Hashable, Sendable {
    /// Invalid type.
    case unspecified
    ...
    public func encode(to encoder: Encoder) throws {
      var container = encoder.singleValueContainer()
      switch self {
      case .unspecified: return try container.encode("COLUMN_DATA_TYPE_UNSPECIFIED")
      case .typeInt64: return try container.encode("TYPE_INT64")
      case .typeBool: return try container.encode("TYPE_BOOL")
      case .typeFloat64: return try container.encode("TYPE_FLOAT64")
      case .typeString: return try container.encode("TYPE_STRING")
      case .typeBytes: return try container.encode("TYPE_BYTES")
      case .typeTimestamp: return try container.encode("TYPE_TIMESTAMP")
      case .typeDate: return try container.encode("TYPE_DATE")
      case .typeTime: return try container.encode("TYPE_TIME")
      case .typeDatetime: return try container.encode("TYPE_DATETIME")
      case .typeGeography: return try container.encode("TYPE_GEOGRAPHY")
      case .typeNumeric: return try container.encode("TYPE_NUMERIC")
      case .typeRecord: return try container.encode("TYPE_RECORD")
      case .typeBignumeric: return try container.encode("TYPE_BIGNUMERIC")
      case .typeJson: return try container.encode("TYPE_JSON")
      case .typeInterval: return try container.encode("TYPE_INTERVAL")
      case .typeRangeDate: return try container.encode("TYPE_RANGE_DATE")
      case .typeRangeDatetime: return try container.encode("TYPE_RANGE_DATETIME")
      case .typeRangeTimestamp: return try container.encode("TYPE_RANGE_TIMESTAMP")
      case .unknownIntValue(let v): return try container.encode(v)
      case .unknownStringValue(let v): return try container.encode(v)
      }
    }
  ...
  ///   expecting specific values to remain unparsed; future releases may promote
  ///   them to named cases.
  public enum ColumnPolicyState: Codable, Equatable, Hashable, Sendable {
    /// No policy tags.
    case unspecified
    ...
    public func encode(to encoder: Encoder) throws {
      var container = encoder.singleValueContainer()
      switch self {
      case .unspecified: return try container.encode("COLUMN_POLICY_STATE_UNSPECIFIED")
      case .columnPolicyTagged: return try container.encode("COLUMN_POLICY_TAGGED")
      case .unknownIntValue(let v): return try container.encode(v)
      case .unknownStringValue(let v): return try container.encode(v)
      }
    }
