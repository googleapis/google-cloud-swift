  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let signals = CodingKeys(stringValue: "signals")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Domain.Category.self, forKey: .category) {
      self.category = value
    }
    if let value = try container.decodeIfPresent([Domain.Signal].self, forKey: .signals) {
      self.signals = value
    }
