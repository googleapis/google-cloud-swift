...
public struct StringValueBatch: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `StringValueBatch`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = StringValueBatch().with { $0.values = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.privacy.dlp.v2.StringValueBatch"
  }
