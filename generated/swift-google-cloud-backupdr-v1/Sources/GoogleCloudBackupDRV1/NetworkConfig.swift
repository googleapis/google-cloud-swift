  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let peeringMode = CodingKeys(stringValue: "peeringMode")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      NetworkConfig.PeeringMode.self, forKey: .peeringMode)
    {
      self.peeringMode = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.peeringMode, forKey: .peeringMode)
  ...
  ///   them to named cases.
  public enum PeeringMode: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("PEERING_MODE_UNSPECIFIED")
