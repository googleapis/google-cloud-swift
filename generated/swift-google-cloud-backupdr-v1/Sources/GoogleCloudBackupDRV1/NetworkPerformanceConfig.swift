  ...
  Sendable
{
  ...
  public var totalEgressBandwidthTier: NetworkPerformanceConfig.Tier? = nil
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.totalEgressBandwidthTier = try container.decodeIfPresent(
      NetworkPerformanceConfig.Tier.self, forKey: .totalEgressBandwidthTier)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.totalEgressBandwidthTier, forKey: .totalEgressBandwidthTier)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.backupdr.v1.NetworkPerformanceConfig"
  }
