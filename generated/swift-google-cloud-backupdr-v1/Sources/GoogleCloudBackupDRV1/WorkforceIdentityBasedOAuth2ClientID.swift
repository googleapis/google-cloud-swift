...
public struct WorkforceIdentityBasedOAuth2ClientID: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Output only. First party OAuth Client ID for Google Identities.
  public var firstPartyOauth2ClientId: Swift.String = Swift.String()
  ...
  ///
  /// ```
  /// let value = WorkforceIdentityBasedOAuth2ClientID().with { $0.firstPartyOauth2ClientId = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.backupdr.v1.WorkforceIdentityBasedOAuth2ClientID"
  }
