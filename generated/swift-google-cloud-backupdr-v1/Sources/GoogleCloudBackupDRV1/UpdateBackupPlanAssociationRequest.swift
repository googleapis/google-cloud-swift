...
public struct UpdateBackupPlanAssociationRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateBackupPlanAssociationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateBackupPlanAssociationRequest().with { $0.backupPlanAssociation = ... }
  /// ```
