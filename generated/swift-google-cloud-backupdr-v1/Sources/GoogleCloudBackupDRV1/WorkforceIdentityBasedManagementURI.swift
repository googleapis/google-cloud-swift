...
public struct WorkforceIdentityBasedManagementURI: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `WorkforceIdentityBasedManagementURI`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = WorkforceIdentityBasedManagementURI().with { $0.firstPartyManagementUri = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.backupdr.v1.WorkforceIdentityBasedManagementURI"
  }
