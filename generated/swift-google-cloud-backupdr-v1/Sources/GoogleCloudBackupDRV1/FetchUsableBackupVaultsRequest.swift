...
public struct FetchUsableBackupVaultsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `FetchUsableBackupVaultsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FetchUsableBackupVaultsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.backupdr.v1.FetchUsableBackupVaultsRequest"
  }
