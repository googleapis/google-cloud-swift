  ...
  Sendable
{
  ...
  /// Initialize a new instance of `FetchBackupsForResourceTypeResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FetchBackupsForResourceTypeResponse().with { $0.backups = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.backupdr.v1.FetchBackupsForResourceTypeResponse"
  }
