...
public struct CloudSqlInstanceBackupPlanAssociationProperties: Codable, Equatable, GoogleWKT
    ._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = CloudSqlInstanceBackupPlanAssociationProperties().with { $0.instanceCreateTime = ... }
  /// ```
