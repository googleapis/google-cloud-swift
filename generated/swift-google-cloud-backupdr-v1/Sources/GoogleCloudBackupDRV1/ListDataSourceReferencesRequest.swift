...
public struct ListDataSourceReferencesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDataSourceReferencesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDataSourceReferencesRequest().with { $0.parent = ... }
  /// ```
