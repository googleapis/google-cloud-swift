  ...
  Sendable
{
  ...
  /// Initialize a new instance of `BackupGcpResource`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = BackupGcpResource().with { $0.gcpResourcename = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.backupdr.v1.BackupGcpResource"
  }
