...
public struct TriggerBackupRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `TriggerBackupRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = TriggerBackupRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.backupdr.v1.TriggerBackupRequest"
  }
