  ...
  Sendable
{
  ...
  /// Initialize a new instance of `FetchDataSourceReferencesForResourceTypeResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FetchDataSourceReferencesForResourceTypeResponse().with { $0.dataSourceReferences = ... }
  /// ```
