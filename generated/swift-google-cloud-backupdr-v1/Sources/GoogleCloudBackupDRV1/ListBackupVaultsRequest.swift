  ...
  Sendable
{
  ...
  /// Vault.
  public var view: BackupVaultView = BackupVaultView()
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(BackupVaultView.self, forKey: .view) {
      self.view = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.backupdr.v1.ListBackupVaultsRequest"
  }
