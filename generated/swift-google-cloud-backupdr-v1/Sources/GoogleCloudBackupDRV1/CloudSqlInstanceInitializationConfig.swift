...
public struct CloudSqlInstanceInitializationConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = CloudSqlInstanceInitializationConfig().with { $0.edition = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.backupdr.v1.CloudSqlInstanceInitializationConfig"
  }
