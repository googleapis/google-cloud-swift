...
public struct FetchUsableBackupVaultsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `FetchUsableBackupVaultsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FetchUsableBackupVaultsResponse().with { $0.backupVaults = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.backupdr.v1.FetchUsableBackupVaultsResponse"
  }
...
extension FetchUsableBackupVaultsResponse: GoogleGax._PaginatedResponse {
