...
/// Backup resource.
public struct ServiceLockInfo: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ServiceLockInfo`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ServiceLockInfo().with { $0.operation = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.backupdr.v1.ServiceLockInfo"
  }
