...
public struct ListDataSourceReferencesResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The DataSourceReferences from the specified parent.
  public var dataSourceReferences: [DataSourceReference] = []
  ...
  /// Initialize a new instance of `ListDataSourceReferencesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDataSourceReferencesResponse().with { $0.dataSourceReferences = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let dataSourceReferences = CodingKeys(stringValue: "dataSourceReferences")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [DataSourceReference].self, forKey: .dataSourceReferences)
    {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.dataSourceReferences, forKey: .dataSourceReferences)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.backupdr.v1.ListDataSourceReferencesResponse"
  }
...
extension ListDataSourceReferencesResponse: GoogleGax._PaginatedResponse {
