...
public struct ListBackupPlanRevisionsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// locations.
  public var backupPlanRevisions: [BackupPlanRevision] = []
  ...
  /// to return.
  ///
  /// [google.cloud.backupdr.v1.ListBackupPlanRevisionsRequest.page_token]: <doc:ListBackupPlanRevisionsRequest/pageToken>
  ...
  /// Initialize a new instance of `ListBackupPlanRevisionsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListBackupPlanRevisionsResponse().with { $0.backupPlanRevisions = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let backupPlanRevisions = CodingKeys(stringValue: "backupPlanRevisions")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [BackupPlanRevision].self, forKey: .backupPlanRevisions)
    {
      self.backupPlanRevisions = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.backupPlanRevisions, forKey: .backupPlanRevisions)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.backupdr.v1.ListBackupPlanRevisionsResponse"
  }
...
extension ListBackupPlanRevisionsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [BackupPlanRevision] {
    return self.backupPlanRevisions
  }
