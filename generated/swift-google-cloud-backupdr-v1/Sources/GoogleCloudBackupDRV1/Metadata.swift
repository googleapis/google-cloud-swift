  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = Metadata().with { $0.items = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Entry].self, forKey: .items) {
      self.items = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.backupdr.v1.Metadata"
  }
