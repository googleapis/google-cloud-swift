...
public struct UpdateDataSourceRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateDataSourceRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateDataSourceRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.backupdr.v1.UpdateDataSourceRequest"
  }
