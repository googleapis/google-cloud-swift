...
public struct DiskTargetEnvironment: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DiskTargetEnvironment`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DiskTargetEnvironment().with { $0.project = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.backupdr.v1.DiskTargetEnvironment"
  }
