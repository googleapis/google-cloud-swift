...
///   them to named cases.
public enum BackupConfigState: Codable, Equatable, Hashable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "BACKUP_CONFIG_STATE_UNSPECIFIED"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:BackupConfigState/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "BACKUP_CONFIG_STATE_UNSPECIFIED": self = .unspecified
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:BackupConfigState/unknownIntValue(_:)).
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    switch self {
    case .unspecified: return try container.encode("BACKUP_CONFIG_STATE_UNSPECIFIED")
