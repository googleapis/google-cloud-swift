...
public struct ListResourceBackupConfigsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListResourceBackupConfigsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListResourceBackupConfigsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.backupdr.v1.ListResourceBackupConfigsRequest"
  }
