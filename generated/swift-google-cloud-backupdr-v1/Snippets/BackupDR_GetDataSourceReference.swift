...
func sample(
  ...
  let response = try await client.getDataSourceReference(
    request: GetDataSourceReferenceRequest()
      .with {
        $0.name =
          "projects/\(projectId)/locations/\(locationId)/dataSourceReferences/\(dataSourceReferenceId)"
      }
  )
  ...
  static func main() async throws {
    do {
      ...
      try await sample(
        ...
        dataSourceReferenceId: "[placeholder]")
    } catch {
      print("Error: \(error)")
    }
  }
