...
func sample(
  ...
  let poller = try await client.updateDataSource(
    withPolling: UpdateDataSourceRequest()
      .with {
        $0.dataSource = DataSource().with {
          $0.name =
  ...
  static func main() async throws {
    do {
      ...
      try await sample(
        ...
        backupvaultId: "[placeholder]", datasourceId: "[placeholder]")
    } catch {
      print("Error: \(error)")
    }
  }
