...
public struct RouteInfo: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Type of route.
  ...
  public enum RouteType: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .peeringSubnet: return try container.encode("PEERING_SUBNET")
      case .peeringStatic: return try container.encode("PEERING_STATIC")
      case .peeringDynamic: return try container.encode("PEERING_DYNAMIC")
  ...
  public enum NextHopType: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .nextHopIp: return try container.encode("NEXT_HOP_IP")
      case .nextHopInstance: return try container.encode("NEXT_HOP_INSTANCE")
      case .nextHopNetwork: return try container.encode("NEXT_HOP_NETWORK")
      case .nextHopPeering: return try container.encode("NEXT_HOP_PEERING")
      case .nextHopInterconnect: return try container.encode("NEXT_HOP_INTERCONNECT")
      case .nextHopVpnTunnel: return try container.encode("NEXT_HOP_VPN_TUNNEL")
      case .nextHopVpnGateway: return try container.encode("NEXT_HOP_VPN_GATEWAY")
      case .nextHopInternetGateway: return try container.encode("NEXT_HOP_INTERNET_GATEWAY")
      case .nextHopBlackhole: return try container.encode("NEXT_HOP_BLACKHOLE")
      case .nextHopIlb: return try container.encode("NEXT_HOP_ILB")
      case .nextHopRouterAppliance: return try container.encode("NEXT_HOP_ROUTER_APPLIANCE")
      case .nextHopNccHub: return try container.encode("NEXT_HOP_NCC_HUB")
      case .secureWebProxyGateway: return try container.encode("SECURE_WEB_PROXY_GATEWAY")
      case .unknownIntValue(let v): return try container.encode(v)
      case .unknownStringValue(let v): return try container.encode(v)
      }
    }
  ...
  public enum RouteScope: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .nccHub: return try container.encode("NCC_HUB")
      case .unknownIntValue(let v): return try container.encode(v)
      case .unknownStringValue(let v): return try container.encode(v)
      }
    }
