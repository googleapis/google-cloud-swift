...
public struct RedisInstanceInfo: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var primaryEndpointIp: Swift.String = Swift.String()

  /// Read endpoint IP address of a Cloud Redis Instance (if applicable).
  public var readEndpointIp: Swift.String = Swift.String()
  ...
  ///
  /// ```
  /// let value = RedisInstanceInfo().with { $0.displayName = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkmanagement.v1.RedisInstanceInfo"
  }
