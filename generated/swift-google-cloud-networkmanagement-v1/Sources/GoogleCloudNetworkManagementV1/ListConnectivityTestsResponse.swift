  ...
  Sendable
{
  ...
  public var resources: [ConnectivityTest] = []
  ...
  /// Initialize a new instance of `ListConnectivityTestsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListConnectivityTestsResponse().with { $0.resources = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([ConnectivityTest].self, forKey: .resources) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkmanagement.v1.ListConnectivityTestsResponse"
  }
