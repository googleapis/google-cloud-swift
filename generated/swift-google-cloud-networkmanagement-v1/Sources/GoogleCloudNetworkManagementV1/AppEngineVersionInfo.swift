...
public struct AppEngineVersionInfo: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `AppEngineVersionInfo`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AppEngineVersionInfo().with { $0.displayName = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkmanagement.v1.AppEngineVersionInfo"
  }
