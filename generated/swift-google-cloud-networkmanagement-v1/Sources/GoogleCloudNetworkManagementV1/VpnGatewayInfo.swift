...
public struct VpnGatewayInfo: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let vpnTunnelUri = CodingKeys(stringValue: "vpnTunnelUri")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .vpnTunnelUri) {
      self.vpnTunnelUri = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.vpnTunnelUri, forKey: .vpnTunnelUri)
