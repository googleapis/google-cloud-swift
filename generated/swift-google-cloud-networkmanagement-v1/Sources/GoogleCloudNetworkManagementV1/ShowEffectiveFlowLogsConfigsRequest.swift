...
public struct ShowEffectiveFlowLogsConfigsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ShowEffectiveFlowLogsConfigsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ShowEffectiveFlowLogsConfigsRequest().with { $0.parent = ... }
  /// ```
