...
public struct GkeNetworkPolicyInfo: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GkeNetworkPolicyInfo`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GkeNetworkPolicyInfo().with { $0.displayName = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.networkmanagement.v1.GkeNetworkPolicyInfo"
  }
