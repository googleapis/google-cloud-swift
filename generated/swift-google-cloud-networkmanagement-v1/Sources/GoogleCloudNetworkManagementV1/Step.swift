  ...
  Sendable
{
  ...
  public enum State: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .startFromInstance: return try container.encode("START_FROM_INSTANCE")
      case .startFromInternet: return try container.encode("START_FROM_INTERNET")
      case .startFromPrivateNetwork: return try container.encode("START_FROM_PRIVATE_NETWORK")
      case .applyIngressFirewallRule: return try container.encode("APPLY_INGRESS_FIREWALL_RULE")
      case .applyEgressFirewallRule: return try container.encode("APPLY_EGRESS_FIREWALL_RULE")
      case .applyRoute: return try container.encode("APPLY_ROUTE")
      case .applyForwardingRule: return try container.encode("APPLY_FORWARDING_RULE")
      case .spoofingApproved: return try container.encode("SPOOFING_APPROVED")
      case .arriveAtInstance: return try container.encode("ARRIVE_AT_INSTANCE")
      case .arriveAtInternalLoadBalancer:
        return try container.encode("ARRIVE_AT_INTERNAL_LOAD_BALANCER")
      case .arriveAtExternalLoadBalancer:
        return try container.encode("ARRIVE_AT_EXTERNAL_LOAD_BALANCER")
      case .arriveAtVpnGateway: return try container.encode("ARRIVE_AT_VPN_GATEWAY")
      case .arriveAtVpnTunnel: return try container.encode("ARRIVE_AT_VPN_TUNNEL")
      case .nat: return try container.encode("NAT")
      case .proxyConnection: return try container.encode("PROXY_CONNECTION")
      case .deliver: return try container.encode("DELIVER")
      case .drop: return try container.encode("DROP")
      case .forward: return try container.encode("FORWARD")
      case .abort: return try container.encode("ABORT")
      case .viewerPermissionMissing: return try container.encode("VIEWER_PERMISSION_MISSING")
      case .startFromGkeMaster: return try container.encode("START_FROM_GKE_MASTER")
      case .startFromCloudSqlInstance: return try container.encode("START_FROM_CLOUD_SQL_INSTANCE")
      case .startFromCloudFunction: return try container.encode("START_FROM_CLOUD_FUNCTION")
      case .arriveAtVpcConnector: return try container.encode("ARRIVE_AT_VPC_CONNECTOR")
      case .startFromAppEngineVersion: return try container.encode("START_FROM_APP_ENGINE_VERSION")
      case .startFromCloudRunRevision: return try container.encode("START_FROM_CLOUD_RUN_REVISION")
      case .startFromGoogleService: return try container.encode("START_FROM_GOOGLE_SERVICE")
      case .analyzeLoadBalancerBackend: return try container.encode("ANALYZE_LOAD_BALANCER_BACKEND")
      case .startFromStorageBucket: return try container.encode("START_FROM_STORAGE_BUCKET")
      case .startFromPscPublishedService:
        return try container.encode("START_FROM_PSC_PUBLISHED_SERVICE")
      case .startFromServerlessNeg: return try container.encode("START_FROM_SERVERLESS_NEG")
      case .startFromRedisInstance: return try container.encode("START_FROM_REDIS_INSTANCE")
      case .startFromRedisCluster: return try container.encode("START_FROM_REDIS_CLUSTER")
      case .directVpcEgressConnection: return try container.encode("DIRECT_VPC_EGRESS_CONNECTION")
      case .serverlessExternalConnection:
        return try container.encode("SERVERLESS_EXTERNAL_CONNECTION")
      case .arriveAtInterconnectAttachment:
        return try container.encode("ARRIVE_AT_INTERCONNECT_ATTACHMENT")
      case .arriveAtHybridSubnet: return try container.encode("ARRIVE_AT_HYBRID_SUBNET")
      case .startFromGkePod: return try container.encode("START_FROM_GKE_POD")
      case .skipGkePodIpMasquerading: return try container.encode("SKIP_GKE_POD_IP_MASQUERADING")
      case .skipGkeIngressNetworkPolicy:
        return try container.encode("SKIP_GKE_INGRESS_NETWORK_POLICY")
      case .skipGkeEgressNetworkPolicy:
        return try container.encode("SKIP_GKE_EGRESS_NETWORK_POLICY")
      case .arriveAtGkePod: return try container.encode("ARRIVE_AT_GKE_POD")
      case .applyIngressGkeNetworkPolicy:
        return try container.encode("APPLY_INGRESS_GKE_NETWORK_POLICY")
      case .applyEgressGkeNetworkPolicy:
        return try container.encode("APPLY_EGRESS_GKE_NETWORK_POLICY")
      case .ngfwPacketInspection: return try container.encode("NGFW_PACKET_INSPECTION")
      case .startFromDmsPrivateConnection:
        return try container.encode("START_FROM_DMS_PRIVATE_CONNECTION")
      case .startFromCloudRunJob: return try container.encode("START_FROM_CLOUD_RUN_JOB")
