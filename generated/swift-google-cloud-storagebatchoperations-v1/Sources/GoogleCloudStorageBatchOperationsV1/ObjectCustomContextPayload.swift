...
public struct ObjectCustomContextPayload: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ObjectCustomContextPayload`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ObjectCustomContextPayload().with { $0.value = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.storagebatchoperations.v1.ObjectCustomContextPayload"
  }
