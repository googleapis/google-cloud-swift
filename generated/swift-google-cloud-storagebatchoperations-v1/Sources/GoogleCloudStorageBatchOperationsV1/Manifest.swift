  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let manifestLocation = CodingKeys(stringValue: "manifestLocation")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .manifestLocation) {
      self.manifestLocation = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.manifestLocation, forKey: .manifestLocation)
