...
public struct ListBucketOperationsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListBucketOperationsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListBucketOperationsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.storagebatchoperations.v1.ListBucketOperationsRequest"
  }
