  ...
  Sendable
{
  ...
  public var bucketOperations: [BucketOperation] = []
  ...
  /// Initialize a new instance of `ListBucketOperationsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListBucketOperationsResponse().with { $0.bucketOperations = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let bucketOperations = CodingKeys(stringValue: "bucketOperations")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([BucketOperation].self, forKey: .bucketOperations)
    {
      self.bucketOperations = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.bucketOperations, forKey: .bucketOperations)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.storagebatchoperations.v1.ListBucketOperationsResponse"
  }
