...
public struct ErrorLogEntry: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ErrorLogEntry`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ErrorLogEntry().with { $0.objectUri = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.storagebatchoperations.v1.ErrorLogEntry"
  }
