...
public struct ErrorLocation: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ErrorLocation`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ErrorLocation().with { $0.line = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.migration.v2.ErrorLocation"
  }
