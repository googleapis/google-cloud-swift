  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let regionCodes = CodingKeys(stringValue: "regionCodes")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(ThreatDiscovery.Platform.self, forKey: .platform) {
      self.platform = value
    }
    if let value = try container.decodeIfPresent([Swift.String].self, forKey: .regionCodes) {
      self.regionCodes = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.regionCodes, forKey: .regionCodes)
