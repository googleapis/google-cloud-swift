...
/// supporting details.
public struct ThreatInfo: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The type of abuse.
  ...
  /// Context about why the URI is unsafe.
  public struct ThreatJustification: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public enum JustificationLabel: Codable, Equatable, Sendable {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        case .manualVerification: return try container.encode("MANUAL_VERIFICATION")
        case .userReport: return try container.encode("USER_REPORT")
        case .automatedReport: return try container.encode("AUTOMATED_REPORT")
        case .unknownIntValue(let v): return try container.encode(v)
        case .unknownStringValue(let v): return try container.encode(v)
        }
      }
