...
extension Clients {
  final class WebRiskServiceTransport: WebRiskServiceStub {
    ...
    public func computeThreatListDiff(
      ...
      let (path, query, configure) = try {
        ...
        if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
          let path = "/v1/threatLists:computeDiff"
          var query = [
    ...
    public func createSubmission(
      ...
      let (path, query, configure) = try {
        ...
        if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
          ...
          let path = "/v1/\(pathVariable0)/submissions"
          let query = [
            URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
          ]
          return (path, query)
      ...
      return try await req.rpc(
        GoogleCloudWebRiskV1.Submission.self, timeout: options.attemptTimeout
      ).get()
    }
    ...
    public func submitUri(
      ...
      let (path, query, configure) = try {
        ...
        if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
          ...
          let path = "/v1/\(pathVariable0)/uris:submit"
          let query = [
            URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
          ]
          return (path, query)
