...
public struct Submission: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `Submission`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = Submission().with { $0.uri = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.webrisk.v1.Submission"
  }
