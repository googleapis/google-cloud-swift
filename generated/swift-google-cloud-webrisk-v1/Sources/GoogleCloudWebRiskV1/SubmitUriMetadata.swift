...
public struct SubmitUriMetadata: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  /// The state of the operation.
  public var state: SubmitUriMetadata.State = SubmitUriMetadata.State()
  ...
  /// Initialize a new instance of `SubmitUriMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SubmitUriMetadata().with { $0.state = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(SubmitUriMetadata.State.self, forKey: .state) {
      self.state = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.webrisk.v1.SubmitUriMetadata"
  }
