...
public struct SearchUrisRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SearchUrisRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SearchUrisRequest().with { $0.uri = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.webrisk.v1.SearchUrisRequest"
  }
