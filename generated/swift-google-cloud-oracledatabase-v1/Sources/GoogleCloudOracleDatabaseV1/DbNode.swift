...
public struct DbNode: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  public var properties: DbNodeProperties? = nil

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleCloudWKT._UnknownFields = .init()

  /// Initialize a new instance of `DbNode`.
  public init() {}
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.properties = try container.decodeIfPresent(DbNodeProperties.self, forKey: .properties)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.oracledatabase.v1.DbNode"
  }
