  ...
  Sendable
{
  ...
  public var odbSubnets: [OdbSubnet] = []
  ...
  /// Initialize a new instance of `ListOdbSubnetsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListOdbSubnetsResponse().with { $0.odbSubnets = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let odbSubnets = CodingKeys(stringValue: "odbSubnets")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([OdbSubnet].self, forKey: .odbSubnets) {
      self.odbSubnets = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.odbSubnets, forKey: .odbSubnets)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.oracledatabase.v1.ListOdbSubnetsResponse"
  }
