...
public struct ListCloudExadataInfrastructuresRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListCloudExadataInfrastructuresRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCloudExadataInfrastructuresRequest().with { $0.parent = ... }
  /// ```
