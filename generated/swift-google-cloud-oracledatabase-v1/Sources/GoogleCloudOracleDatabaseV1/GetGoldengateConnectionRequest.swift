...
public struct GetGoldengateConnectionRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetGoldengateConnectionRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetGoldengateConnectionRequest().with { $0.name = ... }
  /// ```
