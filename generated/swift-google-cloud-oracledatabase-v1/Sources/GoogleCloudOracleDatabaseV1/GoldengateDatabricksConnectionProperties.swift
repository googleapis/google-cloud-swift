...
public struct GoldengateDatabricksConnectionProperties: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///   them to named cases.
  public enum DatabricksAuthenticationType: Codable, Equatable, Hashable, Sendable {
