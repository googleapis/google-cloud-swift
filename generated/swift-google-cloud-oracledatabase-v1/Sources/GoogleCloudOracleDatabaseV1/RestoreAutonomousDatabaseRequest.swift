  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = RestoreAutonomousDatabaseRequest().with { $0.name = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let restoreTime = CodingKeys(stringValue: "restoreTime")
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.restoreTime, forKey: .restoreTime)
