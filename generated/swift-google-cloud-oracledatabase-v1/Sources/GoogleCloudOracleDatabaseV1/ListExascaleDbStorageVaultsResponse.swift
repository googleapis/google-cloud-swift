...
public struct ListExascaleDbStorageVaultsResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// The ExascaleDbStorageVaults.
  public var exascaleDbStorageVaults: [ExascaleDbStorageVault] = []
  ...
  /// Initialize a new instance of `ListExascaleDbStorageVaultsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListExascaleDbStorageVaultsResponse().with { $0.exascaleDbStorageVaults = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let exascaleDbStorageVaults = CodingKeys(stringValue: "exascaleDbStorageVaults")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [ExascaleDbStorageVault].self, forKey: .exascaleDbStorageVaults)
    {
      self.exascaleDbStorageVaults = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.exascaleDbStorageVaults, forKey: .exascaleDbStorageVaults)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.oracledatabase.v1.ListExascaleDbStorageVaultsResponse"
  }
