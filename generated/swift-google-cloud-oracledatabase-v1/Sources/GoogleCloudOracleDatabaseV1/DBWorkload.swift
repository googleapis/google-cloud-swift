...
///   them to named cases.
public enum DBWorkload: Codable, Equatable, Hashable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "DB_WORKLOAD_UNSPECIFIED"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:DBWorkload/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "DB_WORKLOAD_UNSPECIFIED": self = .unspecified
    case "OLTP": self = .oltp
    case "DW": self = .dw
    case "AJD": self = .ajd
    case "APEX": self = .apex
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:DBWorkload/unknownIntValue(_:)).
