...
public struct GoldengateDeploymentLock: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let relatedResourceId = CodingKeys(stringValue: "relatedResourceId")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .relatedResourceId) {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.relatedResourceId, forKey: .relatedResourceId)
