...
public struct ListDbSystemInitialStorageSizesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDbSystemInitialStorageSizesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDbSystemInitialStorageSizesRequest().with { $0.parent = ... }
  /// ```
