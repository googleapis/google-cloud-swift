  ...
  Sendable
{
  ...
  public enum GoldengateConnectionType: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("GOLDENGATE_CONNECTION_TYPE_UNSPECIFIED")
      case .goldengate: return try container.encode("GOLDENGATE")
      case .kafka: return try container.encode("KAFKA")
      case .kafkaSchemaRegistry: return try container.encode("KAFKA_SCHEMA_REGISTRY")
      case .mysql: return try container.encode("MYSQL")
      case .javaMessageService: return try container.encode("JAVA_MESSAGE_SERVICE")
      case .microsoftSqlserver: return try container.encode("MICROSOFT_SQLSERVER")
      case .ociObjectStorage: return try container.encode("OCI_OBJECT_STORAGE")
      ...
      case .azureSynapseAnalytics: return try container.encode("AZURE_SYNAPSE_ANALYTICS")
      case .snowflake: return try container.encode("SNOWFLAKE")
      case .amazonS3: return try container.encode("AMAZON_S3")
      case .hdfs: return try container.encode("HDFS")
      case .oracleAiDataPlatform: return try container.encode("ORACLE_AI_DATA_PLATFORM")
      case .oracleNosql: return try container.encode("ORACLE_NOSQL")
      case .mongodb: return try container.encode("MONGODB")
      case .amazonKinesis: return try container.encode("AMAZON_KINESIS")
      case .amazonRedshift: return try container.encode("AMAZON_REDSHIFT")
      case .db2: return try container.encode("DB2")
      case .redis: return try container.encode("REDIS")
      case .elasticsearch: return try container.encode("ELASTICSEARCH")
      case .generic: return try container.encode("GENERIC")
      case .googleCloudStorage: return try container.encode("GOOGLE_CLOUD_STORAGE")
      case .googleBigquery: return try container.encode("GOOGLE_BIGQUERY")
      case .databricks: return try container.encode("DATABRICKS")
      case .googlePubsub: return try container.encode("GOOGLE_PUBSUB")
      case .microsoftFabric: return try container.encode("MICROSOFT_FABRIC")
  ...
  public enum GoldengateConnectionLifecycleState: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified:
        return try container.encode("GOLDENGATE_CONNECTION_LIFECYCLE_STATE_UNSPECIFIED")
  ...
  public enum GoldengateConnectionRoutingMethod: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified:
        return try container.encode("GOLDENGATE_CONNECTION_ROUTING_METHOD_UNSPECIFIED")
      case .sharedDeploymentEndpoint: return try container.encode("SHARED_DEPLOYMENT_ENDPOINT")
      case .dedicatedEndpoint: return try container.encode("DEDICATED_ENDPOINT")
      case .unknownIntValue(let v): return try container.encode(v)
      case .unknownStringValue(let v): return try container.encode(v)
      }
    }
