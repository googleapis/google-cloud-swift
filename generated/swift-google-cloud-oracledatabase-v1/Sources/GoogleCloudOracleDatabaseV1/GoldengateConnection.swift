...
public struct GoldengateConnection: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  public var properties: GoldengateConnectionProperties? = nil
  ...
  /// Initialize a new instance of `GoldengateConnection`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GoldengateConnection().with { $0.name = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.properties = try container.decodeIfPresent(
      GoldengateConnectionProperties.self, forKey: .properties)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.oracledatabase.v1.GoldengateConnection"
  }
