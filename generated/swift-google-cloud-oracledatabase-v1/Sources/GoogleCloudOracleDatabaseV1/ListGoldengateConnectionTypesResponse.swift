...
public struct ListGoldengateConnectionTypesResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListGoldengateConnectionTypesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListGoldengateConnectionTypesResponse().with { $0.goldengateConnectionTypes = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let goldengateConnectionTypes = CodingKeys(stringValue: "goldengateConnectionTypes")
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.goldengateConnectionTypes, forKey: .goldengateConnectionTypes)
  ...
  public static var _anyTypeUrl: Swift.String {
    return
      "type.googleapis.com/google.cloud.oracledatabase.v1.ListGoldengateConnectionTypesResponse"
  }
