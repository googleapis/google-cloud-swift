...
public struct ListDatabasesResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListDatabasesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDatabasesResponse().with { $0.databases = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Database].self, forKey: .databases) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.oracledatabase.v1.ListDatabasesResponse"
  }
