...
public struct AutonomousDatabaseCharacterSet: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  public var characterSetType: AutonomousDatabaseCharacterSet.CharacterSetType =
  ...
  /// Initialize a new instance of `AutonomousDatabaseCharacterSet`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AutonomousDatabaseCharacterSet().with { $0.name = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      AutonomousDatabaseCharacterSet.CharacterSetType.self, forKey: .characterSetType)
    {
  ...
  public enum CharacterSetType: Codable, Equatable, Sendable {
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "CHARACTER_SET_TYPE_UNSPECIFIED"
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:CharacterSetType/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "CHARACTER_SET_TYPE_UNSPECIFIED": self = .unspecified
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:CharacterSetType/unknownIntValue(_:)).
    public init(intValue: Int) {
      switch intValue {
      case 0: self = .unspecified
      case 1: self = .database
      case 2: self = .national
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.oracledatabase.v1.AutonomousDatabaseCharacterSet"
  }
