...
public struct AutonomousDatabaseBackup: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  public var properties: AutonomousDatabaseBackupProperties? = nil
  ...
  /// Initialize a new instance of `AutonomousDatabaseBackup`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AutonomousDatabaseBackup().with { $0.name = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.properties = try container.decodeIfPresent(
      AutonomousDatabaseBackupProperties.self, forKey: .properties)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.oracledatabase.v1.AutonomousDatabaseBackup"
  }
