...
public enum State: Codable, Equatable, Sendable {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    case .scaleInProgress: return try container.encode("SCALE_IN_PROGRESS")
    case .availableNeedsAttention: return try container.encode("AVAILABLE_NEEDS_ATTENTION")
    ...
    case .roleChangeInProgress: return try container.encode("ROLE_CHANGE_IN_PROGRESS")
    case .upgrading: return try container.encode("UPGRADING")
    case .inaccessible: return try container.encode("INACCESSIBLE")
