  ...
  Sendable
{
  ...
  public var autonomousDbVersions: [AutonomousDbVersion] = []
  ...
  /// Initialize a new instance of `ListAutonomousDbVersionsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAutonomousDbVersionsResponse().with { $0.autonomousDbVersions = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let autonomousDbVersions = CodingKeys(stringValue: "autonomousDbVersions")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [AutonomousDbVersion].self, forKey: .autonomousDbVersions)
    {
      self.autonomousDbVersions = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.autonomousDbVersions, forKey: .autonomousDbVersions)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.oracledatabase.v1.ListAutonomousDbVersionsResponse"
  }
