...
public struct DeleteCloudExadataInfrastructureRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteCloudExadataInfrastructureRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteCloudExadataInfrastructureRequest().with { $0.name = ... }
  /// ```
