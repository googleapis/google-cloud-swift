...
///   them to named cases.
public enum GenerateType: Codable, Equatable, Hashable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "GENERATE_TYPE_UNSPECIFIED"
    case .all: return "ALL"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:GenerateType/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "GENERATE_TYPE_UNSPECIFIED": self = .unspecified
    case "ALL": self = .all
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:GenerateType/unknownIntValue(_:)).
