  ...
  Sendable
{
  ...
  public var goldengateDeploymentEnvironments: [GoldengateDeploymentEnvironment] = []
  ...
  ///
  /// ```
  /// let value = ListGoldengateDeploymentEnvironmentsResponse().with { $0.goldengateDeploymentEnvironments = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let goldengateDeploymentEnvironments = CodingKeys(
      stringValue: "goldengateDeploymentEnvironments")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [GoldengateDeploymentEnvironment].self, forKey: .goldengateDeploymentEnvironments)
    {
      self.goldengateDeploymentEnvironments = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(
      self.goldengateDeploymentEnvironments, forKey: .goldengateDeploymentEnvironments)
