...
public struct GoldengateDeploymentVersion: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// resource.
  public var properties: GoldengateDeploymentVersionProperties? = nil

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleCloudWKT._UnknownFields = .init()

  /// Initialize a new instance of `GoldengateDeploymentVersion`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GoldengateDeploymentVersion().with { $0.name = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.properties = try container.decodeIfPresent(
      GoldengateDeploymentVersionProperties.self, forKey: .properties)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.oracledatabase.v1.GoldengateDeploymentVersion"
  }
