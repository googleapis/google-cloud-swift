  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let workloadUri = CodingKeys(stringValue: "workloadUri")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .workloadUri) {
      self.workloadUri = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.workloadUri, forKey: .workloadUri)
