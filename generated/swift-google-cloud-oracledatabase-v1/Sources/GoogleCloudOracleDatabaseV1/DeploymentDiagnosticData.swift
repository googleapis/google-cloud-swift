...
public struct DeploymentDiagnosticData: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var diagnosticState: DeploymentDiagnosticData.DiagnosticState =
  ...
  ///
  /// ```
  /// let value = DeploymentDiagnosticData().with { $0.namespace = ... }
  /// ```
  ...
  public enum DiagnosticState: Codable, Equatable, Sendable {
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "DIAGNOSTIC_STATE_UNSPECIFIED"
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:DiagnosticState/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "DIAGNOSTIC_STATE_UNSPECIFIED": self = .unspecified
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:DiagnosticState/unknownIntValue(_:)).
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("DIAGNOSTIC_STATE_UNSPECIFIED")
