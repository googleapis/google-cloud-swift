...
public struct ListCloudVmClustersResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// The list of VM Clusters.
  public var cloudVmClusters: [CloudVmCluster] = []
  ...
  /// Initialize a new instance of `ListCloudVmClustersResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCloudVmClustersResponse().with { $0.cloudVmClusters = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let cloudVmClusters = CodingKeys(stringValue: "cloudVmClusters")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.oracledatabase.v1.ListCloudVmClustersResponse"
  }
