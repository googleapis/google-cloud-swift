...
public struct AutonomousDatabaseRefreshableClones: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let autonomousDatabaseRefreshableClones = CodingKeys(
      stringValue: "autonomousDatabaseRefreshableClones")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [AutonomousDatabaseRefreshableClone].self, forKey: .autonomousDatabaseRefreshableClones)
    {
      self.autonomousDatabaseRefreshableClones = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(
      self.autonomousDatabaseRefreshableClones, forKey: .autonomousDatabaseRefreshableClones)
