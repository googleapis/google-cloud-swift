...
public struct ListExascaleDbStorageVaultsRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListExascaleDbStorageVaultsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListExascaleDbStorageVaultsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.oracledatabase.v1.ListExascaleDbStorageVaultsRequest"
  }
