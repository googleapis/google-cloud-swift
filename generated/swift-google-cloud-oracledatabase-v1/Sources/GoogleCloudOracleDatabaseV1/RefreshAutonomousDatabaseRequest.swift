...
public struct RefreshAutonomousDatabaseRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let refreshCutoffTime = CodingKeys(stringValue: "refreshCutoffTime")
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.refreshCutoffTime, forKey: .refreshCutoffTime)
