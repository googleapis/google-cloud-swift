...
public struct ListCloudExadataInfrastructuresResponse: Codable, Equatable, GoogleCloudWKT
    ._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// The list of Exadata Infrastructures.
  public var cloudExadataInfrastructures: [CloudExadataInfrastructure] = []
  ...
  /// Initialize a new instance of `ListCloudExadataInfrastructuresResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCloudExadataInfrastructuresResponse().with { $0.cloudExadataInfrastructures = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let cloudExadataInfrastructures = CodingKeys(stringValue: "cloudExadataInfrastructures")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [CloudExadataInfrastructure].self, forKey: .cloudExadataInfrastructures)
    {
      self.cloudExadataInfrastructures = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.cloudExadataInfrastructures, forKey: .cloudExadataInfrastructures)
