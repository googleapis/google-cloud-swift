...
public struct GiVersion: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GiVersion`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GiVersion().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.oracledatabase.v1.GiVersion"
  }
