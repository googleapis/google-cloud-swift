...
public struct GoldengateGenericConnectionProperties: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GoldengateGenericConnectionProperties`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GoldengateGenericConnectionProperties().with { $0.technologyType = ... }
  /// ```
