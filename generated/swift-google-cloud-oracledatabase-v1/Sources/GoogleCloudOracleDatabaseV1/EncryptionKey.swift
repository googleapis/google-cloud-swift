  ...
  Sendable
{
  ...
  public var provider: EncryptionKey.Provider = EncryptionKey.Provider()
  ...
  ///
  /// ```
  /// let value = EncryptionKey().with { $0.provider = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(EncryptionKey.Provider.self, forKey: .provider) {
      self.provider = value
    }
  ...
  public enum Provider: Codable, Equatable, Hashable, Sendable {
    ...
    public var intValue: Int? {
      ...
      case .googleManaged: return 1
      case .oracleManaged: return 2
    ...
    public var stringValue: Swift.String? {
      ...
      case .googleManaged: return "GOOGLE_MANAGED"
    ...
    public init(stringValue: Swift.String) {
      ...
      case "GOOGLE_MANAGED": self = .googleManaged
      case "ORACLE_MANAGED": self = .oracleManaged
    ...
    public init(intValue: Int) {
      ...
      case 1: self = .googleManaged
      case 2: self = .oracleManaged
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.oracledatabase.v1.EncryptionKey"
  }
