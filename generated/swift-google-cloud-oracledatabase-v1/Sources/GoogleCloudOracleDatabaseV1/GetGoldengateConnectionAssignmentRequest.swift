...
public struct GetGoldengateConnectionAssignmentRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetGoldengateConnectionAssignmentRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetGoldengateConnectionAssignmentRequest().with { $0.name = ... }
  /// ```
