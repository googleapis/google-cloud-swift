...
public struct ListGoldengateConnectionAssignmentsResponse: Codable, Equatable, GoogleCloudWKT
    ._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// The list of GoldengateConnectionAssignments.
  public var goldengateConnectionAssignments: [GoldengateConnectionAssignment] = []
  ...
  /// Initialize a new instance of `ListGoldengateConnectionAssignmentsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListGoldengateConnectionAssignmentsResponse().with { $0.goldengateConnectionAssignments = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let goldengateConnectionAssignments = CodingKeys(
      stringValue: "goldengateConnectionAssignments")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [GoldengateConnectionAssignment].self, forKey: .goldengateConnectionAssignments)
    {
      self.goldengateConnectionAssignments = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(
      self.goldengateConnectionAssignments, forKey: .goldengateConnectionAssignments)
  ...
  public static var _anyTypeUrl: Swift.String {
    return
      "type.googleapis.com/google.cloud.oracledatabase.v1.ListGoldengateConnectionAssignmentsResponse"
  }
