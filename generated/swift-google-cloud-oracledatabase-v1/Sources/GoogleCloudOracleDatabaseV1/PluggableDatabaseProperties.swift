...
public struct PluggableDatabaseProperties: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public struct DefinedTagValue: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
  ...
  public enum PluggableDatabaseLifecycleState: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified:
        return try container.encode("PLUGGABLE_DATABASE_LIFECYCLE_STATE_UNSPECIFIED")
      ...
      case .relocating: return try container.encode("RELOCATING")
      case .relocated: return try container.encode("RELOCATED")
      case .refreshing: return try container.encode("REFRESHING")
      case .restoreInProgress: return try container.encode("RESTORE_IN_PROGRESS")
      case .restoreFailed: return try container.encode("RESTORE_FAILED")
      case .backupInProgress: return try container.encode("BACKUP_IN_PROGRESS")
