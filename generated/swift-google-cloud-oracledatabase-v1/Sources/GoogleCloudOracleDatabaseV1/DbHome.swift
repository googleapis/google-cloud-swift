  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let isUnifiedAuditingEnabled = CodingKeys(stringValue: "isUnifiedAuditingEnabled")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.Bool.self, forKey: .isUnifiedAuditingEnabled)
    {
      self.isUnifiedAuditingEnabled = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.isUnifiedAuditingEnabled, forKey: .isUnifiedAuditingEnabled)
