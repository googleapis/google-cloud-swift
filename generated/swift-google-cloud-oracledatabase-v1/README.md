# Google Cloud Client Libraries for Swift - Oracle Database@Google Cloud API
...
Add `swift-google-cloud-oracledatabase-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-oracledatabase-v1.git --from 0.0.0-preview
```

Then add `GoogleCloudOracleDatabaseV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudOracleDatabaseV1 <target-name> --package swift-google-cloud-oracledatabase-v1
```
