...
public struct ImageObjectDetectionPredictionInstance: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ImageObjectDetectionPredictionInstance`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ImageObjectDetectionPredictionInstance().with { $0.content = ... }
  /// ```
