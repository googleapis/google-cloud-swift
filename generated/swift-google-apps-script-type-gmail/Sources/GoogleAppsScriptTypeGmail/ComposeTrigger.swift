  ...
  Sendable
{
  ...
  public var actions: [GoogleAppsScriptType.MenuItemExtensionPoint] = []
  ...
  ///
  /// ```
  /// let value = ComposeTrigger().with { $0.actions = ... }
  /// ```
  ...
  public enum DraftAccess: Codable, Equatable, Sendable {
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:DraftAccess/unknownStringValue(_:)).
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:DraftAccess/unknownIntValue(_:)).
