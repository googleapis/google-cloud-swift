...
public struct AddGranteesRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = AddGranteesRequest().with { $0.dataPolicy = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.datapolicies.v2.AddGranteesRequest"
  }
