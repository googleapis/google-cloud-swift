...
public struct RemoveGranteesRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  /// Required. Resource name of this data policy, in the format of
  /// `projects/{project_number}/locations/{location_id}/dataPolicies/{data_policy_id}`.
  public var dataPolicy: Swift.String = Swift.String()
  ...
  /// Initialize a new instance of `RemoveGranteesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RemoveGranteesRequest().with { $0.dataPolicy = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.datapolicies.v2.RemoveGranteesRequest"
  }
