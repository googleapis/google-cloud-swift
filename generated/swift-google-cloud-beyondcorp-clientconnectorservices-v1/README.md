# Google Cloud Client Libraries for Swift - BeyondCorp API
...
Add `swift-google-cloud-beyondcorp-clientconnectorservices-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-beyondcorp-clientconnectorservices-v1.git --from 0.3.0
```

Then add `GoogleCloudBeyondCorpClientConnectorServicesV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudBeyondCorpClientConnectorServicesV1 <target-name> --package swift-google-cloud-beyondcorp-clientconnectorservices-v1
```
