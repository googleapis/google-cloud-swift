...
public struct ClientConnectorServiceOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ClientConnectorServiceOperationMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ClientConnectorServiceOperationMetadata().with { $0.createTime = ... }
  /// ```
