...
public struct CreateClientConnectorServiceRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var clientConnectorServiceId: Swift.String = Swift.String()
  ...
  /// Initialize a new instance of `CreateClientConnectorServiceRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateClientConnectorServiceRequest().with { $0.parent = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let clientConnectorServiceId = CodingKeys(stringValue: "clientConnectorServiceId")
    static let clientConnectorService = CodingKeys(stringValue: "clientConnectorService")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      Swift.String.self, forKey: .clientConnectorServiceId)
    {
      self.clientConnectorServiceId = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.clientConnectorServiceId, forKey: .clientConnectorServiceId)
    try container.encodeIfPresent(self.clientConnectorService, forKey: .clientConnectorService)
