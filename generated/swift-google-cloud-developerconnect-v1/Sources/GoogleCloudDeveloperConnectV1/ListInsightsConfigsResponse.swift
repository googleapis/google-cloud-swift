  ...
  Sendable
{
  ...
  public var insightsConfigs: [InsightsConfig] = []
  ...
  /// Initialize a new instance of `ListInsightsConfigsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListInsightsConfigsResponse().with { $0.insightsConfigs = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let insightsConfigs = CodingKeys(stringValue: "insightsConfigs")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([InsightsConfig].self, forKey: .insightsConfigs) {
      self.insightsConfigs = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.insightsConfigs, forKey: .insightsConfigs)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.developerconnect.v1.ListInsightsConfigsResponse"
  }
