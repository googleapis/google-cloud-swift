...
public struct FetchReadTokenResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The token content.
  ...
  ///
  /// ```
  /// let value = FetchReadTokenResponse().with { $0.token = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.developerconnect.v1.FetchReadTokenResponse"
  }
