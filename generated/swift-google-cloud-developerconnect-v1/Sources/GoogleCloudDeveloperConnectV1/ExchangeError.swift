...
public struct ExchangeError: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ExchangeError`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ExchangeError().with { $0.code = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.developerconnect.v1.ExchangeError"
  }
