  ...
  Sendable
{
  ...
  public var gitRepositoryLinks: [GitRepositoryLink] = []
  ...
  /// Initialize a new instance of `ListGitRepositoryLinksResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListGitRepositoryLinksResponse().with { $0.gitRepositoryLinks = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let gitRepositoryLinks = CodingKeys(stringValue: "gitRepositoryLinks")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [GitRepositoryLink].self, forKey: .gitRepositoryLinks)
    {
      self.gitRepositoryLinks = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.gitRepositoryLinks, forKey: .gitRepositoryLinks)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.developerconnect.v1.ListGitRepositoryLinksResponse"
  }
