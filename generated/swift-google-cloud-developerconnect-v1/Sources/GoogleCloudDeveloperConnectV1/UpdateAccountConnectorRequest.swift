...
public struct UpdateAccountConnectorRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateAccountConnectorRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateAccountConnectorRequest().with { $0.updateMask = ... }
  /// ```
