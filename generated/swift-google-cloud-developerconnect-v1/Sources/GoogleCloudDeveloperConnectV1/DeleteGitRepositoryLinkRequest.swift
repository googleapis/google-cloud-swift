...
public struct DeleteGitRepositoryLinkRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteGitRepositoryLinkRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteGitRepositoryLinkRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.developerconnect.v1.DeleteGitRepositoryLinkRequest"
  }
