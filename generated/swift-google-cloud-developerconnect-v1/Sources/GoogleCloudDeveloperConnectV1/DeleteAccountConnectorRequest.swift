...
public struct DeleteAccountConnectorRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteAccountConnectorRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteAccountConnectorRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.developerconnect.v1.DeleteAccountConnectorRequest"
  }
