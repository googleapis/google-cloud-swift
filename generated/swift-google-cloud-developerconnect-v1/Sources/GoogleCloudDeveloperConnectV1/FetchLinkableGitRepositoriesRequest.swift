...
public struct FetchLinkableGitRepositoriesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `FetchLinkableGitRepositoriesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FetchLinkableGitRepositoriesRequest().with { $0.connection = ... }
  /// ```
