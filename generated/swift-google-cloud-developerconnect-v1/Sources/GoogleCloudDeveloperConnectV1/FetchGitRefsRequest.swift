...
public struct FetchGitRefsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = FetchGitRefsRequest().with { $0.gitRepositoryLink = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .gitRepositoryLink) {
  ...
  ///   them to named cases.
  public enum RefType: Codable, Equatable, Hashable, Sendable {
    /// No type specified.
    case unspecified
    /// To fetch tags.
    case tag
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .tag: return try container.encode("TAG")
      case .branch: return try container.encode("BRANCH")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.developerconnect.v1.FetchGitRefsRequest"
  }
