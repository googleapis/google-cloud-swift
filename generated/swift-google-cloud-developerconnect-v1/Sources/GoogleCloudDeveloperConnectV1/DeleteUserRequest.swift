...
public struct DeleteUserRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteUserRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteUserRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.developerconnect.v1.DeleteUserRequest"
  }
