...
public struct SecureSourceManagerInstanceConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SecureSourceManagerInstanceConfig`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SecureSourceManagerInstanceConfig().with { $0.instance = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.developerconnect.v1.SecureSourceManagerInstanceConfig"
  }
