...
public struct CreateGitRepositoryLinkRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var gitRepositoryLink: GitRepositoryLink? = nil

  /// Required. The ID to use for the repository, which will become the final
  /// component of the repository's resource name. This ID should be unique in
  /// the connection. Allows alphanumeric characters and any of
  /// -._~%!$&'()*+,;=@.
  public var gitRepositoryLinkId: Swift.String = Swift.String()
  ...
  /// Initialize a new instance of `CreateGitRepositoryLinkRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateGitRepositoryLinkRequest().with { $0.parent = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let gitRepositoryLinkId = CodingKeys(stringValue: "gitRepositoryLinkId")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.gitRepositoryLink = try container.decodeIfPresent(
      GitRepositoryLink.self, forKey: .gitRepositoryLink)
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .gitRepositoryLinkId) {
      self.gitRepositoryLinkId = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.gitRepositoryLinkId, forKey: .gitRepositoryLinkId)
