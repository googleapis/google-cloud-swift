  ...
  Sendable
{
  ...
  /// Initialize a new instance of `GitLabEnterpriseConfig`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GitLabEnterpriseConfig().with { $0.hostUri = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.developerconnect.v1.GitLabEnterpriseConfig"
  }
