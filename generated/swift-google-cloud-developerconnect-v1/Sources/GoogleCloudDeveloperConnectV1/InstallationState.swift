...
/// based connections.
public struct InstallationState: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Output only. Current step of the installation process.
  public var stage: InstallationState.Stage = InstallationState.Stage()
  ...
  /// Initialize a new instance of `InstallationState`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = InstallationState().with { $0.stage = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(InstallationState.Stage.self, forKey: .stage) {
      self.stage = value
    }
  ...
  public enum Stage: Codable, Equatable, Sendable {
    ...
    case pendingCreateApp
    /// User needs to authorize the GitHub (or Enterprise) App via OAuth.
    case pendingUserOauth
    /// User needs to follow the link to install the GitHub (or Enterprise) App.
    case pendingInstallApp
    ...
    public var intValue: Int? {
      ...
      case .pendingCreateApp: return 1
      case .pendingUserOauth: return 2
      case .pendingInstallApp: return 3
    ...
    public var stringValue: Swift.String? {
      ...
      case .pendingCreateApp: return "PENDING_CREATE_APP"
      case .pendingUserOauth: return "PENDING_USER_OAUTH"
      case .pendingInstallApp: return "PENDING_INSTALL_APP"
    ...
    public init(stringValue: Swift.String) {
      ...
      case "PENDING_CREATE_APP": self = .pendingCreateApp
      case "PENDING_USER_OAUTH": self = .pendingUserOauth
      case "PENDING_INSTALL_APP": self = .pendingInstallApp
    ...
    public init(intValue: Int) {
      ...
      case 1: self = .pendingCreateApp
      case 2: self = .pendingUserOauth
      case 3: self = .pendingInstallApp
      case 10: self = .complete
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.developerconnect.v1.InstallationState"
  }
