...
public struct ListAccountConnectorsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListAccountConnectorsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAccountConnectorsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.developerconnect.v1.ListAccountConnectorsRequest"
  }
