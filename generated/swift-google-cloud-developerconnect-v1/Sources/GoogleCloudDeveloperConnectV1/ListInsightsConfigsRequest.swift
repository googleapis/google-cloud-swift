...
public struct ListInsightsConfigsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListInsightsConfigsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListInsightsConfigsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.developerconnect.v1.ListInsightsConfigsRequest"
  }
