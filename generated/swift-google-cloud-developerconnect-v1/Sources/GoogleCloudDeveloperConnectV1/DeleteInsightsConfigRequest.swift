...
public struct DeleteInsightsConfigRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteInsightsConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteInsightsConfigRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.developerconnect.v1.DeleteInsightsConfigRequest"
  }
