...
public struct ListGitRepositoryLinksRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListGitRepositoryLinksRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListGitRepositoryLinksRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.developerconnect.v1.ListGitRepositoryLinksRequest"
  }
