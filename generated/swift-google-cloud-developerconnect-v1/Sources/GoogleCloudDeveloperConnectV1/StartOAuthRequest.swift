...
public struct StartOAuthRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `StartOAuthRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = StartOAuthRequest().with { $0.accountConnector = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.developerconnect.v1.StartOAuthRequest"
  }
