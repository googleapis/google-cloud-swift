  ...
  Sendable
{
  ...
  public var accountConnectors: [AccountConnector] = []
  ...
  /// Initialize a new instance of `ListAccountConnectorsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAccountConnectorsResponse().with { $0.accountConnectors = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let accountConnectors = CodingKeys(stringValue: "accountConnectors")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [AccountConnector].self, forKey: .accountConnectors)
    {
      self.accountConnectors = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.accountConnectors, forKey: .accountConnectors)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.developerconnect.v1.ListAccountConnectorsResponse"
  }
