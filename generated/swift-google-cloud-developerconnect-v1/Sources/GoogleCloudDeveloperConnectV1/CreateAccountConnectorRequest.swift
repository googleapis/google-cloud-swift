...
public struct CreateAccountConnectorRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var accountConnectorId: Swift.String = Swift.String()
  ...
  /// Initialize a new instance of `CreateAccountConnectorRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateAccountConnectorRequest().with { $0.parent = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let accountConnectorId = CodingKeys(stringValue: "accountConnectorId")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .accountConnectorId) {
      self.accountConnectorId = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.accountConnectorId, forKey: .accountConnectorId)
    try container.encodeIfPresent(self.accountConnector, forKey: .accountConnector)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.developerconnect.v1.CreateAccountConnectorRequest"
  }
