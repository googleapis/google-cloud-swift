...
public struct FetchAccessTokenRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `FetchAccessTokenRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FetchAccessTokenRequest().with { $0.accountConnector = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.developerconnect.v1.FetchAccessTokenRequest"
  }
