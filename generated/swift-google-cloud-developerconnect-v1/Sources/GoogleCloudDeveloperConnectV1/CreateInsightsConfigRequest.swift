...
public struct CreateInsightsConfigRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var insightsConfigId: Swift.String = Swift.String()
  ...
  /// Initialize a new instance of `CreateInsightsConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateInsightsConfigRequest().with { $0.parent = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let insightsConfigId = CodingKeys(stringValue: "insightsConfigId")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .insightsConfigId) {
      self.insightsConfigId = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.insightsConfigId, forKey: .insightsConfigId)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.developerconnect.v1.CreateInsightsConfigRequest"
  }
