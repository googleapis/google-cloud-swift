...
public struct SBOMReferenceNote: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SBOMReferenceNote`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SBOMReferenceNote().with { $0.format = ... }
  /// ```
