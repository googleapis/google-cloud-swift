  ...
  Sendable
{
  ...
  public var lineageEvents: [LineageEvent] = []
  ...
  /// Initialize a new instance of `ListLineageEventsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListLineageEventsResponse().with { $0.lineageEvents = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datacatalog.lineage.v1.ListLineageEventsResponse"
  }
