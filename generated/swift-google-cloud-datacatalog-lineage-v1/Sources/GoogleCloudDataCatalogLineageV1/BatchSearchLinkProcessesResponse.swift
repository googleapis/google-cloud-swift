  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let processLinks = CodingKeys(stringValue: "processLinks")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([ProcessLinks].self, forKey: .processLinks) {
      self.processLinks = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.processLinks, forKey: .processLinks)
