...
///
/// [google.cloud.datacatalog.lineage.v1.Lineage.CreateRun]: <doc:LineageClient/createRun(request:options:)>
public struct CreateRunRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CreateRunRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateRunRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datacatalog.lineage.v1.CreateRunRequest"
  }
