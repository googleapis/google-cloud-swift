...
public struct DeleteProcessRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteProcessRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteProcessRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datacatalog.lineage.v1.DeleteProcessRequest"
  }
