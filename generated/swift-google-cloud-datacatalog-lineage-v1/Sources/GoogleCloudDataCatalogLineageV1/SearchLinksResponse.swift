  ...
  Sendable
{
  ...
  /// Initialize a new instance of `SearchLinksResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SearchLinksResponse().with { $0.links = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datacatalog.lineage.v1.SearchLinksResponse"
  }
