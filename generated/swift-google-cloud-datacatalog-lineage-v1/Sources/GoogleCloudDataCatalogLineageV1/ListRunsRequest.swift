...
public struct ListRunsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListRunsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListRunsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datacatalog.lineage.v1.ListRunsRequest"
  }
