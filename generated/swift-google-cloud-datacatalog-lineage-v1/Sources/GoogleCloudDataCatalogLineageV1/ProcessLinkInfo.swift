...
/// Link details.
public struct ProcessLinkInfo: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ProcessLinkInfo`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ProcessLinkInfo().with { $0.link = ... }
  /// ```
