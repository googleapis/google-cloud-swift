  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListProcessesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListProcessesResponse().with { $0.processes = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datacatalog.lineage.v1.ListProcessesResponse"
  }
