...
public struct DeleteLineageEventRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteLineageEventRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteLineageEventRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.datacatalog.lineage.v1.DeleteLineageEventRequest"
  }
