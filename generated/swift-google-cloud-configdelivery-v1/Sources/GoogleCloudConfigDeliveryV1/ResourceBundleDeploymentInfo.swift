...
/// deployment.
public struct ResourceBundleDeploymentInfo: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///   them to named cases.
  public enum SyncState: Codable, Equatable, Hashable, Sendable {
    /// Unspecified state.
    case unspecified
    /// Reconciling state.
    case reconciling
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("SYNC_STATE_UNSPECIFIED")
