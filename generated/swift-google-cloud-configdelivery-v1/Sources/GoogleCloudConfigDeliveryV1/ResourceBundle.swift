  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ResourceBundle`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ResourceBundle().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.configdelivery.v1.ResourceBundle"
  }
