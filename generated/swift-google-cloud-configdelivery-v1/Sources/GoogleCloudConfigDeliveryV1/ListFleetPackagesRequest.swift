...
public struct ListFleetPackagesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListFleetPackagesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListFleetPackagesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.configdelivery.v1.ListFleetPackagesRequest"
  }
