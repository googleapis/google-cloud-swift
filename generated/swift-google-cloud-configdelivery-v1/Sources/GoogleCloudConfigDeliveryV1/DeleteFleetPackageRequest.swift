...
public struct DeleteFleetPackageRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteFleetPackageRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteFleetPackageRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.configdelivery.v1.DeleteFleetPackageRequest"
  }
