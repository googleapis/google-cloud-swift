...
public struct SuspendRolloutRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SuspendRolloutRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SuspendRolloutRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.configdelivery.v1.SuspendRolloutRequest"
  }
