...
public struct ListVariantsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListVariantsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListVariantsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.configdelivery.v1.ListVariantsRequest"
  }
