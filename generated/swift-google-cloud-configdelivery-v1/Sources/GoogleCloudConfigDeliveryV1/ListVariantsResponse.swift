...
public struct ListVariantsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListVariantsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListVariantsResponse().with { $0.variants = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.configdelivery.v1.ListVariantsResponse"
  }
...
extension ListVariantsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Variant] {
