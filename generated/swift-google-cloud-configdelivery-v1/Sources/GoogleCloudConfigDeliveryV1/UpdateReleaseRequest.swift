...
public struct UpdateReleaseRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var release: Release? = nil
  ...
  /// Initialize a new instance of `UpdateReleaseRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateReleaseRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.release, forKey: .release)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.configdelivery.v1.UpdateReleaseRequest"
  }
