...
public enum DeletionPropagationPolicy: Codable, Equatable, Hashable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "DELETION_PROPAGATION_POLICY_UNSPECIFIED"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:DeletionPropagationPolicy/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "DELETION_PROPAGATION_POLICY_UNSPECIFIED": self = .unspecified
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:DeletionPropagationPolicy/unknownIntValue(_:)).
