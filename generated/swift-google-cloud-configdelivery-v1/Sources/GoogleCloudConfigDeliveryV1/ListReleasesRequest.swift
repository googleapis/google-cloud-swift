...
public struct ListReleasesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListReleasesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListReleasesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.configdelivery.v1.ListReleasesRequest"
  }
