  ...
  Sendable
{
  ...
  public var lifecycle: Release.Lifecycle = Release.Lifecycle()
  ...
  /// registry image path.
  public var info: ReleaseInfo? = nil
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Release.Lifecycle.self, forKey: .lifecycle) {
  ...
  ///   them to named cases.
  public enum Lifecycle: Codable, Equatable, Hashable, Sendable {
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "LIFECYCLE_UNSPECIFIED"
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:Lifecycle/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "LIFECYCLE_UNSPECIFIED": self = .unspecified
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:Lifecycle/unknownIntValue(_:)).
