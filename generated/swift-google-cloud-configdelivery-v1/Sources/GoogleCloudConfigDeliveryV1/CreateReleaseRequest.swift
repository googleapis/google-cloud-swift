...
public struct CreateReleaseRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CreateReleaseRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateReleaseRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.configdelivery.v1.CreateReleaseRequest"
  }
