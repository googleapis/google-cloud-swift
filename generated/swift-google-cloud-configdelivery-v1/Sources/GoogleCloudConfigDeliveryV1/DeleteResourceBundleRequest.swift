...
public struct DeleteResourceBundleRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteResourceBundleRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteResourceBundleRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.configdelivery.v1.DeleteResourceBundleRequest"
  }
