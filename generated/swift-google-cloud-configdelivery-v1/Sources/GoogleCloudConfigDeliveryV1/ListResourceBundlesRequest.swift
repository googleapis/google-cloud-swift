...
public struct ListResourceBundlesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListResourceBundlesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListResourceBundlesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.configdelivery.v1.ListResourceBundlesRequest"
  }
