...
/// configurations.
public struct FleetPackageError: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `FleetPackageError`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FleetPackageError().with { $0.errorMessage = ... }
  /// ```
