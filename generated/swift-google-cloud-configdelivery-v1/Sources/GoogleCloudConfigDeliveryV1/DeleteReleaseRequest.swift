...
public struct DeleteReleaseRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteReleaseRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteReleaseRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.configdelivery.v1.DeleteReleaseRequest"
  }
