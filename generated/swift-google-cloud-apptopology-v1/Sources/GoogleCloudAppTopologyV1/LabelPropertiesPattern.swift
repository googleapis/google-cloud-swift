...
/// expression.
public struct LabelPropertiesPattern: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var labelMatcherExpr: Swift.String = Swift.String()
  ...
  public var propertyMatcherExpr: Swift.String = Swift.String()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `LabelPropertiesPattern`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = LabelPropertiesPattern().with { $0.labelMatcherExpr = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let labelMatcherExpr = CodingKeys(stringValue: "labelMatcherExpr")
    static let propertyMatcherExpr = CodingKeys(stringValue: "propertyMatcherExpr")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .propertyMatcherExpr) {
      self.propertyMatcherExpr = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apptopology.v1.LabelPropertiesPattern"
  }
