  ...
  Sendable
{
  ...
  public var allowedValues: [Swift.Int64] = []

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `IntValue`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = IntValue().with { $0.repeated = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Swift.Int64].self, forKey: .allowedValues) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apptopology.v1.IntValue"
  }
