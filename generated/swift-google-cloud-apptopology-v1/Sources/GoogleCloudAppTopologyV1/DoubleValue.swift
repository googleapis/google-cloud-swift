...
public struct DoubleValue: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// OPTIONAL
  ...
  public var allowedValues: [Swift.Double] = []

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `DoubleValue`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DoubleValue().with { $0.repeated = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Swift.Double].self, forKey: .allowedValues) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apptopology.v1.DoubleValue"
  }
