...
public struct EdgePattern: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(EdgePattern.Direction.self, forKey: .direction) {
  ...
  public enum Direction: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .to: return try container.encode("TO")
      case .from: return try container.encode("FROM")
