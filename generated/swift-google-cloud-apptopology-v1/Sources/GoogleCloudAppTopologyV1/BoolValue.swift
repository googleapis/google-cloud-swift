...
public struct BoolValue: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// OPTIONAL
  ...
  public var allowedValues: [Swift.Bool] = []

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `BoolValue`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = BoolValue().with { $0.repeated = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Swift.Bool].self, forKey: .allowedValues) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apptopology.v1.BoolValue"
  }
