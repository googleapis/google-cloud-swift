  ...
  Sendable
{
  ...
  public var anyLabels: [Swift.String] = []
  ...
  ///
  /// ```
  /// let value = NodeGroup().with { $0.anyLabels = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let anyLabels = CodingKeys(stringValue: "anyLabels")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Swift.String].self, forKey: .anyLabels) {
      self.anyLabels = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.anyLabels, forKey: .anyLabels)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.apptopology.v1.NodeGroup"
  }
