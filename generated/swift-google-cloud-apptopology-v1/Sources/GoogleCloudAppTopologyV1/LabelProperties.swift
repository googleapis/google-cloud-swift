...
public struct LabelProperties: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `LabelProperties`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = LabelProperties().with { $0.label = ... }
  /// ```
