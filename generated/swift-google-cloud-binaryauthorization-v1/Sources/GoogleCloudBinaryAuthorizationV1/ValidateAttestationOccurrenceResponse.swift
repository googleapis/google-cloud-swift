...
public struct ValidateAttestationOccurrenceResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The result of the Attestation validation.
  public var result: ValidateAttestationOccurrenceResponse.Result =
    ValidateAttestationOccurrenceResponse.Result()

  /// The reason for denial if the Attestation couldn't be validated.
  public var denialReason: Swift.String = Swift.String()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `ValidateAttestationOccurrenceResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ValidateAttestationOccurrenceResponse().with { $0.result = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let denialReason = CodingKeys(stringValue: "denialReason")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      ValidateAttestationOccurrenceResponse.Result.self, forKey: .result)
    {
      self.result = value
    }
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .denialReason) {
      self.denialReason = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.denialReason, forKey: .denialReason)
  ...
  public enum Result: Codable, Equatable, Sendable {
    ...
    public var intValue: Int? {
      ...
      case .attestationNotVerifiable: return 2
    ...
    public var stringValue: Swift.String? {
      ...
      case .attestationNotVerifiable: return "ATTESTATION_NOT_VERIFIABLE"
    ...
    public init(stringValue: Swift.String) {
      ...
      case "ATTESTATION_NOT_VERIFIABLE": self = .attestationNotVerifiable
    ...
    public init(intValue: Int) {
      ...
      case 2: self = .attestationNotVerifiable
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .attestationNotVerifiable: return try container.encode("ATTESTATION_NOT_VERIFIABLE")
