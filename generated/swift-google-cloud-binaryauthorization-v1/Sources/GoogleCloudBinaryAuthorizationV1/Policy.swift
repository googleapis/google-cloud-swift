  ...
  Sendable
{
  ...
  ///   them to named cases.
  public enum GlobalPolicyEvaluationMode: Codable, Equatable, Hashable, Sendable {
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:GlobalPolicyEvaluationMode/unknownStringValue(_:)).
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:GlobalPolicyEvaluationMode/unknownIntValue(_:)).
