...
public struct PkixPublicKey: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      PkixPublicKey.SignatureAlgorithm.self, forKey: .signatureAlgorithm)
    {
  ...
  ///   them to named cases.
  public enum SignatureAlgorithm: Codable, Equatable, Hashable, Sendable {
    /// Not specified.
    case unspecified
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:SignatureAlgorithm/unknownStringValue(_:)).
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:SignatureAlgorithm/unknownIntValue(_:)).
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("SIGNATURE_ALGORITHM_UNSPECIFIED")
      ...
      case .rsaPss4096Sha512: return try container.encode("RSA_PSS_4096_SHA512")
      ...
      case .ecdsaP384Sha384: return try container.encode("ECDSA_P384_SHA384")
      case .ecdsaP521Sha512: return try container.encode("ECDSA_P521_SHA512")
      case .mlDsa65: return try container.encode("ML_DSA_65")
