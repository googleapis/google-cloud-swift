...
public struct DeleteAppProfileRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteAppProfileRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteAppProfileRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.bigtable.admin.v2.DeleteAppProfileRequest"
  }
