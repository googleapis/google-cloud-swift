...
public struct PartialUpdateInstanceRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `PartialUpdateInstanceRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = PartialUpdateInstanceRequest().with { $0.instance = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.bigtable.admin.v2.PartialUpdateInstanceRequest"
  }
