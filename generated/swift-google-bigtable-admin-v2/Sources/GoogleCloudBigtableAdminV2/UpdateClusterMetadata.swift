...
public struct UpdateClusterMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateClusterMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateClusterMetadata().with { $0.originalRequest = ... }
  /// ```
