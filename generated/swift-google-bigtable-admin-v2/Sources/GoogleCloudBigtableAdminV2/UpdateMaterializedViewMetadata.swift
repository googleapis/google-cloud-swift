...
public struct UpdateMaterializedViewMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The request that prompted the initiation of this UpdateMaterializedView
  /// operation.
  public var originalRequest: UpdateMaterializedViewRequest? = nil
  ...
  /// Initialize a new instance of `UpdateMaterializedViewMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateMaterializedViewMetadata().with { $0.originalRequest = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.originalRequest = try container.decodeIfPresent(
      UpdateMaterializedViewRequest.self, forKey: .originalRequest)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.bigtable.admin.v2.UpdateMaterializedViewMetadata"
  }
