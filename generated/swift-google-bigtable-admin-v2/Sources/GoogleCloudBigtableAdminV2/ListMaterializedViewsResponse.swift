  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListMaterializedViewsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMaterializedViewsResponse().with { $0.materializedViews = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let materializedViews = CodingKeys(stringValue: "materializedViews")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [MaterializedView].self, forKey: .materializedViews)
    {
      self.materializedViews = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.materializedViews, forKey: .materializedViews)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.bigtable.admin.v2.ListMaterializedViewsResponse"
  }
