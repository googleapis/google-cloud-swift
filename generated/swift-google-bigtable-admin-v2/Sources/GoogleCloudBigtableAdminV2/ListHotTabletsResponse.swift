  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let hotTablets = CodingKeys(stringValue: "hotTablets")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([HotTablet].self, forKey: .hotTablets) {
      self.hotTablets = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.hotTablets, forKey: .hotTablets)
