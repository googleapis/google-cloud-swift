  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let authorizedViews = CodingKeys(stringValue: "authorizedViews")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([AuthorizedView].self, forKey: .authorizedViews) {
      self.authorizedViews = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.authorizedViews, forKey: .authorizedViews)
