...
public struct UpdateSchemaBundleMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateSchemaBundleMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateSchemaBundleMetadata().with { $0.name = ... }
  /// ```
