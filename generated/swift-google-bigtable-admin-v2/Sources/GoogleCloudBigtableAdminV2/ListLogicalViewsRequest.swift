...
public struct ListLogicalViewsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListLogicalViewsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListLogicalViewsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.bigtable.admin.v2.ListLogicalViewsRequest"
  }
