  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let schemaBundles = CodingKeys(stringValue: "schemaBundles")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([SchemaBundle].self, forKey: .schemaBundles) {
      self.schemaBundles = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.schemaBundles, forKey: .schemaBundles)
