...
public struct CreateLogicalViewMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = CreateLogicalViewMetadata().with { $0.originalRequest = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.originalRequest = try container.decodeIfPresent(
      CreateLogicalViewRequest.self, forKey: .originalRequest)
