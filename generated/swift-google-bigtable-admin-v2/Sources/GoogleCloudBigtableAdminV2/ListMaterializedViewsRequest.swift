...
public struct ListMaterializedViewsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListMaterializedViewsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMaterializedViewsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.bigtable.admin.v2.ListMaterializedViewsRequest"
  }
