...
public struct DeleteAuthorizedViewRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteAuthorizedViewRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteAuthorizedViewRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.bigtable.admin.v2.DeleteAuthorizedViewRequest"
  }
