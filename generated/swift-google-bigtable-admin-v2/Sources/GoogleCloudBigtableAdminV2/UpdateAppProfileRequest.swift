...
public struct UpdateAppProfileRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateAppProfileRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateAppProfileRequest().with { $0.appProfile = ... }
  /// ```
