...
public struct BatchTranslateMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The state of the operation.
  public var state: BatchTranslateMetadata.State = BatchTranslateMetadata.State()
  ...
  /// Initialize a new instance of `BatchTranslateMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = BatchTranslateMetadata().with { $0.state = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(BatchTranslateMetadata.State.self, forKey: .state)
    {
      self.state = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.translation.v3.BatchTranslateMetadata"
  }
