...
/// access to.
public struct ListAdaptiveMtDatasetsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListAdaptiveMtDatasetsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAdaptiveMtDatasetsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.translation.v3.ListAdaptiveMtDatasetsRequest"
  }
