...
/// An inlined file.
public struct FileInputSource: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `FileInputSource`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FileInputSource().with { $0.mimeType = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.translation.v3.FileInputSource"
  }
