  ...
  Sendable
{
  ...
  public var outputConfig: DatasetOutputConfig? = nil
  ...
  ///
  /// ```
  /// let value = ExportDataRequest().with { $0.dataset = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.outputConfig = try container.decodeIfPresent(
      DatasetOutputConfig.self, forKey: .outputConfig)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.translation.v3.ExportDataRequest"
  }
