...
public struct GcsOutputDestination: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GcsOutputDestination`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GcsOutputDestination().with { $0.outputUriPrefix = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.translation.v3.GcsOutputDestination"
  }
