...
public struct DeleteDatasetMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteDatasetMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteDatasetMetadata().with { $0.state = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.translation.v3.DeleteDatasetMetadata"
  }
