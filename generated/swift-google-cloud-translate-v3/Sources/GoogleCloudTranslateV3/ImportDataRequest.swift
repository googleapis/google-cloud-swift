  ...
  Sendable
{
  ...
  public var inputConfig: DatasetInputConfig? = nil
  ...
  ///
  /// ```
  /// let value = ImportDataRequest().with { $0.dataset = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.inputConfig = try container.decodeIfPresent(DatasetInputConfig.self, forKey: .inputConfig)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.translation.v3.ImportDataRequest"
  }
