...
public struct DeleteGlossaryMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(DeleteGlossaryMetadata.State.self, forKey: .state)
    {
      self.state = value
    }
