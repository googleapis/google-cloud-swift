  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = ImportAdaptiveMtFileResponse().with { $0.adaptiveMtFile = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let adaptiveMtFile = CodingKeys(stringValue: "adaptiveMtFile")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.adaptiveMtFile = try container.decodeIfPresent(
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.adaptiveMtFile, forKey: .adaptiveMtFile)
