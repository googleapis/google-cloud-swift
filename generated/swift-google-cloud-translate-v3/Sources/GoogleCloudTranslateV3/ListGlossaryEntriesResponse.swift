  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let glossaryEntries = CodingKeys(stringValue: "glossaryEntries")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([GlossaryEntry].self, forKey: .glossaryEntries) {
      self.glossaryEntries = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.glossaryEntries, forKey: .glossaryEntries)
