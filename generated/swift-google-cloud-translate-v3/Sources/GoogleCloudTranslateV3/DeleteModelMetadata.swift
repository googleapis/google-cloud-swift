...
public struct DeleteModelMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteModelMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteModelMetadata().with { $0.state = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.translation.v3.DeleteModelMetadata"
  }
