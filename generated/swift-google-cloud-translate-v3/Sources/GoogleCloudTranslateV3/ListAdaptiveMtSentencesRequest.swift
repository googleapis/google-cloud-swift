  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListAdaptiveMtSentencesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAdaptiveMtSentencesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.translation.v3.ListAdaptiveMtSentencesRequest"
  }
