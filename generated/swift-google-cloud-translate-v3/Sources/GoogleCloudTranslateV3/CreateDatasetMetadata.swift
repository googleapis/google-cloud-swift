...
public struct CreateDatasetMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CreateDatasetMetadata`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateDatasetMetadata().with { $0.state = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.translation.v3.CreateDatasetMetadata"
  }
