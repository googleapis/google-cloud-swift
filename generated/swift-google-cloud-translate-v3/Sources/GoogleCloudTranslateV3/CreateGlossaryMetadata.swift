...
public struct CreateGlossaryMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = CreateGlossaryMetadata().with { $0.name = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(CreateGlossaryMetadata.State.self, forKey: .state)
    {
      self.state = value
    }
