...
public struct BatchTranslateDocumentMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The state of the operation.
  public var state: BatchTranslateDocumentMetadata.State = BatchTranslateDocumentMetadata.State()
  ...
  ///
  /// ```
  /// let value = BatchTranslateDocumentMetadata().with { $0.state = ... }
  /// ```
