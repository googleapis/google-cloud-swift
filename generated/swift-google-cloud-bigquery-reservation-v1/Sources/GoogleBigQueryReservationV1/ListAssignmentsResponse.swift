...
public struct ListAssignmentsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListAssignmentsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAssignmentsResponse().with { $0.assignments = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.reservation.v1.ListAssignmentsResponse"
  }
...
extension ListAssignmentsResponse: GoogleGax._PaginatedResponse {
