...
public struct SplitCapacityCommitmentRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SplitCapacityCommitmentRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SplitCapacityCommitmentRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.reservation.v1.SplitCapacityCommitmentRequest"
  }
