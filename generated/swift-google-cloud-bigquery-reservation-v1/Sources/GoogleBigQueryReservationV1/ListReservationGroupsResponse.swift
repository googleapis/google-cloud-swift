  ...
  Sendable
{
  ...
  public var reservationGroups: [ReservationGroup] = []
  ...
  /// Initialize a new instance of `ListReservationGroupsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListReservationGroupsResponse().with { $0.reservationGroups = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let reservationGroups = CodingKeys(stringValue: "reservationGroups")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [ReservationGroup].self, forKey: .reservationGroups)
    {
      self.reservationGroups = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.reservationGroups, forKey: .reservationGroups)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.reservation.v1.ListReservationGroupsResponse"
  }
