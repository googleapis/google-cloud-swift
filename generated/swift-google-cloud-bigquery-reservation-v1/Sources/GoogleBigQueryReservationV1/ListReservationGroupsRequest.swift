...
public struct ListReservationGroupsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListReservationGroupsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListReservationGroupsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.reservation.v1.ListReservationGroupsRequest"
  }
