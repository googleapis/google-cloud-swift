...
///   them to named cases.
public enum FailoverMode: Codable, Equatable, Hashable, Sendable {
  /// Invalid value.
  case unspecified
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "FAILOVER_MODE_UNSPECIFIED"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:FailoverMode/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "FAILOVER_MODE_UNSPECIFIED": self = .unspecified
    case "SOFT": self = .soft
    case "HARD": self = .hard
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:FailoverMode/unknownIntValue(_:)).
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    switch self {
    case .unspecified: return try container.encode("FAILOVER_MODE_UNSPECIFIED")
    case .soft: return try container.encode("SOFT")
    case .hard: return try container.encode("HARD")
