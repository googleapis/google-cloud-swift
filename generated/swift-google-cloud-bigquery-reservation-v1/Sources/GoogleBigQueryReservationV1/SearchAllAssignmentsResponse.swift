  ...
  Sendable
{
  ...
  /// Initialize a new instance of `SearchAllAssignmentsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SearchAllAssignmentsResponse().with { $0.assignments = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.reservation.v1.SearchAllAssignmentsResponse"
  }
