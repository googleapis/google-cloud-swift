...
public struct ListCapacityCommitmentsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListCapacityCommitmentsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCapacityCommitmentsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.reservation.v1.ListCapacityCommitmentsRequest"
  }
