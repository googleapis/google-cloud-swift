...
public struct ListReservationsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListReservationsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListReservationsRequest().with { $0.parent = ... }
  /// ```
