  ...
  Sendable
{
  ...
  public var capacityCommitments: [CapacityCommitment] = []
  ...
  /// Initialize a new instance of `ListCapacityCommitmentsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCapacityCommitmentsResponse().with { $0.capacityCommitments = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let capacityCommitments = CodingKeys(stringValue: "capacityCommitments")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [CapacityCommitment].self, forKey: .capacityCommitments)
    {
      self.capacityCommitments = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.capacityCommitments, forKey: .capacityCommitments)
