...
public struct ListAssignmentsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListAssignmentsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAssignmentsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.reservation.v1.ListAssignmentsRequest"
  }
