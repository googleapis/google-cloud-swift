...
public struct SearchAssignmentsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SearchAssignmentsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SearchAssignmentsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.reservation.v1.SearchAssignmentsRequest"
  }
