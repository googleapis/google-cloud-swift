...
func sample(
  ...
  let response = try await client.updateReservation(
    request: UpdateReservationRequest()
      .with {
        $0.reservation = Reservation().with {
          $0.name = "projects/\(projectId)/locations/\(locationId)/reservations/\(reservationId)"
        }
