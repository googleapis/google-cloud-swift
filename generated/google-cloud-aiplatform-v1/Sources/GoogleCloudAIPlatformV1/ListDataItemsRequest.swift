...
// limitations under the License.
  ...
  public struct ListDataItemsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ListDataItemsRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListDataItemsRequest().with { $0.parent = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.ListDataItemsRequest"
    }
