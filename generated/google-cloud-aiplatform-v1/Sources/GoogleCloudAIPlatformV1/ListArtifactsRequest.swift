...
// limitations under the License.
  ...
  public struct ListArtifactsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ListArtifactsRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListArtifactsRequest().with { $0.parent = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.ListArtifactsRequest"
    }
