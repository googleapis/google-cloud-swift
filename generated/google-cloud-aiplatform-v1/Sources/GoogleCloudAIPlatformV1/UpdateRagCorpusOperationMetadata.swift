...
// limitations under the License.
  ...
  public struct UpdateRagCorpusOperationMetadata: Codable, Equatable, GoogleCloudWkt._AnyPackable,
    Sendable
  {
    /// The operation generic information.
    public var genericMetadata: GenericOperationMetadata? = nil

    /// Initialize a new instance of `UpdateRagCorpusOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = UpdateRagCorpusOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.UpdateRagCorpusOperationMetadata"
    }
