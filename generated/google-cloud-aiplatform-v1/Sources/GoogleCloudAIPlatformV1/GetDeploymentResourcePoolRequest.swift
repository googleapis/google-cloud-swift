...
// limitations under the License.
  ...
  public struct GetDeploymentResourcePoolRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `GetDeploymentResourcePoolRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = GetDeploymentResourcePoolRequest().with { $0.name = ... }
    /// ```
