...
// limitations under the License.
  ...
  public struct DedicatedResources: Codable, Equatable, GoogleCloudWkt._AnyPackable,
    Sendable
  {
    ...
    ///
    /// [google.cloud.aiplatform.v1.DedicatedResources.min_replica_count]: <doc:DedicatedResources/minReplicaCount>
    ...
    public var requiredReplicaCount: Swift.Int32 = Swift.Int32()
    ...
    /// to `80`.
    ///
    /// [google.cloud.aiplatform.v1.AutoscalingMetricSpec.metric_name]: <doc:AutoscalingMetricSpec/metricName>
    /// [google.cloud.aiplatform.v1.AutoscalingMetricSpec.target]: <doc:AutoscalingMetricSpec/target>
    ...
    ///
    /// ```
    /// let value = DedicatedResources().with { $0.machineSpec = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.DedicatedResources"
    }
