...
// limitations under the License.
  ...
  ///
  /// [google.cloud.aiplatform.v1.FeaturestoreService.DeleteFeaturestore]: <doc:FeaturestoreService/deleteFeaturestore(request:)>
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `DeleteFeaturestoreRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DeleteFeaturestoreRequest().with { $0.name = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.DeleteFeaturestoreRequest"
    }
