...
// limitations under the License.
  ...
  public struct AsyncQueryReasoningEngineRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
    Sendable
  {
    ...
    public var inputGcsUri: Swift.String = Swift.String()
    ...
    ///
    /// ```
    /// let value = AsyncQueryReasoningEngineRequest().with { $0.name = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.AsyncQueryReasoningEngineRequest"
    }
