...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `ListAnnotationsResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListAnnotationsResponse().with { $0.annotations = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.ListAnnotationsResponse"
    }
