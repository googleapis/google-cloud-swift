...
// limitations under the License.
  ...
  ///
  /// [google.cloud.aiplatform.v1.JobService.PauseModelDeploymentMonitoringJob]: <doc:JobService/pauseModelDeploymentMonitoringJob(request:)>
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `PauseModelDeploymentMonitoringJobRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = PauseModelDeploymentMonitoringJobRequest().with { $0.name = ... }
    /// ```
