...
// limitations under the License.
  ...
  public struct FunctionCallingConfig: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    /// Optional. Function calling mode.
    public var mode: FunctionCallingConfig.Mode = FunctionCallingConfig.Mode()

    /// Optional. Function names to call. Only set when the Mode is ANY. Function
    /// names should match [FunctionDeclaration.name]. With mode set to ANY, model
    /// will predict a function call from the set of function names provided.
    public var allowedFunctionNames: [Swift.String] = []
    ...
    ///
    /// ```
    /// let value = FunctionCallingConfig().with { $0.mode = ... }
    /// ```
    ...
    public enum Mode: Codable, Equatable, Sendable {
      ...
      ///
      /// [FunctionCallingConfig.allowed_function_names]: <doc:FunctionCallingConfig/allowedFunctionNames>
      case validated
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.FunctionCallingConfig"
    }
