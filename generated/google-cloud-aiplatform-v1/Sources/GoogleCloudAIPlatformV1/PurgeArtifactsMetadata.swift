...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `PurgeArtifactsMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = PurgeArtifactsMetadata().with { $0.genericMetadata = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.PurgeArtifactsMetadata"
    }
