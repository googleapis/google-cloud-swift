...
// limitations under the License.
  ...
  public struct UpgradeNotebookRuntimeRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `UpgradeNotebookRuntimeRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = UpgradeNotebookRuntimeRequest().with { $0.name = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.UpgradeNotebookRuntimeRequest"
    }
