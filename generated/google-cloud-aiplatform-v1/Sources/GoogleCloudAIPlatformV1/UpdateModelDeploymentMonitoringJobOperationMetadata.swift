...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `UpdateModelDeploymentMonitoringJobOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = UpdateModelDeploymentMonitoringJobOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
