...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `ListStudiesRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListStudiesRequest().with { $0.parent = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.ListStudiesRequest"
    }
