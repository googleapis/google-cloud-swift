...
// limitations under the License.
  ...
  ///
  /// [google.cloud.aiplatform.v1.FeatureOnlineStoreAdminService.UpdateFeatureOnlineStore]: <doc:FeatureOnlineStoreAdminService/updateFeatureOnlineStore(request:)>
