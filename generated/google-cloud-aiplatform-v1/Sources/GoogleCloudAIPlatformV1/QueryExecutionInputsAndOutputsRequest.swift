...
// limitations under the License.
  ...
  ///
  /// [google.cloud.aiplatform.v1.MetadataService.QueryExecutionInputsAndOutputs]: <doc:MetadataService/queryExecutionInputsAndOutputs(request:)>
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `QueryExecutionInputsAndOutputsRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = QueryExecutionInputsAndOutputsRequest().with { $0.execution = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.QueryExecutionInputsAndOutputsRequest"
    }
