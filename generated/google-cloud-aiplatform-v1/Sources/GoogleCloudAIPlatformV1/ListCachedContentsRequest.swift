...
// limitations under the License.
  ...
  public struct ListCachedContentsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ListCachedContentsRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListCachedContentsRequest().with { $0.parent = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.ListCachedContentsRequest"
    }
