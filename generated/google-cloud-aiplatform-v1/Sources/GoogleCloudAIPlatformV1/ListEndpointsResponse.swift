...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// to obtain that page.
    ///
    /// [google.cloud.aiplatform.v1.ListEndpointsRequest.page_token]: <doc:ListEndpointsRequest/pageToken>
    public var nextPageToken: Swift.String = Swift.String()

    /// Initialize a new instance of `ListEndpointsResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListEndpointsResponse().with { $0.endpoints = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.ListEndpointsResponse"
    }
