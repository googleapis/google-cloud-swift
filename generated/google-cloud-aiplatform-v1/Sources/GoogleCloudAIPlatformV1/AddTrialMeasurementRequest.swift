...
// limitations under the License.
  ...
  ///
  /// [google.cloud.aiplatform.v1.VizierService.AddTrialMeasurement]: <doc:VizierService/addTrialMeasurement(request:)>
    ...
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = AddTrialMeasurementRequest().with { $0.trialName = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.AddTrialMeasurementRequest"
    }
