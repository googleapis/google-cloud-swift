...
// limitations under the License.
  ...
  public struct ListDeploymentResourcePoolsRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ListDeploymentResourcePoolsRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListDeploymentResourcePoolsRequest().with { $0.parent = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.ListDeploymentResourcePoolsRequest"
    }
