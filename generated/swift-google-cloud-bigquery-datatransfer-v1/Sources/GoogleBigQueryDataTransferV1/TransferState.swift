...
///   them to named cases.
public enum TransferState: Codable, Equatable, Hashable, Sendable {
  /// State placeholder (0).
  case unspecified
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "TRANSFER_STATE_UNSPECIFIED"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:TransferState/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "TRANSFER_STATE_UNSPECIFIED": self = .unspecified
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:TransferState/unknownIntValue(_:)).
