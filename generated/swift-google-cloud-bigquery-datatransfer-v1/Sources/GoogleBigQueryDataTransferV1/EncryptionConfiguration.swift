...
public struct EncryptionConfiguration: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `EncryptionConfiguration`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = EncryptionConfiguration().with { $0.kmsKeyName = ... }
  /// ```
