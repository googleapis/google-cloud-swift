  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListDataSourcesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDataSourcesResponse().with { $0.dataSources = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.datatransfer.v1.ListDataSourcesResponse"
  }
