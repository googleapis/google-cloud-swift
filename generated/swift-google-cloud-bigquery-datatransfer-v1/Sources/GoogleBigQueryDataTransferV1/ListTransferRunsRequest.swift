...
public struct ListTransferRunsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var states: [TransferState] = []
  ...
  public var runAttempt: ListTransferRunsRequest.RunAttempt = ListTransferRunsRequest.RunAttempt()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `ListTransferRunsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListTransferRunsRequest().with { $0.parent = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let runAttempt = CodingKeys(stringValue: "runAttempt")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([TransferState].self, forKey: .states) {
      self.states = value
    }
    ...
    if let value = try container.decodeIfPresent(
      ListTransferRunsRequest.RunAttempt.self, forKey: .runAttempt)
    {
      self.runAttempt = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.runAttempt, forKey: .runAttempt)
  ...
  public enum RunAttempt: Codable, Equatable, Sendable {
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "RUN_ATTEMPT_UNSPECIFIED"
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("RUN_ATTEMPT_UNSPECIFIED")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.bigquery.datatransfer.v1.ListTransferRunsRequest"
  }
