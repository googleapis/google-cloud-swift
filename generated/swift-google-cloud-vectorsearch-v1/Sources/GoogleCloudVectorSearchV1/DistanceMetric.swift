...
///   them to named cases.
public enum DistanceMetric: Codable, Equatable, Hashable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "DISTANCE_METRIC_UNSPECIFIED"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:DistanceMetric/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "DISTANCE_METRIC_UNSPECIFIED": self = .unspecified
    case "DOT_PRODUCT": self = .dotProduct
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:DistanceMetric/unknownIntValue(_:)).
