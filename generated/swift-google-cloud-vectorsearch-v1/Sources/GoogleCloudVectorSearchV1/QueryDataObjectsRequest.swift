...
public struct QueryDataObjectsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `QueryDataObjectsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = QueryDataObjectsRequest().with { $0.parent = ... }
  /// ```
