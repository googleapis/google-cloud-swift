...
public struct BatchDeleteDataObjectsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var requests: [DeleteDataObjectRequest] = []

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `BatchDeleteDataObjectsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = BatchDeleteDataObjectsRequest().with { $0.parent = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([DeleteDataObjectRequest].self, forKey: .requests)
    {
      self.requests = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vectorsearch.v1.BatchDeleteDataObjectsRequest"
  }
