...
public struct SearchDataObjectsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SearchDataObjectsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SearchDataObjectsResponse().with { $0.results = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([SearchResult].self, forKey: .results) {
      self.results = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vectorsearch.v1.SearchDataObjectsResponse"
  }
...
extension SearchDataObjectsResponse: GoogleGax._PaginatedResponse {
