...
public struct ListCollectionsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListCollectionsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCollectionsResponse().with { $0.collections = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let collections = CodingKeys(stringValue: "collections")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Collection].self, forKey: .collections) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vectorsearch.v1.ListCollectionsResponse"
  }
...
extension ListCollectionsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Collection] {
