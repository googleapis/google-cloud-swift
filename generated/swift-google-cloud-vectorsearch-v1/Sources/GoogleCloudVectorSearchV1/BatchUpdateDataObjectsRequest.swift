...
///
/// [google.cloud.vectorsearch.v1.DataObjectService.BatchUpdateDataObjects]: <doc:DataObjectServiceClient/batchUpdateDataObjects(request:options:)>
public struct BatchUpdateDataObjectsRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  public var requests: [UpdateDataObjectRequest] = []

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleCloudWKT._UnknownFields = .init()

  /// Initialize a new instance of `BatchUpdateDataObjectsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = BatchUpdateDataObjectsRequest().with { $0.parent = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([UpdateDataObjectRequest].self, forKey: .requests)
    {
      self.requests = value
    }
