...
extension Clients {
  class EssentialContactsServiceTransport: EssentialContactsServiceStub {
    let inner: GoogleCloudGax.HTTPClient

    public init(_ options: GoogleCloudGax.ClientOptions = .init()) throws {
      self.inner = try GoogleCloudGax.HTTPClient(
        from: options, withDefaultEndpoint: "https://essentialcontacts.googleapis.com")
    }
    ...
    public func createContact(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/contacts"
      }()
      let query = [
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudEssentialContactsV1.Contact.self, from: data)
    }
    ...
    public func updateContact(
      ...
      let path = try { () throws -> Swift.String in
        guard let pathVariable0 = request.contact.map({ $0.name }), !pathVariable0.isEmpty else {
          throw GoogleCloudGax.RequestError.binding("'request.contact.name' is not set or is empty")
        }
    ...
    public func listContacts(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudEssentialContactsV1.ListContactsResponse.self, from: data)
    }
    ...
    public func computeContacts(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/contacts:compute"
      }()
      var query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudEssentialContactsV1.ComputeContactsResponse.self, from: data)
    }
    ...
    public func sendTestMessage(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/contacts:sendTestMessage"
      }()
      let query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
