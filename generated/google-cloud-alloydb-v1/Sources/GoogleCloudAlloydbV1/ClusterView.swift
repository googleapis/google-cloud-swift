...
public enum ClusterView: Codable, Equatable, Sendable {
  ...
  public var intValue: Int? {
    ...
    case .basic: return 1
    case .continuousBackup: return 2
  ...
  public var stringValue: Swift.String? {
    ...
    case .continuousBackup: return "CLUSTER_VIEW_CONTINUOUS_BACKUP"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:ClusterView/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "CLUSTER_VIEW_UNSPECIFIED": self = .unspecified
    case "CLUSTER_VIEW_BASIC": self = .basic
    case "CLUSTER_VIEW_CONTINUOUS_BACKUP": self = .continuousBackup
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:ClusterView/unknownIntValue(_:)).
  public init(intValue: Int) {
    switch intValue {
    case 0: self = .unspecified
    case 1: self = .basic
    case 2: self = .continuousBackup
