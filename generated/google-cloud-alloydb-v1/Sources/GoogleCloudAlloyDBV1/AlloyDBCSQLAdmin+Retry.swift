...
extension Clients {
  final class AlloyDBCSQLAdminRetry: AlloyDBCSQLAdminStub {
    let inner: any AlloyDBCSQLAdminStub
    let options: GoogleCloudGax.ClientOptions

    public init(_ inner: any AlloyDBCSQLAdminStub, options: GoogleCloudGax.ClientOptions) {
      self.inner = inner
    ...
    public func restoreFromCloudSql(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: RestoreFromCloudSQLRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleLongRunning.Operation
          in
          return try await self.inner.restoreFromCloudSql(request: r, options: o)
        })
    }
