...
public struct ExportClusterResponse: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  /// Oneof field to support other destinations in future.
  public var destination: OneOf_Destination? = nil

  /// Initialize a new instance of `ExportClusterResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ExportClusterResponse().with { $0.gcsDestination = ... }
  /// ```
