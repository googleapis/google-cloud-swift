...
public struct CreateSecondaryInstanceRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CreateSecondaryInstanceRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateSecondaryInstanceRequest().with { $0.parent = ... }
  /// ```
