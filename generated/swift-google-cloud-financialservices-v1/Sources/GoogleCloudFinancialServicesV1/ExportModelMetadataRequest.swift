...
public struct ExportModelMetadataRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ExportModelMetadataRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ExportModelMetadataRequest().with { $0.model = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.financialservices.v1.ExportModelMetadataRequest"
  }
