...
public struct ListPredictionResultsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let predictionResults = CodingKeys(stringValue: "predictionResults")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [PredictionResult].self, forKey: .predictionResults)
    {
      self.predictionResults = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.predictionResults, forKey: .predictionResults)
...
extension ListPredictionResultsResponse: GoogleGax._PaginatedResponse {
