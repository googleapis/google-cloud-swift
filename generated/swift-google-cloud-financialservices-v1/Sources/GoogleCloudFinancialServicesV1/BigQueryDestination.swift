  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let tableUri = CodingKeys(stringValue: "tableUri")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .tableUri) {
      self.tableUri = value
    }
    if let value = try container.decodeIfPresent(
      BigQueryDestination.WriteDisposition.self, forKey: .writeDisposition)
    {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.tableUri, forKey: .tableUri)
  ...
  public enum WriteDisposition: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .writeEmpty: return try container.encode("WRITE_EMPTY")
