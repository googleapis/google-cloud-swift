...
public struct UpdateBacktestResultRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateBacktestResultRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateBacktestResultRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.financialservices.v1.UpdateBacktestResultRequest"
  }
