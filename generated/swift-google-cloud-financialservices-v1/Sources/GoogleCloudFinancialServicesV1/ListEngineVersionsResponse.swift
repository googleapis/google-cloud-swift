  ...
  Sendable
{
  ...
  public var engineVersions: [EngineVersion] = []
  ...
  /// Initialize a new instance of `ListEngineVersionsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListEngineVersionsResponse().with { $0.engineVersions = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let engineVersions = CodingKeys(stringValue: "engineVersions")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([EngineVersion].self, forKey: .engineVersions) {
      self.engineVersions = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.engineVersions, forKey: .engineVersions)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.financialservices.v1.ListEngineVersionsResponse"
  }
