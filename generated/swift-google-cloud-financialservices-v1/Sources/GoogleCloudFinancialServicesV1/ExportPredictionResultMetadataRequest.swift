...
public struct ExportPredictionResultMetadataRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Required. The resource name of the PredictionResult.
  public var predictionResult: Swift.String = Swift.String()
  ...
  /// Initialize a new instance of `ExportPredictionResultMetadataRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ExportPredictionResultMetadataRequest().with { $0.predictionResult = ... }
  /// ```
