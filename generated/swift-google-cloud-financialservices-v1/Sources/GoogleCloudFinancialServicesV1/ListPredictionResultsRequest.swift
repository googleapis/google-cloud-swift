...
public struct ListPredictionResultsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListPredictionResultsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPredictionResultsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.financialservices.v1.ListPredictionResultsRequest"
  }
