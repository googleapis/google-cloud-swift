  ...
  Sendable
{
  ...
  public var engineConfigs: [EngineConfig] = []
  ...
  /// Initialize a new instance of `ListEngineConfigsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListEngineConfigsResponse().with { $0.engineConfigs = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([EngineConfig].self, forKey: .engineConfigs) {
