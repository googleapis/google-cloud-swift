...
public struct ListEngineConfigsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListEngineConfigsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListEngineConfigsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.financialservices.v1.ListEngineConfigsRequest"
  }
