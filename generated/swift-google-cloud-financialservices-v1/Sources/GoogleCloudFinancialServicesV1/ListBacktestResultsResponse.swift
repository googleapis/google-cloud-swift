...
public struct ListBacktestResultsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// List of BacktestResult resources
  public var backtestResults: [BacktestResult] = []
  ...
  /// Initialize a new instance of `ListBacktestResultsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListBacktestResultsResponse().with { $0.backtestResults = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let backtestResults = CodingKeys(stringValue: "backtestResults")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([BacktestResult].self, forKey: .backtestResults) {
      self.backtestResults = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.backtestResults, forKey: .backtestResults)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.financialservices.v1.ListBacktestResultsResponse"
  }
...
extension ListBacktestResultsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [BacktestResult] {
