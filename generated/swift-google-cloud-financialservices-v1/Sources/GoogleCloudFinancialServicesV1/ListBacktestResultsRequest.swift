...
public struct ListBacktestResultsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListBacktestResultsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListBacktestResultsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.financialservices.v1.ListBacktestResultsRequest"
  }
