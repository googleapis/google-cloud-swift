...
// limitations under the License.
  ...
  public struct SummarizationHelpfulnessInstance: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `SummarizationHelpfulnessInstance`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SummarizationHelpfulnessInstance().with { $0.prediction = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.SummarizationHelpfulnessInstance"
    }
