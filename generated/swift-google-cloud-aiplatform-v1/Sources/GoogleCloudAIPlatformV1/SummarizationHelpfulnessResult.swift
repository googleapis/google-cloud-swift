...
// limitations under the License.
  ...
  public struct SummarizationHelpfulnessResult: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `SummarizationHelpfulnessResult`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SummarizationHelpfulnessResult().with { $0.score = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.SummarizationHelpfulnessResult"
    }
