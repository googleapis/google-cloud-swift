...
// limitations under the License.
  ...
  public struct DeleteRagFileRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `DeleteRagFileRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DeleteRagFileRequest().with { $0.name = ... }
    /// ```
