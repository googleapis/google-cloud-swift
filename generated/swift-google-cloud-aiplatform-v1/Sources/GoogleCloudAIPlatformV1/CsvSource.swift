...
// limitations under the License.
  ...
  public struct CsvSource: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `CsvSource`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = CsvSource().with { $0.gcsSource = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.CsvSource"
    }
