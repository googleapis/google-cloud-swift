...
// limitations under the License.
  ...
  public struct UpdateFeatureViewOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `UpdateFeatureViewOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = UpdateFeatureViewOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.UpdateFeatureViewOperationMetadata"
    }
