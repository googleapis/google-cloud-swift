...
// limitations under the License.
    ...
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let enableInternetAccess = CodingKeys(stringValue: "enableInternetAccess")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(Swift.Bool.self, forKey: .enableInternetAccess) {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.enableInternetAccess, forKey: .enableInternetAccess)
