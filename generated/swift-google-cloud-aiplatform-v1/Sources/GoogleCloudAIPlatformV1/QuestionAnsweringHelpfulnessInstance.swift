...
// limitations under the License.
  ...
  public struct QuestionAnsweringHelpfulnessInstance: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `QuestionAnsweringHelpfulnessInstance`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = QuestionAnsweringHelpfulnessInstance().with { $0.prediction = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.QuestionAnsweringHelpfulnessInstance"
    }
