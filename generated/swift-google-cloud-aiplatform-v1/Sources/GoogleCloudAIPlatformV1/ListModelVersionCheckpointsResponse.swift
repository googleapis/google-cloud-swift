...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var checkpoints: [ModelVersionCheckpoint] = []
    ...
    /// to obtain that page.
    ///
    /// [google.cloud.aiplatform.v1.ListModelVersionCheckpointsRequest.page_token]: <doc:ListModelVersionCheckpointsRequest/pageToken>
    public var nextPageToken: Swift.String = Swift.String()

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ListModelVersionCheckpointsResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListModelVersionCheckpointsResponse().with { $0.checkpoints = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [ModelVersionCheckpoint].self, forKey: .checkpoints)
      {
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.ListModelVersionCheckpointsResponse"
    }
