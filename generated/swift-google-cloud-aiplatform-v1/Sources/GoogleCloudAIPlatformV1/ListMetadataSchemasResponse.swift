...
// limitations under the License.
    ...
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let metadataSchemas = CodingKeys(stringValue: "metadataSchemas")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([MetadataSchema].self, forKey: .metadataSchemas)
      {
        self.metadataSchemas = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.metadataSchemas, forKey: .metadataSchemas)
