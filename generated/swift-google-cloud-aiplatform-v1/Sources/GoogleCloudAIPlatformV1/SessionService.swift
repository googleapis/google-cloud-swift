...
// limitations under the License.
  ...
  public final class SessionServiceClient: Clients.SessionServiceProtocol, Sendable {
    ...
    public func createSessionPollingUntilDone(
      ...
      let extractStatus = {
        (op: GoogleLongRunning.Operation) throws -> GoogleGax._PollableOperationImpl<Session>.State
        in
  ...
  extension Clients {
    ...
    public protocol SessionServiceProtocol: Sendable {
      ...
      func createSessionPollingUntilDone(request: CreateSessionRequest) async throws
      ...
      func deleteSessionPollingUntilDone(request: DeleteSessionRequest) async throws
  ...
  extension Clients.SessionServiceProtocol {
    ...
    ) -> any AsyncSequence<SessionEvent, Swift.Error> & Sendable {
  ...
  @available(
    *, unavailable,
    message: "Enable the 'SessionService' trait in Package.swift to use this client."
  )
  public final class SessionServiceClient: Sendable {
    @available(
      *, unavailable,
      message: "Enable the 'SessionService' trait in Package.swift to use this client."
    )
