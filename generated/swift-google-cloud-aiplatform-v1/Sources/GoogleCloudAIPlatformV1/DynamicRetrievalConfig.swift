...
// limitations under the License.
  ...
  public struct DynamicRetrievalConfig: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// The mode of the predictor to be used in dynamic retrieval.
    public var mode: DynamicRetrievalConfig.Mode = DynamicRetrievalConfig.Mode()
    ...
    ///
    /// ```
    /// let value = DynamicRetrievalConfig().with { $0.mode = ... }
    /// ```
    ...
    public enum Mode: Codable, Equatable, Sendable {
      ...
      public var stringValue: Swift.String? {
        ...
        case .`dynamic`: return "MODE_DYNAMIC"
