...
// limitations under the License.
  ...
  extension Clients.SpecialistPoolServiceProtocol {
    ...
    ) -> some AsyncSequence<SpecialistPool, Swift.Error> & Sendable {
    ...
    public func listSpecialistPoolsByItems(
      ...
      return self.listSpecialistPoolsByItems(request: request)
    }
  ...
  @available(
    *, unavailable,
    message: "Enable the 'SpecialistPoolService' trait in Package.swift to use this client."
  )
  public final class SpecialistPoolServiceClient: Sendable {
    @available(
      *, unavailable,
      message: "Enable the 'SpecialistPoolService' trait in Package.swift to use this client."
    )
