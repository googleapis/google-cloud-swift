...
// limitations under the License.
  ...
  public struct CreateMetadataStoreOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `CreateMetadataStoreOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = CreateMetadataStoreOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.CreateMetadataStoreOperationMetadata"
    }
