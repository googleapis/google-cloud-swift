...
// limitations under the License.
  ...
  public struct PairwiseQuestionAnsweringQualityInstance: Codable, Equatable, GoogleCloudWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `PairwiseQuestionAnsweringQualityInstance`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = PairwiseQuestionAnsweringQualityInstance().with { $0.prediction = ... }
    /// ```
