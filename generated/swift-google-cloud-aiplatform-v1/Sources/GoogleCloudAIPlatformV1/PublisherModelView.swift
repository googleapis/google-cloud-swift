...
// limitations under the License.
  ...
  ///   them to named cases.
  public enum PublisherModelView: Codable, Equatable, Hashable, Sendable {
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "PUBLISHER_MODEL_VIEW_UNSPECIFIED"
      case .basic: return "PUBLISHER_MODEL_VIEW_BASIC"
      case .full: return "PUBLISHER_MODEL_VIEW_FULL"
      case .publisherModelVersionViewBasic: return "PUBLISHER_MODEL_VERSION_VIEW_BASIC"
    ...
    public init(stringValue: Swift.String) {
      ...
      case "PUBLISHER_MODEL_VIEW_BASIC": self = .basic
      case "PUBLISHER_MODEL_VIEW_FULL": self = .full
      case "PUBLISHER_MODEL_VERSION_VIEW_BASIC": self = .publisherModelVersionViewBasic
