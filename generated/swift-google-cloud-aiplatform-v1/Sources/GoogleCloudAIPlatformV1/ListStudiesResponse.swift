...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `ListStudiesResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListStudiesResponse().with { $0.studies = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let studies = CodingKeys(stringValue: "studies")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Study].self, forKey: .studies) {
        self.studies = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.studies, forKey: .studies)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.ListStudiesResponse"
    }
