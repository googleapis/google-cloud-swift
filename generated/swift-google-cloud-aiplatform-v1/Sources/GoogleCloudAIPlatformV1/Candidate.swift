...
// limitations under the License.
    ...
    Sendable
  {
    ...
    ///   them to named cases.
    public enum FinishReason: Codable, Equatable, Hashable, Sendable {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .unspecified: return try container.encode("FINISH_REASON_UNSPECIFIED")
        case .stop: return try container.encode("STOP")
        case .maxTokens: return try container.encode("MAX_TOKENS")
        case .safety: return try container.encode("SAFETY")
        case .recitation: return try container.encode("RECITATION")
        ...
        case .malformedFunctionCall: return try container.encode("MALFORMED_FUNCTION_CALL")
