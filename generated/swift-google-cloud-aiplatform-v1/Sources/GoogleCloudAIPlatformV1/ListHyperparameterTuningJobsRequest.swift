...
// limitations under the License.
  ...
  public struct ListHyperparameterTuningJobsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ListHyperparameterTuningJobsRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListHyperparameterTuningJobsRequest().with { $0.parent = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.ListHyperparameterTuningJobsRequest"
    }
