...
// limitations under the License.
  ...
  public struct QuestionAnsweringRelevanceResult: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `QuestionAnsweringRelevanceResult`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = QuestionAnsweringRelevanceResult().with { $0.score = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.QuestionAnsweringRelevanceResult"
    }
