...
// limitations under the License.
  ...
  extension Clients.ReasoningEngineServiceProtocol {
    ...
    public func listReasoningEnginesByItems(
      request: ListReasoningEnginesRequest
    ) -> some AsyncSequence<ReasoningEngine, Swift.Error> & Sendable {
      self.listReasoningEnginesByItems(request: request, options: .init())
    }
    ...
    public func listReasoningEnginesByItems(
      ...
      let listRpc = {
        @Sendable (token: Swift.String) async throws
          -> GoogleCloudAIPlatformV1.ListReasoningEnginesResponse in
        var request = request
    ...
    public func listReasoningEnginesByItems(
      ...
      return self.listReasoningEnginesByItems(request: request)
    }
  ...
  @available(
    *, unavailable,
    message: "Enable the 'ReasoningEngineService' trait in Package.swift to use this client."
  )
  public final class ReasoningEngineServiceClient: Sendable {
    @available(
      *, unavailable,
      message: "Enable the 'ReasoningEngineService' trait in Package.swift to use this client."
    )
