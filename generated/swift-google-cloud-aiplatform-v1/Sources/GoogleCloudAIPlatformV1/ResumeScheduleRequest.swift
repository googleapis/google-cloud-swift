...
// limitations under the License.
  ...
  ///
  /// [google.cloud.aiplatform.v1.ScheduleService.ResumeSchedule]: <doc:ScheduleServiceClient/resumeSchedule(request:options:)>
  public struct ResumeScheduleRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
