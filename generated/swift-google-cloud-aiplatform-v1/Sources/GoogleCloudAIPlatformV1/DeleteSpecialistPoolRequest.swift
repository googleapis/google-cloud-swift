...
// limitations under the License.
  ...
  ///
  /// [google.cloud.aiplatform.v1.SpecialistPoolService.DeleteSpecialistPool]: <doc:SpecialistPoolServiceClient/deleteSpecialistPool(request:options:)>
  public struct DeleteSpecialistPoolRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `DeleteSpecialistPoolRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DeleteSpecialistPoolRequest().with { $0.name = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.DeleteSpecialistPoolRequest"
    }
