...
// limitations under the License.
  ...
  @available(
    *, unavailable,
    message:
      "Enable the 'FeaturestoreOnlineServingService' trait in Package.swift to use this client."
  )
  public final class FeaturestoreOnlineServingServiceClient: Sendable {
    @available(
      *, unavailable,
      message:
        "Enable the 'FeaturestoreOnlineServingService' trait in Package.swift to use this client."
