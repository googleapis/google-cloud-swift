...
// limitations under the License.
  ...
  ///   them to named cases.
  public enum PSCAutomationState: Codable, Equatable, Hashable, Sendable {
    /// Should not be used.
    case unspecified
    ...
    public var stringValue: Swift.String? {
      ...
      case .failed: return "PSC_AUTOMATION_STATE_FAILED"
    ...
    public init(stringValue: Swift.String) {
      ...
      case "PSC_AUTOMATION_STATE_FAILED": self = .failed
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("PSC_AUTOMATION_STATE_UNSPECIFIED")
      case .successful: return try container.encode("PSC_AUTOMATION_STATE_SUCCESSFUL")
      case .failed: return try container.encode("PSC_AUTOMATION_STATE_FAILED")
