...
// limitations under the License.
  ...
  public struct BatchImportEvaluatedAnnotationsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = BatchImportEvaluatedAnnotationsResponse().with { $0.importedEvaluatedAnnotationsCount = ... }
    /// ```
