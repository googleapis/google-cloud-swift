...
// limitations under the License.
  ...
  public struct DeployedIndexRef: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `DeployedIndexRef`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DeployedIndexRef().with { $0.indexEndpoint = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.DeployedIndexRef"
    }
