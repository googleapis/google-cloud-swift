...
// limitations under the License.
  ...
  public struct UpdatePersistentResourceOperationMetadata: Codable, Equatable, GoogleCloudWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `UpdatePersistentResourceOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = UpdatePersistentResourceOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
