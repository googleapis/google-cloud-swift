...
// limitations under the License.
  ...
  public struct QuestionAnsweringQualityResult: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `QuestionAnsweringQualityResult`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = QuestionAnsweringQualityResult().with { $0.score = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.QuestionAnsweringQualityResult"
    }
