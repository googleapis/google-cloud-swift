      ...
      Sendable
    {
      ...
      public enum RecordErrorType: Codable, Equatable, Sendable {
        ...
        public func encode(to encoder: Encoder) throws {
          ...
          case .emptyLine: return try container.encode("EMPTY_LINE")
          case .invalidJsonSyntax: return try container.encode("INVALID_JSON_SYNTAX")
          case .invalidCsvSyntax: return try container.encode("INVALID_CSV_SYNTAX")
          case .invalidAvroSyntax: return try container.encode("INVALID_AVRO_SYNTAX")
          case .invalidEmbeddingId: return try container.encode("INVALID_EMBEDDING_ID")
          case .embeddingSizeMismatch: return try container.encode("EMBEDDING_SIZE_MISMATCH")
          case .namespaceMissing: return try container.encode("NAMESPACE_MISSING")
          case .parsingError: return try container.encode("PARSING_ERROR")
          case .duplicateNamespace: return try container.encode("DUPLICATE_NAMESPACE")
          case .opInDatapoint: return try container.encode("OP_IN_DATAPOINT")
          case .multipleValues: return try container.encode("MULTIPLE_VALUES")
          case .invalidNumericValue: return try container.encode("INVALID_NUMERIC_VALUE")
          case .invalidEncoding: return try container.encode("INVALID_ENCODING")
          case .invalidSparseDimensions: return try container.encode("INVALID_SPARSE_DIMENSIONS")
          case .invalidTokenValue: return try container.encode("INVALID_TOKEN_VALUE")
          case .invalidSparseEmbedding: return try container.encode("INVALID_SPARSE_EMBEDDING")
          case .invalidEmbedding: return try container.encode("INVALID_EMBEDDING")
