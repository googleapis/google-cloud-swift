...
// limitations under the License.
  ...
  public struct QuestionAnsweringCorrectnessInstance: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `QuestionAnsweringCorrectnessInstance`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = QuestionAnsweringCorrectnessInstance().with { $0.prediction = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.QuestionAnsweringCorrectnessInstance"
    }
