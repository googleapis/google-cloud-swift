    ...
    final class FeatureOnlineStoreServiceLogging: FeatureOnlineStoreServiceStub {
      ...
      public func fetchFeatureValues(
        ...
        try await self._intercept(
          ...
          action: {
            (r: FetchFeatureValuesRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func searchNearestEntities(
        ...
        try await self._intercept(
          ...
          action: {
            (r: SearchNearestEntitiesRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func generateFetchAccessToken(
        ...
        try await self._intercept(
          ...
          action: {
            (r: GenerateFetchAccessTokenRequest, o: GoogleGax.RequestOptions) async throws
