...
// limitations under the License.
    ...
    Sendable
  {
    ...
    ///   them to named cases.
    public enum AggregationMetric: Codable, Equatable, Hashable, Sendable {
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        switch self {
        case .unspecified: return try container.encode("AGGREGATION_METRIC_UNSPECIFIED")
        case .average: return try container.encode("AVERAGE")
        case .mode: return try container.encode("MODE")
        case .standardDeviation: return try container.encode("STANDARD_DEVIATION")
        case .variance: return try container.encode("VARIANCE")
        case .minimum: return try container.encode("MINIMUM")
        case .maximum: return try container.encode("MAXIMUM")
        case .median: return try container.encode("MEDIAN")
        case .percentileP90: return try container.encode("PERCENTILE_P90")
        case .percentileP95: return try container.encode("PERCENTILE_P95")
        case .percentileP99: return try container.encode("PERCENTILE_P99")
