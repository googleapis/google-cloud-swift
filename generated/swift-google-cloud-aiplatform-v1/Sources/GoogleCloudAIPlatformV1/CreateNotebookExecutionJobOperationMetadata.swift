...
// limitations under the License.
  ...
  public struct CreateNotebookExecutionJobOperationMetadata: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `CreateNotebookExecutionJobOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = CreateNotebookExecutionJobOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
