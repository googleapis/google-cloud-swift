...
// limitations under the License.
    ...
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let hyperparameterTuningJobs = CodingKeys(stringValue: "hyperparameterTuningJobs")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [HyperparameterTuningJob].self, forKey: .hyperparameterTuningJobs)
      {
        self.hyperparameterTuningJobs = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.hyperparameterTuningJobs, forKey: .hyperparameterTuningJobs)
