...
// limitations under the License.
  ...
  extension Clients {
    final class FeaturestoreOnlineServingServiceRetry: FeaturestoreOnlineServingServiceStub {
      ...
      public init(
        _ inner: any FeaturestoreOnlineServingServiceStub, options: GoogleGax.ClientOptions
      ) {
        self.inner = inner
      ...
      public func readFeatureValues(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: ReadFeatureValuesRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func writeFeatureValues(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: WriteFeatureValuesRequest, o: GoogleGax.RequestOptions) async throws
