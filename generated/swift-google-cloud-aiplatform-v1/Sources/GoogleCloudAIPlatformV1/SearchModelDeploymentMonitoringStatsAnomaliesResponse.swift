...
// limitations under the License.
    ...
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let monitoringStats = CodingKeys(stringValue: "monitoringStats")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [ModelMonitoringStatsAnomalies].self, forKey: .monitoringStats)
      {
        self.monitoringStats = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.monitoringStats, forKey: .monitoringStats)
