...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var metricSpec: QuestionAnsweringHelpfulnessSpec? = nil
    ...
    ///
    /// ```
    /// let value = QuestionAnsweringHelpfulnessInput().with { $0.metricSpec = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.metricSpec = try container.decodeIfPresent(
        QuestionAnsweringHelpfulnessSpec.self, forKey: .metricSpec)
