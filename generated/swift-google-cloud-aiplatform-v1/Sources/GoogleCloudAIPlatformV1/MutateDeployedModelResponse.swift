...
// limitations under the License.
  ...
  public struct MutateDeployedModelResponse: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `MutateDeployedModelResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = MutateDeployedModelResponse().with { $0.deployedModel = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.MutateDeployedModelResponse"
    }
