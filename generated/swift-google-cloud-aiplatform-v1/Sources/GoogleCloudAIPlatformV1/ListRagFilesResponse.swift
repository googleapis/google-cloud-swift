...
// limitations under the License.
    ...
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let ragFiles = CodingKeys(stringValue: "ragFiles")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([RagFile].self, forKey: .ragFiles) {
        self.ragFiles = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.ragFiles, forKey: .ragFiles)
