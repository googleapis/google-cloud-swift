...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// in the request.
    public var modelDeploymentMonitoringJobs: [ModelDeploymentMonitoringJob] = []
    ...
    ///
    /// ```
    /// let value = ListModelDeploymentMonitoringJobsResponse().with { $0.modelDeploymentMonitoringJobs = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let modelDeploymentMonitoringJobs = CodingKeys(
        stringValue: "modelDeploymentMonitoringJobs")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [ModelDeploymentMonitoringJob].self, forKey: .modelDeploymentMonitoringJobs)
      {
        self.modelDeploymentMonitoringJobs = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(
        self.modelDeploymentMonitoringJobs, forKey: .modelDeploymentMonitoringJobs)
