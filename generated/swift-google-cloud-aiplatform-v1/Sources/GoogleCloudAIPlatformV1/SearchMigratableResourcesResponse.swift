...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var migratableResources: [MigratableResource] = []
    ...
    /// Initialize a new instance of `SearchMigratableResourcesResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SearchMigratableResourcesResponse().with { $0.migratableResources = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let migratableResources = CodingKeys(stringValue: "migratableResources")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [MigratableResource].self, forKey: .migratableResources)
      {
        self.migratableResources = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.migratableResources, forKey: .migratableResources)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.SearchMigratableResourcesResponse"
    }
