...
// limitations under the License.
  ...
  public struct BleuMetricValue: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `BleuMetricValue`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = BleuMetricValue().with { $0.score = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.BleuMetricValue"
    }
