...
// limitations under the License.
  ...
  public struct CreateNotebookRuntimeTemplateOperationMetadata: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `CreateNotebookRuntimeTemplateOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = CreateNotebookRuntimeTemplateOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
