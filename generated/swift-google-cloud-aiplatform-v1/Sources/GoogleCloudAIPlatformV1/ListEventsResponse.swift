...
// limitations under the License.
    ...
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let sessionEvents = CodingKeys(stringValue: "sessionEvents")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([SessionEvent].self, forKey: .sessionEvents) {
        self.sessionEvents = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.sessionEvents, forKey: .sessionEvents)
