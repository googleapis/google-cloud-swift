...
// limitations under the License.
  ...
  public struct AddExecutionEventsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `AddExecutionEventsRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = AddExecutionEventsRequest().with { $0.execution = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.AddExecutionEventsRequest"
    }
