...
// limitations under the License.
  ...
  public struct DeployIndexOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `DeployIndexOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DeployIndexOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.DeployIndexOperationMetadata"
    }
