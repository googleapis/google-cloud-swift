...
// limitations under the License.
  ...
  public struct ReadTensorboardTimeSeriesDataRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var maxDataPoints: Swift.Int32 = Swift.Int32()
    ...
    ///
    /// ```
    /// let value = ReadTensorboardTimeSeriesDataRequest().with { $0.tensorboardTimeSeries = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.ReadTensorboardTimeSeriesDataRequest"
    }
