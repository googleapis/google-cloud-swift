...
// limitations under the License.
  ...
  public struct SearchFeaturesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = SearchFeaturesRequest().with { $0.location = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.SearchFeaturesRequest"
    }
