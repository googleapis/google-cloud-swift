...
// limitations under the License.
  ...
  public struct Checkpoint: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `Checkpoint`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = Checkpoint().with { $0.checkpointId = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.Checkpoint"
    }
