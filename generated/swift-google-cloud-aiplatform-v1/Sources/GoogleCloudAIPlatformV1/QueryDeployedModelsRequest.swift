...
// limitations under the License.
  ...
  public struct QueryDeployedModelsRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    /// Required. The name of the target DeploymentResourcePool to query.
    /// Format:
    /// `projects/{project}/locations/{location}/deploymentResourcePools/{deployment_resource_pool}`
    public var deploymentResourcePool: Swift.String = Swift.String()
    ...
    /// Initialize a new instance of `QueryDeployedModelsRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = QueryDeployedModelsRequest().with { $0.deploymentResourcePool = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        Swift.String.self, forKey: .deploymentResourcePool)
      {
        self.deploymentResourcePool = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.deploymentResourcePool, forKey: .deploymentResourcePool)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.QueryDeployedModelsRequest"
    }
