...
// limitations under the License.
  ...
  public struct GroundednessResult: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `GroundednessResult`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = GroundednessResult().with { $0.score = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.GroundednessResult"
    }
