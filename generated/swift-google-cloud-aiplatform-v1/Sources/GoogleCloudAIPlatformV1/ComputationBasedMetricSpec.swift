...
// limitations under the License.
  ...
  public struct ComputationBasedMetricSpec: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// Required. The type of the computation based metric.
    public var type: ComputationBasedMetricSpec.ComputationBasedMetricType? = nil
    ...
    ///
    /// ```
    /// let value = ComputationBasedMetricSpec().with { $0.type = ... }
    /// ```
    ...
    ///   them to named cases.
    public enum ComputationBasedMetricType: Codable, Equatable, Hashable, Sendable {
      ...
      public var stringValue: Swift.String? {
        switch self {
        case .unspecified: return "COMPUTATION_BASED_METRIC_TYPE_UNSPECIFIED"
      ...
      ///
      /// If the value is unknown, this initializes to [`unknownStringValue`](doc:ComputationBasedMetricType/unknownStringValue(_:)).
      public init(stringValue: Swift.String) {
        switch stringValue {
        case "COMPUTATION_BASED_METRIC_TYPE_UNSPECIFIED": self = .unspecified
      ...
      ///
      /// If the value is unknown, this initializes to [`unknownIntValue`](doc:ComputationBasedMetricType/unknownIntValue(_:)).
