...
// limitations under the License.
  ...
  /// RagFile status.
  public struct FileStatus: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    /// Output only. RagFile state.
    public var state: FileStatus.State = FileStatus.State()
    ...
    /// Initialize a new instance of `FileStatus`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = FileStatus().with { $0.state = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(FileStatus.State.self, forKey: .state) {
        self.state = value
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.FileStatus"
    }
