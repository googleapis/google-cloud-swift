...
// limitations under the License.
  ...
  public struct ListFeatureViewsResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    GoogleCloudGax._PaginatedResponse,
    Sendable
  {
    /// The FeatureViews matching the request.
    public var featureViews: [FeatureView] = []
    ...
    /// subsequent pages.
    ///
    /// [google.cloud.aiplatform.v1.ListFeatureViewsRequest.page_token]: <doc:ListFeatureViewsRequest/pageToken>
    public var nextPageToken: Swift.String = Swift.String()

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleCloudWKT._UnknownFields = .init()

    /// Initialize a new instance of `ListFeatureViewsResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListFeatureViewsResponse().with { $0.featureViews = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let featureViews = CodingKeys(stringValue: "featureViews")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([FeatureView].self, forKey: .featureViews) {
        self.featureViews = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.featureViews, forKey: .featureViews)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.ListFeatureViewsResponse"
    }
