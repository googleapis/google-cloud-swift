...
// limitations under the License.
  ...
  public struct RebaseTunedModelOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `RebaseTunedModelOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RebaseTunedModelOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.RebaseTunedModelOperationMetadata"
    }
