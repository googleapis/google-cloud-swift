...
// limitations under the License.
  ...
  public struct UpdateReasoningEngineOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `UpdateReasoningEngineOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = UpdateReasoningEngineOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.UpdateReasoningEngineOperationMetadata"
    }
