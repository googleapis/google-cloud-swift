...
// limitations under the License.
  ...
  public struct CreateModelDeploymentMonitoringJobRequest: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `CreateModelDeploymentMonitoringJobRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = CreateModelDeploymentMonitoringJobRequest().with { $0.parent = ... }
    /// ```
