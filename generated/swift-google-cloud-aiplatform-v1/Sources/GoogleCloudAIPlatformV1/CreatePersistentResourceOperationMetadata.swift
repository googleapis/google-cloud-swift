...
// limitations under the License.
  ...
  public struct CreatePersistentResourceOperationMetadata: Codable, Equatable, GoogleCloudWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `CreatePersistentResourceOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = CreatePersistentResourceOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
