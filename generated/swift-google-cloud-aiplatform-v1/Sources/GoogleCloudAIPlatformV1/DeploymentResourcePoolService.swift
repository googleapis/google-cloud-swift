...
// limitations under the License.
  ...
  extension Clients.DeploymentResourcePoolServiceProtocol {
    ...
    public func createDeploymentResourcePoolPollingUntilDone(
      ...
      return try await self.createDeploymentResourcePoolPollingUntilDone(request: request)
    }
    ...
    ) -> any AsyncSequence<DeploymentResourcePool, Swift.Error> & Sendable {
    ...
    public func updateDeploymentResourcePoolPollingUntilDone(
      ...
      return try await self.updateDeploymentResourcePoolPollingUntilDone(request: request)
    }
    ...
    ) -> any AsyncSequence<DeployedModel, Swift.Error> & Sendable {
  ...
  @available(
    *, unavailable,
    message: "Enable the 'DeploymentResourcePoolService' trait in Package.swift to use this client."
  )
  public final class DeploymentResourcePoolServiceClient: Sendable {
    @available(
      *, unavailable,
      message:
        "Enable the 'DeploymentResourcePoolService' trait in Package.swift to use this client."
    )
    public init(_ options: GoogleGax.ClientOptions = .init()) throws {}
  }
#endif
