...
// limitations under the License.
  ...
  public struct ListDatasetVersionsResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    ...
    Sendable
  {
    ...
    /// Initialize a new instance of `ListDatasetVersionsResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListDatasetVersionsResponse().with { $0.datasetVersions = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let datasetVersions = CodingKeys(stringValue: "datasetVersions")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([DatasetVersion].self, forKey: .datasetVersions)
      {
        self.datasetVersions = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.datasetVersions, forKey: .datasetVersions)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.ListDatasetVersionsResponse"
    }
