...
// limitations under the License.
  ...
  public struct UpdateFeaturestoreOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `UpdateFeaturestoreOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = UpdateFeaturestoreOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.UpdateFeaturestoreOperationMetadata"
    }
