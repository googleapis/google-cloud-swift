...
// limitations under the License.
    ...
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let fileUri = CodingKeys(stringValue: "fileUri")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(Swift.String.self, forKey: .fileUri) {
        self.fileUri = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.fileUri, forKey: .fileUri)
