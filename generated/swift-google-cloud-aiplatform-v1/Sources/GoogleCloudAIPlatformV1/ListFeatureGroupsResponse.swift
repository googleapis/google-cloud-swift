...
// limitations under the License.
  ...
  public struct ListFeatureGroupsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// subsequent pages.
    ///
    /// [google.cloud.aiplatform.v1.ListFeatureGroupsRequest.page_token]: <doc:ListFeatureGroupsRequest/pageToken>
    public var nextPageToken: Swift.String = Swift.String()

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ListFeatureGroupsResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListFeatureGroupsResponse().with { $0.featureGroups = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.ListFeatureGroupsResponse"
    }
