...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// Tensor, Blob
    public var pluginName: Swift.String = Swift.String()

    /// Data of the current plugin, with the size limited to 65KB.
    public var pluginData: Foundation.Data = Foundation.Data()
    ...
    ///
    /// ```
    /// let value = TensorboardTimeSeries().with { $0.name = ... }
    /// ```
      ...
      Sendable
    {
      ...
      /// TensorboardTimeSeries.
      public var maxStep: Swift.Int64 = Swift.Int64()
      ...
      ///
      /// ```
      /// let value = Metadata().with { $0.maxStep = ... }
      /// ```
      public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
        var copy = self
        try config(&copy)
    ...
    public enum ValueType: Codable, Equatable, Sendable {
      ...
      public var stringValue: Swift.String? {
        ...
        case .blobSequence: return "BLOB_SEQUENCE"
      ...
      public init(stringValue: Swift.String) {
        ...
        case "BLOB_SEQUENCE": self = .blobSequence
      ...
      public func encode(to encoder: Encoder) throws {
        ...
        case .scalar: return try container.encode("SCALAR")
        case .tensor: return try container.encode("TENSOR")
        case .blobSequence: return try container.encode("BLOB_SEQUENCE")
