...
// limitations under the License.
  ...
  public struct SummarizationVerbosityResult: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `SummarizationVerbosityResult`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SummarizationVerbosityResult().with { $0.score = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.SummarizationVerbosityResult"
    }
