...
// limitations under the License.
    ...
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let tensorboardExperiments = CodingKeys(stringValue: "tensorboardExperiments")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [TensorboardExperiment].self, forKey: .tensorboardExperiments)
      {
        self.tensorboardExperiments = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.tensorboardExperiments, forKey: .tensorboardExperiments)
