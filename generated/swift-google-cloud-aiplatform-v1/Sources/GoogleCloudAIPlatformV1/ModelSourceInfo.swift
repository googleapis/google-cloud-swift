...
// limitations under the License.
  ...
  public struct ModelSourceInfo: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    /// Type of the model source.
    public var sourceType: ModelSourceInfo.ModelSourceType = ModelSourceInfo.ModelSourceType()

    /// If this Model is copy of another Model. If true then
    /// [source_type][google.cloud.aiplatform.v1.ModelSourceInfo.source_type]
    /// pertains to the original.
    ///
    /// [google.cloud.aiplatform.v1.ModelSourceInfo.source_type]: <doc:ModelSourceInfo/sourceType>
    public var copy: Swift.Bool = Swift.Bool()

    /// Initialize a new instance of `ModelSourceInfo`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ModelSourceInfo().with { $0.sourceType = ... }
    /// ```
