...
// limitations under the License.
  ...
  public struct StreamingPredictResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `StreamingPredictResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = StreamingPredictResponse().with { $0.outputs = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.StreamingPredictResponse"
    }
