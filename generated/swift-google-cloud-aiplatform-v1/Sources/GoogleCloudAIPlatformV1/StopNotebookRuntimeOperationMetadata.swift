...
// limitations under the License.
  ...
  public struct StopNotebookRuntimeOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `StopNotebookRuntimeOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = StopNotebookRuntimeOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.StopNotebookRuntimeOperationMetadata"
    }
