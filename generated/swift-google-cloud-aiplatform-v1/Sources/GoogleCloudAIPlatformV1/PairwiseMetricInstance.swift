...
// limitations under the License.
  ...
  /// evaluation dataset.
  public struct PairwiseMetricInstance: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `PairwiseMetricInstance`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = PairwiseMetricInstance().with { $0.jsonInstance = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let jsonInstance = CodingKeys(stringValue: "jsonInstance")
      static let contentMapInstance = CodingKeys(stringValue: "contentMapInstance")
