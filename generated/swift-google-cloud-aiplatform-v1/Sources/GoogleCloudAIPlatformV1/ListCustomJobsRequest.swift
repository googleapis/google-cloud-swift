...
// limitations under the License.
  ...
  public struct ListCustomJobsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ListCustomJobsRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListCustomJobsRequest().with { $0.parent = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.ListCustomJobsRequest"
    }
