...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// request.
    public var dataLabelingJobs: [DataLabelingJob] = []
    ...
    /// Initialize a new instance of `ListDataLabelingJobsResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListDataLabelingJobsResponse().with { $0.dataLabelingJobs = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let dataLabelingJobs = CodingKeys(stringValue: "dataLabelingJobs")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [DataLabelingJob].self, forKey: .dataLabelingJobs)
      {
        self.dataLabelingJobs = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.dataLabelingJobs, forKey: .dataLabelingJobs)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.ListDataLabelingJobsResponse"
    }
