...
// limitations under the License.
  ...
  public struct ImportDataOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ImportDataOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ImportDataOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.ImportDataOperationMetadata"
    }
