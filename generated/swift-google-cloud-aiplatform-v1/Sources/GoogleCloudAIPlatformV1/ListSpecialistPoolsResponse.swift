...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var specialistPools: [SpecialistPool] = []
    ...
    /// Initialize a new instance of `ListSpecialistPoolsResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListSpecialistPoolsResponse().with { $0.specialistPools = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([SpecialistPool].self, forKey: .specialistPools)
      {
