...
// limitations under the License.
  ...
  public struct FluencyResult: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `FluencyResult`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = FluencyResult().with { $0.score = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.FluencyResult"
    }
