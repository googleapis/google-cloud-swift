...
// limitations under the License.
  ...
  ///
  /// [google.cloud.aiplatform.v1.IndexEndpointService.UndeployIndex]: <doc:IndexEndpointServiceClient/undeployIndex(request:options:)>
  public struct UndeployIndexOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `UndeployIndexOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = UndeployIndexOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.UndeployIndexOperationMetadata"
    }
