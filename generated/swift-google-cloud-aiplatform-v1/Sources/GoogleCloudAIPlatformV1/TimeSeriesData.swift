...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var values: [TimeSeriesDataPoint] = []
    ...
    ///
    /// ```
    /// let value = TimeSeriesData().with { $0.tensorboardTimeSeriesId = ... }
    /// ```
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([TimeSeriesDataPoint].self, forKey: .values) {
        self.values = value
      }
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.TimeSeriesData"
    }
