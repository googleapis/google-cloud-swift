...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// to obtain that page.
    ///
    /// [google.cloud.aiplatform.v1.ListSchedulesRequest.page_token]: <doc:ListSchedulesRequest/pageToken>
    public var nextPageToken: Swift.String = Swift.String()

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ListSchedulesResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListSchedulesResponse().with { $0.schedules = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let schedules = CodingKeys(stringValue: "schedules")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Schedule].self, forKey: .schedules) {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.schedules, forKey: .schedules)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.ListSchedulesResponse"
    }
