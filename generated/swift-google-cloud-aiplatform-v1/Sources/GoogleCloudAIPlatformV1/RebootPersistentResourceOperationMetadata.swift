...
// limitations under the License.
  ...
  public struct RebootPersistentResourceOperationMetadata: Codable, Equatable, GoogleCloudWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `RebootPersistentResourceOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = RebootPersistentResourceOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
