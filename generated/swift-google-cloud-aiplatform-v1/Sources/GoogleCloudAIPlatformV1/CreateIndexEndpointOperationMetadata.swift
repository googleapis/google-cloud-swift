...
// limitations under the License.
  ...
  public struct CreateIndexEndpointOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `CreateIndexEndpointOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = CreateIndexEndpointOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.CreateIndexEndpointOperationMetadata"
    }
