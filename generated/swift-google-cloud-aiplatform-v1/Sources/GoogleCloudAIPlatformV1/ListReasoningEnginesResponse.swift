...
// limitations under the License.
    ...
    Sendable
  {
    ...
    public var reasoningEngines: [ReasoningEngine] = []
    ...
    /// to obtain that page.
    ///
    /// [google.cloud.aiplatform.v1.ListReasoningEnginesRequest.page_token]: <doc:ListReasoningEnginesRequest/pageToken>
    public var nextPageToken: Swift.String = Swift.String()

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ListReasoningEnginesResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListReasoningEnginesResponse().with { $0.reasoningEngines = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let reasoningEngines = CodingKeys(stringValue: "reasoningEngines")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [ReasoningEngine].self, forKey: .reasoningEngines)
      {
        self.reasoningEngines = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.reasoningEngines, forKey: .reasoningEngines)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.ListReasoningEnginesResponse"
    }
