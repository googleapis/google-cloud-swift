...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// to obtain that page.
    ///
    /// [google.cloud.aiplatform.v1.ListIndexesRequest.page_token]: <doc:ListIndexesRequest/pageToken>
    public var nextPageToken: Swift.String = Swift.String()

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ListIndexesResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListIndexesResponse().with { $0.indexes = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let indexes = CodingKeys(stringValue: "indexes")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([Index].self, forKey: .indexes) {
        self.indexes = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.indexes, forKey: .indexes)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.ListIndexesResponse"
    }
