...
// limitations under the License.
  ...
  public struct QueryArtifactLineageSubgraphRequest: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let maxHops = CodingKeys(stringValue: "maxHops")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(Swift.Int32.self, forKey: .maxHops) {
        self.maxHops = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.maxHops, forKey: .maxHops)
