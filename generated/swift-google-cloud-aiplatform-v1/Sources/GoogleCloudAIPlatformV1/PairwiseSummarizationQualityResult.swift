...
// limitations under the License.
  ...
  public struct PairwiseSummarizationQualityResult: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `PairwiseSummarizationQualityResult`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = PairwiseSummarizationQualityResult().with { $0.pairwiseChoice = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.PairwiseSummarizationQualityResult"
    }
