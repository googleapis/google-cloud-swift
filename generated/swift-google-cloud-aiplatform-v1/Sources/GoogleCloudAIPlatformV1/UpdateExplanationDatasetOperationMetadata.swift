...
// limitations under the License.
  ...
  public struct UpdateExplanationDatasetOperationMetadata: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `UpdateExplanationDatasetOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = UpdateExplanationDatasetOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
