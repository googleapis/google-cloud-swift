...
// limitations under the License.
  ...
  public struct CoherenceResult: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `CoherenceResult`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = CoherenceResult().with { $0.score = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.CoherenceResult"
    }
