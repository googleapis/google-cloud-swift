...
// limitations under the License.
  ...
  public struct DeployModelResponse: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `DeployModelResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DeployModelResponse().with { $0.deployedModel = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.DeployModelResponse"
    }
