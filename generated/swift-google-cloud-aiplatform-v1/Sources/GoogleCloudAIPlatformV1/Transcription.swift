...
// limitations under the License.
  ...
  public struct Transcription: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `Transcription`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = Transcription().with { $0.text = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.Transcription"
    }
