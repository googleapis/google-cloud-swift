...
// limitations under the License.
    ...
    Sendable
  {
    ...
    /// to obtain that page.
    ///
    /// [google.cloud.aiplatform.v1.ListPersistentResourcesRequest.page_token]: <doc:ListPersistentResourcesRequest/pageToken>
    public var nextPageToken: Swift.String = Swift.String()

    @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

    /// Initialize a new instance of `ListPersistentResourcesResponse`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ListPersistentResourcesResponse().with { $0.persistentResources = ... }
    /// ```
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let persistentResources = CodingKeys(stringValue: "persistentResources")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent(
        [PersistentResource].self, forKey: .persistentResources)
      {
        self.persistentResources = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.persistentResources, forKey: .persistentResources)
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.ListPersistentResourcesResponse"
    }
