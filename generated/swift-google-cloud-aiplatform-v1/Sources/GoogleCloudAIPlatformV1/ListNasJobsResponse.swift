...
// limitations under the License.
    ...
    Sendable
  {
    ...
    private struct CodingKeys: CodingKey {
      ...
      static let nasJobs = CodingKeys(stringValue: "nasJobs")
    ...
    public init(from decoder: Decoder) throws {
      ...
      if let value = try container.decodeIfPresent([NasJob].self, forKey: .nasJobs) {
        self.nasJobs = value
      }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encode(self.nasJobs, forKey: .nasJobs)
