...
// limitations under the License.
  ...
  public struct BleuInstance: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `BleuInstance`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = BleuInstance().with { $0.prediction = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.BleuInstance"
    }
