...
// limitations under the License.
  ...
  public struct AsyncRetrieveContextsOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `AsyncRetrieveContextsOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = AsyncRetrieveContextsOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.AsyncRetrieveContextsOperationMetadata"
    }
