...
// limitations under the License.
  ...
  public struct QuestionAnsweringHelpfulnessResult: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `QuestionAnsweringHelpfulnessResult`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = QuestionAnsweringHelpfulnessResult().with { $0.score = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.QuestionAnsweringHelpfulnessResult"
    }
