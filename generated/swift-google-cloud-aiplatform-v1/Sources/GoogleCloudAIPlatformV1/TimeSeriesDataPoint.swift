...
// limitations under the License.
  ...
  public struct TimeSeriesDataPoint: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// Wall clock timestamp when this data point is generated by the end user.
    public var wallTime: GoogleWKT.WKTTimestamp? = nil
    ...
    public init(from decoder: Decoder) throws {
      ...
      self.wallTime = try container.decodeIfPresent(GoogleWKT.WKTTimestamp.self, forKey: .wallTime)
