...
// limitations under the License.
  ...
  public struct DirectPredictRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `DirectPredictRequest`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DirectPredictRequest().with { $0.endpoint = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.DirectPredictRequest"
    }
