...
// limitations under the License.
  ...
  public struct CreateFeatureViewOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `CreateFeatureViewOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = CreateFeatureViewOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.CreateFeatureViewOperationMetadata"
    }
