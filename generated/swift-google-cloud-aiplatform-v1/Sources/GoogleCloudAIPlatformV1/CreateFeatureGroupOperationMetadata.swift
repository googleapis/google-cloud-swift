...
// limitations under the License.
  ...
  public struct CreateFeatureGroupOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `CreateFeatureGroupOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = CreateFeatureGroupOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.CreateFeatureGroupOperationMetadata"
    }
