...
// limitations under the License.
  ...
  public struct SummarizationQualityResult: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `SummarizationQualityResult`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = SummarizationQualityResult().with { $0.score = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.SummarizationQualityResult"
    }
