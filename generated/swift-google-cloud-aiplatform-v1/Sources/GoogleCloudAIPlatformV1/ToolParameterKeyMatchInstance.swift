...
// limitations under the License.
  ...
  public struct ToolParameterKeyMatchInstance: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `ToolParameterKeyMatchInstance`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = ToolParameterKeyMatchInstance().with { $0.prediction = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.ToolParameterKeyMatchInstance"
    }
