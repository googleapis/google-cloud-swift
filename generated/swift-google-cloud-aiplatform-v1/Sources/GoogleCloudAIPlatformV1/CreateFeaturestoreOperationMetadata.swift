...
// limitations under the License.
  ...
  public struct CreateFeaturestoreOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `CreateFeaturestoreOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = CreateFeaturestoreOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.CreateFeaturestoreOperationMetadata"
    }
