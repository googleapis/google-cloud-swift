...
// limitations under the License.
  ...
  public struct OutputFieldSpec: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    public var guidance: Swift.String = Swift.String()
    ...
    ///
    /// ```
    /// let value = OutputFieldSpec().with { $0.fieldName = ... }
    /// ```
    ...
    ///   them to named cases.
    public enum FieldType: Codable, Equatable, Hashable, Sendable {
      ...
      public var stringValue: Swift.String? {
        switch self {
        case .unspecified: return "FIELD_TYPE_UNSPECIFIED"
      ...
      ///
      /// If the value is unknown, this initializes to [`unknownStringValue`](doc:FieldType/unknownStringValue(_:)).
      public init(stringValue: Swift.String) {
        switch stringValue {
        case "FIELD_TYPE_UNSPECIFIED": self = .unspecified
      ...
      ///
      /// If the value is unknown, this initializes to [`unknownIntValue`](doc:FieldType/unknownIntValue(_:)).
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.OutputFieldSpec"
    }
