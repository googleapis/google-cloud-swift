...
// limitations under the License.
  ...
  public struct QuestionAnsweringCorrectnessResult: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `QuestionAnsweringCorrectnessResult`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = QuestionAnsweringCorrectnessResult().with { $0.score = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.QuestionAnsweringCorrectnessResult"
    }
