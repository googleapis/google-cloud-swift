...
// limitations under the License.
  ...
  extension Clients {
    final class ReasoningEngineExecutionServiceRetry: ReasoningEngineExecutionServiceStub {
      ...
      public init(
        _ inner: any ReasoningEngineExecutionServiceStub, options: GoogleGax.ClientOptions
      ) {
        self.inner = inner
      ...
      public func queryReasoningEngine(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: QueryReasoningEngineRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func asyncQueryReasoningEngine(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: AsyncQueryReasoningEngineRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func cancelAsyncQueryReasoningEngine(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: CancelAsyncQueryReasoningEngineRequest, o: GoogleGax.RequestOptions) async throws
              -> GoogleCloudAIPlatformV1.CancelAsyncQueryReasoningEngineResponse
            in
