...
// limitations under the License.
  ...
  public struct AssignNotebookRuntimeOperationMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `AssignNotebookRuntimeOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = AssignNotebookRuntimeOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.aiplatform.v1.AssignNotebookRuntimeOperationMetadata"
    }
