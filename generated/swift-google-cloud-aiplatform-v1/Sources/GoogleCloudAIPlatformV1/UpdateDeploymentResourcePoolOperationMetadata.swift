...
// limitations under the License.
  ...
  public struct UpdateDeploymentResourcePoolOperationMetadata: Codable, Equatable, GoogleWKT
      ._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `UpdateDeploymentResourcePoolOperationMetadata`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = UpdateDeploymentResourcePoolOperationMetadata().with { $0.genericMetadata = ... }
    /// ```
