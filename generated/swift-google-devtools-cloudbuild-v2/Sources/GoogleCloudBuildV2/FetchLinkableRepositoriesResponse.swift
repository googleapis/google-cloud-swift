  ...
  Sendable
{
  ...
  /// Initialize a new instance of `FetchLinkableRepositoriesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FetchLinkableRepositoriesResponse().with { $0.repositories = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.devtools.cloudbuild.v2.FetchLinkableRepositoriesResponse"
  }
