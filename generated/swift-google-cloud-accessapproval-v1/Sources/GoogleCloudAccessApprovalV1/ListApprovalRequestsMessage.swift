...
public struct ListApprovalRequestsMessage: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListApprovalRequestsMessage`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListApprovalRequestsMessage().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.accessapproval.v1.ListApprovalRequestsMessage"
  }
