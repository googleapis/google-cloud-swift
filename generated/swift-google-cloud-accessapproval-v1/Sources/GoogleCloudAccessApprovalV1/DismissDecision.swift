  ...
  Sendable
{
  ...
  public var dismissTime: GoogleWKT.WKTTimestamp? = nil
  ...
  ///
  /// ```
  /// let value = DismissDecision().with { $0.dismissTime = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let dismissTime = CodingKeys(stringValue: "dismissTime")
    static let implicit = CodingKeys(stringValue: "implicit")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.dismissTime = try container.decodeIfPresent(
      GoogleWKT.WKTTimestamp.self, forKey: .dismissTime)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.dismissTime, forKey: .dismissTime)
