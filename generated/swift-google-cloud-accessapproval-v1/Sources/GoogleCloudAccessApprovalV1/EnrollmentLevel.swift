...
///   them to named cases.
public enum EnrollmentLevel: Codable, Equatable, Hashable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "ENROLLMENT_LEVEL_UNSPECIFIED"
    case .blockAll: return "BLOCK_ALL"
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    switch self {
    case .unspecified: return try container.encode("ENROLLMENT_LEVEL_UNSPECIFIED")
    case .blockAll: return try container.encode("BLOCK_ALL")
