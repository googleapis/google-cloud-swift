  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let audioChannelCount = CodingKeys(stringValue: "audioChannelCount")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      ExplicitDecodingConfig.AudioEncoding.self, forKey: .encoding)
    {
      self.encoding = value
    }
    ...
    if let value = try container.decodeIfPresent(Swift.Int32.self, forKey: .audioChannelCount) {
      self.audioChannelCount = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.audioChannelCount, forKey: .audioChannelCount)
  ...
  ///   them to named cases.
  public enum AudioEncoding: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .amr: return try container.encode("AMR")
      case .amrWb: return try container.encode("AMR_WB")
      case .flac: return try container.encode("FLAC")
      case .mp3: return try container.encode("MP3")
      case .oggOpus: return try container.encode("OGG_OPUS")
      case .webmOpus: return try container.encode("WEBM_OPUS")
      case .mp4Aac: return try container.encode("MP4_AAC")
      case .m4AAac: return try container.encode("M4A_AAC")
      case .movAac: return try container.encode("MOV_AAC")
