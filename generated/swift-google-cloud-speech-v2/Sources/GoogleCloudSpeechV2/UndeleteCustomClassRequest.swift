...
/// method.
///
/// [google.cloud.speech.v2.Speech.UndeleteCustomClass]: <doc:SpeechClient/undeleteCustomClass(request:options:)>
public struct UndeleteCustomClassRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
