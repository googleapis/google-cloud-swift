  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let recognizers = CodingKeys(stringValue: "recognizers")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Recognizer].self, forKey: .recognizers) {
      self.recognizers = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.recognizers, forKey: .recognizers)
