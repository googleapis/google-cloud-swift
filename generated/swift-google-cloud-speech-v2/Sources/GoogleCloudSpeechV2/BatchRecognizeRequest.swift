  ...
  Sendable
{
  ...
  public enum ProcessingStrategy: Codable, Equatable, Sendable {
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:ProcessingStrategy/unknownStringValue(_:)).
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:ProcessingStrategy/unknownIntValue(_:)).
