...
/// desired language.
public struct TranslationConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `TranslationConfig`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = TranslationConfig().with { $0.targetLanguage = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.speech.v2.TranslationConfig"
  }
