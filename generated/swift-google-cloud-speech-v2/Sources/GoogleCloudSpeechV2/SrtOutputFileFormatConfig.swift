...
public struct SrtOutputFileFormatConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `SrtOutputFileFormatConfig`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SrtOutputFileFormatConfig().with { $0.<placeholder> = ... }
  /// ```
