  ...
  Sendable
{
  ...
  ///
  /// [google.cloud.speech.v2.ListCustomClassesRequest.page_token]: <doc:ListCustomClassesRequest/pageToken>
  public var nextPageToken: Swift.String = Swift.String()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `ListCustomClassesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCustomClassesResponse().with { $0.customClasses = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.speech.v2.ListCustomClassesResponse"
  }
