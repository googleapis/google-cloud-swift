...
public struct DeletePhraseSetRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeletePhraseSetRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeletePhraseSetRequest().with { $0.name = ... }
  /// ```
