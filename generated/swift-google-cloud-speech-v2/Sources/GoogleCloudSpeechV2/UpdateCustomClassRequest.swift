...
///
/// [google.cloud.speech.v2.Speech.UpdateCustomClass]: <doc:SpeechClient/updateCustomClass(request:options:)>
public struct UpdateCustomClassRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateCustomClassRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateCustomClassRequest().with { $0.customClass = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.speech.v2.UpdateCustomClassRequest"
  }
