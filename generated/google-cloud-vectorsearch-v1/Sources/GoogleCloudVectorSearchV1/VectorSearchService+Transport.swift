...
extension Clients {
  class VectorSearchServiceTransport: VectorSearchServiceStub {
    ...
    public func listCollections(
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudVectorSearchV1.ListCollectionsResponse.self, from: data)
    }
    ...
    public func getCollection(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudVectorSearchV1.Collection.self, from: data)
    }
    ...
    public func listIndexes(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudVectorSearchV1.ListIndexesResponse.self, from: data)
    }
    ...
    public func getIndex(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudVectorSearchV1.Index.self, from: data)
    }
