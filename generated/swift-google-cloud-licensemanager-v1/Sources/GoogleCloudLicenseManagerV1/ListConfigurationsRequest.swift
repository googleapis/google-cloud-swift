...
public struct ListConfigurationsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListConfigurationsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListConfigurationsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.licensemanager.v1.ListConfigurationsRequest"
  }
