...
public struct QueryConfigurationLicenseUsageRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `QueryConfigurationLicenseUsageRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = QueryConfigurationLicenseUsageRequest().with { $0.name = ... }
  /// ```
