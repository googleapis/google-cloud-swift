  ...
  Sendable
{
  ...
  /// Initialize a new instance of `AggregateUsageResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AggregateUsageResponse().with { $0.usages = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Usage].self, forKey: .usages) {
      self.usages = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.licensemanager.v1.AggregateUsageResponse"
  }
