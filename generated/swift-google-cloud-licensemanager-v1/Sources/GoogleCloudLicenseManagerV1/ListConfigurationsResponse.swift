...
public struct ListConfigurationsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListConfigurationsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListConfigurationsResponse().with { $0.configurations = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let configurations = CodingKeys(stringValue: "configurations")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.licensemanager.v1.ListConfigurationsResponse"
  }
...
extension ListConfigurationsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Configuration] {
