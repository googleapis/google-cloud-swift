...
public struct UpdateConfigurationRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateConfigurationRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateConfigurationRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.licensemanager.v1.UpdateConfigurationRequest"
  }
