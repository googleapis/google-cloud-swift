...
public struct ListReferenceListsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var view: ReferenceListView = ReferenceListView()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `ListReferenceListsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListReferenceListsRequest().with { $0.parent = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(ReferenceListView.self, forKey: .view) {
      self.view = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ListReferenceListsRequest"
  }
