...
public struct ListRuleRevisionsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListRuleRevisionsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListRuleRevisionsResponse().with { $0.rules = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ListRuleRevisionsResponse"
  }
...
extension ListRuleRevisionsResponse: GoogleGax._PaginatedResponse {
