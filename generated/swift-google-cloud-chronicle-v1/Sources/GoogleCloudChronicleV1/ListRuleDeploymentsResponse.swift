  ...
  Sendable
{
  ...
  public var ruleDeployments: [RuleDeployment] = []
  ...
  /// Initialize a new instance of `ListRuleDeploymentsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListRuleDeploymentsResponse().with { $0.ruleDeployments = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let ruleDeployments = CodingKeys(stringValue: "ruleDeployments")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([RuleDeployment].self, forKey: .ruleDeployments) {
      self.ruleDeployments = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.ruleDeployments, forKey: .ruleDeployments)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ListRuleDeploymentsResponse"
  }
