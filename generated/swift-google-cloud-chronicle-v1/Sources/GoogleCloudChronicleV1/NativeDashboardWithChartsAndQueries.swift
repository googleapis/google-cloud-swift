...
public struct NativeDashboardWithChartsAndQueries: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Optional. Native dashboard.
  public var dashboard: NativeDashboard? = nil
  ...
  ///
  /// ```
  /// let value = NativeDashboardWithChartsAndQueries().with { $0.dashboard = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.NativeDashboardWithChartsAndQueries"
  }
