...
public struct ExportNativeDashboardsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ExportNativeDashboardsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ExportNativeDashboardsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ExportNativeDashboardsRequest"
  }
