...
public struct UpdateFindingsRefinementRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var findingsRefinement: FindingsRefinement? = nil
  ...
  /// Initialize a new instance of `UpdateFindingsRefinementRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateFindingsRefinementRequest().with { $0.findingsRefinement = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.UpdateFindingsRefinementRequest"
  }
