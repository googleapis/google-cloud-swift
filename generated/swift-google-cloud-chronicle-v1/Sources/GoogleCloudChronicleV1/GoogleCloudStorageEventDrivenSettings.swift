...
public struct GoogleCloudStorageEventDrivenSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GoogleCloudStorageEventDrivenSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GoogleCloudStorageEventDrivenSettings().with { $0.bucketUri = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.GoogleCloudStorageEventDrivenSettings"
  }
