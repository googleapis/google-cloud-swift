...
public struct ListWatchlistsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListWatchlistsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListWatchlistsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ListWatchlistsRequest"
  }
