  ...
  Sendable
{
  ...
  public var errorTitle: Swift.String = Swift.String()

  /// Error message
  public var errorDescription: Swift.String = Swift.String()

  /// Severity of the error.
  public var errorSeverity: QueryRuntimeError.ErrorSeverity = QueryRuntimeError.ErrorSeverity()

  /// Metadata for the error.
  public var metadata: [QueryRuntimeError.QueryRuntimeErrorMetadata] = []
  ...
  ///
  /// ```
  /// let value = QueryRuntimeError().with { $0.errorTitle = ... }
  /// ```
  ...
  {
    /// Metadata key.
    public var key: QueryRuntimeError.MetadataKey = QueryRuntimeError.MetadataKey()
    ...
    ///
    /// ```
    /// let value = QueryRuntimeErrorMetadata().with { $0.key = ... }
    /// ```
    public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
      var copy = self
      try config(&copy)
  ...
  public enum ErrorSeverity: Codable, Equatable, Sendable {
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "ERROR_SEVERITY_UNSPECIFIED"
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:ErrorSeverity/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "ERROR_SEVERITY_UNSPECIFIED": self = .unspecified
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:ErrorSeverity/unknownIntValue(_:)).
  ...
  public enum MetadataKey: Codable, Equatable, Sendable {
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "METADATA_KEY_UNSPECIFIED"
      case .rowLimit: return "ROW_LIMIT"
      case .unknownIntValue: return nil
      case .unknownStringValue(let v): return v
      }
    }
    ...
    /// Initialize from a string value.
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:MetadataKey/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "METADATA_KEY_UNSPECIFIED": self = .unspecified
      case "ROW_LIMIT": self = .rowLimit
      default: self = .unknownStringValue(stringValue)
      }
    }
    ...
    /// Initialize from an integer value.
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:MetadataKey/unknownIntValue(_:)).
    public init(intValue: Int) {
      switch intValue {
      case 0: self = .unspecified
      case 1: self = .rowLimit
      default: self = .unknownIntValue(intValue)
      }
    }
  ...
  public enum WarningReason: Codable, Equatable, Sendable {
    ...
    public var intValue: Int? {
      switch self {
      case .unspecified: return 0
      case .rowLimitExceeded: return 1
      case .defaultRowLimitExceeded: return 2
      case .curatedQueryDefaultRowLimitExceeded: return 3
      case .unknownIntValue(let v): return v
      case .unknownStringValue: return nil
      }
    }
    ...
    public var stringValue: Swift.String? {
      switch self {
      case .unspecified: return "WARNING_REASON_UNSPECIFIED"
      case .rowLimitExceeded: return "ROW_LIMIT_EXCEEDED"
      case .defaultRowLimitExceeded: return "DEFAULT_ROW_LIMIT_EXCEEDED"
      case .curatedQueryDefaultRowLimitExceeded: return "CURATED_QUERY_DEFAULT_ROW_LIMIT_EXCEEDED"
      case .unknownIntValue: return nil
      case .unknownStringValue(let v): return v
      }
    }
    ...
    /// Initialize from a string value.
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:WarningReason/unknownStringValue(_:)).
    public init(stringValue: Swift.String) {
      switch stringValue {
      case "WARNING_REASON_UNSPECIFIED": self = .unspecified
      case "ROW_LIMIT_EXCEEDED": self = .rowLimitExceeded
      case "DEFAULT_ROW_LIMIT_EXCEEDED": self = .defaultRowLimitExceeded
      case "CURATED_QUERY_DEFAULT_ROW_LIMIT_EXCEEDED": self = .curatedQueryDefaultRowLimitExceeded
      default: self = .unknownStringValue(stringValue)
      }
    }
    ...
    /// Initialize from an integer value.
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:WarningReason/unknownIntValue(_:)).
    public init(intValue: Int) {
      switch intValue {
      case 0: self = .unspecified
      case 1: self = .rowLimitExceeded
      case 2: self = .defaultRowLimitExceeded
      case 3: self = .curatedQueryDefaultRowLimitExceeded
      default: self = .unknownIntValue(intValue)
      }
    }
