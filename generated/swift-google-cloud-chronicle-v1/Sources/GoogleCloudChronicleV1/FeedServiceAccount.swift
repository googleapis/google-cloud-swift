  ...
  Sendable
{
  ...
  /// Initialize a new instance of `FeedServiceAccount`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FeedServiceAccount().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.FeedServiceAccount"
  }
