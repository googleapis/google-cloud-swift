...
public struct DeleteDataTableRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteDataTableRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteDataTableRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.DeleteDataTableRequest"
  }
