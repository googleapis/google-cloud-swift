...
public struct DashboardUserData: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DashboardUserData`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DashboardUserData().with { $0.lastViewedTime = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let lastViewedTime = CodingKeys(stringValue: "lastViewedTime")
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.lastViewedTime, forKey: .lastViewedTime)
