...
public struct ListNativeDashboardsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListNativeDashboardsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListNativeDashboardsRequest().with { $0.parent = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(NativeDashboardView.self, forKey: .view) {
      self.view = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ListNativeDashboardsRequest"
  }
