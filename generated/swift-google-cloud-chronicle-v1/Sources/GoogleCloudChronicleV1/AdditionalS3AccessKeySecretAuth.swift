...
public struct AdditionalS3AccessKeySecretAuth: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Access key ID.
  ...
  /// Initialize a new instance of `AdditionalS3AccessKeySecretAuth`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AdditionalS3AccessKeySecretAuth().with { $0.accessKeyId = ... }
  /// ```
