...
public struct MicrosoftSecurityCenterAlertSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `MicrosoftSecurityCenterAlertSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = MicrosoftSecurityCenterAlertSettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.MicrosoftSecurityCenterAlertSettings"
  }
