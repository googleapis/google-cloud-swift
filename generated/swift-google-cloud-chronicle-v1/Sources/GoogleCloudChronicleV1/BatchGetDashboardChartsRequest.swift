...
public struct BatchGetDashboardChartsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `BatchGetDashboardChartsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = BatchGetDashboardChartsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.BatchGetDashboardChartsRequest"
  }
