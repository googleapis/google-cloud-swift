...
public struct UpdateRuleDeploymentRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var ruleDeployment: RuleDeployment? = nil
  ...
  /// Initialize a new instance of `UpdateRuleDeploymentRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateRuleDeploymentRequest().with { $0.ruleDeployment = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let ruleDeployment = CodingKeys(stringValue: "ruleDeployment")
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.UpdateRuleDeploymentRequest"
  }
