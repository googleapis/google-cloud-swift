...
public struct RemoveChartRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `RemoveChartRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RemoveChartRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.RemoveChartRequest"
  }
