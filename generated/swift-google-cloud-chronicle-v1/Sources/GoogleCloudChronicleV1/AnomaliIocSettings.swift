...
public struct AnomaliIocSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `AnomaliIocSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AnomaliIocSettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.AnomaliIocSettings"
  }
