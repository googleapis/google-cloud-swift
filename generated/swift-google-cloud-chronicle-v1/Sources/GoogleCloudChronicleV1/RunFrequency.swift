...
///   them to named cases.
public enum RunFrequency: Codable, Equatable, Hashable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "RUN_FREQUENCY_UNSPECIFIED"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:RunFrequency/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "RUN_FREQUENCY_UNSPECIFIED": self = .unspecified
    case "LIVE": self = .live
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:RunFrequency/unknownIntValue(_:)).
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    switch self {
    case .unspecified: return try container.encode("RUN_FREQUENCY_UNSPECIFIED")
