...
public struct AzureADAuditSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `AzureADAuditSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AzureADAuditSettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.AzureADAuditSettings"
  }
