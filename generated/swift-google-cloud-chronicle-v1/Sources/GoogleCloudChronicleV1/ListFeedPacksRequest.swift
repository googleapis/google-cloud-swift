...
public struct ListFeedPacksRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListFeedPacksRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListFeedPacksRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ListFeedPacksRequest"
  }
