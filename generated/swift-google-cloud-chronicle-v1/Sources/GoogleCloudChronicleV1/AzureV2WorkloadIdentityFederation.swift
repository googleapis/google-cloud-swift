  ...
  Sendable
{
  ...
  /// Initialize a new instance of `AzureV2WorkloadIdentityFederation`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AzureV2WorkloadIdentityFederation().with { $0.clientId = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.AzureV2WorkloadIdentityFederation"
  }
