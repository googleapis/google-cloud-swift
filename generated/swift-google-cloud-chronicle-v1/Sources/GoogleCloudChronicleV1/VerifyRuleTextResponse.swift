...
public struct VerifyRuleTextResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `VerifyRuleTextResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = VerifyRuleTextResponse().with { $0.success = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.VerifyRuleTextResponse"
  }
