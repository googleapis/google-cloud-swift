...
public struct S3V2AccessKeySecretAuth: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `S3V2AccessKeySecretAuth`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = S3V2AccessKeySecretAuth().with { $0.accessKeyId = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.S3V2AccessKeySecretAuth"
  }
