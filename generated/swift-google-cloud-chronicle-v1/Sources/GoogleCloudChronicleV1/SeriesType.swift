...
///   them to named cases.
public enum SeriesType: Codable, Equatable, Hashable, Sendable {
  case unspecified
  case line
  case bar
  case pie
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "SERIES_TYPE_UNSPECIFIED"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:SeriesType/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "SERIES_TYPE_UNSPECIFIED": self = .unspecified
    case "LINE": self = .line
    case "BAR": self = .bar
    case "PIE": self = .pie
    case "TEXT": self = .text
    ...
    case "SCATTERPLOT": self = .scatterplot
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:SeriesType/unknownIntValue(_:)).
