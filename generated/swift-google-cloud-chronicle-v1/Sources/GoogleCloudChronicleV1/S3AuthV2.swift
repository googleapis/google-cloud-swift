...
public struct S3AuthV2: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// auth type for S3.
  ...
  /// Initialize a new instance of `S3AuthV2`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = S3AuthV2().with { $0.accessKeySecretAuth = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let accessKeySecretAuth = CodingKeys(stringValue: "accessKeySecretAuth")
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    if let choice = self.authType {
      switch choice {
      case .accessKeySecretAuth(let value):
        try container.encode(value, forKey: .accessKeySecretAuth)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.S3AuthV2"
  }
