  ...
  Sendable
{
  ...
  /// Initialize a new instance of `UsernameSecretAuth`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UsernameSecretAuth().with { $0.user = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.UsernameSecretAuth"
  }
