  ...
  Sendable
{
  ...
  /// Initialize a new instance of `AWSEC2VpcsSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AWSEC2VpcsSettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.AWSEC2VpcsSettings"
  }
