...
public struct ListDataAccessScopesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDataAccessScopesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDataAccessScopesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ListDataAccessScopesRequest"
  }
