...
public struct CreateFindingsRefinementRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CreateFindingsRefinementRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateFindingsRefinementRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.CreateFindingsRefinementRequest"
  }
