  ...
  Sendable
{
  ...
  public var featuredContentNativeDashboards: [FeaturedContentNativeDashboard] = []
  ...
  /// Initialize a new instance of `ListFeaturedContentNativeDashboardsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListFeaturedContentNativeDashboardsResponse().with { $0.featuredContentNativeDashboards = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let featuredContentNativeDashboards = CodingKeys(
      stringValue: "featuredContentNativeDashboards")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [FeaturedContentNativeDashboard].self, forKey: .featuredContentNativeDashboards)
    {
      self.featuredContentNativeDashboards = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(
      self.featuredContentNativeDashboards, forKey: .featuredContentNativeDashboards)
