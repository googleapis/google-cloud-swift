  ...
  Sendable
{
  ...
  /// Initialize a new instance of `OAuthPasswordGrantCredentials`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = OAuthPasswordGrantCredentials().with { $0.tokenEndpoint = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.OAuthPasswordGrantCredentials"
  }
