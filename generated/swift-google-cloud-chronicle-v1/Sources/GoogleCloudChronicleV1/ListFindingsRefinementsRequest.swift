...
public struct ListFindingsRefinementsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListFindingsRefinementsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListFindingsRefinementsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ListFindingsRefinementsRequest"
  }
