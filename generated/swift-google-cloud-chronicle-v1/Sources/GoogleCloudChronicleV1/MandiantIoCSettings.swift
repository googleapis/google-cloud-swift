  ...
  Sendable
{
  ...
  /// Initialize a new instance of `MandiantIoCSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = MandiantIoCSettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.MandiantIoCSettings"
  }
