...
public struct MimecastV2OAuthClientCredentials: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Required. Client ID.
  ...
  /// Initialize a new instance of `MimecastV2OAuthClientCredentials`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = MimecastV2OAuthClientCredentials().with { $0.clientId = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.MimecastV2OAuthClientCredentials"
  }
