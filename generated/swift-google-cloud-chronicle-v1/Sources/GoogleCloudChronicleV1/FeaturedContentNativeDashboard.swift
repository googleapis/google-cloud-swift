...
public struct FeaturedContentNativeDashboard: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var contentMetadata: FeaturedContentMetadata? = nil
  ...
  ///
  /// ```
  /// let value = FeaturedContentNativeDashboard().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.FeaturedContentNativeDashboard"
  }
