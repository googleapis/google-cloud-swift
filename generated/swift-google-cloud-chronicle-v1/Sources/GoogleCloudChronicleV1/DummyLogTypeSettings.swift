...
public struct DummyLogTypeSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DummyLogTypeSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DummyLogTypeSettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.DummyLogTypeSettings"
  }
