...
public struct Rapid7InsightSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `Rapid7InsightSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = Rapid7InsightSettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.Rapid7InsightSettings"
  }
