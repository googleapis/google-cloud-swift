...
public struct CloudPassageSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CloudPassageSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CloudPassageSettings().with { $0.authentication = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Swift.String].self, forKey: .eventTypes) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.CloudPassageSettings"
  }
