...
/// Workday settings.
public struct WorkdaySettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Input only. Authentication.
  public var authentication: WorkdayAuth? = nil
  ...
  /// Initialize a new instance of `WorkdaySettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = WorkdaySettings().with { $0.authentication = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.authentication = try container.decodeIfPresent(WorkdayAuth.self, forKey: .authentication)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.WorkdaySettings"
  }
