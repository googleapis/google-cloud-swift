  ...
  Sendable
{
  ...
  public var retrohunts: [Retrohunt] = []
  ...
  /// Initialize a new instance of `ListRetrohuntsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListRetrohuntsResponse().with { $0.retrohunts = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let retrohunts = CodingKeys(stringValue: "retrohunts")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Retrohunt].self, forKey: .retrohunts) {
      self.retrohunts = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.retrohunts, forKey: .retrohunts)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ListRetrohuntsResponse"
  }
