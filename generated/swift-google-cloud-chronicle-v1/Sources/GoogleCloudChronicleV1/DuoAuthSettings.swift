...
public struct DuoAuthSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DuoAuthSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DuoAuthSettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.DuoAuthSettings"
  }
