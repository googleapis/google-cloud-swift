  ...
  Sendable
{
  ...
  /// Initialize a new instance of `CustomAPIHeaderKeyValue`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CustomAPIHeaderKeyValue().with { $0.key = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.CustomAPIHeaderKeyValue"
  }
