  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ProofpointMailSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ProofpointMailSettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ProofpointMailSettings"
  }
