...
public struct ThreatConnectIoCSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ThreatConnectIoCSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ThreatConnectIoCSettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ThreatConnectIoCSettings"
  }
