...
extension Clients {
  final class DashboardQueryServiceTransport: DashboardQueryServiceStub {
    ...
    public func getDashboardQuery(
      ...
      let (path, query, configure) = try {
          ...
          guard
            let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
              ...
              matching: [
                ...
                .literal("/instances/"), .singleWildcard, .literal("/dashboardQueries/"),
                .singleWildcard,
              ],
              fieldName: "name")
          else {
        ...
        do {
          ...
          builder.maybeAdd(
            ...
            fieldName: "name",
            expecting: "projects/*/locations/*/instances/*/dashboardQueries/*"
          )
      ...
      return try await req.rpc(
        GoogleCloudChronicleV1.DashboardQuery.self, timeout: options.attemptTimeout
      ).get()
    }
    ...
    public func executeDashboardQuery(
      ...
      let (path, query, configure, omitted) = try {
        ...
        if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
          ...
          let path = "/v1/\(pathVariable0)/dashboardQueries:execute"
          let query = [
            URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
          ]
          return (path, query)
      ...
      return try await req.rpc(
        GoogleCloudChronicleV1.ExecuteDashboardQueryResponse.self, timeout: options.attemptTimeout
      ).get()
    }
