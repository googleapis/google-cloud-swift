...
public struct CortexXDRSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CortexXDRSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CortexXDRSettings().with { $0.authentication = ... }
  /// ```
