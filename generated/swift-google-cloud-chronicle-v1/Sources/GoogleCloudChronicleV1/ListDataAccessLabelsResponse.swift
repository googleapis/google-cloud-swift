  ...
  Sendable
{
  ...
  public var dataAccessLabels: [DataAccessLabel] = []
  ...
  /// Initialize a new instance of `ListDataAccessLabelsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDataAccessLabelsResponse().with { $0.dataAccessLabels = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let dataAccessLabels = CodingKeys(stringValue: "dataAccessLabels")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([DataAccessLabel].self, forKey: .dataAccessLabels)
    {
      self.dataAccessLabels = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.dataAccessLabels, forKey: .dataAccessLabels)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ListDataAccessLabelsResponse"
  }
