  ...
  Sendable
{
  ...
  /// Initialize a new instance of `GoogleCloudIdentityDeviceUsersSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GoogleCloudIdentityDeviceUsersSettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.GoogleCloudIdentityDeviceUsersSettings"
  }
