...
public struct DuoUserContextSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DuoUserContextSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DuoUserContextSettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.DuoUserContextSettings"
  }
