...
public struct BulkCreateDataTableRowsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `BulkCreateDataTableRowsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = BulkCreateDataTableRowsRequest().with { $0.parent = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [CreateDataTableRowRequest].self, forKey: .requests)
    {
      self.requests = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.BulkCreateDataTableRowsRequest"
  }
