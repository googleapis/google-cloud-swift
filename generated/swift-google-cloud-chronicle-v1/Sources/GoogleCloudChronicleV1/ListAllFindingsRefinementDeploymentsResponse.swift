  ...
  Sendable
{
  ...
  public var allFindingsRefinementDeployments: [FindingsRefinementDeployment] = []
  ...
  ///
  /// ```
  /// let value = ListAllFindingsRefinementDeploymentsResponse().with { $0.allFindingsRefinementDeployments = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let allFindingsRefinementDeployments = CodingKeys(
      stringValue: "allFindingsRefinementDeployments")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [FindingsRefinementDeployment].self, forKey: .allFindingsRefinementDeployments)
    {
      self.allFindingsRefinementDeployments = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(
      self.allFindingsRefinementDeployments, forKey: .allFindingsRefinementDeployments)
