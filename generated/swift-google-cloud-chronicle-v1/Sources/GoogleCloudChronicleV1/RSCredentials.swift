...
/// RS credentials.
public struct RSCredentials: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `RSCredentials`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RSCredentials().with { $0.privateKey = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.RSCredentials"
  }
