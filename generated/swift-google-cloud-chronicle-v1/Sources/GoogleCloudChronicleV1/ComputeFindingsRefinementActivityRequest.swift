...
public struct ComputeFindingsRefinementActivityRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ComputeFindingsRefinementActivityRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ComputeFindingsRefinementActivityRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ComputeFindingsRefinementActivityRequest"
  }
