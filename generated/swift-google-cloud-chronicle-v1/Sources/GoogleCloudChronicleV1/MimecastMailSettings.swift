...
public struct MimecastMailSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `MimecastMailSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = MimecastMailSettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.MimecastMailSettings"
  }
