...
///   them to named cases.
public enum VisualMapType: Codable, Equatable, Hashable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "VISUAL_MAP_TYPE_UNSPECIFIED"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:VisualMapType/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "VISUAL_MAP_TYPE_UNSPECIFIED": self = .unspecified
    case "CONTINUOUS": self = .continuous
    case "PIECEWISE": self = .piecewise
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:VisualMapType/unknownIntValue(_:)).
  public init(intValue: Int) {
    switch intValue {
    case 0: self = .unspecified
    case 1: self = .continuous
    case 2: self = .piecewise
