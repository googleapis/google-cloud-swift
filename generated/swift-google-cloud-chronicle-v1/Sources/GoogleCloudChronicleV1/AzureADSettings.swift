...
/// Azure AD settings.
public struct AzureADSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `AzureADSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AzureADSettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.AzureADSettings"
  }
