...
///   them to named cases.
public enum DataTableUpdateSource: Codable, Equatable, Hashable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "DATA_TABLE_UPDATE_SOURCE_UNSPECIFIED"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:DataTableUpdateSource/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "DATA_TABLE_UPDATE_SOURCE_UNSPECIFIED": self = .unspecified
    case "USER": self = .user
    case "RULE": self = .rule
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:DataTableUpdateSource/unknownIntValue(_:)).
