  ...
  Sendable
{
  ...
  /// Initialize a new instance of `MicrosoftOAuthClientCredentials`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = MicrosoftOAuthClientCredentials().with { $0.clientId = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.MicrosoftOAuthClientCredentials"
  }
