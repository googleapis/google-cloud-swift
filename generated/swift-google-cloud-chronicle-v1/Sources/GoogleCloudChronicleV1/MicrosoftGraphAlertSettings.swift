...
public struct MicrosoftGraphAlertSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `MicrosoftGraphAlertSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = MicrosoftGraphAlertSettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.MicrosoftGraphAlertSettings"
  }
