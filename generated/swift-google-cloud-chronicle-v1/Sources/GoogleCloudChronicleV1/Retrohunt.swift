  ...
  Sendable
{
  ...
  /// processes.
  public var processInterval: GoogleType.Interval? = nil
  ...
  public var state: Retrohunt.State = Retrohunt.State()
  ...
  ///
  /// ```
  /// let value = Retrohunt().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.Retrohunt"
  }
