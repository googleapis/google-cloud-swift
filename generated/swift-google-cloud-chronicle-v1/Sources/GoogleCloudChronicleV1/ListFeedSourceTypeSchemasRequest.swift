...
public struct ListFeedSourceTypeSchemasRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListFeedSourceTypeSchemasRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListFeedSourceTypeSchemasRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ListFeedSourceTypeSchemasRequest"
  }
