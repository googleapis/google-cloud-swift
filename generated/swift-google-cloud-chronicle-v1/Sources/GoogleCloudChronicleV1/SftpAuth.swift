...
/// SFTP Auth.
public struct SftpAuth: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var privateKeyPassphrase: Swift.String = Swift.String()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `SftpAuth`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SftpAuth().with { $0.username = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let privateKeyPassphrase = CodingKeys(stringValue: "privateKeyPassphrase")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .privateKeyPassphrase) {
      self.privateKeyPassphrase = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.privateKeyPassphrase, forKey: .privateKeyPassphrase)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.SftpAuth"
  }
