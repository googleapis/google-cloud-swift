...
public struct AzureMDMIntuneSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `AzureMDMIntuneSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AzureMDMIntuneSettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.AzureMDMIntuneSettings"
  }
