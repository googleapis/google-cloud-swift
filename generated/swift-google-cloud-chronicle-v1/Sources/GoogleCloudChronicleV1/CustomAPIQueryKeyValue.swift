...
/// API Auth.
public struct CustomAPIQueryKeyValue: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `CustomAPIQueryKeyValue`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CustomAPIQueryKeyValue().with { $0.key = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.CustomAPIQueryKeyValue"
  }
