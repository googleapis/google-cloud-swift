  ...
  Sendable
{
  ...
  public var feedSourceTypeSchemas: [FeedSourceTypeSchema] = []
  ...
  /// Initialize a new instance of `ListFeedSourceTypeSchemasResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListFeedSourceTypeSchemasResponse().with { $0.feedSourceTypeSchemas = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let feedSourceTypeSchemas = CodingKeys(stringValue: "feedSourceTypeSchemas")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [FeedSourceTypeSchema].self, forKey: .feedSourceTypeSchemas)
    {
      self.feedSourceTypeSchemas = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.feedSourceTypeSchemas, forKey: .feedSourceTypeSchemas)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ListFeedSourceTypeSchemasResponse"
  }
