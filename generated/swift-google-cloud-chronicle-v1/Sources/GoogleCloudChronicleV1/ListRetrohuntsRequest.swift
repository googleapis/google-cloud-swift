...
public struct ListRetrohuntsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListRetrohuntsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListRetrohuntsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ListRetrohuntsRequest"
  }
