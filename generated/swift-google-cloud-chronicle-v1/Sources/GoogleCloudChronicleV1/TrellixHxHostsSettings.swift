...
public struct TrellixHxHostsSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `TrellixHxHostsSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = TrellixHxHostsSettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.TrellixHxHostsSettings"
  }
