...
public struct ListDataTablesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDataTablesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDataTablesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ListDataTablesRequest"
  }
