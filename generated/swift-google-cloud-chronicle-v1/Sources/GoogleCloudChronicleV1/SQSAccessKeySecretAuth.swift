...
public struct SQSAccessKeySecretAuth: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Access key ID.
  ...
  /// Initialize a new instance of `SQSAccessKeySecretAuth`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SQSAccessKeySecretAuth().with { $0.accessKeyId = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.SQSAccessKeySecretAuth"
  }
