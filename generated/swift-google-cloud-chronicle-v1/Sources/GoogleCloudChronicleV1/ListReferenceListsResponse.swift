  ...
  Sendable
{
  ...
  public var referenceLists: [ReferenceList] = []
  ...
  /// Initialize a new instance of `ListReferenceListsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListReferenceListsResponse().with { $0.referenceLists = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([ReferenceList].self, forKey: .referenceLists) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ListReferenceListsResponse"
  }
