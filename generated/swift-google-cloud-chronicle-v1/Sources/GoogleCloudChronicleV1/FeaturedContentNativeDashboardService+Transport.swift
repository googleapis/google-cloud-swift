      ...
      let (path, query, configure) = try {
          ...
          guard
            let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
              ...
              matching: [
                ...
                .literal("/contentHub/featuredContentNativeDashboards/"), .singleWildcard,
              ],
              fieldName: "name")
          else {
            return nil
        ...
        do {
          ...
          builder.maybeAdd(
            ...
            fieldName: "name",
            expecting:
              "projects/*/locations/*/instances/*/contentHub/featuredContentNativeDashboards/*"
          )
      ...
      let (path, query, configure) = try {
        ...
        if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
          guard
            let pathVariable0 = try GoogleGax._RoutingMatcher.pathValue(
              ...
              matching: [
                .literal("projects/"), .singleWildcard, .literal("/locations/"), .singleWildcard,
                .literal("/instances/"), .singleWildcard, .literal("/contentHub"),
              ],
              fieldName: "parent")
          else {
            return nil
          }
          let path = "/v1/\(pathVariable0)/featuredContentNativeDashboards"
          var query = [
            URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
          ]
        ...
        do {
          ...
          builder.maybeAdd(
            ...
            fieldName: "parent",
            expecting: "projects/*/locations/*/instances/*/contentHub"
          )
          paths.append(builder.build())
        }
        throw GoogleGax.RequestError.binding(GoogleGax.BindingError(paths: paths))
