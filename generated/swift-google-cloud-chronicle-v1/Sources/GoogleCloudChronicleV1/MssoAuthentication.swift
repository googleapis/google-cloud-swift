...
/// endpoint.
public struct MssoAuthentication: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `MssoAuthentication`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = MssoAuthentication().with { $0.username = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.MssoAuthentication"
  }
