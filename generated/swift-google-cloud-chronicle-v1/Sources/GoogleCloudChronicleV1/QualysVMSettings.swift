...
/// Qualys VM settings.
public struct QualysVMSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `QualysVMSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = QualysVMSettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.QualysVMSettings"
  }
