...
public struct DuplicateChartRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DuplicateChartRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DuplicateChartRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.DuplicateChartRequest"
  }
