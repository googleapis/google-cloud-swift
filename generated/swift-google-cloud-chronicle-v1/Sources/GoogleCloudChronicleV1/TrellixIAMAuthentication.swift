...
public struct TrellixIAMAuthentication: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `TrellixIAMAuthentication`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = TrellixIAMAuthentication().with { $0.clientId = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.TrellixIAMAuthentication"
  }
