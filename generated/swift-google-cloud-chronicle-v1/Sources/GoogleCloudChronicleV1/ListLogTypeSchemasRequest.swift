...
public struct ListLogTypeSchemasRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListLogTypeSchemasRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListLogTypeSchemasRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ListLogTypeSchemasRequest"
  }
