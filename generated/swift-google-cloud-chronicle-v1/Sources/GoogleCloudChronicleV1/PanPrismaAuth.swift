...
public struct PanPrismaAuth: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Username.
  ...
  /// Initialize a new instance of `PanPrismaAuth`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = PanPrismaAuth().with { $0.user = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.PanPrismaAuth"
  }
