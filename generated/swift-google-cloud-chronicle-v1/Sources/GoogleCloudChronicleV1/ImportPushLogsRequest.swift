...
public struct ImportPushLogsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ImportPushLogsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ImportPushLogsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ImportPushLogsRequest"
  }
