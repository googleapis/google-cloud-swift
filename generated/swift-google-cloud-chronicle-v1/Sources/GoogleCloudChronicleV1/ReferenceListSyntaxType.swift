...
public enum ReferenceListSyntaxType: Codable, Equatable, Hashable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "REFERENCE_LIST_SYNTAX_TYPE_UNSPECIFIED"
    case .plainTextString: return "REFERENCE_LIST_SYNTAX_TYPE_PLAIN_TEXT_STRING"
    case .regex: return "REFERENCE_LIST_SYNTAX_TYPE_REGEX"
    case .cidr: return "REFERENCE_LIST_SYNTAX_TYPE_CIDR"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:ReferenceListSyntaxType/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "REFERENCE_LIST_SYNTAX_TYPE_UNSPECIFIED": self = .unspecified
    case "REFERENCE_LIST_SYNTAX_TYPE_PLAIN_TEXT_STRING": self = .plainTextString
    case "REFERENCE_LIST_SYNTAX_TYPE_REGEX": self = .regex
    case "REFERENCE_LIST_SYNTAX_TYPE_CIDR": self = .cidr
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:ReferenceListSyntaxType/unknownIntValue(_:)).
  public init(intValue: Int) {
    switch intValue {
    case 0: self = .unspecified
    case 1: self = .plainTextString
    case 2: self = .regex
    case 3: self = .cidr
