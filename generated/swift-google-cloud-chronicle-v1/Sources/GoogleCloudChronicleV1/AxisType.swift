...
///   them to named cases.
public enum AxisType: Codable, Equatable, Hashable, Sendable {
  case unspecified
  case value
  case category
  case time
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "AXIS_TYPE_UNSPECIFIED"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:AxisType/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "AXIS_TYPE_UNSPECIFIED": self = .unspecified
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:AxisType/unknownIntValue(_:)).
