...
public struct ThinkstCanarySettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ThinkstCanarySettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ThinkstCanarySettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ThinkstCanarySettings"
  }
