...
public struct PanPrismaCloudSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Input only. Authentication.
  public var authentication: PanPrismaAuth? = nil
  ...
  /// Initialize a new instance of `PanPrismaCloudSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = PanPrismaCloudSettings().with { $0.authentication = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.authentication = try container.decodeIfPresent(PanPrismaAuth.self, forKey: .authentication)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.PanPrismaCloudSettings"
  }
