...
public struct RetrohuntMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The name of the retrohunt.
  /// Format:
  /// `projects/{project}/locations/{location}/instances/{instance}/rules/{rule}/retrohunts/{retrohunt}`
  public var retrohunt: Swift.String = Swift.String()
  ...
  public var executionInterval: GoogleType.Interval? = nil
  ...
  ///
  /// ```
  /// let value = RetrohuntMetadata().with { $0.retrohunt = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.RetrohuntMetadata"
  }
