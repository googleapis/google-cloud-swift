...
public struct NetskopeAlertSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `NetskopeAlertSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = NetskopeAlertSettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.NetskopeAlertSettings"
  }
