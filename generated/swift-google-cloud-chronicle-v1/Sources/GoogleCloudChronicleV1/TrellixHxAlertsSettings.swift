...
public struct TrellixHxAlertsSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `TrellixHxAlertsSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = TrellixHxAlertsSettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.TrellixHxAlertsSettings"
  }
