...
public struct OAuthRefreshToken: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `OAuthRefreshToken`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = OAuthRefreshToken().with { $0.tokenEndpoint = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.OAuthRefreshToken"
  }
