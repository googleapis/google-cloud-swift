...
/// Okta settings.
public struct OktaSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `OktaSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = OktaSettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.OktaSettings"
  }
