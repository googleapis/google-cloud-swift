...
public struct ProofpointOnDemandSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ProofpointOnDemandSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ProofpointOnDemandSettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ProofpointOnDemandSettings"
  }
