...
public struct ComputeFindingsRefinementActivityResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = ComputeFindingsRefinementActivityResponse().with { $0.activity = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.ComputeFindingsRefinementActivityResponse"
  }
