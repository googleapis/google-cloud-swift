  ...
  Sendable
{
  ...
  /// Initialize a new instance of `SQSV2AccessKeySecretAuth`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SQSV2AccessKeySecretAuth().with { $0.accessKeyId = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.SQSV2AccessKeySecretAuth"
  }
