...
public struct GoogleCloudIdentityDevicesSettings: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GoogleCloudIdentityDevicesSettings`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GoogleCloudIdentityDevicesSettings().with { $0.authentication = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.chronicle.v1.GoogleCloudIdentityDevicesSettings"
  }
