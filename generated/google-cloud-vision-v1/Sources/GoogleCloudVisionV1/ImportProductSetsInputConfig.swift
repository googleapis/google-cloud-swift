...
public struct ImportProductSetsInputConfig: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  /// The source of the input.
  public var source: OneOf_Source? = nil

  /// Initialize a new instance of `ImportProductSetsInputConfig`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ImportProductSetsInputConfig().with { $0.gcsSource = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vision.v1.ImportProductSetsInputConfig"
  }
