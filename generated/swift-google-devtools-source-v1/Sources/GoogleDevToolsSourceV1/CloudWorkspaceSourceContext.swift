...
public struct CloudWorkspaceSourceContext: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The ID of the workspace.
  public var workspaceId: CloudWorkspaceId? = nil
  ...
  ///
  /// ```
  /// let value = CloudWorkspaceSourceContext().with { $0.workspaceId = ... }
  /// ```
