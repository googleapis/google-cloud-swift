...
public struct AliasContext: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The alias kind.
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(AliasContext.Kind.self, forKey: .kind) {
      self.kind = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.devtools.source.v1.AliasContext"
  }
