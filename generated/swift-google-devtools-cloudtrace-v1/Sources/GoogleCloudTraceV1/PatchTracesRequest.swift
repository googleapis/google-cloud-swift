...
public struct PatchTracesRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  public var traces: Traces? = nil

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleCloudWKT._UnknownFields = .init()

  /// Initialize a new instance of `PatchTracesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = PatchTracesRequest().with { $0.projectId = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.traces = try container.decodeIfPresent(Traces.self, forKey: .traces)
