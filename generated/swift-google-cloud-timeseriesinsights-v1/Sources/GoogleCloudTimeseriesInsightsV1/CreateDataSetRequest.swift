...
public struct CreateDataSetRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.timeseriesinsights.v1.CreateDataSetRequest"
  }
