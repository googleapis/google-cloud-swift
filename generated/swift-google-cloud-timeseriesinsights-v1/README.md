# Google Cloud Client Libraries for Swift - Timeseries Insights API
...
```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-timeseriesinsights-v1.git --from 0.0.0-preview
```
