...
public struct DeleteSchemaConfigRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteSchemaConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteSchemaConfigRequest().with { $0.name = ... }
  /// ```
