...
public struct GetSchemaRegistryRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetSchemaRegistryRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetSchemaRegistryRequest().with { $0.name = ... }
  /// ```
