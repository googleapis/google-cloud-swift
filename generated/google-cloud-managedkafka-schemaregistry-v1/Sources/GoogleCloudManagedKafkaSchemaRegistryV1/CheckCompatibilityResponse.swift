...
public struct CheckCompatibilityResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  /// The compatibility check result. If true, the schema is compatible with the
  /// resource.
  public var isCompatible: Swift.Bool = Swift.Bool()
  ...
  ///
  /// ```
  /// let value = CheckCompatibilityResponse().with { $0.isCompatible = ... }
  /// ```
