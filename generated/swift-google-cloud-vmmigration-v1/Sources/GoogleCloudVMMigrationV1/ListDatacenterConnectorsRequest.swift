...
public struct ListDatacenterConnectorsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDatacenterConnectorsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDatacenterConnectorsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmmigration.v1.ListDatacenterConnectorsRequest"
  }
