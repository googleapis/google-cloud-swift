...
public struct ListReplicationCyclesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListReplicationCyclesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListReplicationCyclesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmmigration.v1.ListReplicationCyclesRequest"
  }
