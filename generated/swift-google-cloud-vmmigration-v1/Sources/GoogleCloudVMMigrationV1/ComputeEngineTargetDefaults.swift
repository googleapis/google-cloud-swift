...
public struct ComputeEngineTargetDefaults: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// [google.cloud.vmmigration.v1.ComputeEngineTargetDefaults.zone]: <doc:ComputeEngineTargetDefaults/zone>
  ...
  /// Initialize a new instance of `ComputeEngineTargetDefaults`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ComputeEngineTargetDefaults().with { $0.vmName = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmmigration.v1.ComputeEngineTargetDefaults"
  }
