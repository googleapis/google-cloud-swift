...
public struct ListDiskMigrationJobsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListDiskMigrationJobsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListDiskMigrationJobsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmmigration.v1.ListDiskMigrationJobsRequest"
  }
