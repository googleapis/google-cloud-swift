  ...
  Sendable
{
  ...
  /// Initialize a new instance of `ListCloneJobsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCloneJobsResponse().with { $0.cloneJobs = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let cloneJobs = CodingKeys(stringValue: "cloneJobs")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([CloneJob].self, forKey: .cloneJobs) {
      self.cloneJobs = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.cloneJobs, forKey: .cloneJobs)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmmigration.v1.ListCloneJobsResponse"
  }
