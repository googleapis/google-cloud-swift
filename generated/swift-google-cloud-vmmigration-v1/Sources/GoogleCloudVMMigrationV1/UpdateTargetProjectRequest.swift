  ...
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateTargetProjectRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateTargetProjectRequest().with { $0.updateMask = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmmigration.v1.UpdateTargetProjectRequest"
  }
