...
/// configurations.
public struct MachineImageParametersOverrides: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `MachineImageParametersOverrides`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = MachineImageParametersOverrides().with { $0.machineType = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmmigration.v1.MachineImageParametersOverrides"
  }
