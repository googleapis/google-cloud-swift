  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let awsSourceDiskDetails = CodingKeys(stringValue: "awsSourceDiskDetails")
    static let name = CodingKeys(stringValue: "name")
    static let targetDetails = CodingKeys(stringValue: "targetDetails")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([DiskMigrationStep].self, forKey: .steps) {
      self.steps = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.targetDetails, forKey: .targetDetails)
