  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let estimatedCutoverJobDuration = CodingKeys(stringValue: "estimatedCutoverJobDuration")
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(
      self.estimatedCutoverJobDuration, forKey: .estimatedCutoverJobDuration)
