...
public struct MigratingVm: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public struct Expiration: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
  ...
  public enum State: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .firstSync: return try container.encode("FIRST_SYNC")
      case .active: return try container.encode("ACTIVE")
      case .cuttingOver: return try container.encode("CUTTING_OVER")
      case .cutover: return try container.encode("CUTOVER")
      case .finalSync: return try container.encode("FINAL_SYNC")
      case .paused: return try container.encode("PAUSED")
      case .finalizing: return try container.encode("FINALIZING")
      case .finalized: return try container.encode("FINALIZED")
      case .error: return try container.encode("ERROR")
      case .expired: return try container.encode("EXPIRED")
      case .finalizedExpired: return try container.encode("FINALIZED_EXPIRED")
