...
public struct ListImageImportJobsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListImageImportJobsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListImageImportJobsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmmigration.v1.ListImageImportJobsRequest"
  }
