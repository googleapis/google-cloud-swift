...
public struct ListCloneJobsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListCloneJobsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCloneJobsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmmigration.v1.ListCloneJobsRequest"
  }
