  ...
  Sendable
{
  ...
  public var migratingVms: [MigratingVm] = []
  ...
  /// Initialize a new instance of `ListMigratingVmsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMigratingVmsResponse().with { $0.migratingVms = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let migratingVms = CodingKeys(stringValue: "migratingVms")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([MigratingVm].self, forKey: .migratingVms) {
      self.migratingVms = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.migratingVms, forKey: .migratingVms)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmmigration.v1.ListMigratingVmsResponse"
  }
