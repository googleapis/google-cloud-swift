...
public struct AzureSourceVmDetails: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Output only. The firmware type of the source VM.
  public var firmware: AzureSourceVmDetails.Firmware = AzureSourceVmDetails.Firmware()

  /// Output only. The total size of the disks being migrated in bytes.
  public var committedStorageBytes: Swift.Int64 = Swift.Int64()

  /// Output only. The disks attached to the source VM.
  public var disks: [AzureSourceVmDetails.AzureDiskDetails] = []
  ...
  /// Initialize a new instance of `AzureSourceVmDetails`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AzureSourceVmDetails().with { $0.firmware = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      AzureSourceVmDetails.Firmware.self, forKey: .firmware)
    {
      self.firmware = value
    }
    ...
    if let value = try container.decodeIfPresent(
      [AzureSourceVmDetails.AzureDiskDetails].self, forKey: .disks)
    {
      self.disks = value
    }
  ...
  public struct AzureDiskDetails: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `AzureDiskDetails`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = AzureDiskDetails().with { $0.diskNumber = ... }
    /// ```
    public func with(_ config: (inout Self) throws -> Swift.Void) rethrows -> Self {
      var copy = self
      try config(&copy)
