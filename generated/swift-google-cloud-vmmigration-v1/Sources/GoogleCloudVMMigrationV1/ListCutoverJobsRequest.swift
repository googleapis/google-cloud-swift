...
public struct ListCutoverJobsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListCutoverJobsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListCutoverJobsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.vmmigration.v1.ListCutoverJobsRequest"
  }
