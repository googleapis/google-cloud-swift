  ...
  Sendable
{
  ...
  public var resources: [SourceStorageResource] = []
  ...
  /// Initialize a new instance of `FetchStorageInventoryResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FetchStorageInventoryResponse().with { $0.resources = ... }
  /// ```
