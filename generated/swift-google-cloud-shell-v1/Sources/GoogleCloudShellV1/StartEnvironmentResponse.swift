...
public struct StartEnvironmentResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `StartEnvironmentResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = StartEnvironmentResponse().with { $0.environment = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.shell.v1.StartEnvironmentResponse"
  }
