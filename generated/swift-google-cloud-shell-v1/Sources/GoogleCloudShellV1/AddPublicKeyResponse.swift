...
public struct AddPublicKeyResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `AddPublicKeyResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = AddPublicKeyResponse().with { $0.key = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.shell.v1.AddPublicKeyResponse"
  }
