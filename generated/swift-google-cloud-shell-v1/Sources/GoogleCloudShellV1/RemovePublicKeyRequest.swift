...
public struct RemovePublicKeyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `RemovePublicKeyRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RemovePublicKeyRequest().with { $0.environment = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.shell.v1.RemovePublicKeyRequest"
  }
