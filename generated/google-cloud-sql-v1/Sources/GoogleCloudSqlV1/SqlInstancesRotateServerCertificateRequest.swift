...
// limitations under the License.
  ...
  public struct SqlInstancesRotateServerCertificateRequest: Codable, Equatable, GoogleCloudWkt
      ._AnyPackable,
    Sendable
  {
    ...
    ///
    /// ```
    /// let value = SqlInstancesRotateServerCertificateRequest().with { $0.instance = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.sql.v1.SqlInstancesRotateServerCertificateRequest"
    }
