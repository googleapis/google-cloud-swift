...
// limitations under the License.
  ...
  public struct DatabaseFlags: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    /// Initialize a new instance of `DatabaseFlags`.
    public init() {}
    ...
    ///
    /// ```
    /// let value = DatabaseFlags().with { $0.name = ... }
    /// ```
    ...
    public static var _anyTypeUrl: Swift.String {
      return "type.googleapis.com/google.cloud.sql.v1.DatabaseFlags"
    }
