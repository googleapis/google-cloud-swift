...
// limitations under the License.
  ...
  public enum SqlInstanceType: Codable, Equatable, Sendable {
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownStringValue`](doc:SqlInstanceType/unknownStringValue(_:)).
    ...
    ///
    /// If the value is unknown, this initializes to [`unknownIntValue`](doc:SqlInstanceType/unknownIntValue(_:)).
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      case .onPremisesInstance: return try container.encode(2)
      case .readReplicaInstance: return try container.encode(3)
      case .readPoolInstance: return try container.encode(5)
