...
// limitations under the License.
  ...
  extension Clients {
    final class SqlIamPoliciesServiceRetry: SqlIamPoliciesServiceStub {
      let inner: any SqlIamPoliciesServiceStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any SqlIamPoliciesServiceStub, options: GoogleCloudGax.ClientOptions) {
        self.inner = inner
