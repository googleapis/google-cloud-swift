...
// limitations under the License.
  ...
  extension Clients {
    final class SqlInstanceNamesServiceRetry: SqlInstanceNamesServiceStub {
      let inner: any SqlInstanceNamesServiceStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any SqlInstanceNamesServiceStub, options: GoogleCloudGax.ClientOptions) {
        self.inner = inner
