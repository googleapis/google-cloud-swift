  ...
  Sendable
{
  ...
  public var auditSchedules: [AuditSchedule] = []
  ...
  /// Initialize a new instance of `ListAuditSchedulesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAuditSchedulesResponse().with { $0.auditSchedules = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let auditSchedules = CodingKeys(stringValue: "auditSchedules")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([AuditSchedule].self, forKey: .auditSchedules) {
      self.auditSchedules = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.auditSchedules, forKey: .auditSchedules)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.auditmanager.v1.ListAuditSchedulesResponse"
  }
