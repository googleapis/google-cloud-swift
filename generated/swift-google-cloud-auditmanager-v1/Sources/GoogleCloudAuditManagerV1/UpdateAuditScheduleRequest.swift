...
public struct UpdateAuditScheduleRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateAuditScheduleRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateAuditScheduleRequest().with { $0.auditSchedule = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.auditmanager.v1.UpdateAuditScheduleRequest"
  }
