  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = ListResourceEnrollmentStatusesResponse().with { $0.resourceEnrollmentStatuses = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let resourceEnrollmentStatuses = CodingKeys(stringValue: "resourceEnrollmentStatuses")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [ResourceEnrollmentStatus].self, forKey: .resourceEnrollmentStatuses)
    {
      self.resourceEnrollmentStatuses = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.resourceEnrollmentStatuses, forKey: .resourceEnrollmentStatuses)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.auditmanager.v1.ListResourceEnrollmentStatusesResponse"
  }
