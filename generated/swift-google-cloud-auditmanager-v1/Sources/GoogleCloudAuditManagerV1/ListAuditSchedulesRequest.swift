...
public struct ListAuditSchedulesRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListAuditSchedulesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAuditSchedulesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.auditmanager.v1.ListAuditSchedulesRequest"
  }
