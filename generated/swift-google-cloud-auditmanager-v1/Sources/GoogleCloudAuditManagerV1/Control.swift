  ...
  Sendable
{
  ...
  ///   them to named cases.
  public enum Family: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("FAMILY_UNSPECIFIED")
      case .ac: return try container.encode("AC")
      case .at: return try container.encode("AT")
      case .au: return try container.encode("AU")
      case .ca: return try container.encode("CA")
      case .cm: return try container.encode("CM")
      case .cp: return try container.encode("CP")
      case .ia: return try container.encode("IA")
      case .ir: return try container.encode("IR")
      case .ma: return try container.encode("MA")
      case .mp: return try container.encode("MP")
      case .pe: return try container.encode("PE")
      case .pl: return try container.encode("PL")
      case .ps: return try container.encode("PS")
      case .ra: return try container.encode("RA")
      case .sa: return try container.encode("SA")
      case .sc: return try container.encode("SC")
      case .si: return try container.encode("SI")
      case .sr: return try container.encode("SR")
