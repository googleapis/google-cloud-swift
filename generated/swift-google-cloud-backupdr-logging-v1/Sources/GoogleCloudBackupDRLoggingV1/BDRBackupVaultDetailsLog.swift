  ...
  Sendable
{
  ...
  public var firstAvailableRestorePoint: GoogleWKT.WKTTimestamp? = nil

  /// Timestamp when the latest backup was taken.
  public var lastAvailableRestorePoint: GoogleWKT.WKTTimestamp? = nil
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.firstAvailableRestorePoint = try container.decodeIfPresent(
      GoogleWKT.WKTTimestamp.self, forKey: .firstAvailableRestorePoint)
    self.lastAvailableRestorePoint = try container.decodeIfPresent(
      GoogleWKT.WKTTimestamp.self, forKey: .lastAvailableRestorePoint)
