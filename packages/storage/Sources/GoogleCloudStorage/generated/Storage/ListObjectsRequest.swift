...
///
/// [google.storage.v2.Storage.ListObjects]: <doc:StorageControlClient/listObjects(request:)>
  ...
  Sendable
{
  ...
  /// `prefixes`.
  public var includeTrailingDelimiter: Swift.Bool = Swift.Bool()
  ...
  public var versions: Swift.Bool = Swift.Bool()
  ...
  public var softDeleted: Swift.Bool = Swift.Bool()
  ...
  public var includeFoldersAsPrefixes: Swift.Bool = Swift.Bool()
  ...
  /// for the full syntax.
  public var matchGlob: Swift.String = Swift.String()
  ...
  ///
  /// ```
  /// let value = ListObjectsRequest().with { $0.parent = ... }
  /// ```
