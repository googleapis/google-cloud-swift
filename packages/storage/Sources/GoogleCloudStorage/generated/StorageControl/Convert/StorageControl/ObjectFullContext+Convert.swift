...
extension ObjectFullContext.Type_ {
  internal init(proto: StorageControlProtos.Google_Storage_Control_V2_ObjectFullContext.Type_) {
    switch proto {
    case .unspecified:
      self = .unspecified
    case .custom:
  ...
  internal func toProto() throws
    -> StorageControlProtos.Google_Storage_Control_V2_ObjectFullContext.Type_
  {
    switch self {
    case .unspecified:
      return .unspecified
    ...
    case .unknownIntValue(let val):
      return StorageControlProtos.Google_Storage_Control_V2_ObjectFullContext.Type_(rawValue: val)
        ?? .UNRECOGNIZED(val)
