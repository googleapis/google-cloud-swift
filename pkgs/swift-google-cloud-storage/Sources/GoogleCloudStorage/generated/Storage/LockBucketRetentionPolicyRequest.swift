...
public struct LockBucketRetentionPolicyRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var ifMetagenerationMatch: Swift.Int64 = Swift.Int64()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `LockBucketRetentionPolicyRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = LockBucketRetentionPolicyRequest().with { $0.bucket = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.Int64.self, forKey: .ifMetagenerationMatch) {
      self.ifMetagenerationMatch = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.storage.v2.LockBucketRetentionPolicyRequest"
  }
