...
public struct BucketAccessControl: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `BucketAccessControl`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = BucketAccessControl().with { $0.role = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.storage.v2.BucketAccessControl"
  }
