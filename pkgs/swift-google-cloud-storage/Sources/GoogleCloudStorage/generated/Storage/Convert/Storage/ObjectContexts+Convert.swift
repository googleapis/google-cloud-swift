...
extension ObjectContexts {
  internal typealias ProtoType = StorageProtos.Google_Storage_V2_ObjectContexts

  internal init(proto: ProtoType) throws {
    self.init()
    self.custom = try proto.custom.mapValues { try .init(proto: $0) }
    self._unknownFields.proto = proto.unknownFields.data
  }

  internal func toProto() throws -> ProtoType {
    var proto = ProtoType()
    proto.custom = try self.custom.mapValues { try $0.toProto() }
