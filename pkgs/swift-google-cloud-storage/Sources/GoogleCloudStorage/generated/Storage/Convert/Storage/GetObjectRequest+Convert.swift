...
extension GetObjectRequest {
  internal typealias ProtoType = StorageProtos.Google_Storage_V2_GetObjectRequest
  ...
  internal init(proto: ProtoType) throws {
    ...
    self.softDeleted = proto.hasSoftDeleted ? proto.softDeleted : nil
  ...
  internal func toProto() throws -> ProtoType {
    ...
    if let softDeleted = self.softDeleted { proto.softDeleted = softDeleted }
