...
public struct ObjectFullContext: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var extendedData: GoogleWKT.WKTAny? = nil
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let extendedData = CodingKeys(stringValue: "extendedData")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(ObjectFullContext.Type_.self, forKey: .type) {
      self.type = value
    }
    ...
    self.extendedData = try container.decodeIfPresent(GoogleWKT.WKTAny.self, forKey: .extendedData)
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(self.extendedData, forKey: .extendedData)
