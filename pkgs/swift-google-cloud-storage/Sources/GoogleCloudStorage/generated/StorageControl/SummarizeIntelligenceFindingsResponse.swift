  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let findingSummaries = CodingKeys(stringValue: "findingSummaries")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([FindingSummary].self, forKey: .findingSummaries) {
      self.findingSummaries = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.findingSummaries, forKey: .findingSummaries)
