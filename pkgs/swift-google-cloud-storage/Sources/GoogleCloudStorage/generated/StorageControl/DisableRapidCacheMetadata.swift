...
public struct DisableRapidCacheMetadata: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = DisableRapidCacheMetadata().with { $0.commonMetadata = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.storage.control.v2.DisableRapidCacheMetadata"
  }
