  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let intelligenceFindingRevisions = CodingKeys(
      stringValue: "intelligenceFindingRevisions")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [IntelligenceFindingRevision].self, forKey: .intelligenceFindingRevisions)
    {
      self.intelligenceFindingRevisions = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.intelligenceFindingRevisions, forKey: .intelligenceFindingRevisions)
