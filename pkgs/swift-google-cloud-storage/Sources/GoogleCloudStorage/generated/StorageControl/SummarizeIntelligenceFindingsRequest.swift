...
public struct SummarizeIntelligenceFindingsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let resourceScope = CodingKeys(stringValue: "resourceScope")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      SummarizeIntelligenceFindingsRequest.ResourceScope.self, forKey: .resourceScope)
    {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.resourceScope, forKey: .resourceScope)
  ...
  public enum ResourceScope: Codable, Equatable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .unspecified: return try container.encode("RESOURCE_SCOPE_UNSPECIFIED")
      case .parent: return try container.encode("PARENT")
