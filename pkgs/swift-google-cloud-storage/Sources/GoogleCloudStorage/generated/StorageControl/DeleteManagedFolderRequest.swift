...
public struct DeleteManagedFolderRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let allowNonEmpty = CodingKeys(stringValue: "allowNonEmpty")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.Bool.self, forKey: .allowNonEmpty) {
      self.allowNonEmpty = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.allowNonEmpty, forKey: .allowNonEmpty)
