...
public struct IntelligenceFindingRevision: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.snapshot = try container.decodeIfPresent(IntelligenceFinding.self, forKey: .snapshot)
