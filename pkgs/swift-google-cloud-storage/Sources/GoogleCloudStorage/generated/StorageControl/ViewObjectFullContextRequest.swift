...
public struct ViewObjectFullContextRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public var contextKey: Swift.String = Swift.String()
  ...
  /// Initialize a new instance of `ViewObjectFullContextRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ViewObjectFullContextRequest().with { $0.generation = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let contextKey = CodingKeys(stringValue: "contextKey")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .contextKey) {
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.storage.control.v2.ViewObjectFullContextRequest"
  }
