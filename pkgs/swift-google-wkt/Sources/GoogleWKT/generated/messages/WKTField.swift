  ...
  Sendable
{
  ...
  public enum Kind: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      switch self {
      case .typeUnknown: return try container.encode("TYPE_UNKNOWN")
      case .typeDouble: return try container.encode("TYPE_DOUBLE")
      case .typeFloat: return try container.encode("TYPE_FLOAT")
      case .typeInt64: return try container.encode("TYPE_INT64")
      case .typeUint64: return try container.encode("TYPE_UINT64")
      case .typeInt32: return try container.encode("TYPE_INT32")
      case .typeFixed64: return try container.encode("TYPE_FIXED64")
      case .typeFixed32: return try container.encode("TYPE_FIXED32")
      case .typeBool: return try container.encode("TYPE_BOOL")
      case .typeString: return try container.encode("TYPE_STRING")
      case .typeGroup: return try container.encode("TYPE_GROUP")
      case .typeMessage: return try container.encode("TYPE_MESSAGE")
      case .typeBytes: return try container.encode("TYPE_BYTES")
      case .typeUint32: return try container.encode("TYPE_UINT32")
      case .typeEnum: return try container.encode("TYPE_ENUM")
      case .typeSfixed32: return try container.encode("TYPE_SFIXED32")
      case .typeSfixed64: return try container.encode("TYPE_SFIXED64")
      case .typeSint32: return try container.encode("TYPE_SINT32")
      case .typeSint64: return try container.encode("TYPE_SINT64")
  ...
  ///   expecting specific values to remain unparsed; future releases may promote
  ///   them to named cases.
  public enum Cardinality: Codable, Equatable, Hashable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
      var container = encoder.singleValueContainer()
      switch self {
      case .unknown: return try container.encode("CARDINALITY_UNKNOWN")
      case .`optional`: return try container.encode("CARDINALITY_OPTIONAL")
      case .`required`: return try container.encode("CARDINALITY_REQUIRED")
      case .repeated: return try container.encode("CARDINALITY_REPEATED")
      case .unknownIntValue(let v): return try container.encode(v)
      case .unknownStringValue(let v): return try container.encode(v)
      }
    }
