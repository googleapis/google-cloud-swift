...
public enum WKTAnyError: Error {
  ...
  ///
  /// It is possible to store `WKTAny` into a `WKTAny`. This error indicates that the nested `@type`
  /// field for the inner `WKTAny` contents was missing or was not a JSON string.
